...
return array(
    ...
    'text_size' => array(
        ...
        'options' => array(
            array('value' => '12', 'title' => _wp('Small'), 'description' => ''),
            array('value' => '14', 'title' => _wp('Medium'), 'description' => ''),
            array('value' => '18', 'title' => _wp('Large'), 'description' => '')
        )
    ),
    'text_color' => array(
        'title' => _wp('Text color'),
        'description' => _wp('Color value in hex format, e.g. #000000'),
        'value' => '#FFFFFF',
        'control_type' => waHtmlControl::INPUT
    ),
    'text_align' => array(
    ...
    'image' => array(
        'title' => _wp('Image'),
        'value' => '',
        'control_type' => waHtmlControl::CUSTOM.' '.'shopWatermarkPlugin::getFileControl'
    ),
    'image_align' => array(
