    ...
    'sku_features' => array(
        ...
        'options'      => array(
            0 => array(
                ...
                'description' => 'Значения характеристик в свойствах артикулов обновляться не будут.',
            ),
            'import' => array(
                'value'       => 'import',
                'title'       => 'Импортировать',
                'description' => 'В свойствах артикулов будут сохранены значения характеристик типа «Выбор нескольких возможных вариантов (checkbox)».',
            ),
        ),
    ),
...
Остальным импортированным товарам будет присвоен статус «Опубликован на сайте».<br><br><br>',
        'control_type' => waHtmlControl::CHECKBOX,
        'translate'    => false,
    ),
