...
Идентификатор используется только для экспорта цен товаров из Shop-Script. Для правильного импорта цен укажите значение в поле «Тип цены из 1С».',
    ...
    'export_product_features'  => array(
        ...
        'options'      => array(
            'none' => 'Нэ экспортировать',
            'all'  => 'Экспортировать все характеристики',
            'sync' => 'Экспортировать только синхронизированные с 1С',
        ),
    ),
    'export_product_description'  => array(
        'value'        => '',
        'title'        => 'Экспорт описания товаров в составе заказов',
        'description'  => 'Включите, чтобы экспортировать описание заказанных товаров',
        'control_type' => waHtmlControl::RADIOGROUP,
        'options'      => array(
            '' => 'Нэ экспортировать',
            'summary'  => 'Экспортировать "Краткое описание"',
            'description' => 'Экспортировать "Описание"',
        ),
    ),
