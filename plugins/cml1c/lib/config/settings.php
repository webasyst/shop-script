...
<a href="?plugin=cml1c&action=download&file=cml1c_import_files.zip" target="_blank">скачать</a> в виде архива.<br>После выключения этой настройки накопленные файлы будут доступы для скачивания только до очередного обмена данными.',
        'control_type' => waHtmlControl::CHECKBOX,
        'translate'    => false,
    ),
);
