...
В текстовое поле добавьте строку вида <b>yandexmarket.cpa=0</b> или <b>yandexmarket.cpa=1</b>',
        ...
        'fee'                   => array(
            ...
            'help'        => 'Величина комиссии указывается в процентах и может варьироваться от 0 и до 100% с шагом в 0,01.
Добавить дополнительный параметр <tt>yandexmarket.fee</tt> возможно при редактировании товара, вкладка «Описание и SEO», поле «Дополнительные параметры».
В текстовое поле добавьте строку вида <b>yandexmarket.fee=2.7</b> или <b>yandexmarket.fee=1</b>',
            'source'      => 'skip:',
            'params'      => array(
                'fee' => 'fee',
            ),
