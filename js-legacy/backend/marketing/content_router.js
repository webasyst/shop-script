var ContentRouter = ( function($) {
    ...
    ContentRouter = function(options) {
        ...
        that.on = {
            before_load: (typeof options["onBeforeLoad"] === "function" ? options["onBeforeLoad"] : null),
            loaded: (typeof options["onLoaded"] === "function" ? options["onLoaded"] : null)
        }
    ...
    ContentRouter.prototype.load = function(content_uri, unset_state) {
        ...
        if (typeof that.on.before_load === "function") { that.on.before_load(that); }
        $(document).trigger('wa_before_load', { content_uri: content_uri });
