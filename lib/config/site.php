...
return array(
    ...
    'vars' => array(
        ...
        'product.html'     => array(
            ...
            /*
                        '$category' => _w('Conditional! Available only if current context of photo is album. Below are described the keys of this parameter.'),
                        '$category.id' => '',
                        '$category.name' => '',
                        '$category.parent_id' => '',
                        '$category.description' => '',
        ...
        'my.order.html'    => array(
            ...
            '$order.params.<br>shipping_est_delivery'                  => _w('A string indicating an approximate time frame of the order delivery (if defined)'),
        ...
        '$wa'              => array(
            ...
            '$wa->shop->getListThumbsTemplate(<em>$products</em>, <em>$theme_id = null</em>)'                                                                                   => _w('Returns the HTML code of a product list rendered by a design theme’s <em class="nowrap">list-thumbs.html</em> template file.<br><br><strong>$products</strong>: Array of products to be displayed; e.g., obtained using the <code class="nowrap">{$wa->shop->products()}</code> method.<br><br><strong>$theme_id</strong>: ID of the design theme whose template file must be used. Be default, the product list is rendered by the current theme.'),
            ...
            '$product'                                                                                                => array(
                ...
                '$product->getProductUrl(<em>$storefront_url</em>)'                 => _w('Returns a product URL for a specified storefront address. Use <em>$order.params.storefront|default:true</em> if you have multiple storefronts, or <em>true</em> if you have only one storefront.'),
            ...
            '$wa->shop->products(<em>search_conditions</em>[,<em>offset</em>[, <em>limit</em>[, <em>options</em>]]])' => _w('Returns array of products by search criteria, e.g. <em>"tag/new"</em>, <em>"category/12"</em>, <em>"id/1,5,7"</em>, <em>"set/1"</em>, or <em>"*"</em> for all products list.').' '._w('Optional parameter <em>offset</em> denotes the number of products to be skipped at the beginning of the returned result; by default 0 products are skipped. Optional parameter <em>limit</em> denotes the number of products to be returned instead of the default quantity 500. Optional parameter <em>options</em> indicates additional product options, e.g. <em>["params" => 1]</em> to include product custom parameter values into the output.'),
            ...
            '$wa->shop->productSet(<em>set_id</em>[,<em>offset</em>[, <em>limit</em>[, <em>options</em>]]])'                                                                  => _w('Returns array of products from the specified set.').' '._w('Optional parameter <em>offset</em> denotes the number of products to be skipped at the beginning of the returned result; by default 0 products are skipped. Optional parameter <em>limit</em> denotes the number of products to be returned instead of the default quantity 500. Optional parameter <em>options</em> indicates additional product options, e.g. <em>["params" => 1]</em> to include product custom parameter values into the output.'),
