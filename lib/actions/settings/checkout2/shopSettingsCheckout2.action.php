...
class shopSettingsCheckout2Action extends shopSettingsCheckoutAbstractAction
{
    ...
    public function execute()
    {
        ...
        $this->view->assign([
            ...
            'order_mode_variants'                      => $this->checkout_config->getOrderModeVariants(),
            'order_show_pickuppoint_map_variants'      => $this->checkout_config->getOrderShowPickuppointMapVariants(),
