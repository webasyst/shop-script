...
if(!k.placeholder||!f.call(o,this))if(k.allowEmpty||b)k.truncate?(o.data("real_text",b),o.text(b.length<k.truncate-3?b:b.substr(0,k.truncate-3)+"...")):!k.html?o.text(b):o.html(b),b||d.call(this);o.show();a(this).hide();a(k.editLink).show();!1===c&&k.afterBackReadable.call(o.get(0),this,{changed:b!=r,old_text:r})}}function i(a){switch(k.inputType){case "textarea":return'<textarea id="'+a+'" style="display:none;"></textarea>';default:return'<input type="text" id="'+a+'" style="display:none;">'}}function j(a){return function(){return a}}
function m(a){return!k.html?a.text():a.html()}if(this.length){var l=!1;if("string"==typeof b){if("setOption"==b){var k=this.data("inlineEditableSettings")||{};a.extend(!0,k,c);"undefined"!==typeof c.hold&&"function"!==typeof c.hold&&(k.hold=j(k.hold));this.data("inlineEditableSettings",k)}return this}var q=this.data("inlineEditableSettings");this.data("inlineEditableSettings",a.extend({inputType:"text",inputClass:"",size:{height:null,width:null},minSize:{height:null,width:null},maxSize:{height:null,
width:null},editLink:null,editOnItself:!0,placeholder:null,makeReadableBy:["blur","enter","esc"],updateBy:["ctrl+enter","alt+enter"],beforeBackReadable:function(){},afterBackReadable:function(){},beforeMakeEditable:function(){},afterMakeEditable:function(){},placeholderClass:"hint",truncate:!1,hold:!1,html:!1,allowEmpty:!1},q,b||{}));var k=this.data("inlineEditableSettings")||{},o=this,n="read",r="";"function"!==typeof k.hold&&(k.hold=j(k.hold));this.data("inited")||(k.truncate&&"boolean"==typeof k.truncate&&
...
function(){k.hold.call(o)||n!="edit"&&g.call(this)}),this.unbind("placeholder.inlineEditable").bind("placeholder.inlineEditable",function(b,c){c&&k.placeholder&&d.call(this);c||a(this).removeClass(k.placeholderClass)}),this.data("inited",!0));return this}}})(jQuery);(function(a){a.fn.photoStreamSlider=function(b){function c(){function b(c){function i(){b.execution=!1;var a="on"+k.charAt(0).toUpperCase()+k.slice(1),a=d[a];"function"==typeof a&&a.call(e);a=c.fn;"function"==typeof a&&a.call(e)}"string"==typeof c&&(c={direction:c,animate:!0});var k=c.direction||"forward",l=c.steps||h.length;if(!b.execution){b.execution=!0;var o=h.filter(":first").outerWidth()*l,n=h.length;if("forward"==k){var s=h.filter(":last").nextAll(":lt("+l+")"),l=s.length,s=s.filter(":last");
l&&(h.removeClass("visible"),s.prevAll(":lt("+(n-1)+")").addClass("visible"),s.addClass("visible"))}else s=h.filter(":first").prevAll(":lt("+l+")"),l=s.length,s=s.filter(":last"),l&&(h.removeClass("visible"),s.nextAll(":lt("+(n-1)+")").addClass("visible").show(),s.addClass("visible"));h=a("li.visible",g);n=g.position().left;"forward"==k?(l=m-j-q,n-=o,n=n>-l?n:-l):(n+=o,n=n<q?n:q);c.animate?g.animate({left:n},d.duration,i):(g.css({left:n}),i())}}var g=e.find(d.photoStream),h=a("li.visible",g),i=a("li",
g),j=h.filter(":first").outerWidth()*h.length,m=i.filter(":first").outerWidth()*i.length,l=d.height||i.filter(":first").outerHeight();g.parent().css({overflow:"hidden",height:l,position:"relative",padding:"4px 0",margin:0,width:j});for(var l=g.find("li:first"),k=h.filter(":first"),q=(k.outerWidth()-k.width())/2,o=0,n=l.outerWidth(),k=k.get(0);l.length&&l.get(0)!=k;)o+=n,l=l.next();g.css({position:"absolute",left:-(o-q),width:m});a(d.forwardLink).unbind("click").bind("click",function(){b("forward");
return!1});a(d.backwardLink).unbind("click").bind("click",function(){b("backward");return!1});e.unbind("append prepend").bind("append prepend",function(b,d){if("append"==b.type){for(var c=g.find("li:last"),f=a();c.hasClass("dummy");)f=f.add(c),c=c.prev("li");f.remove();g.append(d)}else{var c=a("<div></div>").html(d),f=c.find("li"),h=f.length*n;c.remove();for(var c=g.find("li:first"),j=a();c.hasClass("dummy");)j=j.add(c),c=c.next("li");j.remove();g.prepend(f)}i=g.find("li");m=i.filter(":first").outerWidth()*
i.length;g.css("width",m);"prepend"==b.type&&(g.is(":animated")&&g.stop(!1,!0),g.css("left",parseInt(g.css("left"))-h));g.find("li.selected").hasClass("visible")&&e.trigger("home",[null,!1])});e.unbind("forward backward").bind("forward backward",function(a,d){b({direction:a.type,steps:d.steps,animate:"undefined"!==typeof d.animate?d.animate:!0,fn:d.fn});var c=g.find("li.selected"),e="forward"==a.type?c.next("li:not(.dummy)"):c.prev("li:not(.dummy)");e.length&&(c.removeClass("selected"),e.addClass("selected"))});
e.unbind("home").bind("home",function(d,c,e){var d=parseInt(h.length/2),d=h.filter(":eq("+d+")"),g=d.nextAll(".selected:first"),i=d.prevAll(".selected:first"),j=0,m="";"function"!==typeof c&&(e=c);e="undefined"!==typeof e?e:!0;g.length?(m="forward",d.nextAll().each(function(){++j;if(a(this).hasClass("selected"))return!1})):i.length&&(m="backward",d.prevAll().each(function(){++j;if(a(this).hasClass("selected"))return!1}));m&&j?b({direction:m,steps:j,fn:c,animate:e}):"function"==typeof c&&c();return!1});
...
c){var d=a(this);if(c.draggable.attr("data-type")!=d.attr("data-type"))return!1;(d.is(":animated")||d.hasClass("dragging"))&&d.stop().animate({height:"2px"},300,null,function(){d.removeClass("dragging")});d.removeClass("active").parent().parent().removeClass("drag-active")},drop:function(b,c){var d=a(this),e=c.draggable,f=e.attr("data-type");if(f!=d.attr("data-type"))return!1;var g=function(a){a=a.split("-");a.shift();return a.join("-")},h=g(e.attr("id")),i=d.prev("li"),j=e.next(),m=e.prev();if(i.length&&
i.attr("id")=="category-"+h&&!i.hasClass("dr-helper")||this==e.next().get(0))return!1;var l=e.parent("ul"),k=l.children("li.dr[id!=category-"+h+"]").length,q=parseInt(g(l.parent().attr("id")),10)||0;d.after(j).after(e);d=e.parent().parent();if(d.is("li.dr")||d.is(".s-collection-list")){var o=0;d.is(".s-collection-list")||(o=parseInt(g(d.attr("id")),10)||0);d=e.nextAll("li.dr:first");i=null;d.length&&(i=g(d.attr("id"))||null);!k&&q!==o&&(l.parent("li").children("i").hide(),l.hide());a.product_dragndrop.trigger("move_list",
{id:h,type:f,before_id:i,parent_id:o,success:function(){if(!k&&q!==o){l.parent("li").children("i").remove();l.remove();a.categories_tree.setCollapsed(q)}},error:function(a){a&&console&&console.log(typeof a.errors!=="undefined"?a.errors:a);m.after(e.next()).after(e);if(!k){l.parent("li").children("i").show();l.show()}}})}}})},initDropInsideCollections:function(){a(".s-collection-list li.dr a").liveDroppable({tolerance:"pointer",greedy:!0,out:function(b,c){var d=c.draggable,e=a(this).parent();if(!d.hasClass("product")&&
...
var g=a("#product-list"),h={};if(g.find(".s-select-all").is(":checked"))h.whole_list=!0;else{var i=g.find(".product.selected");h.product_ids=i.map(function(){return a(this).attr("data-product-id")}).toArray()}a.product_dragndrop.trigger("add_to_list",a.extend(h,{collection_param:e.attr("id").replace("-","_id="),success:function(a){h.whole_list?g.find(".s-select-all").trigger("select",!1):h.product_ids&&h.product_ids.length&&i.trigger("select",!1);a.data&&(e.find(">.counters .count:not(.subtree)").text(a.data.count),
...
return false}});a("#s-products-search").unbind("search").bind("search",function(){b.call(this);return false});a("#s-products-search").autocomplete({source:"?action=autocomplete",minLength:3,delay:300,select:function(b,d){a.wa.setHash("#/product/"+d.item.id);return false}})},initSidebar:function(){var b=a("#s-sidebar");a.product_dragndrop.init({collections:true}).bind("move_list",function(b){if(b.type){var c={id:b.id,type:b.type,parent_id:b.parent_id||0};if(b.before_id)c.before_id=b.before_id;a.products.jsonPost("?module=products&action=moveList",
c,b.success,b.error)}else typeof b.error==="function"&&b.error("Unknown list type")});b.off("add",".s-collection-list ul").on("add",".s-collection-list ul",function(b,c,f,g){var b=a(this),h=b.parents(".s-collection-list:first"),i=a("<ul></ul>");i.append(tmpl("template-sidebar-list-item",{type:f,item:c}));c=i.children(":not(.drag-newposition):first");f=c.attr("id");f=b.find("#"+f);f.length?g&&f.replaceWith(c):b.prepend(i.children()).show();b.children().mouseover();b.find(".drag-newposition").css({height:"2px"}).removeClass("dragging");
h.find(".s-empty-list").hide();i.remove();return false});b.unbind("update").bind("update",function(b,c){for(var f in c)if(f=="all")a("#s-all-products").find(".count:first").text(c[f].count);else{var g="#"+f+"-",h;for(h in c[f])a(g+h).find(".count:first").text(c[f][h].count)}return false});a("#s-tag-cloud").unbind("update").bind("update",function(b,c){var f='<ul class="tags"><li class="block align-center">',g;for(g in c)var h=c[g],f=f+('<a href="#/products/tag='+h.uri_name+'/" style="font-size: '+
h.size+"%; opacity: "+h.opacity+'"  data-id="'+h.id+'"  class="s-product-list">'+h.name+"</a>");a("#s-tag-cloud").html(f+"</li></ul>").parents(".block:first").show();return false});b.off("count_subtree",".s-collection-list li").on("count_subtree",".s-collection-list li",function(b,c){var f=a(this);typeof c==="undefined"&&(c=f.find("i.collapse-handler-ajax").hasClass("rarr"));var g=f.find(">.counters .count:not(.subtree)"),h=f.find(">.counters .subtree");if(!h.length){h=g.clone().addClass("subtree").hide();
g.after(h)}if(c){var i=parseInt(g.text(),10)||0;f.find("li.dr:not(.dynamic)>.counters .count:not(.subtree)").each(function(){i=i+(parseInt(a(this).text(),10)||0)});h.text(i).show();g.hide();g.hide();h.show()}else{h.hide();g.show()}return false});b.off("update_counters",".s-collection-list li").on("update_counters",".s-collection-list li",function(b,c){var f=a(this),g=f.find(">.count:not(.subtree)"),f=f.find(">.subtree");if(!f.length){f=g.clone().addClass("subtree").hide();g.after(f)}typeof c.item!==
"undefined"&&g.text(parseInt(c.item,10)||0);typeof c.subtree!=="undefined"&&f.text(parseInt(c.subtree,10)||0);return false});var c=b.find("#s-category-list-widen-arrows");c.find("a.arrow").unbind("click").bind("click",function(){var d=b.attr("class"),e=0,f=d.match(/left([\d]{2,3})px/);if(f&&f[1]&&(e=parseInt(f[1]))){f=e+(a(this).is(".right")?50:-50);f=Math.max(Math.min(f,400),200);if(f!=e){c.css({width:f.toString()+"px"});e=["left"+e+"px","left"+f+"px"];b.attr("class",d.replace(e[0],e[1]));b.css("width",
"");var g=a("#s-content"),d=g.attr("class");g.attr("class",d.replace(e[0],e[1]));g.css("margin-left","");a.product&&a.product.setOptions({sidebar_width:f});a.shop.jsonPost("?action=sidebarSaveWidth",{width:f})}}return false})},jsonPost:function(b,c,d,e){a.shop.jsonPost(b,c,d,e)}}})(jQuery);(function(a){a.product={options:{duration:200,container_selector:"#shop-productprofile",message_selector:"#product-save-message",form_selector:"#s-product-save",update_delay:100},message:{submit:'<i class="icon16 loading"></i>',success:'<i class="icon16 yes"></i>',error:'<i class="icon16 no"></i>'},path:{id:null,mode:null,tab:null,tail:null,raw:null,params:{}},ajax:{random:null,target:null,link:null,save:!1,cached:{}},data:{main:{}},getData:function(a,c){return(this.data[a]||{})[c]},setData:function(a,
...
a(this).parent(),c=b.find("select");1<a("#s-product-edit-forms .s-product-form.main select.s-product-categories").length?(c.attr("disabled",!0),b.remove()):(c.val("selected").attr("disabled",!1),b.find("input.val").val(0).attr("disabled",!0).parent().hide(),b.find(".s-product-delete-from-category").hide());return!1})},editTabMainAction:function(b){var c=!1,d=null;b&&b.params&&b.params.focus?(d=b.params.name||"",!d.length&&b.params.sku&&(d="product[skus]["+parseInt(b.params.sku,10)+"]",b.params.focus&&
(d+="["+b.params.focus+"]"),"stock"==b.params.focus&&(d+="["+(parseInt(b.params.stock,10)||0)+"]")),c=':input[name$="'+d.replace(/(\[|\]|\|\-)/g,"\\$1")+'"]:first'):b&&"new"==b.id&&(c=':input[name$="[name]"]:first');c&&(a.shop.trace("$.product.editTabMainFocus",[d,a(c).length]),setTimeout(function(){a(c).focus();window.location.hash="#/product/"+b.raw.replace(/\/focus=.*$/,"/")},100))},editTabMainBlur:function(){},editTabMainSave:function(){if(!1===this.call("editTabMainSkuEproductSave"))return!1},
helper:{options:{tab_changed:'<i class="icon10 status-yellow-tiny"></i>'},data:{url_helper:{url:"",name:"",timer:null}},init:function(){this.data.url_helper={url:"",name:"",timer:null}},onTabChanged:function(b,c){a.shop.trace("$.product.onChange id="+b+" changed="+c);a("#s-product-edit-menu li."+b+" .s-product-edit-tab-status").html(c?this.options.tab_changed:"")},type:function(b){return parseInt(b,10)||parseInt(a('#s-product-edit-forms .s-product-form.main :input[name="product[type_id]"]').val(),
10)||0},onNameChange:function(b,c,d){this.data.url_helper.timer&&clearTimeout(this.data.url_helper.timer);var e=a(a.product.options.form_selector).find(':input[name="product[url]"]'),f=e.parent();if(a.product.path.id&&"new"!=a.product.path.id||e.val()!=this.data.url_helper.url)a.shop.trace("$.product.onNameChange stop "+this.data.url_helper.url+" != "+e.val()),a(a.product.options.form_selector).off(".product",':input[name="product[name]"]'),f.find(".js-url-helper").hide();else{c&&(f.find(".js-url-helper").length?
f.find(".js-url-helper").show():f.append('<i class="icon16 loading js-url-helper"></i>'));var g=this;this.data.url_helper.timer=setTimeout(function(){g.urlHelper(b,e,d)},d||500)}},onChange:function(b){var c=this.checkChanges(b.parents("form"),!1),d=this.getContainerId(b);a.shop.trace("$.product.onChange changed="+c);a("#s-product-edit-save-panel :submit").removeClass(c?"green":"yellow").addClass(c?"yellow":"green");c&&(c=this.checkChanges(b,!1));this.onTabChanged(d,c)},urlHelper:function(b,c){this.data.url_helper.timer&&
clearTimeout(this.data.url_helper.timer);var d={str:a(b).val()};a.shop.trace("$.product.urlHelper ",d);if(d.url!=this.data.url_helper.name){var e=this;this.data.url_helper.url=d.url;a.ajax({url:"?action=transliterate",data:d}).done(function(b){if((b=a.parseJSON(b))&&"ok"==b.status)e.data.url_helper.url=b.data,c.val(b.data),c.parent().find(".js-url-helper").hide()})}else c.parent().find(".js-url-helper").hide()},getValueByName:function(b,c){for(var d=b,e=c.replace(/\]/,"").split("[");e.shift();)if(void 0!==
d[c])d=d[c];else{d="";break}a.shop.trace("$.product.helper.getValueByName",[d,c,b]);return d},checkChanges:function(b,c){var d=!1,e=this,f=":input:not(.js-ignore-change)";if(b.hasClass("s-product-form")){if(b.hasClass("ajax"))return!1}else f=".s-product-form:not(.ajax) "+f;b.find(f).each(function(){var b=(a(this).attr("type")||this.tagName).toLowerCase();switch(b){case "input":case "text":case "textarea":this.defaultValue!=this.value&&(d=!0,c&&(this.defaultValue=this.value,e.updateInput(this.name,
this.value,"textarea"==b)));break;case "radio":case "checkbox":this.defaultChecked!=this.checked&&(d=!0,c&&(this.defaultChecked=this.checked));break;case "select":this.length&&a(this).find("option").each(function(){this.defaultSelected!=this.selected&&(d=!0,c&&(this.defaultSelected=this.selected));return c||!d});break;case "file":this.value&&(d=!0,c&&(this.value=null));break;case "reset":case "button":case "submit":break;case "hidden":break;default:a.shop.error("$.product.checkChanges unsupported type "+
b,[b,this])}!c&&d&&a.shop.trace("$.product.helper.checkChanges",[this,d]);return c||!d});return d},getContainerId:function(b){var b=(a(b).attr("class")||"").split(" "),c=!1,d;for(d in b)if("s-product-form"!=b[d]){c=b[d];break}return c},updateInput:function(b,c,d,e){if(b){var f=".s-"+b.replace(/\[(.+?)\]/g,"-$1")+"-input";a.shop.trace("update field: "+b+" "+f+" value="+c);b=a(f);b.is("input,textarea")?b.val(c):d?b.html(c):b.text(c);e&&(c=a(f).attr("name"),c=c.replaceAll(/\[-[\d]+\]/,"["+e+"]"),a.shop.trace("$.product.helper.updateInput name",
[c]))}},count:function(a){var c=0,d;for(d in a)a.hasOwnProperty(d)&&c++;return c},loadScript:function(b){var c=b.replace(/^.*\//,""),d=10;a.product.ajax.cached[c]||a.ajax({url:wa_url+b,dataType:"script",cache:!0,complete:function(e,f){"success"==f?(a.product.ajax.cached[c]=!0,a.shop.trace("$.product.helper.loadScript loaded",[c,b])):(a.shop.trace("$.product.helper.loadScript error",[f,c]),d-=1,0<d&&setTimeout(function(){a.product.helper.loadScript(b)},200))}})}},multiSkus:function(b){var c=a("#s-product-edit-forms .s-product-form.main table.s-product-skus:first");
1<b?(c.find("thead tr").show(),c.find(".s-name,.s-sku-sort").show("slow"),2==b?c.find("> tbody:first > tr:first .s-name :input").focus():c.find("> tbody:first > tr:last .s-name :input").focus()):(c.find("thead tr").hide(),c.find(".s-name,.s-sku-sort").hide())},editTabMainSkuAdd:function(){try{var b=a("#s-product-edit-forms .s-product-form.main table.s-product-skus:first").find("tbody:first"),c=0;b.find(':input[name$="[price]"]').each(function(){c=Math.max(c,parseFloat(a(this).val())||0)});var d=0;
b.find(':input[name$="[purchase_price]"]').each(function(){d=Math.max(d,parseFloat(a(this).val())||0)});a.product.multiSkus(b.find("tr:not(.js-sku-settings)").length+1);var e={id:--a.product.editTabMainData.sku_id,sku:"",available:1,name:"",price:""+c,purchase_price:""+d,stock_icon:{"0":"<i class='icon10 status-green' ></i>"},stock:{},count:null};a.shop.trace("$.product.editTabMainSkuAdd",[a.product.editTabMainData.sku_id,e]);b.append(tmpl("template-sku-edit",{sku_id:a.product.editTabMainData.sku_id,
sku:e,stocks:this.getData("main","stocks")}));b.find(".s-product-currency").trigger("change")}catch(f){a.shop.error(f.message,f)}return!1},editTabMainSkuSort:function(b,c,d){try{a.post("?module=product&action=skuSort",{product_id:this.path.id,sku_id:b,after_id:c},function(b){a.shop.trace("$.product.editTabMainSkuSort result",b);b.error&&(a.shop.error("Error occurred while sorting product SKUs","error"),d.sortable("cancel"))},function(b){a.shop.trace("$.product.editTabMainSkuSort cancel",{data:b});
d.sortable("cancel");a.shop.error("Error occurred while sorting product SKUs","error")})}catch(e){a.shop.error(e.message,e)}return!1},editTabMainProductDelete:function(){var b=a("#s-product-list-delete-products-dialog"),c=b.parent();b.length||(c=a("<div></div>").appendTo("body"));c.load("?module=dialog&action=productsDelete&count=1",function(){a("#s-product-list-delete-products-dialog").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(b){a(this).find(".dialog-buttons i.loading").show();
a.shop.jsonPost("?module=products&action=deleteList",{product_id:[a.product.path.id],get_lists:1},function(c){a.product_list&&a("#s-sidebar").trigger("update",c.data.lists);b.trigger("close");window.location.hash="#/products/"});return!1}})});return!1},editTabMainSkuDelete:function(b,c){var d=a("#s-product-edit-forms .s-product-form.main table.s-product-skus:first").find("tbody:first"),e=c.parents("tbody").find('> tr[data-id="'+b+'"]'),f=this;0<b?1<c.parents("tbody").find('tr[data-id]:not(.js-sku-settings):not([data-id^="-"])').length?
a.ajax({url:"?module=product&action=skuDelete",data:{sku_id:b,product_id:this.path.id},dataType:"json",type:"post",success:function(c){"fail"==c.status?f.refresh("error",c.errors):c.data.redirect?window.location.href=c.data.redirect:(f.refresh("success",c.data.message||"Success"),e.hide("normal",function(){e.remove();a('#s-product-view table.s-product-skus > tbody > tr[data-id="'+b+'"]').remove();a.product.multiSkus(d.find("tr:not(.js-sku-settings)").length)}),a("#s-product-edit-forms .s-product-form.main").find("input[name=product\\[sku_id\\]][value="+
...
{sku_id:b,sku:e}))).done(function(){var c;c="?module=product&action=skuSettings&product_id="+f.path.id;c+="&sku_id="+b;var e=a('#s-product-edit-forms .s-product-form.main tr.js-sku-settings[data-id="'+b+'"] > td:first');e.load(c,function(){d.find(':input[name$="[available]"]').remove();if(0<b){a.shop.trace("fileupload",[e.find(".fileupload").length,typeof e.find(".fileupload").fileupload]);try{var c=document.cookie.match(/(?:^|; )_csrf=([^;]*)/),f=c?decodeURIComponent(c[1]):"";e.find(".fileupload:first").fileupload({dropZone:null,
url:"?module=product&action=skuEproductUpload",acceptFileTypes:/(\.|\/)(gif|jpe?g|png)$/i,start:function(){e.find(".fileupload:first").hide()},progress:function(b,c){a.shop.trace("fileupload progress",c);var d=e.find(".js-progressbar-container");d.show();d.find(".progressbar-inner:first").css("width",Math.round(100*c.loaded/c.total,0)+"%")},done:function(b,c){a.shop.trace("fileupload done",[c.result,typeof c.result]);var f=(c.result.files||[]).shift();e.find(".js-progressbar-container").hide();if(!f||
f.error)e.find(".error-message").text(f.error).show(),e.find(".fileupload:first").addClass("error").show();else{var g=e.find(".s-sku-attachment");g.find("input.s-input-file-name").val(f.name);g.find(".s-file-name").text(f.name);g.find(".s-file-size").text(f.size);g.find(".s-file-description").val("");g.find("input[type=checkbox]").attr("checked",!0);g.show();d.find("input.s-input-virtual").val(0)}},fail:function(b,c){a.shop.trace("fileupload fail",[c.textStatus,c.errorThrown]);e.find(".error-message").text("error").show().text(c.errorThrown||
"error");e.find(".js-progressbar-container").hide();e.find(".fileupload:first").addClass("error").show()},formData:{product_id:a.product.path.id,sku_id:b,_csrf:f}})}catch(g){a.shop.error("Exception "+g.message,g)}}})})},editTabMainSkuImageSelect:function(b,c,d){var b=d.parents("li:first"),e=b.hasClass("selected"),f=d.parents("div.value:first");f.find("ul.s-product-image-crops li.selected").removeClass("selected");e?f.find('input[name$="[image_id]"]').val(0):(b.addClass("selected"),f.find('input[name$="[image_id]"]').val(c));
...
a.parents("form").find(':input[name="product[type_id]"]').parents(".value");"main"==this.path.tab?a.hide():(c.find(".js-action").hide(),window.location.hash="/product/"+this.path.id+"/"+this.path.mode+"/");c.find(".js-type-name").hide();c.find(":input").show().focus();setTimeout(function(){c.find(":input").focus()},100)},getSkyType:function(){var b=a(this.options.form_selector),c=b.find('input[name="product[sku_type]"]:first'),d="";return d=c.is(":radio")?b.find('input[name="product[sku_type]"]:checked').val():
c.val()},editTabMainTypeChange:function(b){var c=b.parents(".value"),d=b.find(":selected:first"),e=d.val();a.shop.trace("debug",b);e!=c.data("type")?(c.find(".js-type-icon").html(d.data("icon")),c.find(".js-type-name").html(d.text()),a("#s-product-edit-forms .s-product-form.features").length&&"undefined"!=typeof this.editTabFeaturesReload?this.editTabFeaturesReload(e):(b=a("#s-product-edit-menu > li.features > a"),b.attr("href",b.attr("href").replace(/\/features\/.*$/,"/features/"+e+"/")))):(b=a("#s-product-edit-menu > li.features > a"),
b.attr("href",b.attr("href").replace(/\/features\/.*$/,"/features/")));var e=a.product.getSkyType(),f=a("#s-sku-type-field-group .s-base-price-selectable-currency").contents();a.get("?module=product&action=featuresSelectable&id="+a.product.path.id,{type_id:d.val(),sku_type:e},function(b){var c=a("<div></div>");c.html(b);c.find(".s-base-price-selectable-currency").append(f);a("#s-sku-type-field-group").replaceWith(a("#s-sku-type-field-group",c));a("#s-product-feature-superposition-field-group").replaceWith(a("#s-product-feature-superposition-field-group",
c));a.product.featureSelectableInit()})},editTabMainUpdate:function(b,c,d){var e=a("#s-product-edit-forms .s-product-form.main table.s-product-skus tbody"),f=a("#s-product-view table.s-product-skus tbody");e.find('tr[data-id^="-"]').remove();f.find('tr[data-id^="-"]').remove();e.parents("table").find("tr:hidden").show();var g=[],h;for(h in b.skus||{})g.push(a.extend({id:h},b.skus[h]));g=g.sort(function(a,b){return a.sort-b.sort});h="";for(var i=0,j=g.length;i<j;i+=1)h+=tmpl("template-sku-edit",{sku_id:g[i].id,
sku:g[i],stocks:this.getData("main","stocks"),checked:g[i].id==b.sku_id});e.html(h);e.find("select.s-product-currency").val(b.currency);e.parent().show();this.multiSkus(e.find("tr:not(.js-sku-settings)").length);h="";i=0;for(j=g.length;i<j;i+=1)h+=tmpl("template-sku",{sku_id:g[i].id,sku:g[i],stocks:this.getData("main","stocks")});f.html(h);(!d||"new"==d)&&e.parents("div.field-group:first").after(a("#s-sku-type-field-group"));c&&(d=a("#s-product-feature-superposition .superposition-count"),d.find(".options").text(c.options),
...
e=0;h.find("i").removeClass("star star-hover").addClass("star-empty").each(function(){e++;a(this).removeClass("star-empty").addClass("star");if(this==c){if(d!=e){h.attr("data-rate",e);g.onUpdate(e)}return false}});return false}});if(g.withClearAction){var b="clear-"+a(this).attr("id"),i=a("#"+b);i.length||(h.after('<a href="javascript:void(0);" class="inline-link rate-clear" id="'+b+'" style="display:none;"><b><i>'+$_("clear")+"</b></i></a>"),i=a("#"+b));i.click(function(){if(!g.hold.call(h)){var a=
h.attr("data-rate");e.call(h,0);if(a!==0)g.onUpdate(0)}});var j;h.parent().mousemove(function(){if(!g.hold.call(h)){j&&clearTimeout(j);i.show(0)}}).mouseleave(function(){j=setTimeout(function(){g.hold.call(h)||i.hide(0)},150)})}this.unbind("clear").bind("clear",function(){e.call(h,0)});this.data("inited",!0);return this}}}})(jQuery);(function(a){a.product_reviews={container:null,sidebar_counter:null,statuses:{},form:null,hotkeys:{"alt+enter":{ctrl:!1,alt:!0,shift:!1,key:13},"ctrl+enter":{ctrl:!0,alt:!1,shift:!1,key:13},"ctrl+s":{ctrl:!0,alt:!1,shift:!1,key:17}},options:{},init:function(b){this.options=b;this.statuses=b.statuses;b.product_id&&(this.product_id=b.product_id);this.form=a("#s-review-add-form");this.sidebar_counter=a("#s-all-reviews").find(".count");b.container&&(this.container="object"===typeof b.container?b.container:
...
else{var f=a("input[name=parent_id]",a.product_reviews.form),g=a.product_reviews.form.parents(".s-review:first").parent("li"),h=b.data.html,i=a("ul:first",g),j=a.product_reviews.container;g.length||(j.show(),i=a("ul:first",j).show());i.length||(i=a('<ul class="menu-v with-icon"></ul>'),g.append(i));i.append(a('<li data-id="'+b.data.id+'" data-parent-id="'+b.data.parent_id+'"></li>').append(h));a("textarea",a.product_reviews.form).val("");g=a("#s-review-add");g.find("form").length||(g.append(a.product_reviews.form),
