...
initReview:function(b){var c=a(document),d=b.$wrapper,e=d.data("id"),f=b.locales,g=b.urls,h=!1;d.on("click",".js-show-image",function(k){k.preventDefault();k=a(this);var m=[];d.find(".js-show-image").each(function(){var l=a(this),n=m,p=n.push,t=l.attr("href");l=l.attr("title");l=a("<div />").text(l).html();p.call(n,{href:t,title:l})});(k=k.closest(".s-image-wrapper").prevAll(".s-image-wrapper").length)&&(m=m.slice(k).concat(m.slice(0,k)));a.swipebox(m,{useSVG:!1,hideBarsDelay:!1,afterOpen:function(){function l(){var n=
a("#swipebox-close");n.length&&n.trigger("click");c.off("scroll",l)}c.on("scroll",l)}})});d.on("click",".js-delete-image",function(k){k.preventDefault();var m=a(this).closest(".s-image-wrapper");k=m.data("image-id");!h&&confirm(f.confirm)&&(h=!0,a.post(g["delete"],{review_id:e,image_id:k},"json").always(function(){h=!1}).done(function(){m.remove()}))})},initLazyLoad:function(b){var c=b.count,d=b.total_count,e=b.url||"?module=reviews",f=a(b.target||".s-reviews:first ul:first");a(window).lazyLoad("stop");
...
a.product_reviews.form),g=a.product_reviews.form.parents(".s-review:first").parent("li"),h=e.data.html,k=a("ul:first",g),m=a.product_reviews.container;g.length||(m.show(),k=a("ul:first",m).show());k.length||(k=a('<ul class="menu"></ul>'),g.append(k));k.append(a('<li data-id="'+e.data.id+'" data-parent-id="'+e.data.parent_id+'"></li>').append(h));a("textarea",a.product_reviews.form).val("");g=a("#s-review-add");g.find("form").length||(g.append(a.product_reviews.form),f.val(0));d.length&&d.text(parseInt(d.text(),
