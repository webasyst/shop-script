...
typeof this[b]},tabIsLoaded:function(a){return b("#s-product-edit-forms").find(".s-product-form."+a.tab).length?!0:!1},call:function(a,c,d){d=null;var e=this.isCallable(a);c=c||[];b.shop.trace("$.product.call",[a,c,e]);if(e)try{d=this[a].apply(this,c)}catch(f){b.shop.error("Error at method $.product."+a+". Original message: "+f.message,f)}return d},load:function(a){var c=this.get("container");if(!c.length||c.data("product-id")!=a.id){var d=this;c="?module=product&id="+a.id;b.shop.trace("$.product.load product",
...
b("#s-toolbar").show().animate({width:"200px"});b("#maincontent").animate({"margin-top":"84px"},"fast");b("#s-content").animate({"margin-left":b.product.options.sidebar_width},"fast")},saveData:function(a,c,d){var e=this,f=e.get("form"),g="radio",h=f.find('input[name="product[sku_type]"]:first');if(h.is(":radio")){var k=f.find('input[name="product[sku_type]"]:checked').val();h=f.find('input[name="product[sku_type]"]')}else g="hidden",k=f.find('input[name="product[sku_type]"]:not(:disabled)').val();
if("1"==k&&!b("#s-product-feature-superposition").find("input:checked:first").length)return"radio"==g&&(h.filter("[value=0]").attr("checked",!0),b.product.onSkuTypeChange(0)),!1;if(e.ajax.save)return setTimeout(function(){e.saveData(a,c,d)},100),!1;if(this.path.tab&&(k="editTab"+this.path.tab.substr(0,1).toUpperCase()+this.path.tab.substr(1)+"Save",!1===this.call(k)))return!1;e.ajax.save=!0;b("#s-product-description-content").length&&b("#s-product-description-content").waEditor("sync");f.find(".s-price").find("input").each(function(){this.value=
...
this.refresh("submit");this.clearValidateErrors();b.ajax({url:b(f).attr("action"),data:b(f).serializeArray(),dataType:"json",type:"post",success:function(f){if("fail"==f.status)e.showValidateErrors(f.errors)||e.refresh("error",f.errors);else if(f.data.redirect)b.shop.trace("$.product.saveData redirect",f.data.redirect),window.location.href=f.data.redirect;else{e.refresh("success",f.data.message||"");b.shop.trace("$.product.saveData updateData",[a,c]);e.updateData(f.data,a,c);d&&"function"==typeof d&&
d();if(e.path.tab&&(f="editTab"+e.path.tab.substr(0,1).toUpperCase()+e.path.tab.substr(1)+"Saved",!1===e.call(f)))return!1;b.each(e.standalone_tabs,function(b,a){e.path.tab!=a&&(b="editTab"+a.substr(0,1).toUpperCase()+a.substr(1)+"Saved",e.call(b))})}e.ajax.save=!1},error:function(b,a,c){e.ajax.save=!1;e.refresh("error",a)}});return!1},showValidateErrors:function(a){a=a||{};if(b.isEmptyObject(a))return!1;var c=this,d=!1,e=c.$edit_forms;if(a.features&&a.features.gtin){var f=e.find(".s-product-form.features").find('input[name="product[features][gtin]"]');
if(f.length){f.addClass("error js-validate-error-input");var g=b('<div class="errormsg js-validate-error-msg"></div>').text(a.features.gtin);f.after(g);d=!0;c.refresh("error",$_("Save GTIN feature for product is fail"))}}if(a.skus){var h=e.find(".s-product-form.main table.s-product-skus tbody");b.each(a.skus,function(a,e){e.features&&e.features.gtin&&(a=h.find('.js-sku-settings[data-id="'+a+'"]').find('input[name="'+("skus["+a+"][features][gtin]")+'"]'),a.length&&(a.addClass("error js-validate-error-input"),
e=b('<div class="errormsg js-validate-error-msg"></div>').text(e.features.gtin),a.after(e),d=!0,c.refresh("error",$_("Save GTIN feature for SKU is fail"))))})}return d},clearValidateErrors:function(){var b=this.$edit_forms,c=b.find(".s-product-form.main table.s-product-skus tbody");b=b.find(".s-product-form.features");c.find(".js-validate-error-input").removeClass("error");c.find(".js-validate-error-msg").remove();b.find(".js-validate-error-input").removeClass("error");b.find(".js-validate-error-msg").remove()},
updateData:function(a,c,d){b.shop.trace("$.product.updateData("+c+","+d+")",a);var e=b("#s-product-edit-forms .s-product-form.main"),f=this.path.id;if(this.path.id&&"new"!=this.path.id)this.path.id!=a.id&&b.shop.error("Abnormal product ID change",[this.path.id,a]);else{this.path.id=a.id;b(this.options.container_selector).data("product-id",this.path.id);var g="/product/"+this.path.id+"/";null!==c&&(c=c||this.path.mode||"profile")&&("profile"!=c&&(g+=c+"/"),null!==d&&(d=d||this.path.tab||"")&&"main"!=
d.toLowerCase()&&(g+=d+"/"));b.shop.trace("update location.hash="+g);var h=/#\/product\/new\//,k="#/product/"+this.path.id+"/";b("#shop-productprofile, #s-product-edit-menu, #s-product-edit-forms, #s-product-profile-page").find('[href*="#/product/new/"]').each(function(){b(this).attr("href",b(this).attr("href").replace(h,k))});b("#s-product-edit-forms").find(':input[name="product\\[id\\]"]').val(this.path.id);window.location.hash=g}c=b("#shop-productprofile h1");c.find(".s-product-name:first").text(a.name);
c.find(".s-product-id").show().text("id: "+a.id);document.title=a.name+b.product.options.title_suffix;b("#product-stock-stat").html(tmpl("template-product-stock-stat",a.raw));e.find(':input[name="product\\[type_id\\]"]').parents(".value").data("type",a.type_id);if(b.isEmptyObject(a.frontend_urls))b(".s-product-frontend-url-not-empty").hide(),b(".s-product-frontend-url-empty").show();else{c=b("#s-product-frontend-url");c.text(a.url);b("#s-product-frontend-url-input").val(a.url);c.trigger("readable");
d=c.parent();d.attr("href",a.frontend_urls[0].url);d.find("span:first").text(a.frontend_urls[0].base);c.closest("div.value").find(".s-product-frontend-url").each(function(c){a.frontend_urls[c+1]&&b(this).attr("href",a.frontend_urls[c+1].url).text(a.frontend_urls[c+1].url)});b(".s-product-frontend-url-not-empty").show();b(".s-product-frontend-url-empty").hide();c="";d=0;for(g=a.frontend_urls.length;d<g;d+=1)c+=' <span class="s-product-frontend-url-not-empty"><a href="'+a.frontend_urls[d].url+'" target="_blank">'+
a.frontend_urls[d].url+'</a><i class="icon10 new-window"></i></span> ';c&&b("#s-product-frontend-links").find(".s-product-frontend-url-not-empty").wrapAll("<div></div>").closest("div").replaceWith(c)}this.editTabMainUpdate(a.raw||{},a.features_selectable_strings,f);e.find("select.s-product-categories").each(function(){var c=b(this),d=c.parent(),e=c.val();if("select"==e||"---"==e){var f=b("#s-product-edit-forms .s-product-form.main select.s-product-categories");1<f.length?d.remove():d.find(".s-product-delete-from-category").hide()}else if("create"==
e){var g=d.find("input.val").val();"0"==g?(f=b("#s-product-edit-forms .s-product-form.main select.s-product-categories"),1<f.length?d.remove():(c.val(g),c.show().attr("disabled",!1),d.find("input.val").attr("disabled",!0),d.find(".s-new-category").hide(),d.find(".s-product-delete-from-category").hide())):(c.val(g),c.show().attr("disabled",!1),d.find("input.val").attr("disabled",!0),d.find(".s-new-category").hide(),d.find(".s-product-delete-from-category").show())}e=parseInt(e,10);if(!b.isEmptyObject(a.storefront_map[e])){c=
"";e=a.storefront_map[e];for(f=0;f<e.length;f+=1)c+='<a class="hint" href="'+e[f]+'" target="_blank">'+e[f]+"</a> ";d.find(".s-storefront-map").html(c)}});b("#s-product-categories").html(tmpl("template-product-categories",{categories:a.categories||[]}));b("#s-product-tags").html(tmpl("template-product-tags",{tags:a.tags||[]}));b("#s-product-save table.s-product-skus > tbody > tr").each(function(){var c=b(this).data("id");b(this).find("td.s-stock .s-product-stock-icon").each(function(){var d=b(this).data("stock");
a.raw&&a.raw.skus&&a.raw.skus[c]&&a.raw.skus[c].stock_icon[d]&&b(this).html(a.raw.skus[c].stock_icon[d])})});e.find("tr.js-sku-settings").each(function(){var c=b(this),d=c.attr("data-id");(d=a.raw.skus[d])&&void 0!==d.file_name&&!d.file_name&&(c.find(".s-sku-attachment").hide(),c.find(".fileupload").show())});this.helper.checkChanges(this.get("form"),!0);b("#s-product-edit-menu li a i.icon10.status-yellow-tiny").remove();this.helper.updateSubmitButton(!1);"0"==a.raw.sku_type&&(e=b("#s-product-feature-superposition"),
e.find("input[type=checkbox]").attr("checked",!1),f=e.find("ul.features li"),f.find(".count").text(""),f.find("i").removeClass("status-blue-tiny status-gray-tiny").addClass("status-gray-tiny"),e=e.find(".superposition-count"),e.find(".options").text(""),e.find(".skus").text(""));b("#s-product-meta-title").attr("placeholder",a.default_meta_title);b("#s-product-meta-keywords").attr("placeholder",a.default_meta_keywords);b("#s-product-meta-description").attr("placeholder",a.default_meta_description);
b('#s-product-profile-tabs .s-tab-block[data-tab="stock-logs"]').trigger("refresh");this.setData("main","category_name",a.category_name)},refresh:function(a,c){b(this.options.form_selector).find(':input[name^="product\\["]:disabled.js-ajax-disabled').each(function(){b(this).removeAttr("disabled").removeClass("js-ajax-disabled")});var d=b(this.options.message_selector);d.removeClass("errormsg successmsg status").empty().show();this.timer&&clearTimeout(this.timer);var e=null;d.append(this.message[a]||
"");switch(a){case "submit":d.addClass("status");break;case "error":d.addClass("errormsg");for(a=0;a<c.length;a++)d.append(c[a][0]);e=2E4;break;case "success":c&&d.addClass("successmsg").append(c),e=3E3,this.helper.updateSubmitButton(!1)}e&&(this.timer=setTimeout(function(){d.removeClass("errormsg successmsg status").empty().show()},e))},editTabLoad:function(a,c){var d=this,e=b("#s-product-edit-forms .s-product-form."+a.tab);!0===c||!e.length&&"new"==a.id?(b.shop.trace("product.editTabLoad: create",
[a.tab+" \u2014 create",a,c]),this.saveData(this.path.mode,a.tab,function(){a.tab&&d.call(a)})):this.editTabLoadContent(a)},editTabLoadContent:function(a,c){var d=this;a=a||this.path;var e="?module=product&action="+a.tab+"&id="+a.id;a.tail&&(e+="&param[]="+a.tail.split("/").join("&param[]="));var f=Math.random();this.ajax.random=f;var g=b("#s-product-edit-forms .s-product-form."+a.tab);g.length&&g.remove();b("#s-product-edit-forms > form").append(tmpl("template-productprofile-tab",{id:a.tab}));g=
b("#s-product-edit-forms .s-product-form."+a.tab);this.ajax.target=g;this.ajax.link=b("#s-product-edit-menu li."+a.tab);b.shop.trace("$.product.editTabLoadContent",[a,e,a.params]);if(a.params&&c){var h=typeof a.params;switch(h){case "String":e+=a.params;break;case "Array":e+=a.params.serialize();break;default:b.shop.error("unexpected type "+h,a.params)}}b.ajax({url:e,type:c?"POST":"GET",data:c?c||{}:a.params||{},success:function(c,e){b.shop.trace("$.product.loadTab status="+e);if(d.ajax.random==f){g.empty().append(c);
...
e.path.id;c+="&sku_id="+a;c+="&type_id="+e.helper.type();var g=b('#s-product-edit-forms .s-product-form.main tr.js-sku-settings[data-id="'+a+'"] > td:first');g.load(c,function(){d.find(':input[name$="[available]"]').remove();b.product_images&&b.product_images.options&&b.product_images.options.enable_2x&&b.fn.retina&&g.find(".s-product-image-crops img").retina();b.product.initFeatureDate();if(0<a){b.shop.trace("fileupload",[g.find(".fileupload").length,typeof g.find(".fileupload").fileupload]);try{var c=
document.cookie.match(/(?:^|; )_csrf=([^;]*)/),e=c?decodeURIComponent(c[1]):"";g.find(".fileupload:first").fileupload({dropZone:null,url:"?module=product&action=skuEproductUpload",acceptFileTypes:/(\.|\/)(gif|jpe?g|png)$/i,start:function(){g.find(".fileupload:first").hide()},progress:function(a,c){b.shop.trace("fileupload progress",c);a=g.find(".js-progressbar-container");a.show();a.find(".progressbar-inner:first").css("width",Math.round(100*c.loaded/c.total,0)+"%")},done:function(a,c){b.shop.trace("fileupload done",
[c.result,typeof c.result]);a=(c.result.files||[]).shift();g.find(".js-progressbar-container").hide();!a||a.error?(g.find(".error-message").text(a.error).show(),g.find(".fileupload:first").addClass("error").show()):(c=g.find(".s-sku-attachment"),c.find("input.s-input-file-name").val(a.name),c.find(".s-file-name").text(a.name),c.find(".s-file-size").text(a.size),c.find(".s-file-description").val(""),c.find("input[type=checkbox]").attr("checked",!0),c.show(),d.find("input.s-input-virtual").val(0))},
fail:function(a,c){b.shop.trace("fileupload fail",[c.textStatus,c.errorThrown]);g.find(".error-message").text("error").show().text(c.errorThrown||"error");g.find(".js-progressbar-container").hide();g.find(".fileupload:first").addClass("error").show()},formData:{product_id:b.product.path.id,sku_id:a,_csrf:e}})}catch(l){b.shop.error("Exception "+l.message,l)}}})})},editTabMainSkuImageSelect:function(a,c,d){a=d.parents("li:first");var e=a.hasClass("selected"),f=d.parents("div.value:first");f.find("ul.s-product-image-crops li.selected").removeClass("selected");
...
h=b("#s-category-list-block"),k=b("#s-set-list"),l=b("#s-set-list-block"),n=function(){function c(){if(!n){var c=b("#s-category-list-handler");v=b.categories_tree.isCollapsed(c);p=g.is(":hidden");var k=b('<div id="s-category-list-dummy" class="block"></div>').css({height:h.height()});h.replaceWith(k);f.show().append(h.hide());h.find(".heading").before('<span class="hint float-right" style="margin-top: 3px;">'+$_("Drag products here")+"</span>");v&&b.categories_tree.expand(c,null,function(){b.categories_tree.collapse(c)});
p||g.hide();h.show();b("i.add",h).hide();b("#s-category-list-handler").hide();h.css({"overflow-x":"hidden","overflow-y":"auto"});(function(){var b=g.is(":hidden"),c;h.bind("mousemove.fixed_blocks.category",function(d){document.getElementById("products-helper")&&b&&(c&&(clearTimeout(c),c=null),c=setTimeout(function(){if(b){h.css({height:""});g.show();var c=h.height(),d=(e.height()-a)/2;h.css({height:Math.min(c,d)});h.find(".heading").prev(".hint").hide();b=!1}},250))});e.bind("mouseout.fixed_blocks.category",
function(a){a.pageX>d+10&&(c&&clearTimeout(c),c=null,b||(g.hide(),h.css({height:""}),h.find(".heading").prev(".hint").show(),b=!0))})})();n=!0}}function k(){if(n){var a=b("#s-category-list-dummy");a.replaceWith(h);h.css({"overflow-x":"","overflow-y":""});var c=b("#s-category-list-handler");v&&b.categories_tree.collapse(c);p||g.show();h.find(".heading").prev(".hint").remove();b("#s-category-list-handler").show();b("i.add",h).show();a.remove();h.unbind("mousemove.fixed_blocks.category");e.unbind("mouseout.fixed_blocks.category");
f.children().length||f.hide();n=!1;b.categories_tree.init()}}var l=h.offset().top,n=!1,p,v;e.unbind("scroll.fixed_blocks.category").bind("scroll.fixed_blocks.category",function(){n||(l=h.offset().top);var d=l;d=document.getElementById("s-category-list-dummy")?d+b("#s-category-list-dummy").height():d+b("#s-category-list-block").height();e.scrollTop()+a+5>=d?c():k()});return{setFixed:c,unsetFixed:k}}(),p=function(){function c(){if(!p){n=k.is(":hidden");var c=b('<div id="s-set-list-dummy" class="block"></div>').css({height:l.height()});
l.replaceWith(c);f.show().append(l);l.find(".heading").before('<span class="hint float-right" style="margin-top: 3px;">'+$_("Drag products here")+"</span>");n||k.hide();b("i.add",l).hide();b("i.collapse-handler",l).hide();l.css({"overflow-x":"hidden","overflow-y":"auto"});(function(){var b=k.is(":hidden"),c;l.bind("mousemove.fixed_blocks.set",function(d){document.getElementById("products-helper")&&b&&(c&&(clearTimeout(c),c=null),c=setTimeout(function(){if(b){l.css({height:""});k.show();var c=l.height(),
...
l.unbind("mousemove.fixed_blocks.category");e.unbind("mouseout.fixed_blocks.category");f.children().length||f.hide();p=!1}}var h=l.offset().top,n,p=!1;e.unbind("scroll.fixed_blocks.set").bind("scroll.fixed_blocks.set",function(){p||(h=l.offset().top);var d=h;d=document.getElementById("s-set-list-dummy")?d+b("#s-set-list-dummy").height():d+b("#s-set-list-block").height();e.scrollTop()+a+5>=d?c():g()});return{setFixed:c,unsetFixed:g}}();return{category:n,set:p}},initEditingControls:function(){var a=
