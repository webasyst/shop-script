...
c=b.data("edit-rights");(!c||b.data("min-price")!=b.data("max-price"))&&b.find(".s-product-price .editable").addClass("not-editable");(!c||1!=b.data("sku-count"))&&b.find(".s-product-stock .editable").addClass("not-editable")})},initInlineEditor:function(){function b(a,b){if(a.data("denied-reason")==b)a.data("denied-reason",""),alert(b);else{a.data("denied-reason",b);setTimeout(function(){a.data("denied-reason","")},3E3);a.wrapInner('<div class="animation-container" style="position:relative;"></div>');
var e=a.find(".animation-container").animate({left:"3px"},100,function(){e.animate({left:"0px"},100,function(){e.animate({left:"3px"},100,function(){e.animate({left:"0px"},100,function(){e.children().first().unwrap()})})})})}}a.product_list.highlightInlineEditorCells();a.product_list.container.on("append_product_list",function(){a.product_list.highlightInlineEditorCells()});a.product_list.container.on("click",".s-product-price,.s-product-stock",function(){function c(){if(f)d.html(tmpl("template-list-price-editor-one",
{product_id:e.data("product-id"),currency:e.data("currency"),value:e.data("original-price")}));else{var b=e.data("stocks");!b||"object"!=typeof b?d.html(tmpl("template-list-stock-editor-one",{product_id:e.data("product-id"),value:b||""})):d.html(tmpl("template-list-stock-editor-many",{product_id:e.data("product-id"),values:b}))}d.find(".cancel").click(function(){var a=d;a.removeClass("editor-on").html(a.data("read-only-state-html"));a.data("read-only-state-html","");a.data("denied-reason","")});var c=
d.find("form").submit(function(){if(c.find(".loading").length)return!1;c.find(":submit").after('<i class="icon16 loading"></i>');a.post("?module=products&action=inlineSave",c.serialize(),function(b){c.find(".loading").remove();try{b.data&&b.data[0]&&(b.data[0].alien=e.hasClass("s-alien"));var d=a("<table>").html(tmpl("template-product-list-table",{products:b.data,check_all:a.product_list.container.find(".s-select-all:first").prop("checked"),sort:a.product_list.sort}));e.replaceWith(d.find("tr"));
self.container.trigger("append_product_list",[b.data])}catch(f){console.log("Error: "+f.message)}},"json");return!1});c.on("dblclick",!1);setTimeout(function(){d.find(":input:visible:first").focus()},0)}var d=a(this),e=d.closest("tr"),f=d.hasClass("s-product-price");if(f){if(e.data("min-price")!=e.data("max-price"))return b(d,$_("Inline editing is available only for products with a single SKU"))}else if("1"!=e.data("sku-count"))return b(d,$_("Inline editing is available only for products with a single SKU"));
if(!e.data("edit-rights"))return b(d,$_("Insufficient access rights"));if(!d.hasClass("editor-on"))if(d.addClass("editor-on").data("read-only-state-html",d.html()),a.product_list.container.removeClass("single-lined"),void 0!==e.data("original-price"))c();else{d.html('<i class="icon16 loading"></i>');var g=[];a.product_list.container.find("tr.product").each(function(){var b=a(this);void 0===b.data("original-price")&&b.data("edit-rights")&&g.push(a(this).data("product-id"))});g.length?a.post("?module=products&action=inlineEditorData",
{ids:g},function(b){b.data&&a.product_list.container.find("tr.product").each(function(){var c=a(this),d=b.data[parseInt(c.data("product-id"),10)];d&&(c.data("stocks",d.stocks||null),c.data("original-price",d.price.replace(/\.?0+$/g,"")))});c()},"json"):c()}})},initFixedBlocks:function(){var b=a("#mainmenu").height(),c=a("#s-sidebar").width(),d=a(window),e=a("#s-fixed-blocks");e.length||(e=a('<div id="s-fixed-blocks"></div>').css({display:"none",position:"fixed",background:"#fff",top:b,width:c,"float":"left"}).appendTo("#s-sidebar"));
var f=a("#s-category-list"),g=a("#s-category-list-block"),h=a("#s-set-list"),j=a("#s-set-list-block"),k,m=function(){if(!n){var h=a("#"+o);s=a.categories_tree.isCollapsed(h);q=f.is(":hidden");var j=a('<div id="'+p+'" class="block"></div>').css({height:g.height()});g.replaceWith(j);e.show().append(g.hide());g.find(".heading").before('<span class="hint float-right" style="margin-top: 3px;">'+$_("Drag products here")+"</span>");s&&a.categories_tree.expand(h,null,function(){a.categories_tree.collapse(h)});
q||f.hide();g.show();a("i.add",g).hide();a("#"+o).hide();g.css({"overflow-x":"hidden","overflow-y":"auto"});var k=f.is(":hidden"),i;g.bind("mousemove.fixed_blocks.category",function(){document.getElementById("products-helper")&&k&&(i&&(clearTimeout(i),i=null),i=setTimeout(function(){if(k){g.css({height:""});f.show();var a=g.height(),c=(d.height()-b)/2;g.css({height:Math.min(a,c)});g.find(".heading").prev(".hint").hide();k=false}},250))});d.bind("mouseout.fixed_blocks.category",function(a){a.pageX>
c+10&&(i&&clearTimeout(i),i=null,k||(f.hide(),g.css({height:""}),g.find(".heading").prev(".hint").show(),k=!0))});n=!0}},l=function(){if(n){var b=a("#"+p);b.replaceWith(g);g.css({"overflow-x":"","overflow-y":""});var c=a("#"+o);s&&a.categories_tree.collapse(c);q||f.show();g.find(".heading").prev(".hint").remove();a("#"+o).show();a("i.add",g).show();b.remove();g.unbind("mousemove.fixed_blocks.category");d.unbind("mouseout.fixed_blocks.category");e.children().length||e.hide();n=!1;a.categories_tree.init()}},
i=g.offset().top,p="s-category-list-dummy",o="s-category-list-handler",n=!1,q,s;d.unbind("scroll.fixed_blocks.category").bind("scroll.fixed_blocks.category",function(){n||(i=g.offset().top);var c=i,c=document.getElementById(p)?c+a("#"+p).height():c+a("#s-category-list-block").height();d.scrollTop()+b+5>=c?m():l()});k={setFixed:m,unsetFixed:l};var t=function(){if(!u){r=h.is(":hidden");var f=a('<div id="'+v+'" class="block"></div>').css({height:j.height()});j.replaceWith(f);e.show().append(j);j.find(".heading").before('<span class="hint float-right" style="margin-top: 3px;">'+
$_("Drag products here")+"</span>");r||h.hide();a("i.add",j).hide();a("i.collapse-handler",j).hide();j.css({"overflow-x":"hidden","overflow-y":"auto"});var g=h.is(":hidden"),k;j.bind("mousemove.fixed_blocks.set",function(){document.getElementById("products-helper")&&g&&(k&&(clearTimeout(k),k=null),k=setTimeout(function(){if(g){j.css({height:""});h.show();var a=j.height(),c=(d.height()-b)/2;j.css({height:Math.min(a,c)});j.find(".heading").prev(".hint").hide();g=false}},250))});d.bind("mouseout.fixed_blocks.set",
function(a){a.pageX>c+10&&(k&&clearTimeout(k),k=null,g||(h.hide(),j.css({height:""}),j.find(".heading").prev(".hint").show(),g=!0))});u=!0}},w=function(){if(u){var b=a("#"+v);b.replaceWith(j);j.css({"overflow-x":"","overflow-y":""});j.find(".heading").prev(".hint").remove();r||h.show();a("i.add",j).show();a("i.collapse-handler",j).show();b.remove();j.unbind("mousemove.fixed_blocks.category");d.unbind("mouseout.fixed_blocks.category");e.children().length||e.hide();u=!1}},x=j.offset().top,v="s-set-list-dummy",
r,u=!1;d.unbind("scroll.fixed_blocks.set").bind("scroll.fixed_blocks.set",function(){u||(x=j.offset().top);var c=x,c=document.getElementById(v)?c+a("#"+v).height():c+a("#s-set-list-block").height();d.scrollTop()+b+5>=c?t():w()});return{category:k,set:{setFixed:t,unsetFixed:w}}},initEditingControls:function(){var b=a("#s-product-list-title");b.hasClass("editable")&&(b.inlineEditable({minSize:{width:350},maxSize:{width:600},size:{height:30},inputClass:"s-title-h1-edit",beforeMakeEditable:function(){a(".s-product-list-manage").hide()},
...
c)&&b.unbind("click").bind("click",function(){a.product_list.settingsListDialog();return false});b=a("#s-product-list-delete");b.length&&("category"==c||"set"==c)&&b.unbind("click").bind("click",function(){a("#s-product-list-delete-dialog").waDialog({disableButtonsOnSubmit:true,onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(){function b(a,c){if(!a.length)return c&&c();var f=a.shift();e(["category",f],function(){b(a,c)})}function e(b,c){var d={hash:b.join("/")||
"all",remove:["list"]};h&&d.remove.push("products");var e=function(){a.product_list.remove(d,function(d){var e=b[0],f=a("#"+b.join("-")),g=f.prev(".drag-newposition"),h=a("#s-"+b[0]+"-list"),i=h.find("ul:first");if(e=="set"){f.remove();g.remove()}else{e=f.find("ul:first");if(e.length){e.find(">li.drag-newposition:first").remove();f.hide();e.find(">li").each(function(){f.after(this)})}e=f.parents("ul:first");f.remove();g.remove();if(!e.find("li.dr").length)if(i.get(0)!=e.get(0)){e.parents("li:first").find("i.collapse-handler").remove();
e.closest("li").find(".collapse-handler-ajax:first").remove();e.remove()}else i.closest(".block").find(".collapse-handler-ajax:first").remove()}if(i.find("li.dr:first").length){i.show();h.find(".s-empty-list").hide()}else{i.hide();h.find(".s-empty-list").show()}d.data.old_parent_category&&(typeof d.data.old_parent_category.children_count!=="undefined"&&!parseInt(d.data.old_parent_category.children_count,10))&&a("#category-"+d.data.old_parent_category.id+"-handler").remove();a.product_list.sidebar.trigger("update",
