...
wa_lang+".js");for(var c=0;c<b.length;c++)a.product.helper.loadScript(b[c])},editTabPagesInit:function(){var b=[];b.push("wa-content/js/elrte/elrte.min.js");b.push("wa-content/js/elrte/elrte-wa.js");"en"!=wa_lang&&b.push("wa-content/js/elrte/i18n/elrte."+wa_lang+".js");for(var c=0;c<b.length;c++)a.product.helper.loadScript(b[c])},editorUpdateSource:function(a){waEditorUpdateSource(a);this.description=wa_editor.getValue()},editTabDescriptionsBlur:function(){this.editorUpdateSource({id:"s-product-description-content"})},
editTabDescriptionsAction:function(){var b=10;(function d(){try{if(a.product.ajax.cached["elrte-wa.js"]&&a.product.ajax.cached["elrte.min.js"]){var e=a("#s-product-description");e.html(tmpl("template-product-description",{description:a("#s-product-description-content").val()}));setTimeout(function(){waEditorInit({id:"s-product-description-content",prefix:"s-product-description-",upload_url:"",lang:wa_lang,save_button:"s-product-save-button",change_callback:function(){if("descriptions"==a.product.path.tab)a.product.helper.onTabChanged(a.product.path.tab,
!0)}});var b=e.find("iframe"),d=b.parents(".workzone"),f=d.height(),j=b.contents().find("body").prop("scrollHeight");j>f&&(d.height(j),b.height(j),e.find(".CodeMirror-scroll").height(j))},200)}else b-=1,0<b&&(a.shop.trace("$.product.editTabDescriptionsAction wait while js are loading",a.product.ajax),setTimeout(function(){d()},500))}catch(f){console.error(f.message),console.dir(f.trace)}})()},profileInit:function(){wa_editor&&(wa_editor=void 0);if(this.options.edit_rights){var b=a("#shop-productprofile").find(".s-product-name");
parseInt(this.path.id,10)?b.addClass("editable"):b.removeClass("editable");b.inlineEditable({minSize:{width:150},maxSize:{width:550},inputClass:"s-title-h1-edit",beforeMakeEditable:function(){a("#s-edit-product").hide()},afterBackReadable:function(b,c){a("#s-edit-product").show();if(!c.changed)return!1;a.shop.jsonPost("?module=product&action=save&id="+a.product.path.id,{update:{name:a(b).val()}},function(){document.title=a(b).val()+a.product.options.title_suffix})},hold:function(){return!a(this).hasClass("editable")}})}var c=
