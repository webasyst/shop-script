...
this.paramsFromSession(a);return((a.view?"&view="+a.view:"")+(a.category_id?"&category_id="+a.category_id:"")+(a.set_id?"&set_id="+a.set_id:"")+(a.tag?"&tag="+a.tag:"")+(a.sort?"&sort="+a.sort:"")+(a.order?"&order="+a.order:"")+(a.text?"&text="+a.text:"")+(a.edit?"&edit="+a.edit:"")+(a.hash?"&hash="+a.hash:"")+(a.page?"&page="+a.page:"")+(a.type_id?"&type_id="+a.type_id:"")).slice(1)},productsAction:function(){var b=Array.prototype.join.call(arguments,"/"),b=a.shop.helper.parseParams(b||"");this.list_hash=
this.hash;this.list_params=b;if(a.product_list!==void 0&&a.product_list.fixed_blocks!==void 0){a.product_list.fixed_blocks.set&&a.product_list.fixed_blocks.set.unsetFixed();a.product_list.fixed_blocks.category&&a.product_list.fixed_blocks.category.unsetFixed()}this.load("?module=products&"+this.buildProductsUrlComponent(b),this.checkAlerts)},checkAlerts:function(){var b=a.storage.get("shop/alerts");a(".s-alert").each(function(){a.inArray(a(this).data("alert"),b)==-1&&a(this).show()})},productAction:function(b,
c,d){var e=Array.prototype.slice.call(arguments).filter(function(a){return a.length}).join("/");a.shop.trace("$.products.productAction",[e,arguments]);var f="?module=product";b&&(f=f+("&id="+b));typeof a.product!="undefined"?a.product.dispatch(e):this.load(f,function(){a.product.dispatch(e)})},productTermination:function(){typeof a.product!="undefined"&&a.product.termination()},reviewsAction:function(){this.load("?module=reviews")},stocksAction:function(a){this.load("?module=stocks"+(a?"&order="+
a:""))},stockslogAction:function(a){this.load("?module=stocksLog"+(a?"&"+a:""))},promosAction:function(a){this.load("?module=promos"+(a?"&"+Array.prototype.join.call(arguments,"/"):""))},servicesAction:function(b){this.load("?module=services"+(b?"&id="+b:""),function(){a("#s-content").addClass("bordered-left");typeof a.products.afterServicesAction==="function"&&a.products.afterServicesAction()})},initCollapsible:function(){var b=function(b,e){a(b).removeClass("darr").addClass("rarr");c(b).hide();
if(!e){a.storage.set("shop/products/"+b.id+"/collapse",1);if(e!==false){var f=b.id.replace(/\-handler$/,""),f=a(b).parents("div.block:first").find("#"+f+":first");if(f.length)(f=f.data("on-collapse-url"))&&a.get(f)}}},c=function(b){b=a(b).parent();return b.is("li")?b.find("ul:first"):b.next()};a(".collapse-handler").die("click").live("click",function(){if(a(this).hasClass("darr"))b(this);else{c(this).show();var d=a(this);d.removeClass("rarr").addClass("darr");a.storage.del("shop/products/"+this.id+
"/collapse");var e=this.id.replace(/\-handler$/,""),f=d.parents("div.block:first").find("#"+e+"-placeholder:first");if(f.length){var g=a(this).parents("div.block:first").find(".count:first");g.find("i.icon16.loading").remove();g.find("i.icon16").hide();g.prepend('<i class="icon16 loading"></i>');a.get(f.data("url"),function(b){f.replaceWith(a(b));g.find("i.icon16.loading").remove();g.find("i.icon16").show();f.remove()})}else{d=a(this).parents("div.block:first").find("#"+e+":first");if(d.length)(d=
...
null).attr("disabled","disabled");c?b.show():b.hide()})}else g.show(),g.find("input:checkbox").each(function(a,b){b.checked=b.defaultChecked;b.disabled=null})}});var e=b.find(".superposition-count");if(c.length){e.find(".options").text(c.join(" x ")+" "+$_("options"));for(var f=1,g=0,h=c.length;g<h;g+=1)f*=c[g];e.find(".skus").html('<span class="highlighted">'+$_("%d SKUs in total").replace("%d",f)+"</span>")}else e.find(".options").text(""),e.find(".skus").html("")},editInit:function(){a("#s-product-edit-forms").unbind("keydown.product").bind("keydown.product",
function(b){if(a(b.target).is(":input")&&b.ctrlKey&&83==b.keyCode)return a("#s-product-save-button").click(),!1});a.shop.makeFlexibleInput("s-product-meta-title");if(!this.options.edit_rights)return window.location.hash="#/product/"+this.path.id+"/",!1;var b=a(this.options.form_selector);b.bind("submit.product",function(){return a.product.saveData("profile",null)});b.on("change.product, keyup.product","div.s-product-form:not(.ajax) :input",function(){a.product.helper.onChange(a(this).parents("div.s-product-form"))});
b.on("change.product, keyup.product, keypress.product",':input[name="product[name]"]',function(){a.product.helper.onNameChange(a(this),!1,a.product.options.update_delay||500)});var c=a("#product-tags");c.data("tags_input_init")||(c.tagsInput({autocomplete_url:"?module=product&action=tagsAutocomplete",height:120,onChange:function(){a.product.updateMetaFields()},defaultText:""}).data("tags_input_init",!0),a("#s-product-popular-tags").off("click.product","a").on("click.product","a",function(){var b=
a(this).text();c.removeTag(b);c.addTag(b)}));b.on("change.product",".s-product-currency",function(){var c=a(this).val();b.find(".s-product-currency").val(c);b.find(".s-product-currency-readonly").text(c);a("#s-product-currency-code").val(c)});b.on("change.product",':input[name="product[type_id]"]',function(){return a.product.editTabMainTypeChange(a(this))});b.on("change",'select[name="product[status]"]',function(){if(a(this).val()=="1"){a(this).prev().removeClass("no-bw").addClass("yes");a(".s-product-status-text").hide()}else{a(this).prev().removeClass("yes").addClass("no-bw");
a(".s-product-status-text").show()}});b.on("change",'input[name="product[sku_type]"]',function(){a.product.onSkuTypeChange(this.value)}).change();a.product.featureSelectableInit()},editFocus:function(){var b=this.options.duration,c=this;a("h1 .s-product-edit-link, #mainmenu .s-level2, #s-product-frontend-links").hide();a("#s-sidebar, #s-toolbar").animate({width:0},b).queue(function(){a(this).hide();a(this).dequeue();a("#s-product-edit-menu, #s-product-edit-forms, #s-product-edit-save-panel").show();
"new"!=c.path.id?c.get("container").find(".back").attr("href","#/product/"+c.path.id+"/"):c.get("container").find(".back").attr("href","#/"+a.products.list_hash);a("#s-product-profile-page").hide();c.switchSubMenu("productprofile")});a("#maincontent").animate({"margin-top":"40px"},b);a("#s-content").animate({"margin-left":0},b);a("#shop-productprofile").off("click.edit-product","a.js-action").on("click.edit-product","a.js-action",function(){return c.editClick(a(this))})},editBlur:function(){this.path.tab=
!1;this.path.mode=!1;a(a.product.options.form_selector).off("submit.product");a(this.options.form_selector).off("change.product, keyup.product");a("#s-product-edit-forms").off("click.edit-product")},editAction:function(a){this.path.mode=a.mode},editTabMainData:{sku_id:-1,stocks:{}},editTabMainInit:function(b){a("#s-product-type").each(function(){a(this).parent().get(0)!=document.body&&(a("body > #s-product-type").remove(),a(document.body).append(a(this)))});var c=a("#s-product-edit-forms .s-product-form.main"),
d=this,e=c.find("table.s-product-skus:last > tbody");e.sortable({distance:5,helper:"original",items:"> tr",handle:"i.sort",opacity:0.75,tolerance:"pointer",update:function(b,c){var f=parseInt(a(c.item).data("id"),10),k=a(c.item).prev().data("id"),k=void 0===k?0:parseInt(k,10);d.editTabMainSkuSort(f,k,a(this));k=e.find('> tr.js-sku-settings[data-id="'+f+'"]');k.length&&(k=k.detach(),a.shop.trace("detach",k),k&&(a.shop.trace("detach",e.find('> tr[data-id="'+f+'"]').length),e.find('> tr[data-id="'+f+
'"]:first').after(k)))},start:function(){e.find("> tr.js-sku-settings").hide()},stop:function(){e.find("> tr.js-sku-settings").show()}});var f=a("#s-product-frontend-url");f.inlineEditable({editLink:"#s-product-frontend-url-edit-link",editOnItself:!1,minSize:{height:15,width:100},makeReadableBy:[],beforeMakeEditable:function(b){var c=a(this).closest("span.s-product-frontend-url-not-empty"),d=c.find("span.slash"),e=c.find("i.new-window");a(b).after(d);e.hide();c.find("a.s-frontend-base-url").hide();
c.find("span.s-frontend-base-url").show()},beforeBackReadable:function(){var b=a(this).closest("span.s-product-frontend-url-not-empty"),c=b.find("span.slash");b.find("i.new-window").show();b.find("span.s-frontend-base-url").hide();b.find("a.s-frontend-base-url").show().append(c)}});parseInt(b.id,10)||f.trigger("editable");"new"==b.id&&a.product_list&&a.isArray(a.product_list.collection_hash)&&("category"==a.product_list.collection_hash[0]?c.find("select.s-product-categories").val(a.product_list.collection_hash[1]):
"set"==a.product_list.collection_hash[0]&&c.find(".add-set-button").click().closest(".field").find("select:first").val(a.product_list.collection_hash[1]));c.off("change.product","select.s-product-categories").on("change.product","select.s-product-categories",function(){var b=a(this),c=b.val(),d=b.parent(),e=d.find(".s-product-delete-from-category"),f=parseInt(c,10)||0;f?e.show():e.hide();"create"==c?(d.find(".s-new-category").show(),d.find("input.val").attr("disabled",!1),b.hide().attr("disabled",
!0).addClass("js-ignore-change")):d.find("input.val").val(f)});c.off("keydown.product","input.new-category").on("keydown.product","input.new-category",function(b){if(13==b.keyCode)return a(this).parent().find("input[type=button]").click(),!1});c.off("click.product",".s-new-category input[type=button]").on("click.product",".s-new-category input[type=button]",function(){var b=a(this).parent(),c=b.parent(),d=b.find("input[name=new_category]"),e=d.val();a.shop.jsonPost("?module=products&action=saveListSettings&category_id=0&parent_id=0",
...
a("#s-category-list>ul").trigger("add",[e.data,"category"])})})});c.off("click.product",".s-product-delete-from-category").on("click.product",".s-product-delete-from-category",function(){var b=a(this),c=b.parent("div"),d=c.find("select");if(d.length)if(2<a("#s-product-edit-forms .s-product-form.main select.s-product-categories").length){d.attr("disabled",!0);var e=c.parents("div.field:first").find('input[name="product[categories.deleted]"]');if(0<parseInt(d.val())){var f=e.val().split(",");f.push(d.val());
f.sort();e.val(f.join(","));a.product.helper.onChange(a.product.get("form").find("div.main:first"))}c.remove()}else d.val("selected").attr("disabled",!1),c.find("input.val").val(0).attr("disabled",!0).parent().hide(),c.find(".s-storefront-map").html(""),c.find(".s-product-delete-from-category").hide();else e=c.parents("div.field:first").find('input[name="product[categories.deleted]"]'),d=b.parents(".value:first").find(":input:first"),0<parseInt(d.val())&&(f=e.val().split(","),f.push(d.val()),f.sort(),
e.val(f.join(",")),a.product.helper.onChange(a.product.get("form").find("div.main:first"))),b.parents(".value:first").remove();return!1})},editTabMainAction:function(b){var c=!1,d=null;b&&b.params&&b.params.focus?(d=b.params.name||"",!d.length&&b.params.sku&&(d="product[skus]["+parseInt(b.params.sku,10)+"]",b.params.focus&&(d+="["+b.params.focus+"]"),"stock"==b.params.focus&&(d+="["+(parseInt(b.params.stock,10)||0)+"]")),c=':input[name$="'+d.replace(/(\[|\]|\|\-)/g,"\\$1")+'"]:first'):b&&"new"==b.id&&
...
a(this),e=b.val()?b.val().replace(",","."):0,e=parseFloat(e);e>c&&(c=e,d=b.val()||"0")});var e=0;b.find(':input[name$="[purchase_price]"]').each(function(){e=Math.max(e,parseFloat(a(this).val())||0)});a.product.multiSkus(b.find("tr:not(.js-sku-settings)").length+1);var f={id:--a.product.editTabMainData.sku_id,product_id:a('input:hidden[name="product[id]"]').val()||"new",sku:"",available:1,name:"",price:""+c,price_loc:d,purchase_price:""+e,stock_icon:{"0":"<i class='icon10 status-green' ></i>"},stock:{},
count:null};a.shop.trace("$.product.editTabMainSkuAdd",[a.product.editTabMainData.sku_id,f]);b.append(tmpl("template-sku-edit",{sku_id:a.product.editTabMainData.sku_id,sku:f,stocks:this.getData("main","stocks"),stock_ids:this.getData("main","stock_ids")},!0));b.find(".s-product-currency").trigger("change")}catch(g){a.shop.error(g.message,g)}return!1},editTabMainSkuSort:function(b,c,d){try{a.post("?module=product&action=skuSort",{product_id:this.path.id,sku_id:b,after_id:c},function(b){a.shop.trace("$.product.editTabMainSkuSort result",
b);b.error&&(a.shop.error("Error occurred while sorting product SKUs","error"),d.sortable("cancel"))},function(b){a.shop.trace("$.product.editTabMainSkuSort cancel",{data:b});d.sortable("cancel");a.shop.error("Error occurred while sorting product SKUs","error")})}catch(e){a.shop.error(e.message,e)}return!1},editTabMainProductDelete:function(){var b=a("#s-product-list-delete-products-dialog"),c=b.parent();b.length||(c=a("<div></div>").appendTo("body"));c.load("?module=dialog&action=productsDelete&count=1",
function(){a("#s-product-list-delete-products-dialog").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(b){a(this).find(".dialog-buttons i.loading").show();a.shop.jsonPost("?module=products&action=deleteList",{product_id:[a.product.path.id],get_lists:1},function(c){a.product_list&&a("#s-sidebar").trigger("update",c.data.lists);b.trigger("close");window.location.hash="#/products/"});return!1}})});return!1},editTabMainSkuDelete:function(b,
c){var d=a("#s-product-edit-forms .s-product-form.main table.s-product-skus:first").find("tbody:first"),e=c.parents("tbody").find('> tr[data-id="'+b+'"]'),f=this;0<b?1<c.parents("tbody").find('tr[data-id]:not(.js-sku-settings):not([data-id^="-"])').length?a.ajax({url:"?module=product&action=skuDelete",data:{sku_id:b,product_id:this.path.id},dataType:"json",type:"post",success:function(c){"fail"==c.status?f.refresh("error",c.errors):c.data.redirect?window.location.href=c.data.redirect:(f.refresh("success",
c.data.message||"Success"),e.hide("normal",function(){e.remove();a('#s-product-view table.s-product-skus > tbody > tr[data-id="'+b+'"]').remove();a.product.multiSkus(d.find("tr:not(.js-sku-settings)").length)}),a("#s-product-edit-forms .s-product-form.main").find("input[name=product\\[sku_id\\]][value="+c.data.sku_id+"]").attr("checked",!0))},error:function(a,b){f.refresh("error",b)}}):f.refresh("error",$_("A product must have at least one SKU.")):e.hide("normal",function(){e.remove();a('#s-product-view table.s-product-skus > tbody >tr[data-id="'+
b+'"]').remove();a.product.multiSkus(d.find("tr:not(.js-sku-settings)").length)})},editTabMainCategoriesAdd:function(){var b=a("#s-product-edit-forms .s-product-form.main select.s-product-categories:last").parent("div"),c=b.clone(!1);c.find("select").val("select").attr("disabled",!1).show();c.find("input.val").val(0).attr("disabled",!0).parent().hide();c.find(".s-product-delete-from-category").hide();c.find(".s-storefront-map").html("");c.show();b.after(c)},editTabMainSkuStock:function(b){var c=a("#s-product-sku-"+
b);c.hide().find(":input:enabled").attr("disabled",!0);b=a("#s-product-sku-stock-"+b);b.show().find(":input:disabled").removeAttr("disabled");b.find(":input:first").val(c.find(":input:first").val())},editTabMainSkuSettings:function(b,c){c.hide();var d=c.parents("tr"),e=d.data(),f=this;a.when(d.after(tmpl("template-sku-settings",{sku_id:b,sku:e}))).done(function(){var c;c="?module=product&action=skuSettings&product_id="+f.path.id;c+="&sku_id="+b;var e=a('#s-product-edit-forms .s-product-form.main tr.js-sku-settings[data-id="'+
b+'"] > td:first');e.load(c,function(){d.find(':input[name$="[available]"]').remove();a.product_images&&a.product_images.options&&a.product_images.options.enable_2x&&a.fn.retina&&e.find(".s-product-image-crops img").retina();if(0<b){a.shop.trace("fileupload",[e.find(".fileupload").length,typeof e.find(".fileupload").fileupload]);try{var c=document.cookie.match(/(?:^|; )_csrf=([^;]*)/),f=c?decodeURIComponent(c[1]):"";e.find(".fileupload:first").fileupload({dropZone:null,url:"?module=product&action=skuEproductUpload",
acceptFileTypes:/(\.|\/)(gif|jpe?g|png)$/i,start:function(){e.find(".fileupload:first").hide()},progress:function(b,c){a.shop.trace("fileupload progress",c);var d=e.find(".js-progressbar-container");d.show();d.find(".progressbar-inner:first").css("width",Math.round(100*c.loaded/c.total,0)+"%")},done:function(b,c){a.shop.trace("fileupload done",[c.result,typeof c.result]);var f=(c.result.files||[]).shift();e.find(".js-progressbar-container").hide();if(!f||f.error)e.find(".error-message").text(f.error).show(),
e.find(".fileupload:first").addClass("error").show();else{var g=e.find(".s-sku-attachment");g.find("input.s-input-file-name").val(f.name);g.find(".s-file-name").text(f.name);g.find(".s-file-size").text(f.size);g.find(".s-file-description").val("");g.find("input[type=checkbox]").attr("checked",!0);g.show();d.find("input.s-input-virtual").val(0)}},fail:function(b,c){a.shop.trace("fileupload fail",[c.textStatus,c.errorThrown]);e.find(".error-message").text("error").show().text(c.errorThrown||"error");
e.find(".js-progressbar-container").hide();e.find(".fileupload:first").addClass("error").show()},formData:{product_id:a.product.path.id,sku_id:b,_csrf:f}})}catch(g){a.shop.error("Exception "+g.message,g)}}})})},editTabMainSkuImageSelect:function(b,c,d){var b=d.parents("li:first"),e=b.hasClass("selected"),f=d.parents("div.value:first");f.find("ul.s-product-image-crops li.selected").removeClass("selected");e?f.find('input[name$="[image_id]"]').val(0):(b.addClass("selected"),f.find('input[name$="[image_id]"]').val(c));
a.shop.trace("$.product.editTabMainSkuImageSelect",[f,f.find(':input[name$="[image_id]"]')]);a.product.helper.onChange(d.parents("div.s-product-form"))},editTabMainSkuEproductSave:function(b){b=a("#s-product-edit-forms .s-product-form.main tr.js-sku-settings"+(b&&0<b?'[data-id="'+b+'"]':"")+" > td:first .fileupload");a.shop.trace("$.product.editTabMainSkuEproductSave",b.length);b.length&&b.fileupload("start")},editTabMainSkuEproductDelete:function(){},editTabMainLinkEdit:function(){return!1},editTabMainTypeSelect:function(a){var c=
a.parents("form").find(':input[name="product[type_id]"]').parents(".value");"main"==this.path.tab?a.hide():(c.find(".js-action").hide(),window.location.hash="/product/"+this.path.id+"/"+this.path.mode+"/");c.find(".js-type-name").hide();c.find(":input").show().focus();setTimeout(function(){c.find(":input").focus()},100)},editTabMainTypeChange:function(b){var c=b.parents(".value"),d=b.find(":selected:first"),e=d.val(),b=parseInt(d.data("sku-type"));c.find(".js-type-icon").html(d.data("icon"));c.find(".js-type-name").html(d.text());
e!=c.data("type")?a("#s-product-edit-forms .s-product-form.features").length&&"undefined"!=typeof this.editTabFeaturesReload?this.editTabFeaturesReload(e):(c=a("#s-product-edit-menu > li.features > a"),c.attr("href",c.attr("href").replace(/\/features\/.*$/,"/features/"+e+"/"))):(c=a("#s-product-edit-menu > li.features > a"),c.attr("href",c.attr("href").replace(/\/features\/.*$/,"/features/")));c=a(this.options.form_selector+' :input[name="product[sku_type]"]');a.shop.trace("sku_type",[b,c]);c.filter('[value="1"]').trigger("disabled",
[b?null:!0]);e=c.parents("ul");b?(c.filter(":checked").change(),e.find('[data-sku-type="1"]').hide()):(c.filter('[value="0"]').trigger("checked",!0).change(),e.find('[data-sku-type="1"]').show())},editTabMainUpdate:function(b,c,d){var e=a("#s-product-edit-forms .s-product-form.main table.s-product-skus tbody"),f=a("#s-product-view table.s-product-skus tbody");e.find('tr[data-id^="-"]').remove();f.find('tr[data-id^="-"]').remove();e.parents("table").find("tr:hidden").show();var g=[],h;for(h in b.skus||
{})g.push(a.extend({id:h},b.skus[h]));g=g.sort(function(a,b){return a.sort-b.sort});h=this.getData("main","stocks");var j=this.getData("main","stock_ids"),k="";tmpl.cache["template-sku-edit"]=tmpl(tmpl.load("template-sku-edit"));for(var m=0,l=g.length;m<l;m+=1)k+=tmpl("template-sku-edit",{sku_id:g[m].id,sku:g[m],stocks:h,stock_ids:j,checked:g[m].id==b.sku_id});e.html(k);e.find("select.s-product-currency").val(b.currency);e.parent().show();e.closest(".s-sku-list").show();this.multiSkus(e.find("tr:not(.js-sku-settings)").length);
k="";m=0;for(l=g.length;m<l;m+=1)k+=tmpl("template-sku",{sku_id:g[m].id,sku:g[m],stocks:h,stock_ids:j,runout:b.runout||{}});f.html(k);(!d||"new"==d)&&e.parents("div.field-group:first").after(a("#s-sku-type-field-group"));c&&(d=a("#s-product-feature-superposition .superposition-count"),d.find(".options").text(c.options),d.find(".skus").html('<span class="highlighted">'+c.skus+"</span>"));var i=/#\/product\/new\//,p="#/product/"+b.id+"/";a("#s-product-edit-forms .s-product-form.main table.s-product-skus tbody, #s-product-view table.s-product-skus tbody").find('[href*="#/product/new/"]').each(function(){a(this).attr("href",
...
if(d&&b.view){try{this.container.append(tmpl("template-product-list-"+this.options.view,{products:d,sort:this.sort},"table"==this.options.view)),this.container.trigger("append_product_list",[d])}catch(e){return console.log("Error: "+e.message),this}delete b.products}this.collection_hash=a.isArray(this.options.collection_hash)&&this.options.collection_hash.length?this.options.collection_hash:[];this.collection_param=this.options.collection_param?this.options.collection_param:"";b.order&&(this.order=
b.order);if(this.options.lazy_loading)this.initLazyLoad(this.options.lazy_loading);else{var f=c.replace(/&page=\d+/,"")+"&page=";a(".pagination a").each(function(){var b=a(this).attr("href").match(/\?page=(\d+)/);a(this).attr("href",f+(b?b[1]:1))})}this.initSelecting();this.initView(this.options.view);this.initDragndrop();this.initSortingNotice();this.rubberTable();"table"==this.options.view&&this.initInlineEditor()}catch(g){a.shop.error("$.product_list.init error: "+g.message,g)}return this},initSortingNotice:function(){if(!a.storage.get("shop/list-sorting-notice-closed")){var b=
a("#custom-backend-order-notice");if(b.length)b.show().on("click",".close",function(){a.storage.set("shop/list-sorting-notice-closed","1");b.remove()})}},initLazyLoad:function(b){var c=b.count,d=this.total_count;a(window).lazyLoad("stop");if(c<d){var e=this,f=e.container.find("tr.header th[data-additional-column]").map(function(){return a(this).data("additional-column")}).get().join(",");a(window).lazyLoad({container:e.container,state:"undefined"===typeof b.auto||b.auto?"wake":"stop",hash:["","products"],
load:function(){a(window).lazyLoad("sleep");a(".lazyloading-link").hide();a(".lazyloading-progress").show();a.get("?module=products&action=loadList&offset="+c+("&total_count="+d)+(e.collection_param?"&"+e.collection_param:"")+(e.sort?"&sort="+e.sort:"")+(e.order?"&order="+e.order:"")+("&enabled_columns="+(f||"")),function(b){if("ok"==b.status&&b.data.count){c+=b.data.count;var f=e.container;try{e.container.append(tmpl("template-product-list-"+e.options.view,{products:b.data.products,check_all:"table"==
e.options.view?f.find(".s-select-all:first").attr("checked"):!1,sort:a.product_list.sort})),e.container.trigger("append_product_list",[b.data.products])}catch(j){console.log("Error: "+j.message);a(window).lazyLoad("stop");return}f.find(".last").removeClass("last");f.find(".product:last").addClass("last");a(".lazyloading-progress-string").text(b.data.progress.loaded+" "+b.data.progress.of);a(".lazyloading-progress").hide();a(".lazyloading-chunk").text(b.data.progress.chunk);c>=d?(a(window).lazyLoad("stop"),
...
d=b.find(".s-select-all:first"),e=function(){var a=parseInt(b.find("> .product.selected").length,10);a?c.text(a).show():c.text("").hide()};a(document).keydown(function(a){16==a.keyCode&&(document.body.onselectstart=function(){return!1})}).keyup(function(a){16==a.keyCode&&(document.body.onselectstart=null)});b.off("select",".product").on("select",".product",function(b,c,h){h=void 0!==h?h:!0;(void 0!==c?c:1)?a(this).addClass("selected").find("input:first").attr("checked",!0):(a(this).removeClass("selected").find("input:first").attr("checked",
...
"table"==b&&(c.find(".s-select-all:first").click(function(){a(this).trigger("select",this.checked)}),a("#s-content .list-view-mode-table").click(function(){c.toggleClass("single-lined");a.storage.set("shop/product_list/multi-lined",!c.hasClass("single-lined"));return!1}),a.storage.get("shop/product_list/multi-lined")&&c.removeClass("single-lined"));var e="view="+b;d.find(".s-collection-list li.dr").each(function(){var b=a(this);b.find("a:first").attr("href","#/products/"+b.attr("id").replace("-",
"_id=")+"&"+e)});a("#s-products-search").autocomplete("disable").val(this.options.text||"").autocomplete("enable");var f="s-all-products";a.product_list.collection_hash.length&&("search"!==a.product_list.collection_hash[0]&&"tag"!==a.product_list.collection_hash[0])&&(f=a.product_list.collection_hash.join("-"));a.shop.trace("$.product_list.initView",[b,f]);d.find("li.selected").removeClass("selected");var g=d.find("#"+f);0>=g.length&&window.location.hash&&(g=d.find('a[href="'+window.location.hash+
'"]').parent());0>=g.length&&(g=d.find("#s-all-products"));g.addClass("selected");a.product_list.collection_hash.length&&("search"!==a.product_list.collection_hash[0]&&"tag"!==a.product_list.collection_hash[0])&&g.find(".count:first").text(this.category_count);a("#s-content").find(".sort").unbind("click").bind("click",function(){location.href=a(this).find("a").attr("href");return false});a.product_list.fixed_blocks=a.product_list.initFixedBlocks();this.initEditingControls();this.initToolbar();a(document).trigger("product_list_init_view")}catch(h){a.shop.error("$.product_list.initView error: "+
h.message,h)}},highlightInlineEditorCells:function(){a.product_list.container.find("tr").each(function(){var b=a(this),c=b.data("edit-rights");(!c||b.data("min-price")!=b.data("max-price"))&&b.find(".s-product-price .editable").filter(function(){return!a(this).data("plugin")}).addClass("not-editable");(!c||1!=b.data("sku-count"))&&b.find(".s-product-stock .editable").filter(function(){return!a(this).data("plugin")}).addClass("not-editable")})},initInlineEditor:function(){function b(a,b){if(a.data("denied-reason")==
b)a.data("denied-reason",""),alert(b);else{a.data("denied-reason",b);setTimeout(function(){a.data("denied-reason","")},3E3);a.wrapInner('<div class="animation-container" style="position:relative;"></div>');var e=a.find(".animation-container").animate({left:"3px"},100,function(){e.animate({left:"0px"},100,function(){e.animate({left:"3px"},100,function(){e.animate({left:"0px"},100,function(){e.children().first().unwrap()})})})})}}a.product_list.highlightInlineEditorCells();a.product_list.container.on("append_product_list",
function(){a.product_list.highlightInlineEditorCells()});a.product_list.container.on("click",".s-product-price,.s-product-stock",function(){function c(){if(f)d.html(tmpl("template-list-price-editor-one",{product_id:e.data("product-id"),currency:e.data("currency"),value:e.data("original-price")}));else{var b=e.data("stocks");!b||"object"!=typeof b?d.html(tmpl("template-list-stock-editor-one",{product_id:e.data("product-id"),value:b||""})):d.html(tmpl("template-list-stock-editor-many",{product_id:e.data("product-id"),
values:b}))}d.find(".cancel").click(function(){var a=d;a.removeClass("editor-on").html(a.data("read-only-state-html"));a.data("read-only-state-html","");a.data("denied-reason","")});var c=d.find("form").submit(function(){if(c.find(".loading").length)return!1;c.find(":submit").after('<i class="icon16 loading"></i>');a.post("?module=products&action=inlineSave",c.serialize(),function(b){c.find(".loading").remove();try{b.data&&b.data[0]&&(b.data[0].alien=e.hasClass("s-alien"));var d=a("<table>").html(tmpl("template-product-list-table",
{products:b.data,check_all:a.product_list.container.find(".s-select-all:first").prop("checked"),sort:a.product_list.sort}));e.replaceWith(d.find("tr"));self.container.trigger("append_product_list",[b.data])}catch(f){console.log("Error: "+f.message)}},"json");return!1});c.on("dblclick",!1);setTimeout(function(){d.find(":input:visible:first").focus()},0)}var d=a(this);if(!d.data("plugin")){var e=d.closest("tr"),f=d.hasClass("s-product-price");if(f){if(e.data("min-price")!=e.data("max-price"))return b(d,
$_("Inline editing is available only for products with a single SKU"))}else if("1"!=e.data("sku-count"))return b(d,$_("Inline editing is available only for products with a single SKU"));if(!e.data("edit-rights"))return b(d,$_("Insufficient access rights"));if(!d.hasClass("editor-on"))if(d.addClass("editor-on").data("read-only-state-html",d.html()),a.product_list.container.removeClass("single-lined"),void 0!==e.data("original-price"))c();else{d.html('<i class="icon16 loading"></i>');var g=[];a.product_list.container.find("tr.product").each(function(){var b=
a(this);void 0===b.data("original-price")&&b.data("edit-rights")&&g.push(a(this).data("product-id"))});g.length?a.post("?module=products&action=inlineEditorData",{ids:g},function(b){b.data&&a.product_list.container.find("tr.product").each(function(){var c=a(this),d=b.data[parseInt(c.data("product-id"),10)];d&&(c.data("stocks",d.stocks||null),c.data("original-price",d.price.replace(/\.?0+$/g,"")))});c()},"json"):c()}}})},initFixedBlocks:function(){var b=a("#mainmenu").height(),c=a("#s-sidebar").width(),
d=a(window),e=a("#s-fixed-blocks");e.length||(e=a('<div id="s-fixed-blocks"></div>').css({display:"none",position:"fixed",background:"#fff",top:b,width:c,"float":"left"}).appendTo("#s-sidebar"));var f=a("#s-category-list"),g=a("#s-category-list-block"),h=a("#s-set-list"),j=a("#s-set-list-block"),k,m=function(){if(!n){var h=a("#"+o);s=a.categories_tree.isCollapsed(h);q=f.is(":hidden");var j=a('<div id="'+p+'" class="block"></div>').css({height:g.height()});g.replaceWith(j);e.show().append(g.hide());
...
f.show();var a=g.height(),c=(d.height()-b)/2;g.css({height:Math.min(a,c)});g.find(".heading").prev(".hint").hide();k=false}},250))});d.bind("mouseout.fixed_blocks.category",function(a){a.pageX>c+10&&(i&&clearTimeout(i),i=null,k||(f.hide(),g.css({height:""}),g.find(".heading").prev(".hint").show(),k=!0))});n=!0}},l=function(){if(n){var b=a("#"+p);b.replaceWith(g);g.css({"overflow-x":"","overflow-y":""});var c=a("#"+o);s&&a.categories_tree.collapse(c);q||f.show();g.find(".heading").prev(".hint").remove();
a("#"+o).show();a("i.add",g).show();b.remove();g.unbind("mousemove.fixed_blocks.category");d.unbind("mouseout.fixed_blocks.category");e.children().length||e.hide();n=!1;a.categories_tree.init()}},i=g.offset().top,p="s-category-list-dummy",o="s-category-list-handler",n=!1,q,s;d.unbind("scroll.fixed_blocks.category").bind("scroll.fixed_blocks.category",function(){n||(i=g.offset().top);var c=i,c=document.getElementById(p)?c+a("#"+p).height():c+a("#s-category-list-block").height();d.scrollTop()+b+5>=
c?m():l()});k={setFixed:m,unsetFixed:l};var t=function(){if(!u){r=h.is(":hidden");var f=a('<div id="'+v+'" class="block"></div>').css({height:j.height()});j.replaceWith(f);e.show().append(j);j.find(".heading").before('<span class="hint float-right" style="margin-top: 3px;">'+$_("Drag products here")+"</span>");r||h.hide();a("i.add",j).hide();a("i.collapse-handler",j).hide();j.css({"overflow-x":"hidden","overflow-y":"auto"});var g=h.is(":hidden"),k;j.bind("mousemove.fixed_blocks.set",function(){document.getElementById("products-helper")&&
g&&(k&&(clearTimeout(k),k=null),k=setTimeout(function(){if(g){j.css({height:""});h.show();var a=j.height(),c=(d.height()-b)/2;j.css({height:Math.min(a,c)});j.find(".heading").prev(".hint").hide();g=false}},250))});d.bind("mouseout.fixed_blocks.set",function(a){a.pageX>c+10&&(k&&clearTimeout(k),k=null,g||(h.hide(),j.css({height:""}),j.find(".heading").prev(".hint").show(),g=!0))});u=!0}},w=function(){if(u){var b=a("#"+v);b.replaceWith(j);j.css({"overflow-x":"","overflow-y":""});j.find(".heading").prev(".hint").remove();
r||h.show();a("i.add",j).show();a("i.collapse-handler",j).show();b.remove();j.unbind("mousemove.fixed_blocks.category");d.unbind("mouseout.fixed_blocks.category");e.children().length||e.hide();u=!1}},x=j.offset().top,v="s-set-list-dummy",r,u=!1;d.unbind("scroll.fixed_blocks.set").bind("scroll.fixed_blocks.set",function(){u||(x=j.offset().top);var c=x,c=document.getElementById(v)?c+a("#"+v).height():c+a("#s-set-list-block").height();d.scrollTop()+b+5>=c?t():w()});return{category:k,set:{setFixed:t,
unsetFixed:w}}},initEditingControls:function(){var b=a("#s-product-list-title");b.hasClass("editable")&&(b.inlineEditable({minSize:{width:350},maxSize:{width:600},size:{height:30},inputClass:"s-title-h1-edit",beforeMakeEditable:function(){a(".s-product-list-manage").hide()},afterBackReadable:function(b,c){a(".s-product-list-manage").show();if(!c.changed)return!1;a.shop.jsonPost("?module=products&action=saveListSettings&"+a.product_list.collection_param+"&edit=name",{name:a(b).val()},function(b){a.product_list.sidebar.find("#"+
...
onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(){function b(a,c){if(!a.length)return c&&c();var f=a.shift();e(["category",f],function(){b(a,c)})}function e(b,c){var d={hash:b.join("/")||"all",remove:["list"]};h&&d.remove.push("products");var e=function(){a.product_list.remove(d,function(d){var e=b[0],f=a("#"+b.join("-")),g=f.prev(".drag-newposition"),h=a("#s-"+b[0]+"-list"),i=h.find("ul:first");if(e=="set"){f.remove();g.remove()}else{e=f.find("ul:first");if(e.length){e.find(">li.drag-newposition:first").remove();
f.hide();e.find(">li").each(function(){f.after(this)})}e=f.parents("ul:first");f.remove();g.remove();if(!e.find("li.dr").length)if(i.get(0)!=e.get(0)){e.parents("li:first").find("i.collapse-handler").remove();e.closest("li").find(".collapse-handler-ajax:first").remove();e.remove()}else i.closest(".block").find(".collapse-handler-ajax:first").remove()}if(i.find("li.dr:first").length){i.show();h.find(".s-empty-list").hide()}else{i.hide();h.find(".s-empty-list").show()}d.data.old_parent_category&&(typeof d.data.old_parent_category.children_count!==
...
"1";c=="category"&&f.find('input[name="s-delete-sub"]').is(":checked")?a.get("?action=categoryExpand&tree=1&recurse=1&id="+g,function(c){c=a("<div>").html(c).find('li[id^="category-"]').map(function(){return parseInt(this.id.substr(9),10)}).get().reverse();c.push(g);b(c,function(){location.href="#/"})}):e(a.product_list.collection_hash,function(){location.href="#/"});return false}});return false});"set"===c&&a("#s-embed-code").click(function(){a("#s-product-list-embed-dialog").waDialog();return false})},
initDragndrop:function(){a.product_dragndrop.init({products:!0,view:this.options.view,sort:this.options.sort}).bind("move_product",function(b){a.shop.jsonPost("?module=product&action=move&"+a.product_list.collection_param,{product_ids:b.product_ids,before_id:b.before_id||null},b.success,b.error)}).bind("is_product_sortable",function(){return a.product_list.sortable}).bind("add_to_list",function(b){var c={};b.whole_list?c.hash=a.product_list.collection_hash.join("/")||"all":c.product_id=b.product_ids;
a.shop.jsonPost("?module=product&action=addToList&"+b.collection_param,c,b.success,b.error)})},initToolbar:function(){var b=this.toolbar;b.find("li").unbind("click.product_list").bind("click.product_list",function(){var b=a(this),c=b.attr("data-action");if(c){var d=a.product_list.getSelectedProducts("delete"!=c);if(!d.count)return alert($_("Please select at least one product")),!1;switch(c){case "new-set":break;case "category":a.product_list.categoriesDialog(d);break;case "set":a.product_list.setsDialog(d);
break;case "type":a.product_list.typesDialog(d);break;case "assign-tags":a.product_list.assignTagsDialog(d);break;case "delete":a.product_list.deleteProductsDialog(d);break;case "delete-from-set":"set"==a.product_list.collection_hash[0]&&a.product_list.deleteFromSet(d);break;case "delete-from-category":"category"==a.product_list.collection_hash[0]&&a.product_list.deleteFromCategory(d);break;case "visibility":a.product_list.visibilityDialog(d,b);break;case "export":a.product_list.exportProducts(d,
a(this).attr("data-plugin"));break;case "duplicate":a.product_list.duplicateProducts(d,a(this));break;case "set-badge":case "delete-badge":a.product_list.setBadge(d,a(this));break;default:return}return!1}});b.find('li[data-action="set-custom-badge"] a').click(function(){a(this).parent().find(".textarea-wrapper").slideToggle("fast");return!1}).closest("li").find(".textarea-wrapper").click(function(){return!1}).find("input").click(function(){var b=a.product_list.getSelectedProducts(!0);b.count?a.product_list.setBadge(b,
...
b.count+")").show();c.find(".dialog-buttons i.loading").hide()},onSubmit:function(c){var d=a(this),g=d.find("#s-assign-tags-list_tag");if(g.length){var h=jQuery.Event("keypress",{which:13});g.trigger(h)}d.find(".dialog-buttons i.loading").show();var j=d.attr("action");setTimeout(function(){var g=d.serializeArray().concat(b.serialized);a.shop.jsonPost(j,g,function(b){b.data.cloud&&a("#s-tag-cloud").trigger("update",[b.data.cloud]);c.trigger("close");a.products.dispatch()},function(){c.trigger("close")})},
10);return!1}})})},typesDialog:function(b){var c=a("#s-types"),d=this.container,e=this.sidebar,f=function(){a("#s-types").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(c){var f=a(this);f.find(".dialog-buttons i.loading").show();a.shop.jsonPost(f.attr("action"),f.serializeArray().concat(b.serialized),function(b){e.trigger("update",{type:b.data.types});d.find(".s-select-all:first").trigger("select",!1);f.find("input:checked").attr("checked",
!1);c.trigger("close");a.products.dispatch()});return!1}})},g=c.parent();c.length?f():(g=a("<div></div>").appendTo("body"),g.load("?module=dialog&action=types",f))},deleteFromSet:function(b){0<b.count&&a.shop.jsonPost("?module=products&action=deleteFromSet&id="+this.collection_hash[1],b.serialized,function(){a.products.dispatch()})},deleteFromCategory:function(b){0<b.count&&a.shop.jsonPost("?module=products&action=deleteFromCategory&id="+this.collection_hash[1],b.serialized,function(){a.products.dispatch()})},
deleteProductsDialog:function(b){var c=a("#s-product-list-delete-products-dialog"),d=c.parent();c.length||(d=a("<div></div>").appendTo("body"));d.load("?module=dialog&action=productsDelete&count="+b.count,function(){a("#s-product-list-delete-products-dialog").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(c){a(this).find(".dialog-buttons i.loading").show();a.product_list.remove(a.extend(b,{remove:["products"]}),function(b,
d){a.product_list.sidebar.trigger("update",b.data.lists);a.products.dispatch();c.trigger("close");d.length&&alert((c.data("not-allowed-string")||"").replace("%d",d.length))});return!1}})})},settingsListDialog:function(){var b=a("#s-product-list-settings-dialog");(b.length?b.parent():a("<div></div>").appendTo("body")).load("?module=dialog&action=productListSettings&"+a.product_list.collection_param,function(){var b=a("#s-product-list-create-dialog");b.length&&(b.parent().remove(),b.remove());a("#s-product-list-settings-dialog").waDialog({esc:!1,
disableButtonsOnSubmit:!0,onLoad:function(){a("#s-category-description-content").length&&a.product_sidebar.initCategoryDescriptionWysiwyg(a(this));setTimeout(function(){a("#s-product-list-name").focus()},50)},onSubmit:function(b){var c=a(this),f=function(c){var e=a.product_list.collection_hash,f=location.hash.replace(e[0]+"_id="+e[1],e[0]+"_id="+c.data.id),g=a("#"+e.join("-"));g.find(".name:first").html(c.data.name);a.isArray(c.data.routes)&&c.data.routes.length?g.find(".routes:first").html(" "+c.data.routes.join(" ")):
g.find(".routes:first").html(" ");c.data.status=="0"?g.children("a").addClass("gray"):c.data.status=="1"&&g.children("a").removeClass("gray");g.find(".id:first").html(c.data.id);g.attr("id",e[0]+"-"+c.data.id);g.find("a").attr("href",f);if("sort_products"in c.data){f=f.replace(/&sort=[^&]*/,"&sort=");f=f.replace(/&order=[^&]*/,"&order=")}location.hash!=f?location.hash=f:a.products.dispatch();b.trigger("close")},g=function(a){if(a&&a.errors){var a=a.errors,c;for(c in a)b.find("input[name="+c+"]").addClass("error").parent().find(".errormsg").text(a[c]);
return false}};a("#s-category-description-content").length&&a("#s-category-description-content").waEditor("sync");if(c.find("input:file").length)a.products._iframePost(c,f,g);else{a.shop.jsonPost(c.attr("action"),c.serialize(),f,g);return false}}})})},exportProducts:function(a,c){for(var d=[],e,f=!1;e=a.serialized.pop();)e.name&&("product_id[]"==e.name?d.push(parseInt(e.value,10)):"hash"==e.name&&(f=e.value));e="?action=importexport#/"+c;f?window.location=e+("/hash/"+f):d.length&&(e+="/hash/id/"+
d.join(","),window.location=e)},duplicateProducts:function(b,c){for(var d=[],e,f=!1;e=b.serialized.pop();)e.name&&("product_id[]"==e.name?d.push(parseInt(e.value,10)):"hash"==e.name&&(f=e.value));!f&&d.length&&(f="id/"+d.join(","));f&&(c.find("i.icon16").removeClass("split").addClass("loading"),this.duplicate(f,{progress:function(a){c.attr("title",Math.round(100*a.offset/a.total_count)+"%")},finish:function(b,d){c.attr("title",null);var e=c.find("i.icon16");e.removeClass("loading").addClass("yes");
setTimeout(function(){e.removeClass("yes").addClass("split")},3E3);a(document).one("product_list_init_view",function(){var b={};a.each(d,function(a,c){b[c]=1});a("#product-list [data-product-id]").each(function(){var c=a(this),d=a(this).data("product-id");d&&b[d]&&c.addClass("highlighted")})});a.products.dispatch()},error:function(){}}))},setBadge:function(b,c){function d(b){var d="delete-badge"==e?null:b.data;a("#product-list [data-product-id]").each(function(){var b=a(this);if(g||f[b.data("product-id")]){if(b.is("tr")){var c=
b.find(".s-image a");c.find(".s-image-corner").remove();d&&c.prepend(a('<div class="s-image-corner"></div>').html(d))}else c=b.find(".s-product-image a"),c.find(".s-image-corner.top.right").remove(),d&&c.append(a('<div class="s-image-corner top right"></div>').html(d));b.trigger("badge",[d])}});"set-custom-badge"==e&&c.parent().find(".textarea-wrapper").slideUp("fast");c.find(".loading").remove();c.find("a").append(a('<span class="count"><i class="icon16 yes"></i></span>').animate({opacity:0},function(){a(this).remove()}));
a.product_list.container.find(".s-select-all:first").trigger("select",!1)}var e=c.data("action");"set-custom-badge"!=e&&c.parent().find(".textarea-wrapper").slideUp("fast");c.find(".loading").remove();c.find("a").append('<span class="count"><i class="icon16 loading"></i></span>');var f={},g=!1;a.each(b.serialized,function(){g=g||"hash"==this.name;f[this.value]=1});if("delete-badge"==e)c.find(".loading").remove(),a.shop.jsonPost("?module=product&action=badgeDelete",b.serialized,d);else{var h;h="set-custom-badge"==
e?c.find("textarea").val():c.data("type");var j=b.serialized;j.push({name:"code",value:h});a.shop.jsonPost("?module=product&action=badgeSet",j,d)}},duplicate:function(b,c){var d=this,e=[];a.shop.jsonPost("?module=products&action=duplicate",{hash:b,limit:50,offset:c.offset||0},function(a){if("ok"==(a.status||"error"))e=e.concat(a.data.new_ids||[]),a.data.offset<a.data.total_count?(c.offset=a.data.offset,d.duplicate(b,c),c.progress(a.data||{})):c.finish(a.data||{},e)})},remove:function(b,c){var d={},
e=[],f;b.product_id?f=function(){100>=b.product_id.length&&(d.get_lists=!0);d.product_id=b.product_id.splice(0,100);a.shop.jsonPost("?module=products&action=deleteList",d,function(a){a.data.not_allowed&&a.data.not_allowed.length&&(e=e.concat(a.data.not_allowed));b.product_id.length?f():typeof c==="function"&&c(a,e)})}:(d.hash=b.hash||this.collection_hash.join("/")||"all",d.remove=a.isArray(b.remove)&&b.remove.length?b.remove:["list"],1==d.remove.length&&"list"==d.remove[0]?f=function(){a.shop.jsonPost("?module=products&action=deleteList",
d,c)}:(d.count=100,f=function(){a.shop.jsonPost("?module=products&action=deleteList",d,function(a){a.data.not_allowed&&a.data.not_allowed.length&&(e=e.concat(a.data.not_allowed));0<a.data.rest_count&&null!=a.data.rest_count?f():"function"===typeof c&&c(a,e)})}));f()},rubberTable:function(){var b=a("#wa"),c=a("#s-content"),d=a("#s-content > .content"),c=parseInt(c.css("margin-left")),e=parseInt(d.css("margin-right")),f=a("#s-product-list-table-container table").width(),g=b.attr("style");g&&b.data("style",
g);d=parseInt(d.width()-a("#s-product-list-table-container").width())+f+c+e;b.width()<d&&b.css({"min-width":d+"px"});a(window).resize()}}})(jQuery);
