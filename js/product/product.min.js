...
!0}else if("wake"==a){if(e=this.data("lazyLoadSettings"))e.loading=!1}else if("force"==a)(e=this.data("lazyLoadSettings"))&&(e.loading||e.load());else{this.data("lazyLoadSettings",b.extend({distance:50,load:function(){},container:g,state:"wake",hash:location.hash.replace(/^[^#]*#\/*/,"").split("/")[0]||null,distanceBetweenBottoms:null},a||{}));e=this.data("lazyLoadSettings");e.loading=!1;e.stopped=!1;var f=b(window),g=e.container||b(this);null===e.hash||b.isArray(e.hash)||(e.hash=[e.hash]);b.fn.lazyLoad.call(f,
e.state);(function(){var b,a=setTimeout(b=function(){if(e.stopped)clearTimeout(a);else{if(null!==e.hash){var c=location.hash.replace(/^[^#]*#\/*/,"").split("/")[0];if(-1===e.hash.indexOf(c)){clearTimeout(a);return}}e.loading?a=setTimeout(b,350):(h(g,f),h(g,f)<=e.distance?(e.load(),a=setTimeout(b,350)):(f.get(0).onscroll=d,clearTimeout(a)))}},350)})();var h="function"===typeof e.distanceBetweenBottoms?e.distanceBetweenBottoms:function(a,c,d){a="string"===typeof a?b(a):a;d=d||0;return a.position().top+
a.outerHeight()-d-(c.scrollTop()+c.height())}}}})(jQuery);$.fn.liveDraggable=function(b){this.each(function(b,a){b=$(this);b.data("init_draggable")&&b.die("mouseover",b.data("init_draggable"))});var a;this.die("mouseover").live("mouseover",a=function(){var c=$(this);c.data("init_draggable")||c.data("init_draggable",a).draggable(b)})};
$.fn.liveDroppable=function(b){this.each(function(b,a){b=$(this);b.data("init_droppable")&&b.die("mouseover",b.data("init_droppable"))});var a=function(){var c=$(this);c.data("init_droppable")||(c.data("init_droppable",a).droppable(b),c.mouseover())};a.call(this);this.die("mouseover",a).live("mouseover",a)};(function(b){b.fn.inlineEditable=function(a,c){function d(){r(b(this))||b(this).addClass(m.placeholderClass).text(m.placeholder)}function e(){r(b(this))==m.placeholder&&b(this).text("").removeClass(m.placeholderClass)}function f(a){return b(a).val()?!1:(b(this).text(m.placeholder).addClass(m.placeholderClass),!0)}function g(){q="edit";this.id=this.id||(""+Math.random()).slice(2);var a=this.id+"-input",c=b("#"+a);c.length||(p.after(k(a)),c=b("#"+a));c.addClass(m.inputClass);l(c,p);m.placeholder&&r(b(this))==
m.placeholder&&e.call(p);m.beforeMakeEditable.call(this,c);u=m.truncate?p.data("real_text"):r(p);c.val(u).show().focus();p.hide();b(m.editLink).hide();if(!t){a=[];for(var d=[],f=0,g=m.makeReadableBy.length;f<g;++f){var n=m.makeReadableBy[f];"blur"==n&&c.blur(function(){"read"!=q&&h.call(this)});"enter"==n&&a.push(13);"esc"==n&&a.push(27)}f=0;for(g=m.updateBy.length;f<g;++f)n=m.updateBy[f],"alt+enter"==n&&d.push({ctrl:!1,alt:!0,shift:!1,key:13}),"ctrl+enter"==n&&d.push({ctrl:!0,alt:!1,shift:!1,key:13}),
"ctrl+s"==n&&d.push({ctrl:!0,alt:!1,shift:!1,key:17});a.length&&function(b){c.keydown(function(a){!~b.indexOf(a.keyCode)||a.ctrlKey||a.altKey||a.shiftKey||"read"!=q&&h.call(this,27==a.keyCode?u:null);if(d.length)for(var c in d){var e=d[c];if(a.keyCode==e.key&&a.ctrlKey==e.ctrl&&a.altKey==e.alt&&a.shiftKey==e.shift){p.trigger("readable");break}}})}(a);p.unbind("readable.inlineEditable").bind("readable.inlineEditable",function(a,c){"read"!=q&&(a=b("#"+(this.id+"-input")),h.call(a,a.val(),c))});t=!0}m.afterMakeEditable.call(this,
c)}function h(a,c){c="undefined"===typeof c?!1:!0;void 0!=a&&null!=a?b(this).val(a):a=b(this).val();if(!1!==c||!1!==m.beforeBackReadable.call(p.get(0),this,{changed:a!=u,old_text:u,new_text:a})){q="read";if(!m.placeholder||!f.call(p,this))if(m.allowEmpty||a){if(m.truncate)p.data("real_text",a),p.text(a.length<m.truncate-3?a:a.substr(0,m.truncate-3)+"...");else{var e=p,g=a;m.html?e.html(g):e.text(g)}a||d.call(this)}p.show();b(this).hide();b(m.editLink).show();!1===c&&m.afterBackReadable.call(p.get(0),
this,{changed:a!=u,old_text:u})}}function k(b){switch(m.inputType){case "textarea":return'<textarea id="'+b+'" style="display:none;"></textarea>';default:return'<input type="text" id="'+b+'" style="display:none;">'}}function l(b,a){var c=m.size.height||a.height();a=m.size.width||1.5*a.width();c=m.minSize.height&&c<m.minSize.height?m.minSize.height:c;a=m.minSize.width&&a<m.minSize.width?m.minSize.width:a;c=m.maxSize.height&&c>m.maxSize.height?m.maxSize.height:c;a=m.maxSize.width&&a>m.maxSize.width?
m.maxSize.width:a;b.height(c);b.width(a)}function n(b){return function(){return b}}function r(b){return m.html?b.html():b.text()}if(this.length){var t=!1;if("string"==typeof a){if("setOption"==a){var m=this.data("inlineEditableSettings")||{};b.extend(!0,m,c);"undefined"!==typeof c.hold&&"function"!==typeof c.hold&&(m.hold=n(m.hold));this.data("inlineEditableSettings",m)}return this}c=this.data("inlineEditableSettings");this.data("inlineEditableSettings",b.extend({inputType:"text",inputClass:"",size:{height:null,
width:null},minSize:{height:null,width:null},maxSize:{height:null,width:null},editLink:null,editOnItself:!0,placeholder:null,makeReadableBy:["blur","enter","esc"],updateBy:["ctrl+enter","alt+enter"],beforeBackReadable:function(){},afterBackReadable:function(){},beforeMakeEditable:function(){},afterMakeEditable:function(){},placeholderClass:"hint",truncate:!1,hold:!1,html:!1,allowEmpty:!1},c,a||{}));m=this.data("inlineEditableSettings")||{};var p=this,q="read",u="";"function"!==typeof m.hold&&(m.hold=
n(m.hold));(function(){if(!this.data("inited")){m.truncate&&"boolean"==typeof m.truncate&&(m.truncate=255);if(m.truncate){var a=m.placeholder&&m.placeholder===this.text()?"":this.text();this.data("real_text",a);this.text(a.length<m.truncate-3?a:a.substr(0,m.truncate-3)+"...")}m.placeholder&&d.call(this);m.editLink&&b(m.editLink).unbind("click.inlineEditable").bind("click.inlineEditable",function(){m.hold.call(p)||"edit"!=q&&g.call(p.get(0))});m.editOnItself&&this.unbind("click.inlineEditable").bind("click.inlineEditable",
function(){m.hold.call(p)||"edit"!=q&&g.call(this)});this.unbind("editable.inlineEditable").bind("editable.inlineEditable",function(){m.hold.call(p)||"edit"!=q&&g.call(this)});this.unbind("placeholder.inlineEditable").bind("placeholder.inlineEditable",function(a,c){c&&m.placeholder&&d.call(this);c||b(this).removeClass(m.placeholderClass)});this.data("inited",!0)}}).call(this);return this}}})(jQuery);(function(b){b.fn.photoStreamSlider=function(a){function c(){function a(c){function f(){a.execution=!1;var b="on"+k.charAt(0).toUpperCase()+k.slice(1);b=d[b];"function"==typeof b&&b.call(e);b=c.fn;"function"==typeof b&&b.call(e)}"string"==typeof c&&(c={direction:c,animate:!0});var k=c.direction||"forward",r=c.steps||h.length;if(!a.execution){a.execution=!0;var t=h.filter(":first").outerWidth()*r,p=h.length;if("forward"==k){var q=h.filter(":last").nextAll(":lt("+r+")");r=q.length;q=q.filter(":last");
r&&(h.removeClass("visible"),q.prevAll(":lt("+(p-1)+")").addClass("visible"),q.addClass("visible"))}else q=h.filter(":first").prevAll(":lt("+r+")"),r=q.length,q=q.filter(":last"),r&&(h.removeClass("visible"),q.nextAll(":lt("+(p-1)+")").addClass("visible").show(),q.addClass("visible"));h=b("li.visible",g);p=g.position().left;"forward"==k?(r=n-l-m,p-=t,p=p>-r?p:-r):(p+=t,p=p<m?p:m);c.animate?g.animate({left:p},d.duration,f):(g.css({left:p}),f())}}var g=e.find(d.photoStream),h=b("li.visible",g),k=b("li",
g),l=h.filter(":first").outerWidth()*h.length,n=k.filter(":first").outerWidth()*k.length,r=d.height||k.filter(":first").outerHeight();g.parent().css({overflow:"hidden",height:r,position:"relative",padding:"4px 0",margin:0,width:l});r=g.find("li:first");var t=h.filter(":first"),m=(t.outerWidth()-t.width())/2,p=0,q=r.outerWidth();for(t=t.get(0);r.length&&r.get(0)!=t;)p+=q,r=r.next();g.css({position:"absolute",left:-(p-m),width:n});b(d.forwardLink).unbind("click").bind("click",function(){a("forward");
return!1});b(d.backwardLink).unbind("click").bind("click",function(){a("backward");return!1});e.unbind("append prepend").bind("append prepend",function(a,c){if("append"==a.type){for(var d=g.find("li:last"),f=b();d.hasClass("dummy");)f=f.add(d),d=d.prev("li");f.remove();g.append(c)}else{d=b("<div></div>").html(c);c=d.find("li");var h=c.length*q;d.remove();d=g.find("li:first");for(f=b();d.hasClass("dummy");)f=f.add(d),d=d.next("li");f.remove();g.prepend(c)}k=g.find("li");n=k.filter(":first").outerWidth()*
...
d=f.attr("data-type");if(d!=c.attr("data-type"))return!1;a=function(b){b=b.split("-");b.shift();return b.join("-")};var g=a(f.attr("id")),h=c.prev("li"),k=f.next(),l=f.prev();if(h.length&&h.attr("id")=="category-"+g&&!h.hasClass("dr-helper")||this==f.next().get(0))return!1;var n=f.parent("ul"),r=n.children("li.dr[id!=category-"+g+"]").length,t=parseInt(a(n.parent().attr("id")),10)||0;c.after(k).after(f);c=f.parent().parent();if(c.is("li.dr")||c.is(".s-collection-list")){var m=0;c.is(".s-collection-list")||
(m=parseInt(a(c.attr("id")),10)||0);c=f.nextAll("li.dr:first");h=null;c.length&&(h=a(c.attr("id"))||null);r||t===m||(n.parent("li").children("i").hide(),n.hide());b.product_dragndrop.trigger("move_list",{id:g,type:d,before_id:h,parent_id:m,success:function(a){r||t===m||(n.parent("li").children("i").remove(),n.remove(),b.categories_tree.setCollapsed(t))},error:function(b){b&&console&&console.log("undefined"!==typeof b.errors?b.errors:b);l.after(f.next()).after(f);r||(n.parent("li").children("i").show(),
n.show())}})}}})},initDropInsideCollections:function(){b(".s-collection-list li.dr a").liveDroppable({tolerance:"pointer",greedy:!0,out:function(a,d){a=d.draggable;var c=b(this).parent();if(!a.hasClass("product")&&c.attr("data-type")!=a.attr("data-type"))return!1;a.hasClass("product")&&d.helper.find("span").show().end().find("i").hide();c.removeClass("drag-newparent")},over:function(a,d){var c=d.draggable;a=b(this).parent();var f=c.attr("data-type");if(!c.hasClass("product")&&f!=a.attr("data-type"))return!1;
"set"!=f&&a.addClass("drag-newparent");if(c.hasClass("product"))return a.hasClass("dynamic")?d.helper.find("span").hide().end().find("i").show():d.helper.find("span").show().end().find("i").hide(),!1;if(!c.hasClass("dynamic")&&a.hasClass("dynamic"))return d.helper.find("i.no-bw").show(),!1;d.helper.find("i.no-bw").hide();var g='.dr[id!="'+c.attr("id")+'"]',h=b(),k=function(b,a){if(!a.length)return b;b=b.add(a.nextUntil(g).filter("li.drag-newposition"));return 0<a.nextAll(g).length?b:k(b,a.parent().closest("li"))};
d=a.prevAll(g+":first");0<d.length?(c=d.find(g),h=0<c.length?k(h,c.last()):k(h,d)):h=h.add(a.prevUntil(g).filter("li.drag-newposition"));h=0<a.children("ul").children(g).length?h.add(a.children("ul").children("li.drag-newposition:first")):k(h,a);var l=b(".drag-newposition:animated, .drag-newposition.dragging").not(h);l.stop().animate({height:"2px"},300,null,function(){l.removeClass("dragging")});h.stop().animate({height:"10px"},300,null,function(){h.addClass("dragging")})},drop:function(a,d){var c=
d.draggable,f=b(this).parent();a=c.attr("data-type");if(!c.hasClass("product")&&("set"==a||f.attr("id")==c.attr("id")||a!=f.attr("data-type")))return!1;f.removeClass("drag-newparent");if(c.hasClass("product")){if(f.hasClass("dynamic"))return!1;var g=b("#product-list"),h={};if(g.find(".s-select-all").is(":checked"))h.whole_list=!0;else{var k=g.find(".product.selected");h.product_ids=k.map(function(){return b(this).attr("data-product-id")}).toArray()}b.product_dragndrop.trigger("add_to_list",b.extend(h,
{collection_param:f.attr("id").replace("-","_id="),success:function(b){h.whole_list?g.find(".s-select-all").trigger("select",!1):h.product_ids&&h.product_ids.length&&k.trigger("select",!1);b.data&&(f.find(">.counters .count:not(.subtree)").text(b.data.count),f.find(">.counters .subtree").text(b.data.total_count))}}));return!1}if(!c.hasClass("dynamic")&&f.hasClass("dynamic"))return!1;d=c.attr("id").split("-")[1];if(f.attr("id")=="category-"+d)return!1;if(c.hasClass("product"))return b("#product-list").find(".product.selected").trigger("select",
!1),!1;var l=parseInt(f.attr("id").split("-")[1],10)||0,n=null,r=c.next(),t=c.prev(),m=!1;f.hasClass("drag-newposition")?n=f.parent("ul"):f.children("ul").length?n=f.children("ul"):f.find(">i.collapse-handler-ajax").length||(n=b('<ul class="menu-v with-icons dr unapproved"><li class="drag-newposition unapproved" data-type="'+a+'"></li></ul>').appendTo(f),n.find(".drag-newposition").mouseover(),b('<i class="icon16 darr overhanging collapse-handler-ajax unapproved" id="'+a+"-"+l+'-handler"></i>').insertBefore(f.children("a")),
m=!0);var p=c.parent("ul"),q=p.children("li.dr[id!=category-"+d+"]").length,u=parseInt(p.parent().attr("id").split("-")[1],10)||0;n&&n.append(c).append(r);q||u===l||(p.parent("li").children("i").hide(),p.hide());f.is("li.dr")&&b.product_dragndrop.trigger("move_list",{id:d,type:a,parent_id:l,success:function(a){q||u===l||(p.parent("li").children("i").remove(),p.remove(),b.categories_tree.setCollapsed(u));n?(b(".s-collection-list .unapproved").removeClass("unapproved"),m?b.categories_tree.setExpanded(l):
f.trigger("count_subtree")):(c.remove(),r.remove(),f.trigger("update_counters",a.data.count||{}))},error:function(a){a&&console&&console.log("undefined"!==typeof a.errors?a.errors:a);t.after(c).after(r);q||(p.parent("li").children("i").show(),p.show());b(".s-collection-list .unapproved").remove()}})}})},_scrolHelper:function(a){a=b("#products-helper");var c=a.data("scrollTop"),e=b(document).scrollTop();c=c?e-c:50;a.css("top",a.position().top+c+"px");a.data("scrollTop",e)},_extDragActivate:function(a,
d,e){var c=e+"-last";if(d.hasClass("last")){var g=a.pageX;a=a.pageY;var h=d.width(),k=d.height(),l=d.offset();"thumbs"==b.product_dragndrop.options.view?g>l.left+.5*h&&g<=l.left+h?(d.removeClass(e).addClass(c),b.product_dragndrop._shiftToLeft(d)):g>l.left&&g<=l.left+.5*h?(d.removeClass(c).addClass(e),b.product_dragndrop._shiftToRight(d)):b.product_dragndrop._shiftAtPlace(d):"table"==b.product_dragndrop.options.view&&(a>l.top+.5*k?d.removeClass(e).addClass(c):a>l.top&&d.removeClass(c).addClass(e));
(a<l.top||a>l.top+k||g<l.left||g>l.left+h)&&d.removeClass(e).removeClass(c)}else d.addClass("drag-active")},_bindExtDragActivate:function(a,d){b(document).bind("mousemove.ext_drag_activate",function(c){b.product_dragndrop._extDragActivate(c,a,d)})},_unbindExtDragActivate:function(){b(document).unbind("mousemove.ext_drag_activate")},_activatePhotoListItem:function(){var a=b(this),d=b.product_dragndrop.trigger("is_product_sortable"),e=d?"drag-active":"drag-active-disabled";d&&"thumbs"==b.product_dragndrop.options.view&&
b.product_dragndrop._shiftToRight(a);a.hasClass("last")?b.product_dragndrop._bindExtDragActivate(a,e):a.addClass(e)},_unactivatePhotoListItem:function(){var a=b(this),d=b.product_dragndrop.trigger("is_product_sortable"),e=d?"drag-active":"drag-active-disabled",f=e+"-last";a.hasClass("last")&&b.product_dragndrop._unbindExtDragActivate();a.removeClass(e+" "+f);d&&"thumbs"==b.product_dragndrop.options.view&&b.product_dragndrop._shiftAtPlace(a)},_shiftToLeft:function(a){if("left"!==a.data("shifted")){var c=
a.find(".p-wrapper");if(!c.length){var e=a.children();c=b("<div class='p-wrapper' style='position:relative;'></div>").appendTo(a);c.append(e)}c.stop().animate({left:-15},200);a.data("shifted","left")}},_shiftToRight:function(a){if("right"!==a.data("shifted")){var c=a.find(".p-wrapper");if(!c.length){var e=a.children();c=b("<div class='p-wrapper' style='position:relative;'></div>").appendTo(a);c.append(e)}c.stop().animate({left:15},200);a.data("shifted","right")}},_shiftAtPlace:function(b){if(b.data("shifted")){var a=
b.find(".p-wrapper");if(a.length){var c=a.children();a.stop().css({left:0});b.append(c);a.remove()}b.data("shifted","")}}}})(jQuery);(function(b){var a=function(b){var a=/^category-(.*?)-handler$/;return a.test(b.attr("id"))?b.attr("id").replace(a,function(b,a){return parseInt(a,10)||0}):0},c=function(b){if(a(b))b=b.parents("li:not(.drag-newposition):first"),d=c=b.find("ul:first");else{b=b.parent();var c=b.next(),d=c.find("ul:first")}return{parent:b,target:c,ul:d}},d=function(b,a){var d=c(b);"category"==d.parent.attr("data-type")&&d.parent.trigger("count_subtree",!1);b.removeClass("rarr").addClass("darr");d.target.show();"function"===
...
minLength:1,delay:300,select:function(a,c){b.wa.setHash("#/products/tag="+c.item.value);return!1}})},initCollapsible:function(){var a=function(a,c){b(a).removeClass("darr").addClass("rarr");d(a).hide();c||(b.storage.set("shop/products/"+a.id+"/collapse",1),!1!==c&&(c=a.id.replace(/\-handler$/,""),a=b(a).parents("div.block:first").find("#"+c+":first"),a.length&&(a=a.data("on-collapse-url"))&&b.get(a)))},c=function(a){d(a).show();var c=b(a);c.removeClass("rarr").addClass("darr");b.storage.del("shop/products/"+
a.id+"/collapse");var e=a.id.replace(/\-handler$/,""),h=c.parents("div.block:first").find("#"+e+"-placeholder:first");if(h.length){var k=b(a).parents("div.block:first").find(".count:first");k.find("i.icon16.loading").remove();k.find("i.icon16").hide();k.prepend('<i class="icon16 loading"></i>');b.get(h.data("url"),function(a){h.replaceWith(b(a));k.find("i.icon16.loading").remove();k.find("i.icon16").show();h.remove()})}else a=b(a).parents("div.block:first").find("#"+e+":first"),a.length&&(a=a.data("on-expand-url"))&&
...
this.path.tail=null}},editTabShow:function(a){var c=b("#s-product-edit-forms .s-product-form."+a.tab);c.length?(c.show(),b.shop.trace("$.product.showTab",a),this.path.tab=a.tab):b.shop.error("$.product.showTab",a)},editClick:function(a){var c=a.attr("href").replace(/.*#\/product\/(\d+|new)\/edit\//,"").replace(/\/$/,"").split("/"),d=[];if(c.length){b.shop.trace("$.product.editClick",c);for(var e,f="editTab";e=c.shift();)if(f+=e.substr(0,1).toUpperCase()+e.substr(1),e="function"==typeof this[f],b.shop.trace("$.settings.featuresClick try",
[f,e,c]),!0===e){var g=f;d=c.slice(0)}}if(g){if(b.shop.trace("$.product.editClick",[g,d]),!a.hasClass("js-confirm")||confirm(a.attr("title")||"Are you sure?")){d.push(a);try{this[g].apply(this,d)}catch(h){b.shop.error("Error: "+h.message,h)}}}else b.shop.error("Not found js handler for link",[g,a]);return!1},switchSubMenu:function(a){a=a||"default";b("#mainmenu .s-submenu > *").hide();b("#mainmenu .s-submenu .s-submenu-"+a).show()},profileFocus:function(){var a=this.options.duration,c=this;b("#s-product-edit-menu, #s-product-edit-save-panel").hide();
...
document.body&&(b("body > #s-product-type").remove(),b(document.body).append(b(this)))});var c=b("#s-product-edit-forms .s-product-form.main"),d=this,e=c.find("table.s-product-skus:last > tbody");e.sortable({distance:5,helper:"original",items:"> tr",handle:"i.sort",opacity:.75,tolerance:"pointer",update:function(a,c){a=parseInt(b(c.item).data("id"),10);c=b(c.item).prev().data("id");c=void 0===c?0:parseInt(c,10);d.editTabMainSkuSort(a,c,b(this));c=e.find('> tr.js-sku-settings[data-id="'+a+'"]');c.length&&
(c=c.detach(),b.shop.trace("detach",c),c&&(b.shop.trace("detach",e.find('> tr[data-id="'+a+'"]').length),e.find('> tr[data-id="'+a+'"]:first').after(c)))},start:function(b,a){e.find("> tr.js-sku-settings").hide()},stop:function(b,a){e.find("> tr.js-sku-settings").show()}});var f=b("#s-product-frontend-url");f.inlineEditable({editLink:"#s-product-frontend-url-edit-link",editOnItself:!1,minSize:{height:15,width:100},makeReadableBy:[],beforeMakeEditable:function(a){var c=b(this).closest("span.s-product-frontend-url-not-empty"),
d=c.find("span.slash"),e=c.find("i.new-window");b(a).after(d);e.hide();c.find("a.s-frontend-base-url").hide();c.find("span.s-frontend-base-url").show()},beforeBackReadable:function(a,c){a=b(this).closest("span.s-product-frontend-url-not-empty");c=a.find("span.slash");a.find("i.new-window").show();a.find("span.s-frontend-base-url").hide();a.find("a.s-frontend-base-url").show().append(c)}});parseInt(a.id,10)||f.trigger("editable");"new"==a.id&&b.product_list&&b.isArray(b.product_list.collection_hash)&&
...
var g=this;this.data.url_helper.timer=setTimeout(function(){g.urlHelper(a,e,d)},d||500)}},onChange:function(a){var c=this.getContainerId(a),d=this;this.checkChanges(a.parents("form"),!1,function(e){b("#s-product-edit-save-panel :submit").removeClass(e?"green":"yellow").addClass(e?"yellow":"green");if(e)d.checkChanges(a,!1,function(b){d.onTabChanged(c,b)});else d.onTabChanged(c,e)})},urlHelper:function(a,c){this.data.url_helper.timer&&clearTimeout(this.data.url_helper.timer);a={name:b(a).val()};b.shop.trace("$.product.urlHelper ",
a);if(a.url!=this.data.url_helper.name){var d=this;this.data.url_helper.url=a.url;b.getJSON("?module=product&action=suggestUrl",a,function(a){"ok"===a.status&&(d.data.url_helper.url=a.data.url,c.val(a.data.url),c.parent().find(".js-url-helper").hide(),b.product.informAboutUrlInUse(a.data.in_use))})}else c.parent().find(".js-url-helper").hide()},getValueByName:function(a,c){for(var d=a,e=c.replace(/\]/,"").split("[");e.shift();)if(void 0!==d[c])d=d[c];else{d="";break}b.shop.trace("$.product.helper.getValueByName",
[d,c,a]);return d},checkChangesStack:{},checkChanges:function(a,c,d){var e=a.attr("id");this.checkChangesStack[e]&&(clearTimeout(this.checkChangesStack[e]),this.checkChangesStack[e]=null);b.shop.trace("$.product.helper.checkChanges",[a,c]);var f=this;this.checkChangesStack[e]=setTimeout(function(){var b=f.checkChangesDelayed(a,c);d&&d(b)},c?50:500)},checkChangesDelayed:function(a,c){var d=this.options.defaultChangedStatus,e=this,f=":input:not(.js-ignore-change)";if(a.hasClass("s-product-form")){if(a.hasClass("ajax"))return!1}else f=
".s-product-form:not(.ajax) "+f;a.find(f).each(function(){var a=(b(this).attr("type")||this.tagName).toLowerCase();switch(a){case "input":case "text":case "textarea":if(b(this).hasClass("ace_text-input"))break;this.defaultValue!=this.value&&(d=!0,c&&(this.defaultValue=this.value,e.updateInput(this.name,this.value,"textarea"==a)));break;case "radio":case "checkbox":this.defaultChecked!=this.checked&&(d=!0,c&&(this.defaultChecked=this.checked));break;case "select":this.length&&b(this).find("option").each(function(){this.defaultSelected!=
this.selected&&(d=!0,c&&(this.defaultSelected=this.selected));return c||!d});break;case "file":this.value&&(d=!0,c&&(this.value=null));break;case "reset":case "button":case "submit":break;case "hidden":if(b(this).closest(".s-selling-mode").length&&b(this).attr("data-value")&&(a=b(this).attr("data-value"),b(this).attr("disabled")?b(this).attr("data-value","empty"):b(this).attr("data-value",a),b(this).attr("data-value")!=this.value))return d=!0,c&&b(this).attr("data-value",this.value),c||!d;break;default:b.shop.error("$.product.checkChangesDelayed unsupported type "+
...
(a=b(f).attr("name"),a=a.replaceAll(/\[-[\d]+\]/,"["+e+"]"),b.shop.trace("$.product.helper.updateInput name",[a]))}},count:function(b){var a=0,d;for(d in b)b.hasOwnProperty(d)&&a++;return a}},multiSkus:function(a){var c=b("#s-product-edit-forms .s-product-form.main table.s-product-skus:first");1<a?(c.find("thead tr th.s-sku-sort").show(),c.find(".s-name,.s-sku-sort").show("slow"),c.find(".delete").parent("a").show(),2==a?c.find("> tbody:first > tr:first .s-name :input").focus():c.find("> tbody:first > tr:last .s-name :input").focus()):
(c.find("thead tr th.s-sku-sort").hide(),c.find(".s-name,.s-sku-sort").hide(),c.find(".delete").parent("a").hide(),c.find(".s-sku-big").removeClass("s-sku-big"))},editTabMainSkuAdd:function(){try{var a=b("#s-product-edit-forms .s-product-form.main table.s-product-skus:first").find("tbody:first"),c=0,d="0";a.find(':input[name$="[price]"]').each(function(){var a=b(this),e=a.val()?a.val().replace(",","."):0;e=parseFloat(e);e>c&&(c=e,d=a.val()||"0")});var e=0;a.find(':input[name$="[purchase_price]"]').each(function(){e=
Math.max(e,parseFloat(b(this).val())||0)});b.product.multiSkus(a.find("tr:not(.js-sku-settings)").length+1);var f={id:--b.product.editTabMainData.sku_id,product_id:b('input:hidden[name="product[id]"]').val()||"new",sku:"",available:1,name:"",price:""+c,price_loc:d,purchase_price:""+e,stock_icon:{0:"<i class='icon10 status-green' ></i>"},stock:{},count:null};b.shop.trace("$.product.editTabMainSkuAdd",[b.product.editTabMainData.sku_id,f]);a.append(tmpl("template-sku-edit",{sku_id:b.product.editTabMainData.sku_id,
...
a+'"]').remove();b.product.multiSkus(d.find("tr:not(.js-sku-settings)").length)})):f.refresh("error",$_("A product must have at least one SKU."))}else e.hide("normal",function(){e.remove();b('#s-product-view table.s-product-skus > tbody >tr[data-id="'+a+'"]').remove();b.product.multiSkus(d.find("tr:not(.js-sku-settings)").length)})},editTabMainCategoriesAdd:function(){var a=b("#s-product-edit-forms .s-product-form.main select.s-product-categories:last").parent("div"),c=a.clone(!1);c.find("select").val("select").attr("disabled",
...
c=d.data();var e=this;b.when(d.after(tmpl("template-sku-settings",{sku_id:a,sku:c}))).done(function(){var c="?module=product&action=skuSettings&product_id="+e.path.id;c+="&sku_id="+a;var g=b('#s-product-edit-forms .s-product-form.main tr.js-sku-settings[data-id="'+a+'"] > td:first');g.load(c,function(){d.find(':input[name$="[available]"]').remove();b.product_images&&b.product_images.options&&b.product_images.options.enable_2x&&b.fn.retina&&g.find(".s-product-image-crops img").retina();if(0<a){b.shop.trace("fileupload",
[g.find(".fileupload").length,typeof g.find(".fileupload").fileupload]);try{var c=document.cookie.match(/(?:^|; )_csrf=([^;]*)/),e=c?decodeURIComponent(c[1]):"";g.find(".fileupload:first").fileupload({dropZone:null,url:"?module=product&action=skuEproductUpload",acceptFileTypes:/(\.|\/)(gif|jpe?g|png)$/i,start:function(){g.find(".fileupload:first").hide()},progress:function(a,c){b.shop.trace("fileupload progress",c);a=g.find(".js-progressbar-container");a.show();a.find(".progressbar-inner:first").css("width",
Math.round(100*c.loaded/c.total,0)+"%")},done:function(a,c){b.shop.trace("fileupload done",[c.result,typeof c.result]);a=(c.result.files||[]).shift();g.find(".js-progressbar-container").hide();!a||a.error?(g.find(".error-message").text(a.error).show(),g.find(".fileupload:first").addClass("error").show()):(c=g.find(".s-sku-attachment"),c.find("input.s-input-file-name").val(a.name),c.find(".s-file-name").text(a.name),c.find(".s-file-size").text(a.size),c.find(".s-file-description").val(""),c.find("input[type=checkbox]").attr("checked",
!0),c.show(),d.find("input.s-input-virtual").val(0))},fail:function(a,c){b.shop.trace("fileupload fail",[c.textStatus,c.errorThrown]);g.find(".error-message").text("error").show().text(c.errorThrown||"error");g.find(".js-progressbar-container").hide();g.find(".fileupload:first").addClass("error").show()},formData:{product_id:b.product.path.id,sku_id:a,_csrf:e}})}catch(l){b.shop.error("Exception "+l.message,l)}}})})},editTabMainSkuImageSelect:function(a,c,d){a=d.parents("li:first");var e=a.hasClass("selected"),
f=d.parents("div.value:first");f.find("ul.s-product-image-crops li.selected").removeClass("selected");e?f.find('input[name$="[image_id]"]').val(0):(a.addClass("selected"),f.find('input[name$="[image_id]"]').val(c));b.shop.trace("$.product.editTabMainSkuImageSelect",[f,f.find(':input[name$="[image_id]"]')]);b.product.helper.onChange(d.parents("div.s-product-form"))},editTabMainSkuEproductSave:function(a){a=b("#s-product-edit-forms .s-product-form.main tr.js-sku-settings"+(a&&0<a?'[data-id="'+a+'"]':
"")+" > td:first .fileupload");b.shop.trace("$.product.editTabMainSkuEproductSave",a.length);a.length&&a.fileupload("start")},editTabMainSkuEproductDelete:function(b){},editTabMainLinkEdit:function(b){return!1},editTabMainTypeSelect:function(b){var a=b.parents("form").find(':input[name="product[type_id]"]').parents(".value");"main"==this.path.tab?b.hide():(a.find(".js-action").hide(),window.location.hash="/product/"+this.path.id+"/"+this.path.mode+"/");a.find(".js-type-name").hide();a.find(":input").show().focus();
setTimeout(function(){a.find(":input").focus()},100)},editTabMainTypeChange:function(a){var c=a.parents(".value"),d=a.find(":selected:first"),e=d.val();a=parseInt(d.data("sku-type"));c.find(".js-type-icon").html(d.data("icon"));c.find(".js-type-name").html(d.text());e!=c.data("type")?b("#s-product-edit-forms .s-product-form.features").length&&"undefined"!=typeof this.editTabFeaturesReload?this.editTabFeaturesReload(e):(c=b("#s-product-edit-menu > li.features > a"),e="/features/"+e+"/",c.attr("href",
c.attr("href").replace(/\/features\/.*$/,e))):(c=b("#s-product-edit-menu > li.features > a"),e="/features/",c.attr("href",c.attr("href").replace(/\/features\/.*$/,e)));c=b(this.options.form_selector+' :input[name="product[sku_type]"]');b.shop.trace("sku_type",[a,c]);c.filter('[value="1"]').trigger("disabled",[a?null:!0]);e=c.parents("ul");a?(c.filter(":checked").change(),e.find('[data-sku-type="1"]').hide()):(c.filter('[value="0"]').trigger("checked",!0).change(),e.find('[data-sku-type="1"]').show())},
editTabMainUpdate:function(a,c,d){var e=b("#s-product-edit-forms .s-product-form.main table.s-product-skus tbody"),f=b("#s-product-view table.s-product-skus tbody");e.find('tr[data-id^="-"]').remove();f.find('tr[data-id^="-"]').remove();e.parents("table").find("tr:hidden").show();var g=[];for(h in a.skus||{})g.push(b.extend({id:h},a.skus[h]));g=g.sort(function(b,a){return b.sort-a.sort});var h=this.getData("main","stocks");var k=this.getData("main","stock_ids"),l="";tmpl.cache["template-sku-edit"]=
tmpl(tmpl.load("template-sku-edit"));for(var n=0,r=g.length;n<r;n+=1)l+=tmpl("template-sku-edit",{sku_id:g[n].id,sku:g[n],hide_sort_column:1>=r,stocks:h,stock_ids:k,checked:g[n].id==a.sku_id});e.html(l);e.find("select.s-product-currency").val(a.currency);e.parent().show();e.closest(".s-sku-list").show();this.multiSkus(e.find("tr:not(.js-sku-settings)").length);l="";n=0;for(r=g.length;n<r;n+=1)l+=tmpl("template-sku",{sku_id:g[n].id,sku:g[n],stocks:h,stock_ids:k,runout:a.runout||{}});f.html(l);d&&"new"!=
d||e.parents("div.field-group:first").after(b("#s-sku-type-field-group"));c&&(d=b("#s-product-feature-superposition .superposition-count"),d.find(".options").text(c.options),d.find(".skus").html('<span class="highlighted">'+c.skus+"</span>"));var t=/#\/product\/new\//,m="#/product/"+a.id+"/";b("#s-product-edit-forms .s-product-form.main table.s-product-skus tbody, #s-product-view table.s-product-skus tbody").find('[href*="#/product/new/"]').each(function(){b(this).attr("href",b(this).attr("href").replace(t,
m))})},editTabDescriptionsBlur:function(){var a=b("#s-product-description-content");a.length&&a.data("redactor")&&a.waEditor("sync")},editTabDescriptionsAction:function(){var a=b("#s-product-description-content");if(a.length&&!a.data("redactor")){var c=a.parents("div.s-product-form");a.waEditor({lang:wa_lang,modification_wysiwyg_msg:a.data("modification-wysiwyg-msg"),toolbarFixedTopOffset:b("#mainmenu").length?b("#mainmenu").height():0,imageUploadFields:a.data("uploadFields"),saveButton:b("#s-product-save-button"),
callbacks:{change:function(){a.length&&(a.waEditor("sync"),b.product.helper.onChange(c))},keydown:function(a){if("115"!=a.which&&"83"!=a.which||!a.ctrlKey&&!a.metaKey)b.product.helper.onChange(c);else return a.preventDefault(),b("#s-product-save-button").click(),!1}}})}},profileInit:function(){void 0!==b.product_list&&void 0!==b.product_list.fixed_blocks&&(b.product_list.fixed_blocks.set&&b.product_list.fixed_blocks.set.unsetFixed(),b.product_list.fixed_blocks.category&&b.product_list.fixed_blocks.category.unsetFixed());
if(this.options.edit_rights){var a=b("#shop-productprofile").find(".s-product-name");parseInt(this.path.id,10)?a.addClass("editable"):a.removeClass("editable");var c=this.get("form");a.inlineEditable({minSize:{width:150},maxSize:{width:550},inputClass:"s-title-h1-edit",beforeMakeEditable:function(){b("#s-edit-product").hide()},afterBackReadable:function(a,e){b("#s-edit-product").show();if(!e.changed)return!1;b.shop.jsonPost("?module=product&action=save&id="+b.product.path.id,{update:{name:b(a).val()}},
function(d){var e=b(a).val();document.title=e+b.product.options.title_suffix;"ok"===d.status&&d.data&&b("#s-product-meta-title").attr("placeholder",d.data.default_meta_title);c.find('input[name="product[name]"]').val(e)})},hold:function(){return!b(this).hasClass("editable")}})}this.call("profileLazyInit",[])},profileLazyInit:function(){var a=b("#product-sales-plot");if(window.sales_data&&sales_data.length){if(!a.data("graph_rendered")){var c=function(){a.length&&0<a.width()?(showSalesGraph(sales_data,
"undefined"==typeof cash_type?null:cash_type),a.data("graph_rendered",1)):setTimeout(c,1E3)};c()}}else a.remove();if(sku_plot_data&&sku_plot_data.length&&sku_plot_data[0]&&sku_plot_data[0].length){if(!b("#product-sku-plot").data("graph_rendered")){var d=[];b.each(sku_plot_data[0],function(b,a){d.push({label:a[0],value:a[1]})});showPieGraph(d,{color_type:"products"});b("#product-sku-plot").data("graph_rendered",1)}}else b("#product-sku-plot").remove()},updateMetaFields:function(){var a=b(".s-product-name-input").val();
...
a.auto?"wake":"stop",hash:"stocks",load:function(){b(window).lazyLoad("sleep");b(".lazyloading-link").hide();b(".lazyloading-progress").show();var a=function(a){console&&(a&&a.errors?console.error("Error when loading products: "+a.errors):a&&a.responseText?console.error("Error when loading products: "+a.responseText):console.error(a));b(window).lazyLoad("stop")};b.get("?module=stocksBalance&offset="+c+"&total_count="+d+(e.options.order?"&order="+e.options.order:""),function(f){f&&"ok"==f.status?(c+=
f.data.count,e.append({product_stocks:f.data.product_stocks,stocks:e.stocks})?(b(".lazyloading-progress-string").text(f.data.progress.loaded+" "+f.data.progress.of),b(".lazyloading-progress").hide(),b(".lazyloading-chunk").text(f.data.progress.chunk),c>=d?(b(window).lazyLoad("stop"),b(".lazyloading-link").hide()):(b(".lazyloading-link").show(),b(window).lazyLoad("wake"))):b(window).lazyLoad("stop")):a(f)},"json").error(a)}});b(".lazyloading-link").die("click").live("click",function(){b(window).lazyLoad("force");
...
if(d&&a.view){try{this.container.append(tmpl("template-product-list-"+this.options.view,{products:d,sort:this.sort,primary_currency:this.options.primary_currency,stocks:this.options.stocks},"thumbs"!=this.options.view)),this.container.trigger("append_product_list",[d])}catch(f){return console.log("Error: "+f.message),this}delete a.products}b.isArray(this.options.collection_hash)&&this.options.collection_hash.length?this.collection_hash=this.options.collection_hash:this.collection_hash=[];this.collection_param=
this.options.collection_param?this.options.collection_param:"";a.order&&(this.order=a.order);if(this.options.lazy_loading)this.initLazyLoad(this.options.lazy_loading);else{var e=c.replace(/&page=\d+/,"")+"&page=";b(".pagination a").each(function(){var a=b(this).attr("href").match(/\?page=(\d+)/);b(this).attr("href",e+(a?a[1]:1))})}this.initSelecting();this.initView(this.options.view);this.initDragndrop();this.rubberTable();"table"==this.options.view&&this.initInlineEditor()}catch(f){b.shop.error("$.product_list.init error: "+
f.message,f)}return this},initLazyLoad:function(a){var c=a.count,d=this.total_count;b(window).lazyLoad("stop");if(c<d){var e=this,f=e.container.find("tr.header th[data-additional-column]").map(function(){return b(this).data("additional-column")}).get().join(",");b(window).lazyLoad({container:e.container,state:"undefined"===typeof a.auto||a.auto?"wake":"stop",hash:["","products"],load:function(){b(window).lazyLoad("sleep");b(".lazyloading-link").hide();b(".lazyloading-progress").show();b.get("?module=products&action=loadList&offset="+
c+("&total_count="+d)+(e.collection_param?"&"+e.collection_param:"")+(e.sort?"&sort="+e.sort:"")+(e.order?"&order="+e.order:"")+("&enabled_columns="+(f||"")),function(a){if("ok"==a.status&&a.data.count){c+=a.data.count;var f=e.container;try{e.container.append(tmpl("template-product-list-"+e.options.view,{products:a.data.products,check_all:f.find(".s-select-all:first").length?f.find(".s-select-all:first").attr("checked"):!1,sort:b.product_list.sort,primary_currency:b.product_list.options.primary_currency,
stocks:b.product_list.options.stocks})),e.container.trigger("append_product_list",[a.data.products])}catch(k){console.log("Error: "+k.message);b(window).lazyLoad("stop");return}f.find(".last").removeClass("last");f.find(".product:last").addClass("last");b(".lazyloading-progress-string").text(a.data.progress.loaded+" "+a.data.progress.of);b(".lazyloading-progress").hide();b(".lazyloading-chunk").text(a.data.progress.chunk);c>=d?(b(window).lazyLoad("stop"),b(".lazyloading-link").hide()):(b(".lazyloading-link").show(),
b(window).lazyLoad("wake"))}else a.data&&!a.data.count?console&&(console.log("Count of again loaded products is 0"),b(".lazyloading-progress").hide()):(a.errors&&console&&console.log("Error when loading products: "+a.errors),b(window).lazyLoad("stop"))},"json")}});b(".lazyloading-link").die("click").live("click",function(){b(window).lazyLoad("force");return!1})}},initSelecting:function(){var a=this.container,c=this.toolbar.find(".count"),d=a.find(".s-select-all:first"),e=function(){var b=parseInt(a.find("> .product.selected").length,
10);b?c.text(b).show():c.text("").hide()};b(document).keydown(function(a){16!=a.keyCode||b(a.target).closest(".redactor-box").length||(document.body.onselectstart=function(){return!1})}).keyup(function(a){16==a.keyCode&&(document.body.onselectstart=null)});a.off("select",".product").on("select",".product",function(a,c,h){h=void 0!==h?h:!0;(void 0!==c?c:1)?b(this).addClass("selected").find("input:first").attr("checked",!0):(b(this).removeClass("selected").find("input:first").attr("checked",!1),d.is(":checked")&&
d.attr("checked",!1));h&&e();return!1});d.unbind("select").bind("select",function(d,e){e=void 0!==e?e:!0;d=b(this);e?(d.attr("checked",!0),a.find("> .product").trigger("select",!0,!1),c.text(d.attr("data-count")).show()):(d.attr("checked",!1),a.find("> .product").trigger("select",!1,!1),c.text("").hide())});a.off("click",".product input").on("click",".product input",function(c,g){var f=c.shiftKey;c=this.checked;g&&(f=g.shiftKey,c=g.checked);g=b(this).parents(".product:first");c?g.addClass("selected"):
(d.is(":checked")&&d.attr("checked",!1),g.removeClass("selected"));if(f&&c){(f=a.data("last_checked"))||(f=a.find("> .product:first").trigger("select",!0));var k=g.prevAll(".selected[data-product-id="+f.attr("data-product-id")+"]");if(k.length){var l=g.prev();for(f=f.get(0);l.length&&f!=l.get(0);)l.addClass("selected").find("input").attr("checked",!0),l=l.prev()}else if(k=g.nextAll(".selected[data-product-id="+f.attr("data-product-id")+"]"),k.length)for(l=g.next(),f=f.get(0);l.length&&f!=l.get(0);)l.addClass("selected").find("input").attr("checked",
!0),l=l.next();a.data("last_checked")||k.length||f.trigger("selected",!1)}c&&a.data("last_checked",g);e()});if(b.browser.mozilla)a.off("click",".product label").on("click",".product label",function(a){if(a.shiftKey){var c=b(a.target);b(c).is("label")||(c=b(c).parents("label:first"));c=b("#"+c.attr("for"));c.trigger("click",{shiftKey:a.shiftKey,checked:!c.attr("checked")})}})},initView:function(a){try{var c=this.container,d=this.sidebar;c.find(".s-select-all:first").length&&c.find(".s-select-all:first").click(function(){b(this).trigger("select",
this.checked)});"table"==a&&(b("#s-content .list-view-mode-table").click(function(){c.toggleClass("single-lined");b.storage.set("shop/product_list/multi-lined",!c.hasClass("single-lined"));return!1}),b.storage.get("shop/product_list/multi-lined")&&c.removeClass("single-lined"));var e="view="+a;d.find(".s-collection-list li.dr").each(function(){var a=b(this);a.find("a:first").attr("href","#/products/"+a.attr("id").replace("-","_id=")+"&"+e)});b("#s-products-search").autocomplete("disable").val(this.options.text||
"").autocomplete("enable");var f="s-all-products";b.product_list.collection_hash.length&&"search"!==b.product_list.collection_hash[0]&&"tag"!==b.product_list.collection_hash[0]&&(f=b.product_list.collection_hash.join("-"));b.shop.trace("$.product_list.initView",[a,f]);d.find("li.selected").removeClass("selected");var g=d.find("#"+f);0>=g.length&&window.location.hash&&(g=d.find('a[href="'+window.location.hash+'"]').parent());0>=g.length&&(g=d.find("#s-all-products"));g.addClass("selected");b.product_list.collection_hash.length&&
"search"!==b.product_list.collection_hash[0]&&"tag"!==b.product_list.collection_hash[0]&&g.find(".count:first").text(this.category_count);b.product_list.fixed_blocks=b.product_list.initFixedBlocks();this.initEditingControls();this.initToolbar();b(document).trigger("product_list_init_view")}catch(h){b.shop.error("$.product_list.initView error: "+h.message,h)}},highlightInlineEditorCells:function(){b.product_list.container.find("tr").each(function(){var a=b(this),c=a.data("edit-rights");c&&a.data("min-price")==
a.data("max-price")||a.find(".s-product-price .editable").filter(function(){return!b(this).data("plugin")}).addClass("not-editable");c&&1==a.data("sku-count")||a.find(".s-product-stock .editable").filter(function(){return!b(this).data("plugin")}).addClass("not-editable")})},initInlineEditor:function(){function a(a,b){if(a.data("denied-reason")==b)a.data("denied-reason",""),alert(b);else{a.data("denied-reason",b);setTimeout(function(){a.data("denied-reason","")},3E3);a.wrapInner('<div class="animation-container" style="position:relative;"></div>');
var c=a.find(".animation-container").animate({left:"3px"},100,function(){c.animate({left:"0px"},100,function(){c.animate({left:"3px"},100,function(){c.animate({left:"0px"},100,function(){c.children().first().unwrap()})})})})}}function c(a){var c=[];b.product_list.container.find("tr.product").each(function(){var a=b(this);void 0===a.data("original-price")&&a.data("edit-rights")&&c.push(b(this).data("product-id"))});if(!c.length)return a();b.post("?module=products&action=inlineEditorData",{ids:c},function(c){c.data&&
b.product_list.container.find("tr.product").each(function(){var a=b(this),d=c.data[parseInt(a.data("product-id"),10)];d&&(a.data("stocks",d.stocks||null),a.data("original-price",d.price.replace(/\.?0+$/g,"")))});a()},"json")}var d=this;b.product_list.highlightInlineEditorCells();b.product_list.container.on("append_product_list",function(){b.product_list.highlightInlineEditorCells()});b.product_list.container.on("click",".s-product-price,.s-product-stock",function(){function e(){if(h)f.html(tmpl("template-list-price-editor-one",
{product_id:g.data("product-id"),currency:g.data("currency"),value:g.data("original-price")}));else{var a=g.data("stocks");a&&"object"==typeof a?f.html(tmpl("template-list-stock-editor-many",{product_id:g.data("product-id"),values:a})):f.html(tmpl("template-list-stock-editor-one",{product_id:g.data("product-id"),value:a||""}))}f.find(".cancel").click(function(){var a=f;a.removeClass("editor-on").html(a.data("read-only-state-html"));a.data("read-only-state-html","");a.data("denied-reason","")});var c=
f.find("form").submit(function(){if(c.find(".loading").length)return!1;c.find(":submit").after('<i class="icon16 loading"></i>');b.post("?module=products&action=inlineSave",c.serialize(),function(a){c.find(".loading").remove();try{a.data&&a.data[0]&&(a.data[0].alien=g.hasClass("s-alien"));var e=b("<table>").html(tmpl("template-product-list-table",{products:a.data,check_all:b.product_list.container.find(".s-select-all:first").prop("checked"),sort:b.product_list.sort}));g.replaceWith(e.find("tr"));
d.container.trigger("append_product_list",[a.data])}catch(t){console.log("Error: "+t.message)}},"json");return!1});c.on("dblclick",!1);setTimeout(function(){f.find(":input:visible:first").focus()},0)}var f=b(this);if(!f.data("plugin")){var g=f.closest("tr"),h=f.hasClass("s-product-price");if(h){if(g.data("min-price")!=g.data("max-price"))return a(f,$_("Inline editing is available only for products with a single SKU"))}else if("1"!=g.data("sku-count"))return a(f,$_("Inline editing is available only for products with a single SKU"));
if(!g.data("edit-rights"))return a(f,$_("Insufficient access rights"));f.hasClass("editor-on")||(f.addClass("editor-on").data("read-only-state-html",f.html()),b.product_list.container.removeClass("single-lined"),void 0!==g.data("original-price")?e():(f.html('<i class="icon16 loading"></i>'),c(e)))}})},initFixedBlocks:function(){var a=b("#mainmenu").height(),c=b("#s-sidebar").width(),d=b(window),e=b("#s-fixed-blocks");e.length||(e=b('<div id="s-fixed-blocks"></div>').css({display:"none",position:"fixed",
background:"#fff",top:a,width:c,"float":"left"}).appendTo("#s-sidebar"));var f=b("#s-category-list"),g=b("#s-category-list-block"),h=b("#s-set-list"),k=b("#s-set-list-block"),l=function(){function h(){if(!l){var h=b("#s-category-list-handler");u=b.categories_tree.isCollapsed(h);q=f.is(":hidden");var k=b('<div id="s-category-list-dummy" class="block"></div>').css({height:g.height()});g.replaceWith(k);e.show().append(g.hide());g.find(".heading").before('<span class="hint float-right" style="margin-top: 3px;">'+
$_("Drag products here")+"</span>");u&&b.categories_tree.expand(h,null,function(){b.categories_tree.collapse(h)});q||f.hide();g.show();b("i.add",g).hide();b("#s-category-list-handler").hide();g.css({"overflow-x":"hidden","overflow-y":"auto"});(function(){var b=f.is(":hidden"),e;g.bind("mousemove.fixed_blocks.category",function(c){document.getElementById("products-helper")&&b&&(e&&(clearTimeout(e),e=null),e=setTimeout(function(){if(b){g.css({height:""});f.show();var c=g.height(),e=(d.height()-a)/2;
g.css({height:Math.min(c,e)});g.find(".heading").prev(".hint").hide();b=!1}},250))});d.bind("mouseout.fixed_blocks.category",function(a){a.pageX>c+10&&(e&&clearTimeout(e),e=null,b||(f.hide(),g.css({height:""}),g.find(".heading").prev(".hint").show(),b=!0))})})();l=!0}}function k(){if(l){var a=b("#s-category-list-dummy");a.replaceWith(g);g.css({"overflow-x":"","overflow-y":""});var c=b("#s-category-list-handler");u&&b.categories_tree.collapse(c);q||f.show();g.find(".heading").prev(".hint").remove();
b("#s-category-list-handler").show();b("i.add",g).show();a.remove();g.unbind("mousemove.fixed_blocks.category");d.unbind("mouseout.fixed_blocks.category");e.children().length||e.hide();l=!1;b.categories_tree.init()}}var n=g.offset().top,l=!1,q,u;d.unbind("scroll.fixed_blocks.category").bind("scroll.fixed_blocks.category",function(){l||(n=g.offset().top);var c=n;c=document.getElementById("s-category-list-dummy")?c+b("#s-category-list-dummy").height():c+b("#s-category-list-block").height();d.scrollTop()+
a+5>=c?h():k()});return{setFixed:h,unsetFixed:k}}(),n=function(){function f(){if(!q){l=h.is(":hidden");var f=b('<div id="s-set-list-dummy" class="block"></div>').css({height:k.height()});k.replaceWith(f);e.show().append(k);k.find(".heading").before('<span class="hint float-right" style="margin-top: 3px;">'+$_("Drag products here")+"</span>");l||h.hide();b("i.add",k).hide();b("i.collapse-handler",k).hide();k.css({"overflow-x":"hidden","overflow-y":"auto"});(function(){var b=h.is(":hidden"),e;k.bind("mousemove.fixed_blocks.set",
function(c){document.getElementById("products-helper")&&b&&(e&&(clearTimeout(e),e=null),e=setTimeout(function(){if(b){k.css({height:""});h.show();var c=k.height(),e=(d.height()-a)/2;k.css({height:Math.min(c,e)});k.find(".heading").prev(".hint").hide();b=!1}},250))});d.bind("mouseout.fixed_blocks.set",function(a){a.pageX>c+10&&(e&&clearTimeout(e),e=null,b||(h.hide(),k.css({height:""}),k.find(".heading").prev(".hint").show(),b=!0))})})();q=!0}}function g(){if(q){var a=b("#s-set-list-dummy");a.replaceWith(k);
k.css({"overflow-x":"","overflow-y":""});k.find(".heading").prev(".hint").remove();l||h.show();b("i.add",k).show();b("i.collapse-handler",k).show();a.remove();k.unbind("mousemove.fixed_blocks.category");d.unbind("mouseout.fixed_blocks.category");e.children().length||e.hide();q=!1}}var n=k.offset().top,l,q=!1;d.unbind("scroll.fixed_blocks.set").bind("scroll.fixed_blocks.set",function(){q||(n=k.offset().top);var c=n;c=document.getElementById("s-set-list-dummy")?c+b("#s-set-list-dummy").height():c+b("#s-set-list-block").height();
d.scrollTop()+a+5>=c?f():g()});return{setFixed:f,unsetFixed:g}}();return{category:l,set:n}},initEditingControls:function(){var a=b("#s-product-list-title"),c=b.product_list.collection_hash[0],d="?module=category&action=save&";"set"===c&&(d="?module=set&action=save&");a.hasClass("editable")&&(a.inlineEditable({minSize:{width:350},maxSize:{width:600},size:{height:30},inputClass:"s-title-h1-edit",beforeMakeEditable:function(){b(".s-product-list-manage").hide()},afterBackReadable:function(a,f){b(".s-product-list-manage").show();
if(!f.changed)return!1;b.shop.jsonPost(d+b.product_list.collection_param+"&edit=name",{name:b(a).val()},function(a){b.product_list.sidebar.find("#"+c+"-"+a.data.id).find(".name:first").html(a.data.name)})}}),"name"==this.options.edit&&a.trigger("editable"));a=b("#s-product-list-settings");!a.length||"category"!=c&&"set"!=c||a.unbind("click").bind("click",function(){"category"==c?shopDialogProductsCategory.staticDialog(b.product_list.collection_hash[1],null,"edit"):shopDialogProductsSet.staticDialog(b.product_list.collection_hash[1],
"edit");return!1});a=b("#s-product-list-delete");!a.length||"category"!=c&&"set"!=c||a.unbind("click").bind("click",function(){b("#s-product-list-delete-dialog").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){b(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(){function a(b,c){if(!b.length)return c&&c();var e=b.shift();d(["category",e],function(){a(b,c)})}function d(a,c){var d={hash:a.join("/")||"all",remove:["list"]};l&&d.remove.push("products");var e=function(){b.product_list.remove(d,
function(d,e){g(a,d);b.product_list.sidebar.trigger("update",d.data.lists);c&&c()})},f=b("#"+a.join("-")+"-handler");f.length?b.categories_tree.expand(f,function(a){a.parent().find("ul:first").hide();e()}):e();return!1}function g(a,c){var d=a[0],e=b("#"+a.join("-")),f=e.prev(".drag-newposition");a=b("#s-"+a[0]+"-list");var g=a.find("ul:first");"set"==d?(e.remove(),f.remove()):(d=e.find("ul:first"),d.length&&(d.find(">li.drag-newposition:first").remove(),e.hide(),d.find(">li").each(function(){e.after(this)})),
d=e.parents("ul:first"),e.remove(),f.remove(),d.find("li.dr").length||(g.get(0)!=d.get(0)?(d.parents("li:first").find("i.collapse-handler").remove(),d.closest("li").find(".collapse-handler-ajax:first").remove(),d.remove()):g.closest(".block").find(".collapse-handler-ajax:first").remove()));g.find("li.dr:first").length?(g.show(),a.find(".s-empty-list").hide()):(g.hide(),a.find(".s-empty-list").show());c.data.old_parent_category&&"undefined"!==typeof c.data.old_parent_category.children_count&&!parseInt(c.data.old_parent_category.children_count,
10)&&b("#category-"+c.data.old_parent_category.id+"-handler").remove()}var h=b(this),k=parseInt(b.product_list.collection_hash[1]);h.find(".dialog-buttons i.loading").show();var l="1"==h.find("input[name=s-delete-products]:checked").val();"category"==c&&h.find('input[name="s-delete-sub"]').is(":checked")?b.get("?action=categoryExpand&tree=1&recurse=1&id="+k,function(c){c=b("<div>").html(c).find('li[id^="category-"]').map(function(){return parseInt(this.id.substr(9),10)}).get().reverse();c.push(k);
a(c,function(){location.href="#/"})}):d(b.product_list.collection_hash,function(){location.href="#/"});return!1}});return!1});"set"===c&&b("#s-embed-code").click(function(){b("#s-product-list-embed-dialog").waDialog();return!1})},initDragndrop:function(){b.product_dragndrop.init({products:!0,view:this.options.view,sort:this.options.sort}).bind("move_product",function(a){b.shop.jsonPost("?module=product&action=move&"+b.product_list.collection_param,{product_ids:a.product_ids,before_id:a.before_id||
null},a.success,a.error)}).bind("is_product_sortable",function(){return b.product_list.sortable}).bind("add_to_list",function(a){var c={};a.whole_list?c.hash=b.product_list.collection_hash.join("/")||"all":c.product_id=a.product_ids;b.shop.jsonPost("?module=product&action=addToList&"+a.collection_param,c,a.success,a.error)})},initToolbar:function(){var a=this.toolbar;a.find("li").unbind("click.product_list").bind("click.product_list",function(){var a=b(this),d=a.attr("data-action");if(d){var e=b.product_list.getSelectedProducts("delete"!=
d);if(!e.count)return alert($_("Please select at least one product")),!1;switch(d){case "new-set":break;case "category":b.product_list.categoriesDialog(e);break;case "set":b.product_list.setsDialog(e);break;case "type":b.product_list.typesDialog(e);break;case "assign-tags":b.product_list.assignTagsDialog(e);break;case "delete":b.product_list.deleteProductsDialog(e);break;case "delete-from-set":"set"==b.product_list.collection_hash[0]&&b.product_list.deleteFromSet(e);break;case "delete-from-category":"category"==
b.product_list.collection_hash[0]&&b.product_list.deleteFromCategory(e);break;case "visibility":b.product_list.visibilityDialog(e,a);break;case "export":b.product_list.exportProducts(e,b(this).attr("data-plugin"));break;case "duplicate":b.product_list.duplicateProducts(e,b(this));break;case "coupon":b.product_list.createCoupon(e);break;case "set-badge":case "delete-badge":b.product_list.setBadge(e,b(this));break;default:return}return!1}});a.find('li[data-action="set-custom-badge"] a').click(function(){b(this).parent().find(".textarea-wrapper").slideToggle("fast");
return!1}).closest("li").find(".textarea-wrapper").click(function(){return!1}).find("input").click(function(){var a=b.product_list.getSelectedProducts(!0);a.count?b.product_list.setBadge(a,b(this).closest("li")):alert($_("Please select at least one product"));return!1});(function(){var c,d=b("#mainmenu").height(),e=a.find(":first").offset().top-d,f=b(document),g=b(window);f.bind("scroll",c=function(){jQuery.contains(document.documentElement,a[0])?f.scrollTop()>e&&a.height()+d<g.height()?a.addClass("s-fixed").css({top:d}):
a.removeClass("s-fixed"):(f.off("scroll",c),g.off("resize",c))});g.bind("resize",c)})()},getSelectedProducts:function(a){a=a||!1;var c={count:0};if(this.container.find(".s-select-all:first").attr("checked")){var d=b.product_list.collection_hash.join("/")||"all";a?c.serialized=[{name:"hash",value:d}]:c.hash=d;c.count=this.total_count}else a?c.serialized=b.product_list.container.find(".product.selected").map(function(){c.count+=1;return{name:"product_id[]",value:b(this).attr("data-product-id")}}).toArray():
c.product_id=b.product_list.container.find(".product.selected").map(function(){c.count+=1;return b(this).attr("data-product-id")}).toArray();return c},visibilityDialog:function(a,c){if(!b.isArray(a.serialized))return!1;var d=c.find("i.icon16");if(!d.hasClass("loading")){c=b("#visibility-dialog-wrapper");c.length||(c=b('<div id="visibility-dialog-wrapper">').appendTo("#s-content"));var e=d.attr("class");d.attr("class","icon16 loading");c.data("products",a).load("?module=dialog&action=visibility",function(){d.attr("class",
e)})}},categoriesDialog:function(a){var c=b("#s-categories"),d=this.sidebar,e=this.container;c.length&&c.parent().remove();b("<div></div>").appendTo("body").load("?module=dialog&action=categories",function(){b("#s-categories").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){var c=b(this);c.find(".dialog-content h1 span").text("("+a.count+")").show();c.find(".dialog-buttons i.loading").hide();c.find("input[name=new_category_name]").val("");c.find("input[name=new_category]").attr("checked",!1)},
onSubmit:function(c){var f=c.find("form");f.find(".dialog-buttons i.loading").show();b.shop.jsonPost(f.attr("action"),f.serializeArray().concat(a.serialized),function(a){a.data.new_category&&b("#s-category-list ul:first").trigger("add",[a.data.new_category,"category","#/products/category_id="+a.data.new_category+"&view="+b.product_list.options.view]);a.data.categories&&(d.trigger("update",[{category:a.data.categories}]),e.find(".s-select-all:first").trigger("select",!1));f.find("input:checked").attr("checked",
!1);c.trigger("close")});return!1}})})},setsDialog:function(a){var c=b("#s-sets"),d=this.sidebar,e=this.container;c.length&&c.parent().remove();b("<div></div>").appendTo("body").load("?module=dialog&action=sets",function(){b("#s-sets").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){var c=b(this);c.find(".dialog-content h1 span").text("("+a.count+")").show();c.find(".dialog-buttons i.loading").hide();c.find("input[name=new_set_name]").val("");c.find("input[name=new_set]").attr("checked",!1)},
onSubmit:function(c){var f=c.find("form");f.find(".dialog-buttons i.loading").show();b.shop.jsonPost(f.attr("action"),f.serializeArray().concat(a.serialized),function(a){a.data.new_set&&b("#s-set-list ul:first").trigger("add",[a.data.new_set,"set","#/products/set_id="+a.data.new_set+"&view="+b.product_list.options.view]);a.data.sets&&(d.trigger("update",[{set:a.data.sets}]),e.find(".s-select-all:first").trigger("select",!1));f.find("input:checked").attr("checked",!1);c.trigger("close")});return!1}})})},
assignTagsDialog:function(a){var c=b("#s-assign-tags"),d=function(){b("#s-assign-tags").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){var c=b(this);c.find(".dialog-content h1 span").text("("+a.count+")").show();c.find(".dialog-buttons i.loading").hide()},onSubmit:function(c){var d=b(this),e=d.find("#s-assign-tags-list_tag");if(e.length){var h=jQuery.Event("keypress",{which:13});e.trigger(h)}d.find(".dialog-buttons i.loading").show();var k=d.attr("action");setTimeout(function(){var e=d.serializeArray().concat(a.serialized);
b.shop.jsonPost(k,e,function(a){"search"===a.data.cloud?c.trigger("close"):a.data.cloud&&b("#s-tag-cloud").trigger("update",[a.data.cloud]);c.trigger("close");b.products.dispatch()},function(){c.trigger("close")})},10);return!1}})};c.length&&c.remove();b.post("?module=dialog&action=assignTags",a.serialized,function(a){b("body").append(a);d()})},typesDialog:function(a){var c=b("#s-types"),d=this.container,e=this.sidebar,f=function(){b("#s-types").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){b(this).find(".dialog-buttons i.loading").hide()},
onSubmit:function(c){var f=b(this);f.find(".dialog-buttons i.loading").show();b.shop.jsonPost(f.attr("action"),f.serializeArray().concat(a.serialized),function(a){e.trigger("update",{type:a.data.types});d.find(".s-select-all:first").trigger("select",!1);f.find("input:checked").attr("checked",!1);c.trigger("close");b.products.dispatch()});return!1}})},g=c.parent();c.length?f():(g=b("<div></div>").appendTo("body"),g.load("?module=dialog&action=types",f))},deleteFromSet:function(a){0<a.count&&b.shop.jsonPost("?module=products&action=deleteFromSet&id="+
this.collection_hash[1],a.serialized,function(){b.products.dispatch()})},deleteFromCategory:function(a){0<a.count&&b.shop.jsonPost("?module=products&action=deleteFromCategory&id="+this.collection_hash[1],a.serialized,function(){b.products.dispatch()})},deleteProductsDialog:function(a){var c=b("#s-product-list-delete-products-dialog"),d=c.parent();c.length||(d=b("<div></div>").appendTo("body"));d.load("?module=dialog&action=productsDelete&count="+a.count,function(){b("#s-product-list-delete-products-dialog").waDialog({disableButtonsOnSubmit:!0,
onLoad:function(){b(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(c){b(this).find(".dialog-buttons i.loading").show();b.product_list.remove(b.extend(a,{remove:["products"]}),function(a,d){b.product_list.sidebar.trigger("update",a.data.lists);b.products.dispatch();c.trigger("close");d.length&&alert((c.data("not-allowed-string")||"").replace("%d",d.length))});return!1}})})},exportProducts:function(a,b){for(var c=[],e,f=!1;e=a.serialized.pop();)e.name&&("product_id[]"==e.name?c.push(parseInt(e.value,
10)):"hash"==e.name&&(f=e.value));a="?action=importexport#/"+b;f?window.location=a+("/hash/"+f):c.length&&(a+="/hash/id/"+c.join(","),window.location=a)},createCoupon:function(a){for(var b=[],d,e=!1;d=a.serialized.pop();)d.name&&("product_id[]"==d.name?b.push(parseInt(d.value,10)):"hash"==d.name&&(e=d.value));a="?action=orders#/coupons/";e?window.location=a+("hash/"+e):b.length&&(a+="hash/id/"+b.join(","),window.location=a)},duplicateProducts:function(a,c){for(var d=[],e,f=!1;e=a.serialized.pop();)e.name&&
("product_id[]"==e.name?d.push(parseInt(e.value,10)):"hash"==e.name&&(f=e.value));!f&&d.length&&(f="id/"+d.join(","));f&&(c.find("i.icon16").removeClass("split").addClass("loading"),this.duplicate(f,{progress:function(a){c.attr("title",Math.round(100*a.offset/a.total_count)+"%")},finish:function(a,d){c.attr("title",null);var e=c.find("i.icon16");e.removeClass("loading").addClass("yes");setTimeout(function(){e.removeClass("yes").addClass("split")},3E3);b(document).one("product_list_init_view",function(){var a=
{};b.each(d,function(b,c){a[c]=1});b("#product-list [data-product-id]").each(function(){var c=b(this),d=b(this).data("product-id");d&&a[d]&&c.addClass("highlighted")})});b.products.dispatch()},error:function(a){}}))},setBadge:function(a,c){function d(a){var d="delete-badge"==e?null:a.data;b("#product-list [data-product-id]").each(function(){var a=b(this);if(g||f[a.data("product-id")]){if(a.is("tr")){var c=a.find(".s-image a");c.find(".s-image-corner").remove();d&&c.prepend(b('<div class="s-image-corner"></div>').html(d))}else c=
a.find(".s-product-image a"),c.find(".s-image-corner.top.right").remove(),d&&c.append(b('<div class="s-image-corner top right"></div>').html(d));a.trigger("badge",[d])}});"set-custom-badge"==e&&c.parent().find(".textarea-wrapper").slideUp("fast");c.find(".loading").remove();c.find("a").append(b('<span class="count"><i class="icon16 yes"></i></span>').animate({opacity:0},function(){b(this).remove()}));b.product_list.container.find(".s-select-all:first").trigger("select",!1)}var e=c.data("action");
"set-custom-badge"!=e&&c.parent().find(".textarea-wrapper").slideUp("fast");c.find(".loading").remove();c.find("a").append('<span class="count"><i class="icon16 loading"></i></span>');var f={},g=!1;b.each(a.serialized,function(){g=g||"hash"==this.name;f[this.value]=1});if("delete-badge"==e)c.find(".loading").remove(),b.shop.jsonPost("?module=product&action=badgeDelete",a.serialized,d);else{var h="set-custom-badge"==e?c.find("textarea").val():c.data("type");a=a.serialized;a.push({name:"code",value:h});
b.shop.jsonPost("?module=product&action=badgeSet",a,d)}},duplicate:function(a,c){var d=this,e=[];b.shop.jsonPost("?module=products&action=duplicate",{hash:a,limit:50,offset:c.offset||0},function(b){"ok"==(b.status||"error")&&(e=e.concat(b.data.new_ids||[]),b.data.offset<b.data.total_count?(c.offset=b.data.offset,d.duplicate(a,c),c.progress(b.data||{})):c.finish(b.data||{},e))},function(a){a.errors&&alert(a.errors)})},remove:function(a,c){var d={},e=[];if(a.product_id)var f=function(){100>=a.product_id.length&&
(d.get_lists=!0);d.product_id=a.product_id.splice(0,100);b.shop.jsonPost("?module=products&action=deleteList",d,function(b){b.data.not_allowed&&b.data.not_allowed.length&&(e=e.concat(b.data.not_allowed));a.product_id.length?f():"function"===typeof c&&c(b,e)})};else d.hash=a.hash||this.collection_hash.join("/")||"all",d.remove=b.isArray(a.remove)&&a.remove.length?a.remove:["list"],1==d.remove.length&&"list"==d.remove[0]?f=function(){b.shop.jsonPost("?module=products&action=deleteList",d,c)}:(d.count=
100,f=function(){b.shop.jsonPost("?module=products&action=deleteList",d,function(a){a.data.not_allowed&&a.data.not_allowed.length&&(e=e.concat(a.data.not_allowed));0<a.data.rest_count&&null!=a.data.rest_count?f():"function"===typeof c&&c(a,e)})});f()},rubberTable:function(){var a=b("#wa"),c=b("#s-content"),d=b("#s-content > .content");c=parseInt(c.css("margin-left"));var e=parseInt(d.css("margin-right")),f=b(".s-product-list-table-container table").width(),g=a.attr("style");g&&a.data("style",g);d=
...
f))/1E5)&&a<g&&(g=a)}e=parseFloat(c.val()?c.val():0);f=parseFloat(d.val()?d.val():100<c.val()?parseFloat(c.val())+100:100);h.slider({range:!0,min:e-3,max:f+5,step:g,values:[e,f],slide:function(a,e){a=b(this).slider("option","min");var f=b(this).slider("option","max");2!=b(e.handle).index()&&(e.values[0]==a&&b(this).slider("option","min",a-g),c.val(e.values[0]));1!=b(e.handle).index()&&(e.values[1]==f&&b(this).slider("option","max",f+g),d.val(e.values[1]))},stop:function(a,b){d.change()}});c.add(d).change(function(){var a=
""===c.val()?h.slider("option","min"):parseFloat(c.val()),b=""===d.val()?h.slider("option","max"):parseFloat(d.val());b>=a&&(h.slider("option","values",[a,b]),h.slider("option","max",parseFloat(b)+5),h.slider("option","min",parseFloat(a)-3))})};shopDialogProductsCategory.prototype.initShowFeatures=function(a,b,d,e,f){var c=a.type.substr(0,5);if("range"==c){var h=[],k=[],l;for(l in a.values)a.values.hasOwnProperty(l)&&(h.push(parseInt(a.values[l].begin)),k.push(parseInt(a.values[l].end)));a.values=
...
k=0,t;for(t in b.data.features)b.data.features.hasOwnProperty(t)&&(c.initShowFeatures(b.data.features[t],g,"template_feature_field",e,!1),++k);b=h-k;0<b?(g="<b><i>"+(20<b?$_("Show %d more").replace("%d",20)+" "+$_("From").toLowerCase()+" "+b:$_("Show %d more").replace("%d",b))+"</i></b>",d.find(".js-show-more").html(g).attr("data-count",b),a||(f=parseInt(f)+parseInt(k),d.find(".js-show-more").attr("data-offset",f))):d.find(".js-autocomplete-wrapper").hide()}else"fail"===b.status&&console.log(b.errors)}})};
...
d=c.find("span.slash");b(a).after(d);c.find("span.s-frontend-base-url").html(c.find("a.s-frontend-base-url").hide().contents()).show()},beforeBackReadable:function(a,c){a=b(this);c=a.parents("div:first");var d=c.find("span.slash");a.after(d);c.find("a.s-frontend-base-url").html(c.find("span.s-frontend-base-url").hide().contents()).show()}});var a=this.$wrapper.find(".js-product-list-name"),c=this.$wrapper.find(".js-product-list-url"),d={name:"",url:"",timer_id:null};a.unbind(".create_product_list").bind("change.create_product_list, keyup.create_product_list",
