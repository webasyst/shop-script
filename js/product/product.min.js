...
a(b):b;d=d||0;return b.position().top+b.outerHeight()-d-(c.scrollTop()+c.height())}}}})(jQuery);$.fn.liveDraggable=function(a){this.each(function(a,c){var e=$(this);e.data("init_draggable")&&e.die("mouseover",e.data("init_draggable"))});this.die("mouseover").live("mouseover",function(){var b=$(this);b.data("init_draggable")||b.data("init_draggable",arguments.callee).draggable(a)})};
...
function n(a,b){var c=l.size.height||b.height(),d=l.size.width||1.5*b.width(),c=l.minSize.height&&c<l.minSize.height?l.minSize.height:c,d=l.minSize.width&&d<l.minSize.width?l.minSize.width:d,c=l.maxSize.height&&c>l.maxSize.height?l.maxSize.height:c,d=l.maxSize.width&&d>l.maxSize.width?l.maxSize.width:d;a.height(c);a.width(d)}function p(a){return function(){return a}}function q(a){return l.html?a.html():a.text()}if(this.length){var u=!1;if("string"==typeof b){if("setOption"==b){var l=this.data("inlineEditableSettings")||
...
afterBackReadable:function(){},beforeMakeEditable:function(){},afterMakeEditable:function(){},placeholderClass:"hint",truncate:!1,hold:!1,html:!1,allowEmpty:!1},t,b||{}));var l=this.data("inlineEditableSettings")||{},r=this,v="read",w="";"function"!==typeof l.hold&&(l.hold=p(l.hold));e.call(this);return this}}})(jQuery);(function(a){a.fn.photoStreamSlider=function(b){function c(){function b(c){function k(){b.execution=!1;var a="on"+p.charAt(0).toUpperCase()+p.slice(1),a=e[a];"function"==typeof a&&a.call(d);a=c.fn;"function"==typeof a&&a.call(d)}"string"==typeof c&&(c={direction:c,animate:!0});var p=c.direction||"forward",q=c.steps||h.length;if(!b.execution){b.execution=!0;var l=h.filter(":first").outerWidth()*q,t=h.length;if("forward"==p){var x=h.filter(":last").nextAll(":lt("+q+")"),q=x.length,x=x.filter(":last");
q&&(h.removeClass("visible"),x.prevAll(":lt("+(t-1)+")").addClass("visible"),x.addClass("visible"))}else x=h.filter(":first").prevAll(":lt("+q+")"),q=x.length,x=x.filter(":last"),q&&(h.removeClass("visible"),x.nextAll(":lt("+(t-1)+")").addClass("visible").show(),x.addClass("visible"));h=a("li.visible",g);t=g.position().left;"forward"==p?(q=n-m-u,t-=l,t=t>-q?t:-q):(t+=l,t=t<u?t:u);c.animate?g.animate({left:t},e.duration,k):(g.css({left:t}),k())}}var g=d.find(e.photoStream),h=a("li.visible",g),k=a("li",
...
a.product.disableSkus(!1,!0):a.product.disableSkus(!0,!1)},onSkuTypeChange:function(b){var c=a("#s-product-feature-superposition-field-group");a.shop.trace("onSkuTypeChange",{sku_type:b});if("1"==b)if(b=a(this.options.form_selector+' :input[name="product[type_id]"]').val(),c.data("type")!=b)c={base_price_selectable:c.find(':input[name="product[base_price_selectable]"]').val(),currency:c.find("select.s-product-currency").val()},a.product.skuTypeFeaturesSelectableLoad(b,c);else a.product.onSkuTypeEnabled();
else c.hide(),c.find("input").attr("disabled",!0),c=a(this.options.form_selector).find(".s-product-skus"),"new"==a.product.path.id?a.product.disableSkus(!1,!1):(b=c.find("tbody"),a.product.disableSkus(!0,!0),b.find(">tr:not(.s-sku-virtual)").length||(a.product.editTabMainSkuAdd(),b.find(">tr:not(.s-sku-virtual):first").find('input[name="product[sku_id]"]').attr("checked",!0))),c.closest(".field").find(".name").show()},featureSelectableInit:function(){var b=a(this.options.form_selector),c=a("#s-product-feature-superposition"),
e=b.find(".s-product-skus"),b=b.find(':input[name="product[base_price_selectable]"]'),d=this;c.on("click","ul.features>li",function(){var b=a(this);b.parent().find("li.selected").removeClass("selected");b.addClass("selected");b=b.attr("data-feature-id");b=c.find(".feature-values[data-feature-id="+b+"]");c.find(".feature-values").hide();b.show();return!1});c.on("change","ul.values>li input",function(){var b=a(this).parents("li:first").parent().find(">li input:checked").length,e=c.find("ul.features li.selected");
e.find(".count").text(b||"");b=b?"status-blue-tiny":"status-gray-tiny";e.find("i").removeClass("status-blue-tiny status-gray-tiny").addClass(b);d.featureSelectableCount(c)});a.shop.changeListener(b,function(){e.find(".s-sku-virtual .s-price input").val(a(this).val())});a.shop.changeListener(e,function(){var b=a(this);if("product[sku_id]"!=b.attr("name")&&(b=b.parents("tr:first"),b.length)){var c=parseInt(b.attr("data-id"),10);if(c){if(b.hasClass("js-sku-settings")&&(b=e.find("tr[data-id="+c+"]:first"),
!b.length))return;b.find("input.s-input-virtual").val(0);b.removeClass("s-sku-virtual");a("#s-product-view").find("tr[data-id="+c+"]").removeClass("s-sku-virtual")}}},"input, textarea");c.find("i.status-blue-tiny:first").parents("li").trigger("click");return c},featureSelectableCount:function(b){b||(b=a("#s-product-feature-superposition"));var c=[],e=a("#s-product-edit-forms .s-product-form.features");b.find("ul.features>li").each(function(){var d=a(this),f=parseInt(d.find(".count").text(),10);f&&
c.push(f);if(e.length){var g=e.find('div[data-code="'+d.data("feature-code")+'"] div.value');if(f){var d=d.data("feature-id"),h=b.find('div.feature-values[data-feature-id="'+d+'"] ul.values input:checked');g.each(function(){var b=a(this),c=h.filter('[value="'+b.data("value-id")+'"]').length;b.find("input:checkbox").attr("checked",c?"checked":null).attr("disabled","disabled");c?b.show():b.hide()})}else g.show(),g.find("input:checkbox").each(function(a,b){b.checked=b.defaultChecked;b.disabled=null})}});
var d=b.find(".superposition-count");if(c.length){d.find(".options").text(c.join(" x ")+" "+$_("options"));for(var f=1,g=0,h=c.length;g<h;g+=1)f*=c[g];d.find(".skus").html('<span class="highlighted">'+$_("%d SKUs in total").replace("%d",f)+"</span>")}else d.find(".options").text(""),d.find(".skus").html("")},editInit:function(){a("#s-product-edit-forms").unbind("keydown.product").bind("keydown.product",function(b){if(a(b.target).is(":input")&&(b.ctrlKey||b.metaKey)&&83==b.keyCode)return a("#s-product-save-button").click(),
!1});a.shop.makeFlexibleInput("s-product-meta-title");if(!this.options.edit_rights)return window.location.hash="#/product/"+this.path.id+"/",!1;var b=a(this.options.form_selector);b.bind("submit.product",function(b){return a.product.saveData("profile",null)});b.on("change.product, keyup.product","div.s-product-form:not(.ajax) :input",function(b){a.product.helper.onChange(a(this).parents("div.s-product-form"))});b.on("change.product, keyup.product, keypress.product",':input[name="product[name]"]',
function(b){a.product.helper.onNameChange(a(this),!1,a.product.options.update_delay||500)});var c=a("#product-tags");c.data("tags_input_init")||(c.tagsInput({autocomplete_url:"?module=product&action=tagsAutocomplete",height:120,onChange:function(){a.product.updateMetaFields()},defaultText:""}).data("tags_input_init",!0),a("#s-product-popular-tags").off("click.product","a").on("click.product","a",function(){var b=a(this).text();c.removeTag(b);c.addTag(b)}));b.on("change.product",".s-product-currency",
function(){var c=a(this).val();b.find(".s-product-currency").val(c);b.find(".s-product-currency-readonly").text(c);a("#s-product-currency-code").val(c)});b.on("change.product",':input[name="product[type_id]"]',function(){return a.product.editTabMainTypeChange(a(this))});b.on("change",'select[name="product[status]"]',function(){"1"==a(this).val()?(a(this).prev().removeClass("no-bw").addClass("yes"),a(".s-product-status-text").hide()):(a(this).prev().removeClass("yes").addClass("no-bw"),a(".s-product-status-text").show())});
b.on("change",'input[name="product[sku_type]"]',function(){a.product.onSkuTypeChange(this.value)}).change();a.product.featureSelectableInit()},editFocus:function(){var b=this.options.duration,c=this;a("h1 .s-product-edit-link, #mainmenu .s-level2, #s-product-frontend-links").hide();a("#s-sidebar, #s-toolbar").animate({width:0},b).queue(function(){a(this).hide();a(this).dequeue();a("#s-product-edit-menu, #s-product-edit-forms, #s-product-edit-save-panel").show();"new"!=c.path.id?c.get("container").find(".back").attr("href",
...
a(this.options.form_selector).off("change.product, keyup.product");a("#s-product-edit-forms").off("click.edit-product")},editAction:function(a){this.path.mode=a.mode},editTabMainData:{sku_id:-1,stocks:{}},editTabMainInit:function(b){a("#s-product-type").each(function(){a(this).parent().get(0)!=document.body&&(a("body > #s-product-type").remove(),a(document.body).append(a(this)))});var c=a("#s-product-edit-forms .s-product-form.main"),e=this,d=c.find("table.s-product-skus:last > tbody");d.sortable({distance:5,
helper:"original",items:"> tr",handle:"i.sort",opacity:.75,tolerance:"pointer",update:function(b,c){var f=parseInt(a(c.item).data("id"),10),m=a(c.item).prev().data("id"),m=void 0===m?0:parseInt(m,10);e.editTabMainSkuSort(f,m,a(this));m=d.find('> tr.js-sku-settings[data-id="'+f+'"]');m.length&&(m=m.detach(),a.shop.trace("detach",m),m&&(a.shop.trace("detach",d.find('> tr[data-id="'+f+'"]').length),d.find('> tr[data-id="'+f+'"]:first').after(m)))},start:function(a,b){d.find("> tr.js-sku-settings").hide()},
stop:function(a,b){d.find("> tr.js-sku-settings").show()}});var f=a("#s-product-frontend-url");f.inlineEditable({editLink:"#s-product-frontend-url-edit-link",editOnItself:!1,minSize:{height:15,width:100},makeReadableBy:[],beforeMakeEditable:function(b){var c=a(this).closest("span.s-product-frontend-url-not-empty"),d=c.find("span.slash"),e=c.find("i.new-window");a(b).after(d);e.hide();c.find("a.s-frontend-base-url").hide();c.find("span.s-frontend-base-url").show()},beforeBackReadable:function(b,c){var d=
a(this).closest("span.s-product-frontend-url-not-empty"),e=d.find("span.slash");d.find("i.new-window").show();d.find("span.s-frontend-base-url").hide();d.find("a.s-frontend-base-url").show().append(e)}});parseInt(b.id,10)||f.trigger("editable");"new"==b.id&&a.product_list&&a.isArray(a.product_list.collection_hash)&&("category"==a.product_list.collection_hash[0]?c.find("select.s-product-categories").val(a.product_list.collection_hash[1]):"set"==a.product_list.collection_hash[0]&&c.find(".add-set-button").click().closest(".field").find("select:first").val(a.product_list.collection_hash[1]));
c.off("change.product","select.s-product-categories").on("change.product","select.s-product-categories",function(b){b=a(this);var c=b.val(),d=b.parent(),e=d.find(".s-product-delete-from-category"),f=parseInt(c,10)||0;f?e.show():e.hide();"create"==c?(d.find(".s-new-category").show(),d.find("input.val").attr("disabled",!1),b.hide().attr("disabled",!0).addClass("js-ignore-change")):d.find("input.val").val(f)});c.off("keydown.product","input.new-category").on("keydown.product","input.new-category",function(b){if(13==
b.keyCode)return a(this).parent().find("input[type=button]").click(),!1});c.off("click.product",".s-new-category input[type=button]").on("click.product",".s-new-category input[type=button]",function(b){var c=a(this).parent(),d=c.parent(),e=c.find("input[name=new_category]");b=e.val();a.shop.jsonPost("?module=products&action=saveListSettings&category_id=0&parent_id=0",{name:b},function(b){var f=d.find("select"),g=f.find("option.separator:first").show();a.when(g.after('<option class="category" value="'+
b.data.id+'">'+b.data.name+"</option>")).then(function(){f.find("option:first").text($_("Please select a category"));f.val(b.data.id).attr("disabled",!1).show().removeClass("js-ignore-change");c.find("input.val").val(b.data.id).attr("disabled",!0);c.hide();d.find(".s-product-delete-from-category").show();e.val("");a.product.helper.onTabChanged("main",!0);a("#s-product-save-button").removeClass("green").addClass("yellow");a("#s-category-list>ul").trigger("add",[b.data,"category"])})})});c.off("click.product",
...
!1,e=null;b&&b.params&&b.params.focus?(e=b.params.name||"",!e.length&&b.params.sku&&(e="product[skus]["+parseInt(b.params.sku,10)+"]",b.params.focus&&(e+="["+b.params.focus+"]"),"stock"==b.params.focus&&(e+="["+(parseInt(b.params.stock,10)||0)+"]")),c=':input[name$="'+e.replace(/(\[|\]|\|\-)/g,"\\$1")+'"]:first'):b&&"new"==b.id&&(c=':input[name$="[name]"]:first');c&&(a.shop.trace("$.product.editTabMainFocus",[e,a(c).length]),setTimeout(function(){a(c).focus();window.location.hash="#/product/"+b.raw.replace(/\/focus=.*$/,
...
d.container;try{d.container.append(tmpl("template-product-list-"+d.options.view,{products:b.data.products,check_all:"table"==d.options.view?f.find(".s-select-all:first").attr("checked"):!1,sort:a.product_list.sort,primary_currency:a.product_list.options.primary_currency,stocks:a.product_list.options.stocks})),d.container.trigger("append_product_list",[b.data.products])}catch(k){console.log("Error: "+k.message);a(window).lazyLoad("stop");return}f.find(".last").removeClass("last");f.find(".product:last").addClass("last");
...
g=a("#s-category-list-block"),h=a("#s-set-list"),k=a("#s-set-list-block"),m=function(){function h(){if(!l){var k=a("#s-category-list-handler");r=a.categories_tree.isCollapsed(k);n=f.is(":hidden");var m=a('<div id="s-category-list-dummy" class="block"></div>').css({height:g.height()});g.replaceWith(m);d.show().append(g.hide());g.find(".heading").before('<span class="hint float-right" style="margin-top: 3px;">'+$_("Drag products here")+"</span>");r&&a.categories_tree.expand(k,null,function(){a.categories_tree.collapse(k)});
...
function(b){b.pageX>c+10&&(d&&clearTimeout(d),d=null,a||(f.hide(),g.css({height:""}),g.find(".heading").prev(".hint").show(),a=!0))})})();l=!0}}function k(){if(l){var b=a("#s-category-list-dummy");b.replaceWith(g);g.css({"overflow-x":"","overflow-y":""});var c=a("#s-category-list-handler");r&&a.categories_tree.collapse(c);n||f.show();g.find(".heading").prev(".hint").remove();a("#s-category-list-handler").show();a("i.add",g).show();b.remove();g.unbind("mousemove.fixed_blocks.category");e.unbind("mouseout.fixed_blocks.category");
d.children().length||d.hide();l=!1;a.categories_tree.init()}}var m=g.offset().top,l=!1,n,r;e.unbind("scroll.fixed_blocks.category").bind("scroll.fixed_blocks.category",function(){l||(m=g.offset().top);var c=m,c=document.getElementById("s-category-list-dummy")?c+a("#s-category-list-dummy").height():c+a("#s-category-list-block").height();e.scrollTop()+b+5>=c?h():k()});return{setFixed:h,unsetFixed:k}}(),n=function(){function f(){if(!n){l=h.is(":hidden");var g=a('<div id="s-set-list-dummy" class="block"></div>').css({height:k.height()});
...
k.unbind("mousemove.fixed_blocks.category");e.unbind("mouseout.fixed_blocks.category");d.children().length||d.hide();n=!1}}var m=k.offset().top,l,n=!1;e.unbind("scroll.fixed_blocks.set").bind("scroll.fixed_blocks.set",function(){n||(m=k.offset().top);var c=m,c=document.getElementById("s-set-list-dummy")?c+a("#s-set-list-dummy").height():c+a("#s-set-list-block").height();e.scrollTop()+b+5>=c?f():g()});return{setFixed:f,unsetFixed:g}}();return{category:m,set:n}},initEditingControls:function(){var b=
