...
$.fn.liveDroppable=function(a){this.each(function(){var a=$(this);a.data("init_droppable")&&a.die("mouseover",a.data("init_droppable"))});var b=function(){var b=$(this);b.data("init_droppable")||(b.data("init_droppable",arguments.callee).droppable(a),b.mouseover())};b.call(this);this.die("mouseover",b).live("mouseover",b)};(function(a){a.fn.inlineEditable=function(b,c){function d(){m(a(this))||a(this).addClass(j.placeholderClass).text(j.placeholder)}function e(){m(a(this))==j.placeholder&&a(this).text("").removeClass(j.placeholderClass)}function f(b){return!a(b).val()?(a(this).text(j.placeholder).addClass(j.placeholderClass),!0):!1}function g(){n="edit";this.id=this.id||(""+Math.random()).slice(2);var b=this.id+"-input",d=a("#"+b);d.length||(o.after(k(b)),d=a("#"+b));d.addClass(j.inputClass);var b=d,c=o,f=j.size.height||
c.height(),c=j.size.width||1.5*c.width(),f=j.minSize.height&&f<j.minSize.height?j.minSize.height:f,c=j.minSize.width&&c<j.minSize.width?j.minSize.width:c,f=j.maxSize.height&&f>j.maxSize.height?j.maxSize.height:f,c=j.maxSize.width&&c>j.maxSize.width?j.maxSize.width:c;b.height(f);b.width(c);j.placeholder&&m(a(this))==j.placeholder&&e.call(o);j.beforeMakeEditable.call(this,d);r=j.truncate?o.data("real_text"):m(o);d.val(r).show().focus();o.hide();a(j.editLink).hide();if(!l){for(var g=[],i=[],b=0,f=j.makeReadableBy.length;b<
f;++b)c=j.makeReadableBy[b],"blur"==c&&d.blur(function(){n!="read"&&h.call(this)}),"enter"==c&&g.push(13),"esc"==c&&g.push(27);b=0;for(f=j.updateBy.length;b<f;++b)c=j.updateBy[b],"alt+enter"==c&&i.push({ctrl:!1,alt:!0,shift:!1,key:13}),"ctrl+enter"==c&&i.push({ctrl:!0,alt:!1,shift:!1,key:13}),"ctrl+s"==c&&i.push({ctrl:!0,alt:!1,shift:!1,key:17});g.length&&d.keydown(function(a){~g.indexOf(a.keyCode)&&!a.ctrlKey&&!a.altKey&&!a.shiftKey&&n!="read"&&h.call(this,a.keyCode==27?r:null);if(i.length)for(var b in i){var c=
i[b];if(a.keyCode==c.key&&a.ctrlKey==c.ctrl&&a.altKey==c.alt&&a.shiftKey==c.shift){o.trigger("readable");break}}});o.unbind("readable.inlineEditable").bind("readable.inlineEditable",function(b,c){if(n!="read"){var d=a("#"+(this.id+"-input"));h.call(d,d.val(),c)}});l=!0}j.afterMakeEditable.call(this,d)}function h(b,c){c="undefined"===typeof c?!1:!0;void 0!=b&&null!=b?a(this).val(b):b=a(this).val();if(!(!1===c&&!1===j.beforeBackReadable.call(o.get(0),this,{changed:b!=r,old_text:r,new_text:b}))){n="read";
if(!j.placeholder||!f.call(o,this))if(j.allowEmpty||b)j.truncate?(o.data("real_text",b),o.text(b.length<j.truncate-3?b:b.substr(0,j.truncate-3)+"...")):!j.html?o.text(b):o.html(b),b||d.call(this);o.show();a(this).hide();a(j.editLink).show();!1===c&&j.afterBackReadable.call(o.get(0),this,{changed:b!=r,old_text:r})}}function k(a){switch(j.inputType){case "textarea":return'<textarea id="'+a+'" style="display:none;"></textarea>';default:return'<input type="text" id="'+a+'" style="display:none;">'}}function i(a){return function(){return a}}
function m(a){return!j.html?a.text():a.html()}if(this.length){var l=!1;if("string"==typeof b){if("setOption"==b){var j=this.data("inlineEditableSettings")||{};a.extend(!0,j,c);"undefined"!==typeof c.hold&&"function"!==typeof c.hold&&(j.hold=i(j.hold));this.data("inlineEditableSettings",j)}return this}var q=this.data("inlineEditableSettings");this.data("inlineEditableSettings",a.extend({inputType:"text",inputClass:"",size:{height:null,width:null},minSize:{height:null,width:null},maxSize:{height:null,
width:null},editLink:null,editOnItself:!0,placeholder:null,makeReadableBy:["blur","enter","esc"],updateBy:["ctrl+enter","alt+enter"],beforeBackReadable:function(){},afterBackReadable:function(){},beforeMakeEditable:function(){},afterMakeEditable:function(){},placeholderClass:"hint",truncate:!1,hold:!1,html:!1,allowEmpty:!1},q,b||{}));var j=this.data("inlineEditableSettings")||{},o=this,n="read",r="";"function"!==typeof j.hold&&(j.hold=i(j.hold));this.data("inited")||(j.truncate&&"boolean"==typeof j.truncate&&
(j.truncate=255),j.truncate&&(q=!j.placeholder||j.placeholder!==this.text()?this.text():"",this.data("real_text",q),this.text(q.length<j.truncate-3?q:q.substr(0,j.truncate-3)+"...")),j.placeholder&&d.call(this),j.editLink&&a(j.editLink).unbind("click.inlineEditable").bind("click.inlineEditable",function(){j.hold.call(o)||n!="edit"&&g.call(o.get(0))}),j.editOnItself&&this.unbind("click.inlineEditable").bind("click.inlineEditable",function(){j.hold.call(o)||n!="edit"&&g.call(this)}),this.unbind("editable.inlineEditable").bind("editable.inlineEditable",
function(){j.hold.call(o)||n!="edit"&&g.call(this)}),this.unbind("placeholder.inlineEditable").bind("placeholder.inlineEditable",function(b,c){c&&j.placeholder&&d.call(this);c||a(this).removeClass(j.placeholderClass)}),this.data("inited",!0));return this}}})(jQuery);(function(a){a.fn.photoStreamSlider=function(b){function c(){function b(c){function k(){b.execution=!1;var a="on"+j.charAt(0).toUpperCase()+j.slice(1),a=d[a];"function"==typeof a&&a.call(e);a=c.fn;"function"==typeof a&&a.call(e)}"string"==typeof c&&(c={direction:c,animate:!0});var j=c.direction||"forward",l=c.steps||h.length;if(!b.execution){b.execution=!0;var o=h.filter(":first").outerWidth()*l,n=h.length;if("forward"==j){var s=h.filter(":last").nextAll(":lt("+l+")"),l=s.length,s=s.filter(":last");
l&&(h.removeClass("visible"),s.prevAll(":lt("+(n-1)+")").addClass("visible"),s.addClass("visible"))}else s=h.filter(":first").prevAll(":lt("+l+")"),l=s.length,s=s.filter(":last"),l&&(h.removeClass("visible"),s.nextAll(":lt("+(n-1)+")").addClass("visible").show(),s.addClass("visible"));h=a("li.visible",g);n=g.position().left;"forward"==j?(l=m-i-q,n-=o,n=n>-l?n:-l):(n+=o,n=n<q?n:q);c.animate?g.animate({left:n},d.duration,k):(g.css({left:n}),k())}}var g=e.find(d.photoStream),h=a("li.visible",g),k=a("li",
g),i=h.filter(":first").outerWidth()*h.length,m=k.filter(":first").outerWidth()*k.length,l=d.height||k.filter(":first").outerHeight();g.parent().css({overflow:"hidden",height:l,position:"relative",padding:"4px 0",margin:0,width:i});for(var l=g.find("li:first"),j=h.filter(":first"),q=(j.outerWidth()-j.width())/2,o=0,n=l.outerWidth(),j=j.get(0);l.length&&l.get(0)!=j;)o+=n,l=l.next();g.css({position:"absolute",left:-(o-q),width:m});a(d.forwardLink).unbind("click").bind("click",function(){b("forward");
return!1});a(d.backwardLink).unbind("click").bind("click",function(){b("backward");return!1});e.unbind("append prepend").bind("append prepend",function(b,c){if("append"==b.type){for(var d=g.find("li:last"),f=a();d.hasClass("dummy");)f=f.add(d),d=d.prev("li");f.remove();g.append(c)}else{var d=a("<div></div>").html(c),f=d.find("li"),h=f.length*n;d.remove();for(var d=g.find("li:first"),i=a();d.hasClass("dummy");)i=i.add(d),d=d.next("li");i.remove();g.prepend(f)}k=g.find("li");m=k.filter(":first").outerWidth()*
...
f.after(g)}if(d){var h=parseInt(f.text(),10)||0;e.find("li.dr:not(.dynamic)>.counters .count:not(.subtree)").each(function(){h=h+(parseInt(a(this).text(),10)||0)});g.text(h).show();f.hide();f.hide();g.show()}else{g.hide();f.show()}return false});b.off("update_counters",".s-collection-list li").on("update_counters",".s-collection-list li",function(b,d){var e=a(this),f=e.find(">.count:not(.subtree)"),e=e.find(">.subtree");if(!e.length){e=f.clone().addClass("subtree").hide();f.after(e)}typeof d.item!==
"undefined"&&f.text(parseInt(d.item,10)||0);typeof d.subtree!=="undefined"&&e.text(parseInt(d.subtree,10)||0);return false})},jsonPost:function(b,c,d,e){a.shop.jsonPost(b,c,d,e)}}})(jQuery);(function(a){a.product={options:{duration:200,container_selector:"#shop-productprofile",message_selector:"#product-save-message",form_selector:"#s-product-save",update_delay:100},message:{submit:'<i class="icon16 loading"></i>',success:'<i class="icon16 yes"></i>',error:'<i class="icon16 no"></i>'},path:{id:null,mode:null,tab:null,tail:null,raw:null,params:{}},ajax:{random:null,target:null,link:null,save:!1,cached:{}},data:{main:{}},getData:function(a,c){return(this.data[a]||{})[c]},setData:function(a,
...
""):(d=b.parents("li.dr:first").attr("id").split("-"),b=d[0],d=d[1]);a.product_list.createListDialog(b,d,function(b,c){var d=a("#s-"+c+"-list"),e=d.find("ul:first");if(!e.length){d.prepend('<ul class="menu-v with-icons"><li class="drag-newposition" data-type="'+c+'"></li></ul>');d.find(".drag-newposition").mouseover();e=d.find("ul:first")}var f=parseInt(b.parent_id,10)||0,d=a.categories_tree.getHandlerByCategoryId(f),g=function(){if(f){var d=e.find("#"+c+"-"+b.parent_id);if(!d.find(">.collapse-handler-ajax").length){d.append('<ul class="menu-v with-icons dr"><li class="drag-newposition" data-type="'+
c+'"></li></ul>');d.find(".drag-newposition").mouseover();d.find(">a").before('<i class="icon16 darr overhanging collapse-handler-ajax" id="'+c+"-"+f+'-handler"></i>');a.categories_tree.setExpanded(f)}e=d.find("ul:first")}e.trigger("add",[b,c])};c=="category"?a.categories_tree.expand(d,function(){g()}):g()});return!1});a("#s-content").find(".sort").unbind("click").bind("click",function(){location.href=a(this).find("a").attr("href");return!1});var h=a("#s-embed-code");h.length&&h.inlineEditable({size:{width:h.width()+
4},afterMakeEditable:function(a){a.trigger("select")}});this.initEditingControls();this.initToolbar()}catch(k){a.shop.error("$.product_list.initView error: "+k.message,k)}},initEditingControls:function(){var b=a("#s-product-list-title");b.hasClass("editable")&&(b.inlineEditable({minSize:{width:350},maxSize:{width:600},size:{height:30},inputClass:"s-title-h1-edit",beforeMakeEditable:function(){a(".s-product-list-manage").hide()},afterBackReadable:function(b,c){a(".s-product-list-manage").show();if(!c.changed)return!1;
a.shop.jsonPost("?module=products&action=saveListSettings&"+a.product_list.collection_param+"&edit=name",{name:a(b).val()},function(b){a.product_list.sidebar.find("#"+a.product_list.collection_hash[0]+"-"+b.data.id).find(".name:first").html(b.data.name)})}}),"name"==this.options.edit&&b.trigger("editable"));var c=a.product_list.collection_hash[0],b=a("#s-product-list-settings");b.length&&("category"==c||"set"==c)&&b.unbind("click").bind("click",function(){a.product_list.settingsListDialog();return false});
b=a("#s-product-list-delete");b.length&&("category"==c||"set"==c)&&b.unbind("click").bind("click",function(){a("#s-product-list-delete-dialog").waDialog({disableButtonsOnSubmit:true,onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(){var b=a(this);b.find(".dialog-buttons i.loading").show();var e={hash:a.product_list.collection_hash.join("/")||"all",remove:["list"]};b.find("input[name=s-delete-products]:checked").val()=="1"&&e.remove.push("products");var f=function(){a.product_list.remove(e,
function(b){var d=a("#"+a.product_list.collection_hash.join("-")),e=d.prev(".drag-newposition"),f=a("#s-"+a.product_list.collection_hash[0]+"-list"),m=f.find("ul"),l;if(c=="set"){d.remove();e.remove()}else{l=d.find("ul:first");if(l.length){l.find(">li.drag-newposition:first").remove();d.hide();l.find(">li").each(function(){d.after(this)})}l=d.parents("ul:first");d.remove();e.remove();if(!l.find("li.dr").length&&m.get(0)!=l.get(0)){l.parents("li:first").find("i.collapse-handler").remove();l.remove()}}if(m.find("li.dr:first").length){m.show();
f.find(".s-empty-list").hide()}else{m.hide();f.find(".s-empty-list").show()}a.product_list.sidebar.trigger("update",b.data.lists);b.data.old_parent_category&&(typeof b.data.old_parent_category.children_count!=="undefined"&&!parseInt(b.data.old_parent_category.children_count,10))&&a("#category-"+b.data.old_parent_category.id+"-handler").remove();location.href="#/"})},b=a("#"+a.product_list.collection_hash.join("-")+"-handler");b.length?a.categories_tree.expand(b,function(a){a.parent().find("ul:first").hide();
f()}):f();return false}});return false})},initCategoryDescriptionWysiwyg:function(b){var c=3,d=function(b){return a.ajax({url:b,dataType:"script",cache:!0})},e=function(){var a=b.find(".field.description");a.find("i").hide();a.find(".s-editor-core-wrapper").show();waEditorInit({id:"s-category-description-content",prefix:"s-category-description-",upload_url:"",lang:"{$lang}"})},f=function(){0<c?(console&&console.log("Coudn't init editor. Error when loading proper js files. Try again."),g(),c-=1):console&&
console.error("Coudn't init editor. Error when loading proper js files")},g="en"!=wa_lang?function(){a.when(d(wa_url+"wa-content/js/elrte/elrte.min.js"),d(wa_url+"wa-content/js/elrte/elrte-wa.js"),d(wa_url+"wa-content/js/elrte/i18n/elrte."+wa_lang+".js")).then(e,f)}:function(){a.when(d(wa_url+"wa-content/js/elrte/elrte.min.js"),d(wa_url+"wa-content/js/elrte/elrte-wa.js")).then(e,f)};g()},initDragndrop:function(){a.product_dragndrop.init({products:!0,view:this.options.view}).bind("move_product",function(b){a.shop.jsonPost("?module=product&action=move&"+
...
b.serialized,function(c){a("body").append(c);a("#s-assign-tags").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){var c=a(this);c.find(".dialog-content h1 span").text("("+b.count+")").show();c.find(".dialog-buttons i.loading").hide()},onSubmit:function(c){var d=a(this);d.find(".dialog-buttons i.loading").show();a.shop.jsonPost(d.attr("action"),d.serializeArray().concat(b.serialized),function(b){b.data.cloud&&a("#s-tag-cloud").trigger("update",[b.data.cloud]);c.trigger("close");a.products.dispatch()},
function(){c.trigger("close")});return!1}})})},typesDialog:function(b){var c=a("#s-types"),d=this.container,e=this.sidebar,f=function(){a("#s-types").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(c){var f=a(this);f.find(".dialog-buttons i.loading").show();a.shop.jsonPost(f.attr("action"),f.serializeArray().concat(b.serialized),function(b){e.trigger("update",{type:b.data.types});d.find(".s-select-all:first").trigger("select",
!1);f.find("input:checked").attr("checked",!1);c.trigger("close");a.products.dispatch()});return!1}})},g=c.parent();c.length?f():(g=a("<div></div>").appendTo("body"),g.load("?module=dialog&action=types",f))},deleteFromSet:function(b){0<b.count&&a.shop.jsonPost("?module=products&action=deleteFromSet&id="+this.collection_hash[1],b.serialized,function(){a.products.dispatch()})},deleteFromCategory:function(b){0<b.count&&a.shop.jsonPost("?module=products&action=deleteFromCategory&id="+this.collection_hash[1],
b.serialized,function(){a.products.dispatch()})},deleteProductsDialog:function(b){var c=a("#s-product-list-delete-products-dialog"),d=c.parent();c.length||(d=a("<div></div>").appendTo("body"));d.load("?module=dialog&action=productsDelete&count="+b.count,function(){a("#s-product-list-delete-products-dialog").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(c){a(this).find(".dialog-buttons i.loading").show();a.product_list.remove(a.extend(b,
{remove:["products"]}),function(b){a.product_list.sidebar.trigger("update",b.data.lists);a.products.dispatch();c.trigger("close")});return!1}})})},_iframePost:function(b,c,d){var e=b.attr("id")+"-iframe";a("#"+e).length||b.after("<iframe id="+e+" name="+e+" style='display:none;'></iframe>");var f=a("#"+e);b.attr("target",e);f.one("load",function(){try{var b=a(this).contents().find("body").html(),e=a.parseJSON(b)}catch(f){d(b);return}"ok"==e.status?c(e):d(e)})},settingsListDialog:function(){var b=
a("#s-product-list-settings-dialog");p=b.length?b.parent():a("<div></div>").appendTo("body");p.load("?module=dialog&action=productListSettings&"+a.product_list.collection_param,function(){var b=a("#s-product-list-create-dialog");b.length&&(b.parent().remove(),b.remove());a("#s-product-list-settings-dialog").waDialog({onLoad:function(){a("#s-category-description-content").length&&a.product_list.initCategoryDescriptionWysiwyg(a(this))},onSubmit:function(b){var c=a(this),f=function(c){var e=a.product_list.collection_hash,
f=location.hash.replace(e[0]+"_id="+e[1],e[0]+"_id="+c.data.id),g=a("#"+e.join("-"));g.find(".name:first").html(c.data.name);c.data.status=="0"?g.children("a").addClass("gray"):c.data.status=="1"&&g.children("a").removeClass("gray");g.find(".id:first").html(c.data.id);g.attr("id",e[0]+"-"+c.data.id);g.find("a").attr("href",f);location.hash!=f?location.hash=f:a.products.dispatch();b.trigger("close")},g=function(a){if(a&&a.errors){var a=a.errors,c;for(c in a)b.find("input[name="+c+"]").addClass("error").parent().find(".errormsg").text(a[c]);
return false}};a("#s-category-description-content").length&&waEditorUpdateSource({id:"s-category-description-content"});if(c.find("input:file").length)a.product_list._iframePost(c,f,g);else{a.shop.jsonPost(c.attr("action"),c.serialize(),f,g);return false}}})})},createListDialog:function(b,c,d){var e=a("#s-product-list-create-dialog");p=e.length?e.parent():a("<div></div>").appendTo("body");p.load("?module=dialog&action=productListCreate&type="+b+"&parent_id="+c,function(){var c=a("#s-product-list-settings-dialog");
c.length&&(c.parent().remove(),c.remove());a("#s-product-list-create-dialog").waDialog({onLoad:function(){a("#s-category-description-content").length&&a.product_list.initCategoryDescriptionWysiwyg(a(this))},onSubmit:function(c){var e=a(this),f=function(e){typeof d==="function"&&d(e.data,b);location.href="#/products/"+b+"_id="+e.data.id+"&view="+a.product_list.options.view;c.trigger("close")},i=function(a){if(a&&a.errors){var a=a.errors,b;for(b in a)c.find("input[name="+b+"]").addClass("error").parent().find(".errormsg").text(a[b]);
return false}};a("#s-category-description-content").length&&waEditorUpdateSource({id:"s-category-description-content"});if(e.find("input:file").length)a.product_list._iframePost(e,f,i);else{a.shop.jsonPost(e.attr("action"),e.serialize(),f,i);return false}}})})},exportProducts:function(a,c){for(var d=[],e,f=!1;e=a.serialized.pop();)e.name&&("product_id[]"==e.name?d.push(parseInt(e.value,10)):"hash"==e.name&&(f=e.value));e="?action=importexport#/"+c;f?window.location=e+("/hash/"+f):d.length&&(e+="/hash/id/"+
d.join(","),window.location=e)},remove:function(b,c){var d={},e;b.product_id?e=function(){100>=b.product_id.length&&(d.get_lists=!0);d.product_id=b.product_id.splice(0,100);a.shop.jsonPost("?module=products&action=deleteList",d,function(a){b.product_id.length?e():typeof c==="function"&&c(a)})}:(d.hash=b.hash||this.collection_hash.join("/")||"all",d.remove=a.isArray(b.remove)&&b.remove.length?b.remove:["list"],1==d.remove.length&&"list"==d.remove[0]?e=function(){a.shop.jsonPost("?module=products&action=deleteList",
