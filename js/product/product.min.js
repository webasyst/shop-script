...
b.type_id:"")).slice(1)},productsAction:function(){var b=Array.prototype.join.call(arguments,"/");b=a.shop.helper.parseParams(b||"");this.list_hash=this.hash;this.list_params=b;void 0!==a.product_list&&void 0!==a.product_list.fixed_blocks&&(a.product_list.fixed_blocks.set&&a.product_list.fixed_blocks.set.unsetFixed(),a.product_list.fixed_blocks.category&&a.product_list.fixed_blocks.category.unsetFixed());window.location.href=this.options.shop_url+"products/"},checkAlerts:function(){var b=a.storage.get("shop/alerts");
a(".s-alert").each(function(){-1==a.inArray(a(this).data("alert"),b)&&a(this).show()})},productAction:function(b,c,d){"undefined"!==typeof d&&"force-old"===d&&(d="main/"+d);var e=Array.prototype.slice.call(arguments).filter(function(g){return g.length}).join("/");a.shop.trace("$.products.productAction",[e,arguments]);var f="?module=product";b&&(f+="&id="+b);"undefined"!=typeof a.product?a.product.dispatch(e):this.load(f,function(g){a.product.dispatch(e)})},productTermination:function(){"undefined"!=
...
a(".lazyloading-link").off("click").on("click",function(){a(window).lazyLoad("force");return!1})}},initView:function(){if(!this.append({product_stocks:this.options.product_stocks,stocks:this.stocks}))return this},initDragndrop:function(){this.container.find("td.s-stock-cell .js-item").liveDraggable({containment:this.container,distance:5,helper:function(){return a(this).clone().append('<i class="fas fa-times text-gray no-bw" style="margin-left: 0; margin-right: 0; display: none;"></i>')},refreshPositions:!0,
...
c=c.draggable;var d=c.parents("td:first");if(b.get(0)==d.get(0))return!1;c=c.attr("id").replace("s-item-","").split("-");d=c[1];b=b.attr("data-stock-id");var e=a("#s-item-"+[c[0],b].join("-"));if(e.length&&e.hasClass("infinity"))return!1;e=a("#s-transfer-product-dialog");e.length&&e.parent().remove();a("<div></div>").appendTo("body").load("?module=transfer",{sku_id:c[0],from:d,to:b},function(){a(this).find(".dialog").on("afterSubmit",function(f,g){f=a(".s-stocks-transfers");if(f.data("empty"))f.data("empty",
0),f.html(g.data.html),a('.s-transfer-item[data-id="'+g.data.transfer.id+'"]',f);else{var h=a("<div>").html(g.data.html);g=a('.s-transfer-item[data-id="'+g.data.transfer.id+'"]',h);f.find("tbody").prepend(g)}})})}})},append:function(b){var c=this;b=function(d){var e=[];a.each(d.product_stocks,function(f,g){0>c.products_ids.indexOf(g.id)&&(e.push(g),c.products_ids.push(g.id))});d.product_stocks=e;return d}(b);try{this.container.append(tmpl("template-product-stocks",b))}catch(d){return console.error("Error: "+
