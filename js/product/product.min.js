...
profileInit:function(){void 0!==a.product_list&&void 0!==a.product_list.fixed_blocks&&(a.product_list.fixed_blocks.set&&a.product_list.fixed_blocks.set.unsetFixed(),a.product_list.fixed_blocks.category&&a.product_list.fixed_blocks.category.unsetFixed());if(this.options.edit_rights){var b=a("#shop-productprofile").find(".s-product-name");parseInt(this.path.id,10)?b.addClass("editable"):b.removeClass("editable");var c=this.get("form");b.inlineEditable({minSize:{width:150},maxSize:{width:550},inputClass:"s-title-h1-edit",
beforeMakeEditable:function(){a("#s-edit-product").hide()},afterBackReadable:function(b,d){a("#s-edit-product").show();if(!d.changed)return false;a.shop.jsonPost("?module=product&action=save&id="+a.product.path.id,{update:{name:a(b).val()}},function(){var d=a(b).val();document.title=d+a.product.options.title_suffix;c.find('input[name="product[name]"]').val(d)})},hold:function(){return!a(this).hasClass("editable")}})}var d=this;setTimeout(function(){d.call("profileLazyInit",[])},2E3)},profileLazyInit:function(){a("#product-sales-plot").empty().length&&
...
showTicks:!1}},highlighter:{lineWidthAdjust:12.5}}):a("#product-sales-plot").remove(),a("#product-sku-plot").empty().length&&(sku_plot_data&&sku_plot_data.length&&sku_plot_data[0]&&sku_plot_data[0].length?a.jqplot("product-sku-plot",sku_plot_data,{seriesColors:"#0077CC #33BB11 #EE5500 #EEBB11 #44DDDD #6b6b6b #686190 #b2b000 #00b1ab #76b300".split(" "),grid:{borderWidth:0,background:"#ffffff",shadow:!1},legend:{show:!0,location:"s"},seriesDefaults:{shadow:!1,renderer:a.jqplot.PieRenderer,rendererOptions:{padding:0,
sliceMargin:1,showDataLabels:!1}}}):a("#product-sku-plot").remove()))}}})(jQuery);(function(a){a.fn.rateWidget=function(b,c,d){function e(b){var c=0;this.find("i").removeClass("star star-hover").addClass("star-empty").each(function(){if(c==b)return!1;c++;a(this).removeClass("star-empty").addClass("star")});this.attr("data-rate",b)}function f(a){return function(){return a}}var g,h=this;if(this&&this.length){if("string"==typeof b){if("getOption"==b&&"rate"==c)return parseInt(this.attr("data-rate"),10);if("setOption"==b&&("rate"==c&&(e.call(this,parseInt(d,10)),c={rate:d}),"object"===
