...
initReview:function(a){var c=b(document),d=a.$wrapper,e=d.data("id"),f=a.locales,g=a.urls,h=!1;d.on("click",".js-show-image",function(a){a.preventDefault();a=b(this);var e=[];d.find(".js-show-image").each(function(){var a=b(this);e.push({href:a.attr("href"),title:a.attr("title")})});(a=a.closest(".s-image-wrapper").prevAll(".s-image-wrapper").length)&&(e=e.slice(a).concat(e.slice(0,a)));b.swipebox(e,{useSVG:!1,hideBarsDelay:!1,afterOpen:function(){function a(){var d=b("#swipebox-close");d.length&&
d.trigger("click");c.off("scroll",a)}c.on("scroll",a)}})});d.on("click",".js-delete-image",function(a){a.preventDefault();var c=b(this).closest(".s-image-wrapper");a=c.data("image-id");!h&&confirm(f.confirm)&&(h=!0,b.post(g["delete"],{review_id:e,image_id:a},"json").always(function(){h=!1}).done(function(){c.remove()}))})},initLazyLoad:function(a){var c=a.count,d=a.total_count,e=a.url||"?module=reviews",f=b(a.target||".s-reviews:first ul:first");b(window).lazyLoad("stop");c<d&&(b(window).lazyLoad({container:f,
state:"undefined"===typeof a.auto||a.auto?"wake":"stop",load:function(){b(window).lazyLoad("sleep");b(".lazyloading-link").hide();b(".lazyloading-progress").show();b.get(e+"&lazy=1&offset="+c+"&total_count="+d,function(a){a=b("<div></div>").html(a);var e=a.find(".s-reviews").children();c+=e.length;f.append(e);b(".lazyloading-progress-string").replaceWith(a.find(".lazyloading-progress-string"));b(".lazyloading-progress").replaceWith(a.find(".lazyloading-progress"));c>=d?(b(window).lazyLoad("stop"),
b(".lazyloading-link").hide()):(b(".lazyloading-link").show(),b(window).lazyLoad("wake"));a.remove()},"html")}}),b(".lazyloading-link").unbind("click").bind("click",function(){b(window).lazyLoad("force");return!1}))},prepareAddingForm:function(a,c){if(c)this.after(a),a.find(".rate a:first").hide();else{var d=b("#s-review-add li:first");d.find("form").length||d.append(a);a.find(".rate a:first").show()}b.product_reviews.clear(!1);b("input[name=parent_id]",a).val(c)},addHotkeyHandler:function(b,c,d){var a=
this.hotkeys[c];this.form.off("keydown",b).on("keydown",b,function(b){if(b.keyCode==a.key&&b.altKey==a.alt&&b.ctrlKey==a.ctrl&&b.shiftKey==a.shift)return d()})},addReview:function(a,c){var d=this.sidebar_counter;b.post("backend"!=a&&a?"#":"?module=reviews&action=add",b.product_reviews.form.serialize(),function(a){if("fail"==a.status)b.product_reviews.clear(!1),b.product_reviews.showErrors(a.errors);else if("ok"==a.status&&a.data.html){var e=b("input[name=parent_id]",b.product_reviews.form),g=b.product_reviews.form.parents(".s-review:first").parent("li"),
h=a.data.html,k=b("ul:first",g),l=b.product_reviews.container;g.length||(l.show(),k=b("ul:first",l).show());k.length||(k=b('<ul class="menu-v with-icon"></ul>'),g.append(k));k.append(b('<li data-id="'+a.data.id+'" data-parent-id="'+a.data.parent_id+'"></li>').append(h));b("textarea",b.product_reviews.form).val("");g=b("#s-review-add");g.find("form").length||(g.append(b.product_reviews.form),e.val(0));d.length&&d.text(parseInt(d.text(),10)+1);"function"===typeof c&&c(a);b.product_reviews.clear()}else console&&
console.log("Error occured.")},"json").error(function(b){console&&console.log(b.responseText?"Error occured: "+b.responseText:"Error occured.")})},deleteReview:function(a,c){var d=this.container,e=this.sidebar_counter;b.post("?module=reviews&action=changeStatus",{review_id:a,status:this.statuses.deleted},function(b){if("ok"==b.status){var f=d.find("li[data-id="+a+"]").find("div:first");f.removeClass("is-published").removeClass("is-unpublished").addClass("is-deleted");f.find(".s-review-delete").hide();
f.find(".s-review-restore").show();e.length&&e.text(parseInt(e.text(),10)-1);"function"===typeof c&&c(b)}},"json")},restoreReview:function(a){var c=this.container,d=this.sidebar_counter;b.post("?module=reviews&action=changeStatus",{review_id:a,status:this.statuses.published},function(b){"ok"==b.status&&(b=c.find("li[data-id="+a+"]").find("div:first"),b.addClass("is-published").removeClass("is-unpublished").removeClass("is-deleted"),b.find(".s-review-delete").show(),b.find(".s-review-restore").hide(),
d.length&&d.text(parseInt(d.text(),10)+1),"function"===typeof success&&success())},"json")},publishReview:function(a){var c=this.container,d=this.sidebar_counter;b.post("?module=reviews&action=changeStatus",{review_id:a,status:this.statuses.published},function(b){"ok"==b.status&&(b=c.find("li[data-id="+a+"]").find("div:first"),b.addClass("is-published").removeClass("is-unpublished").removeClass("is-deleted"),b.find(".s-review-delete").show(),b.find(".js-review-publish").remove(),d.length&&d.text(parseInt(d.text(),
...
shopDialogProductsCategory.prototype.updateShowFilterButton=function(){var a=this.SEARCH_STEP,b=this.$wrapper.find(".js-show-more-filters"),d=this.$wrapper.find(".js-category-filters .js-filter-checkbox").length,e=this.show_more_text;d=d-1-this.filter_ignore_id.length;d+this.SEARCH_STEP>this.filter_count&&(a=this.filter_count-d);1>a?b.hide():(e=e.replace(/%d/g,a),b.text(e))};shopDialogProductsCategory.prototype.setFilterElement=function(a,b){var c=this.filter_element_html,e=this.$wrapper.find(".js-category-filters");
b=b?b:!1;c=c.replace(/%id/g,a.id);c=c.replace(/%name/g,a.name);c=c.replace(/%code/g,a.code);c=c.replace(/%type_name/g,a.type_name);e.append(c);b&&this.$wrapper.find('.js-category-filter input[data-filter-id="'+a.id+'"]').prop("checked",!0)};shopDialogProductsCategory.prototype.getFilterOffset=function(){var a=this.$wrapper.find(".js-category-filters .js-filter-checkbox").length;a=a-1-this.filter_ignore_id.length;0>a&&(a=0);return a};shopDialogProductsCategory.prototype.initFilterIgnoreId=function(){var a=
