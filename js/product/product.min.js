...
f?d.find("textarea").val():d.data("type");a=a.serialized;a.push({name:"code",value:k});b.shop.jsonPost("?module=product&action=badgeSet",a,c,function(a){"object"===typeof a.errors&&"string"===typeof a.errors[0]&&alert(a.errors[0]);d.find(".loading").remove()})}},duplicate:function(a,d){var c=this,f=[];b.shop.jsonPost("?module=products&action=duplicate",{hash:a,limit:50,offset:d.offset||0},function(b){"ok"==(b.status||"error")&&(f=f.concat(b.data.new_ids||[]),b.data.offset<b.data.total_count?(d.offset=
b.data.offset,c.duplicate(a,d),d.progress(b.data||{})):d.finish(b.data||{},f))},function(a){a.errors&&alert(a.errors)})},remove:function(a,d){var c={},f=[];if(a.product_id)var g=function(){100>=a.product_id.length&&(c.get_lists=!0);c.product_id=a.product_id.splice(0,100);b.shop.jsonPost("?module=products&action=deleteList",c,function(b){b.data.not_allowed&&b.data.not_allowed.length&&(f=f.concat(b.data.not_allowed));a.product_id.length?g():"function"===typeof d&&d(b,f)})};else c.hash=a.hash||this.collection_hash.join("/")||
"all",c.remove=b.isArray(a.remove)&&a.remove.length?a.remove:["list"],1==c.remove.length&&"list"==c.remove[0]?g=function(){b.shop.jsonPost("?module=products&action=deleteList",c,d)}:(c.count=100,g=function(){b.shop.jsonPost("?module=products&action=deleteList",c,function(a){a.data.not_allowed&&a.data.not_allowed.length&&(f=f.concat(a.data.not_allowed));0<a.data.rest_count&&null!=a.data.rest_count?g():"function"===typeof d&&d(a,f)})});g()},associatePromo:function(c,d){function e(){var d=location.pathname+
"?module=productsAssociatePromoDialog",e={products_hash:a(c.serialized)};return b.post(d,e).done(function(a){b(a).waDialog({onLoad:function(){b("body").addClass("is-scroll-locked")},onCancel:function(){b("body").removeClass("is-scroll-locked");b(this).remove()}})})}d.data("locked")||(d.data("locked",!0),e().always(function(){d.removeData("locked")}))},rubberTable:function(){var a=b("#wa"),d=b("#s-content"),e=b("#s-content > .content");d=parseInt(d.css("margin-left"));var f=parseInt(e.css("margin-right")),
g=b(".s-product-list-table-container table").width(),h=a.attr("style");h&&a.data("style",h);e=parseInt(e.width()-b(".s-product-list-table-container").width())+g+d+f;a.width()<e&&a.css({"min-width":e+"px"});b(window).resize()}}})(jQuery);var shopDialogProductsSet=function(b){shopDialogProductsSet=function(a){this.$wrapper=a.$wrapper;this.is_new=a.is_new;this.initClass()};shopDialogProductsSet.prototype.initClass=function(){this.is_new&&this.initTransliterateSetID();this.initTypeSwitch()};shopDialogProductsSet.prototype.initTypeSwitch=function(){var a=this.$wrapper;a.find("input[name=type]").on("click",function(){"0"==b(this).val()?a.find(".js-set-dynamic-settings").hide():a.find(".js-set-dynamic-settings").show()})};shopDialogProductsSet.prototype.initTransliterateSetID=
