...
$.fn.liveDroppable=function(b){this.each(function(b,a){b=$(this);b.data("init_droppable")&&b.die("mouseover",b.data("init_droppable"))});var a=function(){var c=$(this);c.data("init_droppable")||(c.data("init_droppable",a).droppable(b),c.mouseover())};a.call(this);this.die("mouseover",a).live("mouseover",a)};(function(b){b.fn.inlineEditable=function(a,c){function d(){r(b(this))||b(this).addClass(l.placeholderClass).text(l.placeholder)}function e(){r(b(this))==l.placeholder&&b(this).text("").removeClass(l.placeholderClass)}function f(a){return b(a).val()?!1:(b(this).text(l.placeholder).addClass(l.placeholderClass),!0)}function g(){q="edit";this.id=this.id||(""+Math.random()).slice(2);var a=this.id+"-input",c=b("#"+a);c.length||(p.after(k(a)),c=b("#"+a));c.addClass(l.inputClass);m(c,p);l.placeholder&&r(b(this))==
l.placeholder&&e.call(p);l.beforeMakeEditable.call(this,c);u=l.truncate?p.data("real_text"):r(p);c.val(u).show().focus();p.hide();b(l.editLink).hide();if(!t){a=[];for(var d=[],f=0,g=l.makeReadableBy.length;f<g;++f){var n=l.makeReadableBy[f];"blur"==n&&c.blur(function(){"read"!=q&&h.call(this)});"enter"==n&&a.push(13);"esc"==n&&a.push(27)}f=0;for(g=l.updateBy.length;f<g;++f)n=l.updateBy[f],"alt+enter"==n&&d.push({ctrl:!1,alt:!0,shift:!1,key:13}),"ctrl+enter"==n&&d.push({ctrl:!0,alt:!1,shift:!1,key:13}),
"ctrl+s"==n&&d.push({ctrl:!0,alt:!1,shift:!1,key:17});a.length&&function(b){c.keydown(function(a){!~b.indexOf(a.keyCode)||a.ctrlKey||a.altKey||a.shiftKey||"read"!=q&&h.call(this,27==a.keyCode?u:null);if(d.length)for(var c in d){var e=d[c];if(a.keyCode==e.key&&a.ctrlKey==e.ctrl&&a.altKey==e.alt&&a.shiftKey==e.shift){p.trigger("readable");break}}})}(a);p.unbind("readable.inlineEditable").bind("readable.inlineEditable",function(a,c){"read"!=q&&(a=b("#"+(this.id+"-input")),h.call(a,a.val(),c))});t=!0}l.afterMakeEditable.call(this,
c)}function h(a,c){c="undefined"===typeof c?!1:!0;void 0!=a&&null!=a?b(this).val(a):a=b(this).val();if(!1!==c||!1!==l.beforeBackReadable.call(p.get(0),this,{changed:a!=u,old_text:u,new_text:a})){q="read";if(!l.placeholder||!f.call(p,this))if(l.allowEmpty||a){if(l.truncate)p.data("real_text",a),p.text(a.length<l.truncate-3?a:a.substr(0,l.truncate-3)+"...");else{var e=p,g=a;l.html?e.html(g):e.text(g)}a||d.call(this)}p.show();b(this).hide();b(l.editLink).show();!1===c&&l.afterBackReadable.call(p.get(0),
this,{changed:a!=u,old_text:u})}}function k(b){switch(l.inputType){case "textarea":return'<textarea id="'+b+'" style="display:none;"></textarea>';default:return'<input type="text" id="'+b+'" style="display:none;">'}}function m(b,a){var c=l.size.height||a.height();a=l.size.width||1.5*a.width();c=l.minSize.height&&c<l.minSize.height?l.minSize.height:c;a=l.minSize.width&&a<l.minSize.width?l.minSize.width:a;c=l.maxSize.height&&c>l.maxSize.height?l.maxSize.height:c;a=l.maxSize.width&&a>l.maxSize.width?
l.maxSize.width:a;b.height(c);b.width(a)}function n(b){return function(){return b}}function r(b){return l.html?b.html():b.text()}if(this.length){var t=!1;if("string"==typeof a){if("setOption"==a){var l=this.data("inlineEditableSettings")||{};b.extend(!0,l,c);"undefined"!==typeof c.hold&&"function"!==typeof c.hold&&(l.hold=n(l.hold));this.data("inlineEditableSettings",l)}return this}c=this.data("inlineEditableSettings");this.data("inlineEditableSettings",b.extend({inputType:"text",inputClass:"",size:{height:null,
width:null},minSize:{height:null,width:null},maxSize:{height:null,width:null},editLink:null,editOnItself:!0,placeholder:null,makeReadableBy:["blur","enter","esc"],updateBy:["ctrl+enter","alt+enter"],beforeBackReadable:function(){},afterBackReadable:function(){},beforeMakeEditable:function(){},afterMakeEditable:function(){},placeholderClass:"hint",truncate:!1,hold:!1,html:!1,allowEmpty:!1},c,a||{}));l=this.data("inlineEditableSettings")||{};var p=this,q="read",u="";"function"!==typeof l.hold&&(l.hold=
n(l.hold));(function(){if(!this.data("inited")){l.truncate&&"boolean"==typeof l.truncate&&(l.truncate=255);if(l.truncate){var a=l.placeholder&&l.placeholder===this.text()?"":this.text();this.data("real_text",a);this.text(a.length<l.truncate-3?a:a.substr(0,l.truncate-3)+"...")}l.placeholder&&d.call(this);l.editLink&&b(l.editLink).unbind("click.inlineEditable").bind("click.inlineEditable",function(){l.hold.call(p)||"edit"!=q&&g.call(p.get(0))});l.editOnItself&&this.unbind("click.inlineEditable").bind("click.inlineEditable",
function(){l.hold.call(p)||"edit"!=q&&g.call(this)});this.unbind("editable.inlineEditable").bind("editable.inlineEditable",function(){l.hold.call(p)||"edit"!=q&&g.call(this)});this.unbind("placeholder.inlineEditable").bind("placeholder.inlineEditable",function(a,c){c&&l.placeholder&&d.call(this);c||b(this).removeClass(l.placeholderClass)});this.data("inited",!0)}}).call(this);return this}}})(jQuery);(function(b){b.fn.photoStreamSlider=function(a){function c(){function a(c){function f(){a.execution=!1;var b="on"+k.charAt(0).toUpperCase()+k.slice(1);b=d[b];"function"==typeof b&&b.call(e);b=c.fn;"function"==typeof b&&b.call(e)}"string"==typeof c&&(c={direction:c,animate:!0});var k=c.direction||"forward",r=c.steps||h.length;if(!a.execution){a.execution=!0;var t=h.filter(":first").outerWidth()*r,p=h.length;if("forward"==k){var q=h.filter(":last").nextAll(":lt("+r+")");r=q.length;q=q.filter(":last");
r&&(h.removeClass("visible"),q.prevAll(":lt("+(p-1)+")").addClass("visible"),q.addClass("visible"))}else q=h.filter(":first").prevAll(":lt("+r+")"),r=q.length,q=q.filter(":last"),r&&(h.removeClass("visible"),q.nextAll(":lt("+(p-1)+")").addClass("visible").show(),q.addClass("visible"));h=b("li.visible",g);p=g.position().left;"forward"==k?(r=n-m-l,p-=t,p=p>-r?p:-r):(p+=t,p=p<l?p:l);c.animate?g.animate({left:p},d.duration,f):(g.css({left:p}),f())}}var g=e.find(d.photoStream),h=b("li.visible",g),k=b("li",
g),m=h.filter(":first").outerWidth()*h.length,n=k.filter(":first").outerWidth()*k.length,r=d.height||k.filter(":first").outerHeight();g.parent().css({overflow:"hidden",height:r,position:"relative",padding:"4px 0",margin:0,width:m});r=g.find("li:first");var t=h.filter(":first"),l=(t.outerWidth()-t.width())/2,p=0,q=r.outerWidth();for(t=t.get(0);r.length&&r.get(0)!=t;)p+=q,r=r.next();g.css({position:"absolute",left:-(p-l),width:n});b(d.forwardLink).unbind("click").bind("click",function(){a("forward");
...
e.unbind("home").bind("home",function(c,d,e){c=parseInt(h.length/2);c=h.filter(":eq("+c+")");var f=c.nextAll(".selected:first"),g=c.prevAll(".selected:first"),k=0,n="";"function"!==typeof d&&(e=d);e="undefined"!==typeof e?e:!0;f.length?(n="forward",c.nextAll().each(function(){++k;if(b(this).hasClass("selected"))return!1})):g.length&&(n="backward",c.prevAll().each(function(){++k;if(b(this).hasClass("selected"))return!1}));n&&k?a({direction:n,steps:k,fn:d,animate:e}):"function"==typeof d&&d();return!1});
...
!1),!1;var m=parseInt(f.attr("id").split("-")[1],10)||0,n=null,r=c.next(),t=c.prev(),l=!1;f.hasClass("drag-newposition")?n=f.parent("ul"):f.children("ul").length?n=f.children("ul"):f.find(">i.collapse-handler-ajax").length||(n=b('<ul class="menu-v with-icons dr unapproved"><li class="drag-newposition unapproved" data-type="'+a+'"></li></ul>').appendTo(f),n.find(".drag-newposition").mouseover(),b('<i class="icon16 darr overhanging collapse-handler-ajax unapproved" id="'+a+"-"+m+'-handler"></i>').insertBefore(f.children("a")),
l=!0);var p=c.parent("ul"),q=p.children("li.dr[id!=category-"+d+"]").length,u=parseInt(p.parent().attr("id").split("-")[1],10)||0;n&&n.append(c).append(r);q||u===m||(p.parent("li").children("i").hide(),p.hide());f.is("li.dr")&&b.product_dragndrop.trigger("move_list",{id:d,type:a,parent_id:m,success:function(a){q||u===m||(p.parent("li").children("i").remove(),p.remove(),b.categories_tree.setCollapsed(u));n?(b(".s-collection-list .unapproved").removeClass("unapproved"),l?b.categories_tree.setExpanded(m):
...
background:"#fff",top:a,width:c,"float":"left"}).appendTo("#s-sidebar"));var f=b("#s-category-list"),g=b("#s-category-list-block"),h=b("#s-set-list"),k=b("#s-set-list-block"),m=function(){function h(){if(!m){var h=b("#s-category-list-handler");u=b.categories_tree.isCollapsed(h);q=f.is(":hidden");var k=b('<div id="s-category-list-dummy" class="block"></div>').css({height:g.height()});g.replaceWith(k);e.show().append(g.hide());g.find(".heading").before('<span class="hint float-right" style="margin-top: 3px;">'+
...
g.css({height:Math.min(c,e)});g.find(".heading").prev(".hint").hide();b=!1}},250))});d.bind("mouseout.fixed_blocks.category",function(a){a.pageX>c+10&&(e&&clearTimeout(e),e=null,b||(f.hide(),g.css({height:""}),g.find(".heading").prev(".hint").show(),b=!0))})})();m=!0}}function k(){if(m){var a=b("#s-category-list-dummy");a.replaceWith(g);g.css({"overflow-x":"","overflow-y":""});var c=b("#s-category-list-handler");u&&b.categories_tree.collapse(c);q||f.show();g.find(".heading").prev(".hint").remove();
b("#s-category-list-handler").show();b("i.add",g).show();a.remove();g.unbind("mousemove.fixed_blocks.category");d.unbind("mouseout.fixed_blocks.category");e.children().length||e.hide();m=!1;b.categories_tree.init()}}var n=g.offset().top,m=!1,q,u;d.unbind("scroll.fixed_blocks.category").bind("scroll.fixed_blocks.category",function(){m||(n=g.offset().top);var c=n;c=document.getElementById("s-category-list-dummy")?c+b("#s-category-list-dummy").height():c+b("#s-category-list-block").height();d.scrollTop()+
a+5>=c?h():k()});return{setFixed:h,unsetFixed:k}}(),n=function(){function f(){if(!q){m=h.is(":hidden");var f=b('<div id="s-set-list-dummy" class="block"></div>').css({height:k.height()});k.replaceWith(f);e.show().append(k);k.find(".heading").before('<span class="hint float-right" style="margin-top: 3px;">'+$_("Drag products here")+"</span>");m||h.hide();b("i.add",k).hide();b("i.collapse-handler",k).hide();k.css({"overflow-x":"hidden","overflow-y":"auto"});(function(){var b=h.is(":hidden"),e;k.bind("mousemove.fixed_blocks.set",
...
k.css({"overflow-x":"","overflow-y":""});k.find(".heading").prev(".hint").remove();m||h.show();b("i.add",k).show();b("i.collapse-handler",k).show();a.remove();k.unbind("mousemove.fixed_blocks.category");d.unbind("mouseout.fixed_blocks.category");e.children().length||e.hide();q=!1}}var n=k.offset().top,m,q=!1;d.unbind("scroll.fixed_blocks.set").bind("scroll.fixed_blocks.set",function(){q||(n=k.offset().top);var c=n;c=document.getElementById("s-set-list-dummy")?c+b("#s-set-list-dummy").height():c+b("#s-set-list-block").height();
d.scrollTop()+a+5>=c?f():g()});return{setFixed:f,unsetFixed:g}}();return{category:m,set:n}},initEditingControls:function(){var a=b("#s-product-list-title"),c=b.product_list.collection_hash[0],d="?module=category&action=save&";"set"===c&&(d="?module=set&action=save&");a.hasClass("editable")&&(a.inlineEditable({minSize:{width:350},maxSize:{width:600},size:{height:30},inputClass:"s-title-h1-edit",beforeMakeEditable:function(){b(".s-product-list-manage").hide()},afterBackReadable:function(a,f){b(".s-product-list-manage").show();
...
shopDialogProductsCategory.prototype.updateShowFilterButton=function(){var a=this.SEARCH_STEP,b=this.$wrapper.find(".js-show-more-filters"),d=this.$wrapper.find(".js-category-filters .js-filter-checkbox").length,e=this.show_more_text;d=d-1-this.filter_ignore_id.length;d+this.SEARCH_STEP>this.filter_count&&(a=this.filter_count-d);1>a?b.hide():(e=e.replace(/%d/g,a),b.text(e))};shopDialogProductsCategory.prototype.setFilterElement=function(a,b){b=void 0===b?!1:b;var c=this.filter_element_html,e=this.$wrapper.find(".js-category-filters");
c=c.replace(/%id/g,a.id);c=c.replace(/%name/g,a.name);c=c.replace(/%code/g,a.code);c=c.replace(/%type_name/g,a.type_name);e.append(c);b&&this.$wrapper.find('.js-category-filter input[data-filter-id="'+a.id+'"]').prop("checked",!0)};shopDialogProductsCategory.prototype.getFilterOffset=function(){var a=this.$wrapper.find(".js-category-filters .js-filter-checkbox").length;a=a-1-this.filter_ignore_id.length;0>a&&(a=0);return a};shopDialogProductsCategory.prototype.initFilterIgnoreId=function(){var a=
[];this.$wrapper.find(".js-category-filters .js-filter-checkbox:checked").each(function(){var c=b(this).val();"price"!==c&&a.push(c)});this.filter_ignore_id=a};shopDialogProductsCategory.prototype.initFilterAutocomplete=function(){var a=this,c=a.$wrapper.find(".js-filter-autocomplete");c.autocomplete({source:function(c,e){b.post("?action=autocomplete&type=filter",{term:c.term,category_id:a.category_id,options:{ignore_id:a.filter_ignore_id,category_type:a.category_type}},function(a){e(a)},"json")},
minLength:1,delay:300,create:function(){c.autocomplete("widget").appendTo(".js-filter-autocomplete-block")},select:function(c,e){c.preventDefault();a.setFilterElement(e.item,!0);a.filter_ignore_id.push(parseInt(e.item.id));b(this).val("");return!1},focus:function(){return!1}})};shopDialogProductsCategory.prototype.initAutocomplete=function(){var a=this,c=a.$wrapper.find(".js-autocomplete"),d=[];c.length&&c.autocomplete({source:function(c,f){a.$wrapper.find(".js-condition-feature").each(function(){var a=
b(this).data("feature_id");b.isNumeric(a)&&-1==b.inArray(a,d)&&d.push(a)});b.ajax({type:"POST",url:"?action=autocomplete&type=feature",data:{term:c.term,options:{ignore_id:d,count:1}},success:function(b){var c=a.$wrapper.find(".js-autocomplete-wrapper .errormsg");f(b);0===b.length?c.html("").html($_("Matching features were not found or are already selected.")):c.html("")},dataType:"json"})},minLength:1,delay:300,create:function(){c.autocomplete("widget").appendTo(".js-autocomplete-block")},select:function(b,
c){a.renderFeature(c.item.id);a.ignore_id.push(parseInt(c.item.id));return!1},focus:function(){return!1}})};shopDialogProductsCategory.prototype.initRangeSlider=function(a){var c=b(a).find(".js-begin"),d=b(a).find(".js-end"),e=parseFloat(c.attr("placeholder")),f=parseFloat(d.attr("placeholder")),g=1,h=b(a).find(".js-range-slider");if(h.data("step"))g=parseFloat(h.data("step"));else if(a=f-e,Math.round(e)!=e||Math.round(f)!=f){g=a/10;for(a=0;1>g;)g*=10,a+=1;g=Math.pow(10,-a);(a=Math.round(1E5*Math.abs(Math.round(e)-
e))/1E5)&&a<g&&(g=a);(a=Math.round(1E5*Math.abs(Math.round(f)-f))/1E5)&&a<g&&(g=a)}e=parseFloat(c.val()?c.val():0);f=parseFloat(d.val()?d.val():100<c.val()?parseFloat(c.val())+100:100);h.slider({range:!0,min:e-3,max:f+5,step:g,values:[e,f],slide:function(a,e){a=b(this).slider("option","min");var f=b(this).slider("option","max");2!=b(e.handle).index()&&(e.values[0]==a&&b(this).slider("option","min",a-g),c.val(e.values[0]));1!=b(e.handle).index()&&(e.values[1]==f&&b(this).slider("option","max",f+g),
d.val(e.values[1]))},stop:function(a,b){d.change()}});c.add(d).change(function(){var a=""===c.val()?h.slider("option","min"):parseFloat(c.val()),b=""===d.val()?h.slider("option","max"):parseFloat(d.val());b>=a&&(h.slider("option","values",[a,b]),h.slider("option","max",parseFloat(b)+5),h.slider("option","min",parseFloat(a)-3))})};shopDialogProductsCategory.prototype.initShowFeatures=function(a,b,d,e,f){var c=a.type.substr(0,5);if("range"==c){var h=[],k=[],m;for(m in a.values)a.values.hasOwnProperty(m)&&
(h.push(parseInt(a.values[m].begin)),k.push(parseInt(a.values[m].end)));a.values={};a.values[0]={begin:Math.min.apply(Math,h)?Math.min.apply(Math,h):"",end:Math.max.apply(Math,k)?Math.max.apply(Math,k):""}}b.append(tmpl(d,{feature:a,default_checked:e,show_all:f}));"range"==c&&this.initRangeSlider(".js-feature-slider-"+a.code)};shopDialogProductsCategory.prototype.initGetFeatures=function(){var a=this;this.$wrapper.on("change",".js-condition-feature",function(){var c=b(this).closest("tr").find(".js-condition-feature-block");
