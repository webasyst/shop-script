...
i.length;g.css("width",m);"prepend"==b.type&&(g.is(":animated")&&g.stop(!1,!0),g.css("left",parseInt(g.css("left"))-h));g.find("li.selected").hasClass("visible")&&e.trigger("home",[null,!1])});e.unbind("forward backward").bind("forward backward",function(a,c){b({direction:a.type,steps:c.steps,animate:"undefined"!==typeof c.animate?c.animate:!0,fn:c.fn});var d=g.find("li.selected"),e="forward"==a.type?d.next("li:not(.dummy)"):d.prev("li:not(.dummy)");e.length&&(d.removeClass("selected"),e.addClass("selected"))});
e.unbind("home").bind("home",function(c,d,e){var c=parseInt(h.length/2),c=h.filter(":eq("+c+")"),g=c.nextAll(".selected:first"),i=c.prevAll(".selected:first"),j=0,m="";"function"!==typeof d&&(e=d);e="undefined"!==typeof e?e:!0;g.length?(m="forward",c.nextAll().each(function(){++j;if(a(this).hasClass("selected"))return!1})):i.length&&(m="backward",c.prevAll().each(function(){++j;if(a(this).hasClass("selected"))return!1}));m&&j?b({direction:m,steps:j,fn:d,animate:e}):"function"==typeof d&&d();return!1});
