...
"").split("-");d=c[1];a=a.attr("data-stock-id");var e=b("#s-item-"+[c[0],a].join("-"));if(e.length&&e.hasClass("infinity"))return!1;e=b("#s-transfer-product-dialog");e.length&&e.parent().remove();b("<div></div>").appendTo("body").load("?module=transfer",{sku_id:c[0],from:d,to:a})}})},append:function(a){var c=this;a=function(a){var d=[];b.each(a.product_stocks,function(b,a){0>c.products_ids.indexOf(a.id)&&(d.push(a),c.products_ids.push(a.id))});a.product_stocks=d;return a}(a);try{this.container.append(tmpl("template-product-stocks",
