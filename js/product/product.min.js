...
a('<div class="block double-padded"></div>').append(b.find(":not(style)"));a("#s-content").empty().append(b);return false}return true};var b=window.location.hash;b==="#/"||!b?this.dispatch():a.wa.setHash(b)},skip_dispatch:0,forceHash:function(b){if(b!=location.hash){a.products.skip_dispatch++;a.wa.setHash(b)}},dispatch:function(b){if(a.products.skip_dispatch>0)a.products.skip_dispatch--;else{if(b===void 0)b=window.location.hash;var b=b.replace(/(^[^#]*#\/*|\/$)/g,""),c=new a.Event("shop_before_dispatched");
a(window).trigger(c);if(c.isDefaultPrevented()){a.products.skip_dispatch=1;window.location.hash=a.products.list_hash;return false}this.hash=b;try{if(b){b=b.split("/");if(b[0]){for(var c="",d=b.length,e=0;e<b.length;e++){var f=b[e];if(e<2)if(e===0)c=f;else if(c=="product"||c=="tag"||c=="search"||c=="plugins"||c=="pages"||c=="stocks"){d=e;break}else if(parseInt(f,10)!=f&&f.indexOf("=")==-1)c=c+(f.substr(0,1).toUpperCase()+f.substr(1));else{d=e;break}else{d=e;break}}var g=b.slice(d);this.preExecute(c,
g);if(typeof this[c+"Action"]=="function"){a.shop.trace("$.products.dispatch",[c+"Action",g]);this[c+"Action"].apply(this,g)}else a.shop.error("Invalid action name:",c+"Action")}else{this.preExecute();this.defaultAction()}}else{this.preExecute();this.defaultAction()}}catch(h){a.shop.error(h.message,h)}}},load:function(b,c){var d=Math.random();this.random=d;var e=this;a.get(b,function(b){if(e.random==d){a("#s-content").removeClass("bordered-left").html(b);a("html, body").animate({scrollTop:0},200);
if(c)try{c.call(this)}catch(g){a.shop.error("$.products.load callback error: "+g.message,g)}}})},addOptions:function(b){this.options=a.extend(this.options,b||{})},preExecute:function(b){try{if(this.data.prev_action&&this.data.prev_action!=b){var c=this.data.prev_action+"Termination";a.shop.trace("$.products.preExecute",[c,b]);typeof this[c]=="function"&&this[c].apply(this,[])}this.data.prev_action=b;var d=a("#wa"),e=d.data("style");e?d.attr("style",e):d.removeAttr("style");a(window).resize();a("body > .dialog").trigger("close").remove()}catch(f){a.shop.error("preExecute error: "+
f.message,f)}},defaultAction:function(){this.productsAction()},welcomeAction:function(){this.load("?module=products&action=welcome")},paramsFromSession:function(b){if(!window.sessionStorage||!window.JSON||!window.JSON.stringify||!window.JSON.parse)return b;if(b.category_id){storage=sessionStorage.getItem("shop/list_categories")||"{}";try{storage=JSON.parse(storage)}catch(c){storage={}}var d=storage[b.category_id]=storage[b.category_id]||{};a.each(["sort","order"],function(a,c){b[c]===void 0?b[c]=
d[c]:d[c]=b[c]});try{sessionStorage.setItem("shop/list_categories",JSON.stringify(storage))}catch(e){}}return b},buildProductsUrlComponent:function(a){a=this.paramsFromSession(a);return((a.view?"&view="+a.view:"")+(a.category_id?"&category_id="+a.category_id:"")+(a.set_id?"&set_id="+a.set_id:"")+(a.tag?"&tag="+a.tag:"")+(a.sort?"&sort="+a.sort:"")+(a.order?"&order="+a.order:"")+(a.text?"&text="+a.text:"")+(a.edit?"&edit="+a.edit:"")+(a.hash?"&hash="+a.hash:"")+(a.page?"&page="+a.page:"")+(a.type_id?
"&type_id="+a.type_id:"")).slice(1)},productsAction:function(){var b=Array.prototype.join.call(arguments,"/"),b=a.shop.helper.parseParams(b||"");this.list_hash=this.hash;this.list_params=b;if(a.product_list!==void 0&&a.product_list.fixed_blocks!==void 0){a.product_list.fixed_blocks.set&&a.product_list.fixed_blocks.set.unsetFixed();a.product_list.fixed_blocks.category&&a.product_list.fixed_blocks.category.unsetFixed()}this.load("?module=products&"+this.buildProductsUrlComponent(b),this.checkAlerts)},
checkAlerts:function(){var b=a.storage.get("shop/alerts");a(".s-alert").each(function(){a.inArray(a(this).data("alert"),b)==-1&&a(this).show()})},productAction:function(b,c,d){var e=Array.prototype.slice.call(arguments).filter(function(a){return a.length}).join("/");a.shop.trace("$.products.productAction",[e,arguments]);var f="?module=product";b&&(f=f+("&id="+b));typeof a.product!="undefined"?a.product.dispatch(e):this.load(f,function(){a.product.dispatch(e)})},productTermination:function(){typeof a.product!=
"undefined"&&a.product.termination()},reviewsAction:function(){this.load("?module=reviews")},stocksAction:function(b){var c="";if(!b||b==="desc"||b==="asc")c="count";else{var b=""+(b||""),d=b.match(/stock_count_(\d*)_*(desc|asc)*/);if(d){c="stock_count_"+d[1];b=d[2]==="desc"?"desc":"asc"}}a("#s-stocks-container").length?a("#s-stocks-container").trigger("load",["balance",(b?"order="+b:"")+(c?"&sort="+c:"")]):this.load("?module=stocks"+(b?"&order="+b:"")+(c?"&sort="+c:"")+"&tab=balance")},stockslogAction:function(b){a("#s-stocks-container").length?
a("#s-stocks-container").trigger("load",["log",b?b:""]):this.load("?module=stocks"+(b?"&"+b:"")+"&tab=log")},promosAction:function(a){this.load("?module=promos"+(a?"&"+Array.prototype.join.call(arguments,"/"):""))},servicesAction:function(b){this.load("?module=services"+(b?"&id="+b:""),function(){a("#s-content").addClass("bordered-left");typeof a.products.afterServicesAction==="function"&&a.products.afterServicesAction()})},initCollapsible:function(){var b=function(b,e){a(b).removeClass("darr").addClass("rarr");
c(b).hide();if(!e){a.storage.set("shop/products/"+b.id+"/collapse",1);if(e!==false){var f=b.id.replace(/\-handler$/,""),f=a(b).parents("div.block:first").find("#"+f+":first");if(f.length)(f=f.data("on-collapse-url"))&&a.get(f)}}},c=function(b){b=a(b).parent();return b.is("li")?b.find("ul:first"):b.next()};a(".collapse-handler").die("click").live("click",function(){if(a(this).hasClass("darr"))b(this);else{c(this).show();var d=a(this);d.removeClass("rarr").addClass("darr");a.storage.del("shop/products/"+
this.id+"/collapse");var e=this.id.replace(/\-handler$/,""),f=d.parents("div.block:first").find("#"+e+"-placeholder:first");if(f.length){var g=a(this).parents("div.block:first").find(".count:first");g.find("i.icon16.loading").remove();g.find("i.icon16").hide();g.prepend('<i class="icon16 loading"></i>');a.get(f.data("url"),function(b){f.replaceWith(a(b));g.find("i.icon16.loading").remove();g.find("i.icon16").show();f.remove()})}else{d=a(this).parents("div.block:first").find("#"+e+":first");if(d.length)(d=
d.data("on-expand-url"))&&a.get(d)}}}).each(function(){var c="shop/products/"+this.id+"/collapse",e=a(this).hasClass("rarr");(a.storage.get(c)||e)&&b(this,!e)});a(".collapse-handler").closest(".heading").off("click").on("click",function(b){$collapse_handler=a(this).find(".collapse-handler");$collapse_handler.is(b.target)||$collapse_handler.click()})},initSearch:function(){var b=function(){a.wa.setHash("#/products/"+(a.products.list_params&&a.products.list_params.view?"view="+a.products.list_params.view+
"&":"")+"text="+encodeURIComponent(this.value))},c=a("#s-products-search");c.unbind("keydown").bind("keydown",function(c){if(c.keyCode==13){b.call(this);var e=a(this);e.autocomplete("close");setTimeout(function(){e.autocomplete("close")},300);return false}});c.unbind("search").bind("search",function(){b.call(this);return false});c.autocomplete({source:"?action=autocomplete",minLength:3,delay:300,select:function(b,e){c.val("");a.wa.setHash("#/product/"+e.item.id);return false}})},jsonPost:function(b,
c,d,e){a.shop.jsonPost(b,c,d,e)},_iframePost:function(b,c,d){var e=b.attr("id")+"-iframe";a("#"+e).length||b.after("<iframe id="+e+" name="+e+" style='display:none;'></iframe>");var f=a("#"+e);b.attr("target",e);f.one("load",function(){var b;try{var e=a(this).contents().find("body").html();b=a.parseJSON(e)}catch(f){d(e);return}b.status=="ok"?c(b):d(b)})}}})(jQuery);(function(a){a.product={options:{duration:200,container_selector:"#shop-productprofile",message_selector:"#product-save-message",form_selector:"#s-product-save",update_delay:100},message:{submit:'<i class="icon16 loading"></i>',success:'<i class="icon16 yes"></i>',error:'<i class="icon16 no"></i>'},path:{id:null,mode:null,tab:null,tail:null,raw:null,params:{}},ajax:{random:null,target:null,link:null,save:!1,cached:{}},data:{main:{}},getData:function(a,c){return(this.data[a]||{})[c]},setData:function(a,
...
"new"==a.product.path.id?a.product.disableSkus(!1,!1):(b=c.find("tbody"),a.product.disableSkus(!0,!0),b.find(">tr:not(.s-sku-virtual)").length||(a.product.editTabMainSkuAdd(),b.find(">tr:not(.s-sku-virtual):first").find('input[name="product[sku_id]"]').attr("checked",!0))),c.closest(".field").find(".name").show()},featureSelectableInit:function(){var b=a(this.options.form_selector),c=a("#s-product-feature-superposition"),d=b.find(".s-product-skus"),b=b.find(':input[name="product[base_price_selectable]"]'),
e=this;c.on("click","ul.features>li",function(){var b=a(this);b.parent().find("li.selected").removeClass("selected");b.addClass("selected");b=b.attr("data-feature-id");b=c.find(".feature-values[data-feature-id="+b+"]");c.find(".feature-values").hide();b.show();return!1});c.on("change","ul.values>li input",function(){var b=a(this).parents("li:first").parent().find(">li input:checked").length,d=c.find("ul.features li.selected");d.find(".count").text(b||"");d.find("i").removeClass("status-blue-tiny status-gray-tiny").addClass(b?
"status-blue-tiny":"status-gray-tiny");e.featureSelectableCount(c)});a.shop.changeListener(b,function(){d.find(".s-sku-virtual .s-price input").val(a(this).val())});a.shop.changeListener(d,function(){var b=a(this);if("product[sku_id]"!=b.attr("name")&&(b=b.parents("tr:first"),b.length)){var c=parseInt(b.attr("data-id"),10);if(c){if(b.hasClass("js-sku-settings")&&(b=d.find("tr[data-id="+c+"]:first"),!b.length))return;b.find("input.s-input-virtual").val(0);b.removeClass("s-sku-virtual");a("#s-product-view").find("tr[data-id="+
c+"]").removeClass("s-sku-virtual")}}},"input, textarea");c.find("i.status-blue-tiny:first").parents("li").trigger("click");return c},featureSelectableCount:function(b){b||(b=a("#s-product-feature-superposition"));var c=[],d=a("#s-product-edit-forms .s-product-form.features");b.find("ul.features>li").each(function(){var e=a(this),f=parseInt(e.find(".count").text(),10);f&&c.push(f);if(d.length){var g=d.find('div[data-code="'+e.data("feature-code")+'"] div.value');if(f){var e=e.data("feature-id"),h=
b.find('div.feature-values[data-feature-id="'+e+'"] ul.values input:checked');g.each(function(){var b=a(this),c=h.filter('[value="'+b.data("value-id")+'"]').length;b.find("input:checkbox").attr("checked",c?"checked":null).attr("disabled","disabled");c?b.show():b.hide()})}else g.show(),g.find("input:checkbox").each(function(a,b){b.checked=b.defaultChecked;b.disabled=null})}});var e=b.find(".superposition-count");if(c.length){e.find(".options").text(c.join(" x ")+" "+$_("options"));for(var f=1,g=0,
h=c.length;g<h;g+=1)f*=c[g];e.find(".skus").html('<span class="highlighted">'+$_("%d SKUs in total").replace("%d",f)+"</span>")}else e.find(".options").text(""),e.find(".skus").html("")},editInit:function(){a("#s-product-edit-forms").unbind("keydown.product").bind("keydown.product",function(b){if(a(b.target).is(":input")&&(b.ctrlKey||b.metaKey)&&83==b.keyCode)return a("#s-product-save-button").click(),!1});a.shop.makeFlexibleInput("s-product-meta-title");if(!this.options.edit_rights)return window.location.hash=
"#/product/"+this.path.id+"/",!1;var b=a(this.options.form_selector);b.bind("submit.product",function(){return a.product.saveData("profile",null)});b.on("change.product, keyup.product","div.s-product-form:not(.ajax) :input",function(){a.product.helper.onChange(a(this).parents("div.s-product-form"))});b.on("change.product, keyup.product, keypress.product",':input[name="product[name]"]',function(){a.product.helper.onNameChange(a(this),!1,a.product.options.update_delay||500)});a.shop.changeListener(b,
...
document.body&&(a("body > #s-product-type").remove(),a(document.body).append(a(this)))});var c=a("#s-product-edit-forms .s-product-form.main"),d=this,e=c.find("table.s-product-skus:last > tbody");e.sortable({distance:5,helper:"original",items:"> tr",handle:"i.sort",opacity:0.75,tolerance:"pointer",update:function(b,c){var f=parseInt(a(c.item).data("id"),10),k=a(c.item).prev().data("id"),k=void 0===k?0:parseInt(k,10);d.editTabMainSkuSort(f,k,a(this));k=e.find('> tr.js-sku-settings[data-id="'+f+'"]');
k.length&&(k=k.detach(),a.shop.trace("detach",k),k&&(a.shop.trace("detach",e.find('> tr[data-id="'+f+'"]').length),e.find('> tr[data-id="'+f+'"]:first').after(k)))},start:function(){e.find("> tr.js-sku-settings").hide()},stop:function(){e.find("> tr.js-sku-settings").show()}});var f=a("#s-product-frontend-url");f.inlineEditable({editLink:"#s-product-frontend-url-edit-link",editOnItself:!1,minSize:{height:15,width:100},makeReadableBy:[],beforeMakeEditable:function(b){var c=a(this).closest("span.s-product-frontend-url-not-empty"),
d=c.find("span.slash"),e=c.find("i.new-window");a(b).after(d);e.hide();c.find("a.s-frontend-base-url").hide();c.find("span.s-frontend-base-url").show()},beforeBackReadable:function(){var b=a(this).closest("span.s-product-frontend-url-not-empty"),c=b.find("span.slash");b.find("i.new-window").show();b.find("span.s-frontend-base-url").hide();b.find("a.s-frontend-base-url").show().append(c)}});parseInt(b.id,10)||f.trigger("editable");"new"==b.id&&a.product_list&&a.isArray(a.product_list.collection_hash)&&
("category"==a.product_list.collection_hash[0]?c.find("select.s-product-categories").val(a.product_list.collection_hash[1]):"set"==a.product_list.collection_hash[0]&&c.find(".add-set-button").click().closest(".field").find("select:first").val(a.product_list.collection_hash[1]));c.off("change.product","select.s-product-categories").on("change.product","select.s-product-categories",function(){var b=a(this),c=b.val(),d=b.parent(),e=d.find(".s-product-delete-from-category"),f=parseInt(c,10)||0;f?e.show():
e.hide();"create"==c?(d.find(".s-new-category").show(),d.find("input.val").attr("disabled",!1),b.hide().attr("disabled",!0).addClass("js-ignore-change")):d.find("input.val").val(f)});c.off("keydown.product","input.new-category").on("keydown.product","input.new-category",function(b){if(13==b.keyCode)return a(this).parent().find("input[type=button]").click(),!1});c.off("click.product",".s-new-category input[type=button]").on("click.product",".s-new-category input[type=button]",function(){var b=a(this).parent(),
c=b.parent(),d=b.find("input[name=new_category]"),e=d.val();a.shop.jsonPost("?module=products&action=saveListSettings&category_id=0&parent_id=0",{name:e},function(e){var f=c.find("select"),k=f.find("option.separator:first").show();a.when(k.after('<option class="category" value="'+e.data.id+'">'+e.data.name+"</option>")).then(function(){f.find("option:first").text($_("Please select a category"));f.val(e.data.id).attr("disabled",!1).show().removeClass("js-ignore-change");b.find("input.val").val(e.data.id).attr("disabled",
!0);b.hide();c.find(".s-product-delete-from-category").show();d.val("");a.product.helper.onTabChanged("main",!0);a("#s-product-save-button").removeClass("green").addClass("yellow");a("#s-category-list>ul").trigger("add",[e.data,"category"])})})});c.off("click.product",".s-product-delete-from-category").on("click.product",".s-product-delete-from-category",function(){var b=a(this),c=b.parent("div"),d=c.find("select");if(d.length)if(2<a("#s-product-edit-forms .s-product-form.main select.s-product-categories").length){d.attr("disabled",
...
d=b.parents(".value:first").find(":input:first"),0<parseInt(d.val())&&(f=e.val().split(","),f.push(d.val()),f.sort(),e.val(f.join(",")),a.product.helper.onChange(a.product.get("form").find("div.main:first"))),b.parents(".value:first").remove();return!1})},editTabMainAction:function(b){var c=!1,d=null;b&&b.params&&b.params.focus?(d=b.params.name||"",!d.length&&b.params.sku&&(d="product[skus]["+parseInt(b.params.sku,10)+"]",b.params.focus&&(d+="["+b.params.focus+"]"),"stock"==b.params.focus&&(d+="["+
(parseInt(b.params.stock,10)||0)+"]")),c=':input[name$="'+d.replace(/(\[|\]|\|\-)/g,"\\$1")+'"]:first'):b&&"new"==b.id&&(c=':input[name$="[name]"]:first');c&&(a.shop.trace("$.product.editTabMainFocus",[d,a(c).length]),setTimeout(function(){a(c).focus();window.location.hash="#/product/"+b.raw.replace(/\/focus=.*$/,"/")},100))},editTabMainBlur:function(){},editTabMainSave:function(){if(!1===this.call("editTabMainSkuEproductSave"))return!1},helper:{options:{tab_changed:'<i class="icon10 status-yellow-tiny"></i>',
defaultChangedStatus:!1},data:{url_helper:{url:"",name:"",timer:null}},init:function(){this.data.url_helper={url:"",name:"",timer:null}},onTabChanged:function(b,c){a.shop.trace("$.product.onTabChanged id="+b+" changed="+c);a("#s-product-edit-menu li."+b+" .s-product-edit-tab-status").html(c?this.options.tab_changed:"")},type:function(b){return parseInt(b,10)||parseInt(a('#s-product-edit-forms .s-product-form.main :input[name="product\\[type_id\\]"]').val(),10)||0},onNameChange:function(b,c,d){this.data.url_helper.timer&&
clearTimeout(this.data.url_helper.timer);var e=a(a.product.options.form_selector).find(':input[name="product\\[url\\]"]'),f=e.parent();if(a.product.path.id&&"new"!=a.product.path.id||e.val()!=this.data.url_helper.url)a.shop.trace("$.product.onNameChange stop "+this.data.url_helper.url+" != "+e.val()),a(a.product.options.form_selector).off(".product",':input[name="product\\[name\\]"]'),f.find(".js-url-helper").hide();else{c&&(f.find(".js-url-helper").length?f.find(".js-url-helper").show():f.append('<i class="icon16 loading js-url-helper"></i>'));
var g=this;this.data.url_helper.timer=setTimeout(function(){g.urlHelper(b,e,d)},d||500)}},onChange:function(b){var c=this.getContainerId(b),d=this;this.checkChanges(b.parents("form"),!1,function(e){a("#s-product-edit-save-panel :submit").removeClass(e?"green":"yellow").addClass(e?"yellow":"green");if(e)d.checkChanges(b,false,function(a){d.onTabChanged(c,a)});else d.onTabChanged(c,e)})},urlHelper:function(b,c){this.data.url_helper.timer&&clearTimeout(this.data.url_helper.timer);var d={name:a(b).val()};
a.shop.trace("$.product.urlHelper ",d);if(d.url!=this.data.url_helper.name){var e=this;this.data.url_helper.url=d.url;a.getJSON("?module=product&action=suggestUrl",d,function(b){"ok"===b.status&&(e.data.url_helper.url=b.data.url,c.val(b.data.url),c.parent().find(".js-url-helper").hide(),a.product.informAboutUrlInUse(b.data.in_use))})}else c.parent().find(".js-url-helper").hide()},getValueByName:function(b,c){for(var d=b,e=c.replace(/\]/,"").split("[");e.shift();)if(void 0!==d[c])d=d[c];else{d="";
break}a.shop.trace("$.product.helper.getValueByName",[d,c,b]);return d},checkChangesStack:{},checkChanges:function(b,c,d){var e=b.attr("id");this.checkChangesStack[e]&&(clearTimeout(this.checkChangesStack[e]),this.checkChangesStack[e]=null);a.shop.trace("$.product.helper.checkChanges",[b,c]);var f=this;this.checkChangesStack[e]=setTimeout(function(){var a=f.checkChangesDelayed(b,c);d&&d(a)},c?50:500)},checkChangesDelayed:function(b,c){var d=this.options.defaultChangedStatus,e=this,f=":input:not(.js-ignore-change)";
if(b.hasClass("s-product-form")){if(b.hasClass("ajax"))return!1}else f=".s-product-form:not(.ajax) "+f;b.find(f).each(function(){var b=(a(this).attr("type")||this.tagName).toLowerCase();switch(b){case "input":case "text":case "textarea":if(a(this).hasClass("ace_text-input"))break;this.defaultValue!=this.value&&(d=!0,c&&(this.defaultValue=this.value,e.updateInput(this.name,this.value,"textarea"==b)));break;case "radio":case "checkbox":this.defaultChecked!=this.checked&&(d=!0,c&&(this.defaultChecked=
this.checked));break;case "select":this.length&&a(this).find("option").each(function(){this.defaultSelected!=this.selected&&(d=!0,c&&(this.defaultSelected=this.selected));return c||!d});break;case "file":this.value&&(d=!0,c&&(this.value=null));break;case "reset":case "button":case "submit":break;case "hidden":break;default:a.shop.error("$.product.checkChangesDelayed unsupported type "+b,[b,this])}!c&&d&&a.shop.trace("$.product.helper.checkChangesDelayed",[this,d,this.defaultValue,this.value]);return c||
!d});return d},getContainerId:function(b){var b=(a(b).attr("class")||"").split(" "),c=!1,d;for(d in b)if("s-product-form"!=b[d]){c=b[d];break}return c},updateInput:function(b,c,d,e){if(b){var f=".s-"+b.replace(/\[(.+?)\]/g,"-$1")+"-input";a.shop.trace("update field: "+b+" "+f,c);var g=a(f);g.is("input,textarea")?g.val(c):d?"product[summary]"===b?g.text(c):g.html(c):g.text(c);e&&(b=a(f).attr("name"),b=b.replaceAll(/\[-[\d]+\]/,"["+e+"]"),a.shop.trace("$.product.helper.updateInput name",[b]))}},count:function(a){var c=
0,d;for(d in a)a.hasOwnProperty(d)&&c++;return c}},multiSkus:function(b){var c=a("#s-product-edit-forms .s-product-form.main table.s-product-skus:first");1<b?(c.find("thead tr").show(),c.find(".s-name,.s-sku-sort").show("slow"),c.find(".delete").parent("a").show(),2==b?c.find("> tbody:first > tr:first .s-name :input").focus():c.find("> tbody:first > tr:last .s-name :input").focus()):(c.find("thead tr").hide(),c.find(".s-name,.s-sku-sort").hide(),c.find(".delete").parent("a").hide())},editTabMainSkuAdd:function(){try{var b=
a("#s-product-edit-forms .s-product-form.main table.s-product-skus:first").find("tbody:first"),c=0,d="0";b.find(':input[name$="[price]"]').each(function(){var b=a(this),e=b.val()?b.val().replace(",","."):0,e=parseFloat(e);e>c&&(c=e,d=b.val()||"0")});var e=0;b.find(':input[name$="[purchase_price]"]').each(function(){e=Math.max(e,parseFloat(a(this).val())||0)});a.product.multiSkus(b.find("tr:not(.js-sku-settings)").length+1);var f={id:--a.product.editTabMainData.sku_id,product_id:a('input:hidden[name="product[id]"]').val()||
"new",sku:"",available:1,name:"",price:""+c,price_loc:d,purchase_price:""+e,stock_icon:{"0":"<i class='icon10 status-green' ></i>"},stock:{},count:null};a.shop.trace("$.product.editTabMainSkuAdd",[a.product.editTabMainData.sku_id,f]);b.append(tmpl("template-sku-edit",{sku_id:a.product.editTabMainData.sku_id,sku:f,stocks:this.getData("main","stocks"),stock_ids:this.getData("main","stock_ids")},!0));b.find(".s-product-currency").trigger("change")}catch(g){a.shop.error(g.message,g)}return!1},editTabMainSkuSort:function(b,
c,d){try{a.post("?module=product&action=skuSort",{product_id:this.path.id,sku_id:b,after_id:c},function(b){a.shop.trace("$.product.editTabMainSkuSort result",b);b.error&&(a.shop.error("Error occurred while sorting product SKUs","error"),d.sortable("cancel"))},function(b){a.shop.trace("$.product.editTabMainSkuSort cancel",{data:b});d.sortable("cancel");a.shop.error("Error occurred while sorting product SKUs","error")})}catch(e){a.shop.error(e.message,e)}return!1},editTabMainProductDelete:function(){var b=
a("#s-product-list-delete-products-dialog"),c=b.parent();b.length||(c=a("<div></div>").appendTo("body"));c.load("?module=dialog&action=productsDelete&count=1",function(){a("#s-product-list-delete-products-dialog").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(b){a(this).find(".dialog-buttons i.loading").show();a.shop.jsonPost("?module=products&action=deleteList",{product_id:[a.product.path.id],get_lists:1},function(c){a.product_list&&
a("#s-sidebar").trigger("update",c.data.lists);b.trigger("close");window.location.hash="#/products/"});return!1}})});return!1},editTabMainSkuDelete:function(b,c){var d=a("#s-product-edit-forms .s-product-form.main table.s-product-skus:first").find("tbody:first"),e=c.parents("tbody").find('> tr[data-id="'+b+'"]'),f=this;0<b?1<c.parents("tbody").find('tr[data-id]:not(.js-sku-settings):not([data-id^="-"])').length?a.ajax({url:"?module=product&action=skuDelete",data:{sku_id:b,product_id:this.path.id},
dataType:"json",type:"post",success:function(c){"fail"==c.status?f.refresh("error",c.errors):c.data.redirect?window.location.href=c.data.redirect:(f.refresh("success",c.data.message||"Success"),e.hide("normal",function(){e.remove();a('#s-product-view table.s-product-skus > tbody > tr[data-id="'+b+'"]').remove();a.product.multiSkus(d.find("tr:not(.js-sku-settings)").length)}),a("#s-product-edit-forms .s-product-form.main").find("input[name=product\\[sku_id\\]][value="+c.data.sku_id+"]").attr("checked",
!0))},error:function(a,b){f.refresh("error",b)}}):f.refresh("error",$_("A product must have at least one SKU.")):e.hide("normal",function(){e.remove();a('#s-product-view table.s-product-skus > tbody >tr[data-id="'+b+'"]').remove();a.product.multiSkus(d.find("tr:not(.js-sku-settings)").length)})},editTabMainCategoriesAdd:function(){var b=a("#s-product-edit-forms .s-product-form.main select.s-product-categories:last").parent("div"),c=b.clone(!1);c.find("select").val("select").attr("disabled",!1).show();
c.find("input.val").val(0).attr("disabled",!0).parent().hide();c.find(".s-product-delete-from-category").hide();c.find(".s-storefront-map").html("");c.show();b.after(c)},editTabMainSkuStock:function(b){var c=a("#s-product-sku-"+b);c.hide().find(":input:enabled").attr("disabled",!0);b=a("#s-product-sku-stock-"+b);b.show().find(":input:disabled").removeAttr("disabled");b.find(":input:first").val(c.find(":input:first").val())},editTabMainSkuSettings:function(b,c){c.hide();var d=c.parents("tr"),e=d.data(),
f=this;a.when(d.after(tmpl("template-sku-settings",{sku_id:b,sku:e}))).done(function(){var c;c="?module=product&action=skuSettings&product_id="+f.path.id;c+="&sku_id="+b;var e=a('#s-product-edit-forms .s-product-form.main tr.js-sku-settings[data-id="'+b+'"] > td:first');e.load(c,function(){d.find(':input[name$="[available]"]').remove();a.product_images&&a.product_images.options&&a.product_images.options.enable_2x&&a.fn.retina&&e.find(".s-product-image-crops img").retina();if(0<b){a.shop.trace("fileupload",
[e.find(".fileupload").length,typeof e.find(".fileupload").fileupload]);try{var c=document.cookie.match(/(?:^|; )_csrf=([^;]*)/),f=c?decodeURIComponent(c[1]):"";e.find(".fileupload:first").fileupload({dropZone:null,url:"?module=product&action=skuEproductUpload",acceptFileTypes:/(\.|\/)(gif|jpe?g|png)$/i,start:function(){e.find(".fileupload:first").hide()},progress:function(b,c){a.shop.trace("fileupload progress",c);var d=e.find(".js-progressbar-container");d.show();d.find(".progressbar-inner:first").css("width",
...
g.find("input[type=checkbox]").attr("checked",!0);g.show();d.find("input.s-input-virtual").val(0)}},fail:function(b,c){a.shop.trace("fileupload fail",[c.textStatus,c.errorThrown]);e.find(".error-message").text("error").show().text(c.errorThrown||"error");e.find(".js-progressbar-container").hide();e.find(".fileupload:first").addClass("error").show()},formData:{product_id:a.product.path.id,sku_id:b,_csrf:f}})}catch(g){a.shop.error("Exception "+g.message,g)}}})})},editTabMainSkuImageSelect:function(b,
c,d){var b=d.parents("li:first"),e=b.hasClass("selected"),f=d.parents("div.value:first");f.find("ul.s-product-image-crops li.selected").removeClass("selected");e?f.find('input[name$="[image_id]"]').val(0):(b.addClass("selected"),f.find('input[name$="[image_id]"]').val(c));a.shop.trace("$.product.editTabMainSkuImageSelect",[f,f.find(':input[name$="[image_id]"]')]);a.product.helper.onChange(d.parents("div.s-product-form"))},editTabMainSkuEproductSave:function(b){b=a("#s-product-edit-forms .s-product-form.main tr.js-sku-settings"+
(b&&0<b?'[data-id="'+b+'"]':"")+" > td:first .fileupload");a.shop.trace("$.product.editTabMainSkuEproductSave",b.length);b.length&&b.fileupload("start")},editTabMainSkuEproductDelete:function(){},editTabMainLinkEdit:function(){return!1},editTabMainTypeSelect:function(a){var c=a.parents("form").find(':input[name="product[type_id]"]').parents(".value");"main"==this.path.tab?a.hide():(c.find(".js-action").hide(),window.location.hash="/product/"+this.path.id+"/"+this.path.mode+"/");c.find(".js-type-name").hide();
c.find(":input").show().focus();setTimeout(function(){c.find(":input").focus()},100)},editTabMainTypeChange:function(b){var c=b.parents(".value"),d=b.find(":selected:first"),e=d.val(),b=parseInt(d.data("sku-type"));c.find(".js-type-icon").html(d.data("icon"));c.find(".js-type-name").html(d.text());e!=c.data("type")?a("#s-product-edit-forms .s-product-form.features").length&&"undefined"!=typeof this.editTabFeaturesReload?this.editTabFeaturesReload(e):(c=a("#s-product-edit-menu > li.features > a"),
c.attr("href",c.attr("href").replace(/\/features\/.*$/,"/features/"+e+"/"))):(c=a("#s-product-edit-menu > li.features > a"),c.attr("href",c.attr("href").replace(/\/features\/.*$/,"/features/")));c=a(this.options.form_selector+' :input[name="product[sku_type]"]');a.shop.trace("sku_type",[b,c]);c.filter('[value="1"]').trigger("disabled",[b?null:!0]);e=c.parents("ul");b?(c.filter(":checked").change(),e.find('[data-sku-type="1"]').hide()):(c.filter('[value="0"]').trigger("checked",!0).change(),e.find('[data-sku-type="1"]').show())},
editTabMainUpdate:function(b,c,d){var e=a("#s-product-edit-forms .s-product-form.main table.s-product-skus tbody"),f=a("#s-product-view table.s-product-skus tbody");e.find('tr[data-id^="-"]').remove();f.find('tr[data-id^="-"]').remove();e.parents("table").find("tr:hidden").show();var g=[],h;for(h in b.skus||{})g.push(a.extend({id:h},b.skus[h]));g=g.sort(function(a,b){return a.sort-b.sort});h=this.getData("main","stocks");var j=this.getData("main","stock_ids"),k="";tmpl.cache["template-sku-edit"]=
tmpl(tmpl.load("template-sku-edit"));for(var m=0,l=g.length;m<l;m+=1)k+=tmpl("template-sku-edit",{sku_id:g[m].id,sku:g[m],hide_sort_column:1>=l,stocks:h,stock_ids:j,checked:g[m].id==b.sku_id});e.html(k);e.find("select.s-product-currency").val(b.currency);e.parent().show();e.closest(".s-sku-list").show();this.multiSkus(e.find("tr:not(.js-sku-settings)").length);k="";m=0;for(l=g.length;m<l;m+=1)k+=tmpl("template-sku",{sku_id:g[m].id,sku:g[m],stocks:h,stock_ids:j,runout:b.runout||{}});f.html(k);(!d||
"new"==d)&&e.parents("div.field-group:first").after(a("#s-sku-type-field-group"));c&&(d=a("#s-product-feature-superposition .superposition-count"),d.find(".options").text(c.options),d.find(".skus").html('<span class="highlighted">'+c.skus+"</span>"));var i=/#\/product\/new\//,p="#/product/"+b.id+"/";a("#s-product-edit-forms .s-product-form.main table.s-product-skus tbody, #s-product-view table.s-product-skus tbody").find('[href*="#/product/new/"]').each(function(){a(this).attr("href",a(this).attr("href").replace(i,
p))})},editTabDescriptionsBlur:function(){var b=a("#s-product-description-content");b.length&&b.data("redactor")&&b.waEditor("sync")},editTabDescriptionsAction:function(){var b=a("#s-product-description-content");if(b.length&&!b.data("redactor")){var c=b.parents("div.s-product-form");b.waEditor({lang:wa_lang,toolbarFixedTopOffset:a("#mainmenu").length?a("#mainmenu").height():0,uploadFields:b.data("uploadFields"),changeCallback:function(){b.length&&(b.waEditor("sync"),a.product.helper.onChange(c))},
keydownCallback:function(b){if(("115"==b.which||"83"==b.which)&&(b.ctrlKey||b.metaKey))return b.preventDefault(),a("#s-product-save-button").click(),!1;a.product.helper.onChange(c)}})}},profileInit:function(){void 0!==a.product_list&&void 0!==a.product_list.fixed_blocks&&(a.product_list.fixed_blocks.set&&a.product_list.fixed_blocks.set.unsetFixed(),a.product_list.fixed_blocks.category&&a.product_list.fixed_blocks.category.unsetFixed());if(this.options.edit_rights){var b=a("#shop-productprofile").find(".s-product-name");
parseInt(this.path.id,10)?b.addClass("editable"):b.removeClass("editable");var c=this.get("form");b.inlineEditable({minSize:{width:150},maxSize:{width:550},inputClass:"s-title-h1-edit",beforeMakeEditable:function(){a("#s-edit-product").hide()},afterBackReadable:function(b,e){a("#s-edit-product").show();if(!e.changed)return false;a.shop.jsonPost("?module=product&action=save&id="+a.product.path.id,{update:{name:a(b).val()}},function(e){var g=a(b).val();document.title=g+a.product.options.title_suffix;
e.status==="ok"&&e.data&&a("#s-product-meta-title").attr("placeholder",e.data.default_meta_title);c.find('input[name="product[name]"]').val(g)})},hold:function(){return!a(this).hasClass("editable")}})}this.call("profileLazyInit",[])},profileLazyInit:function(){var b=a("#product-sales-plot");if(window.sales_data&&sales_data.length){if(!b.data("graph_rendered")){var c=function(){b.length&&0<b.width()?(showSalesGraph(sales_data,"undefined"==typeof cash_type?null:cash_type),b.data("graph_rendered",1)):
setTimeout(c,1E3)};c()}}else b.remove();if(sku_plot_data&&sku_plot_data.length&&sku_plot_data[0]&&sku_plot_data[0].length){if(!a("#product-sku-plot").data("graph_rendered")){var d=[];a.each(sku_plot_data[0],function(a,b){d.push({label:b[0],value:b[1]})});showPieGraph(d,{color_type:"products"});a("#product-sku-plot").data("graph_rendered",1)}}else a("#product-sku-plot").remove()},updateMetaFields:function(){var b=a(".s-product-name-input").val();a("#s-product-meta-title").attr("placeholder",b);var c=
[b],d=5;a(".s-sku-name-input").each(function(){if(0>=d)return!1;var b=a.trim(a(this).val());b&&c.push(b);d-=1});b=this.getData("main","category_name");null!==b&&c.push(b);for(var b=a("#product-tags").val().split(","),d=5,e=0;e<b.length&&!(0>=d);e+=1){var f=a.trim(b[e]);f&&c.push(f);d-=1}a("#s-product-meta-keywords").attr("placeholder",c.join(", "));a("#s-product-meta-description").attr("placeholder",a("#s-product-summary").val())},getId:function(){return this.path.id}}})(jQuery);(function(a){a.fn.rateWidget=function(b,c,d){function e(b){var c=0;this.find("i").removeClass("star star-hover").addClass("star-empty").each(function(){if(c==b)return!1;c++;a(this).removeClass("star-empty").addClass("star")});this.attr("data-rate",b)}function f(a){return function(){return a}}var g,h=this;if(this&&this.length){if("string"==typeof b){if("getOption"==b&&"rate"==c)return parseInt(this.attr("data-rate"),10);if("setOption"==b&&("rate"==c&&(e.call(this,parseInt(d,10)),c={rate:d}),"object"===
...
a.product.editTabImagesAction=function(b){if(null!==a.product_images.tail){var c="?module=product&action=images&id="+b.id;if(b.tail&&(c+="&param[]="+b.tail,a.product_images.photo_stream&&a.product_images.photo_stream.length))var d=a.product_images.photo_stream.find(".s-stream-wrapper>ul"),c=c+("&ps[left]="+parseInt(d.css("left"),10)),c=c+("&ps[width]="+parseInt(d.css("width"),10));a.get(c,function(b){a("#s-product-edit-forms .s-product-form.images").html(b)})}a.product_images.tail=b.tail};a.product.editTabImagesBlur=
function(){a("#fileupload").fileupload("destroy")};var d=a("#s-product-set-custom-badge");a(".s-product-images-actions").off("click","li").on("click","li",function(){var b=a(this),c=b.attr("data-action");switch(c){case "set-badge":a.product_images.setBadge(b.attr("data-type"));break;case "set-custom-badge":d.data("type",b.attr("data-type"));d.show();break;case "delete-badge":a.product_images.deleteBadge()}"set-custom-badge"!=c&&d.hide();return!1});d.find("input[type=button]").unbind("click").bind("click",
function(){var b=a(this).parent();d.show();a.product_images.setBadge(d.data("type"),b.find("textarea[name=code]").val());return!1})},initImageList:function(b){this.image_list=a(b.image_list||"#s-product-image-list");this.image_list.html(tmpl("template-product-image-list",{images:b.images,placeholder:b.placeholder,type:b.type,product_id:this.product_id}));this.initListSortable();(!b.type||"thumbs"==b.type)&&this.initListEditable();b.enable_2x&&a.fn.retina&&this.image_list.find("img").retina()},initImage:function(){a("#s-product-one-image").parent().width();
this.photo_stream=a("#s-product-image-toolbar ul.s-photostream:first");var b=this.setImageDimensions();a(window).unbind("resize.product_images").bind("resize.product_images",function(){if(a("#s-product-image").length)if(a.product_images.image){var b=a.product_images.setImageDimensions();a.product_images.loupe.resize(b)}else a(this).unbind("resize.product_images");else a(this).unbind("resize.product_images")});a("#s-product-image-description").inlineEditable({inputType:"textarea",makeReadableBy:["esc"],
updateBy:["ctrl+enter"],placeholderClass:"gray",placeholder:a.product_images.options.placeholder,minSize:{height:50,widht:600},size:{width:b.width},editLink:"#s-product-image-description-edit-link",allowEmpty:!0,beforeMakeEditable:function(b){var c=a(this),d=this.id+"-button",e=a("#"+d);e.length||(b.after('<br><input type="button" id="'+d+'" value="'+$_("Save")+'"> <em class="hint" id="'+this.id+'-hint">Ctrl+Enter</em>'),a("#"+d).click(function(){c.trigger("readable")}));a("#"+this.id+"-hint").show();
e.show().prev("br").hide()},afterBackReadable:function(b,c){var d=a(b).val(),e="#"+this.id+"-";a(e+"button").hide().prev("br").hide();a(e+"hint").hide();c.changed&&a.products.jsonPost("?module=product&action=imageSave",{id:a.product_images.image.id,data:{description:d}})}});var c=this.photo_stream,d=c.find("li.selected");c.photoStreamSlider({backwardLink:"#s-product-image-toolbar .rewind",forwardLink:"#s-product-image-toolbar .ff",photoStream:"ul",duration:400});c.off("click","li.visible a").on("click",
"li.visible a",function(){var b=a(this).attr("href"),e=a(this).parent();d.removeClass("selected");d=e.addClass("selected");c.trigger("home",[function(){location.href=b}]);return!1});this.photo_stream=c;this.product_image=a("#s-product-image");var e=a("#s-product-set-custom-badge");a(".s-product-image-actions").off("click","li").on("click","li",function(){var b=a(this),c=b.attr("data-action");switch(c){case "delete":a.product_images.deleteImage();break;case "rotate-right":a.product_images.rotateImage("right");
break;case "rotate-left":a.product_images.rotateImage("left");break;case "set-badge":a.product_images.setBadge(b.attr("data-type"));break;case "set-custom-badge":e.data("type",b.attr("data-type"));e.show();break;case "delete-badge":a.product_images.deleteBadge()}"set-custom-badge"!=c&&e.hide();return!1});e.find("input[type=button]").unbind("click").bind("click",function(){var b=a(this).parent();e.show();a.product_images.setBadge(e.data("type"),b.find("textarea[name=code]").val());return!1});b=this.image;
a("#s-product-image-loupe").length&&a.product_images.loupe.init({original:{width:b.width,height:b.height,src:"?module=product&action=ImageDownload&id="+b.id},image:{width:this.product_image.width(),height:this.product_image.height(),src:b.url_big,dom:this.product_image},animate:!(!b.dimensions.width||!b.dimensions.height)});var f=this;a("#s-restore-image-original").unbind("click").bind("click",function(){confirm($_("This will reset all changes you applied to the image after upload, and will restore the image to its original. Are you sure?"))&&
(f.coverToggle(),a.products.jsonPost("?module=product&action=imageRestore",{id:f.image.id},function(b){a("#s-product-view").find("li[data-image-id="+f.image.id+"] img").attr("src",b.data.url_crop);a("<img>").attr("src",b.data.url_big).load(function(){a(this).remove();a.products.dispatch("#/product/"+f.product_id+"/edit/images/"+f.image.id+"/");f.coverToggle()})},"json"))});this.options.enable_2x&&a.fn.retina&&a("#s-product-image").retina();var g=!1;a(document).unbind("keydown.product_images").bind("keydown.product_images",
function(b){var d=a(b.target).prop("nodeName").toLowerCase(),b=b.keyCode;if(!g&&!("text"==d||"textarea"==d||37!=b&&39!=b)){if(39==b)return d=c.find("li.selected").next(),d.length&&!d.hasClass("dummy")&&(g=!0,location.href=d.find("a").attr("href")),!1;if(37==b)return d=c.find("li.selected").prev(),d.length&&!d.hasClass("dummy")&&(g=!0,location.href=d.find("a").attr("href")),!1}})},setImageDimensions:function(){var b=a("#s-product-image"),c=a("#s-product-one-image").parent().width(),d=this.image.dimensions;
d.width=parseInt(d.width,10);d.height=parseInt(d.height,10);var e={width:"",height:""};!isNaN(d.width)&&d.width<c?(e.width=d.width,isNaN(d.height)||(e.height=d.height)):e.width=c;b.css(e);return e},deleteImage:function(){var b=this,c=a("#s-product-image-delete-dialog");c.waDialog({onSubmit:function(){c.trigger("close");b.coverToggle();var d=c.find("form");a.shop.jsonPost(d.attr("action"),d.serialize(),function(c){var d="#/product/"+b.product_id+"/edit/images/",g=b.photo_stream.find("li.selected"),
h=g.next("li:not(.dummy)");h.length?d=h.find("a").attr("href"):(h=g.prev("li:not(.dummy)"),h.length&&(d=h.find("a").attr("href")));a(".s-product-image-crops").find("li[data-image-id="+c.data.id+"]").remove();b.coverToggle();location.href=d});return!1}})},rotateImage:function(b){var c=this;c.coverToggle();a.products.jsonPost("?module=product&action=imageRotate&id="+c.image.id,{direction:b},function(b){a("#s-product-view").find("li[data-image-id="+c.image.id+"] img").attr("src",b.data.url_crop);a("<img>").attr("src",
b.data.url_big).load(function(){a(this).remove();a.products.dispatch("#/product/"+c.product_id+"/edit/images/"+c.image.id+"/");c.coverToggle()})})},setBadge:function(b,c,d){var c=c||b,e=a("#photo-organize-menu"),f=e.find("li[data-type="+b+"]");f.find("a").append('<span class="count"><i class="icon16 loading"></i></span>');a.shop.jsonPost("?module=product&action=badgeSet&id="+this.product_id,{code:c},function(c){var h=a("#s-product-one-image");h.find(".top.right").html(c.data);e.find("li.selected").removeClass("selected").find(".small").text("");
f.addClass("selected");f.find("span.count").remove();h.length||(f.find("a").append('<span class="count"><i class="icon10 yes"></i></span>'),setTimeout(function(){f.find("span.count").remove()},1E3));"custom"!=b?(a("#s-product-set-custom-badge").hide(),f.find(".small").text(c.data)):a("#s-product-set-custom-badge").show();"function"===typeof d&&d(c)})},deleteBadge:function(){a.getJSON("?module=product&action=badgeDelete&id="+this.product_id,function(){a("#s-product-one-image").find(".top.right").html("");
a("#photo-organize-menu").find("li.selected").removeClass("selected").find(".small").text("")})},initListSortable:function(){this.image_list.sortable({distance:5,helper:"clone",items:"li",opacity:0.75,tolerance:"pointer",start:function(){document.ondragstart=function(){return!1}},update:function(b,c){document.ondragstart=null;var d=a(this),e=a(c.item),f=parseInt(e.attr("data-image-id"),10),e=e.next(),g=null;e.length&&(g=parseInt(e.attr("data-image-id"),10));a.products.jsonPost("?module=product&action=imageMove",
{id:f,before_id:g},function(){if("function"===typeof a.product_images.options.onSort)a.product_images.options.onSort(f,g)},function(){d.sortable("cancel")})}})},coverToggle:function(){var b=a("#s-product-image-cover");if(b.is(":hidden")){var c=b.find(".loading");c.css({position:"absolute",left:parseInt((b.width()-c.width())/2,10)+"px",top:parseInt((b.height()-c.height())/2,10)+"px"});b.show()}else b.hide()},initListEditable:function(){this.image_list.off("click",".editable").on("click",".editable",
...
this.id+'-hint">Ctrl+Enter</em>'),a("#"+d).click(function(){c.trigger("readable")}));a("#"+this.id+"-hint").show();e.show()},afterBackReadable:function(b,c){var d=a(this),d=parseInt(d.parents("li:first").attr("data-image-id"),10),e=a(b).val(),f="#"+this.id+"-";a(f+"button").hide();a(f+"hint").hide();c.changed&&a.products.jsonPost("?module=product&action=imageSave",{id:d,data:{description:e}})}}).trigger("editable")})}}})(jQuery);(function(a){a.product_stocks={options:{},container:null,init:function(b){this.options=b;this.stocks=b.stocks;this.container=a("#s-product-stocks");this.initView();b.stocks&&1<b.stocks.length&&this.initDragndrop();this.options.lazy_loading&&0<this.options.product_stocks.length&&this.initLazyLoad(this.options.lazy_loading)},initLazyLoad:function(b){var c=b.count,d=b.total_count;a(window).lazyLoad("stop");if(c<d){var e=this;a(window).lazyLoad({container:e.container,state:"undefined"===typeof b.auto||
b.auto?"wake":"stop",hash:"stocks",load:function(){a(window).lazyLoad("sleep");a(".lazyloading-link").hide();a(".lazyloading-progress").show();var b=function(b){console&&(b&&b.errors?console.error("Error when loading products: "+b.errors):b&&b.responseText?console.error("Error when loading products: "+b.responseText):console.error(b));a(window).lazyLoad("stop")};a.get("?module=stocksBalance&offset="+c+"&total_count="+d+(e.options.order?"&order="+e.options.order:""),function(g){g&&"ok"==g.status?(c+=
g.data.count,e.append({product_stocks:g.data.product_stocks,stocks:e.stocks})?(a(".lazyloading-progress-string").text(g.data.progress.loaded+" "+g.data.progress.of),a(".lazyloading-progress").hide(),a(".lazyloading-chunk").text(g.data.progress.chunk),c>=d?(a(window).lazyLoad("stop"),a(".lazyloading-link").hide()):(a(".lazyloading-link").show(),a(window).lazyLoad("wake"))):a(window).lazyLoad("stop")):b(g)},"json").error(b)}});a(".lazyloading-link").die("click").live("click",function(){a(window).lazyLoad("force");
...
refreshPositions:!0,start:function(){a(this).parents("tr:first").find("td.s-stock-cell").addClass("drag-active").filter(":first").addClass("first")},stop:function(){a(this).parents("tr:first").find("td.s-stock-cell").removeClass("drag-active").filter(":first").removeClass("first")}});this.container.find("td").liveDroppable({disabled:!1,greedy:!0,tolerance:"pointer",over:function(b,c){a(this).hasClass("drag-active")?c.helper.find(".no-bw").hide():c.helper.find(".no-bw").show()},drop:function(b,c){var d=
a(this);if(!d.hasClass("drag-active"))return!1;var e=c.draggable,f=e.parents("td:first");if(d.get(0)==f.get(0))return!1;var e=e.attr("id").replace("s-item-","").split("-"),f=e[1],d=d.attr("data-stock-id"),g=a("#s-item-"+[e[0],d].join("-"));if(g.length&&g.hasClass("infinity"))return!1;g=a("#s-transfer-product-dialog");g.length&&g.parent().remove();a("<div></div>").appendTo("body").load("?module=transfer",{sku_id:e[0],from:f,to:d})}})},append:function(a){try{this.container.append(tmpl("template-product-stocks",
...
this.toolbar=a("#s-product-list-toolbar");this.sidebar=a("#s-sidebar");var d=this.options.products;delete this.options.products;this.total_count=this.options.total_count||0;this.category_count=parseInt(this.options.category_count,10);isNaN(this.category_count)&&(this.category_count=this.total_count);this.sortable="undefined"===typeof b.sortable?this.sortable:b.sortable;this.sort=b.sort||null;if(b.enable_2x)this.container.on("append_product_list",function(){a.fn.retina&&a.product_list.container.find("img").retina()});
if(d&&b.view){try{this.container.append(tmpl("template-product-list-"+this.options.view,{products:d,sort:this.sort,primary_currency:this.options.primary_currency,stocks:this.options.stocks},"thumbs"!=this.options.view)),this.container.trigger("append_product_list",[d])}catch(e){return console.log("Error: "+e.message),this}delete b.products}this.collection_hash=a.isArray(this.options.collection_hash)&&this.options.collection_hash.length?this.options.collection_hash:[];this.collection_param=this.options.collection_param?
this.options.collection_param:"";b.order&&(this.order=b.order);if(this.options.lazy_loading)this.initLazyLoad(this.options.lazy_loading);else{var f=c.replace(/&page=\d+/,"")+"&page=";a(".pagination a").each(function(){var b=a(this).attr("href").match(/\?page=(\d+)/);a(this).attr("href",f+(b?b[1]:1))})}this.initSelecting();this.initView(this.options.view);this.initDragndrop();this.initSortingNotice();this.rubberTable();"table"==this.options.view&&this.initInlineEditor()}catch(g){a.shop.error("$.product_list.init error: "+
g.message,g)}return this},initSortingNotice:function(){if(!a.storage.get("shop/list-sorting-notice-closed")){var b=a("#custom-backend-order-notice");if(b.length)b.show().on("click",".close",function(){a.storage.set("shop/list-sorting-notice-closed","1");b.remove()})}},initLazyLoad:function(b){var c=b.count,d=this.total_count;a(window).lazyLoad("stop");if(c<d){var e=this,f=e.container.find("tr.header th[data-additional-column]").map(function(){return a(this).data("additional-column")}).get().join(",");
a(window).lazyLoad({container:e.container,state:"undefined"===typeof b.auto||b.auto?"wake":"stop",hash:["","products"],load:function(){a(window).lazyLoad("sleep");a(".lazyloading-link").hide();a(".lazyloading-progress").show();a.get("?module=products&action=loadList&offset="+c+("&total_count="+d)+(e.collection_param?"&"+e.collection_param:"")+(e.sort?"&sort="+e.sort:"")+(e.order?"&order="+e.order:"")+("&enabled_columns="+(f||"")),function(b){if("ok"==b.status&&b.data.count){c+=b.data.count;var f=
e.container;try{e.container.append(tmpl("template-product-list-"+e.options.view,{products:b.data.products,check_all:f.find(".s-select-all:first").length?f.find(".s-select-all:first").attr("checked"):!1,sort:a.product_list.sort,primary_currency:a.product_list.options.primary_currency,stocks:a.product_list.options.stocks})),e.container.trigger("append_product_list",[b.data.products])}catch(j){console.log("Error: "+j.message);a(window).lazyLoad("stop");return}f.find(".last").removeClass("last");f.find(".product:last").addClass("last");
a(".lazyloading-progress-string").text(b.data.progress.loaded+" "+b.data.progress.of);a(".lazyloading-progress").hide();a(".lazyloading-chunk").text(b.data.progress.chunk);c>=d?(a(window).lazyLoad("stop"),a(".lazyloading-link").hide()):(a(".lazyloading-link").show(),a(window).lazyLoad("wake"))}else b.data&&!b.data.count?console&&(console.log("Count of again loaded products is 0"),a(".lazyloading-progress").hide()):(b.errors&&console&&console.log("Error when loading products: "+b.errors),a(window).lazyLoad("stop"))},
"json")}});a(".lazyloading-link").die("click").live("click",function(){a(window).lazyLoad("force");return!1})}},initSelecting:function(){var b=this.container,c=this.toolbar.find(".count"),d=b.find(".s-select-all:first"),e=function(){var a=parseInt(b.find("> .product.selected").length,10);a?c.text(a).show():c.text("").hide()};a(document).keydown(function(a){16==a.keyCode&&(document.body.onselectstart=function(){return!1})}).keyup(function(a){16==a.keyCode&&(document.body.onselectstart=null)});b.off("select",
".product").on("select",".product",function(b,c,h){h=void 0!==h?h:!0;(void 0!==c?c:1)?a(this).addClass("selected").find("input:first").attr("checked",!0):(a(this).removeClass("selected").find("input:first").attr("checked",!1),d.is(":checked")&&d.attr("checked",!1));h&&e();return!1});d.unbind("select").bind("select",function(d,e){var e=void 0!==e?e:!0,h=a(this);e?(h.attr("checked",!0),b.find("> .product").trigger("select",!0,!1),c.text(h.attr("data-count")).show()):(h.attr("checked",!1),b.find("> .product").trigger("select",
!1,!1),c.text("").hide())});b.off("click",".product input").on("click",".product input",function(c,g){var h=c.shiftKey,j=this.checked;g&&(h=g.shiftKey,j=g.checked);var k=a(this).parents(".product:first");j?k.addClass("selected"):(d.is(":checked")&&d.attr("checked",!1),k.removeClass("selected"));if(h&&j){(h=b.data("last_checked"))||(h=b.find("> .product:first").trigger("select",!0));var m=k.prevAll(".selected[data-product-id="+h.attr("data-product-id")+"]"),l;if(m.length){l=k.prev();for(h=h.get(0);l.length&&
h!=l.get(0);)l.addClass("selected").find("input").attr("checked",!0),l=l.prev()}else if(m=k.nextAll(".selected[data-product-id="+h.attr("data-product-id")+"]"),m.length){l=k.next();for(h=h.get(0);l.length&&h!=l.get(0);)l.addClass("selected").find("input").attr("checked",!0),l=l.next()}!b.data("last_checked")&&!m.length&&h.trigger("selected",!1)}j&&b.data("last_checked",k);e()});if(a.browser.mozilla)b.off("click",".product label").on("click",".product label",function(b){if(b.shiftKey){var c=a(b.target);
a(c).is("label")||(c=a(c).parents("label:first"));c=a("#"+c.attr("for"));c.trigger("click",{shiftKey:b.shiftKey,checked:!c.attr("checked")})}})},initView:function(b){try{var c=this.container,d=this.sidebar;c.find(".s-select-all:first").length&&c.find(".s-select-all:first").click(function(){a(this).trigger("select",this.checked)});"table"==b&&(a("#s-content .list-view-mode-table").click(function(){c.toggleClass("single-lined");a.storage.set("shop/product_list/multi-lined",!c.hasClass("single-lined"));
return!1}),a.storage.get("shop/product_list/multi-lined")&&c.removeClass("single-lined"));var e="view="+b;d.find(".s-collection-list li.dr").each(function(){var b=a(this);b.find("a:first").attr("href","#/products/"+b.attr("id").replace("-","_id=")+"&"+e)});a("#s-products-search").autocomplete("disable").val(this.options.text||"").autocomplete("enable");var f="s-all-products";a.product_list.collection_hash.length&&("search"!==a.product_list.collection_hash[0]&&"tag"!==a.product_list.collection_hash[0])&&
(f=a.product_list.collection_hash.join("-"));a.shop.trace("$.product_list.initView",[b,f]);d.find("li.selected").removeClass("selected");var g=d.find("#"+f);0>=g.length&&window.location.hash&&(g=d.find('a[href="'+window.location.hash+'"]').parent());0>=g.length&&(g=d.find("#s-all-products"));g.addClass("selected");a.product_list.collection_hash.length&&("search"!==a.product_list.collection_hash[0]&&"tag"!==a.product_list.collection_hash[0])&&g.find(".count:first").text(this.category_count);a.product_list.fixed_blocks=
...
b.find(".s-product-stock .editable").filter(function(){return!a(this).data("plugin")}).addClass("not-editable")})},initInlineEditor:function(){function b(a,b){if(a.data("denied-reason")==b)a.data("denied-reason",""),alert(b);else{a.data("denied-reason",b);setTimeout(function(){a.data("denied-reason","")},3E3);a.wrapInner('<div class="animation-container" style="position:relative;"></div>');var e=a.find(".animation-container").animate({left:"3px"},100,function(){e.animate({left:"0px"},100,function(){e.animate({left:"3px"},
100,function(){e.animate({left:"0px"},100,function(){e.children().first().unwrap()})})})})}}a.product_list.highlightInlineEditorCells();a.product_list.container.on("append_product_list",function(){a.product_list.highlightInlineEditorCells()});a.product_list.container.on("click",".s-product-price,.s-product-stock",function(){function c(){if(f)d.html(tmpl("template-list-price-editor-one",{product_id:e.data("product-id"),currency:e.data("currency"),value:e.data("original-price")}));else{var b=e.data("stocks");
!b||"object"!=typeof b?d.html(tmpl("template-list-stock-editor-one",{product_id:e.data("product-id"),value:b||""})):d.html(tmpl("template-list-stock-editor-many",{product_id:e.data("product-id"),values:b}))}d.find(".cancel").click(function(){var a=d;a.removeClass("editor-on").html(a.data("read-only-state-html"));a.data("read-only-state-html","");a.data("denied-reason","")});var c=d.find("form").submit(function(){if(c.find(".loading").length)return!1;c.find(":submit").after('<i class="icon16 loading"></i>');
a.post("?module=products&action=inlineSave",c.serialize(),function(b){c.find(".loading").remove();try{b.data&&b.data[0]&&(b.data[0].alien=e.hasClass("s-alien"));var d=a("<table>").html(tmpl("template-product-list-table",{products:b.data,check_all:a.product_list.container.find(".s-select-all:first").prop("checked"),sort:a.product_list.sort}));e.replaceWith(d.find("tr"));self.container.trigger("append_product_list",[b.data])}catch(f){console.log("Error: "+f.message)}},"json");return!1});c.on("dblclick",
!1);setTimeout(function(){d.find(":input:visible:first").focus()},0)}var d=a(this);if(!d.data("plugin")){var e=d.closest("tr"),f=d.hasClass("s-product-price");if(f){if(e.data("min-price")!=e.data("max-price"))return b(d,$_("Inline editing is available only for products with a single SKU"))}else if("1"!=e.data("sku-count"))return b(d,$_("Inline editing is available only for products with a single SKU"));if(!e.data("edit-rights"))return b(d,$_("Insufficient access rights"));if(!d.hasClass("editor-on"))if(d.addClass("editor-on").data("read-only-state-html",
d.html()),a.product_list.container.removeClass("single-lined"),void 0!==e.data("original-price"))c();else{d.html('<i class="icon16 loading"></i>');var g=[];a.product_list.container.find("tr.product").each(function(){var b=a(this);void 0===b.data("original-price")&&b.data("edit-rights")&&g.push(a(this).data("product-id"))});g.length?a.post("?module=products&action=inlineEditorData",{ids:g},function(b){b.data&&a.product_list.container.find("tr.product").each(function(){var c=a(this),d=b.data[parseInt(c.data("product-id"),
10)];d&&(c.data("stocks",d.stocks||null),c.data("original-price",d.price.replace(/\.?0+$/g,"")))});c()},"json"):c()}}})},initFixedBlocks:function(){var b=a("#mainmenu").height(),c=a("#s-sidebar").width(),d=a(window),e=a("#s-fixed-blocks");e.length||(e=a('<div id="s-fixed-blocks"></div>').css({display:"none",position:"fixed",background:"#fff",top:b,width:c,"float":"left"}).appendTo("#s-sidebar"));var f=a("#s-category-list"),g=a("#s-category-list-block"),h=a("#s-set-list"),j=a("#s-set-list-block"),
k,m=function(){if(!n){var h=a("#"+o);s=a.categories_tree.isCollapsed(h);q=f.is(":hidden");var j=a('<div id="'+p+'" class="block"></div>').css({height:g.height()});g.replaceWith(j);e.show().append(g.hide());g.find(".heading").before('<span class="hint float-right" style="margin-top: 3px;">'+$_("Drag products here")+"</span>");s&&a.categories_tree.expand(h,null,function(){a.categories_tree.collapse(h)});q||f.hide();g.show();a("i.add",g).hide();a("#"+o).hide();g.css({"overflow-x":"hidden","overflow-y":"auto"});
var k=f.is(":hidden"),i;g.bind("mousemove.fixed_blocks.category",function(){document.getElementById("products-helper")&&k&&(i&&(clearTimeout(i),i=null),i=setTimeout(function(){if(k){g.css({height:""});f.show();var a=g.height(),c=(d.height()-b)/2;g.css({height:Math.min(a,c)});g.find(".heading").prev(".hint").hide();k=false}},250))});d.bind("mouseout.fixed_blocks.category",function(a){a.pageX>c+10&&(i&&clearTimeout(i),i=null,k||(f.hide(),g.css({height:""}),g.find(".heading").prev(".hint").show(),k=
!0))});n=!0}},l=function(){if(n){var b=a("#"+p);b.replaceWith(g);g.css({"overflow-x":"","overflow-y":""});var c=a("#"+o);s&&a.categories_tree.collapse(c);q||f.show();g.find(".heading").prev(".hint").remove();a("#"+o).show();a("i.add",g).show();b.remove();g.unbind("mousemove.fixed_blocks.category");d.unbind("mouseout.fixed_blocks.category");e.children().length||e.hide();n=!1;a.categories_tree.init()}},i=g.offset().top,p="s-category-list-dummy",o="s-category-list-handler",n=!1,q,s;d.unbind("scroll.fixed_blocks.category").bind("scroll.fixed_blocks.category",
function(){n||(i=g.offset().top);var c=i,c=document.getElementById(p)?c+a("#"+p).height():c+a("#s-category-list-block").height();d.scrollTop()+b+5>=c?m():l()});k={setFixed:m,unsetFixed:l};var t=function(){if(!u){r=h.is(":hidden");var f=a('<div id="'+v+'" class="block"></div>').css({height:j.height()});j.replaceWith(f);e.show().append(j);j.find(".heading").before('<span class="hint float-right" style="margin-top: 3px;">'+$_("Drag products here")+"</span>");r||h.hide();a("i.add",j).hide();a("i.collapse-handler",
j).hide();j.css({"overflow-x":"hidden","overflow-y":"auto"});var g=h.is(":hidden"),k;j.bind("mousemove.fixed_blocks.set",function(){document.getElementById("products-helper")&&g&&(k&&(clearTimeout(k),k=null),k=setTimeout(function(){if(g){j.css({height:""});h.show();var a=j.height(),c=(d.height()-b)/2;j.css({height:Math.min(a,c)});j.find(".heading").prev(".hint").hide();g=false}},250))});d.bind("mouseout.fixed_blocks.set",function(a){a.pageX>c+10&&(k&&clearTimeout(k),k=null,g||(h.hide(),j.css({height:""}),
j.find(".heading").prev(".hint").show(),g=!0))});u=!0}},w=function(){if(u){var b=a("#"+v);b.replaceWith(j);j.css({"overflow-x":"","overflow-y":""});j.find(".heading").prev(".hint").remove();r||h.show();a("i.add",j).show();a("i.collapse-handler",j).show();b.remove();j.unbind("mousemove.fixed_blocks.category");d.unbind("mouseout.fixed_blocks.category");e.children().length||e.hide();u=!1}},x=j.offset().top,v="s-set-list-dummy",r,u=!1;d.unbind("scroll.fixed_blocks.set").bind("scroll.fixed_blocks.set",
function(){u||(x=j.offset().top);var c=x,c=document.getElementById(v)?c+a("#"+v).height():c+a("#s-set-list-block").height();d.scrollTop()+b+5>=c?t():w()});return{category:k,set:{setFixed:t,unsetFixed:w}}},initEditingControls:function(){var b=a("#s-product-list-title");b.hasClass("editable")&&(b.inlineEditable({minSize:{width:350},maxSize:{width:600},size:{height:30},inputClass:"s-title-h1-edit",beforeMakeEditable:function(){a(".s-product-list-manage").hide()},afterBackReadable:function(b,c){a(".s-product-list-manage").show();
if(!c.changed)return!1;a.shop.jsonPost("?module=products&action=saveListSettings&"+a.product_list.collection_param+"&edit=name",{name:a(b).val()},function(b){a.product_list.sidebar.find("#"+a.product_list.collection_hash[0]+"-"+b.data.id).find(".name:first").html(b.data.name)})}}),"name"==this.options.edit&&b.trigger("editable"));var c=a.product_list.collection_hash[0],b=a("#s-product-list-settings");b.length&&("category"==c||"set"==c)&&b.unbind("click").bind("click",function(){a.product_list.settingsListDialog();
return false});b=a("#s-product-list-delete");b.length&&("category"==c||"set"==c)&&b.unbind("click").bind("click",function(){a("#s-product-list-delete-dialog").waDialog({disableButtonsOnSubmit:true,onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(){function b(a,c){if(!a.length)return c&&c();var f=a.shift();e(["category",f],function(){b(a,c)})}function e(b,c){var d={hash:b.join("/")||"all",remove:["list"]};h&&d.remove.push("products");var e=function(){a.product_list.remove(d,
function(d){var e=b[0],f=a("#"+b.join("-")),g=f.prev(".drag-newposition"),h=a("#s-"+b[0]+"-list"),i=h.find("ul:first");if(e=="set"){f.remove();g.remove()}else{e=f.find("ul:first");if(e.length){e.find(">li.drag-newposition:first").remove();f.hide();e.find(">li").each(function(){f.after(this)})}e=f.parents("ul:first");f.remove();g.remove();if(!e.find("li.dr").length)if(i.get(0)!=e.get(0)){e.parents("li:first").find("i.collapse-handler").remove();e.closest("li").find(".collapse-handler-ajax:first").remove();
e.remove()}else i.closest(".block").find(".collapse-handler-ajax:first").remove()}if(i.find("li.dr:first").length){i.show();h.find(".s-empty-list").hide()}else{i.hide();h.find(".s-empty-list").show()}d.data.old_parent_category&&(typeof d.data.old_parent_category.children_count!=="undefined"&&!parseInt(d.data.old_parent_category.children_count,10))&&a("#category-"+d.data.old_parent_category.id+"-handler").remove();a.product_list.sidebar.trigger("update",d.data.lists);c&&c()})},f=a("#"+b.join("-")+
"-handler");f.length?a.categories_tree.expand(f,function(a){a.parent().find("ul:first").hide();e()}):e();return false}var f=a(this),g=parseInt(a.product_list.collection_hash[1]);f.find(".dialog-buttons i.loading").show();var h=f.find("input[name=s-delete-products]:checked").val()=="1";c=="category"&&f.find('input[name="s-delete-sub"]').is(":checked")?a.get("?action=categoryExpand&tree=1&recurse=1&id="+g,function(c){c=a("<div>").html(c).find('li[id^="category-"]').map(function(){return parseInt(this.id.substr(9),
10)}).get().reverse();c.push(g);b(c,function(){location.href="#/"})}):e(a.product_list.collection_hash,function(){location.href="#/"});return false}});return false});"set"===c&&a("#s-embed-code").click(function(){a("#s-product-list-embed-dialog").waDialog();return false})},initDragndrop:function(){a.product_dragndrop.init({products:!0,view:this.options.view,sort:this.options.sort}).bind("move_product",function(b){a.shop.jsonPost("?module=product&action=move&"+a.product_list.collection_param,{product_ids:b.product_ids,
before_id:b.before_id||null},b.success,b.error)}).bind("is_product_sortable",function(){return a.product_list.sortable}).bind("add_to_list",function(b){var c={};b.whole_list?c.hash=a.product_list.collection_hash.join("/")||"all":c.product_id=b.product_ids;a.shop.jsonPost("?module=product&action=addToList&"+b.collection_param,c,b.success,b.error)})},initToolbar:function(){var b=this.toolbar;b.find("li").unbind("click.product_list").bind("click.product_list",function(){var b=a(this),c=b.attr("data-action");
if(c){var d=a.product_list.getSelectedProducts("delete"!=c);if(!d.count)return alert($_("Please select at least one product")),!1;switch(c){case "new-set":break;case "category":a.product_list.categoriesDialog(d);break;case "set":a.product_list.setsDialog(d);break;case "type":a.product_list.typesDialog(d);break;case "assign-tags":a.product_list.assignTagsDialog(d);break;case "delete":a.product_list.deleteProductsDialog(d);break;case "delete-from-set":"set"==a.product_list.collection_hash[0]&&a.product_list.deleteFromSet(d);
break;case "delete-from-category":"category"==a.product_list.collection_hash[0]&&a.product_list.deleteFromCategory(d);break;case "visibility":a.product_list.visibilityDialog(d,b);break;case "export":a.product_list.exportProducts(d,a(this).attr("data-plugin"));break;case "duplicate":a.product_list.duplicateProducts(d,a(this));break;case "set-badge":case "delete-badge":a.product_list.setBadge(d,a(this));break;default:return}return!1}});b.find('li[data-action="set-custom-badge"] a').click(function(){a(this).parent().find(".textarea-wrapper").slideToggle("fast");
return!1}).closest("li").find(".textarea-wrapper").click(function(){return!1}).find("input").click(function(){var b=a.product_list.getSelectedProducts(!0);b.count?a.product_list.setBadge(b,a(this).closest("li")):alert($_("Please select at least one product"));return!1});var c,d=a("#mainmenu").height(),e=b.find(":first").offset().top-d,f=a(document),g=a(window);f.bind("scroll",c=function(){jQuery.contains(document.documentElement,b[0])?f.scrollTop()>e&&b.height()+d<g.height()?b.addClass("s-fixed").css({top:d}):
b.removeClass("s-fixed"):(f.off("scroll",c),g.off("resize",c))});g.bind("resize",c)},getSelectedProducts:function(b){var b=b||!1,c={count:0};if(this.container.find(".s-select-all:first").attr("checked")){var d=a.product_list.collection_hash.join("/")||"all";b?c.serialized=[{name:"hash",value:d}]:c.hash=d;c.count=this.total_count}else b?c.serialized=a.product_list.container.find(".product.selected").map(function(){c.count+=1;return{name:"product_id[]",value:a(this).attr("data-product-id")}}).toArray():
c.product_id=a.product_list.container.find(".product.selected").map(function(){c.count+=1;return a(this).attr("data-product-id")}).toArray();return c},visibilityDialog:function(b,c){if(!a.isArray(b.serialized))return!1;var d=c.find("i.icon16");if(!d.hasClass("loading")){var e=a("#visibility-dialog-wrapper");e.length||(e=a('<div id="visibility-dialog-wrapper">').appendTo("#s-content"));var f=d.attr("class");d.attr("class","icon16 loading");e.data("products",b).load("?module=dialog&action=visibility",
function(){d.attr("class",f)})}},categoriesDialog:function(b){var c=a("#s-categories"),d=this.sidebar,e=this.container;c.length&&c.parent().remove();a("<div></div>").appendTo("body").load("?module=dialog&action=categories",function(){a("#s-categories").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){var c=a(this);c.find(".dialog-content h1 span").text("("+b.count+")").show();c.find(".dialog-buttons i.loading").hide();c.find("input[name=new_category_name]").val("");c.find("input[name=new_category]").attr("checked",
...
onSubmit:function(c){var g=c.find("form");g.find(".dialog-buttons i.loading").show();a.shop.jsonPost(g.attr("action"),g.serializeArray().concat(b.serialized),function(b){b.data.new_set&&a("#s-set-list ul:first").trigger("add",[b.data.new_set,"set","#/products/set_id="+b.data.new_set+"&view="+a.product_list.options.view]);b.data.sets&&(d.trigger("update",[{set:b.data.sets}]),e.find(".s-select-all:first").trigger("select",!1));g.find("input:checked").attr("checked",!1);c.trigger("close")});return!1}})})},
assignTagsDialog:function(b){var c=a("#s-assign-tags");c.length&&c.remove();a.post("?module=dialog&action=assignTags",b.serialized,function(c){a("body").append(c);a("#s-assign-tags").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){var c=a(this);c.find(".dialog-content h1 span").text("("+b.count+")").show();c.find(".dialog-buttons i.loading").hide()},onSubmit:function(c){var d=a(this),g=d.find("#s-assign-tags-list_tag");if(g.length){var h=jQuery.Event("keypress",{which:13});g.trigger(h)}d.find(".dialog-buttons i.loading").show();
var j=d.attr("action");setTimeout(function(){var g=d.serializeArray().concat(b.serialized);a.shop.jsonPost(j,g,function(b){b.data.cloud&&a("#s-tag-cloud").trigger("update",[b.data.cloud]);c.trigger("close");a.products.dispatch()},function(){c.trigger("close")})},10);return!1}})})},typesDialog:function(b){var c=a("#s-types"),d=this.container,e=this.sidebar,f=function(){a("#s-types").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(c){var f=
a(this);f.find(".dialog-buttons i.loading").show();a.shop.jsonPost(f.attr("action"),f.serializeArray().concat(b.serialized),function(b){e.trigger("update",{type:b.data.types});d.find(".s-select-all:first").trigger("select",!1);f.find("input:checked").attr("checked",!1);c.trigger("close");a.products.dispatch()});return!1}})},g=c.parent();c.length?f():(g=a("<div></div>").appendTo("body"),g.load("?module=dialog&action=types",f))},deleteFromSet:function(b){0<b.count&&a.shop.jsonPost("?module=products&action=deleteFromSet&id="+
this.collection_hash[1],b.serialized,function(){a.products.dispatch()})},deleteFromCategory:function(b){0<b.count&&a.shop.jsonPost("?module=products&action=deleteFromCategory&id="+this.collection_hash[1],b.serialized,function(){a.products.dispatch()})},deleteProductsDialog:function(b){var c=a("#s-product-list-delete-products-dialog"),d=c.parent();c.length||(d=a("<div></div>").appendTo("body"));d.load("?module=dialog&action=productsDelete&count="+b.count,function(){a("#s-product-list-delete-products-dialog").waDialog({disableButtonsOnSubmit:!0,
onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(c){a(this).find(".dialog-buttons i.loading").show();a.product_list.remove(a.extend(b,{remove:["products"]}),function(b,d){a.product_list.sidebar.trigger("update",b.data.lists);a.products.dispatch();c.trigger("close");d.length&&alert((c.data("not-allowed-string")||"").replace("%d",d.length))});return!1}})})},settingsListDialog:function(){var b=a("#s-product-list-settings-dialog");(b.length?b.parent():a("<div></div>").appendTo("body")).load("?module=dialog&action=productListSettings&"+
a.product_list.collection_param,function(){var b=a("#s-product-list-create-dialog");b.length&&(b.parent().remove(),b.remove());a("#s-product-list-settings-dialog").waDialog({esc:!1,disableButtonsOnSubmit:!0,onLoad:function(){a("#s-category-description-content").length&&a.product_sidebar.initCategoryDescriptionWysiwyg(a(this));setTimeout(function(){a("#s-product-list-name").focus()},50)},onSubmit:function(b){var c=a(this),f=function(c){var e=a.product_list.collection_hash,f=location.hash.replace(e[0]+
"_id="+e[1],e[0]+"_id="+c.data.id),g=a("#"+e.join("-"));g.find(".name:first").html(c.data.name);a.isArray(c.data.routes)&&c.data.routes.length?g.find(".routes:first").html(" "+c.data.routes.join(" ")):g.find(".routes:first").html(" ");c.data.status=="0"?g.children("a").addClass("gray"):c.data.status=="1"&&g.children("a").removeClass("gray");g.find(".id:first").html(c.data.id);g.attr("id",e[0]+"-"+c.data.id);g.find("a").attr("href",f);if("sort_products"in c.data||"rule"in c.data){f=f.replace(/&sort=[^&]*/,
"&sort=");f=f.replace(/&order=[^&]*/,"&order=")}location.hash!=f?location.hash=f:a.products.dispatch();b.trigger("close")},g=function(a){if(a&&a.errors){var a=a.errors,c;for(c in a)b.find("input[name="+c+"]").addClass("error").parent().find(".errormsg").text(a[c]);return false}};a("#s-category-description-content").length&&a("#s-category-description-content").waEditor("sync");if(c.find("input:file").length)a.products._iframePost(c,f,g);else{a.shop.jsonPost(c.attr("action"),c.serialize(),f,g);return false}}})})},
exportProducts:function(a,c){for(var d=[],e,f=!1;e=a.serialized.pop();)e.name&&("product_id[]"==e.name?d.push(parseInt(e.value,10)):"hash"==e.name&&(f=e.value));e="?action=importexport#/"+c;f?window.location=e+("/hash/"+f):d.length&&(e+="/hash/id/"+d.join(","),window.location=e)},duplicateProducts:function(b,c){for(var d=[],e,f=!1;e=b.serialized.pop();)e.name&&("product_id[]"==e.name?d.push(parseInt(e.value,10)):"hash"==e.name&&(f=e.value));!f&&d.length&&(f="id/"+d.join(","));f&&(c.find("i.icon16").removeClass("split").addClass("loading"),
...
a.products.dispatch()},error:function(){}}))},setBadge:function(b,c){function d(b){var d="delete-badge"==e?null:b.data;a("#product-list [data-product-id]").each(function(){var b=a(this);if(g||f[b.data("product-id")]){if(b.is("tr")){var c=b.find(".s-image a");c.find(".s-image-corner").remove();d&&c.prepend(a('<div class="s-image-corner"></div>').html(d))}else c=b.find(".s-product-image a"),c.find(".s-image-corner.top.right").remove(),d&&c.append(a('<div class="s-image-corner top right"></div>').html(d));
b.trigger("badge",[d])}});"set-custom-badge"==e&&c.parent().find(".textarea-wrapper").slideUp("fast");c.find(".loading").remove();c.find("a").append(a('<span class="count"><i class="icon16 yes"></i></span>').animate({opacity:0},function(){a(this).remove()}));a.product_list.container.find(".s-select-all:first").trigger("select",!1)}var e=c.data("action");"set-custom-badge"!=e&&c.parent().find(".textarea-wrapper").slideUp("fast");c.find(".loading").remove();c.find("a").append('<span class="count"><i class="icon16 loading"></i></span>');
var f={},g=!1;a.each(b.serialized,function(){g=g||"hash"==this.name;f[this.value]=1});if("delete-badge"==e)c.find(".loading").remove(),a.shop.jsonPost("?module=product&action=badgeDelete",b.serialized,d);else{var h;h="set-custom-badge"==e?c.find("textarea").val():c.data("type");var j=b.serialized;j.push({name:"code",value:h});a.shop.jsonPost("?module=product&action=badgeSet",j,d)}},duplicate:function(b,c){var d=this,e=[];a.shop.jsonPost("?module=products&action=duplicate",{hash:b,limit:50,offset:c.offset||
0},function(a){if("ok"==(a.status||"error"))e=e.concat(a.data.new_ids||[]),a.data.offset<a.data.total_count?(c.offset=a.data.offset,d.duplicate(b,c),c.progress(a.data||{})):c.finish(a.data||{},e)})},remove:function(b,c){var d={},e=[],f;b.product_id?f=function(){100>=b.product_id.length&&(d.get_lists=!0);d.product_id=b.product_id.splice(0,100);a.shop.jsonPost("?module=products&action=deleteList",d,function(a){a.data.not_allowed&&a.data.not_allowed.length&&(e=e.concat(a.data.not_allowed));b.product_id.length?
f():typeof c==="function"&&c(a,e)})}:(d.hash=b.hash||this.collection_hash.join("/")||"all",d.remove=a.isArray(b.remove)&&b.remove.length?b.remove:["list"],1==d.remove.length&&"list"==d.remove[0]?f=function(){a.shop.jsonPost("?module=products&action=deleteList",d,c)}:(d.count=100,f=function(){a.shop.jsonPost("?module=products&action=deleteList",d,function(a){a.data.not_allowed&&a.data.not_allowed.length&&(e=e.concat(a.data.not_allowed));0<a.data.rest_count&&null!=a.data.rest_count?f():"function"===
typeof c&&c(a,e)})}));f()},rubberTable:function(){var b=a("#wa"),c=a("#s-content"),d=a("#s-content > .content"),c=parseInt(c.css("margin-left")),e=parseInt(d.css("margin-right")),f=a(".s-product-list-table-container table").width(),g=b.attr("style");g&&b.data("style",g);d=parseInt(d.width()-a(".s-product-list-table-container").width())+f+c+e;b.width()<d&&b.css({"min-width":d+"px"});a(window).resize()}}})(jQuery);
