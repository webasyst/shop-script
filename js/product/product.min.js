...
var l=!m.ul.length;f.data("loading_content",l);a.get("?action=categoryExpand&id="+b(f)+(l?"&tree=1":""),function(a){l&&(m.target.length?m.target.append(a):m.parent.append(a),e(m,!1),d(f,g),f.data("loading_content",!1));"function"===typeof j&&j()})}};a.categories_tree={init:function(){a("#s-category-list-block").off("click",".collapse-handler-ajax").on("click",".collapse-handler-ajax",function(){var b=a(this);b.hasClass("darr")?f(b):g(b)});a("#s-category-list-block .heading").off("click").click(function(b){var d=
...
s&&a.categories_tree.collapse(c);q||f.show();g.find(".heading").prev(".hint").remove();a("#"+o).show();a("i.add",g).show();b.remove();g.unbind("mousemove.fixed_blocks.category");d.unbind("mouseout.fixed_blocks.category");e.children().length||e.hide();n=!1;a.categories_tree.init()}},i=g.offset().top,p="s-category-list-dummy",o="s-category-list-handler",n=!1,q,s;d.unbind("scroll.fixed_blocks.category").bind("scroll.fixed_blocks.category",function(){n||(i=g.offset().top);var c=i,c=document.getElementById(p)?
...
a.products.dispatch()},error:function(){}}))},setBadge:function(b,c){function d(b){var d="delete-badge"==e?null:b.data;a("#product-list [data-product-id]").each(function(){var b=a(this);if(f[b.data("product-id")]){if(b.is("tr")){var c=b.find(".s-image a");c.find(".s-image-corner").remove();d&&c.prepend(a('<div class="s-image-corner"></div>').html(d))}else c=b.find(".s-product-image a"),c.find(".s-image-corner.top.right").remove(),d&&c.append(a('<div class="s-image-corner top right"></div>').html(d));
...
var f={};a.each(b.serialized,function(){f[this.value]=1});if("delete-badge"==e)c.find(".loading").remove(),a.shop.jsonPost("?module=product&action=badgeDelete",b.serialized,d);else{var g;g="set-custom-badge"==e?c.find("textarea").val():c.data("type");var h=b.serialized;h.push({name:"code",value:g});a.shop.jsonPost("?module=product&action=badgeSet",h,d)}},duplicate:function(b,c){var d=this,e=[];a.shop.jsonPost("?module=products&action=duplicate",{hash:b,limit:50,offset:c.offset||0},function(a){if("ok"==
(a.status||"error"))e=e.concat(a.data.new_ids||[]),a.data.offset<a.data.total_count?(c.offset=a.data.offset,d.duplicate(b,c),c.progress(a.data||{})):c.finish(a.data||{},e)})},remove:function(b,c){var d={},e=[],f;b.product_id?f=function(){100>=b.product_id.length&&(d.get_lists=!0);d.product_id=b.product_id.splice(0,100);a.shop.jsonPost("?module=products&action=deleteList",d,function(a){a.data.not_allowed&&a.data.not_allowed.length&&(e=e.concat(a.data.not_allowed));b.product_id.length?f():typeof c===
"function"&&c(a,e)})}:(d.hash=b.hash||this.collection_hash.join("/")||"all",d.remove=a.isArray(b.remove)&&b.remove.length?b.remove:["list"],1==d.remove.length&&"list"==d.remove[0]?f=function(){a.shop.jsonPost("?module=products&action=deleteList",d,c)}:(d.count=100,f=function(){a.shop.jsonPost("?module=products&action=deleteList",d,function(a){a.data.not_allowed&&a.data.not_allowed.length&&(e=e.concat(a.data.not_allowed));0<a.data.rest_count&&null!=a.data.rest_count?f():"function"===typeof c&&c(a,
e)})}));f()},rubberTable:function(){var b=a("#wa"),c=a("#s-content"),d=a("#s-content > .content"),c=parseInt(c.css("margin-left")),e=parseInt(d.css("margin-right")),f=a("#s-product-list-table-container table").width(),g=b.attr("style");g&&b.data("style",g);d=parseInt(d.width()-a("#s-product-list-table-container").width())+f+c+e;b.width()<d&&b.css({"min-width":d+"px"});a(window).resize()}}})(jQuery);
