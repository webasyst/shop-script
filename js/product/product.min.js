...
$.fn.liveDroppable=function(b){this.each(function(b,a){b=$(this);b.data("init_droppable")&&b.die("mouseover",b.data("init_droppable"))});var a=function(){var c=$(this);c.data("init_droppable")||(c.data("init_droppable",a).droppable(b),c.mouseover())};a.call(this);this.die("mouseover",a).live("mouseover",a)};(function(b){b.fn.inlineEditable=function(a,c){function d(){m(b(this))||b(this).addClass(l.placeholderClass).text(l.placeholder)}function e(){r="edit";this.id=this.id||(""+Math.random()).slice(2);var a=this.id+"-input",c=b("#"+a);c.length||(p.after(g(a)),c=b("#"+a));c.addClass(l.inputClass);h(c,p);l.placeholder&&m(b(this))==l.placeholder&&m(b(p))==l.placeholder&&b(p).text("").removeClass(l.placeholderClass);l.beforeMakeEditable.call(this,c);q=l.truncate?p.data("real_text"):m(p);c.val(q).show().focus();
p.hide();b(l.editLink).hide();if(!n){a=[];for(var d=[],e=0,k=l.makeReadableBy.length;e<k;++e){var v=l.makeReadableBy[e];"blur"==v&&c.blur(function(){"read"!=r&&f.call(this)});"enter"==v&&a.push(13);"esc"==v&&a.push(27)}e=0;for(k=l.updateBy.length;e<k;++e)v=l.updateBy[e],"alt+enter"==v&&d.push({ctrl:!1,alt:!0,shift:!1,key:13}),"ctrl+enter"==v&&d.push({ctrl:!0,alt:!1,shift:!1,key:13}),"ctrl+s"==v&&d.push({ctrl:!0,alt:!1,shift:!1,key:17});a.length&&function(b){c.keydown(function(a){!~b.indexOf(a.keyCode)||
a.ctrlKey||a.altKey||a.shiftKey||"read"!=r&&f.call(this,27==a.keyCode?q:null);if(d.length)for(var c in d){var e=d[c];if(a.keyCode==e.key&&a.ctrlKey==e.ctrl&&a.altKey==e.alt&&a.shiftKey==e.shift){p.trigger("readable");break}}})}(a);p.unbind("readable.inlineEditable").bind("readable.inlineEditable",function(a,c){"read"!=r&&(a=b("#"+(this.id+"-input")),f.call(a,a.val(),c))});n=!0}l.afterMakeEditable.call(this,c)}function f(a,c){c="undefined"===typeof c?!1:!0;void 0!=a&&null!=a?b(this).val(a):a=b(this).val();
if(!1!==c||!1!==l.beforeBackReadable.call(p.get(0),this,{changed:a!=q,old_text:q,new_text:a})){r="read";var e;(e=!l.placeholder)||(b(this).val()?e=!1:(b(p).text(l.placeholder).addClass(l.placeholderClass),e=!0),e=!e);if(e&&(l.allowEmpty||a)){if(l.truncate)p.data("real_text",a),p.text(a.length<l.truncate-3?a:a.substr(0,l.truncate-3)+"...");else{e=p;var f=a;l.html?e.html(f):e.text(f)}a||d.call(this)}p.show();b(this).hide();b(l.editLink).show();!1===c&&l.afterBackReadable.call(p.get(0),this,{changed:a!=
q,old_text:q})}}function g(b){switch(l.inputType){case "textarea":return'<textarea id="'+b+'" style="display:none;"></textarea>';default:return'<input type="text" id="'+b+'" style="display:none;">'}}function h(b,a){var c=l.size.height||a.height();a=l.size.width||1.5*a.width();c=l.minSize.height&&c<l.minSize.height?l.minSize.height:c;a=l.minSize.width&&a<l.minSize.width?l.minSize.width:a;c=l.maxSize.height&&c>l.maxSize.height?l.maxSize.height:c;a=l.maxSize.width&&a>l.maxSize.width?l.maxSize.width:
a;b.height(c);b.width(a)}function k(b){return function(){return b}}function m(b){return l.html?b.html():b.text()}if(this.length){var n=!1;if("string"==typeof a){if("setOption"==a){var l=this.data("inlineEditableSettings")||{};b.extend(!0,l,c);"undefined"!==typeof c.hold&&"function"!==typeof c.hold&&(l.hold=k(l.hold));this.data("inlineEditableSettings",l)}return this}c=this.data("inlineEditableSettings");this.data("inlineEditableSettings",b.extend({inputType:"text",inputClass:"",size:{height:null,
width:null},minSize:{height:null,width:null},maxSize:{height:null,width:null},editLink:null,editOnItself:!0,placeholder:null,makeReadableBy:["blur","enter","esc"],updateBy:["ctrl+enter","alt+enter"],beforeBackReadable:function(){},afterBackReadable:function(){},beforeMakeEditable:function(){},afterMakeEditable:function(){},placeholderClass:"hint",truncate:!1,hold:!1,html:!1,allowEmpty:!1},c,a||{}));l=this.data("inlineEditableSettings")||{};var p=this,r="read",q="";"function"!==typeof l.hold&&(l.hold=
k(l.hold));(function(){if(!this.data("inited")){l.truncate&&"boolean"==typeof l.truncate&&(l.truncate=255);if(l.truncate){var a=l.placeholder&&l.placeholder===this.text()?"":this.text();this.data("real_text",a);this.text(a.length<l.truncate-3?a:a.substr(0,l.truncate-3)+"...")}l.placeholder&&d.call(this);l.editLink&&b(l.editLink).unbind("click.inlineEditable").bind("click.inlineEditable",function(){l.hold.call(p)||"edit"!=r&&e.call(p.get(0))});l.editOnItself&&this.unbind("click.inlineEditable").bind("click.inlineEditable",
function(){l.hold.call(p)||"edit"!=r&&e.call(this)});this.unbind("editable.inlineEditable").bind("editable.inlineEditable",function(){l.hold.call(p)||"edit"!=r&&e.call(this)});this.unbind("placeholder.inlineEditable").bind("placeholder.inlineEditable",function(a,c){c&&l.placeholder&&d.call(this);c||b(this).removeClass(l.placeholderClass)});this.data("inited",!0)}}).call(this);return this}}})(jQuery);(function(b){b.fn.photoStreamSlider=function(a){function c(){function a(c){function f(){a.execution=!1;var b="on"+k.charAt(0).toUpperCase()+k.slice(1);b=d[b];"function"==typeof b&&b.call(e);b=c.fn;"function"==typeof b&&b.call(e)}"string"==typeof c&&(c={direction:c,animate:!0});var k=c.direction||"forward",l=c.steps||h.length;if(!a.execution){a.execution=!0;var p=h.filter(":first").outerWidth()*l,q=h.length;if("forward"==k){var t=h.filter(":last").nextAll(":lt("+l+")");l=t.length;t=t.filter(":last");
l&&(h.removeClass("visible"),t.prevAll(":lt("+(q-1)+")").addClass("visible"),t.addClass("visible"))}else t=h.filter(":first").prevAll(":lt("+l+")"),l=t.length,t=t.filter(":last"),l&&(h.removeClass("visible"),t.nextAll(":lt("+(q-1)+")").addClass("visible").show(),t.addClass("visible"));h=b("li.visible",g);q=g.position().left;"forward"==k?(l=n-m-r,q-=p,q=q>-l?q:-l):(q+=p,q=q<r?q:r);c.animate?g.animate({left:q},d.duration,f):(g.css({left:q}),f())}}var g=e.find(d.photoStream),h=b("li.visible",g),k=b("li",
g),m=h.filter(":first").outerWidth()*h.length,n=k.filter(":first").outerWidth()*k.length,l=d.height||k.filter(":first").outerHeight();g.parent().css({overflow:"hidden",height:l,position:"relative",padding:"4px 0",margin:0,width:m});l=g.find("li:first");var p=h.filter(":first"),r=(p.outerWidth()-p.width())/2,q=0,u=l.outerWidth();for(p=p.get(0);l.length&&l.get(0)!=p;)q+=u,l=l.next();g.css({position:"absolute",left:-(q-r),width:n});b(d.forwardLink).unbind("click").bind("click",function(){a("forward");
...
e.unbind("home").bind("home",function(c,d,e){c=parseInt(h.length/2);c=h.filter(":eq("+c+")");var f=c.nextAll(".selected:first"),g=c.prevAll(".selected:first"),k=0,m="";"function"!==typeof d&&(e=d);e="undefined"!==typeof e?e:!0;f.length?(m="forward",c.nextAll().each(function(){++k;if(b(this).hasClass("selected"))return!1})):g.length&&(m="backward",c.prevAll().each(function(){++k;if(b(this).hasClass("selected"))return!1}));m&&k?a({direction:m,steps:k,fn:d,animate:e}):"function"==typeof d&&d();return!1});
...
d=f.attr("data-type");if(d!=c.attr("data-type"))return!1;a=function(b){b=b.split("-");b.shift();return b.join("-")};var g=a(f.attr("id")),h=c.prev("li"),k=f.next(),m=f.prev();if(h.length&&h.attr("id")=="category-"+g&&!h.hasClass("dr-helper")||this==f.next().get(0))return!1;var n=f.parent("ul"),l=n.children("li.dr[id!=category-"+g+"]").length,p=parseInt(a(n.parent().attr("id")),10)||0;c.after(k).after(f);c=f.parent().parent();if(c.is("li.dr")||c.is(".s-collection-list")){var r=0;c.is(".s-collection-list")||
(r=parseInt(a(c.attr("id")),10)||0);c=f.nextAll("li.dr:first");h=null;c.length&&(h=a(c.attr("id"))||null);l||p===r||(n.parent("li").children("i").hide(),n.hide());b.product_dragndrop.trigger("move_list",{id:g,type:d,before_id:h,parent_id:r,success:function(a){l||p===r||(n.parent("li").children("i").remove(),n.remove(),b.categories_tree.setCollapsed(p))},error:function(b){b&&console&&console.log("undefined"!==typeof b.errors?b.errors:b);m.after(f.next()).after(f);l||(n.parent("li").children("i").show(),
...
!1),!1;var m=parseInt(f.attr("id").split("-")[1],10)||0,n=null,l=c.next(),p=c.prev(),r=!1;f.hasClass("drag-newposition")?n=f.parent("ul"):f.children("ul").length?n=f.children("ul"):f.find(">i.collapse-handler-ajax").length||(n=b('<ul class="menu-v with-icons dr unapproved"><li class="drag-newposition unapproved" data-type="'+a+'"></li></ul>').appendTo(f),n.find(".drag-newposition").mouseover(),b('<i class="icon16 darr overhanging collapse-handler-ajax unapproved" id="'+a+"-"+m+'-handler"></i>').insertBefore(f.children("a")),
r=!0);var q=c.parent("ul"),u=q.children("li.dr[id!=category-"+d+"]").length,t=parseInt(q.parent().attr("id").split("-")[1],10)||0;n&&n.append(c).append(l);u||t===m||(q.parent("li").children("i").hide(),q.hide());f.is("li.dr")&&b.product_dragndrop.trigger("move_list",{id:d,type:a,parent_id:m,success:function(a){u||t===m||(q.parent("li").children("i").remove(),q.remove(),b.categories_tree.setCollapsed(t));n?(b(".s-collection-list .unapproved").removeClass("unapproved"),r?b.categories_tree.setExpanded(m):
f.trigger("count_subtree")):(c.remove(),l.remove(),f.trigger("update_counters",a.data.count||{}))},error:function(a){a&&console&&console.log("undefined"!==typeof a.errors?a.errors:a);p.after(c).after(l);u||(q.parent("li").children("i").show(),q.show());b(".s-collection-list .unapproved").remove()}})}})},_scrolHelper:function(a){a=b("#products-helper");var c=a.data("scrollTop"),e=b(document).scrollTop();c=c?e-c:50;a.css("top",a.position().top+c+"px");a.data("scrollTop",e)},_extDragActivate:function(a,
d,e){var c=e+"-last";if(d.hasClass("last")){var g=a.pageX;a=a.pageY;var h=d.width(),k=d.height(),m=d.offset();"thumbs"==b.product_dragndrop.options.view?g>m.left+.5*h&&g<=m.left+h?(d.removeClass(e).addClass(c),b.product_dragndrop._shiftToLeft(d)):g>m.left&&g<=m.left+.5*h?(d.removeClass(c).addClass(e),b.product_dragndrop._shiftToRight(d)):b.product_dragndrop._shiftAtPlace(d):"table"==b.product_dragndrop.options.view&&(a>m.top+.5*k?d.removeClass(e).addClass(c):a>m.top&&d.removeClass(c).addClass(e));
(a<m.top||a>m.top+k||g<m.left||g>m.left+h)&&d.removeClass(e).removeClass(c)}else d.addClass("drag-active")},_bindExtDragActivate:function(a,d){b(document).bind("mousemove.ext_drag_activate",function(c){b.product_dragndrop._extDragActivate(c,a,d)})},_unbindExtDragActivate:function(){b(document).unbind("mousemove.ext_drag_activate")},_activatePhotoListItem:function(){var a=b(this),d=b.product_dragndrop.trigger("is_product_sortable"),e=d?"drag-active":"drag-active-disabled";d&&"thumbs"==b.product_dragndrop.options.view&&
...
a+'"]'),f=this;0<a?1<c.parents("tbody").find('tr[data-id]:not(.js-sku-settings):not([data-id^="-"])').length?b.ajax({url:"?module=product&action=skuDelete",data:{sku_id:a,product_id:this.path.id},dataType:"json",type:"post",success:function(c){"fail"==c.status?f.refresh("error",c.errors):c.data.redirect?window.location.href=c.data.redirect:(f.refresh("success",c.data.message||"Success"),e.hide("normal",function(){e.remove();b('#s-product-view table.s-product-skus > tbody > tr[data-id="'+a+'"]').remove();
b.product.multiSkus(d.find("tr:not(.js-sku-settings)").length)}),b("#s-product-edit-forms .s-product-form.main").find("input[name=product\\[sku_id\\]][value="+c.data.sku_id+"]").attr("checked",!0))},error:function(b,a,c){f.refresh("error",a)}}):f.refresh("error",$_("A product must have at least one SKU.")):e.hide("normal",function(){e.remove();b('#s-product-view table.s-product-skus > tbody >tr[data-id="'+a+'"]').remove();b.product.multiSkus(d.find("tr:not(.js-sku-settings)").length)})},editTabMainCategoriesAdd:function(){var a=
b("#s-product-edit-forms .s-product-form.main select.s-product-categories:last").parent("div"),c=a.clone(!1);c.find("select").val("select").attr("disabled",!1).show();c.find("input.val").val(0).attr("disabled",!0).parent().hide();c.find(".s-product-delete-from-category").hide();c.find(".s-storefront-map").html("");c.show();a.after(c)},editTabMainSkuStock:function(a,c){c=b("#s-product-sku-"+a);c.hide().find(":input:enabled").attr("disabled",!0);a=b("#s-product-sku-stock-"+a);a.show().find(":input:disabled").removeAttr("disabled");
a.find(":input:first").val(c.find(":input:first").val())},editTabMainSkuSettings:function(a,c){c.hide();var d=c.parents("tr");c=d.data();var e=this;b.when(d.after(tmpl("template-sku-settings",{sku_id:a,sku:c}))).done(function(){var c="?module=product&action=skuSettings&product_id="+e.path.id;c+="&sku_id="+a;var g=b('#s-product-edit-forms .s-product-form.main tr.js-sku-settings[data-id="'+a+'"] > td:first');g.load(c,function(){d.find(':input[name$="[available]"]').remove();b.product_images&&b.product_images.options&&
b.product_images.options.enable_2x&&b.fn.retina&&g.find(".s-product-image-crops img").retina();if(0<a){b.shop.trace("fileupload",[g.find(".fileupload").length,typeof g.find(".fileupload").fileupload]);try{var c=document.cookie.match(/(?:^|; )_csrf=([^;]*)/),e=c?decodeURIComponent(c[1]):"";g.find(".fileupload:first").fileupload({dropZone:null,url:"?module=product&action=skuEproductUpload",acceptFileTypes:/(\.|\/)(gif|jpe?g|png)$/i,start:function(){g.find(".fileupload:first").hide()},progress:function(a,
c){b.shop.trace("fileupload progress",c);a=g.find(".js-progressbar-container");a.show();a.find(".progressbar-inner:first").css("width",Math.round(100*c.loaded/c.total,0)+"%")},done:function(a,c){b.shop.trace("fileupload done",[c.result,typeof c.result]);a=(c.result.files||[]).shift();g.find(".js-progressbar-container").hide();!a||a.error?(g.find(".error-message").text(a.error).show(),g.find(".fileupload:first").addClass("error").show()):(c=g.find(".s-sku-attachment"),c.find("input.s-input-file-name").val(a.name),
c.find(".s-file-name").text(a.name),c.find(".s-file-size").text(a.size),c.find(".s-file-description").val(""),c.find("input[type=checkbox]").attr("checked",!0),c.show(),d.find("input.s-input-virtual").val(0))},fail:function(a,c){b.shop.trace("fileupload fail",[c.textStatus,c.errorThrown]);g.find(".error-message").text("error").show().text(c.errorThrown||"error");g.find(".js-progressbar-container").hide();g.find(".fileupload:first").addClass("error").show()},formData:{product_id:b.product.path.id,
sku_id:a,_csrf:e}})}catch(m){b.shop.error("Exception "+m.message,m)}}})})},editTabMainSkuImageSelect:function(a,c,d){a=d.parents("li:first");var e=a.hasClass("selected"),f=d.parents("div.value:first");f.find("ul.s-product-image-crops li.selected").removeClass("selected");e?f.find('input[name$="[image_id]"]').val(0):(a.addClass("selected"),f.find('input[name$="[image_id]"]').val(c));b.shop.trace("$.product.editTabMainSkuImageSelect",[f,f.find(':input[name$="[image_id]"]')]);b.product.helper.onChange(d.parents("div.s-product-form"))},
editTabMainSkuEproductSave:function(a){a=b("#s-product-edit-forms .s-product-form.main tr.js-sku-settings"+(a&&0<a?'[data-id="'+a+'"]':"")+" > td:first .fileupload");b.shop.trace("$.product.editTabMainSkuEproductSave",a.length);a.length&&a.fileupload("start")},editTabMainSkuEproductDelete:function(b){},editTabMainLinkEdit:function(b){return!1},editTabMainTypeSelect:function(b){var a=b.parents("form").find(':input[name="product[type_id]"]').parents(".value");"main"==this.path.tab?b.hide():(a.find(".js-action").hide(),
window.location.hash="/product/"+this.path.id+"/"+this.path.mode+"/");a.find(".js-type-name").hide();a.find(":input").show().focus();setTimeout(function(){a.find(":input").focus()},100)},editTabMainTypeChange:function(a){var c=a.parents(".value"),d=a.find(":selected:first"),e=d.val();a=parseInt(d.data("sku-type"));c.find(".js-type-icon").html(d.data("icon"));c.find(".js-type-name").html(d.text());e!=c.data("type")?b("#s-product-edit-forms .s-product-form.features").length&&"undefined"!=typeof this.editTabFeaturesReload?
...
"stocks");var k=this.getData("main","stock_ids"),m="";tmpl.cache["template-sku-edit"]=tmpl(tmpl.load("template-sku-edit"));for(var n=0,l=g.length;n<l;n+=1)m+=tmpl("template-sku-edit",{sku_id:g[n].id,sku:g[n],hide_sort_column:1>=l,stocks:h,stock_ids:k,checked:g[n].id==a.sku_id});e.html(m);e.find("select.s-product-currency").val(a.currency);e.parent().show();e.closest(".s-sku-list").show();this.multiSkus(e.find("tr:not(.js-sku-settings)").length);m="";n=0;for(l=g.length;n<l;n+=1)m+=tmpl("template-sku",
{sku_id:g[n].id,sku:g[n],stocks:h,stock_ids:k,runout:a.runout||{}});f.html(m);d&&"new"!=d||e.parents("div.field-group:first").after(b("#s-sku-type-field-group"));c&&(d=b("#s-product-feature-superposition .superposition-count"),d.find(".options").text(c.options),d.find(".skus").html('<span class="highlighted">'+c.skus+"</span>"));var p=/#\/product\/new\//,r="#/product/"+a.id+"/";b("#s-product-edit-forms .s-product-form.main table.s-product-skus tbody, #s-product-view table.s-product-skus tbody").find('[href*="#/product/new/"]').each(function(){b(this).attr("href",
b(this).attr("href").replace(p,r))})},editTabDescriptionsBlur:function(){var a=b("#s-product-description-content");a.length&&a.data("redactor")&&a.waEditor("sync")},editTabDescriptionsAction:function(){var a=b("#s-product-description-content");if(a.length&&!a.data("redactor")){var c=a.parents("div.s-product-form");a.waEditor({lang:wa_lang,modification_wysiwyg_msg:a.data("modification-wysiwyg-msg"),toolbarFixedTopOffset:b("#mainmenu").length?b("#mainmenu").height():0,imageUploadFields:a.data("uploadFields"),
...
b.product_reviews.form),g=b.product_reviews.form.parents(".s-review:first").parent("li"),h=a.data.html,k=b("ul:first",g),m=b.product_reviews.container;g.length||(m.show(),k=b("ul:first",m).show());k.length||(k=b('<ul class="menu-v with-icon"></ul>'),g.append(k));k.append(b('<li data-id="'+a.data.id+'" data-parent-id="'+a.data.parent_id+'"></li>').append(h));b("textarea",b.product_reviews.form).val("");g=b("#s-review-add");g.find("form").length||(g.append(b.product_reviews.form),e.val(0));d.length&&
...
"json")}});b(".lazyloading-link").die("click").live("click",function(){b(window).lazyLoad("force");return!1})}},initSelecting:function(){var a=this.container,c=this.toolbar.find(".count"),d=a.find(".s-select-all:first"),e=function(){var b=parseInt(a.find("> .product.selected").length,10);b?c.text(b).show():c.text("").hide()};b(document).keydown(function(a){16!=a.keyCode||b(a.target).closest(".redactor-box").length||(document.body.onselectstart=function(){return!1})}).keyup(function(a){16==a.keyCode&&
(document.body.onselectstart=null)});a.off("select",".product").on("select",".product",function(a,c,h){h=void 0!==h?h:!0;(void 0!==c?c:1)?b(this).addClass("selected").find("input:first").attr("checked",!0):(b(this).removeClass("selected").find("input:first").attr("checked",!1),d.is(":checked")&&d.attr("checked",!1));h&&e();return!1});d.unbind("select").bind("select",function(d,e){e=void 0!==e?e:!0;d=b(this);e?(d.attr("checked",!0),a.find("> .product").trigger("select",!0,!1),c.text(d.attr("data-count")).show()):
(d.attr("checked",!1),a.find("> .product").trigger("select",!1,!1),c.text("").hide())});a.off("click",".product input").on("click",".product input",function(c,g){var f=c.shiftKey;c=this.checked;g&&(f=g.shiftKey,c=g.checked);g=b(this).parents(".product:first");c?g.addClass("selected"):(d.is(":checked")&&d.attr("checked",!1),g.removeClass("selected"));if(f&&c){(f=a.data("last_checked"))||(f=a.find("> .product:first").trigger("select",!0));var k=g.prevAll(".selected[data-product-id="+f.attr("data-product-id")+
"]");if(k.length){var m=g.prev();for(f=f.get(0);m.length&&f!=m.get(0);)m.addClass("selected").find("input").attr("checked",!0),m=m.prev()}else if(k=g.nextAll(".selected[data-product-id="+f.attr("data-product-id")+"]"),k.length)for(m=g.next(),f=f.get(0);m.length&&f!=m.get(0);)m.addClass("selected").find("input").attr("checked",!0),m=m.next();a.data("last_checked")||k.length||f.trigger("selected",!1)}c&&a.data("last_checked",g);e()});if(b.browser.mozilla)a.off("click",".product label").on("click",".product label",
...
b.post("?module=products&action=inlineSave",c.serialize(),function(a){c.find(".loading").remove();try{a.data&&a.data[0]&&(a.data[0].alien=g.hasClass("s-alien"));var e=b("<table>").html(tmpl("template-product-list-table",{products:a.data,check_all:b.product_list.container.find(".s-select-all:first").prop("checked"),sort:b.product_list.sort}));g.replaceWith(e.find("tr"));d.container.trigger("append_product_list",[a.data])}catch(p){console.log("Error: "+p.message)}},"json");return!1});c.on("dblclick",
...
g=b("#s-category-list-block"),h=b("#s-set-list"),k=b("#s-set-list-block"),m=function(){function h(){if(!n){var h=b("#s-category-list-handler");t=b.categories_tree.isCollapsed(h);u=f.is(":hidden");var k=b('<div id="s-category-list-dummy" class="block"></div>').css({height:g.height()});g.replaceWith(k);e.show().append(g.hide());g.find(".heading").before('<span class="hint float-right" style="margin-top: 3px;">'+$_("Drag products here")+"</span>");t&&b.categories_tree.expand(h,null,function(){b.categories_tree.collapse(h)});
u||f.hide();g.show();b("i.add",g).hide();b("#s-category-list-handler").hide();g.css({"overflow-x":"hidden","overflow-y":"auto"});(function(){var b=f.is(":hidden"),e;g.bind("mousemove.fixed_blocks.category",function(c){document.getElementById("products-helper")&&b&&(e&&(clearTimeout(e),e=null),e=setTimeout(function(){if(b){g.css({height:""});f.show();var c=g.height(),e=(d.height()-a)/2;g.css({height:Math.min(c,e)});g.find(".heading").prev(".hint").hide();b=!1}},250))});d.bind("mouseout.fixed_blocks.category",
function(a){a.pageX>c+10&&(e&&clearTimeout(e),e=null,b||(f.hide(),g.css({height:""}),g.find(".heading").prev(".hint").show(),b=!0))})})();n=!0}}function k(){if(n){var a=b("#s-category-list-dummy");a.replaceWith(g);g.css({"overflow-x":"","overflow-y":""});var c=b("#s-category-list-handler");t&&b.categories_tree.collapse(c);u||f.show();g.find(".heading").prev(".hint").remove();b("#s-category-list-handler").show();b("i.add",g).show();a.remove();g.unbind("mousemove.fixed_blocks.category");d.unbind("mouseout.fixed_blocks.category");
e.children().length||e.hide();n=!1;b.categories_tree.init()}}var m=g.offset().top,n=!1,u,t;d.unbind("scroll.fixed_blocks.category").bind("scroll.fixed_blocks.category",function(){n||(m=g.offset().top);var c=m;c=document.getElementById("s-category-list-dummy")?c+b("#s-category-list-dummy").height():c+b("#s-category-list-block").height();d.scrollTop()+a+5>=c?h():k()});return{setFixed:h,unsetFixed:k}}(),n=function(){function f(){if(!u){m=h.is(":hidden");var f=b('<div id="s-set-list-dummy" class="block"></div>').css({height:k.height()});
k.replaceWith(f);e.show().append(k);k.find(".heading").before('<span class="hint float-right" style="margin-top: 3px;">'+$_("Drag products here")+"</span>");m||h.hide();b("i.add",k).hide();b("i.collapse-handler",k).hide();k.css({"overflow-x":"hidden","overflow-y":"auto"});(function(){var b=h.is(":hidden"),e;k.bind("mousemove.fixed_blocks.set",function(c){document.getElementById("products-helper")&&b&&(e&&(clearTimeout(e),e=null),e=setTimeout(function(){if(b){k.css({height:""});h.show();var c=k.height(),
e=(d.height()-a)/2;k.css({height:Math.min(c,e)});k.find(".heading").prev(".hint").hide();b=!1}},250))});d.bind("mouseout.fixed_blocks.set",function(a){a.pageX>c+10&&(e&&clearTimeout(e),e=null,b||(h.hide(),k.css({height:""}),k.find(".heading").prev(".hint").show(),b=!0))})})();u=!0}}function g(){if(u){var a=b("#s-set-list-dummy");a.replaceWith(k);k.css({"overflow-x":"","overflow-y":""});k.find(".heading").prev(".hint").remove();m||h.show();b("i.add",k).show();b("i.collapse-handler",k).show();a.remove();
k.unbind("mousemove.fixed_blocks.category");d.unbind("mouseout.fixed_blocks.category");e.children().length||e.hide();u=!1}}var n=k.offset().top,m,u=!1;d.unbind("scroll.fixed_blocks.set").bind("scroll.fixed_blocks.set",function(){u||(n=k.offset().top);var c=n;c=document.getElementById("s-set-list-dummy")?c+b("#s-set-list-dummy").height():c+b("#s-set-list-block").height();d.scrollTop()+a+5>=c?f():g()});return{setFixed:f,unsetFixed:g}}();return{category:m,set:n}},initEditingControls:function(){var a=
...
c.find(".dialog-content h1 span").text("("+a.count+")").show();c.find(".dialog-buttons i.loading").hide()},onSubmit:function(c){var d=b(this),e=d.find("#s-assign-tags-list_tag");if(e.length){var h=jQuery.Event("keypress",{which:13});e.trigger(h)}d.find(".dialog-buttons i.loading").show();var k=d.attr("action");setTimeout(function(){var e=d.serializeArray().concat(a.serialized);b.shop.jsonPost(k,e,function(a){"search"===a.data.cloud?c.trigger("close"):a.data.cloud&&b("#s-tag-cloud").trigger("update",
...
"&order="))}else f="#/products/set_id="+e.data.id;"new"===c&&b.product_sidebar.createNewElementInList(e.data,"set");b.product_sidebar.updateItemInCategoryList(e,f);location.hash!=f?location.hash=f:b.products.dispatch();d.trigger("close")},g=function(a){if(a&&a.errors){a=a.errors;for(var b in a)d.find("input[name="+b+"]").addClass("error").parent().find(".errormsg").text(a[b]);return!1}};if(e.find("input:file").length)b.products._iframePost(e,f,g);else return b.shop.jsonPost(e.attr("action"),e.serialize(),
f,g),!1}})};var f=d.length?d.parent():b("<div></div>").appendTo("body");"new"===c&&f.load("?module=set&action=Create",e);"edit"===c&&f.load("?module=set&action=Edit&set_id="+a,e)};return shopDialogProductsSet}(jQuery);var shopDialogProductsCategory=function(b){shopDialogProductsCategory=function(a){this.$wrapper=a.$wrapper;this.category_id=a.category_id;this.account_name=a.account_name;this.ignore_id=[];this.initClass()};shopDialogProductsCategory.prototype.initClass=function(){var a=this;a.initAutocomplete();a.initEvent();a.initFilter();a.initMetaTagEdit();a.initFrontendUrlEdit();a.initCategoryVisibility();a.initSocialMetaTag();var c=a.$wrapper.find('*[data-slider="range"]');c.length&&c.each(function(){a.initRangeSlider(".js-feature-slider-"+
...
k=0,p;for(p in b.data.features)b.data.features.hasOwnProperty(p)&&(c.initShowFeatures(b.data.features[p],g,"template_feature_field",e,!1),++k);b=h-k;0<b?(g="<b><i>"+(20<b?$_("Show %d more").replace("%d",20)+" "+$_("From").toLowerCase()+" "+b:$_("Show %d more").replace("%d",b))+"</i></b>",d.find(".js-show-more").html(g).attr("data-count",b),a||(f=parseInt(f)+parseInt(k),d.find(".js-show-more").attr("data-offset",f))):d.find(".js-autocomplete-wrapper").hide()}else"fail"===b.status&&console.log(b.errors)}})};
...
5E3);return a}())return!1;var f=function(e){if(0<location.hash.indexOf("category_id")){var f=location.hash.replace("category_id="+a,"category_id="+e.data.id);if("sort_products"in e.data||"rule"in e.data)f=f.replace(/&sort=[^&]*/,"&sort="),f=f.replace(/&order=[^&]*/,"&order=")}else f="#/products/category_id="+e.data.id;"new"===d&&b.product_sidebar.createNewElementInList(e.data,"category");b.product_sidebar.updateItemInCategoryList(e,f);location.hash!=f?location.hash=f:b.products.dispatch();c.trigger("close")},
g=function(a){if(a&&a.errors){a=a.errors;for(var b in a)c.find("input[name="+b+"]").addClass("error").parent().find(".errormsg").text(a[b]);return!1}};b("#s-category-description-content").length&&b("#s-category-description-content").waEditor("sync");if(e.find("input:file").length)b.products._iframePost(e,f,g);else return b.shop.jsonPost(e.attr("action"),e.serialize(),f,g),!1}})},f=b("#s-product-category-dialog");f=f.length?f.parent():b("<div></div>").appendTo("body");"new"===d&&f.load("?module=category&action=Create&parent_id="+
...
a)d.range.stop(1,1)[e?"animate":"css"]({bottom:n+"%"},c.animate);if(1===a)d.range[e?"animate":"css"]({height:n-g+"%"},{queue:!1,duration:c.animate})}g=n});else{var h=this.value();var k=this._valueMin();var m=this._valueMax();var n=m!==k?(h-k)/(m-k)*100:0;f["horizontal"===d.orientation?"left":"bottom"]=n+"%";this.handle.stop(1,1)[e?"animate":"css"](f,c.animate);if("min"===a&&"horizontal"===this.orientation)this.range.stop(1,1)[e?"animate":"css"]({width:n+"%"},c.animate);if("max"===a&&"horizontal"===
