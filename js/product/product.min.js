...
$.fn.liveDroppable=function(a){this.each(function(){var a=$(this);a.data("init_droppable")&&a.die("mouseover",a.data("init_droppable"))});var b=function(){var b=$(this);b.data("init_droppable")||(b.data("init_droppable",arguments.callee).droppable(a),b.mouseover())};b.call(this);this.die("mouseover",b).live("mouseover",b)};(function(a){a.fn.inlineEditable=function(b,c){function d(){n(a(this))||a(this).addClass(k.placeholderClass).text(k.placeholder)}function e(){n(a(this))==k.placeholder&&a(this).text("").removeClass(k.placeholderClass)}function f(b){return!a(b).val()?(a(this).text(k.placeholder).addClass(k.placeholderClass),!0):!1}function g(){q="edit";this.id=this.id||(""+Math.random()).slice(2);var b=this.id+"-input",d=a("#"+b);d.length||(r.after(l(b)),d=a("#"+b));d.addClass(k.inputClass);var b=d,c=r,f=k.size.height||
c.height(),c=k.size.width||1.5*c.width(),f=k.minSize.height&&f<k.minSize.height?k.minSize.height:f,c=k.minSize.width&&c<k.minSize.width?k.minSize.width:c,f=k.maxSize.height&&f>k.maxSize.height?k.maxSize.height:f,c=k.maxSize.width&&c>k.maxSize.width?k.maxSize.width:c;b.height(f);b.width(c);k.placeholder&&n(a(this))==k.placeholder&&e.call(r);k.beforeMakeEditable.call(this,d);t=k.truncate?r.data("real_text"):n(r);d.val(t).show().focus();r.hide();a(k.editLink).hide();if(!m){for(var g=[],j=[],b=0,f=k.makeReadableBy.length;b<
f;++b)c=k.makeReadableBy[b],"blur"==c&&d.blur(function(){"read"!=q&&h.call(this)}),"enter"==c&&g.push(13),"esc"==c&&g.push(27);b=0;for(f=k.updateBy.length;b<f;++b)c=k.updateBy[b],"alt+enter"==c&&j.push({ctrl:!1,alt:!0,shift:!1,key:13}),"ctrl+enter"==c&&j.push({ctrl:!0,alt:!1,shift:!1,key:13}),"ctrl+s"==c&&j.push({ctrl:!0,alt:!1,shift:!1,key:17});g.length&&d.keydown(function(a){~g.indexOf(a.keyCode)&&!a.ctrlKey&&!a.altKey&&!a.shiftKey&&"read"!=q&&h.call(this,27==a.keyCode?t:null);if(j.length)for(var b in j){var d=
j[b];if(a.keyCode==d.key&&a.ctrlKey==d.ctrl&&a.altKey==d.alt&&a.shiftKey==d.shift){r.trigger("readable");break}}});r.unbind("readable.inlineEditable").bind("readable.inlineEditable",function(b,d){if("read"!=q){var c=a("#"+(this.id+"-input"));h.call(c,c.val(),d)}});m=!0}k.afterMakeEditable.call(this,d)}function h(b,c){c="undefined"===typeof c?!1:!0;void 0!=b&&null!=b?a(this).val(b):b=a(this).val();if(!(!1===c&&!1===k.beforeBackReadable.call(r.get(0),this,{changed:b!=t,old_text:t,new_text:b}))){q="read";
if(!k.placeholder||!f.call(r,this))if(k.allowEmpty||b)k.truncate?(r.data("real_text",b),r.text(b.length<k.truncate-3?b:b.substr(0,k.truncate-3)+"...")):!k.html?r.text(b):r.html(b),b||d.call(this);r.show();a(this).hide();a(k.editLink).show();!1===c&&k.afterBackReadable.call(r.get(0),this,{changed:b!=t,old_text:t})}}function l(a){switch(k.inputType){case "textarea":return'<textarea id="'+a+'" style="display:none;"></textarea>';default:return'<input type="text" id="'+a+'" style="display:none;">'}}function j(a){return function(){return a}}
function n(a){return!k.html?a.text():a.html()}if(this.length){var m=!1;if("string"==typeof b){if("setOption"==b){var k=this.data("inlineEditableSettings")||{};a.extend(!0,k,c);"undefined"!==typeof c.hold&&"function"!==typeof c.hold&&(k.hold=j(k.hold));this.data("inlineEditableSettings",k)}return this}var s=this.data("inlineEditableSettings");this.data("inlineEditableSettings",a.extend({inputType:"text",inputClass:"",size:{height:null,width:null},minSize:{height:null,width:null},maxSize:{height:null,
width:null},editLink:null,editOnItself:!0,placeholder:null,makeReadableBy:["blur","enter","esc"],updateBy:["ctrl+enter","alt+enter"],beforeBackReadable:function(){},afterBackReadable:function(){},beforeMakeEditable:function(){},afterMakeEditable:function(){},placeholderClass:"hint",truncate:!1,hold:!1,html:!1,allowEmpty:!1},s,b||{}));var k=this.data("inlineEditableSettings")||{},r=this,q="read",t="";"function"!==typeof k.hold&&(k.hold=j(k.hold));this.data("inited")||(k.truncate&&"boolean"==typeof k.truncate&&
(k.truncate=255),k.truncate&&(s=!k.placeholder||k.placeholder!==this.text()?this.text():"",this.data("real_text",s),this.text(s.length<k.truncate-3?s:s.substr(0,k.truncate-3)+"...")),k.placeholder&&d.call(this),k.editLink&&a(k.editLink).unbind("click.inlineEditable").bind("click.inlineEditable",function(){k.hold.call(r)||"edit"!=q&&g.call(r.get(0))}),k.editOnItself&&this.unbind("click.inlineEditable").bind("click.inlineEditable",function(){k.hold.call(r)||"edit"!=q&&g.call(this)}),this.unbind("editable.inlineEditable").bind("editable.inlineEditable",
function(){k.hold.call(r)||"edit"!=q&&g.call(this)}),this.unbind("placeholder.inlineEditable").bind("placeholder.inlineEditable",function(b,c){c&&k.placeholder&&d.call(this);c||a(this).removeClass(k.placeholderClass)}),this.data("inited",!0));return this}}})(jQuery);(function(a){a.fn.photoStreamSlider=function(b){function c(){function b(c){function l(){b.execution=!1;var a="on"+k.charAt(0).toUpperCase()+k.slice(1),a=d[a];"function"==typeof a&&a.call(e);a=c.fn;"function"==typeof a&&a.call(e)}"string"==typeof c&&(c={direction:c,animate:!0});var k=c.direction||"forward",m=c.steps||h.length;if(!b.execution){b.execution=!0;var r=h.filter(":first").outerWidth()*m,q=h.length;if("forward"==k){var u=h.filter(":last").nextAll(":lt("+m+")"),m=u.length,u=u.filter(":last");
m&&(h.removeClass("visible"),u.prevAll(":lt("+(q-1)+")").addClass("visible"),u.addClass("visible"))}else u=h.filter(":first").prevAll(":lt("+m+")"),m=u.length,u=u.filter(":last"),m&&(h.removeClass("visible"),u.nextAll(":lt("+(q-1)+")").addClass("visible").show(),u.addClass("visible"));h=a("li.visible",g);q=g.position().left;"forward"==k?(m=n-j-s,q-=r,q=q>-m?q:-m):(q+=r,q=q<s?q:s);c.animate?g.animate({left:q},d.duration,l):(g.css({left:q}),l())}}var g=e.find(d.photoStream),h=a("li.visible",g),l=a("li",
g),j=h.filter(":first").outerWidth()*h.length,n=l.filter(":first").outerWidth()*l.length,m=d.height||l.filter(":first").outerHeight();g.parent().css({overflow:"hidden",height:m,position:"relative",padding:"4px 0",margin:0,width:j});for(var m=g.find("li:first"),k=h.filter(":first"),s=(k.outerWidth()-k.width())/2,r=0,q=m.outerWidth(),k=k.get(0);m.length&&m.get(0)!=k;)r+=q,m=m.next();g.css({position:"absolute",left:-(r-s),width:n});a(d.forwardLink).unbind("click").bind("click",function(){b("forward");
return!1});a(d.backwardLink).unbind("click").bind("click",function(){b("backward");return!1});e.unbind("append prepend").bind("append prepend",function(b,d){if("append"==b.type){for(var c=g.find("li:last"),f=a();c.hasClass("dummy");)f=f.add(c),c=c.prev("li");f.remove();g.append(d)}else{var c=a("<div></div>").html(d),f=c.find("li"),h=f.length*q;c.remove();for(var c=g.find("li:first"),j=a();c.hasClass("dummy");)j=j.add(c),c=c.next("li");j.remove();g.prepend(f)}l=g.find("li");n=l.filter(":first").outerWidth()*
...
e.unbind("home").bind("home",function(d,c,e){d=parseInt(h.length/2);d=h.filter(":eq("+d+")");var g=d.nextAll(".selected:first"),l=d.prevAll(".selected:first"),j=0,n="";"function"!==typeof c&&(e=c);e="undefined"!==typeof e?e:!0;g.length?(n="forward",d.nextAll().each(function(){++j;if(a(this).hasClass("selected"))return!1})):l.length&&(n="backward",d.prevAll().each(function(){++j;if(a(this).hasClass("selected"))return!1}));n&&j?b({direction:n,steps:j,fn:c,animate:e}):"function"==typeof c&&c();return!1});
...
c){var d=a(this);if(c.draggable.attr("data-type")!=d.attr("data-type"))return!1;(d.is(":animated")||d.hasClass("dragging"))&&d.stop().animate({height:"2px"},300,null,function(){d.removeClass("dragging")});d.removeClass("active").parent().parent().removeClass("drag-active")},drop:function(b,c){var d=a(this),e=c.draggable,f=e.attr("data-type");if(f!=d.attr("data-type"))return!1;var g=function(a){a=a.split("-");a.shift();return a.join("-")},h=g(e.attr("id")),l=d.prev("li"),j=e.next(),n=e.prev();if(l.length&&
l.attr("id")=="category-"+h&&!l.hasClass("dr-helper")||this==e.next().get(0))return!1;var m=e.parent("ul"),k=m.children("li.dr[id!=category-"+h+"]").length,s=parseInt(g(m.parent().attr("id")),10)||0;d.after(j).after(e);d=e.parent().parent();if(d.is("li.dr")||d.is(".s-collection-list")){var r=0;d.is(".s-collection-list")||(r=parseInt(g(d.attr("id")),10)||0);d=e.nextAll("li.dr:first");l=null;d.length&&(l=g(d.attr("id"))||null);!k&&s!==r&&(m.parent("li").children("i").hide(),m.hide());a.product_dragndrop.trigger("move_list",
{id:h,type:f,before_id:l,parent_id:r,success:function(){!k&&s!==r&&(m.parent("li").children("i").remove(),m.remove(),a.categories_tree.setCollapsed(s))},error:function(a){a&&console&&console.log("undefined"!==typeof a.errors?a.errors:a);n.after(e.next()).after(e);k||(m.parent("li").children("i").show(),m.show())}})}}})},initDropInsideCollections:function(){a(".s-collection-list li.dr a").liveDroppable({tolerance:"pointer",greedy:!0,out:function(b,c){var d=c.draggable,e=a(this).parent();if(!d.hasClass("product")&&
...
e.hasClass("dynamic"))return c.helper.find("i.no-bw").show(),!1;c.helper.find("i.no-bw").hide();var g='.dr[id!="'+d.attr("id")+'"]',h=a(),d=function(a,b){if(!b.length)return a;a=a.add(b.nextUntil(g).filter("li.drag-newposition"));return 0<b.nextAll(g).length?a:arguments.callee(a,b.parent().closest("li"))},f=e.prevAll(g+":first");if(0<f.length)var l=f.find(g),h=0<l.length?d(h,l.last()):d(h,f);else h=h.add(e.prevUntil(g).filter("li.drag-newposition"));var h=0<e.children("ul").children(g).length?h.add(e.children("ul").children("li.drag-newposition:first")):
d(h,e),j=a(".drag-newposition:animated, .drag-newposition.dragging").not(h);j.stop().animate({height:"2px"},300,null,function(){j.removeClass("dragging")});h.stop().animate({height:"10px"},300,null,function(){h.addClass("dragging")})},drop:function(b,c){var d=c.draggable,e=a(this).parent(),f=d.attr("data-type");if(!d.hasClass("product")&&("set"==f||e.attr("id")==d.attr("id")||f!=e.attr("data-type")))return!1;e.removeClass("drag-newparent");if(d.hasClass("product")){if(e.hasClass("dynamic"))return!1;
var g=a("#product-list"),h={};if(g.find(".s-select-all").is(":checked"))h.whole_list=!0;else{var l=g.find(".product.selected");h.product_ids=l.map(function(){return a(this).attr("data-product-id")}).toArray()}a.product_dragndrop.trigger("add_to_list",a.extend(h,{collection_param:e.attr("id").replace("-","_id="),success:function(a){h.whole_list?g.find(".s-select-all").trigger("select",!1):h.product_ids&&h.product_ids.length&&l.trigger("select",!1);a.data&&(e.find(">.counters .count:not(.subtree)").text(a.data.count),
e.find(">.counters .subtree").text(a.data.total_count))}}));return!1}if(!d.hasClass("dynamic")&&e.hasClass("dynamic"))return!1;var j=d.attr("id").split("-")[1];if(e.attr("id")=="category-"+j)return!1;if(d.hasClass("product"))return a("#product-list").find(".product.selected").trigger("select",!1),!1;var n=parseInt(e.attr("id").split("-")[1],10)||0,m=null,k=d.next(),s=d.prev(),r=!1;e.hasClass("drag-newposition")?m=e.parent("ul"):e.children("ul").length?m=e.children("ul"):e.find(">i.collapse-handler-ajax").length||
(m=a('<ul class="menu-v with-icons dr unapproved"><li class="drag-newposition unapproved" data-type="'+f+'"></li></ul>').appendTo(e),m.find(".drag-newposition").mouseover(),a('<i class="icon16 darr overhanging collapse-handler-ajax unapproved" id="'+f+"-"+n+'-handler"></i>').insertBefore(e.children("a")),r=!0);var q=d.parent("ul"),t=q.children("li.dr[id!=category-"+j+"]").length,v=parseInt(q.parent().attr("id").split("-")[1],10)||0;m&&m.append(d).append(k);!t&&v!==n&&(q.parent("li").children("i").hide(),
q.hide());e.is("li.dr")&&a.product_dragndrop.trigger("move_list",{id:j,type:f,parent_id:n,success:function(b){!t&&v!==n&&(q.parent("li").children("i").remove(),q.remove(),a.categories_tree.setCollapsed(v));m?(a(".s-collection-list .unapproved").removeClass("unapproved"),r?a.categories_tree.setExpanded(n):e.trigger("count_subtree")):(d.remove(),k.remove(),e.trigger("update_counters",b.data.count||{}))},error:function(b){b&&console&&console.log("undefined"!==typeof b.errors?b.errors:b);s.after(d).after(k);
t||(q.parent("li").children("i").show(),q.show());a(".s-collection-list .unapproved").remove()}})}})},_scrolHelper:function(){var b=a("#products-helper"),c=b.data("scrollTop"),d=a(document).scrollTop();b.css("top",b.position().top+(c?d-c:50)+"px");b.data("scrollTop",d)},_extDragActivate:function(b,c){if(c.hasClass("last")){var d=b.pageX,e=b.pageY,f=c.width(),g=c.height(),h=c.offset();"thumbs"==a.product_dragndrop.options.view?d>h.left+0.5*f?c.removeClass("drag-active").addClass("drag-active-last"):
d>h.left&&c.removeClass("drag-active-last").addClass("drag-active"):"table"==a.product_dragndrop.options.view&&(e>h.top+0.5*g?c.removeClass("drag-active").addClass("drag-active-last"):e>h.top&&c.removeClass("drag-active-last").addClass("drag-active"));(e<h.top||e>h.top+g||d<h.left||d>h.left+f)&&c.removeClass("drag-active drag-active-last")}else c.addClass("drag-active")}}})(jQuery);(function(a){var b=function(a){var b=/^category-(.*?)-handler$/;return b.test(a.attr("id"))?a.attr("id").replace(b,function(a,b){return parseInt(b,10)||0}):0},c=function(a){if(b(a))a=a.parents("li:not(.drag-newposition):first"),d=c=a.find("ul:first");else{a=a.parent();var c=a.next(),d=c.find("ul:first")}return{parent:a,target:c,ul:d}},d=function(a,b){var d=c(a);"category"==d.parent.attr("data-type")&&d.parent.trigger("count_subtree",!1);a.removeClass("rarr").addClass("darr");d.target.show();"function"===
typeof b&&b(a)},e=function(a,b){var c=a.parent.find(".loading:first"),d=a.parent.parent().find(".count:first"),e=a.parent.find(".counters");b?(c.show(),d.hide(),e.hide()):(c.hide(),d.show(),e.show())},f=function(d,e){var f=c(d);"category"==f.parent.attr("data-type")&&f.parent.trigger("count_subtree",!0);d.removeClass("darr").addClass("rarr");f.target.hide();"function"===typeof e&&e(d);a.get("?action=categoryExpand&id="+b(d)+"&collapsed=1")},g=function(f,g){if(!f.data("loading_content")){var j=c(f);
j.parent.find(".loading:first");j.ul.length?d(f,g):e(j,!0);var n=!j.ul.length;f.data("loading_content",n);a.get("?action=categoryExpand&id="+b(f)+(n?"&tree=1":""),function(a){n&&(j.target.length?j.target.append(a):j.parent.append(a),e(j,!1),d(f,g),f.data("loading_content",!1))})}};a.categories_tree={init:function(){a("#s-category-list-handler").parent().parent().off("click",".collapse-handler-ajax").on("click",".collapse-handler-ajax",function(){var b=a(this);b.hasClass("darr")?f(b):g(b)})},collapse:function(b,
c){b=a(b);b.hasClass("darr")?f(b,c):"function"===typeof c&&c(b)},expand:function(b,c){b=a(b);b.hasClass("rarr")?g(b,c):"function"===typeof c&&c(b)},setExpanded:function(b){a.get("?action=categoryExpand&id="+b)},setCollapsed:function(b){a.get("?action=categoryExpand&id="+b+"&collapsed=1")},getHandlerByCategoryId:function(b){var c=a();return c=(b=parseInt(b,10)||0)?a("#category-"+b+"-handler"):a("#s-category-list-handler")}}})(jQuery);(function(a){Array.prototype.filter||(Array.prototype.filter=function(a,c){var d=this.length;if("function"!=typeof a)throw new TypeError;for(var e=[],f=0;f<d;f++)if(f in this){var g=this[f];a.call(c,g,f,this)&&e.push(g)}return e});a.storage=new a.store;a.products={hash:"",list_hash:"",list_params:{},options:{view:"thumbs"},random:"",init:function(b){a.extend(this.options,b);this.initRouting();this.initSearch();this.initSidebar();a.categories_tree.init();this.initCollapsible()},data:{prev_action:null},
initRouting:function(){"undefined"!=typeof a.History&&a.History.bind(function(){a.products.dispatch()});a.wa.errorHandler=function(b){return 403===b.status||404===b.status?(b=a(b.responseText),console.log(b),b=b.find(".dialog-content").length?a('<div class="block double-padded"></div>').append(b.find(".dialog-content *")):a('<div class="block double-padded"></div>').append(b.find(":not(style)")),a("#s-content").empty().append(b),!1):!0};var b=window.location.hash;"#/"===b||!b?this.dispatch():a.wa.setHash(b)},
dispatch:function(b){void 0===b&&(b=window.location.hash);this.hash=b=b.replace(/(^[^#]*#\/*|\/$)/g,"");try{if(b)if(b=b.split("/"),b[0]){for(var c="",d=b.length,e=0;e<b.length;e++){var f=b[e];if(2>e)if(0===e)c=f;else if("product"==c||"tag"==c||"search"==c||"plugins"==c||"pages"==c||"stocks"==c){d=e;break}else if(parseInt(f,10)!=f&&-1==f.indexOf("="))c+=f.substr(0,1).toUpperCase()+f.substr(1);else{d=e;break}else{d=e;break}}var g=b.slice(d);this.preExecute(c,g);"function"==typeof this[c+"Action"]?(a.shop.trace("$.products.dispatch",
[c+"Action",g]),this[c+"Action"].apply(this,g)):a.shop.error("Invalid action name:",c+"Action")}else this.preExecute(),this.defaultAction();else this.preExecute(),this.defaultAction()}catch(h){a.shop.error(h.message,h)}},load:function(b,c){var d=Math.random();this.random=d;var e=this;a.get(b,function(b){if(e.random==d&&(a("#s-content").removeClass("bordered-left").html(b),a("html, body").animate({scrollTop:0},200),c))try{c.call(this)}catch(g){a.shop.error("$.products.load callback error: "+g.message,
g)}})},addOptions:function(b){this.options=a.extend(this.options,b||{})},preExecute:function(b){try{if(this.data.prev_action&&this.data.prev_action!=b){var c=this.data.prev_action+"Termination";a.shop.trace("$.products.preExecute",[c,b]);"function"==typeof this[c]&&this[c].apply(this,[])}this.data.prev_action=b}catch(d){a.shop.error("preExecute error: "+d.message,d)}},defaultAction:function(){this.productsAction()},buildProductsUrlComponent:function(a){return"view="+(a.view||this.options.view)+(a.category_id?
"&category_id="+a.category_id:"")+(a.set_id?"&set_id="+a.set_id:"")+(a.tag?"&tag="+a.tag:"")+(a.sort?"&sort="+a.sort:"")+(a.order?"&order="+a.order:"")+(a.text?"&text="+a.text:"")+(a.edit?"&edit="+a.edit:"")+(a.hash?"&hash="+a.hash:"")+(a.type_id?"&type_id="+a.type_id:"")},productsAction:function(){var b=Array.prototype.join.call(arguments,"/"),b=a.shop.helper.parseParams(b||"");b.view||(b.view=a.storage.get("shop/products/view")||this.options.view);a.storage.set("shop/products/view",b.view);this.list_hash=
this.hash;this.list_params=b;this.load("?module=products&"+this.buildProductsUrlComponent(b))},productAction:function(b,c,d){var e=Array.prototype.slice.call(arguments).filter(function(a){return a.length}).join("/");a.shop.trace("$.products.productAction",[e,arguments]);var f="?module=product";b&&(f+="&id="+b);"undefined"!=typeof a.product?a.product.dispatch(e):this.load(f,function(){a.product.dispatch(e)})},productTermination:function(){"undefined"!=typeof a.product&&a.product.termination()},reviewsAction:function(){this.load("?module=reviews")},
stocksAction:function(a){this.load("?module=stocks"+(a?"&order="+a:""))},servicesAction:function(b){this.load("?module=services"+(b?"&id="+b:""),function(){a("#s-content").addClass("bordered-left");"function"===typeof a.products.afterServicesAction&&a.products.afterServicesAction()})},initCollapsible:function(){var b=function(b,e){a(b).removeClass("darr").addClass("rarr");c(b).hide();if(!e&&(a.storage.set("shop/products/"+b.id+"/collapse",1),!1!==e)){var f=b.id.replace(/\-handler$/,""),f=a(b).parents("div.block:first").find("#"+
f+":first");f.length&&(f=f.data("on-collapse-url"))&&a.get(f)}},c=function(b){b=a(b).parent();return b.is("li")?b.find("ul:first"):b.next()};a(".collapse-handler").die("click").live("click",function(){if(a(this).hasClass("darr"))b(this);else{c(this).show();var d=a(this);d.removeClass("rarr").addClass("darr");a.storage.del("shop/products/"+this.id+"/collapse");var e=this.id.replace(/\-handler$/,""),f=d.parents("div.block:first").find("#"+e+"-placeholder:first");if(f.length){var g=a(this).parents("div.block:first").find(".count:first");
g.find("i.icon16.loading").remove();g.find("i.icon16").hide();g.prepend('<i class="icon16 loading"></i>');a.get(f.data("url"),function(b){f.replaceWith(a(b));g.find("i.icon16.loading").remove();g.find("i.icon16").show();f.remove()})}else d=a(this).parents("div.block:first").find("#"+e+":first"),d.length&&(d=d.data("on-expand-url"))&&a.get(d)}}).each(function(){var c="shop/products/"+this.id+"/collapse",e=a(this).hasClass("rarr");(a.storage.get(c)||e)&&b(this,!e)})},initSearch:function(){var b=function(){var b=
this.value,c=a.products.hash.match(/[&\/](text=.*?&|text=.*)/),f=a.products.hash;c?(c=c[1],b?(b="&"==c.substr(-1)?"text="+encodeURIComponent(b)+"&":"text="+encodeURIComponent(b),f=f.replace(c,b)):("&"!=c.substr(-1)&&(c="[&/]"+c),f=f.replace(RegExp(c),""))):b?(delete a.products.list_params.text,f="products/"+a.products.buildProductsUrlComponent(a.products.list_params)+"&text="+encodeURIComponent(b)):f="products/"+a.products.buildProductsUrlComponent(a.products.list_params);location.hash="#/"+f},c=
a("#s-products-search");c.unbind("keydown").bind("keydown",function(c){if(13==c.keyCode)return b.call(this),a(this).autocomplete("close"),!1});c.unbind("search").bind("search",function(){b.call(this);return!1});c.autocomplete({source:"?action=autocomplete",minLength:3,delay:300,select:function(b,c){a.wa.setHash("#/product/"+c.item.id);return!1}})},initSidebar:function(){var b=a("#s-sidebar");a.product_dragndrop.init({collections:!0}).bind("move_list",function(b){if(b.type){var c={id:b.id,type:b.type,
parent_id:b.parent_id||0};b.before_id&&(c.before_id=b.before_id);a.products.jsonPost("?module=products&action=moveList",c,b.success,b.error)}else"function"===typeof b.error&&b.error("Unknown list type")});b.off("add",".s-collection-list ul").on("add",".s-collection-list ul",function(b,c,f,g){b=a(this);var h=b.parents(".s-collection-list:first"),l=a("<ul></ul>");l.append(tmpl("template-sidebar-list-item",{type:f,item:c}));c=l.children(":not(.drag-newposition):first");f=c.attr("id");f=b.find("#"+f);
var j=l.children();f.length?g&&f.replaceWith(c):b.prepend(j).show();j.each(function(){var b=a(this);b.hasClass("dr")?b.find("a").mouseover():b.mouseover()});b.find(".drag-newposition").css({height:"2px"}).removeClass("dragging");h.find(".s-empty-list").hide();l.remove();return!1});b.unbind("update").bind("update",function(b,c){for(var f in c)if("all"==f)a("#s-all-products").find(".count:first").text(c[f].count);else{var g="#"+f+"-",h;for(h in c[f])a(g+h).find(".count:first").text(c[f][h].count)}return!1});
a("#s-tag-cloud").unbind("update").bind("update",function(b,c){var f='<ul class="tags"><li class="block align-center">',g;for(g in c)var h=c[g],f=f+('<a href="#/products/tag='+h.uri_name+'/" style="font-size: '+h.size+"%; opacity: "+h.opacity+'"  data-id="'+h.id+'"  class="s-product-list">'+h.name+"</a>");a("#s-tag-cloud").html(f+"</li></ul>").parents(".block:first").show();return!1});b.off("count_subtree",".s-collection-list li").on("count_subtree",".s-collection-list li",function(b,c){var f=a(this);
"undefined"===typeof c&&(c=f.find("i.collapse-handler-ajax").hasClass("rarr"));var g=f.find(">.counters .count:not(.subtree)"),f=f.find(">.counters .subtree");f.length||(f=g.clone().addClass("subtree").hide(),g.after(f));c?(g.hide(),f.show()):(f.hide(),g.show());return!1});b.off("update_counters",".s-collection-list li").on("update_counters",".s-collection-list li",function(b,c){var f=a(this),g=f.find(">.count:not(.subtree)"),f=f.find(">.subtree");f.length||(f=g.clone().addClass("subtree").hide(),
g.after(f));"undefined"!==typeof c.item&&g.text(parseInt(c.item,10)||0);"undefined"!==typeof c.subtree&&f.text(parseInt(c.subtree,10)||0);return!1});var c=b.find("#s-category-list-widen-arrows");c.find("a.arrow").unbind("click").bind("click",function(){var d=b.attr("class"),e=0,f=d.match(/left([\d]{2,3})px/);if(f&&f[1]&&(e=parseInt(f[1])))if(f=e+(a(this).is(".right")?50:-50),f=Math.max(Math.min(f,400),200),f!=e){c.css({width:f.toString()+"px"});e=["left"+e+"px","left"+f+"px"];b.attr("class",d.replace(e[0],
e[1]));b.css("width","");var g=a("#s-content"),d=g.attr("class");g.attr("class",d.replace(e[0],e[1]));g.css("margin-left","");a.product&&a.product.setOptions({sidebar_width:f});a.shop.jsonPost("?action=sidebarSaveWidth",{width:f})}return!1})},jsonPost:function(b,c,d,e){a.shop.jsonPost(b,c,d,e)}}})(jQuery);(function(a){a.product={options:{duration:200,container_selector:"#shop-productprofile",message_selector:"#product-save-message",form_selector:"#s-product-save",update_delay:100},message:{submit:'<i class="icon16 loading"></i>',success:'<i class="icon16 yes"></i>',error:'<i class="icon16 no"></i>'},path:{id:null,mode:null,tab:null,tail:null,raw:null,params:{}},ajax:{random:null,target:null,link:null,save:!1,cached:{}},data:{main:{}},getData:function(a,c){return(this.data[a]||{})[c]},setData:function(a,
...
"").replace(/(^\/|\/$)/,"");var c=b.split("/"),d=c.pop(),e={};d.match(/^[\w_\-]+=/)?e=a.shop.helper.parseParams(d):c.push(d);return{id:c[0]||"new",mode:c[1]||"profile",tab:c[1]?c[2]||"main":!1,tail:c.slice(3).join("/")||"",raw:b,params:e}},dispatch:function(b){"string"==typeof b&&(b=this.parsePath(b));var c=[];a.shop.trace("$.product.dispatch",[this.path,b,b.raw]);if(!this.path.id){var d=this.get("container");d.length&&(this.path.id=d.data("product-id"),c.push("load"))}if(this.path.id!=b.id)this.path.id&&
...
f=this.path.id;if(!this.path.id||"new"==this.path.id){this.path.id=b.id;a(this.options.container_selector).data("product-id",this.path.id);var g="/product/"+this.path.id+"/";if(null!==c&&(c=c||this.path.mode||"profile"))if("profile"!=c&&(g+=c+"/"),null!==d&&(d=d||this.path.tab||""))"main"!=d.toLowerCase()&&(g+=d+"/");a.shop.trace("update location.hash="+g);var h=/#\/product\/new\//,l="#/product/"+this.path.id+"/";a("#shop-productprofile, #s-product-edit-menu, #s-product-edit-forms, #s-product-profile-page").find('[href*="#/product/new/"]').each(function(){a(this).attr("href",
a(this).attr("href").replace(h,l))});a("#s-product-edit-forms").find(':input[name="product[id]"]').val(this.path.id);window.location.hash=g}else this.path.id!=b.id&&a.shop.error("Abnormal product ID change",[this.path.id,b]);c=a("#shop-productprofile h1");c.find(".s-product-name:first").text(b.name);c.find(".s-product-id").show().text("id: "+b.id);document.title=b.name+a.product.options.title_suffix;e.find(':input[name="product[type_id]"]').parents(".value").data("type",b.type_id);b.frontend_url?
...
(a(".s-product-frontend-url-not-empty").hide(),a(".s-product-frontend-url-empty").show());this.editTabMainUpdate(b.raw||{},b.features_selectable_strings,f);e.find("select.s-product-categories").each(function(){var b=a(this),c=b.parent(),d=b.val();if("select"==d||"---"==d)d=a("#s-product-edit-forms .s-product-form.main select.s-product-categories"),1<d.length?c.remove():c.find(".s-product-delete-from-category").hide();else if("create"==d){var e=c.find("input.val").val();"0"==e?(d=a("#s-product-edit-forms .s-product-form.main select.s-product-categories"),
1<d.length?c.remove():(b.val(e),b.show().attr("disabled",!1),c.find("input.val").attr("disabled",!0),c.find(".s-new-category").hide(),c.find(".s-product-delete-from-category").hide())):(b.val(e),b.show().attr("disabled",!1),c.find("input.val").attr("disabled",!0),c.find(".s-new-category").hide(),c.find(".s-product-delete-from-category").show())}});a("#s-product-save table.s-product-skus > tbody > tr").each(function(){var c=a(this).data("id");a(this).find("td.s-stock .s-product-stock-icon").each(function(){var d=
...
j.length&&(j=j.detach(),a.shop.trace("detach",j),j&&(a.shop.trace("detach",e.find('> tr[data-id="'+f+'"]').length),e.find('> tr[data-id="'+f+'"]:first').after(j)))},start:function(){e.find("> tr.js-sku-settings").hide()},stop:function(){e.find("> tr.js-sku-settings").show()}});var f=a("#s-product-frontend-url");f.inlineEditable({editLink:"#s-product-frontend-url-edit-link",editOnItself:!1,minSize:{height:15,width:100},makeReadableBy:[],beforeMakeEditable:function(b){var c=a(this).parents("div:first"),
...
c.find("select"),j=f.find("option.separator:first").show();a.when(j.after('<option class="category" value="'+e.data.id+'">'+e.data.name+"</option>")).then(function(){f.find("option:first").text($_("Please select a category"));f.val(e.data.id).attr("disabled",!1).show().removeClass("js-ignore-change");b.find("input.val").val(e.data.id).attr("disabled",!0);b.hide();c.find(".s-product-delete-from-category").show();d.val("");a.product.helper.onTabChanged("main",!0);a("#s-product-save-button").removeClass("green").addClass("yellow");
...
else{var f=a("input[name=parent_id]",a.product_reviews.form),g=a.product_reviews.form.parents(".s-review:first").parent("li"),h=b.data.html,l=a("ul:first",g),j=a.product_reviews.container;g.length||(j.show(),l=a("ul:first",j).show());l.length||(l=a('<ul class="menu-v with-icon"></ul>'),g.append(l));l.append(a('<li data-id="'+b.data.id+'" data-parent-id="'+b.data.parent_id+'"></li>').append(h));a("textarea",a.product_reviews.form).val("");g=a("#s-review-add");g.find("form").length||(g.append(a.product_reviews.form),
...
!1),d.is(":checked")&&d.attr("checked",!1));h&&e();return!1});d.unbind("select").bind("select",function(d,e){e=void 0!==e?e:!0;var h=a(this);e?(h.attr("checked",!0),b.find(".product").trigger("select",!0,!1),c.text(h.attr("data-count")).show()):(h.attr("checked",!1),b.find(".product").trigger("select",!1,!1),c.text("").hide())});b.off("click",".product input").on("click",".product input",function(c,g){var h=c.shiftKey,l=this.checked;g&&(h=g.shiftKey,l=g.checked);var j=a(this).parents(".product:first");
l?j.addClass("selected"):(d.is(":checked")&&d.attr("checked",!1),j.removeClass("selected"));if(h&&l){(h=b.data("last_checked"))||(h=b.find(".product:first").trigger("select",!0));var n=j.prevAll(".selected[data-product-id="+h.attr("data-product-id")+"]"),m;if(n.length){m=j.prev();for(h=h.get(0);m.length&&h!=m.get(0);)m.addClass("selected").find("input").attr("checked",!0),m=m.prev()}else if(n=j.nextAll(".selected[data-product-id="+h.attr("data-product-id")+"]"),n.length){m=j.next();for(h=h.get(0);m.length&&
h!=m.get(0);)m.addClass("selected").find("input").attr("checked",!0),m=m.next()}!b.data("last_checked")&&!n.length&&h.trigger("selected",!1)}l&&b.data("last_checked",j);e()});if(a.browser.mozilla)b.off("click",".product label").on("click",".product label",function(b){if(b.shiftKey){var c=a(b.target);a(c).is("label")||(c=a(c).parents("label:first"));c=a("#"+c.attr("for"));c.trigger("click",{shiftKey:b.shiftKey,checked:!c.attr("checked")})}})},initView:function(b){try{var c=this.container,d=this.sidebar;
"table"==b&&c.find(".s-select-all").click(function(){a(this).trigger("select",this.checked)});var e="view="+b;d.find(".s-collection-list li.dr").each(function(){var b=a(this);b.find("a:first").attr("href","#/products/"+b.attr("id").replace("-","_id=")+"&"+e)});a("#s-products-search").val(this.options.text||"");c="s-all-products";a.product_list.collection_hash.length&&"search"!==a.product_list.collection_hash[0]&&(c=a.product_list.collection_hash.join("-"));a.shop.trace("$.product_list.initView",[b,
c]);d.find("li.selected").removeClass("selected");var f=d.find("#"+c);0>=f.length&&window.location.hash&&(f=d.find('a[href="'+window.location.hash+'"]').parent());0>=f.length&&(f=d.find("#s-all-products"));f.addClass("selected").find(".count:first").text(this.category_count);d.off("click",".s-new-list").on("click",".s-new-list",function(){var b=a(this),c=b.attr("id"),d=0;c?b=c.replace("s-new-",""):(d=b.parents("li.dr:first").attr("id").split("-"),b=d[0],d=d[1]);a.product_list.createListDialog(b,d,
function(b,c){var d=a("#s-"+c+"-list"),e=d.find("ul:first");e.length||(d.prepend('<ul class="menu-v with-icons"><li class="drag-newposition" data-type="'+c+'"></li></ul>'),d.find(".drag-newposition").mouseover(),e=d.find("ul:first"));var f=parseInt(b.parent_id,10)||0,d=a.categories_tree.getHandlerByCategoryId(f),g=function(){if(f){var d=e.find("#"+c+"-"+b.parent_id);d.find(">.collapse-handler-ajax").length||(d.append('<ul class="menu-v with-icons dr"><li class="drag-newposition" data-type="'+c+'"></li></ul>'),
d.find(".drag-newposition").mouseover(),d.find(">a").before('<i class="icon16 darr overhanging collapse-handler-ajax" id="'+c+"-"+f+'-handler"></i>'),a.categories_tree.setExpanded(f));e=d.find("ul:first")}e.trigger("add",[b,c])};"category"==c?a.categories_tree.expand(d,function(){g()}):g()});return!1});a("#s-content").find(".sort").unbind("click").bind("click",function(){location.href=a(this).find("a").attr("href");return!1});var g=a("#s-embed-code");g.length&&g.inlineEditable({size:{width:g.width()+
4},afterMakeEditable:function(a){a.trigger("select")}});this.initEditingControls();this.initToolbar()}catch(h){a.shop.error("$.product_list.initView error: "+h.message,h)}},initEditingControls:function(){var b=a("#s-product-list-title");b.hasClass("editable")&&(b.inlineEditable({minSize:{width:350},maxSize:{width:600},size:{height:30},inputClass:"s-title-h1-edit",beforeMakeEditable:function(){a(".s-product-list-manage").hide()},afterBackReadable:function(b,c){a(".s-product-list-manage").show();if(!c.changed)return!1;
...
b=a("#s-product-list-delete");b.length&&("category"==c||"set"==c)&&b.unbind("click").bind("click",function(){a("#s-product-list-delete-dialog").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(){var b=a(this);b.find(".dialog-buttons i.loading").show();var e={hash:a.product_list.collection_hash.join("/")||"all",remove:["list"]};"1"==b.find("input[name=s-delete-products]:checked").val()&&e.remove.push("products");var f=function(){a.product_list.remove(e,
function(b){var d=a("#"+a.product_list.collection_hash.join("-")),e=d.prev(".drag-newposition"),f=a("#s-"+a.product_list.collection_hash[0]+"-list"),n=f.find("ul:first"),m;"set"==c?(d.remove(),e.remove()):(m=d.find("ul:first"),m.length&&(m.find(">li.drag-newposition:first").remove(),d.hide(),m.find(">li").each(function(){d.after(this)})),m=d.parents("ul:first"),d.remove(),e.remove(),m.find("li.dr").length||(n.get(0)!=m.get(0)?(m.parents("li:first").find("i.collapse-handler").remove(),m.closest("li").find(".collapse-handler-ajax:first").remove(),
m.remove()):n.closest(".block").find(".collapse-handler-ajax:first").remove()));n.find("li.dr:first").length?(n.show(),f.find(".s-empty-list").hide()):(n.hide(),f.find(".s-empty-list").show());a.product_list.sidebar.trigger("update",b.data.lists);b.data.old_parent_category&&("undefined"!==typeof b.data.old_parent_category.children_count&&!parseInt(b.data.old_parent_category.children_count,10))&&a("#category-"+b.data.old_parent_category.id+"-handler").remove();location.href="#/"})},b=a("#"+a.product_list.collection_hash.join("-")+
"-handler");b.length?a.categories_tree.expand(b,function(a){a.parent().find("ul:first").hide();f()}):f();return!1}});return!1})},initCategoryDescriptionWysiwygLoad:function(){var b=[];b.push("wa-content/js/elrte/elrte.min.js");b.push("wa-content/js/elrte/elrte-wa.js");"en"!=wa_lang&&b.push("wa-content/js/elrte/i18n/elrte."+wa_lang+".js");for(var c=0;c<b.length;c++)a.product_list.loadScript(b[c])},initCategoryDescriptionWysiwyg:function(b){var c=10;(function e(){try{a.product_list.cached["elrte-wa.js"]&&
a.product_list.cached["elrte.min.js"]?setTimeout(function(){var a=b.find(".field.description");a.find("i").hide();a.find(".s-editor-core-wrapper").show();waEditorInit({id:"s-category-description-content",prefix:"s-category-description-",upload_url:"",lang:wa_lang})},200):(c-=1,0<c&&(a.shop.trace("$.product_list.initCategoryDescriptionWysiwyg wait while js are loading"),setTimeout(function(){e()},500)))}catch(f){console.error(f.message),console.dir(f.trace)}})()},loadScript:function(b){var c=b.replace(/^.*\//,
""),d=10;a.product_list.cached[c]||a.ajax({url:wa_url+b,dataType:"script",cache:!0,complete:function(e,f){"success"==f?(a.product_list.cached[c]=!0,a.shop.trace("$.product_list.loadScript loaded",[c,b])):(a.shop.trace("$.product.list.loadScript error",[f,c]),d-=1,0<d&&setTimeout(function(){a.product_list.loadScript(b)},200))}})},initDragndrop:function(){a.product_dragndrop.init({products:!0,view:this.options.view}).bind("move_product",function(b){a.shop.jsonPost("?module=product&action=move&"+a.product_list.collection_param,
{product_ids:b.product_ids,before_id:b.before_id||null},b.success,b.error)}).bind("is_product_sortable",function(){return a.product_list.sortable}).bind("add_to_list",function(b){var c={};b.whole_list?c.hash=a.product_list.collection_hash.join("/")||"all":c.product_id=b.product_ids;a.shop.jsonPost("?module=product&action=addToList&"+b.collection_param,c,b.success,b.error)})},initToolbar:function(){var b=this.toolbar;b.find("li").unbind("click.product_list").bind("click.product_list",function(){var b=
a(this).attr("data-action");if(b){var c=a.product_list.getSelectedProducts("delete"!=b);if(!c.count)return alert($_("Please select at least one product")),!1;"new-set"!=b&&("category"==b?a.product_list.categoriesDialog(c):"set"==b?a.product_list.setsDialog(c):"type"==b?a.product_list.typesDialog(c):"assign-tags"==b?a.product_list.assignTagsDialog(c):"delete"==b?a.product_list.deleteProductsDialog(c):"delete-from-set"==b&&"set"==a.product_list.collection_hash[0]?a.product_list.deleteFromSet(c):"delete-from-category"==
b&&"category"==a.product_list.collection_hash[0]?a.product_list.deleteFromCategory(c):"export"==b&&a.product_list.exportProducts(c,a(this).attr("data-plugin")));return!1}});var c=a("#mainmenu").height(),d=b.find(":first").offset().top-c;a(document).bind("scroll",function(){a(this).scrollTop()>d?b.addClass("s-fixed").css({top:c}):b.removeClass("s-fixed")})},getSelectedProducts:function(b){b=b||!1;var c={count:0};if(this.container.find(".s-select-all").attr("checked")){var d=a.product_list.collection_hash.join("/")||
"all";b?c.serialized=[{name:"hash",value:d}]:c.hash=d;c.count=this.total_count}else b?c.serialized=a.product_list.container.find(".product.selected").map(function(){c.count+=1;return{name:"product_id[]",value:a(this).attr("data-product-id")}}).toArray():c.product_id=a.product_list.container.find(".product.selected").map(function(){c.count+=1;return a(this).attr("data-product-id")}).toArray();return c},categoriesDialog:function(b){var c=a("#s-categories"),d=this.sidebar,e=this.container;c.length&&
c.parent().remove();a("<div></div>").appendTo("body").load("?module=dialog&action=categories",function(){a("#s-categories").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){var c=a(this);c.find(".dialog-content h1 span").text("("+b.count+")").show();c.find(".dialog-buttons i.loading").hide();c.find("input[name=new_category_name]").val("");c.find("input[name=new_category]").attr("checked",!1)},onSubmit:function(c){var g=c.find("form");g.find(".dialog-buttons i.loading").show();a.shop.jsonPost(g.attr("action"),
g.serializeArray().concat(b.serialized),function(b){b.data.new_category&&a("#s-category-list ul:first").trigger("add",[b.data.new_category,"category","#/products/category_id="+b.data.new_category+"&view="+a.product_list.options.view]);b.data.categories&&(d.trigger("update",[{category:b.data.categories}]),e.find(".s-select-all:first").trigger("select",!1));g.find("input:checked").attr("checked",!1);c.trigger("close")});return!1}})})},setsDialog:function(b){var c=a("#s-sets"),d=this.sidebar,e=this.container;
c.length&&c.parent().remove();a("<div></div>").appendTo("body").load("?module=dialog&action=sets",function(){a("#s-sets").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){var c=a(this);c.find(".dialog-content h1 span").text("("+b.count+")").show();c.find(".dialog-buttons i.loading").hide();c.find("input[name=new_set_name]").val("");c.find("input[name=new_set]").attr("checked",!1)},onSubmit:function(c){var g=c.find("form");g.find(".dialog-buttons i.loading").show();a.shop.jsonPost(g.attr("action"),
g.serializeArray().concat(b.serialized),function(b){b.data.new_set&&a("#s-set-list ul:first").trigger("add",[b.data.new_set,"set","#/products/set_id="+b.data.new_set+"&view="+a.product_list.options.view]);b.data.sets&&(d.trigger("update",[{set:b.data.sets}]),e.find(".s-select-all:first").trigger("select",!1));g.find("input:checked").attr("checked",!1);c.trigger("close")});return!1}})})},assignTagsDialog:function(b){var c=a("#s-assign-tags");c.length&&c.remove();a.post("?module=dialog&action=assignTags",
...
a("#s-product-list-settings-dialog");p=b.length?b.parent():a("<div></div>").appendTo("body");p.load("?module=dialog&action=productListSettings&"+a.product_list.collection_param,function(){var b=a("#s-product-list-create-dialog");b.length&&(b.parent().remove(),b.remove());a("#s-product-list-settings-dialog").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a("#s-category-description-content").length&&((!a.product_list.cached["elrte-wa.js"]||!a.product_list.cached["elrte.min.js"])&&a.product_list.initCategoryDescriptionWysiwygLoad(),
a.product_list.initCategoryDescriptionWysiwyg(a(this)));a("#s-product-list-name").focus()},onSubmit:function(b){var c=a(this),f=function(c){var e=a.product_list.collection_hash,f=location.hash.replace(e[0]+"_id="+e[1],e[0]+"_id="+c.data.id),g=a("#"+e.join("-"));g.find(".name:first").html(c.data.name);"0"==c.data.status?g.children("a").addClass("gray"):"1"==c.data.status&&g.children("a").removeClass("gray");g.find(".id:first").html(c.data.id);g.attr("id",e[0]+"-"+c.data.id);g.find("a").attr("href",
f);location.hash!=f?location.hash=f:a.products.dispatch();b.trigger("close")},g=function(a){if(a&&a.errors){a=a.errors;for(var c in a)b.find("input[name="+c+"]").addClass("error").parent().find(".errormsg").text(a[c]);return!1}};a("#s-category-description-content").length&&waEditorUpdateSource({id:"s-category-description-content"});if(c.find("input:file").length)a.product_list._iframePost(c,f,g);else return a.shop.jsonPost(c.attr("action"),c.serialize(),f,g),!1}})})},createListDialog:function(b,c,
d){var e=a("#s-product-list-create-dialog");p=e.length?e.parent():a("<div></div>").appendTo("body");p.load("?module=dialog&action=productListCreate&type="+b+"&parent_id="+c,function(){var c=a("#s-product-list-settings-dialog");c.length&&(c.parent().remove(),c.remove());a("#s-product-list-create-dialog").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a("#s-category-description-content").length&&a.product_list.initCategoryDescriptionWysiwyg(a(this));a("#s-c-product-list-name").focus()},onSubmit:function(c){var e=
a(this),f=function(e){"function"===typeof d&&d(e.data,b);location.href="#/products/"+b+"_id="+e.data.id+"&view="+a.product_list.options.view;c.trigger("close")},j=function(a){if(a&&a.errors){a=a.errors;for(var b in a)c.find("input[name="+b+"]").addClass("error").parent().find(".errormsg").text(a[b]);return!1}};a("#s-category-description-content").length&&waEditorUpdateSource({id:"s-category-description-content"});if(e.find("input:file").length)a.product_list._iframePost(e,f,j);else return a.shop.jsonPost(e.attr("action"),
e.serialize(),f,j),!1}})})},exportProducts:function(a,c){for(var d=[],e,f=!1;e=a.serialized.pop();)e.name&&("product_id[]"==e.name?d.push(parseInt(e.value,10)):"hash"==e.name&&(f=e.value));e="?action=importexport#/"+c;f?window.location=e+("/hash/"+f):d.length&&(e+="/hash/id/"+d.join(","),window.location=e)},remove:function(b,c){var d={},e;b.product_id?e=function(){100>=b.product_id.length&&(d.get_lists=!0);d.product_id=b.product_id.splice(0,100);a.shop.jsonPost("?module=products&action=deleteList",
d,function(a){b.product_id.length?e():"function"===typeof c&&c(a)})}:(d.hash=b.hash||this.collection_hash.join("/")||"all",d.remove=a.isArray(b.remove)&&b.remove.length?b.remove:["list"],1==d.remove.length&&"list"==d.remove[0]?e=function(){a.shop.jsonPost("?module=products&action=deleteList",d,c)}:(d.count=100,e=function(){a.shop.jsonPost("?module=products&action=deleteList",d,function(a){0<a.data.rest_count&&null!=a.data.rest_count?e():"function"===typeof c&&c(a)})}));e()}}})(jQuery);
