...
d.state);var g=setTimeout(function(){if(d.stopped)clearTimeout(g);else{if(d.hash!==null){var a=location.hash.replace(/^[^#]*#\/*/,"").split("/")[0];if(d.hash.indexOf(a)===-1){clearTimeout(g);return}}if(d.loading)g=setTimeout(arguments.callee,350);else{h(f,e);if(h(f,e)<=d.distance){d.load();g=setTimeout(arguments.callee,350)}else{e.get(0).onscroll=c;clearTimeout(g)}}}},350),h="function"===typeof d.distanceBetweenBottoms?d.distanceBetweenBottoms:function(b,c,e){b=typeof b==="string"?a(b):b;return b.position().top+
b.outerHeight()-(e||0)-(c.scrollTop()+c.height())}}}})(jQuery);$.fn.liveDraggable=function(a){this.each(function(){var a=$(this);a.data("init_draggable")&&a.die("mouseover",a.data("init_draggable"))});this.die("mouseover").live("mouseover",function(){var b=$(this);b.data("init_draggable")||b.data("init_draggable",arguments.callee).draggable(a)})};
...
f;++b)d=i.makeReadableBy[b],"blur"==d&&c.blur(function(){o!="read"&&h.call(this)}),"enter"==d&&g.push(13),"esc"==d&&g.push(27);b=0;for(f=i.updateBy.length;b<f;++b)d=i.updateBy[b],"alt+enter"==d&&k.push({ctrl:!1,alt:!0,shift:!1,key:13}),"ctrl+enter"==d&&k.push({ctrl:!0,alt:!1,shift:!1,key:13}),"ctrl+s"==d&&k.push({ctrl:!0,alt:!1,shift:!1,key:17});g.length&&c.keydown(function(a){~g.indexOf(a.keyCode)&&!a.ctrlKey&&!a.altKey&&!a.shiftKey&&o!="read"&&h.call(this,a.keyCode==27?q:null);if(k.length)for(var b in k){var c=
k[b];if(a.keyCode==c.key&&a.ctrlKey==c.ctrl&&a.altKey==c.alt&&a.shiftKey==c.shift){n.trigger("readable");break}}});n.unbind("readable.inlineEditable").bind("readable.inlineEditable",function(b,c){if(o!="read"){var d=a("#"+(this.id+"-input"));h.call(d,d.val(),c)}});l=!0}i.afterMakeEditable.call(this,c)}function h(b,c){c="undefined"===typeof c?!1:!0;void 0!=b&&null!=b?a(this).val(b):b=a(this).val();if(!(!1===c&&!1===i.beforeBackReadable.call(n.get(0),this,{changed:b!=q,old_text:q,new_text:b}))){o="read";
...
"delete"==b?a.product_list.deleteProductsDialog(c):"delete-from-set"==b&&"set"==a.product_list.collection_hash[0]?a.product_list.deleteFromSet(c):"delete-from-category"==b&&"category"==a.product_list.collection_hash[0]?a.product_list.deleteFromCategory(c):"export"==b?a.product_list.exportProducts(c,a(this).attr("data-plugin")):"duplicate"==b&&a.product_list.duplicateProducts(c,a(this)));return!1}});var c=a("#mainmenu").height(),d=b.find(":first").offset().top-c,e=a(window),f=a(document),g;f.bind("scroll",
g=function(){f.scrollTop()>d&&b.height()+c<e.height()?b.addClass("s-fixed").css({top:c}):b.removeClass("s-fixed")});e.bind("resize",g)},getSelectedProducts:function(b){var b=b||!1,c={count:0};if(this.container.find(".s-select-all:first").attr("checked")){var d=a.product_list.collection_hash.join("/")||"all";b?c.serialized=[{name:"hash",value:d}]:c.hash=d;c.count=this.total_count}else b?c.serialized=a.product_list.container.find(".product.selected").map(function(){c.count+=1;return{name:"product_id[]",
value:a(this).attr("data-product-id")}}).toArray():c.product_id=a.product_list.container.find(".product.selected").map(function(){c.count+=1;return a(this).attr("data-product-id")}).toArray();return c},categoriesDialog:function(b){var c=a("#s-categories"),d=this.sidebar,e=this.container;c.length&&c.parent().remove();a("<div></div>").appendTo("body").load("?module=dialog&action=categories",function(){a("#s-categories").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){var c=a(this);c.find(".dialog-content h1 span").text("("+
b.count+")").show();c.find(".dialog-buttons i.loading").hide();c.find("input[name=new_category_name]").val("");c.find("input[name=new_category]").attr("checked",!1)},onSubmit:function(c){var g=c.find("form");g.find(".dialog-buttons i.loading").show();a.shop.jsonPost(g.attr("action"),g.serializeArray().concat(b.serialized),function(b){b.data.new_category&&a("#s-category-list ul:first").trigger("add",[b.data.new_category,"category","#/products/category_id="+b.data.new_category+"&view="+a.product_list.options.view]);
b.data.categories&&(d.trigger("update",[{category:b.data.categories}]),e.find(".s-select-all:first").trigger("select",!1));g.find("input:checked").attr("checked",!1);c.trigger("close")});return!1}})})},setsDialog:function(b){var c=a("#s-sets"),d=this.sidebar,e=this.container;c.length&&c.parent().remove();a("<div></div>").appendTo("body").load("?module=dialog&action=sets",function(){a("#s-sets").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){var c=a(this);c.find(".dialog-content h1 span").text("("+
b.count+")").show();c.find(".dialog-buttons i.loading").hide();c.find("input[name=new_set_name]").val("");c.find("input[name=new_set]").attr("checked",!1)},onSubmit:function(c){var g=c.find("form");g.find(".dialog-buttons i.loading").show();a.shop.jsonPost(g.attr("action"),g.serializeArray().concat(b.serialized),function(b){b.data.new_set&&a("#s-set-list ul:first").trigger("add",[b.data.new_set,"set","#/products/set_id="+b.data.new_set+"&view="+a.product_list.options.view]);b.data.sets&&(d.trigger("update",
[{set:b.data.sets}]),e.find(".s-select-all:first").trigger("select",!1));g.find("input:checked").attr("checked",!1);c.trigger("close")});return!1}})})},assignTagsDialog:function(b){var c=a("#s-assign-tags");c.length&&c.remove();a.post("?module=dialog&action=assignTags",b.serialized,function(c){a("body").append(c);a("#s-assign-tags").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){var c=a(this);c.find(".dialog-content h1 span").text("("+b.count+")").show();c.find(".dialog-buttons i.loading").hide()},
onSubmit:function(c){var d=a(this),g=d.find("#s-assign-tags-list_tag");if(g.length){var h=jQuery.Event("keypress",{which:13});g.trigger(h)}d.find(".dialog-buttons i.loading").show();var j=d.attr("action");setTimeout(function(){var g=d.serializeArray().concat(b.serialized);a.shop.jsonPost(j,g,function(b){b.data.cloud&&a("#s-tag-cloud").trigger("update",[b.data.cloud]);c.trigger("close");a.products.dispatch()},function(){c.trigger("close")})},10);return!1}})})},typesDialog:function(b){var c=a("#s-types"),
d=this.container,e=this.sidebar,f=function(){a("#s-types").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(c){var f=a(this);f.find(".dialog-buttons i.loading").show();a.shop.jsonPost(f.attr("action"),f.serializeArray().concat(b.serialized),function(b){e.trigger("update",{type:b.data.types});d.find(".s-select-all:first").trigger("select",!1);f.find("input:checked").attr("checked",!1);c.trigger("close");a.products.dispatch()});
return!1}})},g=c.parent();c.length?f():(g=a("<div></div>").appendTo("body"),g.load("?module=dialog&action=types",f))},deleteFromSet:function(b){0<b.count&&a.shop.jsonPost("?module=products&action=deleteFromSet&id="+this.collection_hash[1],b.serialized,function(){a.products.dispatch()})},deleteFromCategory:function(b){0<b.count&&a.shop.jsonPost("?module=products&action=deleteFromCategory&id="+this.collection_hash[1],b.serialized,function(){a.products.dispatch()})},deleteProductsDialog:function(b){var c=
a("#s-product-list-delete-products-dialog"),d=c.parent();c.length||(d=a("<div></div>").appendTo("body"));d.load("?module=dialog&action=productsDelete&count="+b.count,function(){a("#s-product-list-delete-products-dialog").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(c){a(this).find(".dialog-buttons i.loading").show();a.product_list.remove(a.extend(b,{remove:["products"]}),function(b){a.product_list.sidebar.trigger("update",
b.data.lists);a.products.dispatch();c.trigger("close")});return!1}})})},settingsListDialog:function(){var b=a("#s-product-list-settings-dialog");(b.length?b.parent():a("<div></div>").appendTo("body")).load("?module=dialog&action=productListSettings&"+a.product_list.collection_param,function(){var b=a("#s-product-list-create-dialog");b.length&&(b.parent().remove(),b.remove());a("#s-product-list-settings-dialog").waDialog({esc:!1,disableButtonsOnSubmit:!0,onLoad:function(){a("#s-category-description-content").length&&
a.product_sidebar.initCategoryDescriptionWysiwyg(a(this));setTimeout(function(){a("#s-product-list-name").focus()},50)},onSubmit:function(b){var c=a(this),f=function(c){var e=a.product_list.collection_hash,f=location.hash.replace(e[0]+"_id="+e[1],e[0]+"_id="+c.data.id),g=a("#"+e.join("-"));g.find(".name:first").html(c.data.name);a.isArray(c.data.routes)&&c.data.routes.length?g.find(".routes:first").html(" "+c.data.routes.join(" ")):g.find(".routes:first").html(" ");c.data.status=="0"?g.children("a").addClass("gray"):
c.data.status=="1"&&g.children("a").removeClass("gray");g.find(".id:first").html(c.data.id);g.attr("id",e[0]+"-"+c.data.id);g.find("a").attr("href",f);location.hash!=f?location.hash=f:a.products.dispatch();b.trigger("close")},g=function(a){if(a&&a.errors){var a=a.errors,c;for(c in a)b.find("input[name="+c+"]").addClass("error").parent().find(".errormsg").text(a[c]);return false}};a("#s-category-description-content").length&&a("#s-category-description-content").waEditor("sync");if(c.find("input:file").length)a.products._iframePost(c,
f,g);else{a.shop.jsonPost(c.attr("action"),c.serialize(),f,g);return false}}})})},exportProducts:function(a,c){for(var d=[],e,f=!1;e=a.serialized.pop();)e.name&&("product_id[]"==e.name?d.push(parseInt(e.value,10)):"hash"==e.name&&(f=e.value));e="?action=importexport#/"+c;f?window.location=e+("/hash/"+f):d.length&&(e+="/hash/id/"+d.join(","),window.location=e)},duplicateProducts:function(b,c){for(var d=[],e,f=!1;e=b.serialized.pop();)e.name&&("product_id[]"==e.name?d.push(parseInt(e.value,10)):"hash"==
e.name&&(f=e.value));!f&&d.length&&(f="id/"+d.join(","));f&&(c.find("i.icon16").removeClass("split").addClass("loading"),this.duplicate(f,{progress:function(a){c.attr("title",Math.round(100*a.offset/a.total_count)+"%")},finish:function(){c.attr("title",null);var b=c.find("i.icon16");b.removeClass("loading").addClass("yes");setTimeout(function(){b.removeClass("yes").addClass("split")},3E3);a.products.dispatch()},error:function(){}}))},duplicate:function(b,c){var d=this;a.shop.jsonPost("?module=products&action=duplicate",
{hash:b,limit:50,offset:c.offset||0},function(a){if("ok"==(a.status||"error"))a.data.offset<a.data.total_count?(c.offset=a.data.offset,d.duplicate(b,c),c.progress(a.data||{})):c.finish(a.data||{})})},remove:function(b,c){var d={},e;b.product_id?e=function(){100>=b.product_id.length&&(d.get_lists=!0);d.product_id=b.product_id.splice(0,100);a.shop.jsonPost("?module=products&action=deleteList",d,function(a){b.product_id.length?e():typeof c==="function"&&c(a)})}:(d.hash=b.hash||this.collection_hash.join("/")||
"all",d.remove=a.isArray(b.remove)&&b.remove.length?b.remove:["list"],1==d.remove.length&&"list"==d.remove[0]?e=function(){a.shop.jsonPost("?module=products&action=deleteList",d,c)}:(d.count=100,e=function(){a.shop.jsonPost("?module=products&action=deleteList",d,function(a){0<a.data.rest_count&&null!=a.data.rest_count?e():"function"===typeof c&&c(a)})}));e()}}})(jQuery);
