...
null===e.hash||a.isArray(e.hash)||(e.hash=[e.hash]);a.fn.lazyLoad.call(f,e.state);(function(){var k,m=setTimeout(k=function(){if(e.stopped)clearTimeout(m);else{if(null!==e.hash){var l=location.hash.replace(/^[^#]*#\/*/,"").split("/")[0];if(-1===e.hash.indexOf(l)){clearTimeout(m);return}}e.loading?m=setTimeout(k,350):(h(g,f),h(g,f)<=e.distance?(e.load(),m=setTimeout(k,350)):(f.get(0).onscroll=d,clearTimeout(m)))}},350)})();var h="function"===typeof e.distanceBetweenBottoms?e.distanceBetweenBottoms:
function(k,m,l){k="string"===typeof k?a(k):k;l=l||0;return k.position().top+k.outerHeight()-l-(m.scrollTop()+m.height())}}}})(jQuery);$.fn.liveDraggable=function(a){this.each(function(c,d){c=$(this);c.data("init_draggable")&&c.off("mouseover",c.data("init_draggable"))});var b;this.off("mouseover").on("mouseover",b=function(){var c=$(this);c.data("init_draggable")||c.data("init_draggable",b).draggable(a)})};
$.fn.liveDroppable=function(a){this.each(function(c,d){c=$(this);c.data("init_droppable")&&c.off("mouseover",c.data("init_droppable"))});var b=function(){var c=$(this);c.data("init_droppable")||(c.data("init_droppable",b).droppable(a),c.mouseover())};b.call(this);this.off("mouseover",b).on("mouseover",b)};(function(a){a.fn.inlineEditable=function(b,c){function d(){k(a(this))||a(this).addClass(l.placeholderClass).text(l.placeholder)}function e(){p="edit";this.id=this.id||(""+Math.random()).slice(2);var q=this.id+"-input",u=a("#"+q);if(!u.length){var r=n,v=r.after;a:switch(l.inputType){case "textarea":var w='<textarea id="'+q+'" style="display:none;"></textarea>';break a;default:w='<input type="text" id="'+q+'" style="display:none;">'}v.call(r,w);u=a("#"+q)}u.addClass(l.inputClass);g(u,n);l.placeholder&&
k(a(this))==l.placeholder&&k(a(n))==l.placeholder&&a(n).text("").removeClass(l.placeholderClass);l.beforeMakeEditable.call(this,u);t=l.truncate?n.data("real_text"):k(n);u.val(t).show().focus();n.hide();a(l.editLink).hide();if(!m){q=[];var y=[];r=0;for(v=l.makeReadableBy.length;r<v;++r)w=l.makeReadableBy[r],"blur"==w&&u.blur(function(){"read"!=p&&f.call(this)}),"enter"==w&&q.push(13),"esc"==w&&q.push(27);r=0;for(v=l.updateBy.length;r<v;++r)w=l.updateBy[r],"alt+enter"==w&&y.push({ctrl:!1,alt:!0,shift:!1,
key:13}),"ctrl+enter"==w&&y.push({ctrl:!0,alt:!1,shift:!1,key:13}),"ctrl+s"==w&&y.push({ctrl:!0,alt:!1,shift:!1,key:17});q.length&&function(A){u.keydown(function(x){!~A.indexOf(x.keyCode)||x.ctrlKey||x.altKey||x.shiftKey||"read"!=p&&f.call(this,27==x.keyCode?t:null);if(y.length)for(var z in y){var B=y[z];if(x.keyCode==B.key&&x.ctrlKey==B.ctrl&&x.altKey==B.alt&&x.shiftKey==B.shift){n.trigger("readable");break}}})}(q);n.unbind("readable.inlineEditable").bind("readable.inlineEditable",function(A,x){"read"!=
p&&(A=a("#"+(this.id+"-input")),f.call(A,A.val(),x))});m=!0}l.afterMakeEditable.call(this,u)}function f(q,u){u="undefined"===typeof u?!1:!0;void 0!=q&&null!=q?a(this).val(q):q=a(this).val();if(!1!==u||!1!==l.beforeBackReadable.call(n.get(0),this,{changed:q!=t,old_text:t,new_text:q})){p="read";var r;(r=!l.placeholder)||(a(this).val()?r=!1:(a(n).text(l.placeholder).addClass(l.placeholderClass),r=!0),r=!r);if(r&&(l.allowEmpty||q)){if(l.truncate)n.data("real_text",q),n.text(q.length<l.truncate-3?q:q.substr(0,
l.truncate-3)+"...");else{r=n;var v=q;l.html?r.html(v):r.text(v)}q||d.call(this)}n.show();a(this).hide();a(l.editLink).show();!1===u&&l.afterBackReadable.call(n.get(0),this,{changed:q!=t,old_text:t})}}function g(q,u){var r=l.size.height||u.height();u=l.size.width||1.5*u.width();r=l.minSize.height&&r<l.minSize.height?l.minSize.height:r;u=l.minSize.width&&u<l.minSize.width?l.minSize.width:u;r=l.maxSize.height&&r>l.maxSize.height?l.maxSize.height:r;u=l.maxSize.width&&u>l.maxSize.width?l.maxSize.width:
u;q.height(r);q.width(u)}function h(q){return function(){return q}}function k(q){return l.html?q.html():q.text()}if(this.length){var m=!1;if("string"==typeof b){if("setOption"==b){var l=this.data("inlineEditableSettings")||{};a.extend(!0,l,c);"undefined"!==typeof c.hold&&"function"!==typeof c.hold&&(l.hold=h(l.hold));this.data("inlineEditableSettings",l)}return this}c=this.data("inlineEditableSettings");this.data("inlineEditableSettings",a.extend({inputType:"text",inputClass:"",size:{height:null,
width:null},minSize:{height:null,width:null},maxSize:{height:null,width:null},editLink:null,editOnItself:!0,placeholder:null,makeReadableBy:["blur","enter","esc"],updateBy:["ctrl+enter","alt+enter"],beforeBackReadable:function(){},afterBackReadable:function(){},beforeMakeEditable:function(){},afterMakeEditable:function(){},placeholderClass:"hint",truncate:!1,hold:!1,html:!1,allowEmpty:!1},c,b||{}));l=this.data("inlineEditableSettings")||{};var n=this,p="read",t="";"function"!==typeof l.hold&&(l.hold=
h(l.hold));(function(){if(!this.data("inited")){l.truncate&&"boolean"==typeof l.truncate&&(l.truncate=255);if(l.truncate){var q=l.placeholder&&l.placeholder===this.text()?"":this.text();this.data("real_text",q);this.text(q.length<l.truncate-3?q:q.substr(0,l.truncate-3)+"...")}l.placeholder&&d.call(this);l.editLink&&a(l.editLink).unbind("click.inlineEditable").bind("click.inlineEditable",function(){l.hold.call(n)||"edit"!=p&&e.call(n.get(0))});l.editOnItself&&this.unbind("click.inlineEditable").bind("click.inlineEditable",
function(){l.hold.call(n)||"edit"!=p&&e.call(this)});this.unbind("editable.inlineEditable").bind("editable.inlineEditable",function(){l.hold.call(n)||"edit"!=p&&e.call(this)});this.unbind("placeholder.inlineEditable").bind("placeholder.inlineEditable",function(u,r){r&&l.placeholder&&d.call(this);r||a(this).removeClass(l.placeholderClass)});this.data("inited",!0)}}).call(this);return this}}})(jQuery);(function(a){a.fn.photoStreamSlider=function(b){function c(){function f(r){function v(){f.execution=!1;var B="on"+w.charAt(0).toUpperCase()+w.slice(1);B=d[B];"function"==typeof B&&B.call(e);B=r.fn;"function"==typeof B&&B.call(e)}"string"==typeof r&&(r={direction:r,animate:!0});var w=r.direction||"forward",y=r.steps||h.length;if(!f.execution){f.execution=!0;var A=h.filter(":first").outerWidth()*y,x=h.length;if("forward"==w){var z=h.filter(":last").nextAll(":lt("+y+")");y=z.length;z=z.filter(":last");
y&&(h.removeClass("visible"),z.prevAll(":lt("+(x-1)+")").addClass("visible"),z.addClass("visible"))}else z=h.filter(":first").prevAll(":lt("+y+")"),y=z.length,z=z.filter(":last"),y&&(h.removeClass("visible"),z.nextAll(":lt("+(x-1)+")").addClass("visible").show(),z.addClass("visible"));h=a("li.visible",g);x=g.position().left;"forward"==w?(y=l-m-t,x-=A,x=x>-y?x:-y):(x+=A,x=x<t?x:t);r.animate?g.animate({left:x},d.duration,v):(g.css({left:x}),v())}}var g=e.find(d.photoStream),h=a("li.visible",g),k=a("li",
g),m=h.filter(":first").outerWidth()*h.length,l=k.filter(":first").outerWidth()*k.length,n=d.height||k.filter(":first").outerHeight();g.parent().css({overflow:"hidden",height:n,position:"relative",padding:"4px 0",margin:0,width:m});n=g.find("li:first");var p=h.filter(":first"),t=(p.outerWidth()-p.width())/2,q=0,u=n.outerWidth();for(p=p.get(0);n.length&&n.get(0)!=p;)q+=u,n=n.next();g.css({position:"absolute",left:-(q-t),width:l});a(d.forwardLink).unbind("click").bind("click",function(){f("forward");
return!1});a(d.backwardLink).unbind("click").bind("click",function(){f("backward");return!1});e.unbind("append prepend").bind("append prepend",function(r,v){if("append"==r.type){for(var w=g.find("li:last"),y=a();w.hasClass("dummy");)y=y.add(w),w=w.prev("li");y.remove();g.append(v)}else{w=a("<div></div>").html(v);v=w.find("li");var A=v.length*u;w.remove();w=g.find("li:first");for(y=a();w.hasClass("dummy");)y=y.add(w),w=w.next("li");y.remove();g.prepend(v)}k=g.find("li");l=k.filter(":first").outerWidth()*
k.length;g.css("width",l);"prepend"==r.type&&(g.is(":animated")&&g.stop(!1,!0),g.css("left",parseInt(g.css("left"))-A));g.find("li.selected").hasClass("visible")&&e.trigger("home",[null,!1])});e.unbind("forward backward").bind("forward backward",function(r,v){f({direction:r.type,steps:v.steps,animate:"undefined"!==typeof v.animate?v.animate:!0,fn:v.fn});v=g.find("li.selected");r="forward"==r.type?v.next("li:not(.dummy)"):v.prev("li:not(.dummy)");r.length&&(v.removeClass("selected"),r.addClass("selected"))});
e.unbind("home").bind("home",function(r,v,w){r=parseInt(h.length/2);r=h.filter(":eq("+r+")");var y=r.nextAll(".selected:first"),A=r.prevAll(".selected:first"),x=0,z="";"function"!==typeof v&&(w=v);w="undefined"!==typeof w?w:!0;y.length?(z="forward",r.nextAll().each(function(){++x;if(a(this).hasClass("selected"))return!1})):A.length&&(z="backward",r.prevAll().each(function(){++x;if(a(this).hasClass("selected"))return!1}));z&&x?f({direction:z,steps:x,fn:v,animate:w}):"function"==typeof v&&v();return!1});
...
d=f.attr("data-type");if(d!=e.attr("data-type"))return!1;c=function(q){q=q.split("-");q.shift();return q.join("-")};var g=c(f.attr("id")),h=e.prev("li"),k=f.next(),m=f.prev();if(h.length&&h.attr("id")=="category-"+g&&!h.hasClass("dr-helper")||this==f.next().get(0))return!1;var l=f.parent("ul"),n=l.children("li.dr[id!=category-"+g+"]").length,p=parseInt(c(l.parent().attr("id")),10)||0;e.after(k).after(f);e=f.parent().parent();if(e.is("li.dr")||e.is(".s-collection-list")){var t=0;e.is(".s-collection-list")||
(t=parseInt(c(e.attr("id")),10)||0);e=f.nextAll("li.dr:first");h=null;e.length&&(h=c(e.attr("id"))||null);n||p===t||(l.parent("li").children("i").hide(),l.hide());a.product_dragndrop.trigger("move_list",{id:g,type:d,before_id:h,parent_id:t,success:function(q){n||p===t||(l.parent("li").children("i").remove(),l.remove(),a.categories_tree.setCollapsed(p))},error:function(q){q&&console&&console.log("undefined"!==typeof q.errors?q.errors:q);m.after(f.next()).after(f);n||l.show()}})}}})},initDropInsideCollections:function(){a(".s-collection-list li.dr a").liveDroppable({tolerance:"pointer",
...
d.helper.find("span").show().end().find("i").hide(),!1;if(!e.hasClass("dynamic")&&c.hasClass("dynamic"))return d.helper.find("i.no-bw").show(),!1;d.helper.find("i.no-bw").hide();var g='.dr[id!="'+e.attr("id")+'"]',h=a(),k=function(l,n){if(!n.length)return l;l=l.add(n.nextUntil(g).filter("li.drag-newposition"));return 0<n.nextAll(g).length?l:k(l,n.parent().closest("li"))};d=c.prevAll(g+":first");0<d.length?(e=d.find(g),h=0<e.length?k(h,e.last()):k(h,d)):h=h.add(c.prevUntil(g).filter("li.drag-newposition"));
h=0<c.children("ul").children(g).length?h.add(c.children("ul").children("li.drag-newposition:first")):k(h,c);var m=a(".drag-newposition:animated, .drag-newposition.dragging").not(h);m.stop().animate({height:"2px"},300,null,function(){m.removeClass("dragging")});h.stop().animate({height:"10px"},300,null,function(){h.addClass("dragging")})},drop:function(c,d){var e=d.draggable,f=a(this).parent();c=e.attr("data-type");if(!e.hasClass("product")&&("set"==c||f.attr("id")==e.attr("id")||c!=f.attr("data-type")))return!1;
f.removeClass("drag-newparent");if(e.hasClass("product")){if(f.hasClass("dynamic"))return!1;var g=a("#product-list"),h={};if(g.find(".s-select-all").is(":checked"))h.whole_list=!0;else{var k=g.find(".product.selected");h.product_ids=k.map(function(){return a(this).attr("data-product-id")}).toArray()}a.product_dragndrop.trigger("add_to_list",a.extend(h,{collection_param:f.attr("id").replace("-","_id="),success:function(v){h.whole_list?g.find(".s-select-all").trigger("select",!1):h.product_ids&&h.product_ids.length&&
k.trigger("select",!1);v.data&&(f.find(">.counters .count:not(.subtree)").text(v.data.count),f.find(">.counters .subtree").text(v.data.total_count))}}));return!1}if(!e.hasClass("dynamic")&&f.hasClass("dynamic"))return!1;d=e.attr("id").split("-")[1];if(f.attr("id")=="category-"+d)return!1;if(e.hasClass("product"))return a("#product-list").find(".product.selected").trigger("select",!1),!1;var m=parseInt(f.attr("id").split("-")[1],10)||0,l=null,n=e.next(),p=e.prev(),t=!1;f.hasClass("drag-newposition")?
l=f.parent("ul"):f.children("ul").length?l=f.children("ul"):f.find(">i.collapse-handler-ajax").length||(l=a('<ul class="menu-v with-icons dr unapproved"><li class="drag-newposition unapproved" data-type="'+c+'"></li></ul>').appendTo(f),l.find(".drag-newposition").mouseover(),a('<i class="icon16 darr overhanging collapse-handler-ajax unapproved" id="'+c+"-"+m+'-handler"></i>').insertBefore(f.children("a")),t=!0);var q=e.parent("ul"),u=q.children("li.dr[id!=category-"+d+"]").length,r=parseInt(q.parent().attr("id").split("-")[1],
10)||0;l&&l.append(e).append(n);u||r===m||(q.parent("li").children("i").hide(),q.hide());f.is("li.dr")&&a.product_dragndrop.trigger("move_list",{id:d,type:c,parent_id:m,success:function(v){u||r===m||(q.parent("li").children("i").remove(),q.remove(),a.categories_tree.setCollapsed(r));l?(a(".s-collection-list .unapproved").removeClass("unapproved"),t?a.categories_tree.setExpanded(m):f.trigger("count_subtree")):(e.remove(),n.remove(),f.trigger("update_counters",v.data.count||{}))},error:function(v){v&&
console&&console.log("undefined"!==typeof v.errors?v.errors:v);p.after(e).after(n);u||q.show();a(".s-collection-list .unapproved").remove()}})}})},_scrolHelper:function(c){c=a("#products-helper");var d=c.data("scrollTop"),e=a(document).scrollTop();d=d?e-d:50;c.css("top",c.position().top+d+"px");c.data("scrollTop",e)},_extDragActivate:function(c,d,e){var f=e+"-last";if(d.hasClass("last")){var g=c.pageX;c=c.pageY;var h=d.width(),k=d.height(),m=d.offset();"thumbs"==a.product_dragndrop.options.view?g>
m.left+.5*h&&g<=m.left+h?(d.removeClass(e).addClass(f),a.product_dragndrop._shiftToLeft(d)):g>m.left&&g<=m.left+.5*h?(d.removeClass(f).addClass(e),a.product_dragndrop._shiftToRight(d)):a.product_dragndrop._shiftAtPlace(d):"table"==a.product_dragndrop.options.view&&(c>m.top+.5*k?d.removeClass(e).addClass(f):c>m.top&&d.removeClass(f).addClass(e));(c<m.top||c>m.top+k||g<m.left||g>m.left+h)&&d.removeClass(e).removeClass(f)}else d.addClass("drag-active")},_bindExtDragActivate:function(c,d){a(document).bind("mousemove.ext_drag_activate",
...
200);c.data("shifted","left")}},_shiftToRight:function(c){if("right"!==c.data("shifted")){var d=c.find(".p-wrapper");if(!d.length){var e=c.children();d=a("<div class='p-wrapper' style='position:relative;'></div>").appendTo(c);d.append(e)}d.stop().animate({left:15},200);c.data("shifted","right")}},_shiftAtPlace:function(c){if(c.data("shifted")){var d=c.find(".p-wrapper");if(d.length){var e=d.children();d.stop().css({left:0});c.append(e);d.remove()}c.data("shifted","")}}}})(jQuery);(function(a){var b=function(h){var k=/^category-(.*?)-handler$/;return k.test(h.attr("id"))?h.attr("id").replace(k,function(m,l){return parseInt(l,10)||0}):0},c=function(h){if(b(h))h=h.parents("li:not(.drag-newposition):first"),m=k=h.find("ul:first");else{h=h.parent();var k=h.next(),m=k.find("ul:first")}return{parent:h,target:k,ul:m}},d=function(h,k){var m=c(h);"category"==m.parent.attr("data-type")&&m.parent.trigger("count_subtree",!1);h.removeClass("rarr").addClass("darr");m.target.show();"function"===
typeof k&&k(h)},e=function(h,k){var m=h.parent.find(".loading:first");h=h.parent.find(".counters");k?(m.show(),h.hide()):(m.hide(),h.show())},f=function(h,k){var m=c(h);"category"!=m.parent.attr("data-type")||m.parent.hasClass("dynamic")||m.parent.trigger("count_subtree",!0);h.removeClass("darr").addClass("rarr");m.target.hide();"function"===typeof k&&k(h);a.get("?action=categoryExpand&id="+b(h)+"&collapsed=1")},g=function(h,k,m){if(!h.data("loading_content")){var l=c(h);l.ul.length?d(h,k):e(l,!0);
var n=!l.ul.length;h.data("loading_content",n);a.get("?action=categoryExpand&id="+b(h)+(n?"&tree=1":""),function(p){n&&(l.target.length?l.target.append(p):l.parent.append(p),e(l,!1),d(h,k),h.data("loading_content",!1));"function"===typeof m&&m()})}};a.categories_tree={init:function(){a("#s-category-list-block").off("click",".collapse-handler-ajax").on("click",".collapse-handler-ajax",function(){var h=a(this);h.hasClass("darr")?f(h):g(h)});a("#s-category-list-block .heading").off("click").click(function(h){var k=
a(this).find(".collapse-handler-ajax");k.is(h.target)||k.click()})},collapse:function(h,k){h=a(h);h.hasClass("darr")?f(h,k):"function"===typeof k&&k(h)},expand:function(h,k,m){h=a(h);h.hasClass("rarr")?g(h,k,m):("function"===typeof k&&k(h),"function"===typeof m&&m(h))},isCollapsed:function(h){return a(h).hasClass("rarr")},setExpanded:function(h){a.get("?action=categoryExpand&id="+h)},setCollapsed:function(h){a.get("?action=categoryExpand&id="+h+"&collapsed=1")},getHandlerByCategoryId:function(h){a();
...
d.error("Unknown list type")});b.off("add",".s-collection-list ul").on("add",".s-collection-list ul",function(d,e,f,g){d=a(this);var h=d.parents(".s-collection-list:first"),k=a("<ul></ul>");k.append(tmpl("template-sidebar-list-item",{type:f,item:e}));e=k.children(":not(.drag-newposition):first");f=e.attr("id");f=d.find("#"+f);var m=k.children();f.length?g&&f.replaceWith(e):d.prepend(m).show();m.each(function(){var l=a(this);l.hasClass("dr")?l.find("a").mouseover():l.mouseover()});d.find(".drag-newposition").css({height:"2px"}).removeClass("dragging");
...
c,d)},100),!1;if(this.path.tab&&(k="editTab"+this.path.tab.substr(0,1).toUpperCase()+this.path.tab.substr(1)+"Save",!1===this.call(k)))return!1;e.ajax.save=!0;a("#s-product-description-content").length&&a("#s-product-description-content").waEditor("sync");f.find(".s-price").find("input").each(function(){this.value=this.value.replace(/\s+/g,"")});a.shop.trace("$.product.saveData(mode="+b+", tab="+c+")");k=a("#product-tags_tag");k.length&&(g=jQuery.Event("keypress",{which:13}),k.trigger(g));a(f).find(':input[name^="product\\["]:not(:disabled)').each(function(){var m=
a(this).attr("type");if("text"!=m&&"textarea"!=m)return!0;this.defaultValue==this.value?a(this).attr("disabled",!0).addClass("js-ajax-disabled"):a(this).hasClass("js-ajax-disabled")&&a(this).removeAttr("disabled").removeClass("js-ajax-disabled")});this.refresh("submit");this.clearValidateErrors();a.ajax({url:a(f).attr("action"),data:a(f).serializeArray(),dataType:"json",type:"post",success:function(m){if("fail"==m.status)e.showValidateErrors(m.errors)||e.refresh("error",m.errors);else if(m.data.redirect)a.shop.trace("$.product.saveData redirect",
m.data.redirect),window.location.href=m.data.redirect;else{e.refresh("success",m.data.message||"");a.shop.trace("$.product.saveData updateData",[b,c]);e.updateData(m.data,b,c);d&&"function"==typeof d&&d();if(e.path.tab&&(m="editTab"+e.path.tab.substr(0,1).toUpperCase()+e.path.tab.substr(1)+"Saved",!1===e.call(m)))return!1;a.each(e.standalone_tabs,function(l,n){e.path.tab!=n&&(l="editTab"+n.substr(0,1).toUpperCase()+n.substr(1)+"Saved",e.call(l))})}e.ajax.save=!1},error:function(m,l,n){e.ajax.save=
!1;e.refresh("error",l)}});return!1},showValidateErrors:function(b){b=b||{};if(a.isEmptyObject(b))return!1;var c=this,d=!1,e=c.$edit_forms;if(b.features&&b.features.gtin){var f=e.find(".s-product-form.features").find('input[name="product[features][gtin]"]');if(f.length){f.addClass("error js-validate-error-input");var g=a('<div class="errormsg js-validate-error-msg"></div>').text(b.features.gtin);f.after(g);d=!0;c.refresh("error",$_("Cannot save the value of the \u201cGTIN\u201d feature for this product."))}}if(b.skus){var h=
e.find(".s-product-form.main table.s-product-skus tbody");a.each(b.skus,function(k,m){"status"===k?(d=!0,c.refresh("error",$_(m))):m.features&&m.features.gtin&&(k=h.find('.js-sku-settings[data-id="'+k+'"]').find('input[name="skus['+(k+'][features][gtin]"]')),k.length&&(k.addClass("error js-validate-error-input"),m=a('<div class="errormsg js-validate-error-msg"></div>').text(m.features.gtin),k.after(m),d=!0,c.refresh("error",$_("Cannot save the value of the \u201cGTIN\u201d feature for an SKU of this product."))))})}return d},
...
a(".s-product-frontend-url-empty").show();else{c=a("#s-product-frontend-url");c.text(b.url);a("#s-product-frontend-url-input").val(b.url);c.trigger("readable");d=c.parent();d.attr("href",b.frontend_urls[0].url);d.find("span:first").text(b.frontend_urls[0].base);c.closest("div.value").find(".s-product-frontend-url").each(function(m){b.frontend_urls[m+1]&&a(this).attr("href",b.frontend_urls[m+1].url).text(b.frontend_urls[m+1].url)});a(".s-product-frontend-url-not-empty").show();a(".s-product-frontend-url-empty").hide();
c="";d=0;for(g=b.frontend_urls.length;d<g;d+=1)c+=' <span class="s-product-frontend-url-not-empty"><a href="'+b.frontend_urls[d].url+'" target="_blank">'+b.frontend_urls[d].url+'</a><i class="icon10 new-window"></i></span> ';c&&a("#s-product-frontend-links").find(".s-product-frontend-url-not-empty").wrapAll("<div></div>").closest("div").replaceWith(c)}this.editTabMainUpdate(b.raw||{},b.features_selectable_strings,f);e.find("select.s-product-categories").each(function(){var m=a(this),l=m.parent(),
n=m.val();if("select"==n||"---"==n){var p=a("#s-product-edit-forms .s-product-form.main select.s-product-categories");1<p.length?l.remove():l.find(".s-product-delete-from-category").hide()}else if("create"==n){var t=l.find("input.val").val();"0"==t?(p=a("#s-product-edit-forms .s-product-form.main select.s-product-categories"),1<p.length?l.remove():(m.val(t),m.show().attr("disabled",!1),l.find("input.val").attr("disabled",!0),l.find(".s-new-category").hide(),l.find(".s-product-delete-from-category").hide())):
(m.val(t),m.show().attr("disabled",!1),l.find("input.val").attr("disabled",!0),l.find(".s-new-category").hide(),l.find(".s-product-delete-from-category").show())}n=parseInt(n,10);if(!a.isEmptyObject(b.storefront_map[n])){m="";n=b.storefront_map[n];for(p=0;p<n.length;p+=1)m+='<a class="hint" href="'+n[p]+'" target="_blank">'+n[p]+"</a> ";l.find(".s-storefront-map").html(m)}});a("#s-product-categories").html(tmpl("template-product-categories",{categories:b.categories||[]}));a("#s-product-tags").html(tmpl("template-product-tags",
{tags:b.tags||[]}));a("#s-product-save table.s-product-skus > tbody > tr").each(function(){var m=a(this).data("id");a(this).find("td.s-stock .s-product-stock-icon").each(function(){var l=a(this).data("stock");b.raw&&b.raw.skus&&b.raw.skus[m]&&b.raw.skus[m].stock_icon[l]&&a(this).html(b.raw.skus[m].stock_icon[l])})});e.find("tr.js-sku-settings").each(function(){var m=a(this),l=m.attr("data-id");(l=b.raw.skus[l])&&void 0!==l.file_name&&!l.file_name&&(m.find(".s-sku-attachment").hide(),m.find(".fileupload").show())});
...
h,b.params)}}a.ajax({url:e,type:c?"POST":"GET",data:c?c||{}:b.params||{},success:function(k,m){a.shop.trace("$.product.loadTab status="+m);if(d.ajax.random==f){g.empty().append(k);d.ajax.target=null;d.ajax.link=null;k="#/product/"+b.id+"/edit/";b.tab&&(k+=b.tab+"/");b.tail&&(k+=b.tail+"/");if(b.params&&!a.isEmptyObject(b.params)){m=[];for(var l in b.params)b.params.hasOwnProperty(l)&&m.push(l+"="+b.params[l]);k+=m.join("&")}window.location.hash=k;d.dispatch(b)}}})},editTabInit:function(b){a("html, body").animate({scrollTop:0},
...
(f=d.find("tr[data-id="+g+"]:first"),!f.length))return;f.find("input.s-input-virtual").val(0);f.removeClass("s-sku-virtual");a("#s-product-view").find("tr[data-id="+g+"]").removeClass("s-sku-virtual")}}},"input, textarea");c.find("i.status-blue-tiny:first").parents("li").trigger("click");return c},featureSelectableCount:function(b){b||=a("#s-product-feature-superposition");var c=[],d=a("#s-product-edit-forms .s-product-form.features");b.find("ul.features>li").each(function(){var k=a(this),m=parseInt(k.find(".count").text(),
10);m&&c.push(m);if(d.length){var l=d.find('div[data-code="'+k.data("feature-code")+'"] div.value');if(m){k=k.data("feature-id");var n=b.find('div.feature-values[data-feature-id="'+k+'"] ul.values input:checked');l.each(function(){var p=a(this),t=n.filter('[value="'+p.data("value-id")+'"]').length;p.find("input:checkbox").attr("checked",t?"checked":null).attr("disabled","disabled");t?p.show():p.hide()})}else l.show(),l.find("input:checkbox").each(function(p,t){t.checked=t.defaultChecked;t.disabled=
...
c.off("change.product","select.s-product-categories").on("change.product","select.s-product-categories",function(g){g=a(this);var h=g.val(),k=g.parent(),m=k.find(".s-product-delete-from-category"),l=parseInt(h,10)||0;l?m.show():m.hide();"create"==h?(k.find(".s-new-category").show(),k.find("input.val").attr("disabled",!1),g.hide().attr("disabled",!0).addClass("js-ignore-change")):k.find("input.val").val(l)});c.off("keydown.product","input.new-category").on("keydown.product","input.new-category",function(g){if(13==
g.keyCode)return a(this).parent().find("input[type=button]").click(),!1});c.off("click.product",".s-new-category input[type=button]").on("click.product",".s-new-category input[type=button]",function(g){var h=a(this).parent(),k=h.parent(),m=h.find("input[name=new_category]");g=m.val();a.shop.jsonPost("?module=category&action=save&category_id=0&parent_id=0",{name:g},function(l){var n=k.find("select"),p=n.find("option.separator:first").show();a.when(p.after('<option class="category" value="'+l.data.id+
'">'+l.data.name+"</option>")).then(function(){n.find("option:first").text($_("Please select a category"));n.val(l.data.id).attr("disabled",!1).show().removeClass("js-ignore-change");h.find("input.val").val(l.data.id).attr("disabled",!0);h.hide();k.find(".s-product-delete-from-category").show();m.val("");a.product.helper.onTabChanged("main",{"saving new category":!0});a("#s-category-list>ul").trigger("add",[l.data,"category"])})})});c.off("click.product",".s-product-delete-from-category").on("click.product",
".s-product-delete-from-category",function(){var g=a(this),h=g.parent("div"),k=h.find("select");if(k.length)if(2<a("#s-product-edit-forms .s-product-form.main select.s-product-categories").length){k.attr("disabled",!0);var m=h.parents("div.field:first").find('input[name="product[categories.deleted]"]');if(0<parseInt(k.val())){var l=m.val().split(",");l.push(k.val());l.sort();m.val(l.join(","));a.product.helper.onChange(a.product.get("form").find("div.main:first"))}h.remove()}else k.val("selected").attr("disabled",
!1),h.find("input.val").val(0).attr("disabled",!0).parent().hide(),h.find(".s-storefront-map").html(""),h.find(".s-product-delete-from-category").hide();else m=h.parents("div.field:first").find('input[name="product[categories.deleted]"]'),k=g.parents(".value:first").find(":input:first"),0<parseInt(k.val())&&(l=m.val().split(","),l.push(k.val()),l.sort(),m.val(l.join(",")),a.product.helper.onChange(a.product.get("form").find("div.main:first"))),g.parents(".value:first").remove();return!1})},editTabMainAction:function(b){var c=
...
g.find(".s-product-image-crops img").retina();a.product.initFeatureDate();if(0<b){a.shop.trace("fileupload",[g.find(".fileupload").length,typeof g.find(".fileupload").fileupload]);try{var h=document.cookie.match(RegExp("(?:^|; )_csrf=([^;]*)")),k=h?decodeURIComponent(h[1]):"";g.find(".fileupload:first").fileupload({dropZone:null,url:"?module=product&action=skuEproductUpload",acceptFileTypes:/(\.|\/)(gif|jpe?g|png)$/i,start:function(){g.find(".fileupload:first").hide()},progress:function(m,l){a.shop.trace("fileupload progress",
l);m=g.find(".js-progressbar-container");m.show();m.find(".progressbar-inner:first").css("width",Math.round(100*l.loaded/l.total,0)+"%")},done:function(m,l){a.shop.trace("fileupload done",[l.result,typeof l.result]);m=(l.result.files||[]).shift();g.find(".js-progressbar-container").hide();!m||m.error?(g.find(".error-message").text(m.error).show(),g.find(".fileupload:first").addClass("error").show()):(l=g.find(".s-sku-attachment"),l.find("input.s-input-file-name").val(m.name),l.find(".s-file-name").text(m.name),
l.find(".s-file-size").text(m.size),l.find(".s-file-description").val(""),l.find("input[type=checkbox]").attr("checked",!0),l.show(),d.find("input.s-input-virtual").val(0))},fail:function(m,l){a.shop.trace("fileupload fail",[l.textStatus,l.errorThrown]);g.find(".error-message").text("error").show().text(l.errorThrown||"error");g.find(".js-progressbar-container").hide();g.find(".fileupload:first").addClass("error").show()},formData:{product_id:a.product.path.id,sku_id:b,_csrf:k}})}catch(m){a.shop.error("Exception "+
m.message,m)}}})})},editTabMainSkuImageSelect:function(b,c,d){b=d.parents("li:first");var e=b.hasClass("selected"),f=d.parents("div.value:first");f.find("ul.s-product-image-crops li.selected").removeClass("selected");e?f.find('input[name$="[image_id]"]').val(0):(b.addClass("selected"),f.find('input[name$="[image_id]"]').val(c));a.shop.trace("$.product.editTabMainSkuImageSelect",[f,f.find(':input[name$="[image_id]"]')]);a.product.helper.onChange(d.parents("div.s-product-form"))},editTabMainSkuEproductSave:function(b){b=
...
(c.filter('[value="0"]').trigger("checked",!0).change(),e.find('[data-sku-type="1"]').show())},editTabMainUpdate:function(b,c,d){var e=a("#s-product-edit-forms .s-product-form.main table.s-product-skus tbody"),f=a("#s-product-view table.s-product-skus tbody");e.find('tr[data-id^="-"]').remove();f.find('tr[data-id^="-"]').remove();e.parents("table").find("tr:hidden").show();var g=[];for(h in b.skus||{})g.push(a.extend({id:h},b.skus[h]));g=g.sort(function(q,u){return q.sort-u.sort});var h=this.getData("main",
"stocks");var k=this.getData("main","stock_ids"),m="";tmpl.cache["template-sku-edit"]=tmpl(tmpl.load("template-sku-edit"));for(var l=0,n=g.length;l<n;l+=1)m+=tmpl("template-sku-edit",{sku_id:g[l].id,sku:g[l],hide_sort_column:1>=n,stocks:h,stock_ids:k,checked:g[l].id==b.sku_id});e.html(m);e.find("select.s-product-currency").val(b.currency);e.parent().show();e.closest(".s-sku-list").show();this.multiSkus(e.find("tr:not(.js-sku-settings)").length);m="";l=0;for(n=g.length;l<n;l+=1)m+=tmpl("template-sku",
{sku_id:g[l].id,sku:g[l],stocks:h,stock_ids:k,runout:b.runout||{}});f.html(m);d&&"new"!=d||e.parents("div.field-group:first").after(a("#s-sku-type-field-group"));c&&(d=a("#s-product-feature-superposition .superposition-count"),d.find(".options").text(c.options),d.find(".skus").html('<span class="highlighted">'+c.skus+"</span>"));var p=/#\/product\/new\//,t="#/product/"+b.id+"/";a("#s-product-edit-forms .s-product-form.main table.s-product-skus tbody, #s-product-view table.s-product-skus tbody").find('[href*="#/product/new/"]').each(function(){a(this).attr("href",
a(this).attr("href").replace(p,t))})},editTabDescriptionsBlur:function(){var b=a("#s-product-description-content");b.length&&b.data("redactor")&&b.waEditor("sync")},editTabDescriptionsAction:function(){var b=a("#s-product-description-content");if(b.length&&!b.data("redactor")){var c=b.parents("div.s-product-form");b.waEditor({lang:wa_lang,modification_wysiwyg_msg:b.data("modification-wysiwyg-msg"),toolbarFixedTopOffset:a("#mainmenu").length?a("#mainmenu").height():0,imageUploadFields:b.data("uploadFields"),
...
getId:function(){return this.path.id}}})(jQuery);(function(a){a.fn.rateWidget=function(b,c,d){function e(m){var l=0;this.find("i").removeClass("star star-hover").addClass("star-empty").each(function(){if(l==m)return!1;l++;a(this).removeClass("star-empty").addClass("star")});this.attr("data-rate",m)}function f(m){return function(){return m}}var g=!!("ontouchstart"in window||navigator.msMaxTouchPoints),h=this;if(this&&this.length){if("string"==typeof b){if("getOption"==b&&"rate"==c)return parseInt(this.attr("data-rate"),10);if("setOption"==b&&("rate"==
...
null!==k.rate&&h.attr("data-rate",k.rate);h.find("i:lt("+h.attr("data-rate")+")").removeClass("star-empty").addClass("star");g||h.mouseover(function(p){k.hold.call(h)||(p=p.target,"I"==p.tagName&&(p=a(p),p.prevAll().removeClass("star star-empty").addClass("star-hover").end().removeClass("star star-empty").addClass("star-hover"),p.nextAll().removeClass("star star-hover").addClass("star-empty")))}).mouseleave(function(){k.hold.call(h)||e.call(h,h.attr("data-rate"))});h.click(function(p){if(!k.hold.call(h)){for(var t=
p.target;"I"!=t.tagName;)if(t==this)return;var q=h.attr("data-rate"),u=0;h.find("i").removeClass("star star-hover").addClass("star-empty").each(function(){u++;a(this).removeClass("star-empty").addClass("star");if(this==t)return q!=u&&(h.attr("data-rate",u),k.onUpdate(u)),!1});return!1}});if(k.withClearAction){var m="clear-"+a(this).attr("id"),l=a("#"+m);l.length||(h.after('<a href="javascript:void(0);" class="inline-link rate-clear" id="'+m+'" style="display:none;"><b><i>'+$_("clear")+"</b></i></a>"),
l=a("#"+m));l.click(function(){if(!k.hold.call(h)){var p=h.attr("data-rate");e.call(h,0);if(0!==p)k.onUpdate(0)}});var n;h.parent().mousemove(function(){k.hold.call(h)||(n&&clearTimeout(n),l.show(0))}).mouseleave(function(){n=setTimeout(function(){k.hold.call(h)||l.hide(0)},150)})}this.unbind("clear").bind("clear",function(){e.call(h,0)});this.data("inited",!0);h[0].addEventListener("touchend",function(p){a(p.target).trigger("click")},!1)}.call(this),this}}})(jQuery);(function(a){a.product_reviews={container:null,sidebar_counter:null,statuses:{},form:null,hotkeys:{"alt+enter":{ctrl:!1,alt:!0,shift:!1,key:13},"ctrl+enter":{ctrl:!0,alt:!1,shift:!1,key:13},"ctrl+s":{ctrl:!0,alt:!1,shift:!1,key:17}},options:{},init:function(b){this.options=b;this.statuses=b.statuses;b.product_id&&(this.product_id=b.product_id);this.form=a("#s-review-add-form");this.sidebar_counter=a("#s-all-reviews").find(".count");b.container&&(this.container="object"===typeof b.container?b.container:
...
b.afterDelete):d.hasClass("s-review-restore")?a.product_reviews.restoreReview(e,b.afterRestore):d.hasClass("js-review-publish")&&a.product_reviews.publishReview(e);return!1}));this.product_id&&this.container.addClass("ajax");var c=function(){a.product_reviews.addReview("backend",b.afterAdd)};this.addHotkeyHandler("textarea","ctrl+enter",c);this.form.find("input.save").unbind("click").bind("click",c);this.form.find(".js-ai-answer-button").off("click").on("click",a.product_reviews.addAnswerAi);this.initView();
this.options.lazy_loading&&this.initLazyLoad(this.options.lazy_loading);a.product&&(a.product.editTabReviewsAction=function(d){d.tail&&setTimeout(function(){a.product_reviews.activeReplyToForm(d.tail)},200)})},activeReplyToForm:function(b){var c=this.container.find(".s-reviews li[data-id="+b+"]");if(c.length){var d=c.find(".s-review-reply:first");this.prepareAddingForm.call(d,this.form,b);a(document).scrollTop(c.offset().top)}},initView:function(){if("reviews"==a.products.hash.substr(0,7)){var b=
a("#s-sidebar");b.find("li.selected").removeClass("selected");b.find("#s-all-reviews").addClass("selected")}},initReview:function(b){var c=a(document),d=b.$wrapper,e=d.data("id"),f=b.locales,g=b.urls,h=!1;d.on("click",".js-show-image",function(k){k.preventDefault();k=a(this);var m=[];d.find(".js-show-image").each(function(){var l=a(this),n=m,p=n.push,t=l.attr("href");l=l.attr("title");l=a("<div />").text(l).html();p.call(n,{href:t,title:l})});(k=k.closest(".s-image-wrapper").prevAll(".s-image-wrapper").length)&&
(m=m.slice(k).concat(m.slice(0,k)));a.swipebox(m,{useSVG:!1,hideBarsDelay:!1,afterOpen:function(){function l(){var n=a("#swipebox-close");n.length&&n.trigger("click");c.off("scroll",l)}c.on("scroll",l)}})});d.on("click",".js-delete-image",function(k){k.preventDefault();var m=a(this).closest(".s-image-wrapper");k=m.data("image-id");!h&&confirm(f.confirm)&&(h=!0,a.post(g["delete"],{review_id:e,image_id:k},"json").always(function(){h=!1}).done(function(){m.remove()}))})},initLazyLoad:function(b){var c=
b.count,d=b.total_count,e=b.url||"?module=reviews",f=a(b.target||".s-reviews:first ul:first");a(window).lazyLoad("stop");c<d&&(a(window).lazyLoad({container:f,state:"undefined"===typeof b.auto||b.auto?"wake":"stop",load:function(){a(window).lazyLoad("sleep");a(".lazyloading-link").hide();a(".lazyloading-progress").show();a.get(e+"&lazy=1&offset="+c+"&total_count="+d,function(g){g=a("<div></div>").html(g);var h=g.find(".s-reviews").children();c+=h.length;f.append(h);a(".lazyloading-progress-string").replaceWith(g.find(".lazyloading-progress-string"));
a(".lazyloading-progress").replaceWith(g.find(".lazyloading-progress"));c>=d?(a(window).lazyLoad("stop"),a(".lazyloading-link").hide()):(a(".lazyloading-link").show(),a(window).lazyLoad("wake"));g.remove()},"html")}}),a(".lazyloading-link").unbind("click").bind("click",function(){a(window).lazyLoad("force");return!1}))},prepareAddingForm:function(b,c){if(c)this.after(b),b.find(".rate a:first").hide();else{var d=a("#s-review-add li:first");d.find("form").length||d.append(b);b.find(".rate a:first").show()}a.product_reviews.clear(!1);
a("input[name=parent_id]",b).val(c)},addHotkeyHandler:function(b,c,d){var e=this.hotkeys[c];this.form.off("keydown",b).on("keydown",b,function(f){if(f.keyCode==e.key&&f.altKey==e.alt&&f.ctrlKey==e.ctrl&&f.shiftKey==e.shift)return d()})},addReview:function(b,c){var d=this.sidebar_counter;a.post("backend"!=b&&b?"#":"?module=reviews&action=add",a.product_reviews.form.serialize(),function(e){if("fail"==e.status)a.product_reviews.clear(!1),a.product_reviews.showErrors(e.errors);else if("ok"==e.status&&
e.data.html){var f=a("input[name=parent_id]",a.product_reviews.form),g=a.product_reviews.form.parents(".s-review:first").parent("li"),h=e.data.html,k=a("ul:first",g),m=a.product_reviews.container;g.length||(m.show(),k=a("ul:first",m).show());k.length||(k=a('<ul class="menu"></ul>'),g.append(k));k.append(a('<li data-id="'+e.data.id+'" data-parent-id="'+e.data.parent_id+'"></li>').append(h));a("textarea",a.product_reviews.form).val("");g=a("#s-review-add");g.find("form").length||(g.append(a.product_reviews.form),
f.val(0));d.length&&d.text(parseInt(d.text(),10)+1);"function"===typeof c&&c(e);a.product_reviews.clear()}else console&&console.log("Error occured.")},"json").error(function(e){console&&console.log(e.responseText?"Error occured: "+e.responseText:"Error occured.")})},deleteReview:function(b,c){var d=this.container,e=this.sidebar_counter;a.post("?module=reviews&action=changeStatus",{review_id:b,status:this.statuses.deleted},function(f){if("ok"==f.status){var g=d.find("li[data-id="+b+"]").find("div:first");
g.removeClass("is-published").removeClass("is-unpublished").addClass("is-deleted");g.find(".s-review-delete").hide();g.find(".s-review-restore").show();e.length&&e.text(parseInt(e.text(),10)-1);"function"===typeof c&&c(f)}},"json")},restoreReview:function(b){var c=this.container,d=this.sidebar_counter;a.post("?module=reviews&action=changeStatus",{review_id:b,status:this.statuses.published},function(e){"ok"==e.status&&(e=c.find("li[data-id="+b+"]").find("div:first"),e.addClass("is-published").removeClass("is-unpublished").removeClass("is-deleted"),
e.find(".s-review-delete").show(),e.find(".s-review-restore").hide(),d.length&&d.text(parseInt(d.text(),10)+1),"function"===typeof success&&success())},"json")},publishReview:function(b){var c=this.container,d=this.sidebar_counter;a.post("?module=reviews&action=changeStatus",{review_id:b,status:this.statuses.published},function(e){"ok"==e.status&&(e=c.find("li[data-id="+b+"]").find("div:first"),e.addClass("is-published").removeClass("is-unpublished").removeClass("is-deleted"),e.find(".s-review-delete").show(),
e.find(".js-review-publish").remove(),d.length&&d.text(parseInt(d.text(),10)+1),"function"===typeof success&&success())},"json")},addAnswerAi:function(){const b=a(this);b.prop("disabled",!0);a.post("?module=reviews&action=addAi",a.product_reviews.form.serialize(),function(c){if("fail"==c.status)c.errors.forEach(({error:e,error_description:f})=>{"payment_required"===e&&(f=f.replace("%s",'href="javascript:void(0)"'));b.next().hasClass("state-error-hint")&&b.next().remove();const g=a('<span class="state-error-hint" />').html(f);
b.after(g);setTimeout(()=>g.remove(),5E3)});else{var d=a("textarea",a.product_reviews.form);d.val(d.val()?d.val()+"\n"+c.data.text:c.data.text)}},"json").error(function(c){console&&console.log(c.responseText?"Error occured: "+c.responseText:"Error occured.")}).always(function(){b.prop("disabled",!1)})},clear:function(b){b="undefined"===typeof b?!0:b;a(".errormsg",this.form).remove();a(".error",this.form).removeClass("error");a(".wa-captcha-refresh",this.form).click();b&&(a("input[name=captcha], textarea",
this.form).val(""),a("input[name=rate]",this.form).val(0),a(".rate a:first",this.form).trigger("clear"))},showErrors:function(b){for(var c=0,d=b.length,e=b[c];c<d;e=b[++c])for(var f in e)a("[name="+f+"]",this.form).after(a('<em class="errormsg"></em>').text(e[f])).addClass("error")}}})(jQuery);(function(a){a.product_images={product_id:0,image:null,product_image:null,image_list:null,photo_stream:null,tail:null,options:{},init:function(b){this.options=b;this.product_id=b.product_id||0;this.image=b.image||null;this.options.placeholder=this.options.placeholder||null;var c=a("#s-product-edit-menu .images");this.image?setTimeout(function(){a.product_images.initImage()},200):this.initImageList(b);c.find(".hint").text(b.count||b.images&&b.images.length||0);a("#s-product-edit-forms .s-product-form.images").addClass("ajax");
...
this.id+'-hint">Ctrl+Enter</em>'),a("#"+d).click(function(){c.trigger("readable")}));a("#"+this.id+"-hint").show();e.show()},afterBackReadable:function(b,c){var d=a(this);d=parseInt(d.parents("li:first").attr("data-image-id"),10);b=a(b).val();var e="#"+this.id+"-";a(e+"button").hide();a(e+"hint").hide();c.changed&&a.products.jsonPost("?module=product&action=imageSave",{id:d,data:{description:b}})}}).trigger("editable")})}}})(jQuery);(function(a){a.product_stocks={options:{},container:null,products_ids:[],stock_id:null,waLoading:a.waLoading(),init:function(b){this.options=b;this.stocks=b.stocks;this.stock_id=b.stock_id;this.container=a("#s-product-stocks");this.products_ids=[];this.initView();this.options.lazy_loading&&0<this.options.product_stocks.length&&this.initLazyLoad(this.options.lazy_loading)},initLazyLoad:function(b){let c=b.count,d=b.total_count,e=b.sort;a(window).lazyLoad("stop");if(c<d){const f=this;a(window).lazyLoad({container:f.container.find("tbody"),
state:"undefined"===typeof b.auto||b.auto?"wake":"stop",hash:"stocks",load:function(){a(window).lazyLoad("sleep");a(".lazyloading-link").hide();a(".lazyloading-progress").show();const g=function(k){console&&(k&&k.errors?console.error("Error when loading products: "+k.errors):k&&k.responseText?console.error("Error when loading products: "+k.responseText):console.error(k));a(window).lazyLoad("stop")},h=["module=stocksBalance","offset="+c,"total_count="+d];f.stock_id&&h.push("stock_id="+f.stock_id);
f.options.order&&h.push("order="+f.options.order);e&&h.push("sort="+e);a.get("?"+h.join("&"),function(k){k&&"ok"===k.status?(c+=k.data.count,f.append({product_stocks:k.data.product_stocks,stocks:f.stocks,is_single_stock:!!f.stock_id})?(a(".lazyloading-progress-string").text(k.data.progress.loaded+" "+k.data.progress.of),a(".lazyloading-progress").hide(),a(".lazyloading-chunk").text(k.data.progress.chunk),c>=d||1>k.data.count?(a(window).lazyLoad("stop"),a(".lazyloading-link").hide()):(a(".lazyloading-link").show(),
a(window).lazyLoad("wake"))):a(window).lazyLoad("stop")):g(k)},"json").error(g)}});a(".lazyloading-link").off("click").on("click",function(){a(window).lazyLoad("force");return!1})}},initView:function(){if(!this.append({product_stocks:this.options.product_stocks,stocks:this.stocks,is_single_stock:!!this.stock_id}))return this},append:function(b){const c=this;b=function(d){const e=[];a.each(d.product_stocks,function(f,g){0>c.products_ids.indexOf(g.id)&&(e.push(g),c.products_ids.push(g.id))});d.product_stocks=
...
a(g.fake_input).bind("keydown",function(k){if(8==k.keyCode&&""==a(this).val()){k.preventDefault();k=a(this).closest(".tagsinput").find(".tag:last").text();var m=a(this).attr("id").replace(/_tag$/,"");k=k.replace(/[\s]+x$/,"");a("#"+m).removeTag(escape(k));a(this).trigger("focus")}});a(g.fake_input).blur();g.unique&&a(g.fake_input).keydown(function(k){(8==k.keyCode||String.fromCharCode(k.which).match(/\w+|[\u00e1\u00e9\u00ed\u00f3\u00fa\u00c1\u00c9\u00cd\u00d3\u00da\u00f1\u00d1,\/]+/))&&a(this).removeClass("not_valid")})}return!1});
...
f.options.view,{products:h.data.products,check_all:k.find(".s-select-all:first").length?k.find(".s-select-all:first").attr("checked"):!1,sort:a.product_list.sort,primary_currency:a.product_list.options.primary_currency,stocks:a.product_list.options.stocks})),f.container.trigger("append_product_list",[h.data.products])}catch(m){console.log("Error: "+m.message);a(window).lazyLoad("stop");return}k.find(".last").removeClass("last");k.find(".product:last").addClass("last");a(".lazyloading-progress-string").text(h.data.progress.loaded+
...
!1,!1),d.text("").hide())});c.off("click",".product input").on("click",".product input",function(g,h){var k=g.shiftKey;g=this.checked;h&&(k=h.shiftKey,g=h.checked);h=a(this).parents(".product:first");g?h.addClass("selected"):(e.is(":checked")&&e.attr("checked",!1),h.removeClass("selected"));if(k&&g){(k=c.data("last_checked"))||(k=c.find("> .product:first").trigger("select",!0));var m=h.prevAll(".selected[data-product-id="+k.attr("data-product-id")+"]");if(m.length){var l=h.prev();for(k=k.get(0);l.length&&
k!=l.get(0);)l.addClass("selected").find("input").attr("checked",!0),l=l.prev()}else if(m=h.nextAll(".selected[data-product-id="+k.attr("data-product-id")+"]"),m.length)for(l=h.next(),k=k.get(0);l.length&&k!=l.get(0);)l.addClass("selected").find("input").attr("checked",!0),l=l.next();c.data("last_checked")||m.length||k.trigger("selected",!1)}g&&c.data("last_checked",h);f()});if(a.browser.mozilla)c.off("click",".product label").on("click",".product label",function(g){if(g.shiftKey){var h=a(g.target);
...
return!1}),a.storage.get("shop/product_list/multi-lined")&&d.removeClass("single-lined"));var f="view="+c;e.find(".s-collection-list li.dr").each(function(){var m=a(this);m.find("a:first").attr("href","#/products/"+m.attr("id").replace("-","_id=")+"&"+f)});a("#s-products-search").autocomplete("disable").val(this.options.text||"").autocomplete("enable");var g="s-all-products",h=a.product_list.collection_hash.length&&"search"!==a.product_list.collection_hash[0]&&"tag"!==a.product_list.collection_hash[0]&&
"id"!==a.product_list.collection_hash[0];h&&(g=a.product_list.collection_hash.join("-"));a.shop.trace("$.product_list.initView",[c,g]);e.find("li.selected").removeClass("selected");var k=e.find("#"+g);0>=k.length&&window.location.hash&&(k=e.find('a[href="'+window.location.hash+'"]').parent());0>=k.length&&(k=e.find("#s-all-products"));k.addClass("selected");h&&k.find(".count:first").text(this.category_count);this.initEditingControls();this.initToolbar();a(document).trigger("product_list_init_view")}catch(m){a.shop.error("$.product_list.initView error: "+
m.message,m)}},highlightInlineEditorCells:function(){a.product_list.container.find("tr").each(function(){var c=a(this),d=c.data("edit-rights");d&&c.data("min-price")==c.data("max-price")||c.find(".s-product-price .editable").filter(function(){return!a(this).data("plugin")}).addClass("not-editable");d&&1==c.data("sku-count")||c.find(".s-product-stock .editable").filter(function(){return!a(this).data("plugin")}).addClass("not-editable")})},initInlineEditor:function(){function c(g,h){if(g.data("denied-reason")==
...
a(this);void 0===k.data("original-price")&&k.data("edit-rights")&&h.push(a(this).data("product-id"))});if(!h.length)return g();a.post("?module=products&action=inlineEditorData",{ids:h},function(k){k.data&&a.product_list.container.find("tr.product").each(function(){var m=a(this),l=k.data[parseInt(m.data("product-id"),10)];l&&(m.data("stocks",l.stocks||null),m.data("original-price",l.price.replace(/\.?0+$/g,"")))});g()},"json")}var e=this,f=0;e.options.stocks&&e.options.stocks.length&&(f=e.options.stocks.length);
a.product_list.highlightInlineEditorCells();a.product_list.container.on("append_product_list",function(){a.product_list.highlightInlineEditorCells()});a.product_list.container.on("click",".s-product-price,.s-product-stock",function(){function g(){if(m)h.html(tmpl("template-list-price-editor-one",{product_id:k.data("product-id"),currency:k.data("currency"),value:k.data("original-price")}));else{var l=k.data("stocks");f?(l&&"object"===typeof l||(l={}),h.html(tmpl("template-list-stock-editor-many",{product_id:k.data("product-id"),
values:l}))):(l&&"object"!==typeof l||(l=""),h.html(tmpl("template-list-stock-editor-one",{product_id:k.data("product-id"),value:l})))}h.find(".cancel").click(function(){var p=h;p.removeClass("editor-on").html(p.data("read-only-state-html"));p.data("read-only-state-html","");p.data("denied-reason","")});var n=h.find("form").submit(function(){if(n.find(".loading").length)return!1;n.find(":submit").after('<i class="icon16 loading"></i>');a.post("?module=products&action=inlineSave",n.serialize(),function(p){n.find(".loading").remove();
try{p.data&&p.data[0]&&(p.data[0].alien=k.hasClass("s-alien"));var t=a("<table>").html(tmpl("template-product-list-table",{products:p.data,check_all:a.product_list.container.find(".s-select-all:first").prop("checked"),sort:a.product_list.sort}));k.replaceWith(t.find("tr"));e.container.trigger("append_product_list",[p.data])}catch(q){console.log("Error: "+q.message)}},"json");return!1});n.on("dblclick",!1);setTimeout(function(){h.find(":input:visible:first").focus()},0)}var h=a(this);if(!h.data("plugin")){var k=
h.closest("tr"),m=h.hasClass("s-product-price");if(m){if(k.data("min-price")!=k.data("max-price"))return c(h,$_("Inline editing is available only for products with a single SKU"))}else if("1"!=k.data("sku-count"))return c(h,$_("Inline editing is available only for products with a single SKU"));if(!k.data("edit-rights"))return c(h,$_("Insufficient access rights"));h.hasClass("editor-on")||(h.addClass("editor-on").data("read-only-state-html",h.html()),a.product_list.container.removeClass("single-lined"),
...
"edit");return!1});c=a("#s-product-list-delete");!c.length||"category"!=d&&"set"!=d||c.unbind("click").bind("click",function(){a("#s-product-list-delete-dialog").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(){function f(n,p){if(!n.length)return p&&p();var t=n.shift();g(["category",t],function(){f(n,p)})}function g(n,p){var t={hash:n.join("/")||"all",remove:["list"]};l&&t.remove.push("products");var q=function(){a.product_list.remove(t,
function(r,v){h(n,r);a.product_list.sidebar.trigger("update",r.data.lists);p&&p()})},u=a("#"+n.join("-")+"-handler");u.length?a.categories_tree.expand(u,function(r){r.parent().find("ul:first").hide();q()}):q();return!1}function h(n,p){var t=n[0],q=a("#"+n.join("-")),u=q.prev(".drag-newposition");n=a("#s-"+n[0]+"-list");var r=n.find("ul:first");"set"==t?(q.remove(),u.remove()):(t=q.find("ul:first"),t.length&&(t.find(">li.drag-newposition:first").remove(),q.hide(),t.find(">li").each(function(){q.after(this)})),
t=q.parents("ul:first"),q.remove(),u.remove(),t.find("li.dr").length||(r.get(0)!=t.get(0)?(t.parents("li:first").find("i.collapse-handler").remove(),t.closest("li").find(".collapse-handler-ajax:first").remove(),t.remove()):r.closest(".block").find(".collapse-handler-ajax:first").remove()));r.find("li.dr:first").length?(r.show(),n.find(".s-empty-list").hide()):(r.hide(),n.find(".s-empty-list").show());p.data.old_parent_category&&"undefined"!==typeof p.data.old_parent_category.children_count&&!parseInt(p.data.old_parent_category.children_count,
10)&&a("#category-"+p.data.old_parent_category.id+"-handler").remove()}var k=a(this),m=parseInt(a.product_list.collection_hash[1]);k.find(".dialog-buttons i.loading").show();var l="1"==k.find("input[name=s-delete-products]:checked").val();"category"==d&&k.find('input[name="s-delete-sub"]').is(":checked")?a.get("?action=categoryExpand&tree=1&recurse=1&id="+m,function(n){n=a("<div>").html(n).find('li[id^="category-"]').map(function(){return parseInt(this.id.substr(9),10)}).get().reverse();n.push(m);
f(n,function(){location.href="#/"})}):g(a.product_list.collection_hash,function(){location.href="#/"});return!1}});return!1});"set"===d&&a("#s-embed-code").click(function(){a("#s-product-list-embed-dialog").waDialog();return!1})},initDragndrop:function(){a.product_dragndrop.init({products:!0,view:this.options.view,sort:this.options.sort}).bind("move_product",function(c){a.shop.jsonPost("?module=product&action=move&"+a.product_list.collection_param,{product_ids:c.product_ids,before_id:c.before_id||
...
var m=g.attr("action");setTimeout(function(){var l=g.serializeArray().concat(c.serialized);a.shop.jsonPost(m,l,function(n){n.data.denied_message&&alert(n.data.denied_message);"search"===n.data.cloud?f.trigger("close"):n.data.cloud&&a("#s-tag-cloud").trigger("update",[n.data.cloud]);f.trigger("close");a.products.dispatch()},function(){f.trigger("close")})},10);return!1}})};d.length&&d.remove();a.post("?module=dialog&action=assignTags",c.serialized,function(f){a("body").append(f);e()})},typesDialog:function(c){var d=
a("#s-types"),e=this.container,f=this.sidebar,g=function(){a("#s-types").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(k){var m=a(this);m.find(".dialog-buttons i.loading").show();a.shop.jsonPost(m.attr("action"),m.serializeArray().concat(c.serialized),function(l){f.trigger("update",{type:l.data.types});e.find(".s-select-all:first").trigger("select",!1);m.find("input:checked").attr("checked",!1);k.trigger("close");a.products.dispatch()});
...
Math.round(100*h.offset/h.total_count)+"%")},finish:function(h,k){d.attr("title",null);var m=d.find("i.icon16");m.removeClass("loading").addClass("yes");setTimeout(function(){m.removeClass("yes").addClass("split")},3E3);a(document).one("product_list_init_view",function(){var l={};a.each(k,function(n,p){l[p]=1});a("#product-list [data-product-id]").each(function(){var n=a(this),p=a(this).data("product-id");p&&l[p]&&n.addClass("highlighted")})});(h||k)&&a.products.dispatch()},error:function(h){}}))},
setBadge:function(c,d){function e(m){var l="delete-badge"==f?null:m.data;a("#product-list [data-product-id]").each(function(){var n=a(this);if(h||g[n.data("product-id")]){if(n.is("tr")){var p=n.find(".s-image a");p.find(".s-image-corner").remove();l&&p.prepend(a('<div class="s-image-corner"></div>').html(l))}else p=n.find(".s-product-image a"),p.find(".s-image-corner.top.right").remove(),l&&p.append(a('<div class="s-image-corner top right"></div>').html(l));n.trigger("badge",[l])}});"set-custom-badge"==
...
this.$wrapper,c=b.find(".js-product-set-id");b=b.find(".js-product-list-name");var d="",e=!1,f,g;c.bind("keydown",function(){var h=a(this);null!==f&&(clearTimeout(f),f=null);f=setTimeout(function(){var k=h.val();d!==k&&(e=!0,d=k,h.unbind("keydown"))},200)});b.bind("keydown",function(){var h=a(this);e?h.unbind("keydown"):(null!==g&&(clearTimeout(g),g=null),g=setTimeout(function(){var k=h.val();k&&a.getJSON("?action=transliterate&str="+k,function(m){e?h.unbind("keydown"):"ok"==m.status&&(d=m.data,c.val(d))})},
200))})};shopDialogProductsSet.staticDialog=function(b,c){var d=a("#s-product-set-dialog"),e=function(){d=a("#s-product-set-dialog");d.waDialog({esc:!1,disableButtonsOnSubmit:!0,onLoad:function(){new shopDialogProductsSet({$wrapper:d,is_new:"new"===c});setTimeout(function(){a(".js-product-list-name").focus()},50)},onSubmit:function(g){var h=a(this),k=function(l){if(0<location.hash.indexOf("set_id")){var n=location.hash.replace("set_id="+b,"set_id="+l.data.id);"rule"in l.data&&(n=n.replace(/&sort=[^&]*/,
"&sort="),n=n.replace(/&order=[^&]*/,"&order="))}else n="#/products/set_id="+l.data.id;"new"===c&&a.product_sidebar.createNewElementInList(l.data,"set");a.product_sidebar.updateItemInCategoryList(l,n);location.hash!=n?location.hash=n:a.products.dispatch();g.trigger("close")},m=function(l){if(l&&l.errors){l=l.errors;var n=0,p;for(p in l){var t=g.find("input[name="+p+"]");if(t.length){t.addClass("error");n+=1;var q=t.parent().find(".errormsg");q.length&&q.text(l[p]);t.one("keyup",function(){--n||h.find("[type='submit']").removeAttr("disabled",
!1);t.removeClass("error");q.length&&q.text("")})}}return!1}};if(h.find("input:file").length)a.products._iframePost(h,k,m);else return a.shop.jsonPost(h.attr("action"),h.serialize(),k,m),!1},onClose:function(){d.find(".js-datepicker").each(function(){a(this).datepicker("widget").hide()})}})};var f=d.length?d.closest(".s-products-set-dialog-wrapper").empty():a('<div class="s-products-set-dialog-wrapper"></div>').appendTo("body");"new"===c?f.load("?module=set&action=Create",e):"edit"===c&&f.load("?module=set&action=Edit&set_id="+
...
100<c.val()?parseFloat(c.val())+100:100);h.slider({range:!0,min:e-3,max:f+5,step:g,values:[e,f],slide:function(k,m){k=a(this).slider("option","min");var l=a(this).slider("option","max");2!=a(m.handle).index()&&(m.values[0]==k&&a(this).slider("option","min",k-g),c.val(m.values[0]));1!=a(m.handle).index()&&(m.values[1]==l&&a(this).slider("option","max",l+g),d.val(m.values[1]))},stop:function(k,m){d.change()}});c.add(d).change(function(){var k=""===c.val()?h.slider("option","min"):parseFloat(c.val()),
m=""===d.val()?h.slider("option","max"):parseFloat(d.val());m>=k&&(h.slider("option","values",[k,m]),h.slider("option","max",parseFloat(m)+5),h.slider("option","min",parseFloat(k)-3))})};shopDialogProductsCategory.prototype.initShowFeatures=function(b,c,d,e,f){var g=b.type.substr(0,5);if("range"==g){var h=[],k=[],m;for(m in b.values)b.values.hasOwnProperty(m)&&(h.push(parseInt(b.values[m].begin)),k.push(parseInt(b.values[m].end)));b.values={};b.values[0]={begin:Math.min.apply(Math,h)?Math.min.apply(Math,
...
b).attr("disabled",!1):a('input[name="routes[]"]',b).attr("disabled",!0)})};shopDialogProductsCategory.staticDialog=function(b,c,d){var e=function(){a("#s-product-category-dialog").waDialog({esc:!1,disableButtonsOnSubmit:!1,onLoad:function(){a("#s-category-description-content").length&&a.product_sidebar.initCategoryDescriptionWysiwyg(a(this));setTimeout(function(){a(".js-product-list-name").focus()},150)},onSubmit:function(g){var h=a(this);if(function(){var l=!1;h.find(".js-condition-feature:checked, .js-condition-tag:checked").each(function(){var n=
a(this).closest("tr").find(".js-condition-feature-block, .js-condition-tag-block"),p=n.find(".js-feature-value:checkbox, .js-tag-value:checkbox");p.length&&!p.is(":checked")&&(l=!0,n.find(".errormsg").html("").html($_("Nothing selected")),h.find(".js-category-error").html("").html($_("Nothing selected")))});setTimeout(function(){h.find(".errormsg").html("")},5E3);return l}())return!1;var k=function(l){if(0<location.hash.indexOf("category_id")){var n=location.hash.replace("category_id="+b,"category_id="+
l.data.id);if("sort_products"in l.data||"rule"in l.data)n=n.replace(/&sort=[^&]*/,"&sort="),n=n.replace(/&order=[^&]*/,"&order=")}else n="#/products/category_id="+l.data.id;"new"===d&&a.product_sidebar.createNewElementInList(l.data,"category");a.product_sidebar.updateItemInCategoryList(l,n);location.hash!=n?location.hash=n:a.products.dispatch();g.trigger("close")},m=function(l){if(l&&l.errors){l=l.errors;for(var n in l)g.find("input[name="+n+"]").addClass("error").parent().find(".errormsg").text(l[n]);
return!1}};a("#s-category-description-content").length&&a("#s-category-description-content").waEditor("sync");if(h.find("input:file").length)a.products._iframePost(h,k,m);else return a.shop.jsonPost(h.attr("action"),h.serialize(),k,m),!1}})},f=a("#s-product-category-dialog");f=f.length?f.parent():a("<div></div>").appendTo("body");"new"===d&&f.load("?module=category&action=Create&parent_id="+c,e);"edit"===d&&f.load("?module=category&action=Edit&category_id="+b,e)};return shopDialogProductsCategory}(jQuery);//# sourceMappingURL=%outname%.map
