...
$.fn.liveDroppable=function(a){this.each(function(){var a=$(this);a.data("init_droppable")&&a.die("mouseover",a.data("init_droppable"))});var b=function(){var b=$(this);b.data("init_droppable")||(b.data("init_droppable",arguments.callee).droppable(a),b.mouseover())};b.call(this);this.die("mouseover",b).live("mouseover",b)};(function(a){a.fn.inlineEditable=function(b,c){function d(){m(a(this))||a(this).addClass(i.placeholderClass).text(i.placeholder)}function e(){m(a(this))==i.placeholder&&a(this).text("").removeClass(i.placeholderClass)}function f(b){return!a(b).val()?(a(this).text(i.placeholder).addClass(i.placeholderClass),!0):!1}function g(){n="edit";this.id=this.id||(""+Math.random()).slice(2);var b=this.id+"-input",c=a("#"+b);c.length||(o.after(k(b)),c=a("#"+b));c.addClass(i.inputClass);var b=c,d=o,f=i.size.height||
d.height(),d=i.size.width||1.5*d.width(),f=i.minSize.height&&f<i.minSize.height?i.minSize.height:f,d=i.minSize.width&&d<i.minSize.width?i.minSize.width:d,f=i.maxSize.height&&f>i.maxSize.height?i.maxSize.height:f,d=i.maxSize.width&&d>i.maxSize.width?i.maxSize.width:d;b.height(f);b.width(d);i.placeholder&&m(a(this))==i.placeholder&&e.call(o);i.beforeMakeEditable.call(this,c);q=i.truncate?o.data("real_text"):m(o);c.val(q).show().focus();o.hide();a(i.editLink).hide();if(!l){for(var g=[],j=[],b=0,f=i.makeReadableBy.length;b<
f;++b)d=i.makeReadableBy[b],"blur"==d&&c.blur(function(){n!="read"&&h.call(this)}),"enter"==d&&g.push(13),"esc"==d&&g.push(27);b=0;for(f=i.updateBy.length;b<f;++b)d=i.updateBy[b],"alt+enter"==d&&j.push({ctrl:!1,alt:!0,shift:!1,key:13}),"ctrl+enter"==d&&j.push({ctrl:!0,alt:!1,shift:!1,key:13}),"ctrl+s"==d&&j.push({ctrl:!0,alt:!1,shift:!1,key:17});g.length&&c.keydown(function(a){~g.indexOf(a.keyCode)&&!a.ctrlKey&&!a.altKey&&!a.shiftKey&&n!="read"&&h.call(this,a.keyCode==27?q:null);if(j.length)for(var b in j){var c=
j[b];if(a.keyCode==c.key&&a.ctrlKey==c.ctrl&&a.altKey==c.alt&&a.shiftKey==c.shift){o.trigger("readable");break}}});o.unbind("readable.inlineEditable").bind("readable.inlineEditable",function(b,c){if(n!="read"){var d=a("#"+(this.id+"-input"));h.call(d,d.val(),c)}});l=!0}i.afterMakeEditable.call(this,c)}function h(b,c){c="undefined"===typeof c?!1:!0;void 0!=b&&null!=b?a(this).val(b):b=a(this).val();if(!(!1===c&&!1===i.beforeBackReadable.call(o.get(0),this,{changed:b!=q,old_text:q,new_text:b}))){n="read";
if(!i.placeholder||!f.call(o,this))if(i.allowEmpty||b)i.truncate?(o.data("real_text",b),o.text(b.length<i.truncate-3?b:b.substr(0,i.truncate-3)+"...")):!i.html?o.text(b):o.html(b),b||d.call(this);o.show();a(this).hide();a(i.editLink).show();!1===c&&i.afterBackReadable.call(o.get(0),this,{changed:b!=q,old_text:q})}}function k(a){switch(i.inputType){case "textarea":return'<textarea id="'+a+'" style="display:none;"></textarea>';default:return'<input type="text" id="'+a+'" style="display:none;">'}}function j(a){return function(){return a}}
function m(a){return!i.html?a.text():a.html()}if(this.length){var l=!1;if("string"==typeof b){if("setOption"==b){var i=this.data("inlineEditableSettings")||{};a.extend(!0,i,c);"undefined"!==typeof c.hold&&"function"!==typeof c.hold&&(i.hold=j(i.hold));this.data("inlineEditableSettings",i)}return this}var p=this.data("inlineEditableSettings");this.data("inlineEditableSettings",a.extend({inputType:"text",inputClass:"",size:{height:null,width:null},minSize:{height:null,width:null},maxSize:{height:null,
width:null},editLink:null,editOnItself:!0,placeholder:null,makeReadableBy:["blur","enter","esc"],updateBy:["ctrl+enter","alt+enter"],beforeBackReadable:function(){},afterBackReadable:function(){},beforeMakeEditable:function(){},afterMakeEditable:function(){},placeholderClass:"hint",truncate:!1,hold:!1,html:!1,allowEmpty:!1},p,b||{}));var i=this.data("inlineEditableSettings")||{},o=this,n="read",q="";"function"!==typeof i.hold&&(i.hold=j(i.hold));this.data("inited")||(i.truncate&&"boolean"==typeof i.truncate&&
...
function(){i.hold.call(o)||n!="edit"&&g.call(this)}),this.unbind("placeholder.inlineEditable").bind("placeholder.inlineEditable",function(b,c){c&&i.placeholder&&d.call(this);c||a(this).removeClass(i.placeholderClass)}),this.data("inited",!0));return this}}})(jQuery);(function(a){a.fn.photoStreamSlider=function(b){function c(){function b(c){function k(){b.execution=!1;var a="on"+i.charAt(0).toUpperCase()+i.slice(1),a=d[a];"function"==typeof a&&a.call(e);a=c.fn;"function"==typeof a&&a.call(e)}"string"==typeof c&&(c={direction:c,animate:!0});var i=c.direction||"forward",l=c.steps||h.length;if(!b.execution){b.execution=!0;var o=h.filter(":first").outerWidth()*l,n=h.length;if("forward"==i){var r=h.filter(":last").nextAll(":lt("+l+")"),l=r.length,r=r.filter(":last");
l&&(h.removeClass("visible"),r.prevAll(":lt("+(n-1)+")").addClass("visible"),r.addClass("visible"))}else r=h.filter(":first").prevAll(":lt("+l+")"),l=r.length,r=r.filter(":last"),l&&(h.removeClass("visible"),r.nextAll(":lt("+(n-1)+")").addClass("visible").show(),r.addClass("visible"));h=a("li.visible",g);n=g.position().left;"forward"==i?(l=m-j-p,n-=o,n=n>-l?n:-l):(n+=o,n=n<p?n:p);c.animate?g.animate({left:n},d.duration,k):(g.css({left:n}),k())}}var g=e.find(d.photoStream),h=a("li.visible",g),k=a("li",
g),j=h.filter(":first").outerWidth()*h.length,m=k.filter(":first").outerWidth()*k.length,l=d.height||k.filter(":first").outerHeight();g.parent().css({overflow:"hidden",height:l,position:"relative",padding:"4px 0",margin:0,width:j});for(var l=g.find("li:first"),i=h.filter(":first"),p=(i.outerWidth()-i.width())/2,o=0,n=l.outerWidth(),i=i.get(0);l.length&&l.get(0)!=i;)o+=n,l=l.next();g.css({position:"absolute",left:-(o-p),width:m});a(d.forwardLink).unbind("click").bind("click",function(){b("forward");
return!1});a(d.backwardLink).unbind("click").bind("click",function(){b("backward");return!1});e.unbind("append prepend").bind("append prepend",function(b,c){if("append"==b.type){for(var d=g.find("li:last"),f=a();d.hasClass("dummy");)f=f.add(d),d=d.prev("li");f.remove();g.append(c)}else{var d=a("<div></div>").html(c),f=d.find("li"),h=f.length*n;d.remove();for(var d=g.find("li:first"),j=a();d.hasClass("dummy");)j=j.add(d),d=d.next("li");j.remove();g.prepend(f)}k=g.find("li");m=k.filter(":first").outerWidth()*
...
e.unbind("home").bind("home",function(c,d,e){var c=parseInt(h.length/2),c=h.filter(":eq("+c+")"),g=c.nextAll(".selected:first"),k=c.prevAll(".selected:first"),j=0,m="";"function"!==typeof d&&(e=d);e="undefined"!==typeof e?e:!0;g.length?(m="forward",c.nextAll().each(function(){++j;if(a(this).hasClass("selected"))return!1})):k.length&&(m="backward",c.prevAll().each(function(){++j;if(a(this).hasClass("selected"))return!1}));m&&j?b({direction:m,steps:j,fn:d,animate:e}):"function"==typeof d&&d();return!1});
...
g=f.attr("data-type");if(g!=e.attr("data-type"))return!1;var h=function(a){a=a.split("-");a.shift();return a.join("-")},k=h(f.attr("id")),j=e.prev("li"),m=f.next(),l=f.prev();if(j.length&&j.attr("id")=="category-"+k&&!j.hasClass("dr-helper")||this==f.next().get(0))return!1;var i=f.parent("ul"),p=i.children("li.dr[id!=category-"+k+"]").length,o=parseInt(h(i.parent().attr("id")),10)||0;e.after(m).after(f);e=f.parent().parent();if(e.is("li.dr")||e.is(".s-collection-list")){var n=0;e.is(".s-collection-list")||
(n=parseInt(h(e.attr("id")),10)||0);e=f.nextAll("li.dr:first");j=null;e.length&&(j=h(e.attr("id"))||null);!p&&o!==n&&(i.parent("li").children("i").hide(),i.hide());a.product_dragndrop.trigger("move_list",{id:k,type:g,before_id:j,parent_id:n,success:function(){if(!p&&o!==n){i.parent("li").children("i").remove();i.remove();a.categories_tree.setCollapsed(o)}},error:function(a){a&&console&&console.log(typeof a.errors!=="undefined"?a.errors:a);l.after(f.next()).after(f);if(!p){i.parent("li").children("i").show();
...
d,e){var f=e+"-last";if(d.hasClass("last")){var g=b.pageX,b=b.pageY,h=d.width(),k=d.height(),j=d.offset();"thumbs"==a.product_dragndrop.options.view?g>j.left+0.5*h&&g<=j.left+h?(d.removeClass(e).addClass(f),a.product_dragndrop._shiftToLeft(d)):g>j.left&&g<=j.left+0.5*h?(d.removeClass(f).addClass(e),a.product_dragndrop._shiftToRight(d)):a.product_dragndrop._shiftAtPlace(d):"table"==a.product_dragndrop.options.view&&(b>j.top+0.5*k?d.removeClass(e).addClass(f):b>j.top&&d.removeClass(f).addClass(e));
(b<j.top||b>j.top+k||g<j.left||g>j.left+h)&&d.removeClass(e).removeClass(f)}else d.addClass("drag-active")},_bindExtDragActivate:function(b,d){a(document).bind("mousemove.ext_drag_activate",function(e){a.product_dragndrop._extDragActivate(e,b,d)})},_unbindExtDragActivate:function(){a(document).unbind("mousemove.ext_drag_activate")},_activatePhotoListItem:function(){var b=a(this),d=a.product_dragndrop.trigger("is_product_sortable"),e=d?"drag-active":"drag-active-disabled";d&&"thumbs"==a.product_dragndrop.options.view&&
...
a("#s-toolbar").show().animate({width:"200px"});a("#maincontent").animate({"margin-top":"84px"},"fast");a("#s-content").animate({"margin-left":a.product.options.sidebar_width},"fast")},saveData:function(b,c,d){var e=this,f=e.get("form"),g,h="radio",k=f.find('input[name="product[sku_type]"]:first');k.is(":radio")?(g=f.find('input[name="product[sku_type]"]:checked').val(),k=f.find('input[name="product[sku_type]"]')):(h="hidden",g=f.find('input[name="product[sku_type]"]:not(:disabled)').val());if("1"==
...
b);c.show();c.find("input").attr("disabled",!1);"new"==a.product.path.id?a.product.disableSkus(!1,!0):a.product.disableSkus(!0,!1);a(this.options.form_selector).find(".s-product-skus").closest(".field").find(".name").hide()},onSkuTypeChange:function(b){var c=a("#s-product-feature-superposition-field-group");a.shop.trace("onSkuTypeChange",{sku_type:b});if("1"==b)if(b=a(this.options.form_selector+' :input[name="product[type_id]"]').val(),c.data("type")!=b)c={base_price_selectable:c.find(':input[name="product[base_price_selectable]"]').val(),
currency:c.find("select.s-product-currency").val()},a.product.skuTypeFeaturesSelectableLoad(b,c);else a.product.onSkuTypeEnabled();else c.hide(),c.find("input").attr("disabled",!0),c=a(this.options.form_selector).find(".s-product-skus"),"new"==a.product.path.id?a.product.disableSkus(!1,!1):(b=c.find("tbody"),a.product.disableSkus(!0,!0),b.find(">tr:not(.s-sku-virtual)").length||(a.product.editTabMainSkuAdd(),b.find(">tr:not(.s-sku-virtual):first").find('input[name="product[sku_id]"]').attr("checked",
!0))),c.closest(".field").find(".name").show()},featureSelectableInit:function(){var b=a(this.options.form_selector),c=a("#s-product-feature-superposition"),d=b.find(".s-product-skus"),b=b.find(':input[name="product[base_price_selectable]"]');c.on("click","ul.features>li",function(){var b=a(this);b.parent().find("li.selected").removeClass("selected");b.addClass("selected");b=b.attr("data-feature-id");b=c.find(".feature-values[data-feature-id="+b+"]");c.find(".feature-values").hide();b.show();return!1});
c.on("change","ul.values>li input",function(){var b=a(this).parents("li:first").parent().find(">li input:checked").length,d=c.find("ul.features li.selected");d.find(".count").text(b||"");d.find("i").removeClass("status-blue-tiny status-gray-tiny").addClass(b?"status-blue-tiny":"status-gray-tiny");var g=[];c.find("ul.features>li").each(function(){var b=a(this);(b=parseInt(b.find(".count").text(),10))&&g.push(b)});b=c.find(".superposition-count");if(g.length){b.find(".options").text(g.join(" x ")+" "+
$_("options"));for(var d=1,h=0,k=g.length;h<k;h+=1)d*=g[h];b.find(".skus").html('<span class="highlighted">'+$_("%d SKUs in total").replace("%d",d)+"</span>")}else b.find(".options").text(""),b.find(".skus").html("")});a.shop.changeListener(b,function(){d.find(".s-sku-virtual .s-price input").val(a(this).val())});a.shop.changeListener(d,function(){var b=a(this);if("product[sku_id]"!=b.attr("name")&&(b=b.parents("tr:first"),b.length)){var c=parseInt(b.attr("data-id"),10);if(c){if(b.hasClass("js-sku-settings")&&
(b=d.find("tr[data-id="+c+"]:first"),!b.length))return;b.find("input.s-input-virtual").val(0);b.removeClass("s-sku-virtual");a("#s-product-view").find("tr[data-id="+c+"]").removeClass("s-sku-virtual")}}},"input, textarea");c.find("i.status-blue-tiny:first").parents("li").trigger("click");return c},editInit:function(){a("#s-product-edit-forms").unbind("keydown.product").bind("keydown.product",function(b){if(a(b.target).is(":input")&&b.ctrlKey&&83==b.keyCode)return a("#s-product-save-button").click(),
!1});a.shop.makeFlexibleInput("s-product-meta-title");if(!this.options.edit_rights)return window.location.hash="#/product/"+this.path.id+"/",!1;var b=a(this.options.form_selector);b.bind("submit.product",function(){return a.product.saveData("profile",null)});b.on("change.product, keyup.product","div.s-product-form:not(.ajax) :input",function(){a.product.helper.onChange(a(this).parents("div.s-product-form"))});b.on("change.product, keyup.product, keypress.product",':input[name="product[name]"]',function(){a.product.helper.onNameChange(a(this),
!1,a.product.options.update_delay||500)});var c=a("#product-tags");c.data("tags_input_init")||(c.tagsInput({autocomplete_url:"?module=product&action=tagsAutocomplete",height:120,onChange:function(){a.product.updateMetaFields()},defaultText:""}).data("tags_input_init",!0),a("#s-product-popular-tags").off("click.product","a").on("click.product","a",function(){var b=a(this).text();c.removeTag(b);c.addTag(b)}));b.on("change.product",".s-product-currency",function(){var c=a(this).val();b.find(".s-product-currency").val(c);
b.find(".s-product-currency-readonly").text(c);a("#s-product-currency-code").val(c)});b.on("change.product",':input[name="product[type_id]"]',function(){return a.product.editTabMainTypeChange(a(this))});b.on("change",'select[name="product[status]"]',function(){if(a(this).val()=="1"){a(this).prev().removeClass("no-bw").addClass("yes");a(".s-product-status-text").hide()}else{a(this).prev().removeClass("yes").addClass("no-bw");a(".s-product-status-text").show()}});b.on("change",'input[name="product[sku_type]"]',
function(){a.product.onSkuTypeChange(this.value)}).change();a.product.featureSelectableInit()},editFocus:function(){var b=this.options.duration,c=this;a("h1 .s-product-edit-link, #mainmenu .s-level2, #s-product-frontend-links").hide();a("#s-sidebar, #s-toolbar").animate({width:0},b).queue(function(){a(this).hide();a(this).dequeue();a("#s-product-edit-menu, #s-product-edit-forms, #s-product-edit-save-panel").show();"new"!=c.path.id?c.get("container").find(".back").attr("href","#/product/"+c.path.id+
...
a(this.options.form_selector).off("change.product, keyup.product");a("#s-product-edit-forms").off("click.edit-product")},editAction:function(a){this.path.mode=a.mode},editTabMainData:{sku_id:-1,stocks:{}},editTabMainInit:function(b){a("#s-product-type").each(function(){a(this).parent().get(0)!=document.body&&(a("body > #s-product-type").remove(),a(document.body).append(a(this)))});var c=a("#s-product-edit-forms .s-product-form.main"),d=this,e=c.find("table.s-product-skus:last > tbody");e.sortable({distance:5,
helper:"original",items:"> tr",handle:"i.sort",opacity:0.75,tolerance:"pointer",update:function(b,c){var f=parseInt(a(c.item).data("id"),10),j=a(c.item).prev().data("id"),j=void 0===j?0:parseInt(j,10);d.editTabMainSkuSort(f,j,a(this));j=e.find('> tr.js-sku-settings[data-id="'+f+'"]');j.length&&(j=j.detach(),a.shop.trace("detach",j),j&&(a.shop.trace("detach",e.find('> tr[data-id="'+f+'"]').length),e.find('> tr[data-id="'+f+'"]:first').after(j)))},start:function(){e.find("> tr.js-sku-settings").hide()},
stop:function(){e.find("> tr.js-sku-settings").show()}});var f=a("#s-product-frontend-url");f.inlineEditable({editLink:"#s-product-frontend-url-edit-link",editOnItself:!1,minSize:{height:15,width:100},makeReadableBy:[],beforeMakeEditable:function(b){var c=a(this).closest("span.s-product-frontend-url-not-empty"),d=c.find("span.slash"),e=c.find("i.new-window");a(b).after(d);e.hide();c.find("a.s-frontend-base-url").hide();c.find("span.s-frontend-base-url").show()},beforeBackReadable:function(){var b=
a(this).closest("span.s-product-frontend-url-not-empty"),c=b.find("span.slash");b.find("i.new-window").show();b.find("span.s-frontend-base-url").hide();b.find("a.s-frontend-base-url").show().append(c)}});parseInt(b.id,10)||f.trigger("editable");"new"==b.id&&a.product_list&&a.isArray(a.product_list.collection_hash)&&("category"==a.product_list.collection_hash[0]?c.find("select.s-product-categories").val(a.product_list.collection_hash[1]):"set"==a.product_list.collection_hash[0]&&c.find(".add-set-button").click().closest(".field").find("select:first").val(a.product_list.collection_hash[1]));
c.off("change.product","select.s-product-categories").on("change.product","select.s-product-categories",function(){var b=a(this),c=b.val(),d=b.parent(),e=d.find(".s-product-delete-from-category"),f=parseInt(c,10)||0;f?e.show():e.hide();"create"==c?(d.find(".s-new-category").show(),d.find("input.val").attr("disabled",!1),b.hide().attr("disabled",!0).addClass("js-ignore-change")):d.find("input.val").val(f)});c.off("keydown.product","input.new-category").on("keydown.product","input.new-category",function(b){if(13==
b.keyCode)return a(this).parent().find("input[type=button]").click(),!1});c.off("click.product",".s-new-category input[type=button]").on("click.product",".s-new-category input[type=button]",function(){var b=a(this).parent(),c=b.parent(),d=b.find("input[name=new_category]"),e=d.val();a.shop.jsonPost("?module=products&action=saveListSettings&category_id=0&parent_id=0",{name:e},function(e){var f=c.find("select"),j=f.find("option.separator:first").show();a.when(j.after('<option class="category" value="'+
e.data.id+'">'+e.data.name+"</option>")).then(function(){f.find("option:first").text($_("Please select a category"));f.val(e.data.id).attr("disabled",!1).show().removeClass("js-ignore-change");b.find("input.val").val(e.data.id).attr("disabled",!0);b.hide();c.find(".s-product-delete-from-category").show();d.val("");a.product.helper.onTabChanged("main",!0);a("#s-product-save-button").removeClass("green").addClass("yellow");a("#s-category-list>ul").trigger("add",[e.data,"category"])})})});c.off("click.product",
".s-product-delete-from-category").on("click.product",".s-product-delete-from-category",function(){var b=a(this),c=b.parent("div"),d=c.find("select");if(d.length)if(2<a("#s-product-edit-forms .s-product-form.main select.s-product-categories").length){d.attr("disabled",!0);var e=c.parents("div.field:first").find('input[name="product[categories.deleted]"]');if(0<parseInt(d.val())){var f=e.val().split(",");f.push(d.val());f.sort();e.val(f.join(","));a.product.helper.onChange(a.product.get("form").find("div.main:first"))}c.remove()}else d.val("selected").attr("disabled",
!1),c.find("input.val").val(0).attr("disabled",!0).parent().hide(),c.find(".s-storefront-map").html(""),c.find(".s-product-delete-from-category").hide();else e=c.parents("div.field:first").find('input[name="product[categories.deleted]"]'),d=b.parents(".value:first").find(":input:first"),0<parseInt(d.val())&&(f=e.val().split(","),f.push(d.val()),f.sort(),e.val(f.join(",")),a.product.helper.onChange(a.product.get("form").find("div.main:first"))),b.parents(".value:first").remove();return!1})},editTabMainAction:function(b){var c=
...
g.is("input,textarea")?g.val(c):d?"product[summary]"===b?g.text(c):g.html(c):g.text(c);e&&(b=a(f).attr("name"),b=b.replaceAll(/\[-[\d]+\]/,"["+e+"]"),a.shop.trace("$.product.helper.updateInput name",[b]))}},count:function(a){var c=0,d;for(d in a)a.hasOwnProperty(d)&&c++;return c}},multiSkus:function(b){var c=a("#s-product-edit-forms .s-product-form.main table.s-product-skus:first");1<b?(c.find("thead tr").show(),c.find(".s-name,.s-sku-sort").show("slow"),c.find(".delete").parent("a").show(),2==b?
c.find("> tbody:first > tr:first .s-name :input").focus():c.find("> tbody:first > tr:last .s-name :input").focus()):(c.find("thead tr").hide(),c.find(".s-name,.s-sku-sort").hide(),c.find(".delete").parent("a").hide())},editTabMainSkuAdd:function(){try{var b=a("#s-product-edit-forms .s-product-form.main table.s-product-skus:first").find("tbody:first"),c=0,d="0";b.find(':input[name$="[price]"]').each(function(){var b=a(this),e=b.val()?b.val().replace(",","."):0,e=parseFloat(e);e>c&&(c=e,d=b.val()||
"0")});var e=0;b.find(':input[name$="[purchase_price]"]').each(function(){e=Math.max(e,parseFloat(a(this).val())||0)});a.product.multiSkus(b.find("tr:not(.js-sku-settings)").length+1);var f={id:--a.product.editTabMainData.sku_id,product_id:a('input:hidden[name="product[id]"]').val()||"new",sku:"",available:1,name:"",price:""+c,price_loc:d,purchase_price:""+e,stock_icon:{"0":"<i class='icon10 status-green' ></i>"},stock:{},count:null};a.shop.trace("$.product.editTabMainSkuAdd",[a.product.editTabMainData.sku_id,
f]);b.append(tmpl("template-sku-edit",{sku_id:a.product.editTabMainData.sku_id,sku:f,stocks:this.getData("main","stocks"),stock_ids:this.getData("main","stock_ids")},!0));b.find(".s-product-currency").trigger("change")}catch(g){a.shop.error(g.message,g)}return!1},editTabMainSkuSort:function(b,c,d){try{a.post("?module=product&action=skuSort",{product_id:this.path.id,sku_id:b,after_id:c},function(b){a.shop.trace("$.product.editTabMainSkuSort result",b);b.error&&(a.shop.error("Error occurred while sorting product SKUs",
...
a.product_images&&a.product_images.options&&a.product_images.options.enable_2x&&a.fn.retina&&e.find(".s-product-image-crops img").retina();if(0<b){a.shop.trace("fileupload",[e.find(".fileupload").length,typeof e.find(".fileupload").fileupload]);try{var c=document.cookie.match(/(?:^|; )_csrf=([^;]*)/),f=c?decodeURIComponent(c[1]):"";e.find(".fileupload:first").fileupload({dropZone:null,url:"?module=product&action=skuEproductUpload",acceptFileTypes:/(\.|\/)(gif|jpe?g|png)$/i,start:function(){e.find(".fileupload:first").hide()},
progress:function(b,c){a.shop.trace("fileupload progress",c);var d=e.find(".js-progressbar-container");d.show();d.find(".progressbar-inner:first").css("width",Math.round(100*c.loaded/c.total,0)+"%")},done:function(b,c){a.shop.trace("fileupload done",[c.result,typeof c.result]);var f=(c.result.files||[]).shift();e.find(".js-progressbar-container").hide();if(!f||f.error)e.find(".error-message").text(f.error).show(),e.find(".fileupload:first").addClass("error").show();else{var g=e.find(".s-sku-attachment");
g.find("input.s-input-file-name").val(f.name);g.find(".s-file-name").text(f.name);g.find(".s-file-size").text(f.size);g.find(".s-file-description").val("");g.find("input[type=checkbox]").attr("checked",!0);g.show();d.find("input.s-input-virtual").val(0)}},fail:function(b,c){a.shop.trace("fileupload fail",[c.textStatus,c.errorThrown]);e.find(".error-message").text("error").show().text(c.errorThrown||"error");e.find(".js-progressbar-container").hide();e.find(".fileupload:first").addClass("error").show()},
formData:{product_id:a.product.path.id,sku_id:b,_csrf:f}})}catch(g){a.shop.error("Exception "+g.message,g)}}})})},editTabMainSkuImageSelect:function(b,c,d){var b=d.parents("li:first"),e=b.hasClass("selected"),f=d.parents("div.value:first");f.find("ul.s-product-image-crops li.selected").removeClass("selected");e?f.find('input[name$="[image_id]"]').val(0):(b.addClass("selected"),f.find('input[name$="[image_id]"]').val(c));a.shop.trace("$.product.editTabMainSkuImageSelect",[f,f.find(':input[name$="[image_id]"]')]);
a.product.helper.onChange(d.parents("div.s-product-form"))},editTabMainSkuEproductSave:function(b){b=a("#s-product-edit-forms .s-product-form.main tr.js-sku-settings"+(b&&0<b?'[data-id="'+b+'"]':"")+" > td:first .fileupload");a.shop.trace("$.product.editTabMainSkuEproductSave",b.length);b.length&&b.fileupload("start")},editTabMainSkuEproductDelete:function(){},editTabMainLinkEdit:function(){return!1},editTabMainTypeSelect:function(a){var c=a.parents("form").find(':input[name="product[type_id]"]').parents(".value");
"main"==this.path.tab?a.hide():(c.find(".js-action").hide(),window.location.hash="/product/"+this.path.id+"/"+this.path.mode+"/");c.find(".js-type-name").hide();c.find(":input").show().focus();setTimeout(function(){c.find(":input").focus()},100)},editTabMainTypeChange:function(b){var c=b.parents(".value"),d=b.find(":selected:first"),e=d.val(),b=parseInt(d.data("sku-type"));c.find(".js-type-icon").html(d.data("icon"));c.find(".js-type-name").html(d.text());e!=c.data("type")?a("#s-product-edit-forms .s-product-form.features").length&&
"undefined"!=typeof this.editTabFeaturesReload?this.editTabFeaturesReload(e):(c=a("#s-product-edit-menu > li.features > a"),c.attr("href",c.attr("href").replace(/\/features\/.*$/,"/features/"+e+"/"))):(c=a("#s-product-edit-menu > li.features > a"),c.attr("href",c.attr("href").replace(/\/features\/.*$/,"/features/")));c=a(this.options.form_selector+' :input[name="product[sku_type]"]');a.shop.trace("sku_type",[b,c]);c.filter('[value="1"]').trigger("disabled",[b?null:!0]);e=c.parents("ul");b?(c.filter(":checked").change(),
e.find('[data-sku-type="1"]').hide()):(c.filter('[value="0"]').trigger("checked",!0).change(),e.find('[data-sku-type="1"]').show())},editTabMainUpdate:function(b,c,d){var e=a("#s-product-edit-forms .s-product-form.main table.s-product-skus tbody"),f=a("#s-product-view table.s-product-skus tbody");e.find('tr[data-id^="-"]').remove();f.find('tr[data-id^="-"]').remove();e.parents("table").find("tr:hidden").show();var g=[],h;for(h in b.skus||{})g.push(a.extend({id:h},b.skus[h]));g=g.sort(function(a,b){return a.sort-
b.sort});h=this.getData("main","stocks");var k=this.getData("main","stock_ids"),j="";tmpl.cache["template-sku-edit"]=tmpl(tmpl.load("template-sku-edit"));for(var m=0,l=g.length;m<l;m+=1)j+=tmpl("template-sku-edit",{sku_id:g[m].id,sku:g[m],stocks:h,stock_ids:k,checked:g[m].id==b.sku_id});e.html(j);e.find("select.s-product-currency").val(b.currency);e.parent().show();e.closest(".s-sku-list").show();this.multiSkus(e.find("tr:not(.js-sku-settings)").length);j="";m=0;for(l=g.length;m<l;m+=1)j+=tmpl("template-sku",
{sku_id:g[m].id,sku:g[m],stocks:h,stock_ids:k,runout:b.runout||{}});f.html(j);(!d||"new"==d)&&e.parents("div.field-group:first").after(a("#s-sku-type-field-group"));c&&(d=a("#s-product-feature-superposition .superposition-count"),d.find(".options").text(c.options),d.find(".skus").html('<span class="highlighted">'+c.skus+"</span>"));var i=/#\/product\/new\//,p="#/product/"+b.id+"/";a("#s-product-edit-forms .s-product-form.main table.s-product-skus tbody, #s-product-view table.s-product-skus tbody").find('[href*="#/product/new/"]').each(function(){a(this).attr("href",
a(this).attr("href").replace(i,p))})},editTabDescriptionsBlur:function(){var b=a("#s-product-description-content");b.length&&b.data("redactor")&&b.waEditor("sync")},editTabDescriptionsAction:function(){var b=a("#s-product-description-content");if(b.length&&!b.data("redactor")){var c=b.parents("div.s-product-form");b.waEditor({lang:wa_lang,toolbarFixedTopOffset:a("#mainmenu").length?a("#mainmenu").height():0,uploadFields:b.data("uploadFields"),changeCallback:function(){b.length&&(b.waEditor("sync"),
...
maxSize:{width:550},inputClass:"s-title-h1-edit",beforeMakeEditable:function(){a("#s-edit-product").hide()},afterBackReadable:function(b,e){a("#s-edit-product").show();if(!e.changed)return false;a.shop.jsonPost("?module=product&action=save&id="+a.product.path.id,{update:{name:a(b).val()}},function(e){var g=a(b).val();document.title=g+a.product.options.title_suffix;e.status==="ok"&&e.data&&a("#s-product-meta-title").attr("placeholder",e.data.default_meta_title);c.find('input[name="product[name]"]').val(g)})},
hold:function(){return!a(this).hasClass("editable")}})}this.call("profileLazyInit",[])},profileLazyInit:function(){sales_data&&sales_data.length?a("#product-sales-plot").data("graph_rendered")||(showSalesGraph(sales_data),a("#product-sales-plot").data("graph_rendered",1)):a("#product-sales-plot").remove();if(sku_plot_data&&sku_plot_data.length&&sku_plot_data[0]&&sku_plot_data[0].length){if(!a("#product-sku-plot").data("graph_rendered")){var b=[];a.each(sku_plot_data[0],function(a,d){b.push({label:d[0],
value:d[1]})});showPieGraph(b,{color_type:"products"});a("#product-sku-plot").data("graph_rendered",1)}}else a("#product-sku-plot").remove()},updateMetaFields:function(){var b=a(".s-product-name-input").val();a("#s-product-meta-title").attr("placeholder",b);var c=[b],d=5;a(".s-sku-name-input").each(function(){if(0>=d)return!1;c.push(a(this).val());d-=1});c=c.concat(a("#product-tags").val().split(",").slice(0,5));a("#s-product-meta-keywords").attr("placeholder",c.join(", "));a("#s-product-meta-description").attr("placeholder",
...
else{var f=a("input[name=parent_id]",a.product_reviews.form),g=a.product_reviews.form.parents(".s-review:first").parent("li"),h=b.data.html,k=a("ul:first",g),j=a.product_reviews.container;g.length||(j.show(),k=a("ul:first",j).show());k.length||(k=a('<ul class="menu-v with-icon"></ul>'),g.append(k));k.append(a('<li data-id="'+b.data.id+'" data-parent-id="'+b.data.parent_id+'"></li>').append(h));a("textarea",a.product_reviews.form).val("");g=a("#s-review-add");g.find("form").length||(g.append(a.product_reviews.form),
...
f.image.id+"] img").attr("src",b.data.url_crop);a("<img>").attr("src",b.data.url_big).load(function(){a(this).remove();a.products.dispatch("#/product/"+f.product_id+"/edit/images/"+f.image.id+"/");f.coverToggle()})},"json"))});this.options.enable_2x&&a.fn.retina&&a("#s-product-image").retina();var g=!1;a(document).unbind("keydown.product_images").bind("keydown.product_images",function(b){var d=a(b.target).prop("nodeName").toLowerCase(),b=b.keyCode;if(!g&&!("text"==d||"textarea"==d||37!=b&&39!=b)){if(39==
b)return d=c.find("li.selected").next(),d.length&&!d.hasClass("dummy")&&(g=!0,location.href=d.find("a").attr("href")),!1;if(37==b)return d=c.find("li.selected").prev(),d.length&&!d.hasClass("dummy")&&(g=!0,location.href=d.find("a").attr("href")),!1}})},setImageDimensions:function(){var b=a("#s-product-image"),c=a("#s-product-one-image").parent().width(),d=this.image.dimensions;d.width=parseInt(d.width,10);d.height=parseInt(d.height,10);var e={width:"",height:""};!isNaN(d.width)&&d.width<c?(e.width=
d.width,isNaN(d.height)||(e.height=d.height)):e.width=c;b.css(e);return e},deleteImage:function(){var b=this,c=a("#s-product-image-delete-dialog");c.waDialog({onSubmit:function(){c.trigger("close");b.coverToggle();var d=c.find("form");a.shop.jsonPost(d.attr("action"),d.serialize(),function(c){var d="#/product/"+b.product_id+"/edit/images/",g=b.photo_stream.find("li.selected"),h=g.next("li:not(.dummy)");h.length?d=h.find("a").attr("href"):(h=g.prev("li:not(.dummy)"),h.length&&(d=h.find("a").attr("href")));
a(".s-product-image-crops").find("li[data-image-id="+c.data.id+"]").remove();b.coverToggle();location.href=d});return!1}})},rotateImage:function(b){var c=this;c.coverToggle();a.products.jsonPost("?module=product&action=imageRotate&id="+c.image.id,{direction:b},function(b){a("#s-product-view").find("li[data-image-id="+c.image.id+"] img").attr("src",b.data.url_crop);a("<img>").attr("src",b.data.url_big).load(function(){a(this).remove();a.products.dispatch("#/product/"+c.product_id+"/edit/images/"+c.image.id+
"/");c.coverToggle()})})},setBadge:function(b,c,d){var c=c||b,e=a("#photo-organize-menu"),f=e.find("li[data-type="+b+"]");f.find("a").append('<span class="count"><i class="icon16 loading"></i></span>');a.shop.jsonPost("?module=product&action=badgeSet&id="+this.product_id,{code:c},function(c){var h=a("#s-product-one-image");h.find(".top.right").html(c.data);e.find("li.selected").removeClass("selected").find(".small").text("");f.addClass("selected");f.find("span.count").remove();h.length||(f.find("a").append('<span class="count"><i class="icon10 yes"></i></span>'),
setTimeout(function(){f.find("span.count").remove()},1E3));"custom"!=b?(a("#s-product-set-custom-badge").hide(),f.find(".small").text(c.data)):a("#s-product-set-custom-badge").show();"function"===typeof d&&d(c)})},deleteBadge:function(){a.getJSON("?module=product&action=badgeDelete&id="+this.product_id,function(){a("#s-product-one-image").find(".top.right").html("");a("#photo-organize-menu").find("li.selected").removeClass("selected").find(".small").text("")})},initListSortable:function(){this.image_list.sortable({distance:5,
helper:"clone",items:"li",opacity:0.75,tolerance:"pointer",start:function(){document.ondragstart=function(){return!1}},update:function(b,c){document.ondragstart=null;var d=a(this),e=a(c.item),f=parseInt(e.attr("data-image-id"),10),e=e.next(),g=null;e.length&&(g=parseInt(e.attr("data-image-id"),10));a.products.jsonPost("?module=product&action=imageMove",{id:f,before_id:g},function(){if("function"===typeof a.product_images.options.onSort)a.product_images.options.onSort(f,g)},function(){d.sortable("cancel")})}})},
coverToggle:function(){var b=a("#s-product-image-cover");if(b.is(":hidden")){var c=b.find(".loading");c.css({position:"absolute",left:parseInt((b.width()-c.width())/2,10)+"px",top:parseInt((b.height()-c.height())/2,10)+"px"});b.show()}else b.hide()},initListEditable:function(){this.image_list.off("click",".editable").on("click",".editable",function(){a(this).inlineEditable({inputType:"textarea",makeReadableBy:["esc"],updateBy:["ctrl+enter"],placeholderClass:"gray",placeholder:a.product_images.options.placeholder,
minSize:{height:40},allowEmpty:!0,beforeMakeEditable:function(b){var c=a(this);b.css({"font-size":c.css("font-size"),"line-height":c.css("line-height")}).width(c.parents("li:first").find("img").width());var d=this.id+"-button",e=a("#"+d);e.length||(b.after('<br><input type="button" id="'+d+'" value="'+$_("Save")+'"> <em class="hint" id="'+this.id+'-hint">Ctrl+Enter</em>'),a("#"+d).click(function(){c.trigger("readable")}));a("#"+this.id+"-hint").show();e.show()},afterBackReadable:function(b,c){var d=
a(this),d=parseInt(d.parents("li:first").attr("data-image-id"),10),e=a(b).val(),f="#"+this.id+"-";a(f+"button").hide();a(f+"hint").hide();c.changed&&a.products.jsonPost("?module=product&action=imageSave",{id:d,data:{description:e}})}}).trigger("editable")})}}})(jQuery);(function(a){a.product_stocks_log={product_id:null,container:null,options:{},init:function(b){this.options=b;this.container=b.container?a(b.container):a("body");this.options.lazy_loading&&this.initLazyLoad(this.options.lazy_loading)},initLazyLoad:function(b){var c=b.count,d=this.options.total_count,e=b.url;a(window).lazyLoad("stop");if(c<d){var f=this;a(window).lazyLoad({container:f.container,state:"undefined"===typeof b.auto||b.auto?"wake":"stop",load:function(){if(f.container.is(":visible"))a(window).lazyLoad("sleep"),
...
this.sidebar=a("#s-sidebar");var d=this.options.products;delete this.options.products;this.total_count=this.options.total_count||0;this.category_count=parseInt(this.options.category_count,10);isNaN(this.category_count)&&(this.category_count=this.total_count);this.sortable="undefined"===typeof b.sortable?this.sortable:b.sortable;this.sort=b.sort||null;if(b.enable_2x)this.container.on("append_product_list",function(){a.fn.retina&&a.product_list.container.find("img").retina()});if(d&&b.view){try{this.container.append(tmpl("template-product-list-"+
this.options.view,{products:d,sort:this.sort},"table"==this.options.view)),this.container.trigger("append_product_list",[d])}catch(e){return console.log("Error: "+e.message),this}delete b.products}this.collection_hash=a.isArray(this.options.collection_hash)&&this.options.collection_hash.length?this.options.collection_hash:[];this.collection_param=this.options.collection_param?this.options.collection_param:"";b.order&&(this.order=b.order);this.options.lazy_loading&&this.initLazyLoad(this.options.lazy_loading);
this.initSelecting();this.initView(this.options.view);this.initDragndrop();this.initSortingNotice();this.rubberTable()}catch(f){a.shop.error("$.product_list.init error: "+f.message,f)}return this},initSortingNotice:function(){if(!a.storage.get("shop/list-sorting-notice-closed")){var b=a("#custom-backend-order-notice");if(b.length)b.show().on("click",".close",function(){a.storage.set("shop/list-sorting-notice-closed","1");b.remove()})}},initLazyLoad:function(b){var c=b.count,d=this.total_count;a(window).lazyLoad("stop");
if(c<d){var e=this,f=e.container.find("tr.header th[data-additional-column]").map(function(){return a(this).data("additional-column")}).get().join(",");a(window).lazyLoad({container:e.container,state:"undefined"===typeof b.auto||b.auto?"wake":"stop",hash:["","products"],load:function(){a(window).lazyLoad("sleep");a(".lazyloading-link").hide();a(".lazyloading-progress").show();a.get("?module=products&action=loadList&offset="+c+("&total_count="+d)+(e.collection_param?"&"+e.collection_param:"")+(e.sort?
"&sort="+e.sort:"")+(e.order?"&order="+e.order:"")+("&enabled_columns="+(f||"")),function(b){if("ok"==b.status&&b.data.count){c+=b.data.count;var f=e.container;try{e.container.append(tmpl("template-product-list-"+e.options.view,{products:b.data.products,check_all:"table"==e.options.view?f.find(".s-select-all:first").attr("checked"):!1,sort:a.product_list.sort})),e.container.trigger("append_product_list",[b.data.products])}catch(k){console.log("Error: "+k.message);a(window).lazyLoad("stop");return}f.find(".last").removeClass("last");
f.find(".product:last").addClass("last");a(".lazyloading-progress-string").text(b.data.progress.loaded+" "+b.data.progress.of);a(".lazyloading-progress").hide();a(".lazyloading-chunk").text(b.data.progress.chunk);c>=d?(a(window).lazyLoad("stop"),a(".lazyloading-link").hide()):(a(".lazyloading-link").show(),a(window).lazyLoad("wake"))}else b.data&&!b.data.count?console&&(console.log("Count of again loaded products is 0"),a(".lazyloading-progress").hide()):(b.errors&&console&&console.log("Error when loading products: "+
b.errors),a(window).lazyLoad("stop"))},"json")}});a(".lazyloading-link").die("click").live("click",function(){a(window).lazyLoad("force");return!1})}},initSelecting:function(){var b=this.container,c=this.toolbar.find(".count"),d=b.find(".s-select-all:first"),e=function(){var a=parseInt(b.find("> .product.selected").length,10);a?c.text(a).show():c.text("").hide()};a(document).keydown(function(a){16==a.keyCode&&(document.body.onselectstart=function(){return!1})}).keyup(function(a){16==a.keyCode&&(document.body.onselectstart=
null)});b.off("select",".product").on("select",".product",function(b,c,h){h=void 0!==h?h:!0;(void 0!==c?c:1)?a(this).addClass("selected").find("input:first").attr("checked",!0):(a(this).removeClass("selected").find("input:first").attr("checked",!1),d.is(":checked")&&d.attr("checked",!1));h&&e();return!1});d.unbind("select").bind("select",function(d,e){var e=void 0!==e?e:!0,h=a(this);e?(h.attr("checked",!0),b.find("> .product").trigger("select",!0,!1),c.text(h.attr("data-count")).show()):(h.attr("checked",
!1),b.find("> .product").trigger("select",!1,!1),c.text("").hide())});b.off("click",".product input").on("click",".product input",function(c,g){var h=c.shiftKey,k=this.checked;g&&(h=g.shiftKey,k=g.checked);var j=a(this).parents(".product:first");k?j.addClass("selected"):(d.is(":checked")&&d.attr("checked",!1),j.removeClass("selected"));if(h&&k){(h=b.data("last_checked"))||(h=b.find("> .product:first").trigger("select",!0));var m=j.prevAll(".selected[data-product-id="+h.attr("data-product-id")+"]"),
l;if(m.length){l=j.prev();for(h=h.get(0);l.length&&h!=l.get(0);)l.addClass("selected").find("input").attr("checked",!0),l=l.prev()}else if(m=j.nextAll(".selected[data-product-id="+h.attr("data-product-id")+"]"),m.length){l=j.next();for(h=h.get(0);l.length&&h!=l.get(0);)l.addClass("selected").find("input").attr("checked",!0),l=l.next()}!b.data("last_checked")&&!m.length&&h.trigger("selected",!1)}k&&b.data("last_checked",j);e()});if(a.browser.mozilla)b.off("click",".product label").on("click",".product label",
function(b){if(b.shiftKey){var c=a(b.target);a(c).is("label")||(c=a(c).parents("label:first"));c=a("#"+c.attr("for"));c.trigger("click",{shiftKey:b.shiftKey,checked:!c.attr("checked")})}})},initView:function(b){try{var c=this.container,d=this.sidebar;"table"==b&&c.find(".s-select-all:first").click(function(){a(this).trigger("select",this.checked)});var e="view="+b;d.find(".s-collection-list li.dr").each(function(){var b=a(this);b.find("a:first").attr("href","#/products/"+b.attr("id").replace("-",
"_id=")+"&"+e)});a("#s-products-search").autocomplete("disable").val(this.options.text||"").autocomplete("enable");c="s-all-products";a.product_list.collection_hash.length&&("search"!==a.product_list.collection_hash[0]&&"tag"!==a.product_list.collection_hash[0])&&(c=a.product_list.collection_hash.join("-"));a.shop.trace("$.product_list.initView",[b,c]);d.find("li.selected").removeClass("selected");var f=d.find("#"+c);0>=f.length&&window.location.hash&&(f=d.find('a[href="'+window.location.hash+'"]').parent());
0>=f.length&&(f=d.find("#s-all-products"));f.addClass("selected");a.product_list.collection_hash.length&&("search"!==a.product_list.collection_hash[0]&&"tag"!==a.product_list.collection_hash[0])&&f.find(".count:first").text(this.category_count);a("#s-content").find(".sort").unbind("click").bind("click",function(){location.href=a(this).find("a").attr("href");return!1});a.product_list.fixed_blocks=a.product_list.initFixedBlocks();this.initEditingControls();this.initToolbar();a(document).trigger("product_list_init_view")}catch(g){a.shop.error("$.product_list.initView error: "+
g.message,g)}},initFixedBlocks:function(){var b=a("#mainmenu").height(),c=a("#s-sidebar").width(),d=a(window),e=a("#s-fixed-blocks");e.length||(e=a('<div id="s-fixed-blocks"></div>').css({display:"none",position:"fixed",background:"#fff",top:b,width:c,"float":"left"}).appendTo("#s-sidebar"));var f=a("#s-category-list"),g=a("#s-category-list-block"),h=a("#s-set-list"),k=a("#s-set-list-block"),j,m=function(){if(!n){var h=a("#"+o);s=a.categories_tree.isCollapsed(h);q=f.is(":hidden");var k=a('<div id="'+
p+'" class="block"></div>').css({height:g.height()});g.replaceWith(k);e.show().append(g.hide());g.find(".heading").before('<span class="hint float-right" style="margin-top: 3px;">'+$_("Drag products here")+"</span>");s&&a.categories_tree.expand(h,null,function(){a.categories_tree.collapse(h)});q||f.hide();g.show();a("i.add",g).hide();a("#"+o).hide();g.css({"overflow-x":"hidden","overflow-y":"auto"});var j=f.is(":hidden"),i;g.bind("mousemove.fixed_blocks.category",function(){document.getElementById("products-helper")&&
j&&(i&&(clearTimeout(i),i=null),i=setTimeout(function(){if(j){g.css({height:""});f.show();var a=g.height(),c=(d.height()-b)/2;g.css({height:Math.min(a,c)});g.find(".heading").prev(".hint").hide();j=false}},250))});d.bind("mouseout.fixed_blocks.category",function(a){a.pageX>c+10&&(i&&clearTimeout(i),i=null,j||(f.hide(),g.css({height:""}),g.find(".heading").prev(".hint").show(),j=!0))});n=!0}},l=function(){if(n){var b=a("#"+p);b.replaceWith(g);g.css({"overflow-x":"","overflow-y":""});var c=a("#"+o);
s&&a.categories_tree.collapse(c);q||f.show();g.find(".heading").prev(".hint").remove();a("#"+o).show();a("i.add",g).show();b.remove();g.unbind("mousemove.fixed_blocks.category");d.unbind("mouseout.fixed_blocks.category");e.children().length||e.hide();n=!1}},i=g.offset().top,p="s-category-list-dummy",o="s-category-list-handler",n=!1,q,s;d.unbind("scroll.fixed_blocks.category").bind("scroll.fixed_blocks.category",function(){n||(i=g.offset().top);var c=i,c=document.getElementById(p)?c+a("#"+p).height():
c+a("#s-category-list-block").height();d.scrollTop()+b+5>=c?m():l()});j={setFixed:m,unsetFixed:l};var t=function(){if(!u){r=h.is(":hidden");var f=a('<div id="'+v+'" class="block"></div>').css({height:k.height()});k.replaceWith(f);e.show().append(k);k.find(".heading").before('<span class="hint float-right" style="margin-top: 3px;">'+$_("Drag products here")+"</span>");r||h.hide();a("i.add",k).hide();a("i.collapse-handler",k).hide();k.css({"overflow-x":"hidden","overflow-y":"auto"});var g=h.is(":hidden"),
j;k.bind("mousemove.fixed_blocks.set",function(){document.getElementById("products-helper")&&g&&(j&&(clearTimeout(j),j=null),j=setTimeout(function(){if(g){k.css({height:""});h.show();var a=k.height(),c=(d.height()-b)/2;k.css({height:Math.min(a,c)});k.find(".heading").prev(".hint").hide();g=false}},250))});d.bind("mouseout.fixed_blocks.set",function(a){a.pageX>c+10&&(j&&clearTimeout(j),j=null,g||(h.hide(),k.css({height:""}),k.find(".heading").prev(".hint").show(),g=!0))});u=!0}},w=function(){if(u){var b=
a("#"+v);b.replaceWith(k);k.css({"overflow-x":"","overflow-y":""});k.find(".heading").prev(".hint").remove();r||h.show();a("i.add",k).show();a("i.collapse-handler",k).show();b.remove();k.unbind("mousemove.fixed_blocks.category");d.unbind("mouseout.fixed_blocks.category");e.children().length||e.hide();u=!1}},x=k.offset().top,v="s-set-list-dummy",r,u=!1;d.unbind("scroll.fixed_blocks.set").bind("scroll.fixed_blocks.set",function(){u||(x=k.offset().top);var c=x,c=document.getElementById(v)?c+a("#"+v).height():
c+a("#s-set-list-block").height();d.scrollTop()+b+5>=c?t():w()});return{category:j,set:{setFixed:t,unsetFixed:w}}},initEditingControls:function(){var b=a("#s-product-list-title");b.hasClass("editable")&&(b.inlineEditable({minSize:{width:350},maxSize:{width:600},size:{height:30},inputClass:"s-title-h1-edit",beforeMakeEditable:function(){a(".s-product-list-manage").hide()},afterBackReadable:function(b,c){a(".s-product-list-manage").show();if(!c.changed)return!1;a.shop.jsonPost("?module=products&action=saveListSettings&"+
a.product_list.collection_param+"&edit=name",{name:a(b).val()},function(b){a.product_list.sidebar.find("#"+a.product_list.collection_hash[0]+"-"+b.data.id).find(".name:first").html(b.data.name)})}}),"name"==this.options.edit&&b.trigger("editable"));var c=a.product_list.collection_hash[0],b=a("#s-product-list-settings");b.length&&("category"==c||"set"==c)&&b.unbind("click").bind("click",function(){a.product_list.settingsListDialog();return false});b=a("#s-product-list-delete");b.length&&("category"==
c||"set"==c)&&b.unbind("click").bind("click",function(){a("#s-product-list-delete-dialog").waDialog({disableButtonsOnSubmit:true,onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(){function b(a,c){if(!a.length)return c&&c();var f=a.shift();e(["category",f],function(){b(a,c)})}function e(b,c){var d={hash:b.join("/")||"all",remove:["list"]};g&&d.remove.push("products");var e=function(){a.product_list.remove(d,function(d){var e=b[0],f=a("#"+b.join("-")),g=f.prev(".drag-newposition"),
j=a("#s-"+b[0]+"-list"),m=j.find("ul:first");if(e=="set"){f.remove();g.remove()}else{e=f.find("ul:first");if(e.length){e.find(">li.drag-newposition:first").remove();f.hide();e.find(">li").each(function(){f.after(this)})}e=f.parents("ul:first");f.remove();g.remove();if(!e.find("li.dr").length)if(m.get(0)!=e.get(0)){e.parents("li:first").find("i.collapse-handler").remove();e.closest("li").find(".collapse-handler-ajax:first").remove();e.remove()}else m.closest(".block").find(".collapse-handler-ajax:first").remove()}if(m.find("li.dr:first").length){m.show();
j.find(".s-empty-list").hide()}else{m.hide();j.find(".s-empty-list").show()}d.data.old_parent_category&&(typeof d.data.old_parent_category.children_count!=="undefined"&&!parseInt(d.data.old_parent_category.children_count,10))&&a("#category-"+d.data.old_parent_category.id+"-handler").remove();a.product_list.sidebar.trigger("update",d.data.lists);c&&c()})},f=a("#"+b.join("-")+"-handler");f.length?a.categories_tree.expand(f,function(a){a.parent().find("ul:first").hide();e()}):e();return false}var f=
a(this);f.find(".dialog-buttons i.loading").show();var g=f.find("input[name=s-delete-products]:checked").val()=="1";if(c=="category"&&f.find('input[name="s-delete-sub"]').is(":checked")){f=a("#category-"+a.product_list.collection_hash[1]).find('li[id^="category-"]').map(function(){return parseInt(this.id.substr(9),10)}).get().reverse();f.push(a.product_list.collection_hash[1]);b(f,function(){location.href="#/"})}else e(a.product_list.collection_hash,function(){location.href="#/"});return false}});
return false});"set"===c&&a("#s-embed-code").click(function(){a("#s-product-list-embed-dialog").waDialog();return false})},initDragndrop:function(){a.product_dragndrop.init({products:!0,view:this.options.view,sort:this.options.sort}).bind("move_product",function(b){a.shop.jsonPost("?module=product&action=move&"+a.product_list.collection_param,{product_ids:b.product_ids,before_id:b.before_id||null},b.success,b.error)}).bind("is_product_sortable",function(){return a.product_list.sortable}).bind("add_to_list",
function(b){var c={};b.whole_list?c.hash=a.product_list.collection_hash.join("/")||"all":c.product_id=b.product_ids;a.shop.jsonPost("?module=product&action=addToList&"+b.collection_param,c,b.success,b.error)})},initToolbar:function(){var b=this.toolbar;b.find("li").unbind("click.product_list").bind("click.product_list",function(){var b=a(this).attr("data-action");if(b){var c=a.product_list.getSelectedProducts("delete"!=b);if(!c.count)return alert($_("Please select at least one product")),!1;switch(b){case "new-set":break;
case "category":a.product_list.categoriesDialog(c);break;case "set":a.product_list.setsDialog(c);break;case "type":a.product_list.typesDialog(c);break;case "assign-tags":a.product_list.assignTagsDialog(c);break;case "delete":a.product_list.deleteProductsDialog(c);break;case "delete-from-set":"set"==a.product_list.collection_hash[0]&&a.product_list.deleteFromSet(c);break;case "delete-from-category":"category"==a.product_list.collection_hash[0]&&a.product_list.deleteFromCategory(c);break;case "export":a.product_list.exportProducts(c,
a(this).attr("data-plugin"));break;case "duplicate":a.product_list.duplicateProducts(c,a(this));break;case "set-badge":case "delete-badge":a.product_list.setBadge(c,a(this));break;default:return}return!1}});b.find('li[data-action="set-custom-badge"] a').click(function(){a(this).parent().find(".textarea-wrapper").slideToggle("fast");return!1}).closest("li").find(".textarea-wrapper").click(function(){return!1}).find("input").click(function(){var b=a.product_list.getSelectedProducts(!0);b.count?a.product_list.setBadge(b,
a(this).closest("li")):alert($_("Please select at least one product"));return!1});var c,d=a("#mainmenu").height(),e=b.find(":first").offset().top-d,f=a(document),g=a(window);f.bind("scroll",c=function(){jQuery.contains(document.documentElement,b[0])?f.scrollTop()>e&&b.height()+d<g.height()?b.addClass("s-fixed").css({top:d}):b.removeClass("s-fixed"):(f.off("scroll",c),g.off("resize",c))});g.bind("resize",c)},getSelectedProducts:function(b){var b=b||!1,c={count:0};if(this.container.find(".s-select-all:first").attr("checked")){var d=
a.product_list.collection_hash.join("/")||"all";b?c.serialized=[{name:"hash",value:d}]:c.hash=d;c.count=this.total_count}else b?c.serialized=a.product_list.container.find(".product.selected").map(function(){c.count+=1;return{name:"product_id[]",value:a(this).attr("data-product-id")}}).toArray():c.product_id=a.product_list.container.find(".product.selected").map(function(){c.count+=1;return a(this).attr("data-product-id")}).toArray();return c},categoriesDialog:function(b){var c=a("#s-categories"),
d=this.sidebar,e=this.container;c.length&&c.parent().remove();a("<div></div>").appendTo("body").load("?module=dialog&action=categories",function(){a("#s-categories").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){var c=a(this);c.find(".dialog-content h1 span").text("("+b.count+")").show();c.find(".dialog-buttons i.loading").hide();c.find("input[name=new_category_name]").val("");c.find("input[name=new_category]").attr("checked",!1)},onSubmit:function(c){var g=c.find("form");g.find(".dialog-buttons i.loading").show();
a.shop.jsonPost(g.attr("action"),g.serializeArray().concat(b.serialized),function(b){b.data.new_category&&a("#s-category-list ul:first").trigger("add",[b.data.new_category,"category","#/products/category_id="+b.data.new_category+"&view="+a.product_list.options.view]);b.data.categories&&(d.trigger("update",[{category:b.data.categories}]),e.find(".s-select-all:first").trigger("select",!1));g.find("input:checked").attr("checked",!1);c.trigger("close")});return!1}})})},setsDialog:function(b){var c=a("#s-sets"),
d=this.sidebar,e=this.container;c.length&&c.parent().remove();a("<div></div>").appendTo("body").load("?module=dialog&action=sets",function(){a("#s-sets").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){var c=a(this);c.find(".dialog-content h1 span").text("("+b.count+")").show();c.find(".dialog-buttons i.loading").hide();c.find("input[name=new_set_name]").val("");c.find("input[name=new_set]").attr("checked",!1)},onSubmit:function(c){var g=c.find("form");g.find(".dialog-buttons i.loading").show();
a.shop.jsonPost(g.attr("action"),g.serializeArray().concat(b.serialized),function(b){b.data.new_set&&a("#s-set-list ul:first").trigger("add",[b.data.new_set,"set","#/products/set_id="+b.data.new_set+"&view="+a.product_list.options.view]);b.data.sets&&(d.trigger("update",[{set:b.data.sets}]),e.find(".s-select-all:first").trigger("select",!1));g.find("input:checked").attr("checked",!1);c.trigger("close")});return!1}})})},assignTagsDialog:function(b){var c=a("#s-assign-tags");c.length&&c.remove();a.post("?module=dialog&action=assignTags",
b.serialized,function(c){a("body").append(c);a("#s-assign-tags").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){var c=a(this);c.find(".dialog-content h1 span").text("("+b.count+")").show();c.find(".dialog-buttons i.loading").hide()},onSubmit:function(c){var d=a(this),g=d.find("#s-assign-tags-list_tag");if(g.length){var h=jQuery.Event("keypress",{which:13});g.trigger(h)}d.find(".dialog-buttons i.loading").show();var k=d.attr("action");setTimeout(function(){var g=d.serializeArray().concat(b.serialized);
a.shop.jsonPost(k,g,function(b){b.data.cloud&&a("#s-tag-cloud").trigger("update",[b.data.cloud]);c.trigger("close");a.products.dispatch()},function(){c.trigger("close")})},10);return!1}})})},typesDialog:function(b){var c=a("#s-types"),d=this.container,e=this.sidebar,f=function(){a("#s-types").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(c){var f=a(this);f.find(".dialog-buttons i.loading").show();a.shop.jsonPost(f.attr("action"),
f.serializeArray().concat(b.serialized),function(b){e.trigger("update",{type:b.data.types});d.find(".s-select-all:first").trigger("select",!1);f.find("input:checked").attr("checked",!1);c.trigger("close");a.products.dispatch()});return!1}})},g=c.parent();c.length?f():(g=a("<div></div>").appendTo("body"),g.load("?module=dialog&action=types",f))},deleteFromSet:function(b){0<b.count&&a.shop.jsonPost("?module=products&action=deleteFromSet&id="+this.collection_hash[1],b.serialized,function(){a.products.dispatch()})},
deleteFromCategory:function(b){0<b.count&&a.shop.jsonPost("?module=products&action=deleteFromCategory&id="+this.collection_hash[1],b.serialized,function(){a.products.dispatch()})},deleteProductsDialog:function(b){var c=a("#s-product-list-delete-products-dialog"),d=c.parent();c.length||(d=a("<div></div>").appendTo("body"));d.load("?module=dialog&action=productsDelete&count="+b.count,function(){a("#s-product-list-delete-products-dialog").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},
onSubmit:function(c){a(this).find(".dialog-buttons i.loading").show();a.product_list.remove(a.extend(b,{remove:["products"]}),function(b,d){a.product_list.sidebar.trigger("update",b.data.lists);a.products.dispatch();c.trigger("close");d.length&&alert((c.data("not-allowed-string")||"").replace("%d",d.length))});return!1}})})},settingsListDialog:function(){var b=a("#s-product-list-settings-dialog");(b.length?b.parent():a("<div></div>").appendTo("body")).load("?module=dialog&action=productListSettings&"+
...
"_id="+e[1],e[0]+"_id="+c.data.id),g=a("#"+e.join("-"));g.find(".name:first").html(c.data.name);a.isArray(c.data.routes)&&c.data.routes.length?g.find(".routes:first").html(" "+c.data.routes.join(" ")):g.find(".routes:first").html(" ");c.data.status=="0"?g.children("a").addClass("gray"):c.data.status=="1"&&g.children("a").removeClass("gray");g.find(".id:first").html(c.data.id);g.attr("id",e[0]+"-"+c.data.id);g.find("a").attr("href",f);if("sort_products"in c.data){f=f.replace(/&sort=[^&]*/,"&sort=");
...
a.products.dispatch()},error:function(){}}))},setBadge:function(b,c){function d(b){var d="delete-badge"==e?null:b.data;a("#product-list [data-product-id]").each(function(){var b=a(this);f[b.data("product-id")]&&(b.is("tr")?(b=b.find(".s-image a"),b.find(".s-image-corner").remove(),d&&b.prepend(a('<div class="s-image-corner"></div>').html(d))):(b=b.find(".s-product-image a"),b.find(".s-image-corner.top.right").remove(),d&&b.append(a('<div class="s-image-corner top right"></div>').html(d))))});"set-custom-badge"==
e&&c.parent().find(".textarea-wrapper").slideUp("fast");c.find(".loading").remove();c.find("a").append(a('<span class="count"><i class="icon16 yes"></i></span>').animate({opacity:0},function(){a(this).remove()}));a.product_list.container.find(".s-select-all:first").trigger("select",!1)}var e=c.data("action");"set-custom-badge"!=e&&c.parent().find(".textarea-wrapper").slideUp("fast");c.find(".loading").remove();c.find("a").append('<span class="count"><i class="icon16 loading"></i></span>');var f={};
a.each(b.serialized,function(){f[this.value]=1});if("delete-badge"==e)c.find(".loading").remove(),a.shop.jsonPost("?module=product&action=badgeDelete",b.serialized,d);else{var g;g="set-custom-badge"==e?c.find("textarea").val():c.data("type");var h=b.serialized;h.push({name:"code",value:g});a.shop.jsonPost("?module=product&action=badgeSet",h,d)}},duplicate:function(b,c){var d=this,e=[];a.shop.jsonPost("?module=products&action=duplicate",{hash:b,limit:50,offset:c.offset||0},function(a){if("ok"==(a.status||
"error"))e=e.concat(a.data.new_ids||[]),a.data.offset<a.data.total_count?(c.offset=a.data.offset,d.duplicate(b,c),c.progress(a.data||{})):c.finish(a.data||{},e)})},remove:function(b,c){var d={},e=[],f;b.product_id?f=function(){100>=b.product_id.length&&(d.get_lists=!0);d.product_id=b.product_id.splice(0,100);a.shop.jsonPost("?module=products&action=deleteList",d,function(a){a.data.not_allowed&&a.data.not_allowed.length&&(e=e.concat(a.data.not_allowed));b.product_id.length?f():typeof c==="function"&&
c(a,e)})}:(d.hash=b.hash||this.collection_hash.join("/")||"all",d.remove=a.isArray(b.remove)&&b.remove.length?b.remove:["list"],1==d.remove.length&&"list"==d.remove[0]?f=function(){a.shop.jsonPost("?module=products&action=deleteList",d,c)}:(d.count=100,f=function(){a.shop.jsonPost("?module=products&action=deleteList",d,function(a){a.data.not_allowed&&a.data.not_allowed.length&&(e=e.concat(a.data.not_allowed));0<a.data.rest_count&&null!=a.data.rest_count?f():"function"===typeof c&&c(a,e)})}));f()},
