...
$jscomp.polyfill("Array.prototype.find",function(b){return b?b:function(b,c){return $jscomp.findInternal(this,b,c).v}},"es6-impl","es3");$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};$jscomp.symbolCounter_=0;$jscomp.Symbol=function(b){return $jscomp.SYMBOL_PREFIX+(b||"")+$jscomp.symbolCounter_++};
...
function(a,c,d){a="string"===typeof a?b(a):a;d=d||0;return a.position().top+a.outerHeight()-d-(c.scrollTop()+c.height())}}}})(jQuery);$.fn.liveDraggable=function(b){this.each(function(b,a){var c=$(this);c.data("init_draggable")&&c.die("mouseover",c.data("init_draggable"))});var a;this.die("mouseover").live("mouseover",a=function(){var c=$(this);c.data("init_draggable")||c.data("init_draggable",a).draggable(b)})};
$.fn.liveDroppable=function(b){this.each(function(b,a){var c=$(this);c.data("init_droppable")&&c.die("mouseover",c.data("init_droppable"))});var a=function(){var c=$(this);c.data("init_droppable")||(c.data("init_droppable",a).droppable(b),c.mouseover())};a.call(this);this.die("mouseover",a).live("mouseover",a)};(function(b){b.fn.inlineEditable=function(a,c){function d(){p(b(this))||b(this).addClass(m.placeholderClass).text(m.placeholder)}function e(){p(b(this))==m.placeholder&&b(this).text("").removeClass(m.placeholderClass)}function f(a){return b(a).val()?!1:(b(this).text(m.placeholder).addClass(m.placeholderClass),!0)}function g(){t="edit";this.id=this.id||(""+Math.random()).slice(2);var a=this.id+"-input",c=b("#"+a);c.length||(r.after(k(a)),c=b("#"+a));c.addClass(m.inputClass);l(c,r);m.placeholder&&p(b(this))==
m.placeholder&&e.call(r);m.beforeMakeEditable.call(this,c);u=m.truncate?r.data("real_text"):p(r);c.val(u).show().focus();r.hide();b(m.editLink).hide();if(!q){for(var a=[],d=[],f=0,g=m.makeReadableBy.length;f<g;++f){var n=m.makeReadableBy[f];"blur"==n&&c.blur(function(){"read"!=t&&h.call(this)});"enter"==n&&a.push(13);"esc"==n&&a.push(27)}f=0;for(g=m.updateBy.length;f<g;++f)n=m.updateBy[f],"alt+enter"==n&&d.push({ctrl:!1,alt:!0,shift:!1,key:13}),"ctrl+enter"==n&&d.push({ctrl:!0,alt:!1,shift:!1,key:13}),
"ctrl+s"==n&&d.push({ctrl:!0,alt:!1,shift:!1,key:17});a.length&&function(b){c.keydown(function(a){!~b.indexOf(a.keyCode)||a.ctrlKey||a.altKey||a.shiftKey||"read"!=t&&h.call(this,27==a.keyCode?u:null);if(d.length)for(var c in d){var e=d[c];if(a.keyCode==e.key&&a.ctrlKey==e.ctrl&&a.altKey==e.alt&&a.shiftKey==e.shift){r.trigger("readable");break}}})}(a);r.unbind("readable.inlineEditable").bind("readable.inlineEditable",function(a,c){if("read"!=t){var d=b("#"+(this.id+"-input"));h.call(d,d.val(),c)}});
q=!0}m.afterMakeEditable.call(this,c)}function h(a,c){c="undefined"===typeof c?!1:!0;void 0!=a&&null!=a?b(this).val(a):a=b(this).val();if(!1!==c||!1!==m.beforeBackReadable.call(r.get(0),this,{changed:a!=u,old_text:u,new_text:a})){t="read";if(!m.placeholder||!f.call(r,this))if(m.allowEmpty||a){if(m.truncate)r.data("real_text",a),r.text(a.length<m.truncate-3?a:a.substr(0,m.truncate-3)+"...");else{var e=r,g=a;m.html?e.html(g):e.text(g)}a||d.call(this)}r.show();b(this).hide();b(m.editLink).show();!1===
c&&m.afterBackReadable.call(r.get(0),this,{changed:a!=u,old_text:u})}}function k(b){switch(m.inputType){case "textarea":return'<textarea id="'+b+'" style="display:none;"></textarea>';default:return'<input type="text" id="'+b+'" style="display:none;">'}}function l(b,a){var c=m.size.height||a.height(),d=m.size.width||1.5*a.width(),c=m.minSize.height&&c<m.minSize.height?m.minSize.height:c,d=m.minSize.width&&d<m.minSize.width?m.minSize.width:d,c=m.maxSize.height&&c>m.maxSize.height?m.maxSize.height:c,
d=m.maxSize.width&&d>m.maxSize.width?m.maxSize.width:d;b.height(c);b.width(d)}function n(b){return function(){return b}}function p(b){return m.html?b.html():b.text()}if(this.length){var q=!1;if("string"==typeof a){if("setOption"==a){var m=this.data("inlineEditableSettings")||{};b.extend(!0,m,c);"undefined"!==typeof c.hold&&"function"!==typeof c.hold&&(m.hold=n(m.hold));this.data("inlineEditableSettings",m)}return this}var v=this.data("inlineEditableSettings");this.data("inlineEditableSettings",b.extend({inputType:"text",
inputClass:"",size:{height:null,width:null},minSize:{height:null,width:null},maxSize:{height:null,width:null},editLink:null,editOnItself:!0,placeholder:null,makeReadableBy:["blur","enter","esc"],updateBy:["ctrl+enter","alt+enter"],beforeBackReadable:function(){},afterBackReadable:function(){},beforeMakeEditable:function(){},afterMakeEditable:function(){},placeholderClass:"hint",truncate:!1,hold:!1,html:!1,allowEmpty:!1},v,a||{}));var m=this.data("inlineEditableSettings")||{},r=this,t="read",u="";
"function"!==typeof m.hold&&(m.hold=n(m.hold));(function(){if(!this.data("inited")){m.truncate&&"boolean"==typeof m.truncate&&(m.truncate=255);if(m.truncate){var a=m.placeholder&&m.placeholder===this.text()?"":this.text();this.data("real_text",a);this.text(a.length<m.truncate-3?a:a.substr(0,m.truncate-3)+"...")}m.placeholder&&d.call(this);m.editLink&&b(m.editLink).unbind("click.inlineEditable").bind("click.inlineEditable",function(){m.hold.call(r)||"edit"!=t&&g.call(r.get(0))});m.editOnItself&&this.unbind("click.inlineEditable").bind("click.inlineEditable",
function(){m.hold.call(r)||"edit"!=t&&g.call(this)});this.unbind("editable.inlineEditable").bind("editable.inlineEditable",function(){m.hold.call(r)||"edit"!=t&&g.call(this)});this.unbind("placeholder.inlineEditable").bind("placeholder.inlineEditable",function(a,c){c&&m.placeholder&&d.call(this);c||b(this).removeClass(m.placeholderClass)});this.data("inited",!0)}}).call(this);return this}}})(jQuery);(function(b){b.fn.photoStreamSlider=function(a){function c(){function a(c){function f(){a.execution=!1;var b="on"+k.charAt(0).toUpperCase()+k.slice(1),b=d[b];"function"==typeof b&&b.call(e);b=c.fn;"function"==typeof b&&b.call(e)}"string"==typeof c&&(c={direction:c,animate:!0});var k=c.direction||"forward",p=c.steps||h.length;if(!a.execution){a.execution=!0;var q=h.filter(":first").outerWidth()*p,t=h.length;if("forward"==k){var r=h.filter(":last").nextAll(":lt("+p+")"),p=r.length,r=r.filter(":last");
p&&(h.removeClass("visible"),r.prevAll(":lt("+(t-1)+")").addClass("visible"),r.addClass("visible"))}else r=h.filter(":first").prevAll(":lt("+p+")"),p=r.length,r=r.filter(":last"),p&&(h.removeClass("visible"),r.nextAll(":lt("+(t-1)+")").addClass("visible").show(),r.addClass("visible"));h=b("li.visible",g);t=g.position().left;"forward"==k?(p=n-l-m,t-=q,t=t>-p?t:-p):(t+=q,t=t<m?t:m);c.animate?g.animate({left:t},d.duration,f):(g.css({left:t}),f())}}var g=e.find(d.photoStream),h=b("li.visible",g),k=b("li",
g),l=h.filter(":first").outerWidth()*h.length,n=k.filter(":first").outerWidth()*k.length,p=d.height||k.filter(":first").outerHeight();g.parent().css({overflow:"hidden",height:p,position:"relative",padding:"4px 0",margin:0,width:l});for(var p=g.find("li:first"),q=h.filter(":first"),m=(q.outerWidth()-q.width())/2,v=0,r=p.outerWidth(),q=q.get(0);p.length&&p.get(0)!=q;)v+=r,p=p.next();g.css({position:"absolute",left:-(v-m),width:n});b(d.forwardLink).unbind("click").bind("click",function(){a("forward");
...
b(".block.drop-target").addClass("drag-active")},handle:".drag-handle",stop:function(c,d){document.ondragstart=null;document.onselectstart=null;var e=b(this);e.find("input:checked").length||e.removeClass("selected");a();b(document).unbind("scroll",b.product_dragndrop._scrolHelper);b(".block.drop-target").removeClass("drag-active");a()},helper:function(a,d){var e=1,f=c.find(".s-select-all");f.is(":checked")?e=f.attr("data-count"):(f=c.find(".product.selected"),f.length?-1!==f.index(this)?e=f.length:
(b(this).trigger("select",!0),e=f.length+1):b(this).addClass("selected"));return'<div id="products-helper"><span class="indicator red">'+e+'</span><i class="icon10 no-bw" style="display:none;"></i></div>'},drag:function(b,a){var c=b.originalEvent;a.position.left=c.pageX-20;a.position.top=c.pageY}})},initDropProducts:function(){b("#product-list .product").liveDroppable({disabled:!1,greedy:!0,tolerance:"pointer",over:function(c,d){if(b(this).hasClass("s-alien")||!d.draggable.hasClass("product"))return!1;
...
if(!b.product_dragndrop.trigger("is_product_sortable"))return b.product_dragndrop._unactivatePhotoListItem.call(this),b.product_dragndrop._unactivatePhotoListItem.call(d.draggable),!1;var g=null;if(c.hasClass("s-alien")){var h=c.nextAll(":not(.s-alien):first");if(h.length)g=h.attr("data-product-id"),h.before(f);else{h=c.prevAll(":not(.s-alien):first");if(!h.length||h.hasClass("selected"))return!1;g=null;h.after(f)}h.hasClass("last")&&(h.removeClass("last"),f.filter(":last").addClass("last"))}else c.hasClass("drag-active-last")||
(g=c.attr("data-product-id")),c.hasClass("last")&&c.hasClass("drag-active-last")?(c.after(f).removeClass("drag-active drag-active-last last"),f.filter(":last").addClass("last")):c.before(f).removeClass("drag-active"),c.removeClass("drag-active drag-active-last");b.product_dragndrop._unactivatePhotoListItem.call(this);b.product_dragndrop._unactivatePhotoListItem.call(d.draggable);f.trigger("select",!1);c=f.map(function(){return b(this).attr("data-product-id")}).toArray();b.product_dragndrop.trigger("move_product",
{product_ids:c,before_id:g,error:function(b){b&&console&&console.log("undefined"!==typeof b.errors?b.errors:b)}})}})},initDragCollections:function(){var a=b("#wa-app .sidebar:first"),d=a.position(),e=a.width(),a=a.height();b(".s-collection-list li.dr").liveDraggable({containment:[d.left,d.top,d.left+1.25*e,d.top+1.25*a],refreshPositions:!0,revert:"invalid",helper:function(){var a=b(this),c=a.parents(".s-collection-list:first").find("ul:first"),a=a.clone().addClass("ui-draggable dr-helper").css({position:"absolute"}).prependTo(c);
...
tolerance:"pointer",over:function(a,d){var c=b(this);if(d.draggable.attr("data-type")!=c.attr("data-type"))return!1;c.addClass("active").parent().parent().addClass("drag-active")},out:function(a,d){var c=b(this);if(d.draggable.attr("data-type")!=c.attr("data-type"))return!1;c.removeClass("active").parent().parent().removeClass("drag-active")},deactivate:function(a,d){var c=b(this);if(d.draggable.attr("data-type")!=c.attr("data-type"))return!1;(c.is(":animated")||c.hasClass("dragging"))&&c.stop().animate({height:"2px"},
300,null,function(){c.removeClass("dragging")});c.removeClass("active").parent().parent().removeClass("drag-active")},drop:function(a,d){var c=b(this),f=d.draggable,g=f.attr("data-type");if(g!=c.attr("data-type"))return!1;var h=function(b){b=b.split("-");b.shift();return b.join("-")},k=h(f.attr("id")),l=c.prev("li"),n=f.next(),p=f.prev();if(l.length&&l.attr("id")=="category-"+k&&!l.hasClass("dr-helper")||this==f.next().get(0))return!1;var q=f.parent("ul"),m=q.children("li.dr[id!=category-"+k+"]").length,
v=parseInt(h(q.parent().attr("id")),10)||0;c.after(n).after(f);c=f.parent().parent();if(c.is("li.dr")||c.is(".s-collection-list")){var r=0;c.is(".s-collection-list")||(r=parseInt(h(c.attr("id")),10)||0);c=f.nextAll("li.dr:first");l=null;c.length&&(l=h(c.attr("id"))||null);m||v===r||(q.parent("li").children("i").hide(),q.hide());b.product_dragndrop.trigger("move_list",{id:k,type:g,before_id:l,parent_id:r,success:function(a){m||v===r||(q.parent("li").children("i").remove(),q.remove(),b.categories_tree.setCollapsed(v))},
error:function(b){b&&console&&console.log("undefined"!==typeof b.errors?b.errors:b);p.after(f.next()).after(f);m||(q.parent("li").children("i").show(),q.show())}})}}})},initDropInsideCollections:function(){b(".s-collection-list li.dr a").liveDroppable({tolerance:"pointer",greedy:!0,out:function(a,d){var c=d.draggable,f=b(this).parent();if(!c.hasClass("product")&&f.attr("data-type")!=c.attr("data-type"))return!1;c.hasClass("product")&&d.helper.find("span").show().end().find("i").hide();f.removeClass("drag-newparent")},
over:function(a,d){var c=d.draggable,f=b(this).parent(),g=c.attr("data-type");if(!c.hasClass("product")&&g!=f.attr("data-type"))return!1;"set"!=g&&f.addClass("drag-newparent");if(c.hasClass("product"))return f.hasClass("dynamic")?d.helper.find("span").hide().end().find("i").show():d.helper.find("span").show().end().find("i").hide(),!1;if(!c.hasClass("dynamic")&&f.hasClass("dynamic"))return d.helper.find("i.no-bw").show(),!1;d.helper.find("i.no-bw").hide();var h='.dr[id!="'+c.attr("id")+'"]',k=b(),
l=function(b,a){if(!a.length)return b;b=b.add(a.nextUntil(h).filter("li.drag-newposition"));return 0<a.nextAll(h).length?b:l(b,a.parent().closest("li"))},c=f.prevAll(h+":first");0<c.length?(g=c.find(h),k=0<g.length?l(k,g.last()):l(k,c)):k=k.add(f.prevUntil(h).filter("li.drag-newposition"));var k=0<f.children("ul").children(h).length?k.add(f.children("ul").children("li.drag-newposition:first")):l(k,f),n=b(".drag-newposition:animated, .drag-newposition.dragging").not(k);n.stop().animate({height:"2px"},
300,null,function(){n.removeClass("dragging")});k.stop().animate({height:"10px"},300,null,function(){k.addClass("dragging")})},drop:function(a,d){var c=d.draggable,f=b(this).parent(),g=c.attr("data-type");if(!c.hasClass("product")&&("set"==g||f.attr("id")==c.attr("id")||g!=f.attr("data-type")))return!1;f.removeClass("drag-newparent");if(c.hasClass("product")){if(f.hasClass("dynamic"))return!1;var h=b("#product-list"),k={};if(h.find(".s-select-all").is(":checked"))k.whole_list=!0;else{var l=h.find(".product.selected");
k.product_ids=l.map(function(){return b(this).attr("data-product-id")}).toArray()}b.product_dragndrop.trigger("add_to_list",b.extend(k,{collection_param:f.attr("id").replace("-","_id="),success:function(b){k.whole_list?h.find(".s-select-all").trigger("select",!1):k.product_ids&&k.product_ids.length&&l.trigger("select",!1);b.data&&(f.find(">.counters .count:not(.subtree)").text(b.data.count),f.find(">.counters .subtree").text(b.data.total_count))}}));return!1}if(!c.hasClass("dynamic")&&f.hasClass("dynamic"))return!1;
var n=c.attr("id").split("-")[1];if(f.attr("id")=="category-"+n)return!1;if(c.hasClass("product"))return b("#product-list").find(".product.selected").trigger("select",!1),!1;var p=parseInt(f.attr("id").split("-")[1],10)||0,q=null,m=c.next(),v=c.prev(),r=!1;f.hasClass("drag-newposition")?q=f.parent("ul"):f.children("ul").length?q=f.children("ul"):f.find(">i.collapse-handler-ajax").length||(q=b('<ul class="menu-v with-icons dr unapproved"><li class="drag-newposition unapproved" data-type="'+g+'"></li></ul>').appendTo(f),
q.find(".drag-newposition").mouseover(),b('<i class="icon16 darr overhanging collapse-handler-ajax unapproved" id="'+g+"-"+p+'-handler"></i>').insertBefore(f.children("a")),r=!0);var t=c.parent("ul"),u=t.children("li.dr[id!=category-"+n+"]").length,w=parseInt(t.parent().attr("id").split("-")[1],10)||0;q&&q.append(c).append(m);u||w===p||(t.parent("li").children("i").hide(),t.hide());f.is("li.dr")&&b.product_dragndrop.trigger("move_list",{id:n,type:g,parent_id:p,success:function(a){u||w===p||(t.parent("li").children("i").remove(),
t.remove(),b.categories_tree.setCollapsed(w));q?(b(".s-collection-list .unapproved").removeClass("unapproved"),r?b.categories_tree.setExpanded(p):f.trigger("count_subtree")):(c.remove(),m.remove(),f.trigger("update_counters",a.data.count||{}))},error:function(a){a&&console&&console.log("undefined"!==typeof a.errors?a.errors:a);v.after(c).after(m);u||(t.parent("li").children("i").show(),t.show());b(".s-collection-list .unapproved").remove()}})}})},_scrolHelper:function(a){a=b("#products-helper");var c=
a.data("scrollTop"),e=b(document).scrollTop(),c=c?e-c:50;a.css("top",a.position().top+c+"px");a.data("scrollTop",e)},_extDragActivate:function(a,d,e){var c=e+"-last";if(d.hasClass("last")){var g=a.pageX;a=a.pageY;var h=d.width(),k=d.height(),l=d.offset();"thumbs"==b.product_dragndrop.options.view?g>l.left+.5*h&&g<=l.left+h?(d.removeClass(e).addClass(c),b.product_dragndrop._shiftToLeft(d)):g>l.left&&g<=l.left+.5*h?(d.removeClass(c).addClass(e),b.product_dragndrop._shiftToRight(d)):b.product_dragndrop._shiftAtPlace(d):
"table"==b.product_dragndrop.options.view&&(a>l.top+.5*k?d.removeClass(e).addClass(c):a>l.top&&d.removeClass(c).addClass(e));(a<l.top||a>l.top+k||g<l.left||g>l.left+h)&&d.removeClass(e).removeClass(c)}else d.addClass("drag-active")},_bindExtDragActivate:function(a,d){b(document).bind("mousemove.ext_drag_activate",function(c){b.product_dragndrop._extDragActivate(c,a,d)})},_unbindExtDragActivate:function(){b(document).unbind("mousemove.ext_drag_activate")},_activatePhotoListItem:function(){var a=b(this),
...
d&&"thumbs"==b.product_dragndrop.options.view&&b.product_dragndrop._shiftAtPlace(a)},_shiftToLeft:function(a){if("left"!==a.data("shifted")){var c=a.find(".p-wrapper");if(!c.length){var e=a.children(),c=b("<div class='p-wrapper' style='position:relative;'></div>").appendTo(a);c.append(e)}c.stop().animate({left:-15},200);a.data("shifted","left")}},_shiftToRight:function(a){if("right"!==a.data("shifted")){var c=a.find(".p-wrapper");if(!c.length){var e=a.children(),c=b("<div class='p-wrapper' style='position:relative;'></div>").appendTo(a);
c.append(e)}c.stop().animate({left:15},200);a.data("shifted","right")}},_shiftAtPlace:function(b){if(b.data("shifted")){var a=b.find(".p-wrapper");if(a.length){var c=a.children();a.stop().css({left:0});b.append(c);a.remove()}b.data("shifted","")}}}})(jQuery);(function(b){var a=function(b){var a=/^category-(.*?)-handler$/;return a.test(b.attr("id"))?b.attr("id").replace(a,function(b,a){return parseInt(a,10)||0}):0},c=function(b){if(a(b))b=b.parents("li:not(.drag-newposition):first"),d=c=b.find("ul:first");else{b=b.parent();var c=b.next(),d=c.find("ul:first")}return{parent:b,target:c,ul:d}},d=function(b,a){var d=c(b);"category"==d.parent.attr("data-type")&&d.parent.trigger("count_subtree",!1);b.removeClass("rarr").addClass("darr");d.target.show();"function"===
...
b(this).parent().hide();b.product.helper.updateSubmitButton(!0)})},parsePath:function(a){a=a.replace(/^.*#\//,"").replace(/(^\/|\/$)/,"");var c=a.split("/"),d=c.pop(),e={};d.match(/^[\w_\-]+=/)?e=b.shop.helper.parseParams(d):c.push(d);return{id:c[0]||"new",mode:c[1]||"profile",tab:c[1]?c[2]||"main":!1,tail:c.slice(3).join("/")||"",raw:a,params:e}},dispatch:function(a){"string"==typeof a&&(a=this.parsePath(a));var c=[];b.shop.trace("$.product.dispatch",[this.path,a,a.raw]);if(!this.path.id){var d=
this.get("container");d.length&&(this.path.id=d.data("product-id"),c.push("load"))}if(this.path.id!=a.id)this.path.id&&c.push("blur"),c.push("load");else{d="undefined";this.path.mode!=a.mode?(b.shop.trace("$.product.dispatch mode",this.path.mode+"->"+a.mode),this.path.mode&&this.path.tab?(b.shop.trace("$.product.dispatch tabBlur",this.path.tab+"->"+a.tab),d=this.path.tab.substr(0,1).toUpperCase()+this.path.tab.substr(1),c.push(this.path.mode+"Tab"+d+"Blur"),c.push(this.path.mode+"TabBlur"),c.push(this.path.mode+
"Blur")):c.push("focus"),c.push(a.mode+"Init"),c.push(a.mode+"Focus")):this.path.tab&&a.tab!=this.path.tab&&(b.shop.trace("$.product.dispatch tabBlur",this.path.tab+"->"+a.tab),d=this.path.tab.substr(0,1).toUpperCase()+this.path.tab.substr(1),c.push(a.mode+"Tab"+d+"Blur"),c.push(a.mode+"TabBlur"));c.push(a.mode+"Action");var e=this.tabIsLoaded(a);a.tab&&(d=a.tab.substr(0,1).toUpperCase()+a.tab.substr(1));if(a.tab&&a.tab!=this.path.tab)if(b.shop.trace("$.product.dispatch tabFocus",this.path.tab+"->"+
a.tab),e)c.push(a.mode+"TabShow"),c.push(a.mode+"TabInit"),c.push(a.mode+"Tab"+d+"Init"),c.push(a.mode+"TabFocus"),c.push(a.mode+"Tab"+d+"Focus");else{c.push(a.mode+"TabFocus");var f=a.mode+"Tab"+d+"Load";this.isCallable(f)?c.push(f):c.push(a.mode+"TabLoad")}a.tab&&e&&c.push(a.mode+"Tab"+d+"Action")}for(d=0;d<c.length;d++)if(!1===this.call(c[d],[a]))return!1},termination:function(){var b=[];if(this.path.mode&&this.path.tab){var c=this.path.tab.substr(0,1).toUpperCase()+this.path.tab.substr(1);b.push(this.path.mode+
"Tab"+c+"Blur");b.push(this.path.mode+"TabBlur");b.push(this.path.mode+"Blur")}b.push("blur");for(c=0;c<b.length;c++)this.call(b[c],[])},isCallable:function(b){return"function"==typeof this[b]},tabIsLoaded:function(a){return b("#s-product-edit-forms").find(".s-product-form."+a.tab).length?!0:!1},call:function(a,c,d){d=null;var e=this.isCallable(a);c=c||[];b.shop.trace("$.product.call",[a,c,e]);if(e)try{d=this[a].apply(this,c)}catch(f){b.shop.error("Error at method $.product."+a+". Original message: "+
f.message,f)}return d},load:function(a){var c=this.get("container");if(!c.length||c.data("product-id")!=a.id){var d=this,c="?module=product&id="+a.id;b.shop.trace("$.product.load product",c);b.products.load(c,function(){d.dispatch(a)})}this.editTabMainData.sku_id="new"==a.id?-1:0;this.editTabMainData.stocks={}},focus:function(){b("*").off(".product");this.helper.init()},blur:function(){this.path.id=null;this.path.mode=null;this.path.tab=null;this.path.tail=null;b("*").off(".product");b("#mainmenu").find(".s-level2").show();
b("#s-product-edit-menu, #s-product-edit-save-panel").hide();b("#s-sidebar").show().animate({width:b.product.options.sidebar_width},"fast").queue(function(){b(this).dequeue()});b("#s-toolbar").show().animate({width:"200px"});b("#maincontent").animate({"margin-top":"84px"},"fast");b("#s-content").animate({"margin-left":b.product.options.sidebar_width},"fast")},saveData:function(a,c,d){var e=this,f=e.get("form"),g,h="radio",k=f.find('input[name="product[sku_type]"]:first');k.is(":radio")?(g=f.find('input[name="product[sku_type]"]:checked').val(),
k=f.find('input[name="product[sku_type]"]')):(h="hidden",g=f.find('input[name="product[sku_type]"]:not(:disabled)').val());if("1"==g&&!b("#s-product-feature-superposition").find("input:checked:first").length)return"radio"==h&&(k.filter("[value=0]").attr("checked",!0),b.product.onSkuTypeChange(0)),!1;if(e.ajax.save)return setTimeout(function(){e.saveData(a,c,d)},100),!1;if(this.path.tab&&(g="editTab"+this.path.tab.substr(0,1).toUpperCase()+this.path.tab.substr(1)+"Save",!1===this.call(g)))return!1;
e.ajax.save=!0;b("#s-product-description-content").length&&b("#s-product-description-content").waEditor("sync");f.find(".s-price").find("input").each(function(){this.value=this.value.replace(/\s+/g,"")});b.shop.trace("$.product.saveData(mode="+a+", tab="+c+")");g=b("#product-tags_tag");g.length&&(h=jQuery.Event("keypress",{which:13}),g.trigger(h));b(f).find(':input[name^="product\\["]:not(:disabled)').each(function(){var a=b(this).attr("type");if("text"!=a&&"textarea"!=a)return!0;this.defaultValue==
this.value?b(this).attr("disabled",!0).addClass("js-ajax-disabled"):b(this).hasClass("js-ajax-disabled")&&b(this).removeAttr("disabled").removeClass("js-ajax-disabled")});this.refresh("submit");b.ajax({url:b(f).attr("action"),data:b(f).serializeArray(),dataType:"json",type:"post",success:function(f){if("fail"==f.status)e.refresh("error",f.errors);else if(f.data.redirect)b.shop.trace("$.product.saveData redirect",f.data.redirect),window.location.href=f.data.redirect;else{e.refresh("success",f.data.message||
"");b.shop.trace("$.product.saveData updateData",[a,c]);e.updateData(f.data,a,c);d&&"function"==typeof d&&d();if(e.path.tab&&(f="editTab"+e.path.tab.substr(0,1).toUpperCase()+e.path.tab.substr(1)+"Saved",!1===e.call(f)))return!1;b.each(e.standalone_tabs,function(b,a){if(e.path.tab!=a){var c="editTab"+a.substr(0,1).toUpperCase()+a.substr(1)+"Saved";e.call(c)}})}e.ajax.save=!1},error:function(b,a,c){e.ajax.save=!1;e.refresh("error",a)}});return!1},updateData:function(a,c,d){b.shop.trace("$.product.updateData("+
c+","+d+")",a);var e=b("#s-product-edit-forms .s-product-form.main"),f=this.path.id;if(this.path.id&&"new"!=this.path.id)this.path.id!=a.id&&b.shop.error("Abnormal product ID change",[this.path.id,a]);else{this.path.id=a.id;b(this.options.container_selector).data("product-id",this.path.id);var g="/product/"+this.path.id+"/";null!==c&&(c=c||this.path.mode||"profile")&&("profile"!=c&&(g+=c+"/"),null!==d&&(d=d||this.path.tab||"")&&"main"!=d.toLowerCase()&&(g+=d+"/"));b.shop.trace("update location.hash="+
g);var h=/#\/product\/new\//,k="#/product/"+this.path.id+"/";b("#shop-productprofile, #s-product-edit-menu, #s-product-edit-forms, #s-product-profile-page").find('[href*="#/product/new/"]').each(function(){b(this).attr("href",b(this).attr("href").replace(h,k))});b("#s-product-edit-forms").find(':input[name="product\\[id\\]"]').val(this.path.id);window.location.hash=g}c=b("#shop-productprofile h1");c.find(".s-product-name:first").text(a.name);c.find(".s-product-id").show().text("id: "+a.id);document.title=
...
h,a.params)}}b.ajax({url:e,type:c?"POST":"GET",data:c?c||{}:a.params||{},success:function(c,e){b.shop.trace("$.product.loadTab status="+e);if(d.ajax.random==f){g.empty().append(c);d.ajax.target=null;d.ajax.link=null;var h="#/product/"+a.id+"/edit/";a.tab&&(h+=a.tab+"/");a.tail&&(h+=a.tail+"/");if(a.params&&!b.isEmptyObject(a.params)){var k=[],l;for(l in a.params)a.params.hasOwnProperty(l)&&k.push(l+"="+a.params[l]);h+=k.join("&")}window.location.hash=h;d.dispatch(a)}}})},editTabInit:function(a){b("html, body").animate({scrollTop:0},
...
c+"]",d.standalone_tabs),d.saveData(d.path.mode,c,function(){c&&d.call(d.path)}))})}this.path.tab=null;this.path.tail=null}},editTabShow:function(a){var c=b("#s-product-edit-forms .s-product-form."+a.tab);c.length?(c.show(),b.shop.trace("$.product.showTab",a),this.path.tab=a.tab):b.shop.error("$.product.showTab",a)},editClick:function(a){var c=a.attr("href").replace(/.*#\/product\/(\d+|new)\/edit\//,"").replace(/\/$/,"").split("/"),d=[],e;if(c.length){b.shop.trace("$.product.editClick",c);for(var f,
g="editTab";f=c.shift();)g+=f.substr(0,1).toUpperCase()+f.substr(1),f="function"==typeof this[g],b.shop.trace("$.settings.featuresClick try",[g,f,c]),!0===f&&(e=g,d=c.slice(0))}if(e){if(b.shop.trace("$.product.editClick",[e,d]),!a.hasClass("js-confirm")||confirm(a.attr("title")||"Are you sure?")){d.push(a);try{this[e].apply(this,d)}catch(h){b.shop.error("Error at method $.product."+e+". Original message: "+h.message,h)}}}else b.shop.error("Not found js handler for link",[e,a]);return!1},switchSubMenu:function(a){a=
...
tolerance:"pointer",update:function(a,c){var f=parseInt(b(c.item).data("id"),10),g=b(c.item).prev().data("id"),g=void 0===g?0:parseInt(g,10);d.editTabMainSkuSort(f,g,b(this));g=e.find('> tr.js-sku-settings[data-id="'+f+'"]');g.length&&(g=g.detach(),b.shop.trace("detach",g),g&&(b.shop.trace("detach",e.find('> tr[data-id="'+f+'"]').length),e.find('> tr[data-id="'+f+'"]:first').after(g)))},start:function(b,a){e.find("> tr.js-sku-settings").hide()},stop:function(b,a){e.find("> tr.js-sku-settings").show()}});
...
e=d.find("span.slash");d.find("i.new-window").show();d.find("span.s-frontend-base-url").hide();d.find("a.s-frontend-base-url").show().append(e)}});parseInt(a.id,10)||f.trigger("editable");"new"==a.id&&b.product_list&&b.isArray(b.product_list.collection_hash)&&("category"==b.product_list.collection_hash[0]?c.find("select.s-product-categories").val(b.product_list.collection_hash[1]):"set"==b.product_list.collection_hash[0]&&c.find(".add-set-button").click().closest(".field").find("select:first").val(b.product_list.collection_hash[1]));
...
if(c)d.checkChanges(b,!1,function(b){d.onTabChanged(a,b)});else d.onTabChanged(a,c)})},urlHelper:function(a,c){this.data.url_helper.timer&&clearTimeout(this.data.url_helper.timer);var d={name:b(a).val()};b.shop.trace("$.product.urlHelper ",d);if(d.url!=this.data.url_helper.name){var e=this;this.data.url_helper.url=d.url;b.getJSON("?module=product&action=suggestUrl",d,function(a){"ok"===a.status&&(e.data.url_helper.url=a.data.url,c.val(a.data.url),c.parent().find(".js-url-helper").hide(),b.product.informAboutUrlInUse(a.data.in_use))})}else c.parent().find(".js-url-helper").hide()},
...
"green":"yellow").addClass(a?"yellow":"green")},count:function(b){var a=0,d;for(d in b)b.hasOwnProperty(d)&&a++;return a}},multiSkus:function(a){var c=b("#s-product-edit-forms .s-product-form.main table.s-product-skus:first");1<a?(c.find("thead tr th.s-sku-sort").show(),c.find(".s-name,.s-sku-sort").show("slow"),c.find(".delete").parent("a").show(),2==a?c.find("> tbody:first > tr:first .s-name :input").focus():c.find("> tbody:first > tr:last .s-name :input").focus()):(c.find("thead tr th.s-sku-sort").hide(),
c.find(".s-name,.s-sku-sort").hide(),c.find(".delete").parent("a").hide(),c.find(".s-sku-big").removeClass("s-sku-big"))},editTabMainSkuAdd:function(){try{var a=b("#s-product-edit-forms .s-product-form.main table.s-product-skus:first").find("tbody:first"),c=0,d="0";a.find(':input[name$="[price]"]').each(function(){var a=b(this),e=a.val()?a.val().replace(",","."):0,e=parseFloat(e);e>c&&(c=e,d=a.val()||"0")});var e=0;a.find(':input[name$="[purchase_price]"]').each(function(){e=Math.max(e,parseFloat(b(this).val())||
0)});b.product.multiSkus(a.find("tr:not(.js-sku-settings)").length+1);var f={id:--b.product.editTabMainData.sku_id,product_id:b('input:hidden[name="product[id]"]').val()||"new",sku:"",available:1,name:"",price:""+c,price_loc:d,purchase_price:""+e,stock_icon:{0:"<i class='icon10 status-green' ></i>"},stock:{},count:null};b.shop.trace("$.product.editTabMainSkuAdd",[b.product.editTabMainData.sku_id,f]);a.append(tmpl("template-sku-edit",{sku_id:b.product.editTabMainData.sku_id,sku:f,stocks:this.getData("main",
"stocks"),stock_ids:this.getData("main","stock_ids")},!0));a.find(".s-product-currency").trigger("change");a.find("td.s-sku").addClass("s-sku-big")}catch(g){b.shop.error(g.message,g)}return!1},editTabMainSkuSort:function(a,c,d){try{b.post("?module=product&action=skuSort",{product_id:this.path.id,sku_id:a,after_id:c},function(a){b.shop.trace("$.product.editTabMainSkuSort result",a);a.error&&(b.shop.error("Error occurred while sorting product SKUs","error"),d.sortable("cancel"))},function(a){b.shop.trace("$.product.editTabMainSkuSort cancel",
{data:a});d.sortable("cancel");b.shop.error("Error occurred while sorting product SKUs","error")})}catch(e){b.shop.error(e.message,e)}return!1},editTabMainProductDelete:function(a){a=b("#s-product-list-delete-products-dialog");var c=a.parent();a.length||(c=b("<div></div>").appendTo("body"));c.load("?module=dialog&action=productsDelete",{product_id:[b.product.path.id]},function(){b("#s-product-list-delete-products-dialog").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){b(this).find(".dialog-buttons i.loading").hide()},
...
!1).show();c.find("input.val").val(0).attr("disabled",!0).parent().hide();c.find(".s-product-delete-from-category").hide();c.find(".s-storefront-map").html("");c.show();a.after(c)},editTabMainSkuStock:function(a,c){var d=b("#s-product-sku-"+a);d.hide().find(":input:enabled").attr("disabled",!0);var e=b("#s-product-sku-stock-"+a);e.show().find(":input:disabled").removeAttr("disabled");e.find(":input:first").val(d.find(":input:first").val())},editTabMainSkuSettings:function(a,c){c.hide();var d=c.parents("tr"),
e=d.data(),f=this;b.when(d.after(tmpl("template-sku-settings",{sku_id:a,sku:e}))).done(function(){var c;c="?module=product&action=skuSettings&product_id="+f.path.id;c+="&sku_id="+a;var e=b('#s-product-edit-forms .s-product-form.main tr.js-sku-settings[data-id="'+a+'"] > td:first');e.load(c,function(){d.find(':input[name$="[available]"]').remove();b.product_images&&b.product_images.options&&b.product_images.options.enable_2x&&b.fn.retina&&e.find(".s-product-image-crops img").retina();if(0<a){b.shop.trace("fileupload",
[e.find(".fileupload").length,typeof e.find(".fileupload").fileupload]);try{var c=document.cookie.match(/(?:^|; )_csrf=([^;]*)/),f=c?decodeURIComponent(c[1]):"";e.find(".fileupload:first").fileupload({dropZone:null,url:"?module=product&action=skuEproductUpload",acceptFileTypes:/(\.|\/)(gif|jpe?g|png)$/i,start:function(){e.find(".fileupload:first").hide()},progress:function(a,c){b.shop.trace("fileupload progress",c);var d=e.find(".js-progressbar-container");d.show();d.find(".progressbar-inner:first").css("width",
Math.round(100*c.loaded/c.total,0)+"%")},done:function(a,c){b.shop.trace("fileupload done",[c.result,typeof c.result]);var f=(c.result.files||[]).shift();e.find(".js-progressbar-container").hide();if(!f||f.error)e.find(".error-message").text(f.error).show(),e.find(".fileupload:first").addClass("error").show();else{var g=e.find(".s-sku-attachment");g.find("input.s-input-file-name").val(f.name);g.find(".s-file-name").text(f.name);g.find(".s-file-size").text(f.size);g.find(".s-file-description").val("");
g.find("input[type=checkbox]").attr("checked",!0);g.show();d.find("input.s-input-virtual").val(0)}},fail:function(a,c){b.shop.trace("fileupload fail",[c.textStatus,c.errorThrown]);e.find(".error-message").text("error").show().text(c.errorThrown||"error");e.find(".js-progressbar-container").hide();e.find(".fileupload:first").addClass("error").show()},formData:{product_id:b.product.path.id,sku_id:a,_csrf:f}})}catch(n){b.shop.error("Exception "+n.message,n)}}})})},editTabMainSkuImageSelect:function(a,
c,d){a=d.parents("li:first");var e=a.hasClass("selected"),f=d.parents("div.value:first");f.find("ul.s-product-image-crops li.selected").removeClass("selected");e?f.find('input[name$="[image_id]"]').val(0):(a.addClass("selected"),f.find('input[name$="[image_id]"]').val(c));b.shop.trace("$.product.editTabMainSkuImageSelect",[f,f.find(':input[name$="[image_id]"]')]);b.product.helper.onChange(d.parents("div.s-product-form"))},editTabMainSkuEproductSave:function(a){a=b("#s-product-edit-forms .s-product-form.main tr.js-sku-settings"+
(a&&0<a?'[data-id="'+a+'"]':"")+" > td:first .fileupload");b.shop.trace("$.product.editTabMainSkuEproductSave",a.length);a.length&&a.fileupload("start")},editTabMainSkuEproductDelete:function(b){},editTabMainLinkEdit:function(b){return!1},editTabMainTypeSelect:function(b){var a=b.parents("form").find(':input[name="product[type_id]"]').parents(".value");"main"==this.path.tab?b.hide():(a.find(".js-action").hide(),window.location.hash="/product/"+this.path.id+"/"+this.path.mode+"/");a.find(".js-type-name").hide();
a.find(":input").show().focus();setTimeout(function(){a.find(":input").focus()},100)},editTabMainTypeChange:function(a){var c=a.parents(".value"),d=a.find(":selected:first"),e=d.val();a=parseInt(d.data("sku-type"));c.find(".js-type-icon").html(d.data("icon"));c.find(".js-type-name").html(d.text());e!=c.data("type")?b("#s-product-edit-forms .s-product-form.features").length&&"undefined"!=typeof this.editTabFeaturesReload?this.editTabFeaturesReload(e):(c=b("#s-product-edit-menu > li.features > a"),
e="/features/"+e+"/",c.attr("href",c.attr("href").replace(/\/features\/.*$/,e))):(c=b("#s-product-edit-menu > li.features > a"),e="/features/",c.attr("href",c.attr("href").replace(/\/features\/.*$/,e)));c=b(this.options.form_selector+' :input[name="product[sku_type]"]');b.shop.trace("sku_type",[a,c]);c.filter('[value="1"]').trigger("disabled",[a?null:!0]);e=c.parents("ul");a?(c.filter(":checked").change(),e.find('[data-sku-type="1"]').hide()):(c.filter('[value="0"]').trigger("checked",!0).change(),
e.find('[data-sku-type="1"]').show())},editTabMainUpdate:function(a,c,d){var e=b("#s-product-edit-forms .s-product-form.main table.s-product-skus tbody"),f=b("#s-product-view table.s-product-skus tbody");e.find('tr[data-id^="-"]').remove();f.find('tr[data-id^="-"]').remove();e.parents("table").find("tr:hidden").show();var g=[],h;for(h in a.skus||{})g.push(b.extend({id:h},a.skus[h]));g=g.sort(function(b,a){return b.sort-a.sort});h=this.getData("main","stocks");var k=this.getData("main","stock_ids"),
...
getId:function(){return this.path.id}}})(jQuery);(function(b){b.fn.rateWidget=function(a,c,d){function e(a){var c=0;this.find("i").removeClass("star star-hover").addClass("star-empty").each(function(){if(c==a)return!1;c++;b(this).removeClass("star-empty").addClass("star")});this.attr("data-rate",a)}function f(b){return function(){return b}}var g=!!("ontouchstart"in window||navigator.msMaxTouchPoints),h,k=this;if(this&&this.length){if("string"==typeof a){if("getOption"==a&&"rate"==c)return parseInt(this.attr("data-rate"),10);"setOption"==a&&("rate"==
c&&(e.call(this,parseInt(d,10)),c={rate:d}),"object"===typeof c&&c&&(h=this.data("rateWidgetSettings")||{},b.extend(h,c),"undefined"!==typeof c.hold&&"function"!==typeof c.hold&&(h.hold=f(h.hold))));return this}this.data("rateWidgetSettings",b.extend({onUpdate:function(){},rate:null,hold:!1,withClearAction:!0},a||{}));if(!this.data("inited"))return h=this.data("rateWidgetSettings"),"function"!==typeof h.hold&&(h.hold=f(h.hold)),function(){k.attr("id")||k.attr("id",(""+Math.random()).substr(2));null!==
h.rate&&k.attr("data-rate",h.rate);k.find("i:lt("+k.attr("data-rate")+")").removeClass("star-empty").addClass("star");g||k.mouseover(function(a){h.hold.call(k)||(a=a.target,"I"==a.tagName&&(a=b(a),a.prevAll().removeClass("star star-empty").addClass("star-hover").end().removeClass("star star-empty").addClass("star-hover"),a.nextAll().removeClass("star star-hover").addClass("star-empty")))}).mouseleave(function(){h.hold.call(k)||e.call(k,k.attr("data-rate"))});k.click(function(a){if(!h.hold.call(k)){for(var c=
a.target;"I"!=c.tagName;)if(c==this)return;var d=k.attr("data-rate"),e=0;k.find("i").removeClass("star star-hover").addClass("star-empty").each(function(){e++;b(this).removeClass("star-empty").addClass("star");if(this==c)return d!=e&&(k.attr("data-rate",e),h.onUpdate(e)),!1});return!1}});if(h.withClearAction){var a="clear-"+b(this).attr("id"),c=b("#"+a);c.length||(k.after('<a href="javascript:void(0);" class="inline-link rate-clear" id="'+a+'" style="display:none;"><b><i>'+$_("clear")+"</b></i></a>"),
c=b("#"+a));c.click(function(){if(!h.hold.call(k)){var b=k.attr("data-rate");e.call(k,0);if(0!==b)h.onUpdate(0)}});var d;k.parent().mousemove(function(){h.hold.call(k)||(d&&clearTimeout(d),c.show(0))}).mouseleave(function(){d=setTimeout(function(){h.hold.call(k)||c.hide(0)},150)})}this.unbind("clear").bind("clear",function(){e.call(k,0)});this.data("inited",!0);k[0].addEventListener("touchend",function(a){b(a.target).trigger("click")},!1)}.call(this),this}}})(jQuery);(function(b){b.product_reviews={container:null,sidebar_counter:null,statuses:{},form:null,hotkeys:{"alt+enter":{ctrl:!1,alt:!0,shift:!1,key:13},"ctrl+enter":{ctrl:!0,alt:!1,shift:!1,key:13},"ctrl+s":{ctrl:!0,alt:!1,shift:!1,key:17}},options:{},init:function(a){this.options=a;this.statuses=a.statuses;a.product_id&&(this.product_id=a.product_id);this.form=b("#s-review-add-form");this.sidebar_counter=b("#s-all-reviews").find(".count");a.container&&(this.container="object"===typeof a.container?a.container:
...
function(){b(window).lazyLoad("force");return!1})}},initSelecting:function(){var a=this.container,d=this.toolbar.find(".count"),e=a.find(".s-select-all:first"),f=function(){var b=parseInt(a.find("> .product.selected").length,10);b?d.text(b).show():d.text("").hide()};b(document).keydown(function(a){16!=a.keyCode||b(a.target).closest(".redactor-box").length||(document.body.onselectstart=function(){return!1})}).keyup(function(b){16==b.keyCode&&(document.body.onselectstart=null)});a.off("select",".product").on("select",
".product",function(a,c,d){d=void 0!==d?d:!0;(void 0!==c?c:1)?b(this).addClass("selected").find("input:first").attr("checked",!0):(b(this).removeClass("selected").find("input:first").attr("checked",!1),e.is(":checked")&&e.attr("checked",!1));d&&f();return!1});e.unbind("select").bind("select",function(c,e){e=void 0!==e?e:!0;var f=b(this);e?(f.attr("checked",!0),a.find("> .product").trigger("select",!0,!1),d.text(f.attr("data-count")).show()):(f.attr("checked",!1),a.find("> .product").trigger("select",
!1,!1),d.text("").hide())});a.off("click",".product input").on("click",".product input",function(c,d){var g=c.shiftKey,h=this.checked;d&&(g=d.shiftKey,h=d.checked);var n=b(this).parents(".product:first");h?n.addClass("selected"):(e.is(":checked")&&e.attr("checked",!1),n.removeClass("selected"));if(g&&h){(g=a.data("last_checked"))||(g=a.find("> .product:first").trigger("select",!0));var p=n.prevAll(".selected[data-product-id="+g.attr("data-product-id")+"]"),q;if(p.length)for(q=n.prev(),g=g.get(0);q.length&&
g!=q.get(0);)q.addClass("selected").find("input").attr("checked",!0),q=q.prev();else if(p=n.nextAll(".selected[data-product-id="+g.attr("data-product-id")+"]"),p.length)for(q=n.next(),g=g.get(0);q.length&&g!=q.get(0);)q.addClass("selected").find("input").attr("checked",!0),q=q.next();a.data("last_checked")||p.length||g.trigger("selected",!1)}h&&a.data("last_checked",n);f()});if(b.browser.mozilla)a.off("click",".product label").on("click",".product label",function(a){if(a.shiftKey){var c=b(a.target);
...
return!1}),b.storage.get("shop/product_list/multi-lined")&&c.removeClass("single-lined"));var f="view="+a;e.find(".s-collection-list li.dr").each(function(){var a=b(this);a.find("a:first").attr("href","#/products/"+a.attr("id").replace("-","_id=")+"&"+f)});b("#s-products-search").autocomplete("disable").val(this.options.text||"").autocomplete("enable");var g="s-all-products";b.product_list.collection_hash.length&&"search"!==b.product_list.collection_hash[0]&&"tag"!==b.product_list.collection_hash[0]&&
(g=b.product_list.collection_hash.join("-"));b.shop.trace("$.product_list.initView",[a,g]);e.find("li.selected").removeClass("selected");var h=e.find("#"+g);0>=h.length&&window.location.hash&&(h=e.find('a[href="'+window.location.hash+'"]').parent());0>=h.length&&(h=e.find("#s-all-products"));h.addClass("selected");b.product_list.collection_hash.length&&"search"!==b.product_list.collection_hash[0]&&"tag"!==b.product_list.collection_hash[0]&&h.find(".count:first").text(this.category_count);b.product_list.fixed_blocks=
b.product_list.initFixedBlocks();this.initEditingControls();this.initToolbar();b(document).trigger("product_list_init_view")}catch(k){b.shop.error("$.product_list.initView error: "+k.message,k)}},highlightInlineEditorCells:function(){b.product_list.container.find("tr").each(function(){var a=b(this),d=a.data("edit-rights");d&&a.data("min-price")==a.data("max-price")||a.find(".s-product-price .editable").filter(function(){return!b(this).data("plugin")}).addClass("not-editable");d&&1==a.data("sku-count")||
...
100,function(){c.animate({left:"0px"},100,function(){c.children().first().unwrap()})})})})}}function d(a){var c=[];b.product_list.container.find("tr.product").each(function(){var a=b(this);void 0===a.data("original-price")&&a.data("edit-rights")&&c.push(b(this).data("product-id"))});if(!c.length)return a();b.post("?module=products&action=inlineEditorData",{ids:c},function(c){c.data&&b.product_list.container.find("tr.product").each(function(){var a=b(this),d=c.data[parseInt(a.data("product-id"),10)];
d&&(a.data("stocks",d.stocks||null),a.data("original-price",d.price.replace(/\.?0+$/g,"")))});a()},"json")}var e=this;b.product_list.highlightInlineEditorCells();b.product_list.container.on("append_product_list",function(){b.product_list.highlightInlineEditorCells()});b.product_list.container.on("click",".s-product-price,.s-product-stock",function(){function c(){if(k)g.html(tmpl("template-list-price-editor-one",{product_id:h.data("product-id"),currency:h.data("currency"),value:h.data("original-price")}));
else{var a=h.data("stocks");a&&"object"==typeof a?g.html(tmpl("template-list-stock-editor-many",{product_id:h.data("product-id"),values:a})):g.html(tmpl("template-list-stock-editor-one",{product_id:h.data("product-id"),value:a||""}))}g.find(".cancel").click(function(){var b=g;b.removeClass("editor-on").html(b.data("read-only-state-html"));b.data("read-only-state-html","");b.data("denied-reason","")});var c=g.find("form").submit(function(){if(c.find(".loading").length)return!1;c.find(":submit").after('<i class="icon16 loading"></i>');
b.post("?module=products&action=inlineSave",c.serialize(),function(a){c.find(".loading").remove();try{a.data&&a.data[0]&&(a.data[0].alien=h.hasClass("s-alien"));var d=b("<table>").html(tmpl("template-product-list-table",{products:a.data,check_all:b.product_list.container.find(".s-select-all:first").prop("checked"),sort:b.product_list.sort}));h.replaceWith(d.find("tr"));e.container.trigger("append_product_list",[a.data])}catch(m){console.log("Error: "+m.message)}},"json");return!1});c.on("dblclick",
!1);setTimeout(function(){g.find(":input:visible:first").focus()},0)}var g=b(this);if(!g.data("plugin")){var h=g.closest("tr"),k=g.hasClass("s-product-price");if(k){if(h.data("min-price")!=h.data("max-price"))return a(g,$_("Inline editing is available only for products with a single SKU"))}else if("1"!=h.data("sku-count"))return a(g,$_("Inline editing is available only for products with a single SKU"));if(!h.data("edit-rights"))return a(g,$_("Insufficient access rights"));g.hasClass("editor-on")||
(g.addClass("editor-on").data("read-only-state-html",g.html()),b.product_list.container.removeClass("single-lined"),void 0!==h.data("original-price")?c():(g.html('<i class="icon16 loading"></i>'),d(c)))}})},initFixedBlocks:function(){var a=b("#mainmenu").height(),d=b("#s-sidebar").width(),e=b(window),f=b("#s-fixed-blocks");f.length||(f=b('<div id="s-fixed-blocks"></div>').css({display:"none",position:"fixed",background:"#fff",top:a,width:d,"float":"left"}).appendTo("#s-sidebar"));var g=b("#s-category-list"),
h=b("#s-category-list-block"),k=b("#s-set-list"),l=b("#s-set-list-block"),n=function(){function c(){if(!p){var c=b("#s-category-list-handler");u=b.categories_tree.isCollapsed(c);n=g.is(":hidden");var k=b('<div id="s-category-list-dummy" class="block"></div>').css({height:h.height()});h.replaceWith(k);f.show().append(h.hide());h.find(".heading").before('<span class="hint float-right" style="margin-top: 3px;">'+$_("Drag products here")+"</span>");u&&b.categories_tree.expand(c,null,function(){b.categories_tree.collapse(c)});
n||g.hide();h.show();b("i.add",h).hide();b("#s-category-list-handler").hide();h.css({"overflow-x":"hidden","overflow-y":"auto"});(function(){var b=g.is(":hidden"),c;h.bind("mousemove.fixed_blocks.category",function(d){document.getElementById("products-helper")&&b&&(c&&(clearTimeout(c),c=null),c=setTimeout(function(){if(b){h.css({height:""});g.show();var c=h.height(),d=(e.height()-a)/2;h.css({height:Math.min(c,d)});h.find(".heading").prev(".hint").hide();b=!1}},250))});e.bind("mouseout.fixed_blocks.category",
function(a){a.pageX>d+10&&(c&&clearTimeout(c),c=null,b||(g.hide(),h.css({height:""}),h.find(".heading").prev(".hint").show(),b=!0))})})();p=!0}}function k(){if(p){var a=b("#s-category-list-dummy");a.replaceWith(h);h.css({"overflow-x":"","overflow-y":""});var c=b("#s-category-list-handler");u&&b.categories_tree.collapse(c);n||g.show();h.find(".heading").prev(".hint").remove();b("#s-category-list-handler").show();b("i.add",h).show();a.remove();h.unbind("mousemove.fixed_blocks.category");e.unbind("mouseout.fixed_blocks.category");
f.children().length||f.hide();p=!1;b.categories_tree.init()}}var l=h.offset().top,p=!1,n,u;e.unbind("scroll.fixed_blocks.category").bind("scroll.fixed_blocks.category",function(){p||(l=h.offset().top);var d=l,d=document.getElementById("s-category-list-dummy")?d+b("#s-category-list-dummy").height():d+b("#s-category-list-block").height();e.scrollTop()+a+5>=d?c():k()});return{setFixed:c,unsetFixed:k}}(),p=function(){function c(){if(!n){p=k.is(":hidden");var c=b('<div id="s-set-list-dummy" class="block"></div>').css({height:l.height()});
l.replaceWith(c);f.show().append(l);l.find(".heading").before('<span class="hint float-right" style="margin-top: 3px;">'+$_("Drag products here")+"</span>");p||k.hide();b("i.add",l).hide();b("i.collapse-handler",l).hide();l.css({"overflow-x":"hidden","overflow-y":"auto"});(function(){var b=k.is(":hidden"),c;l.bind("mousemove.fixed_blocks.set",function(d){document.getElementById("products-helper")&&b&&(c&&(clearTimeout(c),c=null),c=setTimeout(function(){if(b){l.css({height:""});k.show();var c=l.height(),
d=(e.height()-a)/2;l.css({height:Math.min(c,d)});l.find(".heading").prev(".hint").hide();b=!1}},250))});e.bind("mouseout.fixed_blocks.set",function(a){a.pageX>d+10&&(c&&clearTimeout(c),c=null,b||(k.hide(),l.css({height:""}),l.find(".heading").prev(".hint").show(),b=!0))})})();n=!0}}function g(){if(n){var a=b("#s-set-list-dummy");a.replaceWith(l);l.css({"overflow-x":"","overflow-y":""});l.find(".heading").prev(".hint").remove();p||k.show();b("i.add",l).show();b("i.collapse-handler",l).show();a.remove();
l.unbind("mousemove.fixed_blocks.category");e.unbind("mouseout.fixed_blocks.category");f.children().length||f.hide();n=!1}}var h=l.offset().top,p,n=!1;e.unbind("scroll.fixed_blocks.set").bind("scroll.fixed_blocks.set",function(){n||(h=l.offset().top);var d=h,d=document.getElementById("s-set-list-dummy")?d+b("#s-set-list-dummy").height():d+b("#s-set-list-block").height();e.scrollTop()+a+5>=d?c():g()});return{setFixed:c,unsetFixed:g}}();return{category:n,set:p}},initEditingControls:function(){var a=
b("#s-product-list-title"),d=b.product_list.collection_hash[0],e="?module=category&action=save&";"set"===d&&(e="?module=set&action=save&");a.hasClass("editable")&&(a.inlineEditable({minSize:{width:350},maxSize:{width:600},size:{height:30},inputClass:"s-title-h1-edit",beforeMakeEditable:function(){b(".s-product-list-manage").hide()},afterBackReadable:function(a,c){b(".s-product-list-manage").show();if(!c.changed)return!1;b.shop.jsonPost(e+b.product_list.collection_param+"&edit=name",{name:b(a).val()},
function(a){b.product_list.sidebar.find("#"+d+"-"+a.data.id).find(".name:first").html(a.data.name)})}}),"name"==this.options.edit&&a.trigger("editable"));a=b("#s-product-list-settings");!a.length||"category"!=d&&"set"!=d||a.unbind("click").bind("click",function(){"category"==d?shopDialogProductsCategory.staticDialog(b.product_list.collection_hash[1],null,"edit"):shopDialogProductsSet.staticDialog(b.product_list.collection_hash[1],"edit");return!1});a=b("#s-product-list-delete");!a.length||"category"!=
d&&"set"!=d||a.unbind("click").bind("click",function(){b("#s-product-list-delete-dialog").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){b(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(){function a(b,d){if(!b.length)return d&&d();var e=b.shift();c(["category",e],function(){a(b,d)})}function c(a,c){var d={hash:a.join("/")||"all",remove:["list"]};n&&d.remove.push("products");var f=function(){b.product_list.remove(d,function(d,f){e(a,d);b.product_list.sidebar.trigger("update",
d.data.lists);c&&c()})},g=b("#"+a.join("-")+"-handler");g.length?b.categories_tree.expand(g,function(b){b.parent().find("ul:first").hide();f()}):f();return!1}function e(a,c){var d=a[0],e=b("#"+a.join("-")),f=e.prev(".drag-newposition"),g=b("#s-"+a[0]+"-list"),h=g.find("ul:first");"set"==d?(e.remove(),f.remove()):(d=e.find("ul:first"),d.length&&(d.find(">li.drag-newposition:first").remove(),e.hide(),d.find(">li").each(function(){e.after(this)})),d=e.parents("ul:first"),e.remove(),f.remove(),d.find("li.dr").length||
...
"-handler").remove()}var k=b(this),l=parseInt(b.product_list.collection_hash[1]);k.find(".dialog-buttons i.loading").show();var n="1"==k.find("input[name=s-delete-products]:checked").val();"category"==d&&k.find('input[name="s-delete-sub"]').is(":checked")?b.get("?action=categoryExpand&tree=1&recurse=1&id="+l,function(c){c=b("<div>").html(c).find('li[id^="category-"]').map(function(){return parseInt(this.id.substr(9),10)}).get().reverse();c.push(l);a(c,function(){location.href="#/"})}):c(b.product_list.collection_hash,
function(){location.href="#/"});return!1}});return!1});"set"===d&&b("#s-embed-code").click(function(){b("#s-product-list-embed-dialog").waDialog();return!1})},initDragndrop:function(){b.product_dragndrop.init({products:!0,view:this.options.view,sort:this.options.sort}).bind("move_product",function(a){b.shop.jsonPost("?module=product&action=move&"+b.product_list.collection_param,{product_ids:a.product_ids,before_id:a.before_id||null},a.success,a.error)}).bind("is_product_sortable",function(){return b.product_list.sortable}).bind("add_to_list",
...
onSubmit:function(c){var d=c.find("form");d.find(".dialog-buttons i.loading").show();b.shop.jsonPost(d.attr("action"),d.serializeArray().concat(a.serialized),function(a){a.data.new_set&&b("#s-set-list ul:first").trigger("add",[a.data.new_set,"set","#/products/set_id="+a.data.new_set+"&view="+b.product_list.options.view]);a.data.sets&&(e.trigger("update",[{set:a.data.sets}]),f.find(".s-select-all:first").trigger("select",!1));d.find("input:checked").attr("checked",!1);c.trigger("close")});return!1}})})},
assignTagsDialog:function(a){var c=b("#s-assign-tags"),e=function(){b("#s-assign-tags").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){var c=b(this);c.find(".dialog-content h1 span").text("("+a.count+")").show();c.find(".dialog-buttons i.loading").hide()},onSubmit:function(c){var d=b(this),e=d.find("#s-assign-tags-list_tag");if(e.length){var f=jQuery.Event("keypress",{which:13});e.trigger(f)}d.find(".dialog-buttons i.loading").show();var l=d.attr("action");setTimeout(function(){var e=d.serializeArray().concat(a.serialized);
b.shop.jsonPost(l,e,function(a){a.data.denied_message&&alert(a.data.denied_message);"search"===a.data.cloud?c.trigger("close"):a.data.cloud&&b("#s-tag-cloud").trigger("update",[a.data.cloud]);c.trigger("close");b.products.dispatch()},function(){c.trigger("close")})},10);return!1}})};c.length&&c.remove();b.post("?module=dialog&action=assignTags",a.serialized,function(a){b("body").append(a);e()})},typesDialog:function(a){var c=b("#s-types"),e=this.container,f=this.sidebar,g=function(){b("#s-types").waDialog({disableButtonsOnSubmit:!0,
onLoad:function(){b(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(c){var d=b(this);d.find(".dialog-buttons i.loading").show();b.shop.jsonPost(d.attr("action"),d.serializeArray().concat(a.serialized),function(a){f.trigger("update",{type:a.data.types});e.find(".s-select-all:first").trigger("select",!1);d.find("input:checked").attr("checked",!1);c.trigger("close");b.products.dispatch()});return!1}})},h=c.parent();c.length?g():(h=b("<div></div>").appendTo("body"),h.load("?module=dialog&action=types",
g))},deleteFromSet:function(a){0<a.count&&b.shop.jsonPost("?module=products&action=deleteFromSet&id="+this.collection_hash[1],a.serialized,function(){b.products.dispatch()})},deleteFromCategory:function(a){0<a.count&&b.shop.jsonPost("?module=products&action=deleteFromCategory&id="+this.collection_hash[1],a.serialized,function(){b.products.dispatch()})},deleteProductsDialog:function(a){var c=function(){b("#s-product-list-delete-products-dialog").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){b(this).find(".dialog-buttons i.loading").hide()},
onSubmit:function(c){b(this).find(".dialog-buttons i.loading").show();b.product_list.remove(b.extend(a,{remove:["products"]}),function(a,d){b.product_list.sidebar.trigger("update",a.data.lists);b.products.dispatch();c.trigger("close");d.length&&alert((c.data("not-allowed-string")||"").replace("%d",d.length))});return!1}})},e=b("#s-product-list-delete-products-dialog"),f=e.parent();e.length||(f=b("<div></div>").appendTo("body"));0<a.count&&f.load("?module=dialog&action=productsDelete",a,c)},exportProducts:function(a,
b){for(var c=[],d,g=!1;d=a.serialized.pop();)d.name&&("product_id[]"==d.name?c.push(parseInt(d.value,10)):"hash"==d.name&&(g=d.value));d="?action=importexport#/"+b;g?window.location=d+("/hash/"+g):c.length&&(d+="/hash/id/"+c.join(","),window.location=d)},createCoupon:function(a){for(var b=[],c,f=!1;c=a.serialized.pop();)c.name&&("product_id[]"==c.name?b.push(parseInt(c.value,10)):"hash"==c.name&&(f=c.value));a=this.options.marketing_url+"coupons/create/";f?window.location=a+("?products_hash="+f):
b.length&&(a+="?products_hash=id/"+b.join(","),window.location=a)},duplicateProducts:function(a,d){for(var c=[],f,g=!1;f=a.serialized.pop();)f.name&&("product_id[]"==f.name?c.push(parseInt(f.value,10)):"hash"==f.name&&(g=f.value));!g&&c.length&&(g="id/"+c.join(","));g&&(d.find("i.icon16").removeClass("split").addClass("loading"),this.duplicate(g,{progress:function(a){d.attr("title",Math.round(100*a.offset/a.total_count)+"%")},finish:function(a,c){d.attr("title",null);var e=d.find("i.icon16");e.removeClass("loading").addClass("yes");
setTimeout(function(){e.removeClass("yes").addClass("split")},3E3);b(document).one("product_list_init_view",function(){var a={};b.each(c,function(b,c){a[c]=1});b("#product-list [data-product-id]").each(function(){var c=b(this),d=b(this).data("product-id");d&&a[d]&&c.addClass("highlighted")})});(a||c)&&b.products.dispatch()},error:function(a){}}))},setBadge:function(a,d){function c(a){var c="delete-badge"==f?null:a.data;b("#product-list [data-product-id]").each(function(){var a=b(this);if(h||g[a.data("product-id")]){if(a.is("tr")){var d=
a.find(".s-image a");d.find(".s-image-corner").remove();c&&d.prepend(b('<div class="s-image-corner"></div>').html(c))}else d=a.find(".s-product-image a"),d.find(".s-image-corner.top.right").remove(),c&&d.append(b('<div class="s-image-corner top right"></div>').html(c));a.trigger("badge",[c])}});"set-custom-badge"==f&&d.parent().find(".textarea-wrapper").slideUp("fast");d.find(".loading").remove();d.find("a").append(b('<span class="count"><i class="icon16 yes"></i></span>').animate({opacity:0},function(){b(this).remove()}));
b.product_list.container.find(".s-select-all:first").trigger("select",!1)}var f=d.data("action");"set-custom-badge"!=f&&d.parent().find(".textarea-wrapper").slideUp("fast");d.find(".loading").remove();d.find("a").append('<span class="count"><i class="icon16 loading"></i></span>');var g={},h=!1;b.each(a.serialized,function(){h=h||"hash"==this.name;g[this.value]=1});if("delete-badge"==f)d.find(".loading").remove(),b.shop.jsonPost("?module=product&action=badgeDelete",a.serialized,c);else{var k;k="set-custom-badge"==
f?d.find("textarea").val():d.data("type");var l=a.serialized;l.push({name:"code",value:k});b.shop.jsonPost("?module=product&action=badgeSet",l,c,function(a){"object"===typeof a.errors&&"string"===typeof a.errors[0]&&alert(a.errors[0]);d.find(".loading").remove()})}},duplicate:function(a,d){var c=this,f=[];b.shop.jsonPost("?module=products&action=duplicate",{hash:a,limit:50,offset:d.offset||0},function(e){"ok"==(e.status||"error")?(f=f.concat(e.data.new_ids||[]),e.data.offset<e.data.total_count?(d.offset=
e.data.offset,c.duplicate(a,d),d.progress(e.data||{})):d.finish(e.data||{},f)):"fail"==e.status&&e.errors.message&&b("#s-product-list-duplicate-error-dialog").waDialog()},function(a){if(a.errors)if(d.finish(),a.errors.message){var c=b("#s-product-list-duplicate-error-dialog");c.find(".js-content").html(a.errors.message);c.waDialog()}else alert(a.errors)})},remove:function(a,d){var c={},f=[],g;a.product_id?g=function(){100>=a.product_id.length&&(c.get_lists=!0);c.product_id=a.product_id.splice(0,100);
b.shop.jsonPost("?module=products&action=deleteList",c,function(b){b.data.not_allowed&&b.data.not_allowed.length&&(f=f.concat(b.data.not_allowed));a.product_id.length?g():"function"===typeof d&&d(b,f)})}:(c.hash=a.hash||this.collection_hash.join("/")||"all",c.remove=b.isArray(a.remove)&&a.remove.length?a.remove:["list"],1==c.remove.length&&"list"==c.remove[0]?g=function(){b.shop.jsonPost("?module=products&action=deleteList",c,d)}:(c.count=100,g=function(){b.shop.jsonPost("?module=products&action=deleteList",
...
d.data("locked")||(d.data("locked",!0),e().always(function(){d.removeData("locked")}))},rubberTable:function(){var a=b("#wa"),d=b("#s-content"),e=b("#s-content > .content"),d=parseInt(d.css("margin-left")),f=parseInt(e.css("margin-right")),g=b(".s-product-list-table-container table").width(),h=a.attr("style");h&&a.data("style",h);e=parseInt(e.width()-b(".s-product-list-table-container").width())+g+d+f;a.width()<e&&a.css({"min-width":e+"px"});b(window).resize()}}})(jQuery);var shopDialogProductsSet=function(b){shopDialogProductsSet=function(a){this.$wrapper=a.$wrapper;this.is_new=a.is_new;this.initClass()};shopDialogProductsSet.prototype.initClass=function(){this.is_new&&this.initTransliterateSetID();this.initTypeSwitch();this.initDatepickers()};shopDialogProductsSet.prototype.initTypeSwitch=function(){var a=this.$wrapper;a.find("input[name=type]").on("click",function(){"0"==b(this).val()?a.find(".js-set-dynamic-settings").hide():a.find(".js-set-dynamic-settings").show()})};
shopDialogProductsSet.prototype.initDatepickers=function(){var a=this;a.$wrapper.find(".js-datepicker").each(function(){b(this).datepicker({})});(function(){function c(a){var c=b.datepicker._defaults.dateFormat,d=null;try{b.datepicker.parseDate(c,a),d=!0}catch(k){d=!1}return d}var d=a.$wrapper.find(".js-start-date"),e=a.$wrapper.find(".js-finish-date");d.on("change",function(){var a=b(this),d=b.trim(a.val()),h=null;d&&(c(d)?h=new Date(a.datepicker("getDate").getTime()+864E5):a.val("").addClass("error"));
e.datepicker("option","minDate",h)});e.on("change",function(){var a=b(this),e=b.trim(a.val()),h=null;e&&(c(e)?h=new Date(a.datepicker("getDate").getTime()-864E5):a.val("").addClass("error"));d.datepicker("option","maxDate",h)});b([d,e]).on("keydown",function(a){a=b(this);a.hasClass("error")&&a.removeClass("error")});d.trigger("change").datepicker("refresh");e.trigger("change").datepicker("refresh")})()};shopDialogProductsSet.prototype.initTransliterateSetID=function(){var a=this.$wrapper,c=a.find(".js-product-set-id"),
a=a.find(".js-product-list-name"),d="",e=!1,f,g;c.bind("keydown",function(){var a=b(this);null!==f&&(clearTimeout(f),f=null);f=setTimeout(function(){var b=a.val();d!==b&&(e=!0,d=b,a.unbind("keydown"))},200)});a.bind("keydown",function(){var a=b(this);e?a.unbind("keydown"):(null!==g&&(clearTimeout(g),g=null),g=setTimeout(function(){var f=a.val();f&&b.getJSON("?action=transliterate&str="+f,function(b){e?a.unbind("keydown"):"ok"==b.status&&(d=b.data,c.val(d))})},200))})};shopDialogProductsSet.staticDialog=
function(a,c){var d=b("#s-product-set-dialog"),e=function(){d=b("#s-product-set-dialog");d.waDialog({esc:!1,disableButtonsOnSubmit:!0,onLoad:function(){setTimeout(function(){b(".js-product-list-name").focus()},50)},onSubmit:function(d){var e=b(this),f=function(e){var f;0<location.hash.indexOf("set_id")?(f=location.hash.replace("set_id="+a,"set_id="+e.data.id),"rule"in e.data&&(f=f.replace(/&sort=[^&]*/,"&sort="),f=f.replace(/&order=[^&]*/,"&order="))):f="#/products/set_id="+e.data.id;"new"===c&&b.product_sidebar.createNewElementInList(e.data,
"set");b.product_sidebar.updateItemInCategoryList(e,f);location.hash!=f?location.hash=f:b.products.dispatch();d.trigger("close")},g=function(a){if(a&&a.errors){a=a.errors;var b=0,c;for(c in a){var f=d.find("input[name="+c+"]");if(f.length){f.addClass("error");var b=b+1,g=f.parent().find(".errormsg");g.length&&g.text(a[c]);f.one("keyup",function(){--b||e.find("[type='submit']").removeAttr("disabled",!1);f.removeClass("error");g.length&&g.text("")})}}return!1}};if(e.find("input:file").length)b.products._iframePost(e,
f,g);else return b.shop.jsonPost(e.attr("action"),e.serialize(),f,g),!1}})},f;f=d.length?d.parent():b("<div></div>").appendTo("body");"new"===c&&f.load("?module=set&action=Create",e);"edit"===c&&f.load("?module=set&action=Edit&set_id="+a,e)};return shopDialogProductsSet}(jQuery);var shopDialogProductsCategory=function(b){shopDialogProductsCategory=function(a){this.$wrapper=a.$wrapper;this.SEARCH_STEP=a.SEARCH_STEP;this.category_id=a.category_id;this.category_type=a.category_type;this.account_name=a.account_name;this.filter_count=a.filter_count;this.filter_ignore_id=[];this.ignore_id=[];this.filter_element_html=a.templates.filter_element_html;this.show_more_filters_text=a.texts.show_more_filters_text;this.initClass()};shopDialogProductsCategory.prototype.initClass=function(){var a=
...
Math.abs(Math.round(e)-e))/1E5)&&a<g&&(g=a);(a=Math.round(1E5*Math.abs(Math.round(f)-f))/1E5)&&a<g&&(g=a)}e=parseFloat(c.val()?c.val():0);f=parseFloat(d.val()?d.val():100<c.val()?parseFloat(c.val())+100:100);h.slider({range:!0,min:e-3,max:f+5,step:g,values:[e,f],slide:function(a,e){var f=b(this).slider("option","min"),h=b(this).slider("option","max");2!=b(e.handle).index()&&(e.values[0]==f&&b(this).slider("option","min",f-g),c.val(e.values[0]));1!=b(e.handle).index()&&(e.values[1]==h&&b(this).slider("option",
"max",h+g),d.val(e.values[1]))},stop:function(a,b){d.change()}});c.add(d).change(function(){var a=""===c.val()?h.slider("option","min"):parseFloat(c.val()),b=""===d.val()?h.slider("option","max"):parseFloat(d.val());b>=a&&(h.slider("option","values",[a,b]),h.slider("option","max",parseFloat(b)+5),h.slider("option","min",parseFloat(a)-3))})};shopDialogProductsCategory.prototype.initShowFeatures=function(a,b,d,e,f){var c=a.type.substr(0,5);if("range"==c){var h=[],k=[],l;for(l in a.values)a.values.hasOwnProperty(l)&&
...
if("ok"===b.status){var g=d.find(".js-condition-list .js-feature-insertion-block"),h=d.find(".js-show-more").attr("data-count"),k=0,q;for(q in b.data.features)b.data.features.hasOwnProperty(q)&&(c.initShowFeatures(b.data.features[q],g,"template_feature_field",e,!1),++k);b=h-k;0<b?(g="<b><i>"+(20<b?$_("Show %d more").replace("%d",20)+" "+$_("From").toLowerCase()+" "+b:$_("Show %d more").replace("%d",b))+"</i></b>",d.find(".js-show-more").html(g).attr("data-count",b),a||(f=parseInt(f)+parseInt(k),d.find(".js-show-more").attr("data-offset",
...
minSize:{width:100},makeReadableBy:[],beforeMakeEditable:function(a){var c=b(this).parents("div:first"),d=c.find("span.slash");b(a).after(d);c.find("span.s-frontend-base-url").html(c.find("a.s-frontend-base-url").hide().contents()).show()},beforeBackReadable:function(a,c){var d=b(this),e=d.parents("div:first"),f=e.find("span.slash");d.after(f);e.find("a.s-frontend-base-url").html(e.find("span.s-frontend-base-url").hide().contents()).show()}});var a=this.$wrapper.find(".js-product-list-name"),c=this.$wrapper.find(".js-product-list-url"),
...
d=c.find(".js-feature-value:checkbox, .js-tag-value:checkbox");d.length&&!d.is(":checked")&&(a=!0,c.find(".errormsg").html("").html($_("Nothing selected")),e.find(".js-category-error").html("").html($_("Nothing selected")))});setTimeout(function(){e.find(".errormsg").html("")},5E3);return a}())return!1;var f=function(e){var f;if(0<location.hash.indexOf("category_id")){if(f=location.hash.replace("category_id="+a,"category_id="+e.data.id),"sort_products"in e.data||"rule"in e.data)f=f.replace(/&sort=[^&]*/,
...
b(this).blur():(b(".ui-slider .ui-state-focus").removeClass("ui-state-focus"),b(this).addClass("ui-state-focus"))}).blur(function(){b(this).removeClass("ui-state-focus")});this.handles.each(function(a){b(this).data("index.ui-slider-handle",a)});this.handles.keydown(function(c){var d=!0,f=b(this).data("index.ui-slider-handle"),g,h,k;if(!a.options.disabled){switch(c.keyCode){case b.ui.keyCode.HOME:case b.ui.keyCode.END:case b.ui.keyCode.PAGE_UP:case b.ui.keyCode.PAGE_DOWN:case b.ui.keyCode.UP:case b.ui.keyCode.RIGHT:case b.ui.keyCode.DOWN:case b.ui.keyCode.LEFT:if(d=
...
a,c)},_slide:function(a,b,d){var c;this.options.values&&this.options.values.length?(c=this.values(b?0:1),2===this.options.values.length&&!0===this.options.range&&(0===b&&d>c||1===b&&d<c)&&(d=c),d!==this.values(b)&&(c=this.values(),c[b]=d,a=this._trigger("slide",a,{handle:this.handles[b],value:d,values:c}),this.values(b?0:1),!1!==a&&this.values(b,d,!0))):d!==this.value()&&(a=this._trigger("slide",a,{handle:this.handles[b],value:d}),!1!==a&&this.value(d))},_stop:function(a,b){var c={handle:this.handles[b],
value:this.value()};this.options.values&&this.options.values.length&&(c.value=this.values(b),c.values=this.values());this._trigger("stop",a,c)},_change:function(a,b){if(!this._keySliding&&!this._mouseSliding){var c={handle:this.handles[b],value:this.value()};this.options.values&&this.options.values.length&&(c.value=this.values(b),c.values=this.values());this._trigger("change",a,c)}},value:function(a){arguments.length&&(this.options.value=this._trimAlignValue(a),this._refreshValue(),this._change(null,
