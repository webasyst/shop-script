...
if(e.find("input:file").length)b.products._iframePost(e,f,g);else return b.shop.jsonPost(e.attr("action"),e.serialize(),f,g),!1},onClose:function(){d.find(".js-datepicker").each(function(){var a=b(this),c=a.data("datepicker");c=c&&c.dpDiv?c&&c.dpDiv:b();a.datepicker("destroy");c.remove()})}})};var f=d.length?d.parent():b("<div></div>").appendTo("body");"new"===c&&f.load("?module=set&action=Create",e);"edit"===c&&f.load("?module=set&action=Edit&set_id="+a,e)};return shopDialogProductsSet}(jQuery);var shopDialogProductsCategory=function(b){shopDialogProductsCategory=function(a){this.$wrapper=a.$wrapper;this.SEARCH_STEP=a.SEARCH_STEP;this.category_id=a.category_id;this.category_type=a.category_type;this.account_name=a.account_name;this.filter_count=a.filter_count;this.filter_ignore_id=[];this.ignore_id=[];this.filter_element_html=a.templates.filter_element_html;this.show_more_filters_text=a.texts.show_more_filters_text;this.initClass()};shopDialogProductsCategory.prototype.initClass=function(){var a=
