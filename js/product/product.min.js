...
l(n.hold));(function(){if(!this.data("inited")){n.truncate&&"boolean"==typeof n.truncate&&(n.truncate=255);if(n.truncate){var q=n.placeholder&&n.placeholder===this.text()?"":this.text();this.data("real_text",q);this.text(q.length<n.truncate-3?q:q.substr(0,n.truncate-3)+"...")}n.placeholder&&d.call(this);n.editLink&&a(n.editLink).unbind("click.inlineEditable").bind("click.inlineEditable",function(){n.hold.call(r)||"edit"!=v&&g.call(r.get(0))});n.editOnItself&&this.unbind("click.inlineEditable").bind("click.inlineEditable",
function(){n.hold.call(r)||"edit"!=v&&g.call(this)});this.unbind("editable.inlineEditable").bind("editable.inlineEditable",function(){n.hold.call(r)||"edit"!=v&&g.call(this)});this.unbind("placeholder.inlineEditable").bind("placeholder.inlineEditable",function(t,u){u&&n.placeholder&&d.call(this);u||a(this).removeClass(n.placeholderClass)});this.data("inited",!0)}}).call(this);return this}}})(jQuery);(function(a){a.fn.photoStreamSlider=function(b){function c(){function f(q){function t(){f.execution=!1;var B="on"+u.charAt(0).toUpperCase()+u.slice(1);B=d[B];"function"==typeof B&&B.call(e);B=q.fn;"function"==typeof B&&B.call(e)}"string"==typeof q&&(q={direction:q,animate:!0});var u=q.direction||"forward",w=q.steps||h.length;if(!f.execution){f.execution=!0;var A=h.filter(":first").outerWidth()*w,y=h.length;if("forward"==u){var z=h.filter(":last").nextAll(":lt("+w+")");w=z.length;z=z.filter(":last");
w&&(h.removeClass("visible"),z.prevAll(":lt("+(y-1)+")").addClass("visible"),z.addClass("visible"))}else z=h.filter(":first").prevAll(":lt("+w+")"),w=z.length,z=z.filter(":last"),w&&(h.removeClass("visible"),z.nextAll(":lt("+(y-1)+")").addClass("visible").show(),z.addClass("visible"));h=a("li.visible",g);y=g.position().left;"forward"==u?(w=m-l-r,y-=A,y=y>-w?y:-w):(y+=A,y=y<r?y:r);q.animate?g.animate({left:y},d.duration,t):(g.css({left:y}),t())}}var g=e.find(d.photoStream),h=a("li.visible",g),k=a("li",
g),l=h.filter(":first").outerWidth()*h.length,m=k.filter(":first").outerWidth()*k.length,p=d.height||k.filter(":first").outerHeight();g.parent().css({overflow:"hidden",height:p,position:"relative",padding:"4px 0",margin:0,width:l});p=g.find("li:first");var n=h.filter(":first"),r=(n.outerWidth()-n.width())/2,v=0,x=p.outerWidth();for(n=n.get(0);p.length&&p.get(0)!=n;)v+=x,p=p.next();g.css({position:"absolute",left:-(v-r),width:m});a(d.forwardLink).unbind("click").bind("click",function(){f("forward");
return!1});a(d.backwardLink).unbind("click").bind("click",function(){f("backward");return!1});e.unbind("append prepend").bind("append prepend",function(q,t){if("append"==q.type){for(var u=g.find("li:last"),w=a();u.hasClass("dummy");)w=w.add(u),u=u.prev("li");w.remove();g.append(t)}else{u=a("<div></div>").html(t);t=u.find("li");var A=t.length*x;u.remove();u=g.find("li:first");for(w=a();u.hasClass("dummy");)w=w.add(u),u=u.next("li");w.remove();g.prepend(t)}k=g.find("li");m=k.filter(":first").outerWidth()*
k.length;g.css("width",m);"prepend"==q.type&&(g.is(":animated")&&g.stop(!1,!0),g.css("left",parseInt(g.css("left"))-A));g.find("li.selected").hasClass("visible")&&e.trigger("home",[null,!1])});e.unbind("forward backward").bind("forward backward",function(q,t){f({direction:q.type,steps:t.steps,animate:"undefined"!==typeof t.animate?t.animate:!0,fn:t.fn});t=g.find("li.selected");q="forward"==q.type?t.next("li:not(.dummy)"):t.prev("li:not(.dummy)");q.length&&(t.removeClass("selected"),q.addClass("selected"))});
e.unbind("home").bind("home",function(q,t,u){q=parseInt(h.length/2);q=h.filter(":eq("+q+")");var w=q.nextAll(".selected:first"),A=q.prevAll(".selected:first"),y=0,z="";"function"!==typeof t&&(u=t);u="undefined"!==typeof u?u:!0;w.length?(z="forward",q.nextAll().each(function(){++y;if(a(this).hasClass("selected"))return!1})):A.length&&(z="backward",q.prevAll().each(function(){++y;if(a(this).hasClass("selected"))return!1}));z&&y?f({direction:z,steps:y,fn:t,animate:u}):"function"==typeof t&&t();return!1});
...
if(c.isDefaultPrevented())return a.products.skip_dispatch=1,window.location.hash=a.products.list_hash,!1;this.hash=b;try{if(b)if(b=b.split("/"),b[0]){c="";for(var d=b.length,e=0;e<b.length;e++){var f=b[e];if(2>e)if(0===e)c=f;else if("product"==c||"tag"==c||"search"==c||"plugins"==c||"pages"==c||"stocks"==c){d=e;break}else if(parseInt(f,10)!=f&&-1==f.indexOf("="))c+=f.substr(0,1).toUpperCase()+f.substr(1);else{d=e;break}else{d=e;break}}var g=b.slice(d);this.preExecute(c,g);"function"==typeof this[c+
"Action"]?(a.shop.trace("$.products.dispatch",[c+"Action",g]),this[c+"Action"].apply(this,g)):a.shop.error("Invalid action name:",c+"Action")}else this.preExecute(),this.defaultAction();else this.preExecute(),this.defaultAction()}catch(h){a.shop.error(h.message,h)}}},load:function(b,c){var d=Math.random();this.random=d;var e=this;a.get(b,function(f){if(e.random==d&&(a("#s-content").removeClass("bordered-left").html(f),a("html, body").animate({scrollTop:0},200),c))try{c.call(this)}catch(g){a.shop.error("$.products.load callback error: "+
...
a.storage.get("shop/alerts");a(".s-alert").each(function(){-1==a.inArray(a(this).data("alert"),b)&&a(this).show()})},productAction:function(b,c,d){"undefined"!==typeof d&&"force-old"===d&&(d="main/"+d);var e=Array.prototype.slice.call(arguments).filter(function(g){return g.length}).join("/");a.shop.trace("$.products.productAction",[e,arguments]);var f="?module=product";b&&(f+="&id="+b);"undefined"!=typeof a.product?a.product.dispatch(e):this.load(f,function(g){a.product.dispatch(e)})},productTermination:function(){"undefined"!=
...
e.id+"/collapse");var g=e.id.replace(/\-handler$/,""),h=f.parents("div.block:first").find("#"+g+"-placeholder:first");if(h.length){var k=a(e).parents("div.block:first").find(".count:first");k.find("i.icon16.loading").remove();k.find("i.icon16").hide();k.prepend('<i class="icon16 loading"></i>');a.get(h.data("url"),function(l){h.replaceWith(a(l));k.find("i.icon16.loading").remove();k.find("i.icon16").show();h.remove()})}else e=a(e).parents("div.block:first").find("#"+g+":first"),e.length&&(e=e.data("on-expand-url"))&&
...
a(this).attr("href").replace(h,k))});a("#s-product-edit-forms").find(':input[name="product\\[id\\]"]').val(this.path.id);window.location.hash=g}c=a("#shop-productprofile h1");c.find(".s-product-name:first").text(b.name);c.find(".s-product-id").show().text("id: "+b.id);c=c.find(".s-new-product-editor-button");c.length&&(d=c.attr("href"),0<=d.indexOf("/new/")&&c.attr("data-href",c.attr("data-href").replace("/new/","/"+b.id+"/")).attr("href",d.replace("/new/","/"+b.id+"/")),c.show());document.title=
b.name+a.product.options.title_suffix;a("#product-stock-stat").html(tmpl("template-product-stock-stat",b.raw));e.find(':input[name="product\\[type_id\\]"]').parents(".value").data("type",b.type_id);if(a.isEmptyObject(b.frontend_urls))a(".s-product-frontend-url-not-empty").hide(),a(".s-product-frontend-url-empty").show();else{c=a("#s-product-frontend-url");c.text(b.url);a("#s-product-frontend-url-input").val(b.url);c.trigger("readable");d=c.parent();d.attr("href",b.frontend_urls[0].url);d.find("span:first").text(b.frontend_urls[0].base);
c.closest("div.value").find(".s-product-frontend-url").each(function(l){b.frontend_urls[l+1]&&a(this).attr("href",b.frontend_urls[l+1].url).text(b.frontend_urls[l+1].url)});a(".s-product-frontend-url-not-empty").show();a(".s-product-frontend-url-empty").hide();c="";d=0;for(g=b.frontend_urls.length;d<g;d+=1)c+=' <span class="s-product-frontend-url-not-empty"><a href="'+b.frontend_urls[d].url+'" target="_blank">'+b.frontend_urls[d].url+'</a><i class="icon10 new-window"></i></span> ';c&&a("#s-product-frontend-links").find(".s-product-frontend-url-not-empty").wrapAll("<div></div>").closest("div").replaceWith(c)}this.editTabMainUpdate(b.raw||
{},b.features_selectable_strings,f);e.find("select.s-product-categories").each(function(){var l=a(this),m=l.parent(),p=l.val();if("select"==p||"---"==p){var n=a("#s-product-edit-forms .s-product-form.main select.s-product-categories");1<n.length?m.remove():m.find(".s-product-delete-from-category").hide()}else if("create"==p){var r=m.find("input.val").val();"0"==r?(n=a("#s-product-edit-forms .s-product-form.main select.s-product-categories"),1<n.length?m.remove():(l.val(r),l.show().attr("disabled",
!1),m.find("input.val").attr("disabled",!0),m.find(".s-new-category").hide(),m.find(".s-product-delete-from-category").hide())):(l.val(r),l.show().attr("disabled",!1),m.find("input.val").attr("disabled",!0),m.find(".s-new-category").hide(),m.find(".s-product-delete-from-category").show())}p=parseInt(p,10);if(!a.isEmptyObject(b.storefront_map[p])){l="";p=b.storefront_map[p];for(n=0;n<p.length;n+=1)l+='<a class="hint" href="'+p[n]+'" target="_blank">'+p[n]+"</a> ";m.find(".s-storefront-map").html(l)}});
a("#s-product-categories").html(tmpl("template-product-categories",{categories:b.categories||[]}));a("#s-product-tags").html(tmpl("template-product-tags",{tags:b.tags||[]}));a("#s-product-save table.s-product-skus > tbody > tr").each(function(){var l=a(this).data("id");a(this).find("td.s-stock .s-product-stock-icon").each(function(){var m=a(this).data("stock");b.raw&&b.raw.skus&&b.raw.skus[l]&&b.raw.skus[l].stock_icon[m]&&a(this).html(b.raw.skus[l].stock_icon[m])})});e.find("tr.js-sku-settings").each(function(){var l=
a(this),m=l.attr("data-id");(m=b.raw.skus[m])&&void 0!==m.file_name&&!m.file_name&&(l.find(".s-sku-attachment").hide(),l.find(".fileupload").show())});this.helper.checkChanges(this.get("form"),!0);a("#s-product-edit-menu li a i.icon10.status-yellow-tiny").remove();this.helper.updateSubmitButton(!1);"0"==b.raw.sku_type&&(e=a("#s-product-feature-superposition"),e.find("input[type=checkbox]").attr("checked",!1),f=e.find("ul.features li"),f.find(".count").text(""),f.find("i").removeClass("status-blue-tiny status-gray-tiny").addClass("status-gray-tiny"),
...
a.product_reviews.form),g=a.product_reviews.form.parents(".s-review:first").parent("li"),h=e.data.html,k=a("ul:first",g),l=a.product_reviews.container;g.length||(l.show(),k=a("ul:first",l).show());k.length||(k=a('<ul class="menu-v with-icon"></ul>'),g.append(k));k.append(a('<li data-id="'+e.data.id+'" data-parent-id="'+e.data.parent_id+'"></li>').append(h));a("textarea",a.product_reviews.form).val("");g=a("#s-review-add");g.find("form").length||(g.append(a.product_reviews.form),f.val(0));d.length&&
...
state:"undefined"===typeof b.auto||b.auto?"wake":"stop",hash:"stocks",load:function(){a(window).lazyLoad("sleep");a(".lazyloading-link").hide();a(".lazyloading-progress").show();var g=function(k){console&&(k&&k.errors?console.error("Error when loading products: "+k.errors):k&&k.responseText?console.error("Error when loading products: "+k.responseText):console.error(k));a(window).lazyLoad("stop")},h=["module=stocksBalance","offset="+c,"total_count="+d];f.options.order&&h.push("order="+f.options.order);
e&&h.push("sort="+e);a.get("?"+h.join("&"),function(k){k&&"ok"===k.status?(c+=k.data.count,f.append({product_stocks:k.data.product_stocks,stocks:f.stocks})?(a(".lazyloading-progress-string").text(k.data.progress.loaded+" "+k.data.progress.of),a(".lazyloading-progress").hide(),a(".lazyloading-chunk").text(k.data.progress.chunk),c>=d?(a(window).lazyLoad("stop"),a(".lazyloading-link").hide()):(a(".lazyloading-link").show(),a(window).lazyLoad("wake"))):a(window).lazyLoad("stop")):g(k)},"json").error(g)}});
...
initInlineEditor:function(){function c(f,g){if(f.data("denied-reason")==g)f.data("denied-reason",""),alert(g);else{f.data("denied-reason",g);setTimeout(function(){f.data("denied-reason","")},3E3);f.wrapInner('<div class="animation-container" style="position:relative;"></div>');var h=f.find(".animation-container").animate({left:"3px"},100,function(){h.animate({left:"0px"},100,function(){h.animate({left:"3px"},100,function(){h.animate({left:"0px"},100,function(){h.children().first().unwrap()})})})})}}
function d(f){var g=[];a.product_list.container.find("tr.product").each(function(){var h=a(this);void 0===h.data("original-price")&&h.data("edit-rights")&&g.push(a(this).data("product-id"))});if(!g.length)return f();a.post("?module=products&action=inlineEditorData",{ids:g},function(h){h.data&&a.product_list.container.find("tr.product").each(function(){var k=a(this),l=h.data[parseInt(k.data("product-id"),10)];l&&(k.data("stocks",l.stocks||null),k.data("original-price",l.price.replace(/\.?0+$/g,"")))});
f()},"json")}var e=this;a.product_list.highlightInlineEditorCells();a.product_list.container.on("append_product_list",function(){a.product_list.highlightInlineEditorCells()});a.product_list.container.on("click",".s-product-price,.s-product-stock",function(){function f(){if(k)g.html(tmpl("template-list-price-editor-one",{product_id:h.data("product-id"),currency:h.data("currency"),value:h.data("original-price")}));else{var l=h.data("stocks");l&&"object"==typeof l?g.html(tmpl("template-list-stock-editor-many",
{product_id:h.data("product-id"),values:l})):g.html(tmpl("template-list-stock-editor-one",{product_id:h.data("product-id"),value:l||""}))}g.find(".cancel").click(function(){var p=g;p.removeClass("editor-on").html(p.data("read-only-state-html"));p.data("read-only-state-html","");p.data("denied-reason","")});var m=g.find("form").submit(function(){if(m.find(".loading").length)return!1;m.find(":submit").after('<i class="icon16 loading"></i>');a.post("?module=products&action=inlineSave",m.serialize(),
function(p){m.find(".loading").remove();try{p.data&&p.data[0]&&(p.data[0].alien=h.hasClass("s-alien"));var n=a("<table>").html(tmpl("template-product-list-table",{products:p.data,check_all:a.product_list.container.find(".s-select-all:first").prop("checked"),sort:a.product_list.sort}));h.replaceWith(n.find("tr"));e.container.trigger("append_product_list",[p.data])}catch(r){console.log("Error: "+r.message)}},"json");return!1});m.on("dblclick",!1);setTimeout(function(){g.find(":input:visible:first").focus()},
0)}var g=a(this);if(!g.data("plugin")){var h=g.closest("tr"),k=g.hasClass("s-product-price");if(k){if(h.data("min-price")!=h.data("max-price"))return c(g,$_("Inline editing is available only for products with a single SKU"))}else if("1"!=h.data("sku-count"))return c(g,$_("Inline editing is available only for products with a single SKU"));if(!h.data("edit-rights"))return c(g,$_("Insufficient access rights"));g.hasClass("editor-on")||(g.addClass("editor-on").data("read-only-state-html",g.html()),a.product_list.container.removeClass("single-lined"),
void 0!==h.data("original-price")?f():(g.html('<i class="icon16 loading"></i>'),d(f)))}})},initFixedBlocks:function(){var c=a("#mainmenu").height(),d=a("#s-sidebar").width(),e=a(window),f=a("#s-fixed-blocks");f.length||(f=a('<div id="s-fixed-blocks"></div>').css({display:"none",position:"fixed",background:"#fff",top:c,width:d,"float":"left"}).appendTo("#s-sidebar"));var g=a("#s-category-list"),h=a("#s-category-list-block"),k=a("#s-set-list"),l=a("#s-set-list-block"),m=function(){function n(){if(!x){var u=
a("#s-category-list-handler");t=a.categories_tree.isCollapsed(u);q=g.is(":hidden");var w=a('<div id="s-category-list-dummy" class="block"></div>').css({height:h.height()});h.replaceWith(w);f.show().append(h.hide());h.find(".heading").before('<span class="hint float-right" style="margin-top: 3px;">'+$_("Drag products here")+"</span>");t&&a.categories_tree.expand(u,null,function(){a.categories_tree.collapse(u)});q||g.hide();h.show();a("i.add",h).hide();a("#s-category-list-handler").hide();h.css({"overflow-x":"hidden",
"overflow-y":"auto"});(function(){var A=g.is(":hidden"),y;h.bind("mousemove.fixed_blocks.category",function(z){document.getElementById("products-helper")&&A&&(y&&(clearTimeout(y),y=null),y=setTimeout(function(){if(A){h.css({height:""});g.show();var B=h.height(),D=(e.height()-c)/2;h.css({height:Math.min(B,D)});h.find(".heading").prev(".hint").hide();A=!1}},250))});e.bind("mouseout.fixed_blocks.category",function(z){z.pageX>d+10&&(y&&clearTimeout(y),y=null,A||(g.hide(),h.css({height:""}),h.find(".heading").prev(".hint").show(),
A=!0))})})();x=!0}}function r(){if(x){var u=a("#s-category-list-dummy");u.replaceWith(h);h.css({"overflow-x":"","overflow-y":""});var w=a("#s-category-list-handler");t&&a.categories_tree.collapse(w);q||g.show();h.find(".heading").prev(".hint").remove();a("#s-category-list-handler").show();a("i.add",h).show();u.remove();h.unbind("mousemove.fixed_blocks.category");e.unbind("mouseout.fixed_blocks.category");f.children().length||f.hide();x=!1;a.categories_tree.init()}}var v=h.offset().top,x=!1,q,t;e.unbind("scroll.fixed_blocks.category").bind("scroll.fixed_blocks.category",
function(){x||(v=h.offset().top);var u=v;u=document.getElementById("s-category-list-dummy")?u+a("#s-category-list-dummy").height():u+a("#s-category-list-block").height();e.scrollTop()+c+5>=u?n():r()});return{setFixed:n,unsetFixed:r}}(),p=function(){function n(){if(!q){x=k.is(":hidden");var t=a('<div id="s-set-list-dummy" class="block"></div>').css({height:l.height()});l.replaceWith(t);f.show().append(l);l.find(".heading").before('<span class="hint float-right" style="margin-top: 3px;">'+$_("Drag products here")+
"</span>");x||k.hide();a("i.add",l).hide();a("i.collapse-handler",l).hide();l.css({"overflow-x":"hidden","overflow-y":"auto"});(function(){var u=k.is(":hidden"),w;l.bind("mousemove.fixed_blocks.set",function(A){document.getElementById("products-helper")&&u&&(w&&(clearTimeout(w),w=null),w=setTimeout(function(){if(u){l.css({height:""});k.show();var y=l.height(),z=(e.height()-c)/2;l.css({height:Math.min(y,z)});l.find(".heading").prev(".hint").hide();u=!1}},250))});e.bind("mouseout.fixed_blocks.set",
function(A){A.pageX>d+10&&(w&&clearTimeout(w),w=null,u||(k.hide(),l.css({height:""}),l.find(".heading").prev(".hint").show(),u=!0))})})();q=!0}}function r(){if(q){var t=a("#s-set-list-dummy");t.replaceWith(l);l.css({"overflow-x":"","overflow-y":""});l.find(".heading").prev(".hint").remove();x||k.show();a("i.add",l).show();a("i.collapse-handler",l).show();t.remove();l.unbind("mousemove.fixed_blocks.category");e.unbind("mouseout.fixed_blocks.category");f.children().length||f.hide();q=!1}}var v=l.offset().top,
x,q=!1;e.unbind("scroll.fixed_blocks.set").bind("scroll.fixed_blocks.set",function(){q||(v=l.offset().top);var t=v;t=document.getElementById("s-set-list-dummy")?t+a("#s-set-list-dummy").height():t+a("#s-set-list-block").height();e.scrollTop()+c+5>=t?n():r()});return{setFixed:n,unsetFixed:r}}();return{category:m,set:p}},initEditingControls:function(){var c=a("#s-product-list-title"),d=a.product_list.collection_hash[0],e="?module=category&action=save&";"set"===d&&(e="?module=set&action=save&");c.hasClass("editable")&&
(c.inlineEditable({minSize:{width:350},maxSize:{width:600},size:{height:30},inputClass:"s-title-h1-edit",beforeMakeEditable:function(){a(".s-product-list-manage").hide()},afterBackReadable:function(f,g){a(".s-product-list-manage").show();if(!g.changed)return!1;a.shop.jsonPost(e+a.product_list.collection_param+"&edit=name",{name:a(f).val()},function(h){a.product_list.sidebar.find("#"+d+"-"+h.data.id).find(".name:first").html(h.data.name)})}}),"name"==this.options.edit&&c.trigger("editable"));c=a("#s-product-list-settings");
!c.length||"category"!=d&&"set"!=d||c.unbind("click").bind("click",function(){"category"==d?shopDialogProductsCategory.staticDialog(a.product_list.collection_hash[1],null,"edit"):shopDialogProductsSet.staticDialog(a.product_list.collection_hash[1],"edit");return!1});c=a("#s-product-list-delete");!c.length||"category"!=d&&"set"!=d||c.unbind("click").bind("click",function(){a("#s-product-list-delete-dialog").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},
onSubmit:function(){function f(p,n){if(!p.length)return n&&n();var r=p.shift();g(["category",r],function(){f(p,n)})}function g(p,n){var r={hash:p.join("/")||"all",remove:["list"]};m&&r.remove.push("products");var v=function(){a.product_list.remove(r,function(q,t){h(p,q);a.product_list.sidebar.trigger("update",q.data.lists);n&&n()})},x=a("#"+p.join("-")+"-handler");x.length?a.categories_tree.expand(x,function(q){q.parent().find("ul:first").hide();v()}):v();return!1}function h(p,n){var r=p[0],v=a("#"+
p.join("-")),x=v.prev(".drag-newposition");p=a("#s-"+p[0]+"-list");var q=p.find("ul:first");"set"==r?(v.remove(),x.remove()):(r=v.find("ul:first"),r.length&&(r.find(">li.drag-newposition:first").remove(),v.hide(),r.find(">li").each(function(){v.after(this)})),r=v.parents("ul:first"),v.remove(),x.remove(),r.find("li.dr").length||(q.get(0)!=r.get(0)?(r.parents("li:first").find("i.collapse-handler").remove(),r.closest("li").find(".collapse-handler-ajax:first").remove(),r.remove()):q.closest(".block").find(".collapse-handler-ajax:first").remove()));
q.find("li.dr:first").length?(q.show(),p.find(".s-empty-list").hide()):(q.hide(),p.find(".s-empty-list").show());n.data.old_parent_category&&"undefined"!==typeof n.data.old_parent_category.children_count&&!parseInt(n.data.old_parent_category.children_count,10)&&a("#category-"+n.data.old_parent_category.id+"-handler").remove()}var k=a(this),l=parseInt(a.product_list.collection_hash[1]);k.find(".dialog-buttons i.loading").show();var m="1"==k.find("input[name=s-delete-products]:checked").val();"category"==
d&&k.find('input[name="s-delete-sub"]').is(":checked")?a.get("?action=categoryExpand&tree=1&recurse=1&id="+l,function(p){p=a("<div>").html(p).find('li[id^="category-"]').map(function(){return parseInt(this.id.substr(9),10)}).get().reverse();p.push(l);f(p,function(){location.href="#/"})}):g(a.product_list.collection_hash,function(){location.href="#/"});return!1}});return!1});"set"===d&&a("#s-embed-code").click(function(){a("#s-product-list-embed-dialog").waDialog();return!1})},initDragndrop:function(){a.product_dragndrop.init({products:!0,
view:this.options.view,sort:this.options.sort}).bind("move_product",function(c){a.shop.jsonPost("?module=product&action=move&"+a.product_list.collection_param,{product_ids:c.product_ids,before_id:c.before_id||null},c.success,c.error)}).bind("is_product_sortable",function(){return a.product_list.sortable}).bind("add_to_list",function(c){var d={};c.whole_list?d.hash=a.product_list.collection_hash.join("/")||"all":d.product_id=c.product_ids;a.shop.jsonPost("?module=product&action=addToList&"+c.collection_param,
d,c.success,c.error)})},initToolbar:function(){var c=this.toolbar;c.find("li").unbind("click.product_list").bind("click.product_list",function(d){d.preventDefault();d=a(this);var e=d.attr("data-action");if(e){var f=a.product_list.getSelectedProducts("delete"!=e);if(!f.count)return alert($_("Please select at least one product")),!1;switch(e){case "new-set":break;case "category":a.product_list.categoriesDialog(f);break;case "set":a.product_list.setsDialog(f);break;case "type":a.product_list.typesDialog(f);
break;case "assign-tags":a.product_list.assignTagsDialog(f);break;case "delete":a.product_list.deleteProductsDialog(f);break;case "delete-from-set":"set"==a.product_list.collection_hash[0]&&a.product_list.deleteFromSet(f);break;case "delete-from-category":"category"==a.product_list.collection_hash[0]&&a.product_list.deleteFromCategory(f);break;case "visibility":a.product_list.visibilityDialog(f,d);break;case "export":a.product_list.exportProducts(f,a(this).attr("data-plugin"));break;case "duplicate":a.product_list.duplicateProducts(f,
a(this));break;case "promo":a.product_list.associatePromo(f,a(this));break;case "coupon":a.product_list.createCoupon(f);break;case "set-badge":case "delete-badge":a.product_list.setBadge(f,a(this));break;default:return}return!1}});c.find('li[data-action="set-custom-badge"] a').click(function(){a(this).parent().find(".textarea-wrapper").slideToggle("fast");return!1}).closest("li").find(".textarea-wrapper").click(function(){return!1}).find("input").click(function(){var d=a.product_list.getSelectedProducts(!0);
d.count?a.product_list.setBadge(d,a(this).closest("li")):alert($_("Please select at least one product"));return!1});(function(){var d,e=a("#mainmenu").height(),f=c.find(":first").offset().top-e,g=a(document),h=a(window);g.bind("scroll",d=function(){jQuery.contains(document.documentElement,c[0])?g.scrollTop()>f&&c.height()+e<h.height()?c.addClass("s-fixed").css({top:e}):c.removeClass("s-fixed"):(g.off("scroll",d),h.off("resize",d))});h.bind("resize",d)})()},getSelectedProducts:function(c){c=c||!1;
var d={count:0};if(this.container.find(".s-select-all:first").attr("checked")){var e=a.product_list.collection_hash.join("/")||"all";c?d.serialized=[{name:"hash",value:e}]:d.hash=e;d.count=this.total_count}else c?d.serialized=a.product_list.container.find(".product.selected").map(function(){d.count+=1;return{name:"product_id[]",value:a(this).attr("data-product-id")}}).toArray():d.product_id=a.product_list.container.find(".product.selected").map(function(){d.count+=1;return a(this).attr("data-product-id")}).toArray();
return d},visibilityDialog:function(c,d){if(!a.isArray(c.serialized))return!1;var e=d.find("i.icon16");if(!e.hasClass("loading")){d=a("#visibility-dialog-wrapper");d.length||(d=a('<div id="visibility-dialog-wrapper">').appendTo("#s-content"));var f=e.attr("class");e.attr("class","icon16 loading");d.data("products",c).load("?module=dialog&action=visibility",function(){e.attr("class",f)})}},categoriesDialog:function(c){var d=a("#s-categories"),e=this.sidebar,f=this.container;d.length&&d.parent().remove();
a("<div></div>").appendTo("body").load("?module=dialog&action=categories",function(){a("#s-categories").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){var g=a(this);g.find(".dialog-content h1 span").text("("+c.count+")").show();g.find(".dialog-buttons i.loading").hide();g.find("input[name=new_category_name]").val("");g.find("input[name=new_category]").attr("checked",!1)},onSubmit:function(g){var h=g.find("form");h.find(".dialog-buttons i.loading").show();a.shop.jsonPost(h.attr("action"),h.serializeArray().concat(c.serialized),
function(k){k.data.new_category&&a("#s-category-list ul:first").trigger("add",[k.data.new_category,"category","#/products/category_id="+k.data.new_category+"&view="+a.product_list.options.view]);k.data.categories&&(e.trigger("update",[{category:k.data.categories}]),f.find(".s-select-all:first").trigger("select",!1));h.find("input:checked").attr("checked",!1);g.trigger("close")});return!1}})})},setsDialog:function(c){var d=a("#s-sets"),e=this.sidebar,f=this.container;d.length&&d.parent().remove();
a("<div></div>").appendTo("body").load("?module=dialog&action=sets",function(){a("#s-sets").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){var g=a(this);g.find(".dialog-content h1 span").text("("+c.count+")").show();g.find(".dialog-buttons i.loading").hide();g.find("input[name=new_set_name]").val("");g.find("input[name=new_set]").attr("checked",!1)},onSubmit:function(g){var h=g.find("form");h.find(".dialog-buttons i.loading").show();a.shop.jsonPost(h.attr("action"),h.serializeArray().concat(c.serialized),
function(k){k.data.new_set&&a("#s-set-list ul:first").trigger("add",[k.data.new_set,"set","#/products/set_id="+k.data.new_set+"&view="+a.product_list.options.view]);k.data.sets&&(e.trigger("update",[{set:k.data.sets}]),f.find(".s-select-all:first").trigger("select",!1));h.find("input:checked").attr("checked",!1);g.trigger("close")});return!1}})})},assignTagsDialog:function(c){var d=a("#s-assign-tags"),e=function(){a("#s-assign-tags").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){var f=a(this);
f.find(".dialog-content h1 span").text("("+c.count+")").show();f.find(".dialog-buttons i.loading").hide()},onSubmit:function(f){var g=a(this),h=g.find("#s-assign-tags-list_tag");if(h.length){var k=jQuery.Event("keypress",{which:13});h.trigger(k)}g.find(".dialog-buttons i.loading").show();var l=g.attr("action");setTimeout(function(){var m=g.serializeArray().concat(c.serialized);a.shop.jsonPost(l,m,function(p){p.data.denied_message&&alert(p.data.denied_message);"search"===p.data.cloud?f.trigger("close"):
p.data.cloud&&a("#s-tag-cloud").trigger("update",[p.data.cloud]);f.trigger("close");a.products.dispatch()},function(){f.trigger("close")})},10);return!1}})};d.length&&d.remove();a.post("?module=dialog&action=assignTags",c.serialized,function(f){a("body").append(f);e()})},typesDialog:function(c){var d=a("#s-types"),e=this.container,f=this.sidebar,g=function(){a("#s-types").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(k){var l=
a(this);l.find(".dialog-buttons i.loading").show();a.shop.jsonPost(l.attr("action"),l.serializeArray().concat(c.serialized),function(m){f.trigger("update",{type:m.data.types});e.find(".s-select-all:first").trigger("select",!1);l.find("input:checked").attr("checked",!1);k.trigger("close");a.products.dispatch()});return!1}})},h=d.parent();d.length?g():(h=a("<div></div>").appendTo("body"),h.load("?module=dialog&action=types",g))},deleteFromSet:function(c){0<c.count&&a.shop.jsonPost("?module=products&action=deleteFromSet&id="+
this.collection_hash[1],c.serialized,function(){a.products.dispatch()})},deleteFromCategory:function(c){0<c.count&&a.shop.jsonPost("?module=products&action=deleteFromCategory&id="+this.collection_hash[1],c.serialized,function(){a.products.dispatch()})},deleteProductsDialog:function(c){var d=function(){a("#s-product-list-delete-products-dialog").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a(this).find(".dialog-buttons i.loading").hide()},onSubmit:function(g){a(this).find(".dialog-buttons i.loading").show();
a.product_list.remove(a.extend(c,{remove:["products"]}),function(h,k){a.product_list.sidebar.trigger("update",h.data.lists);a.products.dispatch();g.trigger("close");k.length&&alert((g.data("not-allowed-string")||"").replace("%d",k.length))});return!1}})},e=a("#s-product-list-delete-products-dialog"),f=e.parent();e.length||(f=a("<div></div>").appendTo("body"));0<c.count&&f.load("?module=dialog&action=productsDelete",c,d)},exportProducts:function(c,d){for(var e=[],f,g=!1;f=c.serialized.pop();)f.name&&
("product_id[]"==f.name?e.push(parseInt(f.value,10)):"hash"==f.name&&(g=f.value));c="?action=importexport#/"+d;g?window.location=c+("/hash/"+g):e.length&&(c+="/hash/id/"+e.join(","),window.location=c)},createCoupon:function(c){for(var d=[],e,f=!1;e=c.serialized.pop();)e.name&&("product_id[]"==e.name?d.push(parseInt(e.value,10)):"hash"==e.name&&(f=e.value));c=this.options.marketing_url+"coupons/create/";f?window.location=c+("?products_hash="+f):d.length&&(c+="?products_hash=id/"+d.join(","),window.location=
c)},duplicateProducts:function(c,d){for(var e=[],f,g=!1;f=c.serialized.pop();)f.name&&("product_id[]"==f.name?e.push(parseInt(f.value,10)):"hash"==f.name&&(g=f.value));!g&&e.length&&(g="id/"+e.join(","));g&&(d.find("i.icon16").removeClass("split").addClass("loading"),this.duplicate(g,{progress:function(h){d.attr("title",Math.round(100*h.offset/h.total_count)+"%")},finish:function(h,k){d.attr("title",null);var l=d.find("i.icon16");l.removeClass("loading").addClass("yes");setTimeout(function(){l.removeClass("yes").addClass("split")},
3E3);a(document).one("product_list_init_view",function(){var m={};a.each(k,function(p,n){m[n]=1});a("#product-list [data-product-id]").each(function(){var p=a(this),n=a(this).data("product-id");n&&m[n]&&p.addClass("highlighted")})});(h||k)&&a.products.dispatch()},error:function(h){}}))},setBadge:function(c,d){function e(l){var m="delete-badge"==f?null:l.data;a("#product-list [data-product-id]").each(function(){var p=a(this);if(h||g[p.data("product-id")]){if(p.is("tr")){var n=p.find(".s-image a");
n.find(".s-image-corner").remove();m&&n.prepend(a('<div class="s-image-corner"></div>').html(m))}else n=p.find(".s-product-image a"),n.find(".s-image-corner.top.right").remove(),m&&n.append(a('<div class="s-image-corner top right"></div>').html(m));p.trigger("badge",[m])}});"set-custom-badge"==f&&d.parent().find(".textarea-wrapper").slideUp("fast");d.find(".loading").remove();d.find("a").append(a('<span class="count"><i class="icon16 yes"></i></span>').animate({opacity:0},function(){a(this).remove()}));
a.product_list.container.find(".s-select-all:first").trigger("select",!1)}var f=d.data("action");"set-custom-badge"!=f&&d.parent().find(".textarea-wrapper").slideUp("fast");d.find(".loading").remove();d.find("a").append('<span class="count"><i class="icon16 loading"></i></span>');var g={},h=!1;a.each(c.serialized,function(){h=h||"hash"==this.name;g[this.value]=1});if("delete-badge"==f)d.find(".loading").remove(),a.shop.jsonPost("?module=product&action=badgeDelete",c.serialized,e);else{var k="set-custom-badge"==
f?d.find("textarea").val():d.data("type");c=c.serialized;c.push({name:"code",value:k});a.shop.jsonPost("?module=product&action=badgeSet",c,e,function(l){"object"===typeof l.errors&&"string"===typeof l.errors[0]&&alert(l.errors[0]);d.find(".loading").remove()})}},duplicate:function(c,d){var e=this,f=[];a.shop.jsonPost("?module=products&action=duplicate",{hash:c,limit:50,offset:d.offset||0},function(g){"ok"==(g.status||"error")?(f=f.concat(g.data.new_ids||[]),g.data.offset<g.data.total_count?(d.offset=
g.data.offset,e.duplicate(c,d),d.progress(g.data||{})):d.finish(g.data||{},f)):"fail"==g.status&&g.errors.message&&a("#s-product-list-duplicate-error-dialog").waDialog()},function(g){if(g.errors)if(d.finish(),g.errors.message){var h=a("#s-product-list-duplicate-error-dialog");h.find(".js-content").html(g.errors.message);h.waDialog()}else alert(g.errors)})},remove:function(c,d){var e={},f=[];if(c.product_id)var g=function(){100>=c.product_id.length&&(e.get_lists=!0);e.product_id=c.product_id.splice(0,
100);a.shop.jsonPost("?module=products&action=deleteList",e,function(h){h.data.not_allowed&&h.data.not_allowed.length&&(f=f.concat(h.data.not_allowed));c.product_id.length?g():"function"===typeof d&&d(h,f)})};else e.hash=c.hash||this.collection_hash.join("/")||"all",e.remove=a.isArray(c.remove)&&c.remove.length?c.remove:["list"],1==e.remove.length&&"list"==e.remove[0]?g=function(){a.shop.jsonPost("?module=products&action=deleteList",e,d)}:(e.count=100,g=function(){a.shop.jsonPost("?module=products&action=deleteList",
e,function(h){h.data.not_allowed&&h.data.not_allowed.length&&(f=f.concat(h.data.not_allowed));0<h.data.rest_count&&null!=h.data.rest_count?g():"function"===typeof d&&d(h,f)})});g()},associatePromo:function(c,d){function e(){var f=location.pathname+"?module=productsAssociatePromoDialog",g={products_hash:b(c.serialized)};return a.post(f,g).done(function(h){a(h).waDialog({onLoad:function(){a("body").addClass("is-scroll-locked")},onCancel:function(){a("body").removeClass("is-scroll-locked");a(this).remove()}})})}
d.data("locked")||(d.data("locked",!0),e().always(function(){d.removeData("locked")}))},rubberTable:function(){var c=a("#wa"),d=a("#s-content"),e=a("#s-content > .content");d=parseInt(d.css("margin-left"));var f=parseInt(e.css("margin-right")),g=a(".s-product-list-table-container table").width(),h=c.attr("style");h&&c.data("style",h);e=parseInt(e.width()-a(".s-product-list-table-container").width())+g+d+f;c.width()<e&&c.css({"min-width":e+"px"});a(window).resize()}}})(jQuery);var shopDialogProductsSet=function(a){shopDialogProductsSet=function(b){this.$wrapper=b.$wrapper;this.is_new=b.is_new;this.initClass()};shopDialogProductsSet.prototype.initClass=function(){this.is_new&&this.initTransliterateSetID();this.initTypeSwitch();this.initDatepickers()};shopDialogProductsSet.prototype.initTypeSwitch=function(){var b=this.$wrapper;b.find("input[name=type]").on("click",function(){"0"==a(this).val()?b.find(".js-set-dynamic-settings").hide():b.find(".js-set-dynamic-settings").show()})};
...
"&sort="),p=p.replace(/&order=[^&]*/,"&order="))}else p="#/products/set_id="+m.data.id;"new"===c&&a.product_sidebar.createNewElementInList(m.data,"set");a.product_sidebar.updateItemInCategoryList(m,p);location.hash!=p?location.hash=p:a.products.dispatch();g.trigger("close")},l=function(m){if(m&&m.errors){m=m.errors;var p=0,n;for(n in m){var r=g.find("input[name="+n+"]");if(r.length){r.addClass("error");p+=1;var v=r.parent().find(".errormsg");v.length&&v.text(m[n]);r.one("keyup",function(){--p||h.find("[type='submit']").removeAttr("disabled",
!1);r.removeClass("error");v.length&&v.text("")})}}return!1}};if(h.find("input:file").length)a.products._iframePost(h,k,l);else return a.shop.jsonPost(h.attr("action"),h.serialize(),k,l),!1},onClose:function(){d.find(".js-datepicker").each(function(){a(this).datepicker("widget").hide()})}})};var f=d.length?d.closest(".s-products-set-dialog-wrapper").empty():a('<div class="s-products-set-dialog-wrapper"></div>').appendTo("body");"new"===c?f.load("?module=set&action=Create",e):"edit"===c&&f.load("?module=set&action=Edit&set_id="+
b,e)};return shopDialogProductsSet}(jQuery);var shopDialogProductsCategory=function(a){shopDialogProductsCategory=function(b){this.$wrapper=b.$wrapper;this.SEARCH_STEP=b.SEARCH_STEP;this.category_id=b.category_id;this.category_type=b.category_type;this.account_name=b.account_name;this.filter_count=b.filter_count;this.filter_ignore_id=[];this.ignore_id=[];this.filter_element_html=b.templates.filter_element_html;this.show_more_filters_text=b.texts.show_more_filters_text;this.initClass()};shopDialogProductsCategory.prototype.initClass=function(){var b=
this;b.initAutocomplete();b.initEvent();b.initFilter();b.initMetaTagEdit();b.initFrontendUrlEdit();b.initCategoryVisibility();b.initSocialMetaTag();b.initShowMoreFilters();b.initFilterIgnoreId();b.updateShowFilterButton();b.initFilterAutocomplete();var c=b.$wrapper.find('*[data-slider="range"]');c.length&&c.each(function(){b.initRangeSlider(".js-feature-slider-"+a(this).data("code"))})};shopDialogProductsCategory.prototype.initEvent=function(){this.initDynamicSettingsEvent();this.disableManualSorting();
this.initShowMore();this.initShowAllFeatureValue();this.initGetFeatures()};shopDialogProductsCategory.prototype.initShowMoreFilters=function(){var b=this;b.$wrapper.on("click",".js-show-more-filters",function(c){c.preventDefault();c={category:b.category_id,offset:b.getFilterOffset(),ignore_id:b.filter_ignore_id,category_type:b.category_type};a.post("?module=categoryGetFeatures",c).success(function(d){if(!d||!d.data.features)return!1;a.each(d.data.features,function(e,f){b.setFilterElement(f)});b.updateShowFilterButton()})})};
shopDialogProductsCategory.prototype.updateShowFilterButton=function(){var b=this.SEARCH_STEP,c=this.$wrapper.find(".js-show-more-filters"),d=this.$wrapper.find(".js-category-filters .js-filter-checkbox").length,e=this.show_more_filters_text;d=d-1-this.filter_ignore_id.length;d+this.SEARCH_STEP>this.filter_count&&(b=this.filter_count-d);1<=b?(d=this.filter_count-d,e=e.replace(/%d/g,b),e=e.replace(/%all/g,d),c.text(e)):c.hide()};shopDialogProductsCategory.prototype.setFilterElement=function(b,c){var d=
this.filter_element_html,e=this.$wrapper.find(".js-category-filters");c=c?c:!1;d=d.replace(/%id/g,b.id);d=d.replace(/%name/g,b.name);d=d.replace(/%code/g,b.code);d=d.replace(/%type_name/g,b.type_name);e.append(d);c&&this.$wrapper.find('.js-category-filter input[data-filter-id="'+b.id+'"]').prop("checked",!0)};shopDialogProductsCategory.prototype.getFilterOffset=function(){var b=this.$wrapper.find(".js-category-filters .js-filter-checkbox").length;b=b-1-this.filter_ignore_id.length;0>b&&(b=0);return b};
shopDialogProductsCategory.prototype.initFilterIgnoreId=function(){var b=[];this.$wrapper.find(".js-category-filters .js-filter-checkbox:checked").each(function(){var c=a(this).val();"price"!==c&&b.push(c)});this.filter_ignore_id=b};shopDialogProductsCategory.prototype.initFilterAutocomplete=function(){var b=this,c=b.$wrapper.find(".js-filter-autocomplete");c.autocomplete({source:function(d,e){a.post("?action=autocomplete&type=filter",{term:d.term,category_id:b.category_id,options:{ignore_id:b.filter_ignore_id,
category_type:b.category_type}},function(f){e(f)},"json")},minLength:1,delay:300,create:function(){c.autocomplete("widget").appendTo(".js-filter-autocomplete-block")},select:function(d,e){d.preventDefault();b.setFilterElement(e.item,!0);b.filter_ignore_id.push(parseInt(e.item.id));a(this).val("");return!1},focus:function(){return!1}})};shopDialogProductsCategory.prototype.initAutocomplete=function(){var b=this,c=b.$wrapper.find(".js-autocomplete"),d=[];c.length&&c.autocomplete({source:function(e,
f){b.$wrapper.find(".js-condition-feature").each(function(){var g=a(this).data("feature_id");a.isNumeric(g)&&-1==a.inArray(g,d)&&d.push(g)});a.ajax({type:"POST",url:"?action=autocomplete&type=feature",data:{term:e.term,options:{ignore_id:d,count:1}},success:function(g){var h=b.$wrapper.find(".js-autocomplete-wrapper .errormsg");f(g);0===g.length?h.html("").html($_("Matching features were not found or are already selected.")):h.html("")},dataType:"json"})},minLength:1,delay:300,create:function(){c.autocomplete("widget").appendTo(".js-autocomplete-block")},
select:function(e,f){b.renderFeature(f.item.id);b.ignore_id.push(parseInt(f.item.id));return!1},focus:function(){return!1}})};shopDialogProductsCategory.prototype.initRangeSlider=function(b){var c=a(b).find(".js-begin"),d=a(b).find(".js-end"),e=parseFloat(c.attr("placeholder")),f=parseFloat(d.attr("placeholder")),g=1,h=a(b).find(".js-range-slider");if(h.data("step"))g=parseFloat(h.data("step"));else if(b=f-e,Math.round(e)!=e||Math.round(f)!=f){g=b/10;for(b=0;1>g;)g*=10,b+=1;g=Math.pow(10,-b);(b=Math.round(1E5*
Math.abs(Math.round(e)-e))/1E5)&&b<g&&(g=b);(b=Math.round(1E5*Math.abs(Math.round(f)-f))/1E5)&&b<g&&(g=b)}e=parseFloat(c.val()?c.val():0);f=parseFloat(d.val()?d.val():100<c.val()?parseFloat(c.val())+100:100);h.slider({range:!0,min:e-3,max:f+5,step:g,values:[e,f],slide:function(k,l){k=a(this).slider("option","min");var m=a(this).slider("option","max");2!=a(l.handle).index()&&(l.values[0]==k&&a(this).slider("option","min",k-g),c.val(l.values[0]));1!=a(l.handle).index()&&(l.values[1]==m&&a(this).slider("option",
"max",m+g),d.val(l.values[1]))},stop:function(k,l){d.change()}});c.add(d).change(function(){var k=""===c.val()?h.slider("option","min"):parseFloat(c.val()),l=""===d.val()?h.slider("option","max"):parseFloat(d.val());l>=k&&(h.slider("option","values",[k,l]),h.slider("option","max",parseFloat(l)+5),h.slider("option","min",parseFloat(k)-3))})};shopDialogProductsCategory.prototype.initShowFeatures=function(b,c,d,e,f){var g=b.type.substr(0,5);if("range"==g){var h=[],k=[],l;for(l in b.values)b.values.hasOwnProperty(l)&&
(h.push(parseInt(b.values[l].begin)),k.push(parseInt(b.values[l].end)));b.values={};b.values[0]={begin:Math.min.apply(Math,h)?Math.min.apply(Math,h):"",end:Math.max.apply(Math,k)?Math.max.apply(Math,k):""}}c.append(tmpl(d,{feature:b,default_checked:e,show_all:f}));"range"===g&&this.initRangeSlider(".js-feature-slider-"+b.code)};shopDialogProductsCategory.prototype.initGetFeatures=function(){var b=this;this.$wrapper.on("change",".js-condition-feature",function(){var c=a(this).closest("tr").find(".js-condition-feature-block");
if(this.checked){var d=a(this).data("feature_id"),e="?module=category&action=getFeatures&feature_id="+d,f=a(this).attr("data-loading");if("new"===b.category_id&&!f){var g=this;a(g).closest(".js-condition-feature-names").append('<i class="icon16 loading"></i>');a.get(e,function(h){"ok"===h.status&&(h.data.features&&b.initShowFeatures(h.data.features[d],c,"template_feature_field_values",!0,!1),a(g).attr("data-loading","ok"),a(g).closest(".js-condition-feature-names").find("i.loading").remove())})}c.show();
c.find(":input").each(function(){a(this).attr("disabled",!1)})}else c.hide(),c.find(":input").each(function(){a(this).attr("disabled",!0)})})};shopDialogProductsCategory.prototype.renderFeature=function(b){var c=this,d=c.$wrapper,e=!0,f=d.find(".js-show-more").attr("data-offset"),g="feature_id="+b,h="GET";b||(e=!1,g={ignore_id:c.ignore_id,category:c.category_id,category_type:c.category_type,offset:f},h="POST");a.ajax({type:h,url:"?module=categoryGetFeatures",data:g,dataType:"json",success:function(k){d.find(".js-show-more").find("i.loading").remove();
if("ok"===k.status){var l=d.find(".js-condition-list .js-feature-insertion-block"),m=d.find(".js-show-more").attr("data-count"),p=0,n;for(n in k.data.features)k.data.features.hasOwnProperty(n)&&(c.initShowFeatures(k.data.features[n],l,"template_feature_field",e,!1),++p);k=m-p;0<k?(l="<b><i>"+(20<k?$_("Show %d more").replace("%d",20)+" "+$_("From").toLowerCase()+" "+k:$_("Show %d more").replace("%d",k))+"</i></b>",d.find(".js-show-more").html(l).attr("data-count",k),b||(f=parseInt(f)+parseInt(p),d.find(".js-show-more").attr("data-offset",
f))):d.find(".js-autocomplete-wrapper").hide()}else"fail"===k.status&&console.log(k.errors)}})};shopDialogProductsCategory.prototype.initShowAllFeatureValue=function(){var b=this;b.$wrapper.on("click",".js-show-all-feature",function(){var c=this,d=a(this).data("feature_id");a(this).html('<i class="icon16 loading"></i>');if("undefined"==typeof d)a(this).parent().find(".js-feature-hidden").show(),a(this).hide();else{var e="?module=category&action=getFeatures&feature_id="+d,f=a(this).parent();a.get(e,
function(g){if("ok"===g.status&&g.data.features){var h=g.data.features[d];f.find(".js-feature-value").each(function(){var k=parseInt(a(this).data("f_val")),l;for(l in h.values)h.values.hasOwnProperty(l)&&l==k&&delete h.values[l]});b.initShowFeatures(h,f,"template_feature_field_values",!0,!0);a(c).html("")}})}})};shopDialogProductsCategory.prototype.initShowMore=function(){var b=this,c=b.$wrapper,d=c.find(".js-show-more").attr("data-count");b.ignore_id.length||b.$wrapper.find(".js-condition-feature").each(function(){a.isNumeric(a(this).data("feature_id"))&&
b.ignore_id.push(a(this).data("feature_id"))});d-=b.ignore_id.length;if(0>=d)c.find(".js-autocomplete-wrapper").hide();else{var e="<b><i>"+(20<d?$_("Show %d more").replace("%d",20)+" "+$_("From").toLowerCase()+" "+d:$_("Show %d more").replace("%d",d))+"</i></b>";c.find(".js-show-more").html(e).attr("data-count",d)}c.find(".js-show-more").click(function(){a(this).html('<i class="icon16 loading"></i>');b.renderFeature()})};shopDialogProductsCategory.prototype.disableManualSorting=function(){var b=this.$wrapper;
b.find(".js-subcategory-toggle").change(function(){this.checked?b.find('.js-sort-type option[value=""]').attr("disabled",!0).next().attr("selected","selected"):b.find('.js-sort-type option[value=""]').attr("disabled",!1)})};shopDialogProductsCategory.prototype.initDynamicSettingsEvent=function(){var b=this.$wrapper;b.find("input[name=type]").on("click",function(){"0"==a(this).val()?(b.find(".js-category-dynamic-settings").hide(),b.find(".js-category-dynamic-settings").find(":input").each(function(){a(this).attr("disabled",
!0)})):(b.find(".js-category-dynamic-settings").show(),b.find(".js-category-dynamic-settings").find(":input").each(function(){a(this).hasClass("js-always-disabled")||a(this).attr("disabled",!1)}))});b.find(".js-category-rate").rateWidget({withClearAction:!1,onUpdate:function(c){b.find(".js-c-category-rate-value").val(c)}});b.find("select[name^=rating]").change(function(){b.find(".js-condition-rate").attr("checked",!0)});b.find(".js-category-rate").click(function(){b.find(".js-condition-rate").attr("checked",
!0)});b.find("select[name^=count]").change(function(){b.find(".js-condition-count").attr("checked",!0)});b.find(".js-category-count-value").click(function(){b.find(".js-condition-count").attr("checked",!0)});b.on("change","input[name^=tag]",function(){b.find(".js-condition-tag").attr("checked",!0)});b.on("keyup","input[name^=price]",function(){b.find(".js-condition-price-interval").attr("checked",!0)});b.on("change",".js-feature-value",function(){this.checked&&a(this).closest("tr").find(".js-condition-feature").attr("checked",
!0);var c=a(this).closest("tr").find(".js-condition-feature").attr("data-feature_id"),d=parseInt(a(this).closest(".js-condition-feature-block").find("input:checkbox:checked").length);c=b.find('.js-category-filter input[data-filter-id="'+c+'"]');c.length&&(2<=d?c.is(":disabled")&&c.attr("disabled",!1):c.attr("disabled",!0))})};shopDialogProductsCategory.prototype.initFrontendUrlEdit=function(){a("#s-settings-frontend-url").inlineEditable({editLink:".js-settings-frontend-url-edit-link",editOnItself:!1,
minSize:{width:100},makeReadableBy:[],beforeMakeEditable:function(e){var f=a(this).parents("div:first"),g=f.find("span.slash");a(e).after(g);f.find("span.s-frontend-base-url").html(f.find("a.s-frontend-base-url").hide().contents()).show()},beforeBackReadable:function(e,f){e=a(this);f=e.parents("div:first");var g=f.find("span.slash");e.after(g);f.find("a.s-frontend-base-url").html(f.find("span.s-frontend-base-url").hide().contents()).show()}});var b=this.$wrapper.find(".js-product-list-name"),c=this.$wrapper.find(".js-product-list-url"),
d={name:"",url:"",timer_id:null};b.unbind(".create_product_list").bind("change.create_product_list, keyup.create_product_list",function(){d.time_id&&clearTimeout(d.time_id);if(c.val()!==d.url)b.unbind(".create_product_list");else{var e=b.val();e!==d.name&&(d.time_id=setTimeout(function(){a.getJSON("?action=transliterate",{str:e},function(f){"ok"===f.status?(c.val(f.data),d={name:e,url:f.data,time_id:null}):console&&(f.errors?console.error(f.errors):f&&console.error(f))})},300))}})};shopDialogProductsCategory.prototype.initMetaTagEdit=
function(){var b=this.$wrapper,c=this.account_name;(function(){var d=a("input[name=meta_title]",b);a.shop.changeListener(a("input[name=name]",b),function(e){d.attr("placeholder",e.val())})})();(function(){var d=a("[name=meta_keywords]",b);a.shop.changeListener(a("input[name=name]",b),function(e){d.attr("placeholder",[c,e.val()].join(", "))})})();a.shop.makeFlexibleInput("s-meta-title")};shopDialogProductsCategory.prototype.initSocialMetaTag=function(){var b=this.$wrapper.find(".js-category-social-metatag"),
c=b.closest(".field-group"),d=c.find(".editable-og-disabler");b.closest(".field").appendTo(c.closest("form").find('[name="meta_title"]').closest(".field-group"));b.prop("checked")||c.show();b.change(function(){b.prop("checked")?(c.slideUp(200),d.prop("disabled",!1)):(c.slideDown(200),d.prop("disabled",!0))})};shopDialogProductsCategory.prototype.initFilter=function(){function b(){var e=!(1<c.find(".js-filter-item .js-filter-checkbox:checked").length);c.find(".js-filter-item").each(function(){var f=
a(this),g=f.find(".js-filter-checkbox"),h=f.find("i.sort");!e&&g.is(":checked")?f.hasClass("unsortable")&&(f.removeClass("unsortable"),h.show()):f.hasClass("unsortable")||(f.addClass("unsortable"),h.hide())});d.sortable("refresh")}var c=this.$wrapper,d=c.find(".js-category-filter");c.on("click",".js-category-allow-filter",function(){this.checked?(d.find(":input").each(function(){a(this).data("disabled")||a(this).attr("disabled",!1)}),d.show()):(d.find(":input").each(function(){a(this).attr("disabled",
!0)}),d.hide())});d.sortable({distance:5,opacity:.75,items:"li:not(.unsortable)",handle:".sort",cursor:"move",tolerance:"pointer"});c.on("change",".js-filter-checkbox",function(){b()});b()};shopDialogProductsCategory.prototype.initCategoryVisibility=function(){var b=this.$wrapper.find(".js-product-category-visibility-block");a("input[name=storefront]",b).change(function(){"route"==this.value?a('input[name="routes[]"]',b).attr("disabled",!1):a('input[name="routes[]"]',b).attr("disabled",!0)})};shopDialogProductsCategory.staticDialog=
function(b,c,d){var e=function(){a("#s-product-category-dialog").waDialog({esc:!1,disableButtonsOnSubmit:!1,onLoad:function(){a("#s-category-description-content").length&&a.product_sidebar.initCategoryDescriptionWysiwyg(a(this));setTimeout(function(){a(".js-product-list-name").focus()},150)},onSubmit:function(g){var h=a(this);if(function(){var m=!1;h.find(".js-condition-feature:checked, .js-condition-tag:checked").each(function(){var p=a(this).closest("tr").find(".js-condition-feature-block, .js-condition-tag-block"),
n=p.find(".js-feature-value:checkbox, .js-tag-value:checkbox");n.length&&!n.is(":checked")&&(m=!0,p.find(".errormsg").html("").html($_("Nothing selected")),h.find(".js-category-error").html("").html($_("Nothing selected")))});setTimeout(function(){h.find(".errormsg").html("")},5E3);return m}())return!1;var k=function(m){if(0<location.hash.indexOf("category_id")){var p=location.hash.replace("category_id="+b,"category_id="+m.data.id);if("sort_products"in m.data||"rule"in m.data)p=p.replace(/&sort=[^&]*/,
"&sort="),p=p.replace(/&order=[^&]*/,"&order=")}else p="#/products/category_id="+m.data.id;"new"===d&&a.product_sidebar.createNewElementInList(m.data,"category");a.product_sidebar.updateItemInCategoryList(m,p);location.hash!=p?location.hash=p:a.products.dispatch();g.trigger("close")},l=function(m){if(m&&m.errors){m=m.errors;for(var p in m)g.find("input[name="+p+"]").addClass("error").parent().find(".errormsg").text(m[p]);return!1}};a("#s-category-description-content").length&&a("#s-category-description-content").waEditor("sync");
if(h.find("input:file").length)a.products._iframePost(h,k,l);else return a.shop.jsonPost(h.attr("action"),h.serialize(),k,l),!1}})},f=a("#s-product-category-dialog");f=f.length?f.parent():a("<div></div>").appendTo("body");"new"===d&&f.load("?module=category&action=Create&parent_id="+c,e);"edit"===d&&f.load("?module=category&action=Edit&category_id="+b,e)};return shopDialogProductsCategory}(jQuery);(function(a){a.widget("ui.slider",a.ui.mouse,{widgetEventPrefix:"slide",options:{animate:!1,distance:0,max:100,min:0,orientation:"horizontal",range:!1,step:1,value:0,values:null},_create:function(){var b=this,c=this.options;this._mouseSliding=this._keySliding=!1;this._animateOff=!0;this._handleIndex=null;this._detectOrientation();this._mouseInit();this.element.addClass("ui-slider ui-slider-"+this.orientation+" ui-widget ui-widget-content ui-corner-all");c.disabled&&this.element.addClass("ui-slider-disabled ui-disabled");
...
if(c.values&&c.values.length)for(;a(".ui-slider-handle",this.element).length<c.values.length;)a("<a href='#'></a>").appendTo(this.element).addClass("ui-slider-handle");this.handles=a(".ui-slider-handle",this.element).addClass("ui-state-default ui-corner-all");this.handle=this.handles.eq(0);this.handles.add(this.range).filter("a").click(function(d){d.preventDefault()}).hover(function(){c.disabled||a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")}).focus(function(){c.disabled?
a(this).blur():(a(".ui-slider .ui-state-focus").removeClass("ui-state-focus"),a(this).addClass("ui-state-focus"))}).blur(function(){a(this).removeClass("ui-state-focus")});this.handles.each(function(d){a(this).data("index.ui-slider-handle",d)});this.handles.keydown(function(d){var e=!0,f=a(this).data("index.ui-slider-handle"),g;if(!b.options.disabled){switch(d.keyCode){case a.ui.keyCode.HOME:case a.ui.keyCode.END:case a.ui.keyCode.PAGE_UP:case a.ui.keyCode.PAGE_DOWN:case a.ui.keyCode.UP:case a.ui.keyCode.RIGHT:case a.ui.keyCode.DOWN:case a.ui.keyCode.LEFT:if(e=
!1,!b._keySliding){b._keySliding=!0;a(this).addClass("ui-state-active");var h=b._start(d,f);if(!1===h)return}}var k=b.options.step;h=b.options.values&&b.options.values.length?g=b.values(f):g=b.value();switch(d.keyCode){case a.ui.keyCode.HOME:g=b._valueMin();break;case a.ui.keyCode.END:g=b._valueMax();break;case a.ui.keyCode.PAGE_UP:g=b._trimAlignValue(h+(b._valueMax()-b._valueMin())/5);break;case a.ui.keyCode.PAGE_DOWN:g=b._trimAlignValue(h-(b._valueMax()-b._valueMin())/5);break;case a.ui.keyCode.UP:case a.ui.keyCode.RIGHT:if(h===
b._valueMax())return;g=b._trimAlignValue(h+k);break;case a.ui.keyCode.DOWN:case a.ui.keyCode.LEFT:if(h===b._valueMin())return;g=b._trimAlignValue(h-k)}b._slide(d,f,g);return e}}).keyup(function(d){var e=a(this).data("index.ui-slider-handle");b._keySliding&&(b._keySliding=!1,b._stop(d,e),b._change(d,e),a(this).removeClass("ui-state-active"))});this._refreshValue();this._animateOff=!1},destroy:function(){this.handles.remove();this.range.remove();this.element.removeClass("ui-slider ui-slider-horizontal ui-slider-vertical ui-slider-disabled ui-widget ui-widget-content ui-corner-all").removeData("slider").unbind(".slider");
this._mouseDestroy();return this},_mouseCapture:function(b){var c=this.options,d;if(c.disabled)return!1;this.elementSize={width:this.element.outerWidth(),height:this.element.outerHeight()};this.elementOffset=this.element.offset();var e={x:b.pageX,y:b.pageY};var f=this._normValueFromMouse(e);var g=this._valueMax()-this._valueMin()+1;var h=this;this.handles.each(function(l){var m=Math.abs(f-h.values(l));g>m&&(g=m,k=a(this),d=l)});if(!0===c.range&&this.values(1)===c.min){d+=1;var k=a(this.handles[d])}if(!1===
this._start(b,d))return!1;this._mouseSliding=!0;h._handleIndex=d;k.addClass("ui-state-active").focus();c=k.offset();this._clickOffset=a(b.target).parents().andSelf().is(".ui-slider-handle")?{left:b.pageX-c.left-k.width()/2,top:b.pageY-c.top-k.height()/2-(parseInt(k.css("borderTopWidth"),10)||0)-(parseInt(k.css("borderBottomWidth"),10)||0)+(parseInt(k.css("marginTop"),10)||0)}:{left:0,top:0};f=this._normValueFromMouse(e);this._slide(b,d,f);return this._animateOff=!0},_mouseStart:function(){return!0},
_mouseDrag:function(b){var c=this._normValueFromMouse({x:b.pageX,y:b.pageY});this._slide(b,this._handleIndex,c);return!1},_mouseStop:function(b){this.handles.removeClass("ui-state-active");this._mouseSliding=!1;this._stop(b,this._handleIndex);this._change(b,this._handleIndex);this._clickOffset=this._handleIndex=null;return this._animateOff=!1},_detectOrientation:function(){this.orientation="vertical"===this.options.orientation?"vertical":"horizontal"},_normValueFromMouse:function(b){if("horizontal"===
this.orientation){var c=this.elementSize.width;b=b.x-this.elementOffset.left-(this._clickOffset?this._clickOffset.left:0)}else c=this.elementSize.height,b=b.y-this.elementOffset.top-(this._clickOffset?this._clickOffset.top:0);c=b/c;1<c&&(c=1);0>c&&(c=0);"vertical"===this.orientation&&(c=1-c);b=this._valueMax()-this._valueMin();return this._trimAlignValue(this._valueMin()+c*b)},_start:function(b,c){var d={handle:this.handles[c],value:this.value()};this.options.values&&this.options.values.length&&(d.value=
this.values(c),d.values=this.values());return this._trigger("start",b,d)},_slide:function(b,c,d){if(this.options.values&&this.options.values.length){var e=this.values(c?0:1);2===this.options.values.length&&!0===this.options.range&&(0===c&&d>e||1===c&&d<e)&&(d=e);d!==this.values(c)&&(e=this.values(),e[c]=d,b=this._trigger("slide",b,{handle:this.handles[c],value:d,values:e}),this.values(c?0:1),!1!==b&&this.values(c,d,!0))}else d!==this.value()&&(b=this._trigger("slide",b,{handle:this.handles[c],value:d}),
...
this._trimAlignValue(b),this._refreshValue(),this._change(null,0));return this._value()},values:function(b,c){var d;1<arguments.length&&(this.options.values[b]=this._trimAlignValue(c),this._refreshValue(),this._change(null,b));if(arguments.length)if(a.isArray(arguments[0])){var e=this.options.values;var f=arguments[0];for(d=0;d<e.length;d+=1)e[d]=this._trimAlignValue(f[d]),this._change(null,d);this._refreshValue()}else return this.options.values&&this.options.values.length?this._values(b):this.value();
...
this.element.removeClass("ui-slider-horizontal ui-slider-vertical").addClass("ui-slider-"+this.orientation);this._refreshValue();break;case "value":this._animateOff=!0;this._refreshValue();this._change(null,0);this._animateOff=!1;break;case "values":this._animateOff=!0;this._refreshValue();for(d=0;d<e;d+=1)this._change(null,d);this._animateOff=!1}},_value:function(){return this._trimAlignValue(this.options.value)},_values:function(b){var c;if(arguments.length){var d=this.options.values[b];return this._trimAlignValue(d)}d=
this.options.values.slice();for(c=0;c<d.length;c+=1)d[c]=this._trimAlignValue(d[c]);return d},_trimAlignValue:function(b){if(b<this._valueMin())return this._valueMin();if(b>this._valueMax())return this._valueMax();var c=0<this.options.step?this.options.step:1,d=b%c;b-=d;2*Math.abs(d)>=c&&(b+=0<d?c:-c);return parseFloat(b.toFixed(5))},_valueMin:function(){return this.options.min},_valueMax:function(){return this.options.max},_refreshValue:function(){var b=this.options.range,c=this.options,d=this,e=
this._animateOff?!1:c.animate,f={},g;if(this.options.values&&this.options.values.length)this.handles.each(function(p){m=(d.values(p)-d._valueMin())/(d._valueMax()-d._valueMin())*100;f["horizontal"===d.orientation?"left":"bottom"]=m+"%";a(this).stop(1,1)[e?"animate":"css"](f,c.animate);if(!0===d.options.range)if("horizontal"===d.orientation){if(0===p)d.range.stop(1,1)[e?"animate":"css"]({left:m+"%"},c.animate);if(1===p)d.range[e?"animate":"css"]({width:m-g+"%"},{queue:!1,duration:c.animate})}else{if(0===
p)d.range.stop(1,1)[e?"animate":"css"]({bottom:m+"%"},c.animate);if(1===p)d.range[e?"animate":"css"]({height:m-g+"%"},{queue:!1,duration:c.animate})}g=m});else{var h=this.value();var k=this._valueMin();var l=this._valueMax();var m=l!==k?(h-k)/(l-k)*100:0;f["horizontal"===d.orientation?"left":"bottom"]=m+"%";this.handle.stop(1,1)[e?"animate":"css"](f,c.animate);if("min"===b&&"horizontal"===this.orientation)this.range.stop(1,1)[e?"animate":"css"]({width:m+"%"},c.animate);if("max"===b&&"horizontal"===
this.orientation)this.range[e?"animate":"css"]({width:100-m+"%"},{queue:!1,duration:c.animate});if("min"===b&&"vertical"===this.orientation)this.range.stop(1,1)[e?"animate":"css"]({height:m+"%"},c.animate);if("max"===b&&"vertical"===this.orientation)this.range[e?"animate":"css"]({height:100-m+"%"},{queue:!1,duration:c.animate})}}});a.extend(a.ui.slider,{version:"1.8.2"})})(jQuery);
