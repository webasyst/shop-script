( function($) {
                ...
                methods: {
                    ...
                    moveRequest: function() {
                        ...
                        if (!self.states.sort_locked) {
                            ...
                            request({ category_id: self.category.id, products: product_ids })
                    ...
                    changeSort: function(sort_id) {
                        ...
                        if (!self.states.locked) {
                            ...
                            request({ category_id: self.category.id, sort_products: sort_id })
                                .fail( function(errors) {
                    ...
                    forceRender: function() {
                        ...
                        if (!self.states.locked) {
                            ...
                            self.reload({ category_id: self.category.id, force: 1 });
                        }
                    },
                    ...
                    reload: function(data) {
                        ...
                        if (!self.states.reload_locked) {
                            ...
                            $.post(that.urls["category_sort_dialog"], data)
                                .always( function() {
    ...
    $.wa_shop_products.init.initCategorySortDialog = function(options) {
