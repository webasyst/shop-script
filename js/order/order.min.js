...
top:e}));var c=a(window).scrollLeft(),h=a(window).scrollTop(),l=a(window).width(),m=a(window).height(),k=g.parent[0];c+l<k.offsetLeft+k.offsetWidth&&(d-=k.offsetWidth+20+b(i).left,g.parent.css({left:d+"px"}).addClass("viewport-right"));h+m<k.offsetTop+k.offsetHeight&&(e-=k.offsetHeight+20+b(i).top,g.parent.css({top:e+"px"}).addClass("viewport-bottom"))}}function h(){function c(){g.parent.removeClass(d.extraClass).hide().css("opacity","")}if(!a.tooltip.blocked){m&&clearTimeout(m);i=null;var d=b(this);
(!k||!a.fn.bgiframe)&&d.fade?g.parent.is(":animated")?g.parent.stop().fadeTo(d.fade,0,c):g.parent.stop().fadeOut(d.fade,c):c();b(this).fixPNG&&g.parent.unfixPNG()}}var g={},i,l,m,k=a.browser.msie&&/MSIE\s(5\.5|6\.)/.test(navigator.userAgent),p=!1;a.tooltip={blocked:!1,defaults:{delay:200,fade:!1,showURL:!0,extraClass:"",noHideOnClick:!1,top:15,left:15,id:"tooltip"},block:function(){a.tooltip.blocked=!a.tooltip.blocked}};a.fn.extend({tooltip:function(b){b=a.extend({},a.tooltip.defaults,b);g.parent||
(g.parent=a('<div id="'+b.id+'"><h3></h3><div class="body"></div><div class="url"></div></div>').appendTo(document.body).hide(),a.fn.bgiframe&&g.parent.bgiframe(),g.title=a("h3",g.parent),g.body=a("div.body",g.parent),g.url=a("div.url",g.parent));var d=this.each(function(){a.data(this,"tooltip",b);this.tOpacity=g.parent.css("opacity");this.tooltipText=this.title;a(this).removeAttr("title");this.alt=""}).mouseover(c).mouseout(h);b.noHideOnClick||d.click(h);return d},fixPNG:k?function(){return this.each(function(){var b=
a(this).css("backgroundImage");b.match(/^url\(["']?(.*\.png)["']?\)$/i)&&(b=RegExp.$1,a(this).css({backgroundImage:"none",filter:"progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled=true, sizingMethod=crop, src='"+b+"')"}).each(function(){var b=a(this).css("position");"absolute"!=b&&"relative"!=b&&a(this).css("position","relative")}))})}:function(){return this},unfixPNG:k?function(){return this.each(function(){a(this).css({filter:"",backgroundImage:""})})}:function(){return this},hideWhenEmpty:function(){return this.each(function(){a(this)[a(this).html()?
...
".s-orders-skus input[type=radio]",function(){var a=$(this),c=a.parents("tr:first"),e=this.value,i=c.attr("data-product-id"),l=c.attr("data-index"),m=null;if("edit"==($.order_edit.id?"edit":"add"))m=parseInt(a.attr("name").replace("sku[edit][",""),10);$.getJSON("?module=orders&action=getProduct&product_id="+i+"&sku_id="+e+($.order_edit.id?"&order_id="+$.order_edit.id:"&currency="+$.order_edit.options.currency),function(a){c.find(".s-orders-services").replaceWith(tmpl("template-order-services",{services:a.data.sku.services,
service_ids:a.data.service_ids,product_id:i,options:{price_edit:d,index:l,currency:$.order_edit.options.currency,stocks:$.order_edit.stocks}}));c.find(".s-orders-product-price").find("input").val(a.data.sku.price);var f;f=-1!==c.find("input:first").attr("name").indexOf("add")?"add":"edit";c.find(".s-orders-product-stocks").replaceWith(tmpl("template-order-stocks-"+f,{sku:a.data.sku,index:l,stocks:$.order_edit.stocks,item_id:m}));b(c);$.order_edit.updateTotal(c)})});this.container.off("change",".s-orders-stock").on("change",
...
".s-orders-services .s-orders-service-variant",$.order_edit.updateTotal);$(".s-order-customer-details").on("change","input[type=text],select",function(){$(this).attr("name").indexOf("address")&&$.order_edit.updateTotal()});$("#shipping_methods").change(function(){var a=$(this).children(":selected"),b=a.data("rate")||0;$("#shipping-rate").val($.order_edit.formatFloat(b));b=[];a.data("error")&&b.push('<span class="error">'+a.data("error")+"</span>");a.data("est_delivery")&&b.push('<span class="hint est_delivery">'+
a.data("est_delivery")+"</span>");a.data("comment")&&b.push('<span class="hint">'+a.data("comment")+"</span>");b?(a.data("error")?$("#shipping-rate").addClass("error"):$("#shipping-rate").removeClass("error"),$("#shipping-info").html(b.join("<br>")).show()):($("#shipping-rate").removeClass("error"),$("#shipping-info").empty().hide());$.order_edit.updateTotal(!1)});$("#payment_methods").change(function(){var a=$(this).val();$("#payment-info > div").hide();$("#payment-custom-"+a).length&&$("#payment-custom-"+
a).show()});$("#discount,#shipping-rate").change(function(){$.order_edit.updateTotal(!1)});this.container.off("keydown",".s-orders-quantity").on("keydown",".s-orders-quantity",function(){var a=$(this),b=a.data("timer_id");b&&clearTimeout(b);a.data("timer_id",setTimeout(function(){$.order_edit.updateTotal()},450))});this.form&&this.form.length&&this.form.unbind("sumbit").bind("submit",function(){$.order_edit.showValidateErrors();$(".s-orders-services input[name^=service]:not(:checked)",this.form).each(function(){$(this).closest("li").find(":input").attr("disabled",
!0)});$.order_edit.container.find(".error").length||($(".s-order-items-edit td.save i.loading").css("display","inline-block"),$.order_edit.id?$.order_edit.editSubmit():$.order_edit.addSubmit());return!1});this.initDiscountControl()},initDiscountControl:function(){function a(){0<b.val()?e.stop().show():e.stop().hide()}var b=$("#discount"),d=$("#discount-description"),c=$("#update-discount"),e=$("#discount-tooltip-icon");$(document).tooltip;e.tooltip({bodyHandler:function(){return d.val()||d.data("updated-manually-msg")}});
c.tooltip({bodyHandler:function(){return c.data("description")||d.data("updated-manually-msg")}});e.hide();$("#order-edit-form").on("order_total_updated",function(a,d){d.discount&&(c.data("value",d.discount).data("description",d.discount_description),c.data("just-recalculated")?d.discount+""!=b.val()&&c.click():c.show())});c.click(function(){d.val(c.data("description")||"");b.val(c.data("value")||0).change();c.hide().data("just-recalculated",!0);a();e.is(":visible")&&e.fadeOut(50,function(){e.fadeIn(50,
function(){e.fadeOut(50,function(){e.fadeIn(50,function(){e.fadeOut(50,function(){e.fadeIn(50,function(){e.fadeOut(50,function(){e.fadeIn(50,function(){})})})})})})})});return!1});b.on("keyup",function(){d.val("");c.show().data("just-recalculated",!1);a()})},updateTotal:function(a){var a=void 0===a?!0:a,b=$.order_edit.container;if(b.find(".s-order-item").length){for(var d=0,c=$("#discount"),e={},f=$("#s-order-edit-customer").find('[name^="customer["]').serializeArray(),h=0;h<f.length;h++)e[f[h].name]=
f[h].value;e.items=[];b.find(".s-order-item").each(function(){var a=$(this),b=a.find('input[name^="product"]').val(),c=[],f=$.order_edit.parseFloat(a.find(".s-orders-product-price input").val()),h=$.order_edit.parseFloat(a.find("input.s-orders-quantity").val());d+=f*h;a.find(".s-orders-services").length&&a.find(".s-orders-services input:checkbox:checked").each(function(){var a=$(this).closest("li"),a=$.order_edit.parseFloat(a.find("input.s-orders-service-price").val());c.push({id:$(this).val(),price:a});
d+=a*h});a=a.find("input[name^=sku]:not(:radio)").add(a.find("input[name^=sku]:checked")).first().val()||0;e.items.push({product_id:b,quantity:h,price:f,sku_id:a,services:c})});e.subtotal=d;b=$.order_edit.parseFloat(c.val()||0);e.discount=b;$.order_edit.id?e.order_id=$.order_edit.id:e.currency=$("#order-edit-form input[name=currency]").val();e["customer[id]"]=$("#s-customer-id").val();a&&$.post("?module=order&action=total",e,function(a){if("ok"==a.status){var b=$("#shipping_methods"),c=b.val();b.empty();
for(var d=a.data.shipping_method_ids,f=a.data.shipping_methods,e=-1!==d.indexOf(c),h=0;h<d.length;h+=1){var o=d[h],j=f[o],n=$("<option></option>");n.html(j.name).attr("value",o).data("rate",j.rate);j.error&&n.data("error",j.error);j.est_delivery&&n.data("est_delivery",j.est_delivery);j.comment&&n.data("comment",j.comment);b.append(n);e||(j=(""+o).split("."),n=c.split("."),void 0!==j[0]&&(void 0!==n[0]&&j[0]==n[0])&&(e=!0,c=o))}e&&b.val(c).change();$("#order-edit-form").trigger("order_total_updated",
a.data)}},"json");$("#subtotal").text($.order_edit.formatFloat(Math.round(100*d)/100));a=$.order_edit.parseFloat($("#shipping-rate").val().replace(",","."))||0;a=d+a;0>b?(b=0,c.val("")):(0>a-b&&(b=a),c.val($.order_edit.formatFloat(Math.round(100*b)/100)));c=a-b;$("#total").text($.order_edit.formatFloat(Math.round(100*c)/100))}else $("#subtotal").text(0),$("#total").text(0)},editSubmit:function(){var a=this.form;$.shop.jsonPost(a.attr("action"),a.serialize(),function(){$.order_edit.container.find(".back").click()},
function(a){$.shop.trace("editSubmit",a);$(".s-order-items-edit td.save i.loading").hide();if(a&&a.errors&&!$.isEmptyObject(a.errors))return $.order_edit.showValidateErrors(a.errors),$(".s-orders-services input:disabled",this.form).attr("disabled",!1),!1})},addSubmit:function(){var a=this.form;$.shop.trace("addSubmit",$(a));$.shop.jsonPost(a.attr("action"),a.serialize(),function(a){$.order_edit.slide(!1,!0)&&(location.href="#/orders/state_id=new&view=split&id="+a.data.order.id+"/")},function(a){$.shop.trace("addSubmit",
a);$(".s-order-items-edit td.save i.loading").hide();if(a&&a.errors&&!$.isEmptyObject(a.errors))return $.order_edit.showValidateErrors(a.errors),$(".s-orders-services input:disabled",this.form).attr("disabled",!1),!1})},formatFloat:function(a){return","===this.float_delimeter?(""+a).replace(".",","):""+a},parseFloat:function(a){return a?parseFloat((""+a).replace(",",".")):0},slideBack:function(){this.slide(!1,"add"==this.options.mode)},slide:function(a,b,d){if(0==arguments.length)this.slide(!0,"add"==
this.options.mode);else{var a="undefined"===typeof a?!0:a,b="undefined"===typeof b?!1:b,c=this.options.duration||200,e=this.options.view,f=[];return!this.slide_on&&a?(f.push($("#s-sidebar").animate({width:0},c,function(){$(this).hide()})),$(".s-level2").hide(),f.push($("#maincontent").animate({"margin-top":45},c)),f.push($("#s-content").animate({"margin-left":0},c)),f.push($("#s-orders").animate({width:0},c,function(){$(this).hide()})),f.push($("#s-order").animate({"margin-left":0},c).find(">div:first").removeClass("double-padded, bordered-left").find("h1 .back.order-list").hide().end().find("h1 .back.read-mode").show()),
this.slide_on=!0,$(".s-order-readable").hide(),$(".s-order-editable").show(),$.when(f).done(function(){$.order_list.lazy_load_win&&$.order_list.lazy_load_win.lazyLoad("sleep");"function"===typeof d&&d.call(this)}),!0):this.slide_on&&!a?(f.push($("#s-order").animate({"margin-left":"table"!=e&&!b?300:200},c).find(">div:first").addClass("double-padded, bordered-left").find("h1 .back.order-list").show().end().find("h1 .back.read-mode").hide()),f.push($("#s-orders").animate({width:300},c).show()),f.push($("#s-content").animate({"margin-left":200},
c)),f.push($("#maincontent").animate({"margin-top":84},c)),$(".s-level2").show(),f.push($("#s-sidebar").animate({width:200},c).show()),this.slide_on=!1,$(".s-order-editable").hide(),$(".s-order-readable").show(),$.when(f).done(function(){$.order_list.lazy_load_win&&$.order_list.lazy_load_win.lazyLoad("wake");"function"===typeof d&&d.call(this)}),!0):!1}},showValidateErrors:function(a){$(".error").removeClass("error");$("#s-order-edit-customer .errormsg").empty();if(a&&a.customer){var b=a.customer;
$.order_edit.customer_fields.find(".field-group:first").html(b.html);delete b.html;for(var d in b)$.order_edit.customer_fields.find(".s-error-customer-"+d).each(function(){var a=$(this);"EM"==this.tagName?a.text(b[d]):a.addClass("error")})}var c=[];$(".s-order-errors").empty();if(a&&a.order){if(!$.isEmptyObject(a.order.items))for(var e in a.order.items){var f=$(".s-order-item[data-index="+e+"]"),b=a.order.items[e];for(d in b)f.find(".s-error-item-"+d).text(b[d]);delete a.order.items[e]}if(!$.isEmptyObject(a.order.product)){var h=
a.order.product,g;for(g in h)h.hasOwnProperty(g)&&"quantity"in h[g]&&$(".s-order-item[data-product-id="+g+"]").each(function(){if($(this).find("ul.s-orders-skus input:radio:checked").val()==""+h[g].sku_id||!$(this).find("ul.s-orders-skus").length)$(this).find(".s-orders-quantity").addClass("error"),c.push(h[g].quantity)})}a.order.common&&c.push(a.order.common);c.length&&$(".s-order-errors").html(c.join("<br>"))}},bindValidateErrorPlaceholders:function(){for(var a=["firstname","middlename","lastname"],
b=0,d=a.length;b<d;b+=1)$.order_edit.customer_inputs.filter("[name="+$.order_edit.inputName(a[b])+"]").addClass("s-error-customer-name");$.order_edit.customer_fields.find(".s-error-customer-name:last").after('<em class="errormsg s-error-customer-name"></em>')},initCustomerForm:function(a){a="undefined"===typeof a?"add":a;if("add"!==a)$.order_edit.bindValidateErrorPlaceholders();else{var b=$("#customer-autocomplete"),d=function(a){a="undefined"===typeof a?!0:a;$("#s-customer-id").attr("disabled",a);
a?$("#s-order-edit-customer").addClass("s-opaque"):$("#s-order-edit-customer").removeClass("s-opaque")},c=function(a){"undefined"===typeof a||a?(d(!1),b.val("").hide(200)):(d(),$.order_edit.customer_inputs.val(""),b.val("").show())};$.order_edit.bindValidateErrorPlaceholders();c(!1);$.order_edit.customer_fields.off("focus",":input").on("focus",":input",function(){d(!1)});"add"==a&&$("#s-order-new-customer").click(function(){$.order_edit.customer_fields.find(".field-group:first").find(":input").val("");
c();$.order_edit.customer_inputs.first().focus();$("#s-customer-id").val(0);return!1});var e="";b.autocomplete({source:function(a,b){e=a.term;$.getJSON($.order_edit.options.autocomplete_url,a,function(a){(a=a||[]).push({label:$_("New customer"),name:$_("New customer"),value:0});b(a)})},delay:300,minLength:3,select:function(a,b){var d=b.item,i=function(){var a=!1;$.order_edit.customer_inputs.filter("input[type=text], textarea").each(function(){var b=$(this);if(b.is(":not(:hidden)")&&!this.value)return a=
!0,b.focus(),!1});a||$.order_edit.customer_inputs.first().focus()};if(d.value)$.get("?action=contactForm&id="+d.value,function(a){$.order_edit.customer_fields.find(".field-group:first").html(a);$.order_edit.customer_inputs=$.order_edit.customer_fields.find(":input");$("#s-customer-id").val(d.value);c();setTimeout(function(){i()},200)});else{var l="[name="+$.order_edit.inputName(parseInt(e,10)||"+"==e.substr(0,1)||-1!==e.indexOf("(")?"phone":-1!==e.indexOf("@")?"email":"firstname")+"]";$.order_edit.customer_inputs.filter(l).val(e);
$("#s-customer-id").val(0);c();setTimeout(function(){i()},200)}return!1},focus:function(a,b){this.value=b.item.name;return!1}});$("#order-add-form").submit(function(){d(!1)})}},inputName:function(a){return'"customer['+a+']"'},getPercentSymbol:function(){return"%"}};
