...
couponsAction:function(){a.order_list&&a.order_list.finit();this.load("?module=coupons")},ordersEditAction:function(b){this.load("?module=order&action=edit&id="+b,function(){a.order_list&&a.order_list.finit()})},ordersNewAction:function(){this.load("?module=order&action=edit",function(){a.order_list&&a.order_list.finit()})},ordersAction:function(b){var d="";"search"===b&&(d=Array.prototype.slice.call(arguments,1));1<arguments.length&&(b=Array.prototype.join.call(arguments,"/"));b?"all"===b&&(b=""):
b="state_id=new|processing|paid";b=a.shop.helper.parseParams(b||"");b.view||(b.view=a.storage.get("shop/orders/view")||this.options.view);a.storage.set("shop/orders/view",b.view);a.order_edit&&a.order_edit.slideBack();d&&(b.search=d);"orders"!==this.actionName||!a.order_list?(a.order_list&&a.order_list.finit(),this.load("?module=orders&"+this.buildOrdersUrlComponent(b),function(){a.order_list&&a.order_list.dispatch(b)})):a.order_list.dispatch(b)},orderAction:function(b,d){d=a.shop.helper.parseParams(d||
"");d.view||(d.view=a.storage.get("shop/orders/view")||this.options.view);a.storage.set("shop/orders/view",d.view);a.order_edit&&a.order_edit.slideBack();this.load("?module=order&id="+encodeURIComponent(b)+"&"+this.buildOrdersUrlComponent(d),function(){a("#s-content").find("h1 .back.order-list").show()});a.order_list&&a.order_list.finit()},initSearch:function(){var b=a("#s-orders-search"),d=[],c=function(c){switch(c.autocomplete_item_type){case "order":a.wa.setHash("#/order/"+c.id+"/");b.val(c.value);
break;case "contact":a.wa.setHash("#/orders/contact_id="+c.id+"/");b.val(c.value);break;case "product":a.wa.setHash("#/orders/product_id="+c.id+"/");b.val(c.value);break;case "coupon":a.wa.setHash("#/orders/coupon_id="+c.id+"/");break;case "shipping":a.wa.setHash("#/orders/shipping_id="+c.id+"/");break;case "payment":a.wa.setHash("#/orders/payment_id="+c.id+"/");break;case "city":a.wa.setHash("#/orders/city="+c.value+"/");break;case "region":a.wa.setHash("#/orders/region="+((c.value||"").split(":")[1]||
"")+"/");break;case "country":a.wa.setHash("#/orders/country="+c.value+"/")}};b.unbind("keydown").bind("keydown",function(b){if(13==b.keyCode||10==b.keyCode){var f=a(this);if(a(this).val()){if(d&&a.isArray(d)&&d.length)return c(d[0]),setTimeout(function(){f.autocomplete("close")},150),!1}else return location.hash="#/orders/all/",f.autocomplete("close"),!1}});b.autocomplete({minLength:1,delay:300,html:!0,select:function(a,b){c(b.item);return!1},source:function(b,c){a.getJSON("?action=autocomplete&type=order",
b,function(a){d=a;c(a)})}})},onPageNotFound:function(){a.order_list&&a.order_list.finit()}}})(jQuery);$.order_list={id:0,options:{},container:null,sidebar:null,select_all_input:null,filter_params:{},filter_params_str:"",params:null,timer_id:0,lazy_load_win:null,xhrs:{lazy_load:null,update_load:null},init:function(a){this.options=a||{};this.filter_params=a.filter_params||{};this.filter_params_str=a.filter_params_str||"";this.container=$("#order-list");"table"==a.view&&(this.select_all_input=this.container.find(".s-select-all"),this.container=$("#order-list").find("tbody:first"));this.sidebar=$("#s-sidebar");
