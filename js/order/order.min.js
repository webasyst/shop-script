...
$jscomp.polyfill("String.prototype.startsWith",function(b){return b?b:function(a,c){var e=$jscomp.checkStringArgs(this,a,"startsWith");a+="";var d=e.length,g=a.length;c=Math.max(0,Math.min(c|0,e.length));for(var l=0;l<g&&c<d;)if(e[c++]!=a[l++])return!1;return l>=g}},"es6","es3");$jscomp.polyfill("Array.prototype.findIndex",function(b){return b?b:function(a,c){return $jscomp.findInternal(this,a,c).i}},"es6","es3");
$jscomp.polyfill("Array.from",function(b){return b?b:function(a,c,e){c=null!=c?c:function(h){return h};var d=[],g="undefined"!=typeof Symbol&&Symbol.iterator&&a[Symbol.iterator];if("function"==typeof g){a=g.call(a);for(var l=0;!(g=a.next()).done;)d.push(c.call(e,g.value,l++))}else for(g=a.length,l=0;l<g;l++)d.push(c.call(e,a[l],l));return d}},"es6","es3");
...
right:u,top:w}));u=b(window).scrollLeft();var B=b(window).scrollTop(),G=b(window).width(),D=b(window).height(),z=h.parent[0];u+G<z.offsetLeft+z.offsetWidth&&(v-=z.offsetWidth+20+a(k).left,h.parent.css({left:v+"px"}).addClass("viewport-right"));B+D<z.offsetTop+z.offsetHeight&&(w-=z.offsetHeight+20+a(k).top,h.parent.css({top:w+"px"}).addClass("viewport-bottom"))}}function l(u){function v(){h.parent.removeClass(w.extraClass).hide().css("opacity","")}if(!b.tooltip.blocked){r&&clearTimeout(r);k=null;var w=
...
[z(f.disableTimeRanges[n][0]),z(f.disableTimeRanges[n][1])];f.disableTimeRanges=f.disableTimeRanges.sort(function(t,x){return t[0]-x[0]});for(n=f.disableTimeRanges.length-1;0<n;n--)f.disableTimeRanges[n][0]<=f.disableTimeRanges[n-1][1]&&(f.disableTimeRanges[n-1]=[Math.min(f.disableTimeRanges[n][0],f.disableTimeRanges[n-1][0]),Math.max(f.disableTimeRanges[n][1],f.disableTimeRanges[n-1][1])],f.disableTimeRanges.splice(n,1))}return f}function e(f){var m=f.data("timepicker-settings"),n=f.data("timepicker-list");
if(n&&n.length&&(n.remove(),f.data("timepicker-list",!1)),m.useSelect)var t=n=b("<select />",{"class":"ui-timepicker-select"});else n=b("<ul />",{"class":"ui-timepicker-list"}),t=b("<div />",{"class":"ui-timepicker-wrapper",tabindex:-1}),t.css({display:"none",position:"absolute"}).append(n);if(m.noneOption)if(!0===m.noneOption&&(m.noneOption=m.useSelect?"Time...":"None"),b.isArray(m.noneOption))for(var x in m.noneOption){if(parseInt(x,10)==x){var C=d(m.noneOption[x],m.useSelect);n.append(C)}}else C=
d(m.noneOption,m.useSelect),n.append(C);(m.className&&t.addClass(m.className),null===m.minTime&&null===m.durationTime||!m.showDuration)||("function"==typeof m.step?"function":m.step,t.addClass("ui-timepicker-with-duration"),t.addClass("ui-timepicker-step-"+m.step));C=m.minTime;"function"==typeof m.durationTime?C=z(m.durationTime()):null!==m.durationTime&&(C=m.durationTime);x=null!==m.minTime?m.minTime:0;var H=null!==m.maxTime?m.maxTime:x+F-1;x>H&&(H+=F);H===F-1&&"string"===b.type(m.timeFormat)&&m.show2400&&
(H=F);var L=m.disableTimeRanges,I=0,Q=L.length,N=m.step;"function"!=typeof N&&(N=function(){return m.step});for(var O=0;H>=x;O++,x+=60*N(O)){var K=x,M=D(K,m);if(m.useSelect)var J=b("<option />",{value:M});else J=b("<li />"),J.addClass(43200>K%86400?"ui-timepicker-am":"ui-timepicker-pm"),J.data("time",86400>=K?K:K%86400);J.text(M);if((null!==m.minTime||null!==m.durationTime)&&m.showDuration)if(M=G(x-C,m.step),m.useSelect)J.text(J.text()+" ("+M+")");else{var P=b("<span />",{"class":"ui-timepicker-duration"});
P.text(" ("+M+")");J.append(P)}Q>I&&(K>=L[I][1]&&(I+=1),L[I]&&K>=L[I][0]&&K<L[I][1]&&(m.useSelect?J.prop("disabled",!0):J.addClass("ui-timepicker-disabled")));n.append(J)}(t.data("timepicker-input",f),f.data("timepicker-list",t),m.useSelect)?(f.val()&&n.val(g(z(f.val()),m)),n.on("focus",function(){b(this).data("timepicker-input").trigger("showTimepicker")}),n.on("blur",function(){b(this).data("timepicker-input").trigger("hideTimepicker")}),n.on("change",function(){q(f,b(this).val(),"select")}),q(f,
n.val(),"initial"),f.hide().after(n)):(x=m.appendTo,"string"==typeof x?x=b(x):"function"==typeof x&&(x=x(f)),x.append(t),p(f,n),n.on("mousedown click","li",function(R){f.off("focus.timepicker");f.on("focus.timepicker-ie-hack",function(){f.off("focus.timepicker-ie-hack");f.on("focus.timepicker",A.show)});h(f)||f[0].focus();n.find("li").removeClass("ui-timepicker-selected");b(this).addClass("ui-timepicker-selected");B(f)&&(f.trigger("hideTimepicker"),n.on("mouseup.timepicker click.timepicker","li",
function(S){n.off("mouseup.timepicker click.timepicker");t.hide()}))}))}function d(f,m){var n,t,x;return"object"==typeof f?(n=f.label,t=f.className,x=f.value):"string"==typeof f?n=f:b.error("Invalid noneOption value"),m?b("<option />",{value:x,"class":t,text:n}):b("<li />",{"class":t,text:n}).data("time",String(x))}function g(f,m){return f=m.roundingFunction(f,m),null!==f?D(f,m):void 0}function l(f){f.target!=window&&(f=b(f.target),f.closest(".ui-timepicker-input").length||f.closest(".ui-timepicker-wrapper").length||
(A.hide(),b(document).unbind(".ui-timepicker"),b(window).unbind(".ui-timepicker")))}function h(f){f=f.data("timepicker-settings");return(window.navigator.msMaxTouchPoints||"ontouchstart"in document)&&f.disableTouchKeyboard}function k(f,m,n){if(!n&&0!==n)return!1;f=f.data("timepicker-settings");var t=!1;n=f.roundingFunction(n,f);return m.find("li").each(function(x,C){x=b(C);if("number"==typeof x.data("time"))return x.data("time")==n?(t=x,!1):void 0}),t}function p(f,m){m.find("li").removeClass("ui-timepicker-selected");
var n=z(y(f),f.data("timepicker-settings"));null!==n&&(f=k(f,m,n))&&(n=f.offset().top-m.offset().top,(n+f.outerHeight()>m.outerHeight()||0>n)&&m.scrollTop(m.scrollTop()+f.position().top-f.outerHeight()),f.addClass("ui-timepicker-selected"))}function r(f,m){if(""!==this.value&&"timepicker"!=m){var n=b(this);if(!n.is(":focus")||f&&"change"==f.type){f=n.data("timepicker-settings");var t=z(this.value,f);if(null===t)return void n.trigger("timeFormatError");var x=!1;if(null!==f.minTime&&null!==f.maxTime&&
(t<f.minTime||t>f.maxTime)&&(x=!0),b.each(f.disableTimeRanges,function(){return t>=this[0]&&t<this[1]?(x=!0,!1):void 0}),f.forceRoundTime){var C=f.roundingFunction(t,f);C!=t&&(t=C,m=null)}f=D(t,f);x?q(n,f,"error")&&n.trigger("timeRangeError"):q(n,f,m)}}}function y(f){return f.is("input")?f.val():f.data("ui-timepicker-value")}function q(f,m,n){if(f.is("input")){f.val(m);var t=f.data("timepicker-settings");t.useSelect&&"select"!=n&&"initial"!=n&&f.data("timepicker-list").val(g(z(m),t))}return f.data("ui-timepicker-value")!=
m?(f.data("ui-timepicker-value",m),"select"==n?f.trigger("selectTime").trigger("changeTime").trigger("change","timepicker"):-1==["error","initial"].indexOf(n)&&f.trigger("changeTime"),!0):(f.trigger("selectTime"),!1)}function u(f){switch(f.keyCode){case 13:case 9:break;default:f.preventDefault()}}function v(f){var m=b(this),n=m.data("timepicker-list");if(!n||!a(n)){if(40!=f.keyCode)return!0;A.show.call(m.get(0));n=m.data("timepicker-list");h(m)||m.focus()}switch(f.keyCode){case 13:return B(m)&&(r.call(m.get(0),
...
(n.find("li").each(function(x,C){return 0<b(C).position().top?(t=b(C),!1):void 0}),t.addClass("ui-timepicker-selected")):t.is(":last-child")||(t.removeClass("ui-timepicker-selected"),t.next().addClass("ui-timepicker-selected"),t.next().position().top+2*t.outerHeight()>n.outerHeight()&&n.scrollTop(n.scrollTop()+t.outerHeight())),!1;case 27:n.find("li").removeClass("ui-timepicker-selected");A.hide();break;case 9:A.hide();break;default:return!0}}function w(f){var m=b(this),n=m.data("timepicker-list"),
t=m.data("timepicker-settings");if(!n||!a(n)||t.disableTextInput)return!0;switch(f.keyCode){case 96:case 97:case 98:case 99:case 100:case 101:case 102:case 103:case 104:case 105:case 48:case 49:case 50:case 51:case 52:case 53:case 54:case 55:case 56:case 57:case 65:case 77:case 80:case 186:case 8:case 46:t.typeaheadHighlight?p(m,n):n.hide()}}function B(f){var m=f.data("timepicker-settings"),n=null,t=f.data("timepicker-list").find(".ui-timepicker-selected");return t.hasClass("ui-timepicker-disabled")?
!1:(t.length&&(n=t.data("time")),null!==n&&("string"!=typeof n&&(n=D(n,m)),q(f,n,"select")),!0)}function G(f,m){f=Math.abs(f);var n,t;f=Math.round(f/60);var x=[];return 60>f?x=[f,E.mins]:(n=Math.floor(f/60),t=f%60,30==m&&30==t&&(n+=E.decimal+5),x.push(n),x.push(1==n?E.hr:E.hrs),30!=m&&t&&(x.push(t),x.push(E.mins))),x.join(" ")}function D(f,m){if("number"!=typeof f)return null;var n=parseInt(f%60),t=parseInt(f/60%60),x=parseInt(f/3600%24);x=new Date(1970,0,2,x,t,n,0);if(isNaN(x.getTime()))return null;
if("function"===b.type(m.timeFormat))return m.timeFormat(x);for(var C="",H=0;H<m.timeFormat.length;H++)switch(n=m.timeFormat.charAt(H)){case "a":C+=11<x.getHours()?E.pm:E.am;break;case "A":C+=11<x.getHours()?E.PM:E.AM;break;case "g":n=x.getHours()%12;C+=0===n?"12":n;break;case "G":n=x.getHours();f===F&&(n=m.show2400?24:0);C+=n;break;case "h":n=x.getHours()%12;0!==n&&10>n&&(n="0"+n);C+=0===n?"12":n;break;case "H":n=x.getHours();f===F&&(n=m.show2400?24:0);C+=9<n?n:"0"+n;break;case "i":t=x.getMinutes();
C+=9<t?t:"0"+t;break;case "s":n=x.getSeconds();C+=9<n?n:"0"+n;break;case "\\":H++;C+=m.timeFormat.charAt(H);break;default:C+=n}return C}function z(f,m){if(""===f||null===f)return null;if("object"==typeof f)return 3600*f.getHours()+60*f.getMinutes()+f.getSeconds();if("string"!=typeof f)return f;f=f.toLowerCase().replace(/[\s\.]/g,"");"a"!=f.slice(-1)&&"p"!=f.slice(-1)||(f+="m");var n="("+E.am.replace(".","")+"|"+E.pm.replace(".","")+"|"+E.AM.replace(".","")+"|"+E.PM.replace(".","")+")?",t=f.match(new RegExp("^"+
n+"([0-9]?[0-9])\\W?([0-5][0-9])?\\W?([0-5][0-9])?"+n+"$"));if(!t)return null;f=parseInt(1*t[2],10);if(24<f){if(m&&!1===m.wrapHours)return null;f%=24}n=t[1]||t[5];var x=f;12>=f&&n&&(x=n==E.pm||n==E.PM,x=12==f?x?12:0:f+(x?12:0));t=3600*x+60*(1*t[3]||0)+(1*t[4]||0);12>f&&!n&&m&&m._twelveHourTime&&m.scrollDefault&&(m=t-m.scrollDefault(),0>m&&m>=F/-2&&(t=(t+F/2)%F));return t}var F=86400,E={am:"am",pm:"pm",AM:"AM",PM:"PM",decimal:".",mins:"mins",hr:"hr",hrs:"hrs"},A={init:function(f){return this.each(function(){var m=
b(this),n=[],t;for(t in b.fn.timepicker.defaults)m.data(t)&&(n[t]=m.data(t));n=b.extend({},b.fn.timepicker.defaults,n,f);if(n.lang&&(E=b.extend(E,n.lang)),n=c(n),m.data("timepicker-settings",n),m.addClass("ui-timepicker-input"),n.useSelect)e(m);else{if(m.prop("autocomplete","off"),n.showOn)for(var x in n.showOn)m.on(n.showOn[x]+".timepicker",A.show);m.on("change.timepicker",r);m.on("keydown.timepicker",v);m.on("keyup.timepicker",w);n.disableTextInput&&m.on("keydown.timepicker",u);r.call(m.get(0),
null,"initial")}})},show:function(f){var m=b(this),n=m.data("timepicker-settings");if(f&&f.preventDefault(),n.useSelect)return void m.data("timepicker-list").focus();h(m)&&m.blur();f=m.data("timepicker-list");if(!m.prop("readonly")&&(f&&0!==f.length&&"function"!=typeof n.durationTime||(e(m),f=m.data("timepicker-list")),!a(f))){m.data("ui-timepicker-value",m.val());p(m,f);A.hide();f.show();var t={};n.orientation.match(/r/)?t.left=m.offset().left+m.outerWidth()-f.outerWidth()+parseInt(f.css("marginLeft").replace("px",
""),10):t.left=m.offset().left+parseInt(f.css("marginLeft").replace("px",""),10);"t"==(n.orientation.match(/t/)?"t":n.orientation.match(/b/)?"b":m.offset().top+m.outerHeight(!0)+f.outerHeight()>b(window).height()+b(window).scrollTop()?"t":"b")?(f.addClass("ui-timepicker-positioned-top"),t.top=m.offset().top-f.outerHeight()+parseInt(f.css("marginTop").replace("px",""),10)):(f.removeClass("ui-timepicker-positioned-top"),t.top=m.offset().top+m.outerHeight()+parseInt(f.css("marginTop").replace("px",""),
10));f.offset(t);t=f.find(".ui-timepicker-selected");if(!t.length){var x=z(y(m));null!==x?t=k(m,f,x):n.scrollDefault&&(t=k(m,f,n.scrollDefault()))}t&&t.length?(t=f.scrollTop()+t.position().top-t.outerHeight(),f.scrollTop(t)):f.scrollTop(0);return n.stopScrollPropagation&&b(document).on("wheel.ui-timepicker",".ui-timepicker-wrapper",function(C){C.preventDefault();var H=b(this).scrollTop();b(this).scrollTop(H+C.originalEvent.deltaY)}),b(document).on("touchstart.ui-timepicker mousedown.ui-timepicker",
l),b(window).on("resize.ui-timepicker",l),n.closeOnWindowScroll&&b(document).on("scroll.ui-timepicker",l),m.trigger("showTimepicker"),this}},hide:function(f){f=b(this);var m=f.data("timepicker-settings");return m&&m.useSelect&&f.blur(),b(".ui-timepicker-wrapper").each(function(){var n=b(this);if(a(n)){var t=n.data("timepicker-input"),x=t.data("timepicker-settings");x&&x.selectOnBlur&&B(t);n.hide();t.trigger("hideTimepicker")}}),this},option:function(f,m){return"string"==typeof f&&"undefined"==typeof m?
b(this).data("timepicker-settings")[f]:this.each(function(){var n=b(this),t=n.data("timepicker-settings"),x=n.data("timepicker-list");"object"==typeof f?t=b.extend(t,f):"string"==typeof f&&(t[f]=m);t=c(t);n.data("timepicker-settings",t);x&&(x.remove(),n.data("timepicker-list",!1));t.useSelect&&e(n)})},getSecondsFromMidnight:function(){return z(y(this))},getTime:function(f){var m=y(this);if(!m)return null;m=z(m);if(null===m)return null;f||(f=new Date);f=new Date(f);return f.setHours(m/3600),f.setMinutes(m%
3600/60),f.setSeconds(m%60),f.setMilliseconds(0),f},isVisible:function(){var f=this.data("timepicker-list");return!(!f||!a(f))},setTime:function(f){var m=this.data("timepicker-settings"),n=m.forceRoundTime?g(z(f),m):D(z(f),m);return f&&null===n&&m.noneOption&&(n=f),q(this,n),this.data("timepicker-list")&&p(this,this.data("timepicker-list")),this},remove:function(){if(this.hasClass("ui-timepicker-input")){var f=this.data("timepicker-settings");return this.removeAttr("autocomplete","off"),this.removeClass("ui-timepicker-input"),
...
className:null,closeOnWindowScroll:!1,disableTextInput:!1,disableTimeRanges:[],disableTouchKeyboard:!1,durationTime:null,forceRoundTime:!1,maxTime:null,minTime:null,noneOption:!1,orientation:"l",roundingFunction:function(f,m){if(null===f)return null;if("number"!=typeof m.step)return f;var n=f%(60*m.step);return n>=30*m.step?f+=60*m.step-n:f-=n,f==F&&m.show2400?f:f%F},scrollDefault:null,selectOnBlur:!1,show2400:!1,showDuration:!1,showOn:["click","focus"],showOnFocus:!0,step:30,stopScrollPropagation:!1,
timeFormat:"g:ia",typeaheadHighlight:!0,useSelect:!1,wrapHours:!0}});(function(b){var a=function(c,e,d){var g=/[^\w\-\.:]/.test(c)?new Function(a.arg+",tmpl","var _e=tmpl.encode"+a.helper+",_s='"+c.replace(a.regexp,a.func)+"';return _s;"):d?a.cache[c]=a(a.load(c)):a.cache[c]=a.cache[c]||a(a.load(c));return e?g(e,a):function(l){return g(l,a)}};a.cache={};a.load=function(c){var e=document.getElementById(c),d=/<\\\/(\w+)/g;if(!e&&console)throw{message:"template with id="+c+" not found"};return e?("textarea"==e.tagName.toLowerCase()?e.value:document.getElementById(c).innerHTML).replace(d,
"</$1"):null};a.regexp=/([\s'\\])(?![^%]*%\})|(?:\{%(=|#)([\s\S]+?)%\})|(\{%)|(%\})/g;a.func=function(c,e,d,g,l,h){if(e)return{"\n":"\\n","\r":"\\r","\t":"\\t"," ":" "}[c]||"\\"+c;if(d)return"="===d?"'+_e("+g+")+'":"'+("+g+"||'')+'";if(l)return"';";if(h)return"_s+='"};a.encReg=/[<>&"'\x00]/g;a.encMap={"<":"&lt;",">":"&gt;","&":"&amp;",'"':"&quot;","'":"&#39;"};a.encode=function(c){return String(c||"").replace(a.encReg,function(e){return a.encMap[e]||""})};a.arg="o";a.helper=",print=function(s,e){_s+=e&&(s||'')||_e(s);},include=function(s,d){_s+=tmpl(s,d);}";
"function"===typeof define&&define.amd?define(function(){return a}):b.tmpl=a})(this);(function(b){b.fn.lazyLoad=function(a,c){function e(){if(d.stopped)this.onscroll=null;else if(!d.stopped&&!d.loading&&h(l,g)<=d.distance){if(null!==d.hash){var k=location.hash.replace(/^[^#]*#\/*/,"").split("/")[0];if(-1===d.hash.indexOf(k)){this.onscroll=null;return}}d.load()}}if("stop"==a){var d=this.data("lazyLoadSettings");d&&(d.stopped=!0)}else if("reload"==a){if(d=this.data("lazyLoadSettings"))d.stopped=!1,d.loading=!1,this.get(0).onscroll=null,this.lazyLoad(d)}else if("sleep"==a){if(d=this.data("lazyLoadSettings"))d.loading=
!0}else if("wake"==a){if(d=this.data("lazyLoadSettings"))d.loading=!1}else if("force"==a)(d=this.data("lazyLoadSettings"))&&(d.loading||d.load());else{if("get"===a)return d=this.data("lazyLoadSettings")||{},d[c];this.data("lazyLoadSettings",b.extend({distance:50,load:function(){},container:l,state:"wake",hash:location.hash.replace(/^[^#]*#\/*/,"").split("/")[0]||null,distanceBetweenBottoms:null},a||{}));d=this.data("lazyLoadSettings");d.loading=!1;d.stopped=!1;var g=b(window),l=d.container||b(this);
null===d.hash||b.isArray(d.hash)||(d.hash=[d.hash]);b.fn.lazyLoad.call(g,d.state);(function(){var k,p=setTimeout(k=function(){if(d.stopped)clearTimeout(p);else{if(null!==d.hash){var r=location.hash.replace(/^[^#]*#\/*/,"").split("/")[0];if(-1===d.hash.indexOf(r)){clearTimeout(p);return}}d.loading?p=setTimeout(k,350):(h(l,g),h(l,g)<=d.distance?(d.load(),p=setTimeout(k,350)):(g.get(0).onscroll=e,clearTimeout(p)))}},350)})();var h="function"===typeof d.distanceBetweenBottoms?d.distanceBetweenBottoms:
function(k,p,r){k="string"===typeof k?b(k):k;r=r||0;return k.position().top+k.outerHeight()-r-(p.scrollTop()+p.height())}}}})(jQuery);(function(b){b.storage=new b.store;b.orders={$wrapper:null,pre_search_hash:null,search_item_param:null,options:{view:"table"},init:function(a){var c=this,e=this;e.options=a;e.$wrapper=b("#s-content");"undefined"!=typeof b.History&&b.History.bind(function(){e.dispatch()});b.ajaxPrefilter(function(d,g,l){l.originalRequestOptions=g});b.wa.errorHandler=function(d){var g=d.originalRequestOptions||{};if(403===d.status||404===d.status){d=b(d.responseText);d=d.find(".dialog-content").length?b('<div class="box contentbox"></div>').append(d.find(".dialog-content")):
b('<div class="box contentbox"></div>').append(d.find(":not(style)"));var l="content";g=g.url||"";if(0<g.length){var h=g.indexOf("?");-1!==h&&(g=g.substr(h+1),g=b.shop.helper.parseParams(g)||{},"order"===g.module&&"table"!==g.view&&b("#s-order").length&&(l="order"))}"order"===l?b("#s-order").empty().append(d):(b("#s-content").empty().append(d),b.order_list&&b.order_list.finit());return!1}return!0};(a=window.location.hash)&&"#/orders/"!==a||(a="/orders/"+this.getFiltersHashStorage());"#/"!==a&&a?b.wa.setHash(a):
this.dispatch();this.initEventsVisibilityFilters();this.initDropdown();b(document).bind("wa.appcount",function(d,g){g=g||{};d=parseInt(g.shop,10);(g=document.title.match(/\(\d+\) /))?document.title=document.title.replace(g[0],d?"("+d+") ":""):d&&(document.title="("+d+") "+document.title)});b(function(){b("#maincontent").on("click",".s-alert-close",function(d){d.preventDefault();d=b.storage.get("shop/alerts");var g=b(this).parent();d||(d=[]);d.push(g.data("alert"));d=d.filter(function(l,h,k){return null!=
l&&h==k.indexOf(l)});b.storage.set("shop/alerts",d);g.remove()})});this.checkAlerts();this.ordersNavDetach();this.initWaLoading();this.$wrapper.on("wa_init_orders_nav_before",function(d,g){["orders/all","orders/state_id=new|processing|auth|paid"].includes(c.hash)&&c.setFiltersHashStorage(c.hash)});this.$wrapper.on("wa_init_orders_nav_after",function(d,g){c.initSearch(g.filter_params_extended);c.hasFiltersInUrl()&&"split"===g.view&&c.visibilityFilters(!0)})},initEventsVisibilityFilters:function(){var a=
this;b(document).on("click",".js-orders-show-filters",function(){a.visibilityFilters(!0);a.clearFilters()});b(document).on("click",".js-orders-hide-filters",function(){a.visibilityFilters(!1);a.clearFilters()})},initSearch:function(a){var c=this,e=b("#s-orders-search"),d=[],g=null,l=function(q){c.pre_search_hash||(c.pre_search_hash=window.location.hash,b.order_list.options&&"split"===b.order_list.options.view&&c.clearFilters());switch(q.autocomplete_item_type){case "order":c.search_item_param=null;
...
"country="+q.value;b.wa.setHash("#/orders/"+c.search_item_param+"/");break;case "item_code":c.search_item_param="item_code="+q.value;b.wa.setHash("#/orders/"+c.search_item_param+"/");break;default:c.pre_search_hash=null}};e.unbind("keydown").bind("keydown",function(q){if(13==q.keyCode||10==q.keyCode){if(g)return!1;var u=b(this);if(!b(this).val())return location.hash="#/orders/all/",u.autocomplete("close"),!1;if(d&&b.isArray(d)&&d.length)return l(d[0]),setTimeout(function(){u.autocomplete("close")},
150),!1}});e.autocomplete({minLength:1,delay:300,html:!0,select:function(q,u){l(u.item);return!1},source:function(q,u){g&&g.abort();b.orders.waLoadingBeforeLoad();g=b.getJSON("?action=autocomplete&type=order",q,function(v){d=v;u(v);b.orders.waLoadingLoaded()}).always(function(){g=null})}});var h=b(".js-orders-search"),k=function(){h.hasClass("js-orders-search-split-and-mobile")?b(".js-orders-search-show").removeClass("hidden"):b(".js-orders-search-show").addClass("hidden")},p=function(){b(".js-orders-search-show").removeClass("hidden");
...
e.some(function(F){return z.startsWith(F)})&&D.push(z);return!1});u=D.join("&");D.length&&(u="&"+u);u=encodeURIComponent(u);q="";B.length&&(q="&"+B.join("&"));B="";l(D)?(B+="all/",c.clearFilters()):B+="hash=search/"+u+q+"/";c.setFiltersHashStorage(B);b.wa.setHash("/orders/"+B)}else location.replace(k.attr("href"));p||(d(r),r.$button.html(k.html()))}});b(".js-remove-filters-link").on("click",function(){a.clearFilters()})},visibilityFilters:function(a){var c=b(".js-order-nav-block-secondary");a?c.show():
...
!1;if(void 0===a||null===a)a=window.location.hash;a=a.replace(/(^[^#]*#\/*|\/$)/g,"");null!==this.hash&&(this.prevHash=this.hash);this.hash=a;var c=new b.Event("wa_before_dispatched");b(window).trigger(c);if(a)if(a=a.split("/"),a[0]){c="";var e,d=null,g=null;for(e=0;e<a.length;e++){var l=a[e];if(2>e){if(0===e)c=l;else if(parseInt(l,10)!=l&&-1==l.indexOf("="))c+=l.substr(0,1).toUpperCase()+l.substr(1);else break;"function"==typeof this[c+"Action"]&&(d=c,g=e+1)}else break}"function"!==typeof this[c+
...
!1);return h}}).done(function(h){if("undefined"!==typeof c.check&&!c.check||l.random==g){(c.content||b("#s-content")).removeClass("bordered-left").html(h);"function"===typeof e&&e.call(this);var k=b(window);setTimeout(function(){k.trigger("scroll")},250);d();l.checkAlerts();l.waLoadingLoaded()}}).fail(function(h){h.responseText&&(403===h.status?b.wa.errorHandler(h):console.error(h.responseText));l.$wrapper.trigger("wa_load_fail.wa_loading")})},checkAlerts:function(){var a=b.storage.get("shop/alerts");
...
a.filter_params_str||"";this.container=b("#order-list");this.templates=a.templates||{};"table"==a.view&&(this.container=b("#order-list").find("tbody:first"),this.$selectionMenu=this.options.$selectionMenu)&&(this.select_all_input=this.$selectionMenu.find(".s-order-list-select-all"),this.select_all_input.attr("checked",!1),b(".js-selection-dropdown").waDropdown({hide:!1}));if("split"==a.view){var c=b("#s-orders"),e=b("#s-order"),d=function(l){l=e.find(".back.order-list");l.addClass("js-order-hide mobile-only").show().attr("href",
"javascript:void(0);");l.off().on("click",function(){e.addClass("desktop-and-tablet-only");c.removeClass("desktop-and-tablet-only");b(window).off("hashchange")});setTimeout(function(){});b(window).unbind("hashchange");b(window).on("hashchange",function(){})};this.container.off().on("wa_order_mobile_loaded",function(l,h){b.order_list.isMobile()&&h&&b.order_list.id&&d(h)});this.container.on("click","li[data-order-id]",function(l){b("#skeleton_split").removeClass("desktop-and-tablet-only");e.removeClass("desktop-and-tablet-only");
c.addClass("desktop-and-tablet-only");var h=b(this),k=(b.order_list.params?b.order_list.params.id:null)||b.order_list.id;k==h.data("order-id")&&(l.preventDefault(),d(k))});this.container.on("click","[data-order-id]:not(.selected) a",function(){b.skeletonLoader.repeatShow()})}this.options.all_order_state_ids=this.options.all_order_state_ids||null;this.sidebar=b("#s-sidebar");this.id=a.id||0;this.container.on("append_order_list",function(){b("#s-orders [data-wa-tooltip-content]").waTooltip()});if(a.orders&&
a.orders.length&&a.view){try{this.container.append(tmpl("template-order-list-"+this.options.view,{orders:a.orders,states:a.state_names||{},state_counters:a.state_counters||{},state_icons:a.state_icons||{}},!0)),this.container.trigger("append_order_list",[a.orders])}catch(l){if(b("#template-order-list-kanban").length)return b.shop.notification({class:"danger",content:"Error: "+l.message}),console&&console.log(l.stack),this;b.storage.set("shop/orders/view","table")}delete a.orders;delete this.options.orders}a.lazy_loading&&
this.initLazyLoad(a.lazy_loading);a.counters&&this.updateCounters(a.counters);a.update_process&&this.updateProcess("run",a.update_process);b.orders.$wrapper.trigger("wa_init_orders_nav_before",[a]);if(/order\/\d+/.test(b.orders.hash))b.orders.orderNav().hide();else{b.orders.orderNav().show();this.ordersNavTeleport();this.selectionMenuTeleport();if(a.sort&&a.sort[0]){a.sort[0]=""+a.sort[0];var g=b(".js-orders-sort .s-sort").map(function(){var l=b(this).data("sort")||"";return l?l:!1}).toArray();0>
g.indexOf(a.sort[0])&&(a.sort[0]=g[0]);a.sort[1]=a.sort[1]||"";a.sort[1]="desc"===a.sort[1].toLowerCase()?"desc":"asc";this.sort=a.sort}this.initSortMenu();b.orders.$wrapper.trigger("wa_init_orders_nav_after",[a])}a.total_processing&&this.updateTotalProcessing(a.total_processing);this.initView()},initLazyLoad:function(a){function c(){var k=e.container.find(".order:last");if(k=parseInt(k.attr("data-order-id"),10))b(".lazyloading-link").hide(),b(".lazyloading-progress").show(),b.getJSON(e.buildLoadListUrl(k),
function(p){if("ok"==p.status){try{e.container.append(tmpl("template-order-list-"+e.options.view,{orders:p.data.orders,states:e.options.state_names||{},state_counters:e.options.state_counters||{},state_icons:e.options.state_icons||{},check_all:"table"==e.options.view?e.select_all_input.attr("checked"):!1})),e.container.trigger("append_order_list",[p.data.orders]),e.container.find("[data-order-id="+e.options.id+"]").length&&(e.container.find(".selected").removeClass("selected"),e.container.find("[data-order-id="+
e.options.id+"]").addClass("selected"))}catch(r){console&&console.log(r.stack);return}h&&l.unobserve(h);b(".lazyloading-progress-string").text(p.data.progress.loaded+" "+p.data.progress.of);b(".lazyloading-progress").hide();b(".lazyloading-chunk").text(p.data.progress.chunk);p.data.loaded>=p.data.total_count?b(".lazyloading-link").hide():(b(".lazyloading-link").show(),(h=e.container.find(".order:last").get(0))&&l.observe(h))}else console&&console.log("Error when loading orders: "+p.errors)}).error(function(p){console&&
(p&&p.errors?console.log("Error when loading orders: "+p.errors):p?console.log(p):console.log("Error when loading orders"))})}if("kanban"!==this.options.view){var e=this,d=e.options.count,g=e.options.total_count,l=null,h=null;a=b("#s-orders");a.on("touchstart",function(){b("body").css({overflow:"hidden"});b(this).children(".sidebar-body").css({overflow:"overlay"});setTimeout(function(){b("body").css({overflow:"auto"})})});a.off("click",".lazyloading-link").on("click",".lazyloading-link",function(){c();
return!1});(function(){l=new IntersectionObserver(function(k){0>=k[0].intersectionRatio||d<g&&c()});(h=e.container.find(".order:last").get(0))&&l.observe(h)})()}},initView:function(){function a(l){var h=b.order_list.getSelectedOrders(),k=function(){c.$selectionMenu.addClass("disabled");c.$selectionMenu.find(".js-selection-menu-loading").show();c.select_all_input.attr("disabled",!0);g(l,h,function(){c.$selectionMenu.removeClass("disabled");c.$selectionMenu.find(".js-selection-menu-loading").hide();
c.select_all_input.removeAttr("disabled");c.select_all_input.trigger("select",!1);b.orders.dispatch()})};h.all?confirm($_("Perform action to all selected orders?"))&&k():k()}var c=this;this.initSidebar();"table"===this.options.view&&c.$selectionMenu&&c.$selectionMenu.length?this.initSelecting():"split"===this.options.view&&this.options.id&&this.loadOrder(this.options.id);var e=b("#s-orders-views"),d=b("#s-order-nav");e.find("li.selected").removeClass("selected");e.find('li[data-view="'+this.options.view+
'"]').addClass("selected");d.attr("data-view-mode",this.options.view);e.find("li a").each(function(){var l=b(this),h=b(this).parents("li:first");l.attr("href","#/orders/view="+h.attr("data-view")+(b.order_list.options.filter_params_str?"&"+b.order_list.options.filter_params_str:"")+"/")});var g=function(l,h,k){var p=function(){var v=b(window),w=b.Deferred();if(!h.all||!c.options.lazy_loading||v.lazyLoad("get","stopped"))return w.resolve(),w;c.container.one("append_order_list.ensureOrderListChunkLoaded",
function(){w.resolve()});setTimeout(function(){c.container.off("append_order_list.ensureOrderListChunkLoaded");w.resolve()},2E3);v.lazyLoad("force");return w},r=function(v){var w=b.Deferred();if(b.isEmptyObject(v.data.orders))return w.resolve(),w;c.container.one("append_order_list.updateOrderListChunk",function(){w.resolve()});setTimeout(function(){c.container.off("append_order_list.updateOrderListChunk");w.resolve()},1E3);c.updateListItems(v.data.orders);return w},y=function(v){var w=b.Deferred(),
B=function(){c.container.find(".order:not(:hidden):first").length||b("#s-content").html(c.templates.dummy_no_orders_body)},G=[],D=c.filter_params;if(!b.isEmptyObject(v.data.orders))for(var z=0,F=v.data.orders.length;z<F;z++)!b.isEmptyObject(D)&&D.state_id&&("string"===b.type(D.state_id)&&D.state_id!==v.data.orders[z].state_id?G.push(v.data.orders[z].id):"array"===b.type(D.state_id)&&-1===D.state_id.indexOf(v.data.orders[z].state_id)&&G.push(v.data.orders[z].id));b.isEmptyObject(G)?(B(),w.resolve()):
(c.hideListItems(G).done(function(){B();w.resolve()}),setTimeout(function(){w.resolve()},1E3));return w},q=function(v){var w=b.Deferred();p().done(function(){r(v).done(function(){y(v).done(function(){b.order_list.updateCounters({state_counters:v.data.state_counters,common_counters:{pending:v.data.pending_counters}});w.resolve()})})});return w},u=function(v,w){b.shop.jsonPost("?module=orders&action=performAction&id="+l+"&offset="+(v||0)+"&"+c.options.filter_params_str,h,function(B){"ok"===B.status?
q(B).done(function(){B.data.offset<B.data.total_count?u(B.data.offset,w):w(B)}):w(B)})};u(0,k)};if(c.$selectionMenu)c.$selectionMenu.off("click.order_list",".js-wf-action-item").on("click.order_list",".js-wf-action-item",function(){var l=b(this),h=l.data("action-id");if(!l.hasClass("disabled"))return h&&a(h),!1})},loadOrder:function(a){this.container.find(".selected").removeClass("selected");this.container.find("[data-order-id="+a+"]").addClass("selected");b.orders.load("?module=order&id= "+a+"&"+
this.filter_params_str,{content:b("#s-order")},function(){this.id=a;b(window).trigger("wa_loaded",[["split"]]);b("#order-list").trigger("wa_order_mobile_loaded",[a])})},getSelectedOrders:function(a){a=a||!1;var c={count:0,all:!1};if(this.select_all_input.attr("checked")){c.all=!0;var e=b.order_list.filter_params;a?(c.serialized=[],b.isEmptyObject(e)?c.serialized.push({name:"filter_params",value:""}):b.each(e,function(d,g){b.isArray(g)?b.each(g,function(l,h){c.serialized.push({name:"filter_params["+
d+"]["+l+"]",value:h})}):c.serialized.push({name:"filter_params["+d+"]",value:g})})):c.filter_params=b.isEmptyObject(e)?"":e;c.count=this.options.total_count}else a?c.serialized=b.order_list.container.find(".order.selected").map(function(){c.count+=1;return{name:"order_id[]",value:b(this).attr("data-order-id")}}).toArray():c.order_id=b.order_list.container.find(".order.selected").map(function(){c.count+=1;return b(this).attr("data-order-id")}).toArray();return c},initSortMenu:function(){var a=this,
c=b(".js-orders-sort"),e=c.find(".js-sort-dropdown-skeleton");c=c.find(".js-sort-dropdown");var d;d||c.waDropdown({hover:!1,items:".menu > li > a",ready:function(g){d=g;var l=a.sort[0]?a.sort[0]:"create_datetime",h=a.sort[1]?a.sort[1]:"desc";d.$button.data("sort")||(g.$wrapper.find(".count").addClass("hidden"),g.$button.find("."+h).removeClass("hidden"),g.$menu.find('a[data-sort="'+l+'"]').find("."+h).removeClass("hidden"));d.$button.data("sort",l);d.$button.data("order",h)},change:function(g,l,h){g=
b(l);var k=h.$button.data();l=k.sort;k=k.order;g.data("sort")===l?k="desc"===k?"asc":"desc":(l=g.data("sort"),k="desc");h.$menu.find(".count").addClass("hidden");g.find("."+k).removeClass("hidden");h.$button.find("."+k).removeClass("hidden").siblings(".count").addClass("hidden");g=$jscomp.makeIterator([l,k]);h=g.next().value;g=g.next().value;d.$button.data("sort",h).data("order",g);l=window.location.hash||"";l=l.replace(/(^[^#]*#\/*|\/$)/g,"");l.split("/")[1]||(l="#/orders/state_id=new|processing|auth|paid");
l=l.replace(/(&*sort\[[01]\]=.*?[&\/]|&*sort\[[01]\]=.*?$)/g,"");(k=0<l.indexOf("=")||l.includes("all"))&&(l=l.replace(/[\/&]$/,""));b.wa.setHash(l+((k?"&":"")+"sort[0]="+h+"&sort[1]="+g+"/"))}});c.removeClass("hidden");e.addClass("hidden")},initSidebar:function(){var a=b("#s-order-nav"),c=a.find(".selected").removeClass("selected");this.filter_params.state_id?b.isArray(this.filter_params.state_id)&&1<this.filter_params.state_id.length?(b("#s-pending-orders").addClass("selected"),b(".js-pending-orders").parent().addClass("selected")):
a.find('[data-state-id="'+this.filter_params.state_id+'"]').addClass("selected"):this.filter_params.contact_id?a.find("[data-contact-id="+this.filter_params.contact_id+"]").addClass("selected"):this.filter_params.storefront?(c=decodeURIComponent(this.filter_params.storefront),"/"===c.slice(-1)&&(c=c.slice(0,-1)),a.find('[data-storefront="'+c+'"]').addClass("selected")):b.order_list.filter_params_str?a.find('[href="'+window.location.hash+'"]:first').closest("li").addClass("selected").length||c.addClass("selected"):
b("#s-all-orders").addClass("selected");a.find(".js-orders-link").unbind("click.order_list").bind("click.order_list",function(){a.find(".selected").removeClass("selected");b(this).hasClass("js-order-nav-brick")?b(this).addClass("selected"):b(this).closest("li").addClass("selected");if(b(this).attr("href").replace(/(^[^#]*#\/*|\/$)/g,"")==b.orders.hash){var e=b.orders.hash.replace("orders/","");e!==b.orders.hash&&b.orders.ordersAction.apply(b.orders,e.split("/"))}})},updateSelectionMenuActionItemsByStates:function(a){var c=
[];if("string"===typeof a)c.push(a);else if(b.isArray(a))c=[].concat(a);else return;a=this.$selectionMenu.find(".wf-actions .js-wf-action-item");a.addClass("disabled");var e={};a.each(function(){var g=b(this),l=g.data("actionId");g=g.data("availableForStates").split(",");for(var h=0;h<c.length;h++){var k=c[h];k=""+k;-1!==g.indexOf(k)&&(e[k]=e[k]||[],e[k].push(l))}});var d=b.shop.intersectArrays(b.shop.getValues(e),!0);0<d.length&&a.filter(function(){return-1<b.inArray(b(this).data("actionId"),d)}).removeClass("disabled")},
enableAllSelectionMenuActionItems:function(){this.$selectionMenu.find(".wf-actions .js-wf-action-item").removeClass("disabled")},disableAllSelectionMenuActionItems:function(){this.$selectionMenu.find(".wf-actions .js-wf-action-item").addClass("disabled")},initSelecting:function(){var a=this,c=this.container,e=this.select_all_input;a.filter_params&&a.filter_params.state_id&&e.is(":checked")&&a.updateSelectionMenuActionItemsByStates(a.filter_params.state_id);e.click(function(){b(this).trigger("select",
...
(document.body.onselectstart=null)});var g=function(){var k=b("#order-list"),p=e.attr("checked");k=k.find(".order.selected:first").length;p||k?(a.$selectionMenu.show(),a.$search_form&&a.$search_form.hide(),k=null,k=p?a.options.all_order_state_ids?a.options.all_order_state_ids:a.filter_params&&a.filter_params.state_id?a.filter_params.state_id:null:a.container.find(".order.selected").map(function(){return b(this).data("stateId")}).toArray(),null!==k?(k=b.shop.getUniqueValues(k),a.updateSelectionMenuActionItemsByStates(k)):
a.enableAllSelectionMenuActionItems()):(a.$selectionMenu.hide(),a.$search_form&&a.$search_form.show())};c.off("select",".order").on("select",".order",function(k,p){(void 0!==p?p:1)?b(this).addClass("selected").find("input:first").attr("checked",!0).prop("checked",!0):(b(this).removeClass("selected").find("input:first").attr("checked",!1).prop("checked",!1),e.is(":checked")&&e.attr("checked",!1).prop("checked",!1));g();return!1});var l=function(){a.xhrs.printforms&&a.xhrs.printforms.abort();d({printforms:[]});
a.xhrs.printforms=null;e.is(":checked")&&null!==b.order_list.all_printforms?d({printforms:b.order_list.all_printforms}):a.xhrs.printforms=b.shop.getJSON("?module=orders&action=printforms",a.getSelectedOrders(),function(k){b.isEmptyObject(k.data.printforms)||(e.is(":checked")&&(b.order_list.all_printforms=k.data.printforms),d(k.data),a.xhrs.printforms=null)})};e.unbind("select").bind("select",function(k,p){p=void 0!==p?p:!0;k=b(this);p?(k.attr("checked",!0),c.find(".order").trigger("select",!0,!1)):
(k.attr("checked",!1),c.find(".order").trigger("select",!1,!1));l()});c.off("click",".order input").on("click",".order input",function(k){var p=k.shiftKey;k=this.checked;var r=b(this).parents(".order:first");k?r.addClass("selected"):(e.is(":checked")&&e.attr("checked",!1),r.removeClass("selected"));if(p&&k){(p=c.data("last_checked"))||(p=c.find(".order:first").trigger("select",!0));var y=r.prevAll(".selected[data-order-id="+p.attr("data-order-id")+"]");if(y.length){var q=r.prev();for(p=p.get(0);q.length&&
p!=q.get(0);)q.addClass("selected").find("input").attr("checked",!0),q=q.prev()}else if(y=r.nextAll(".selected[data-order-id="+p.attr("data-order-id")+"]"),y.length)for(q=r.next(),p=p.get(0);q.length&&p!=q.get(0);)q.addClass("selected").find("input").attr("checked",!0),q=q.next();c.data("last_checked")||y.length||p.trigger("selected",!1)}k&&c.data("last_checked",r);g();l()});var h=function(k,p){if(100<p.count)alert($_("Maximum of %d orders is allowed for bulk form printing.").replace("%d",100));else{var r=
"?module=orders&action=printformsDisplay";p=b.map(p.serialized,function(y){return y.name+"="+y.value}).join("&");k=b.map(k,function(y){return"form[]="+y}).join("&");r+="&"+p+"&"+k;b.order_list.plugin_hash&&(r+="&hash="+b.order_list.plugin_hash);k=(""+Math.random()).slice(2);window.open(r,k)}};a.$selectionMenu.off("click.printforms").on("click.printforms",".s-printform-item-button",function(k){k.preventDefault();a.xhrs.printforms&&a.xhrs.printforms.abort();a.xhrs.printforms=null;k=a.$selectionMenu.find(".s-printform-item :checkbox").map(function(){var r=
b(this);return r.is(":checked")?r.data("id"):!1}).toArray();if(k.length){var p=a.getSelectedOrders(!0);if(!(0>=p.count))return h(k,p),!1}})},updateTitle:function(a,c){c=parseInt(c,10)||0;var e="";this.options.state_names&&(this.filter_params.state_id?"string"===typeof this.filter_params.state_id?e=this.options.state_names[this.filter_params.state_id].name:b.isArray(this.filter_params.state_id)&&(e=$_("Processing")):e=$_("All orders"));document.title=c?"("+c+") "+e+(a||""):e+a},updateCounters:function(a){if("kanban"===
this.options.view){var c=b(".s-kanban__list__count"),e;for(e in a.state_counters)a.state_counters.hasOwnProperty(e)&&c.filter('[data-status-id="'+e+'"]').text(a.state_counters[e])}else for(c in(e=this.sidebar)||(e=b("#s-sidebar")),a.total_processing&&this.updateTotalProcessing(a.total_processing),a)if(a.hasOwnProperty(c)){var d=a[c],g;for(g in d)if(d.hasOwnProperty(g)){var l="common_counters"==c?b(".js-"+g+"-orders"):"storefront_counters"===c?e.find("li[data-"+c.replace("_counters","")+'="'+g+'"] .count'):
e.find("li[data-"+c.replace("_counters","")+"-id="+g+"] .count");var h=parseInt(l.text(),10)||0;d[g]=""+d[g];if("+"==d[g].substr(0,1))h+=parseInt(d[g].substr(1),10)||0,l.text(h);else if("-"==d[g].substr(0,1))h-=parseInt(d[g].substr(1),10)||0,h=0>h?0:h,l.text(h);else if(h=parseInt(d[g],10)||0,"undefined"==d[g]){var k=void 0,p=void 0,r=void 0;l.find(".js-new-order-counter").text("+"+(null!=(r=null==(k=a)?void 0:null==(p=k.state_counters)?void 0:p.new)?r:0))}else l.text(h);"new"==g&&(b.shop.updateAppCounter(h),
...
!1}));var d=b(".order",e);b(".order",c).each(function(){var g=b(this);d.filter("[data-order-id="+g.attr("data-order-id")+"]").replaceWith(g)});c.remove();this.container.trigger("append_order_list",[a]);this.getAndUpdateCounters()}},getAndUpdateCounters:function(){var a=this,c=parseInt(this.container.find(".order:first").attr("data-order-id"),10)||0;b.getJSON(this.buildLoadListUrl(c,!0,!0),function(e){var d;"ok"==e.status&&(null==e?0:null==(d=e.data)?0:d.counters)&&a.updateCounters(e.data.counters)})},
updateTotalProcessing:function(a){a&&b(".js-total_processing-orders").html(a.replace(",","."))},hideListItems:function(a){var c=b.Deferred();setTimeout(function(){if(b.order_list&&b.order_list.container&&b.order_list.container.length){if(b.isArray(a)){var e=b.order_list.container.find(".order");l=b();for(var d=0;d<a.length;d++){var g=e.filter("[data-order-id="+a[d]+"]");l=l.add(g)}}else var l=b.order_list.container.find(".order[data-order-id="+a+"]");var h=l.length,k=0;l.slideUp(450,function(){k++;
k>=h&&c.resolve()})}},1E3);return c.promise()},dispatch:function(a,c){"string"===typeof a&&(a=b.shop.helper.parseParams(a));var e={list:function(){b.orders.waLoadingBeforeLoad();b.order_list.finit();b.orders.load("?module=orders&"+b.orders.buildOrdersUrlComponent(a),function(){b.order_list.dispatch(a);b(window).trigger("wa_loaded",[["table","kanban"]])})},order:function(){b.order_list.loadOrder(a.id)}};null===this.params?(this.params=a,c&&e.list()):a.id&&(c||a.id!=this.params.id)?(e.order(),this.params=
a):(c||this.diff(a,this.params)||this.diff(this.params,a))&&e.list()},diff:function(a,c){for(var e in a)if(a.hasOwnProperty(e)&&"id"!=e&&a[e]!==c[e])return!0;return!1},buildLoadListUrl:function(a,c,e,d,g,l){d=void 0===d?null:d;g=void 0===g?null:g;l=void 0===l?null:l;d&&this.filter_params_str&&this.filter_params_str.includes("hash")&&(this.filter_params_str+=encodeURIComponent("&update_datetime>="+d),d=null);g=g||this.sort;return"?module=orders&action=loadList"+(l?"&state_id="+l:"")+"&id="+a+(this.filter_params_str?
"&"+this.filter_params_str:"")+(c?"&lt=1":"")+(e?"&counters=1":"")+(this.options.view?"&view="+this.options.view:"")+(d?"&search=update_datetime>="+d:"")+("&sort[0]="+g[0]+"&sort[1]="+g[1])},updateProcess:function(a,c){var e=this;a=a||"run";c=c||{};timeout=c.timeout||6E4;var d=this,g=function(){null!==d.timer_id&&(clearTimeout(d.timer_id),d.timer_id=null);null!==d.xhrs.update_load&&(d.xhrs.update_load.abort(),d.xhrs.update_load=null)};g();if("run"==a){var l=function(r,y){var q=d.container.find(".order:first");
q=parseInt(q.attr("data-order-id"),10)||0;var u=k(c.last_update_datetime),v;(null==(v=d.options)?0:v.view)&&"kanban"===d.options.view&&(q=0,v=Array.from(document.querySelectorAll("#order-list [data-order-id]")).map(function(w){return w.getAttribute("data-order-id")}),v.length&&(q=Math.max.apply(Math,$jscomp.arrayFromIterable(v))));return b.getJSON(d.buildLoadListUrl(q,!0,!0,u),function(w){if("ok"==w.status){h(w);b.isEmptyObject(w.data.counters)||d.updateCounters(w.data.counters);if(w.data.count)try{if("kanban"===
d.options.view){var B=d.container.find('[data-kanban-list-status-id="new"]');if(B.length){w.data.orders.reverse();var G,D,z,F,E,A;w.data.orders.forEach(function(f){return B.prepend(tmpl("template-order-list-kanban-card",{order:f,state:"new",state_name:(null==(G=d.options)?void 0:null==(D=G.state_names["new"])?void 0:D.name)||"",state_color:(null==(z=d.options)?void 0:null==(F=z.state_names["new"])?void 0:null==(E=F.options)?void 0:null==(A=E.style)?void 0:A.color)||""}))})}}else d.container.prepend(tmpl("template-order-list-"+
d.options.view,{orders:w.data.orders,states:d.options.state_names||{},state_counters:d.options.state_counters||{},state_icons:d.options.state_icons||{},check_all:"table"==d.options.view?d.select_all_input.attr("checked"):!1})),b(".lazyloading-progress-string").text(w.data.progress.loaded+" "+w.data.progress.of),d.container.trigger("append_order_list",[w.data.orders])}catch(f){console&&(console.log("Error: "+f.message),y());return}"function"===typeof r&&r(w)}else console&&console.log("Error when loading new orders: "+
w.errors),"function"===typeof y&&y()}).error(function(w){console&&(w&&w.errors?console.log("Error when loading new orders: "+w.errors):console.log(["Error when loading new orders",w]));"function"===typeof y&&y()})},h=function(r){if(!b.isEmptyObject(r.data.updated_orders))try{for(var y=[],q={},u=$jscomp.makeIterator(r.data.updated_orders),v=u.next();!v.done;q={$jscomp$loop$prop$order$5:q.$jscomp$loop$prop$order$5,$jscomp$loop$prop$newStateId$9:q.$jscomp$loop$prop$newStateId$9,$jscomp$loop$prop$orderElem$11:q.$jscomp$loop$prop$orderElem$11,
$jscomp$loop$prop$oldStateId$8:q.$jscomp$loop$prop$oldStateId$8,$jscomp$loop$prop$hashStateIds$10:q.$jscomp$loop$prop$hashStateIds$10,$jscomp$loop$prop$targetColumn$12:q.$jscomp$loop$prop$targetColumn$12},v=u.next()){q.$jscomp$loop$prop$order$5=v.value;q.$jscomp$loop$prop$orderElem$11=d.container.find("[data-order-id="+q.$jscomp$loop$prop$order$5.id+"]");var w=q.$jscomp$loop$prop$orderElem$11.hasClass("selected");if(q.$jscomp$loop$prop$orderElem$11.length){q.$jscomp$loop$prop$oldStateId$8=q.$jscomp$loop$prop$orderElem$11.data("state-id");
q.$jscomp$loop$prop$newStateId$9=q.$jscomp$loop$prop$order$5.state_id;var B=decodeURIComponent(window.location.hash),G=void 0,D=void 0,z=void 0;q.$jscomp$loop$prop$hashStateIds$10=(null==(G=/state_id=([\w|]+)/.exec(B))?void 0:null==(D=G[1])?void 0:null==(z=D.replace(/\|{1,2}/g,","))?void 0:z.split(","))||[];var F=function(A){return function(f){var m={states:d.options.state_names||{}},n="";if("kanban"===d.options.view){n="-card";A.$jscomp$loop$prop$order$5.order_icon=A.$jscomp$loop$prop$order$5.contact.photo_50x50;
m.order=A.$jscomp$loop$prop$order$5;m.state=A.$jscomp$loop$prop$newStateId$9;var t;m.state_name=null==(t=m.states[m.state])?void 0:t.name;var x;m.state_color=(null==(x=m.states[m.state])?void 0:x.options.style.color)||"#fff";m.isUpdated=!0}else m.orders=[A.$jscomp$loop$prop$order$5],m.state_counters=d.options.state_counters||{},m.state_icons=d.options.state_icons||{},m.check_all="table"==d.options.view?d.select_all_input.attr("checked"):!1;A.$jscomp$loop$prop$orderElem$11.after(tmpl("template-order-list-"+
d.options.view+n,m)).remove();f&&d.loadOrder(A.$jscomp$loop$prop$order$5.id)}}(q);if(function(A){return function(){if(A.$jscomp$loop$prop$oldStateId$8!==A.$jscomp$loop$prop$newStateId$9){if(A.$jscomp$loop$prop$hashStateIds$10.some(function(m){return A.$jscomp$loop$prop$newStateId$9.includes(m)})||"kanban"===e.options.view)return!0;var f=A.$jscomp$loop$prop$orderElem$11.next();f.length&&d.loadOrder(f.data("order-id"));A.$jscomp$loop$prop$orderElem$11.remove();return!1}return!0}}(q)()){if(F(w),q.$jscomp$loop$prop$oldStateId$8!==
q.$jscomp$loop$prop$newStateId$9){var E=d.container.find('[data-order-id="'+q.$jscomp$loop$prop$order$5.id+'"]');q.$jscomp$loop$prop$targetColumn$12=d.container.find('[data-kanban-list-status-id="'+q.$jscomp$loop$prop$newStateId$9+'"]');E.slideToggle("normal",function(A){return function(){b(this).prependTo(A.$jscomp$loop$prop$targetColumn$12).slideToggle("normal")}}(q))}}else q.$jscomp$loop$prop$orderElem$11.remove();y.push(q.$jscomp$loop$prop$order$5.update_datetime)}}k(y.sort()[y.length-1]);d.container.trigger("append_order_list",
[r.data.updated_orders])}catch(A){console&&console.log("Error: "+A.message)}},k=function(r){function y(u){return u.toISOString().replace("T"," ").substring(0,19)}r||(r=new Date,r.setDate(r.getDate()-1),r=y(r));r=new Date(r+"Z");var q=y(r);r.setTime(r.getTime()+timeout);c.last_update_datetime=y(r);return q},p=function(){d.timer_id=setTimeout(function(){null===d.xhrs.lazy_load?d.xhrs.update_load=l(p,g):d.xhrs.lazy_load.then(function(){d.xhrs.update_load=l(p,g)})},timeout)};p()}},finit:function(a){a=
this.xhrs;var c=this.lazy_load_win,e;for(e in a)a.hasOwnProperty(e)&&null!==a[e]&&a[e].abort();this.updateProcess("kill");c&&c.lazyLoad("stop");this.params=null},ordersNavTeleport:function(){var a=window.ordersNav;a&&b.orders&&(a.show(),"split"===this.options.view?b("#s-orders").find(".sidebar-header").prepend(a):b("#s-content").before(a),b.orders.initDropdown(),"split"===this.options.view||this.isMobile()?(a=b(".js-orders-search").detach(),a.addClass("js-orders-search-split-and-mobile"),b("#s-order-nav .js-order-nav-view").after(a)):
(a=b(".js-orders-search-split-and-mobile"),a.length&&(a.removeClass("js-orders-search-split-and-mobile"),b("#s-order-nav .s-order-nav-search").append(a.detach()))))},selectionMenuTeleport:function(){if(this.$selectionMenu&&(this.$search_form=b(".js-sidebar-search-form"),this.$search_form.length)){var a=this.$selectionMenu.detach();this.$search_form.after(a)}},isMobile:function(){return b("#js-media-mobile").is(":visible")}}})(jQuery);$.order_edit={id:0,container:null,form:null,customer_form:null,$storefront_selector:null,stocks:[],slide_on:!1,options:{},locales:{},init:function(b){this.options=b;b.id&&(this.id=b.id);this.container="string"===typeof b.container?$(b.container):b.container;this.form="string"===typeof b.form?$(b.form):b.form;this.$storefront_selector=$("#order-storefront");b.stocks.sort(function(a,c){return a.sort-c.sort});this.stocks=b.stocks;b.title&&(document.title=title);b.float_delimeter||(b.float_delimeter=
...
k.discount).data("description",k.discount_description).data("items_discount",k.items_discount);if("calculate"===e.data("discount")){c.val(e.data("description"));h=e.data("items_discount")||[];for(var p=0;p<h.length;p++)if(h[p]){var r="#order-items span.js-item-total-discount";r+='[data-discount-id="'+h[p].selector+'"]';r=$(r);r.length&&r.html(h[p].html).show()}b()}"calculate"===e.data("discount")?$.order_edit.parseFloat(k.discount)!==$.order_edit.parseFloat(a.val())&&e.click():e.show()}});var l=function(){a.show();
a.parent().find("span.js-order-discount:first").hide();d.hide();$(".js-item-total-discount").hide()};d.click(function(){l();c.val("");return!1});e.click(function(){l();a.val(e.data("value")||0).change();c.val(e.data("description"));a.attr("title",c.data("edit-manually-msg"));e.hide().data("discount","calculate");$.order_edit.updateTotal();b();return!1});a.on("change",function(){d.click();c.val("");$("#order-items .js-item-total-discount").hide();a.attr("title",null);e.show().data("discount",$(this).val());
$.order_edit.updateTotal();b()});this.container.trigger("order_edit_init_discount")},initCouponControl:function(){function b(){r.show();r.css("padding-right",$(".coupon-controls").width()+4+"px")}var a=$("#coupon_id"),c=$("#coupon-code"),e=$(".coupon-code-label"),d=$(".js-no-coupon-text"),g=$(".js-coupon-icon"),l=$(".js-edit-coupon"),h=$(".js-close-coupon"),k=$(".js-delete-coupon"),p=$("#update-discount"),r=$("#js-coupon-invalid-msg");l.on("click",function(){$(this).add(d).add(g).add(e).hide();c.data("value",
c.val());c.val("").show();h.show()});h.click(function(){c.val(c.data("value"));l.show();""===a.val()?d.show():g.add(e).show();$(this).add(c).add(r).hide()});k.click(function(){$(this).add(c).add(g).add(e).add(l).add(h).add(r).hide();a.val("");p.click();d.add(l).show()});$(".disabled-link").click(function(y){y.preventDefault()});c.autocomplete({source:function(y,q){$.ajax({type:"POST",url:"?module=marketing&action=CouponsAutocomplete",data:{term:c.val(),products:$('input[name^="product["]').serializeArray()},
success:function(u){q(u);u.length?r.hide():b()},error:function(){q([])}})},minLength:1,delay:300,select:function(y,q){q.item.data.valid?(c.val(q.item.label).hide(),a.val(q.item.value),e.html(q.item.label).show(),l.add(g).add(k).show(),q.item.data.right?($(".s-order-edit-coupon").attr("href",$(".s-order-edit-coupon").data("href")+q.item.value),0!=q.item.value.length&&(p.click(),$(".s-order-edit-coupon").removeClass("disabled-link"))):0!=q.item.value.length&&p.click(),h.hide()):(c.val(q.item.label),
...
d){var g=d="string"===typeof d?d:""+d;switch(e){case "float":e=parseFloat(d);0<=e&&(g=1*e.toFixed(3));break;case "number":var l="0123456789.,".split(""),h=[],k=!1;$.each(d.split(""),function(p,r){"."===r||","===r?k||(k=!0,h.push(".")):0<=l.indexOf(r)&&h.push(r)});g=h.join("");break;case "integer":l="0123456789".split(""),h=[],$.each(d.split(""),function(p,r){0<=l.indexOf(r)&&h.push(r)}),g=h.join("")}return g}var c=function(e){c=function(d){this.$wrapper=d.$wrapper;this.$field=this.$wrapper.find(".js-quantity-field");
...
this.value=this.validate(d);this.init()};c.prototype.init=function(){function d(l){var h="0123456789.".split(""),k=[],p=!1;l=l.replace(/,/g,".");e.each(l.split(""),function(r,y){"."===y?p||(p=!0,k.push(y)):0<=h.indexOf(y)&&k.push(y)});return k.join("")}var g=this;g.$field.data("controller",g);g.$wrapper.data("controller",g);g.$field.on("input",function(){var l=g.$field.val();var h=d("string"===typeof l?l:""+l);h!==l&&g.$field.val(h)});g.$field.on("change",function(){g.set(g.$field.val())})};c.prototype.set=
function(d,g){d=this.validate(d);this.$field.val(d);this.value=d;this.$wrapper.trigger("quantity.changed",[this.value,this])};c.prototype.validate=function(d){d="number"!==typeof d?parseFloat(d):d;d=parseFloat(d.toFixed(3));0<d?.001>d?d=.001:this.max&&.001<this.max&&d>this.max&&(d=this.max):0!==d&&(d=.001);return a("float",d)};c.prototype.update=function(d){var g="undefined"!==typeof d.min?a("float",d.min):this.min,l="undefined"!==typeof d.max?0<=parseFloat(d.max)?a("float",d.max):0:this.max,h="undefined"!==
typeof d.step?a("float",d.step):this.step;d="undefined"!==typeof d.value?this.validate(d.value):this.value;0<g&&g!==this.min&&(this.min=g);0<=l&&l!==this.max&&(this.max=l);0<h&&h!==this.step&&(this.step=h);0<d&&d!==this.value&&(this.value=d);this.set(this.value)};return c}($);return new c(b)},updateServicePriceInPercent:function(b){var a=b.find(".js-order-edit-item-price").val();if("undefined"===typeof a)return null;b.find('[data-currency="%"]').each(function(){var c=$(this),e=a*(c.data("percentPrice")/
...
y.services.push(v)});y.services.sort();y.services=y.services.join("_");a.push({id:p,product_id:d,quantity:h,price:l,sku_id:r,services:g,stock_id:k});c.push(y)});c=this.reduceOrderContent(c);b.data("order-content",c);return a},reduceOrderContent:function(b){b.sort(function(a,c){var e=a.product_id-c.product_id;0===e&&(e=a.sku_id-c.sku_id);0===e&&(e=a.services.localeCompare(c.services));return e});return b.map(function(a){return"*"+a.product_id+":"+a.sku_id+":"+a.services}).join(";")},updateTotal:function(){function b(){a=
null;$.order_edit.realUpdateTotal()}var a=null;return function(){a?(clearTimeout(a),a=setTimeout(b,250)):a=setTimeout(b,500)}}(),realUpdateTotal:function(){var b=$.order_edit.container,a=$("#subtotal"),c=$("#total"),e=$("#tax");if(b.find(".s-order-item").length){var d=this;$.order_edit.switchSubmitButton("disable");$.order_edit.showValidateErrors();for(var g={},l=$("#s-order-edit-customer").find('[name^="customer["]').serializeArray(),h=0;h<l.length;h++)g[l[h].name]=l[h].value;g.storefront=d.getStorefront();
...
function(L,I){x.append('<option value="'+I.id+'">'+I.name+"</option>");I.id===H&&(x.val(H),I.custom_html&&$("<div />",{id:"payment-custom-"+I.id,class:"fields form"}).html(I.custom_html).appendTo(C))})}if(p&&"ok"===p.status){var y=$("#shipping-rate"),q=$("#shipping_methods"),u=$.trim(q.val())||"",v=u.replace(/\W.+$/,"");p.data&&(p.data=$.order_edit.parseTotalResponse(p.data));q.empty();q.prepend('<option value=""></option>');if(0<p.data.shipping_method_ids.length){var w=$("#shipping-custom");w.empty();
var B=p.data.shipping_method_ids,G=p.data.shipping_methods,D=!1,z=!1;-1!==B.indexOf(u)&&(D=!0);D||-1===B.indexOf(Number(v))||(z=D=!0);w.find(">div.fields.form").hide();for(var F=0;F<B.length;F+=1){var E=""+B[F],A=G[E],f=E.replace(/\W.+$/,""),m=$("<option></option>");m.html(A.name).attr("value",E).data("rate",A.rate);m.data("error",A.error||void 0);m.data("est_delivery",A.est_delivery||void 0);m.data("comment",A.comment||void 0);m.data("external",A.external||!1);q.append(m);u||0!==F||$("#shipping-rate").val($.order_edit.formatFloat(A.rate));
if(v==f){if(A.custom_data)for(var n in A.custom_data)A.custom_data.hasOwnProperty(n)&&m.data(n,A.custom_data[n]);A.custom_html&&(m=w.find("#shipping-custom-"+f),m.length||(m=w.append('<div id="shipping-custom-'+f+'" class="fields form"></div>'),m=w.find("#shipping-custom-"+f)),m.html(A.custom_html))}if(!D&&(A=(""+E).split("."),f=u.split("."),""!==f[0]&&void 0!==A[0]&&void 0!==f[0]&&A[0]==f[0])){u=E;q.val(u);$.order_edit.setShippingInfo();$.order_edit.realUpdateTotal();return}}q.val(u);z&&q.val(v);
q.data("_shipping_id",v);$.shop.trace("set shipping_methods id",[v,u])}r(p.data.payment_methods);""!=k&&$("#discount").val(p.data.discount);y.val(p.data.shipping);$("#order-edit-form").trigger("order_total_updated",p.data);a.text(p.data.subtotal);c.text(p.data.total);e.text(p.data.tax);$.order_edit.showValidateErrors(p.data.errors);d.setShippingInfo()}$.order_edit.switchSubmitButton()},dataType:"json"})}else a.text(0),c.text(0),$.order_edit.checkSelectedAddressFields()&&($("#shipping_methods, #shipping-rate").removeClass("error"),
$("#shipping-info").empty().hide())},saveSubmit:function(b,a){var c=this.form,e=c.serializeArray();"calculate"===$("#update-discount").data("discount")?$(e).each(function(){"discount"==this.name&&(this.value="calculate")}):void 0===$("#update-discount").data("discount")&&(e=e.filter(function(g){return"discount"!==g.name}),0<$("#discount").val()?e.discount_description=$("#edit-discount").val():e=e.filter(function(g){return"discount_description"!==g.name}));success="add"==a?function(g){$.order_edit.container.trigger("order_edit_save_success",
{data:g.data,is_new:!0});$.order_edit.slide(!1,!0)&&($.orders.setFiltersHashStorage("state_id=new|processing|auth|paid"),location.href="#/orders/state_id=new|processing|auth|paid&view=split&id="+g.data.order.id+"/")}:function(g){$.order_edit.container.trigger("order_edit_save_success",{data:g.data,is_new:!1});$.order_edit.container.find(".back").click()};if(1===$("#subtotal.hidden").length){var d=[{name:"quantity[edit][0][product]",value:1},{name:"product[edit][0]",value:0},{name:"sku[edit][0]",value:0},
{name:"name[edit][0]",value:$.order_edit.locales.noproduct_item_name},{name:"item[edit][0]",value:0},{name:"currency",value:$("#order-currency").val()}];e=[].concat($jscomp.arrayFromIterable(e),$jscomp.arrayFromIterable(d))}this.container.trigger("order_edit_save",e);return $.shop.jsonPost(c.attr("action"),e,success,function(g){$.shop.trace(a,g);g&&g.errors&&!$.isEmptyObject(g.errors)&&$.order_edit.showValidateErrors(g.errors)},b)},parseTotalResponse:function(b){["total","discount","shipping","tax",
"subtotal"].forEach(function(a){if("number"===typeof b[a]||"string"===typeof b[a])b[a]=$.order_edit.roundFloat(parseFloat((+b[a]).toFixed(2)))});return b},roundFloat:function(b){return b?this.formatFloat(Math.round(100*b)/100):0},formatFloat:function(b){return","===this.float_delimeter?(""+b).replace(".",","):""+b},parseFloat:function(b){return b?parseFloat((""+b).replace(",",".")):0},slideBack:function(){this.slide(!1,"add"==this.options.mode)},slide:function(b,a,c){if(0==arguments.length)this.slide(!0,
"add"==this.options.mode);else{b="undefined"===typeof b?!0:b;a="undefined"===typeof a?!1:a;var e=this.options.duration||200,d=this.options.view,g=[];return!this.slide_on&&b?(g.push($("#s-sidebar").animate({width:0},e,function(){$(this).hide()})),$(".s-level2").hide(),g.push($("#maincontent").animate({"margin-top":45},e)),g.push($("#s-content").animate({"margin-left":0},e)),g.push($("#s-orders").animate({width:0},e,function(){$(this).hide()})),g.push($("#s-order").animate({"margin-left":0},e).find(">div:first").removeClass("double-padded, bordered-left").find("h1 .back.order-list").hide().end().find("h1 .back.read-mode").show()),
this.slide_on=!0,$(".s-order-readable").hide(),$(".s-order-editable").show(),$.when(g).done(function(){$.order_list&&$.order_list.lazy_load_win&&$.order_list.lazy_load_win.lazyLoad("sleep");"function"===typeof c&&c.call(this)}),!0):this.slide_on&&!b?(g.push($("#s-order").animate({"margin-left":"table"==d||a?200:300},e).find(">div:first").addClass("double-padded, bordered-left").find("h1 .back.order-list").show().end().find("h1 .back.read-mode").hide()),g.push($("#s-orders").animate({width:300},e).show()),
g.push($("#maincontent").animate({"margin-top":84},e)),$(".s-level2").show(),g.push($("#s-sidebar").animate({width:200},e).show()),this.slide_on=!1,$(".s-order-editable").hide(),$(".s-order-readable").show(),$.when(g).done(function(){$.order_list.lazy_load_win&&$.order_list.lazy_load_win.lazyLoad("wake");"function"===typeof c&&c.call(this)}),!0):!1}},switchSubmitButton:function(b){var a=this.form,c=$(a).find(".s-order-items-edit td.save i.loading");a=$(a).find("[type=submit]");"disable"===b?(c.css("display",
"inline-block"),a.attr("disabled",!0)):(c.css("display","none"),a.attr("disabled",!1))},showValidateErrors:function(b){var a=[];$.shop.trace("showValidateErrors",b);$("#shipping-info").find(".error").empty();$(".error").removeClass("error");$("#s-order-edit-customer .errormsg").empty();this.customer_form&&this.customer_form.showValidateErrors(b?b.customer:{});$(".s-order-errors").empty();if(b&&b.order){if(!$.isEmptyObject(b.order.items))for(var c in b.order.items){var e=$(".s-order-item[data-index="+
c+"]"),d=b.order.items[c],g;for(g in d){var l=e.find(".s-error-item-"+g);l.length?l.text(d[g]):a.push(d[g])}delete b.order.items[c]}if(!$.isEmptyObject(b.order.product)){var h=b.order.product,k;for(k in h)h.hasOwnProperty(k)&&"quantity"in h[k]&&$(".s-order-item[data-product-id="+k+"]").each(function(){$(this).find("ul.s-orders-skus input:radio:checked").val()!=""+h[k].sku_id&&$(this).find("ul.s-orders-skus").length||($(this).find(".s-orders-quantity").addClass("error"),a.push(h[k].quantity))})}b.order.common&&
...
d=function(){return".s-customer-more-shipping-addresses-control"};e().each(function(h){var k=b(this);h=0<h?a.locales.extra_shipping_address:a.locales.main_shipping_address;h=b("<span />").addClass("s-block-header bold").text(h);k.addClass("s-address-block").prepend(h)});var g=1<e().length,l=0<e().not(":first").find(".errormsg,.error").length;g&&!l&&(e().not(":first").hide(),e().first().after(c.find(d())));c.on("click",d()+" .js-toggle-button",function(h){h.preventDefault();e().not(":first").show();
c.find(d()).hide()})};ShopBackendCustomerForm.prototype.initBillingAddress=function(){var a=this,c=a.$wrapper,e=function(){return c.find(".field-address-billing").find(".value").children()},d=function(){return".s-customer-more-billing-addresses-control"};e().each(function(h){var k=b(this);h=0<h?a.locales.extra_billing_address:a.locales.main_billing_address;h=b("<span />").addClass("s-block-header bold").text(h);k.addClass("s-address-block").prepend(h)});var g=1<e().length,l=0<e().not(":first").find(".errormsg,.error").length;
g&&!l&&(e().not(":first").hide(),e().first().after(c.find(d())));c.on("click",d()+" .js-toggle-button",function(h){h.preventDefault();e().not(":first").show();c.find(d()).hide()})};ShopBackendCustomerForm.prototype.fixStyles=function(){this.$wrapper.find('.field-birthday input[name="'+this.namespace+'[birthday][year]"]').css({width:"",minWidth:""})};ShopBackendCustomerForm.prototype.updateInnerHtml=function(a){var c=this.$wrapper;a=b("<div>").hide().appendTo("body").html(a);var e=a.find(".s-customer-form-wrapper");
e=ShopBackendCustomerForm.getInstance(e);this.setOptions(e.getOptions());c.html(a.children(0).html());a.remove()};ShopBackendCustomerForm.prototype.reloadForm=function(a,c){var e=this,d=e.$wrapper;c=c||{};var g=b.extend({},a||{});g.type||(g.type=e.getContact().type);var l=d.find(".loading").show();c.beforeReload&&c.beforeReload(g);d.trigger("beforeReload",[g]);if(!a["new"]){a=d.find(":input:not(:disabled)").serializeArray();var h=["shipping","billing"];b.each(a,function(k,p){if(p.name.indexOf(e.namespace)){k=
$jscomp.makeIterator(h);for(var r=k.next();!r.done;r=k.next()){r=r.value;var y=b('[name="'+e.namespace+"[address."+r+'][region]"]');0<y.length&&""!=y.data("country")&&(g[e.namespace+"[address."+r+"][data][country]"]=y.data("country"))}}g[p.name]=p.value})}b.post("?action=customerForm",g,function(k){e.updateInnerHtml(k);l.hide();k=e.getContact(!0);c.afterReload&&c.afterReload(k);d.trigger("afterReload",[k])})};ShopBackendCustomerForm.prototype.bind=function(a,c){this.$wrapper.on(a+".custom"+this.dom_ns,
...
c.hide(200)):(this.disable(),e.val("").show(),c.show())};ShopBackendOrderEditorCustomerForm.prototype.focusFirstEmptyInput=function(){var a=this.$customer_inputs,c=!1;a.filter("input[type=text], textarea").each(function(){var e=b(this);if(e.is(":not(:hidden)")&&!this.value)return c=!0,e.focus(),!1});c||a.first().focus()};ShopBackendOrderEditorCustomerForm.prototype.initAutocomplete=function(){var a=this,c=function(d){var g=a.inputName;var l=parseInt(d,10)||"+"==d.substr(0,1)||-1!==d.indexOf("(");
g="[name="+g.call(a,l?"phone":-1!==d.indexOf("@")?"email":"firstname")+"]";a.$customer_inputs.filter(g).val(d)},e="";a.$autocomplete.autocomplete({source:function(d,g){e=d.term;b.getJSON(a.options.autocomplete_url,d,function(l){(l=l||[]).push({label:$_("New customer"),name:$_("New customer"),value:0});g(l)})},delay:300,minLength:3,select:function(d,g){d=g.item;if(0<d.value)return a.reloadForm({id:d.value,"new":!0}),!1;if(a.editor.getSelectedStorefront())return a.reloadForm({},{afterReload:function(){c(e)}}),
...
c.afterReload&&c.afterReload(g)}})};ShopBackendOrderEditorCustomerForm.prototype.initForm=function(){for(var a=this,c=a.customer_form,e=a.editor,d=a.$wrapper,g=["firstname","middlename","lastname"],l=0,h=g.length;l<h;l+=1)a.$customer_inputs.filter("[name="+a.inputName(g[l])+"]").addClass("s-error-customer-name");d.find(".s-error-customer-name:last").after('<em class="errormsg s-error-customer-name"></em>');a.$new_customer_link.on("click",function(){if(0<a.$customer_id.val())return!1;e.filterStorefrontSelector(a.getContact().type);
