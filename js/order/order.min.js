...
b.outerHeight()-(d||0)-(c.scrollTop()+c.height())}}}})(jQuery);(function(a){a.storage=new a.store;a.orders={options:{view:"table"},prevHash:null,hash:null,init:function(b){var d=this;d.options=b;"undefined"!=typeof a.History&&a.History.bind(function(){d.dispatch()});a.wa.errorHandler=function(b){return 403===b.status||404===b.status?(b=a(b.responseText),b=b.find(".dialog-content").length?a('<div class="block double-padded"></div>').append(b.find(".dialog-content *")):a('<div class="block double-padded"></div>').append(b.find(":not(style)")),a("#s-content").empty().append(b),
a.orders.onPageNotFound(),!1):!0};b=window.location.hash;"#/"===b||!b?this.dispatch():a.wa.setHash(b);this.initSearch();a(document).bind("wa.appcount",function(b,d){var f=parseInt(d.shop,10);a("#s-pending-orders .small").text(f?"+"+f:"");var h=document.title.match(/\(\d+\) /);h?document.title=document.title.replace(h[0],f?"("+f+") ":""):f&&(document.title="("+f+") "+document.title)})},skipDispatch:0,stopDispatch:function(a){this.skipDispatch=a},dispatch:function(b){if(0<this.skipDispatch)return this.skipDispatch--,
!1;if(void 0===b||null===b)b=window.location.hash;b=b.replace(/(^[^#]*#\/*|\/$)/g,"");null!==this.hash&&(this.prevHash=this.hash);if(this.hash=b)if(b=b.split("/"),b[0]){for(var d="",c=b.length,e=null,f=null,c=0;c<b.length;c++){var h=b[c];if(2>c){if(0===c)d=h;else if(parseInt(h,10)!=h&&-1==h.indexOf("="))d+=h.substr(0,1).toUpperCase()+h.substr(1);else break;"function"==typeof this[d+"Action"]&&(e=d,f=c+1)}else break}"function"!==typeof this[d+"Action"]&&e&&(d=e,c=f);b=b.slice(c);this.preExecute(d);
"function"==typeof this[d+"Action"]?(a.shop.trace("$.orders.dispatch",[d+"Action",b]),this[d+"Action"].apply(this,b)):a.shop.error("Invalid action name:",d+"Action");this.postExecute(d)}else this.preExecute(),this.defaultAction(),this.postExecute();else this.preExecute(),this.defaultAction(),this.postExecute()},back:function(){var b=a.orders.prevHash||"";location.hash=b?b+"/":""},preExecute:function(){},postExecute:function(a){this.actionName=a},defaultAction:function(){this.ordersAction()},buildOrdersUrlComponent:function(a){var d=
"",c;for(c in a)a.hasOwnProperty(c)&&"view"!==c&&(d+="&"+c+"="+a[c]);return"view="+(a.view||this.options.view)+d},load:function(b,d,c){"function"===typeof d?(c=d,d={}):d=d||{};var e=Math.random();this.random=e;var f=this;return a.get(b,function(b){if(!((typeof d.check==="undefined"||d.check)&&f.random!=e)){(d.content||a("#s-content")).removeClass("bordered-left").html(b);typeof c==="function"&&c.call(this);a("html, body").animate({scrollTop:0},200);a(".level2").show();a("#s-sidebar").width(200).show()}})},
couponsAction:function(){a.order_list&&a.order_list.finit();this.load("?module=coupons")},ordersEditAction:function(b){this.load("?module=order&action=edit&id="+b,function(){a.order_list&&a.order_list.finit()})},ordersNewAction:function(){this.load("?module=order&action=edit",function(){a.order_list&&a.order_list.finit()})},ordersAction:function(b){1<arguments.length&&(b=Array.prototype.join.call(arguments,"/"));b?"all"===b&&(b=""):b="state_id=new|processing|paid";b=a.shop.helper.parseParams(b||"");
b.view||(b.view=a.storage.get("shop/orders/view")||this.options.view);a.storage.set("shop/orders/view",b.view);a.order_edit&&a.order_edit.slideBack();"orders"!==this.actionName||!a.order_list?(a.order_list&&a.order_list.finit(),this.load("?module=orders&"+this.buildOrdersUrlComponent(b),function(){a.order_list&&a.order_list.dispatch(b)})):a.order_list.dispatch(b)},orderAction:function(b,d){d=a.shop.helper.parseParams(d||"");d.view||(d.view=a.storage.get("shop/orders/view")||this.options.view);a.storage.set("shop/orders/view",
d.view);a.order_edit&&a.order_edit.slideBack();this.load("?module=order&id="+encodeURIComponent(b)+"&"+this.buildOrdersUrlComponent(d),function(){a("#s-content").find("h1 .back.order-list").show()});a.order_list&&a.order_list.finit()},initSearch:function(){var b=a("#s-orders-search"),d=[],c=function(c){switch(c.autocomplete_item_type){case "order":a.wa.setHash("#/order/"+c.id+"/");b.val(c.value);break;case "contact":a.wa.setHash("#/orders/contact_id="+c.id+"/");b.val(c.value);break;case "product":a.wa.setHash("#/orders/product_id="+
c.id+"/");b.val(c.value);break;case "coupon":a.wa.setHash("#/orders/coupon_id="+c.id+"/");break;case "shipping":a.wa.setHash("#/orders/shipping_id="+c.id+"/");break;case "payment":a.wa.setHash("#/orders/payment_id="+c.id+"/");break;case "city":a.wa.setHash("#/orders/city="+c.value+"/");break;case "region":a.wa.setHash("#/orders/region="+((c.value||"").split(":")[1]||"")+"/");break;case "country":a.wa.setHash("#/orders/country="+c.value+"/")}};b.unbind("keydown").bind("keydown",function(b){if(13==
b.keyCode||10==b.keyCode){var f=a(this);if(a(this).val()){if(d&&a.isArray(d)&&d.length)return c(d[0]),setTimeout(function(){f.autocomplete("close")},150),!1}else return location.hash="#/orders/all/",f.autocomplete("close"),!1}});b.autocomplete({minLength:1,delay:300,html:!0,select:function(a,b){c(b.item);return!1},source:function(b,c){a.getJSON("?action=autocomplete&type=order",b,function(a){d=a;c(a)})}})},onPageNotFound:function(){a.order_list&&a.order_list.finit()}}})(jQuery);$.order_list={id:0,options:{},container:null,sidebar:null,select_all_input:null,filter_params:{},filter_params_str:"",params:null,timer_id:0,lazy_load_win:null,xhrs:{lazy_load:null,update_load:null},init:function(a){this.options=a||{};this.filter_params=a.filter_params||{};this.filter_params_str=a.filter_params_str||"";this.container=$("#order-list");"table"==a.view&&(this.select_all_input=this.container.find(".s-select-all"),this.container=$("#order-list").find("tbody:first"));this.sidebar=$("#s-sidebar");
...
1;return{name:"order_id[]",value:$(this).attr("data-order-id")}}).toArray():b.order_id=$.order_list.container.find(".order.selected").map(function(){b.count+=1;return $(this).attr("data-order-id")}).toArray();return b},initSidebar:function(){var a=this.sidebar;a.find("li.selected").removeClass("selected");if(this.filter_params.state_id)$.isArray(this.filter_params.state_id)?$("#s-pending-orders").addClass("selected"):a.find('li[data-state-id="'+this.filter_params.state_id+'"]').addClass("selected");
else if(this.filter_params.contact_id)a.find("li[data-contact-id="+this.filter_params.contact_id+"]").addClass("selected");else if(this.filter_params.storefront){var b=decodeURIComponent(this.filter_params.storefront);"/"===b.slice(-1)&&(b=b.slice(0,-1));a.find('li[data-storefront="'+b+'"]').addClass("selected")}else $("#s-all-orders").addClass("selected");var d=this.options.view;a.find("li.list a").each(function(){var a=$(this),b=a.attr("href"),f=b.match(/view=((.*)&|(.*)\/|(.*))/);f?a.attr("href",
b.replace("view="+(f[2]||f[3]||f[4]),"view="+d)):(f=b.match(/orders\/((.*)\/|(.*))/),b="",f&&(f[1]?(b=f[2]||f[3],b+="&view="+d):b="view="+d,a.attr("href","#/orders/"+b+"/")))});a.find("li.list a").unbind("click.order_list").bind("click.order_list",function(){if($(this).attr("href").replace(/(^[^#]*#\/*|\/$)/g,"")==$.orders.hash){var a=$.orders.hash.replace("orders/","");$.order_list.dispatch(a,!0)}})},initSelecting:function(){var a=this.container,b=this.select_all_input;b.click(function(){$(this).trigger("select",
this.checked)});$(document).keydown(function(a){16==a.keyCode&&(document.body.onselectstart=function(){return!1})}).keyup(function(a){16==a.keyCode&&(document.body.onselectstart=null)});var d=function(){if($.order_list.filter_params&&!$.order_list.filter_params.length){var a=$("#order-list");b.attr("checked")?a.find(".s-with-selected").show():a.find(".order.selected:first").length?a.find(".s-with-selected").show():a.find(".s-with-selected").hide()}};a.off("select",".order").on("select",".order",function(a,
e){(void 0!==e?e:1)?$(this).addClass("selected").find("input:first").attr("checked",!0):($(this).removeClass("selected").find("input:first").attr("checked",!1),b.is(":checked")&&b.attr("checked",!1));d();return!1});b.unbind("select").bind("select",function(b,d){var d=void 0!==d?d:!0,f=$(this);d?(f.attr("checked",!0),a.find(".order").trigger("select",!0,!1)):(f.attr("checked",!1),a.find(".order").trigger("select",!1,!1))});a.off("click",".order input").on("click",".order input",function(c){var e=c.shiftKey,
c=this.checked,f=$(this).parents(".order:first");c?f.addClass("selected"):(b.is(":checked")&&b.attr("checked",!1),f.removeClass("selected"));if(e&&c){(e=a.data("last_checked"))||(e=a.find(".order:first").trigger("select",!0));var h=f.prevAll(".selected[data-order-id="+e.attr("data-order-id")+"]"),g;if(h.length){g=f.prev();for(e=e.get(0);g.length&&e!=g.get(0);)g.addClass("selected").find("input").attr("checked",!0),g=g.prev()}else if(h=f.nextAll(".selected[data-order-id="+e.attr("data-order-id")+"]"),
h.length){g=f.next();for(e=e.get(0);g.length&&e!=g.get(0);)g.addClass("selected").find("input").attr("checked",!0),g=g.next()}!a.data("last_checked")&&!h.length&&e.trigger("selected",!1)}c&&a.data("last_checked",f);d()})},updateTitle:function(a,b){var b=parseInt(b,10)||0,d="";this.options.state_names&&(this.filter_params.state_id?"string"===typeof this.filter_params.state_id?d=this.options.state_names[this.filter_params.state_id]:$.isArray(this.filter_params.state_id)&&(d=$_("Processing")):d=$_("All orders"));
document.title=b?"("+b+") "+d+(a||""):d+a},updateCounters:function(a){var b=this.sidebar;b||(b=$("#s-sidebar"));var d=$("#s-pending-orders .small"),c;for(c in a)if(a.hasOwnProperty(c)){var e=a[c],f;for(f in e)if(e.hasOwnProperty(f)){var h;h="common_counters"==c?$("#s-"+f+"-orders .count"):"storefront_counters"!==c?b.find("li[data-"+c.replace("_counters","")+"-id="+f+"] .count"):b.find("li[data-"+c.replace("_counters","")+'="'+f+'"] .count');var g=parseInt(h.text(),10)||0,i=0;e[f]=""+e[f];"+"==e[f].substr(0,
1)?i=g+(parseInt(e[f].substr(1),10)||0):"-"==e[f].substr(0,1)?(i=g-(parseInt(e[f].substr(1),10)||0),i=0>i?0:i):i=parseInt(e[f],10)||0;h.text(i);"new"==f&&(d.text(i?"+"+i:""),$.shop.updateAppCounter(i),this.updateTitle(this.options.title_suffix,parseInt(i,10)))}}},updateListItems:function(a){var b="template-order-list-"+this.options.view;if(document.getElementById(b)){var d=this.container;$.isArray(a)||(a=[a]);var a=$("<div></div>").append(tmpl(b,{orders:a,check_all:"table"==this.options.view?this.select_all_input.attr("checked"):
!1})),c=$(".order",d);$(".order",a).each(function(){var a=$(this);c.filter("[data-order-id="+a.attr("data-order-id")+"]").replaceWith(a)});a.remove()}},hideListItems:function(a){var b=$.Deferred();setTimeout(function(){if($.order_list&&$.order_list.container&&$.order_list.container.length){if($.isArray(a))for(var d=$.order_list.container.find(".order"),c=$(),e=0;e<a.length;e++)var f=d.filter("[data-order-id="+a[e]+"]"),c=c.add(f);else var c=$.order_list.container.find(".order[data-order-id="+a+"]");
var h=c.length,g=0;c.slideUp(450,function(){g++;g>=h&&b.resolve()})}},1E3);return b.promise()},dispatch:function(a,b){"string"===typeof a&&(a=$.shop.helper.parseParams(a));var d={list:function(){$.order_list.finit();$.orders.load("?module=orders&"+$.orders.buildOrdersUrlComponent(a),function(){$.order_list.dispatch(a)})},order:function(){$.order_list.loadOrder(a.id)}};null===this.params?(this.params=a,b&&d.list()):a.id&&(b||a.id!=this.params.id)?(d.order(),this.params=a):(b||this.diff(a,this.params)||
this.diff(this.params,a))&&d.list()},diff:function(a,b){for(var d in a)if(a.hasOwnProperty(d)&&"id"!=d&&a[d]!==b[d])return!0;return!1},buildLoadListUrl:function(a,b,d){return"?module=orders&action=loadList&id="+a+(this.filter_params_str?"&"+this.filter_params_str:"")+(b?"&lt=1":"")+(d?"&counters=1":"")+(this.options.view?"&view="+this.options.view:"")},updateProcess:function(a,b){a=a||"run";b=b||{};timeout=b.timeout||6E4;var d=this,c=function(){null!==d.timer_id&&(clearTimeout(d.timer_id),d.timer_id=
null);null!==d.xhrs.update_load&&(d.xhrs.update_load.abort(),d.xhrs.update_load=null)};c();if("run"==a){var e=function(a,b){var c=d.container.find(".order:first"),c=parseInt(c.attr("data-order-id"),10)||0;return $.getJSON(d.buildLoadListUrl(c,!0,!0),function(c){if("ok"==c.status){$.isEmptyObject(c.data.counters)||d.updateCounters(c.data.counters);if(c.data.count)try{d.container.prepend(tmpl("template-order-list-"+d.options.view,{orders:c.data.orders,check_all:"table"==d.options.view?d.select_all_input.attr("checked"):
!1})),$(".lazyloading-progress-string").text(c.data.progress.loaded+" "+c.data.progress.of)}catch(f){console&&(console.log("Error: "+f.message),b());return}"function"===typeof a&&a(c)}else console&&console.log("Error when loading new orders: "+c.errors),"function"===typeof b&&b()}).error(function(a){console&&(a&&a.errors?console.log("Error when loading new orders: "+a.errors):console.log(["Error when loading new orders",a]));"function"===typeof b&&b()})},f=function(){d.timer_id=setTimeout(function(){null===
d.xhrs.lazy_load?d.xhrs.update_load=e(f,c):d.xhrs.lazy_load.then(function(){d.xhrs.update_load=e(f,c)})},timeout)};f()}},finit:function(){var a=this.xhrs,b=this.lazy_load_win,d;for(d in a)a.hasOwnProperty(d)&&null!==a[d]&&a[d].abort();this.updateProcess("kill");b&&b.lazyLoad("stop");this.params=null}};$.order_edit={id:0,container:null,form:null,customer_fields:null,customer_inputs:null,stocks:[],slide_on:!1,options:{},init:function(a){this.options=a;a.id&&(this.id=a.id);this.container="string"===typeof a.container?$(a.container):a.container;this.form="string"===typeof a.form?$(a.form):a.form;this.customer_fields=$("#s-order-edit-customer");this.customer_inputs=this.customer_fields.find(":input");a.stocks.sort(function(a,d){return a.sort-d.sort});this.stocks=a.stocks;a.title&&(document.title=title);
...
service_ids:a.data.service_ids,product_id:i,options:{price_edit:d,index:k,currency:$.order_edit.options.currency,stocks:$.order_edit.stocks}}));c.find(".s-orders-product-price").find("span").html(a.data.sku.price_html||a.data.sku.price_str).end().find("input").val(a.data.sku.price);var f;f=-1!==c.find("input:first").attr("name").indexOf("add")?"add":"edit";c.find(".s-orders-product-stocks").replaceWith(tmpl("template-order-stocks-"+f,{sku:a.data.sku,index:k,stocks:$.order_edit.stocks,item_id:l}));
b(c);$.order_edit.updateTotal(c)})});this.container.off("change",".s-orders-stock").on("change",".s-orders-stock",function(){var a=$(this).parents("tr.s-order-item:first");b(a)});var e=function(a,b,c){var d=a.attr("data-price"),a=a.attr("data-percent-price");c&&b.val(d);b.attr("data-price",d);b.attr("data-percent-price",a)};this.container.off("change",".s-orders-service-variant").on("change",".s-orders-service-variant",function(){var a=$(this),b=a.find("option:selected"),a=a.parents("li:first");e(b,
a.find(".s-orders-service-price"),!0)});this.container.find(".s-orders-service-variant").each(function(){var a=$(this),b=a.find("option:selected"),a=a.parents("li:first");e(b,a.find(".s-orders-service-price"),!1)});this.container.off("click",".s-order-item-delete").on("click",".s-order-item-delete",function(){var a=$(this);a.parents("tr:first").remove();a.parents("table:first").find("tr.s-order-item:first").length||$("#s-order-comment-edit").hide();$.order_edit.updateTotal();return!1});this.container.off("change",
".s-orders-services input").on("change",".s-orders-services input",$.order_edit.updateTotal);this.container.off("change",".s-orders-product-price input").on("change",".s-orders-product-price input",function(){var a=$.order_edit.parseFloat($(this).val());$.order_edit.container.find(".s-orders-service-price").each(function(){var b=$(this);if("%"===b.data("currency")&&b.attr("data-price")===b.val()){var c=a*(b.data("percentPrice")/100);b.val($.order_edit.formatFloat(c));b.attr("data-price",c)}});$.order_edit.updateTotal.apply(this)});
this.container.off("change",".s-orders-services .s-orders-service-variant").on("change",".s-orders-services .s-orders-service-variant",$.order_edit.updateTotal);$(".s-order-customer-details").on("change","select",function(){$(this).attr("name").indexOf("address")&&$.order_edit.updateTotal()});$("#shipping_methods").change(function(){var a=$(this).children(":selected"),b=a.data("rate")||0;$("#shipping-rate").val($.order_edit.formatFloat(b));a.data("error")?($("#shipping-rate").addClass("error"),$("#shipping-info").html('<span class="error">'+
a.data("error")+"</span>").show()):($("#shipping-rate").removeClass("error"),$("#shipping-info").empty().hide());$.order_edit.updateTotal(!1)});$("#payment_methods").change(function(){var a=$(this).val();$("#payment-info > div").hide();$("#payment-custom-"+a).length&&$("#payment-custom-"+a).show()});$("#discount,#shipping-rate").change(function(){$.order_edit.updateTotal(!1)});this.container.off("keydown",".s-orders-quantity").on("keydown",".s-orders-quantity",function(){var a=$(this),b=a.data("timer_id");
b&&clearTimeout(b);a.data("timer_id",setTimeout(function(){$.order_edit.updateTotal()},450))});this.form&&this.form.length&&this.form.unbind("sumbit").bind("submit",function(){$.order_edit.showValidateErrors();$(".s-orders-services input[name^=service]:not(:checked)",this.form).each(function(){$(this).closest("li").find(":input").attr("disabled",!0)});$.order_edit.container.find(".error").length||($(".s-order-items-edit td.save i.loading").css("display","inline-block"),$.order_edit.id?$.order_edit.editSubmit():
$.order_edit.addSubmit());return!1});this.initDiscountControl()},initDiscountControl:function(){function a(){0<b.val()?e.stop().show():e.stop().hide()}var b=$("#discount"),d=$("#discount-description"),c=$("#update-discount"),e=$("#discount-tooltip-icon");$(document).tooltip;e.tooltip({bodyHandler:function(){return d.val()||d.data("updated-manually-msg")}});c.tooltip({bodyHandler:function(){return c.data("description")||d.data("updated-manually-msg")}});e.hide();$("#order-edit-form").on("order_total_updated",
function(a,d){d.discount&&(c.data("value",d.discount).data("description",d.discount_description),c.data("just-recalculated")?d.discount+""!=b.val()&&c.click():c.show())});c.click(function(){d.val(c.data("description")||"");b.val(c.data("value")||0).change();c.hide().data("just-recalculated",!0);a();e.is(":visible")&&e.fadeOut(50,function(){e.fadeIn(50,function(){e.fadeOut(50,function(){e.fadeIn(50,function(){e.fadeOut(50,function(){e.fadeIn(50,function(){e.fadeOut(50,function(){e.fadeIn(50,function(){})})})})})})})});
return!1});b.on("keyup",function(){d.val("");c.show().data("just-recalculated",!1);a()})},updateTotal:function(a){var a=void 0===a?!0:a,b=$.order_edit.container;if(b.find(".s-order-item").length){for(var d=0,c=$("#discount"),e={},f=$("#s-order-edit-customer").find('[name^="customer["]').serializeArray(),h=0;h<f.length;h++)e[f[h].name]=f[h].value;e.items=[];b.find(".s-order-item").each(function(){var a=$(this),b=a.find('input[name^="product"]').val(),c=[],f=$.order_edit.parseFloat(a.find(".s-orders-product-price input").val()),
h=$.order_edit.parseFloat(a.find("input.s-orders-quantity").val());d+=f*h;a.find(".s-orders-services").length&&a.find(".s-orders-services input:checkbox:checked").each(function(){var a=$(this).closest("li"),a=$.order_edit.parseFloat(a.find("input.s-orders-service-price").val());c.push({id:$(this).val(),price:a});d+=a*h});a=a.find("input[name^=sku]:not(:radio)").add(a.find("input[name^=sku]:checked")).first().val()||0;e.items.push({product_id:b,quantity:h,price:f,sku_id:a,services:c})});e.subtotal=
d;b=$.order_edit.parseFloat(c.val()||0);e.discount=b;$.order_edit.id?e.order_id=$.order_edit.id:e.currency=$("#order-edit-form input[name=currency]").val();e["customer[id]"]=$("#s-customer-id").val();a&&$.post("?module=order&action=total",e,function(a){if("ok"==a.status){var b=$("#shipping_methods"),c=b.val();b.empty();for(var d=a.data.shipping_method_ids,f=a.data.shipping_methods,e=-1!==d.indexOf(c),h=0;h<d.length;h+=1){var o=d[h],m=f[o],n=$("<option></option>");n.html(m.name).attr("value",o).data("rate",
m.rate);m.error&&n.data("error",m.error);b.append(n);e||(m=(""+o).split("."),n=c.split("."),void 0!==m[0]&&(void 0!==n[0]&&m[0]==n[0])&&(e=!0,c=o))}e&&b.val(c).change();$("#order-edit-form").trigger("order_total_updated",a.data)}},"json");$("#subtotal").text($.order_edit.formatFloat(Math.round(100*d)/100));a=$.order_edit.parseFloat($("#shipping-rate").val().replace(",","."))||0;a=d+a;0>b?(b=0,c.val("")):(0>a-b&&(b=a),c.val($.order_edit.formatFloat(Math.round(100*b)/100)));c=a-b;$("#total").text($.order_edit.formatFloat(Math.round(100*
c)/100))}else $("#subtotal").text(0),$("#total").text(0)},editSubmit:function(){var a=this.form;$.shop.jsonPost(a.attr("action"),a.serialize(),function(){$.order_edit.container.find(".back").click()},function(a){$.shop.trace("editSubmit",a);$(".s-order-items-edit td.save i.loading").hide();if(a&&a.errors&&!$.isEmptyObject(a.errors))return $.order_edit.showValidateErrors(a.errors),$(".s-orders-services input:disabled",this.form).attr("disabled",!1),!1})},addSubmit:function(){var a=this.form;$.shop.trace("addSubmit",
$(a));$.shop.jsonPost(a.attr("action"),a.serialize(),function(a){$.order_edit.slide(!1,!0)&&(location.href="#/orders/state_id=new&view=split&id="+a.data.order.id+"/")},function(a){$.shop.trace("addSubmit",a);$(".s-order-items-edit td.save i.loading").hide();if(a&&a.errors&&!$.isEmptyObject(a.errors))return $.order_edit.showValidateErrors(a.errors),$(".s-orders-services input:disabled",this.form).attr("disabled",!1),!1})},formatFloat:function(a){return","===this.float_delimeter?(""+a).replace(".",
