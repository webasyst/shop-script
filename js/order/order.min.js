...
d.view);a.order_edit&&a.order_edit.slideBack();this.load("?module=order&id="+encodeURIComponent(b)+"&"+this.buildOrdersUrlComponent(d),function(){a("#s-content").find("h1 .back.order-list").show()});a.order_list&&a.order_list.finit()},initSearch:function(){var b=a("#s-orders-search"),d=[],c=function(a){switch(a.autocomplete_item_type){case "order":location.hash="#/order/"+a.id+"/";b.val(a.value);break;case "contact":location.hash="#/orders/contact_id="+a.id+"/";b.val(a.value);break;case "product":location.hash=
"#/orders/product_id="+a.id+"/",b.val(a.value)}};b.unbind("keydown").bind("keydown",function(b){if(13==b.keyCode||10==b.keyCode){var f=a(this);if(a(this).val()){if(d&&a.isArray(d)&&d.length)return c(d[0]),setTimeout(function(){f.autocomplete("close")},150),!1}else return location.hash="#/orders/all/",f.autocomplete("close"),!1}});b.autocomplete({minLength:1,delay:300,html:!0,select:function(a,b){c(b.item);return!1},source:function(b,c){a.getJSON("?action=autocomplete&type=order",b,function(a){d=a;
c(a)})}})},onPageNotFound:function(){a.order_list&&a.order_list.finit()}}})(jQuery);$.order_list={id:0,options:{},container:null,sidebar:null,select_all_input:null,filter_params:{},filter_params_str:"",params:null,timer_id:0,lazy_load_win:null,xhrs:{lazy_load:null,update_load:null},init:function(a){this.options=a||{};this.filter_params=a.filter_params||{};this.filter_params_str=a.filter_params_str||"";this.container=$("#order-list");"table"==a.view&&(this.select_all_input=this.container.find(".s-select-all"),this.container=$("#order-list").find("tbody:first"));this.sidebar=$("#s-sidebar");
